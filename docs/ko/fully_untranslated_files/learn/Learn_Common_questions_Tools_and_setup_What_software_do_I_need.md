...
- [Apple Safari(사파리)](https://www.apple.com/safari/)

만약 당신이 기술적인 플랫폼이나 국가 등 특정한 그룹을 목적으로 한다면, [Opera](https://www.opera.com/), [Konqueror](https://apps.kde.org/konqueror/) 같은 추가적인 브라우저도 테스트해야할 지도 모릅니다.
