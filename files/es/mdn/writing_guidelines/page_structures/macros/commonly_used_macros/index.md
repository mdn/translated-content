...
- [`event`](https://github.com/mdn/yari/tree/main/kumascript/macros/event.ejs) enlaces a páginas en la referencia de Evento del DOM, por ejemplo: `\[`change`](/es/docs/Web/Reference/Events/change)` da como resultado [`change`](/es/docs/Web/Reference/Events/change).
