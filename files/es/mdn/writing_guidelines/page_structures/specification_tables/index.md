...
Cada página de referencia en MDN debes proporcionar información sobre la especificación o especificaciones en las que se definió esa API o tecnología. Este artículo muestra el aspecto de estas tablas y explica cómo agregarlas.
...
La sección de especificaciones estándar debesría verse así:
...
En estos casos, la información de especificación se puedes agregar a los metadatos de la página usando la clave `spec-urls`.
