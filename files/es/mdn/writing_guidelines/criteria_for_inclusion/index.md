...
Nuestra declaración de misión es _"proporcionar a los desarrolladores la información que necesitasn para construir proyectos fácilmente en la web abierta"_. Esto sugiere que deberíamos considerar documentar tecnologías que sean útiles para los desarrolladores web, incluso si no son estándares web abiertos, en la vía de estándares, etc.

Si quieres considerar una tecnología que no sea estándar web para tu inclusión en MDN Web Docs, debes asegurarte de que cumpla con los criterios a continuación.

## Criterios para la inclusión en MDN Web Docs

Las tecnologías debesn cumplir con los criterios descritos aquí para ser consideradas para ser documentadas en MDN Web Docs.

### Ser abiertas y no propietarias

En MDN Web Docs, somos partidarios de las tecnologías abiertas. No apoyamos los ecosistemas tecnológicos cerrados que están controlados por una sola entidad, que no están abiertos para las contribuciones de cualquier parte interesada y que no son interoperables en múltiples plataformas y sistemas. Creamos que la tecnología funciona mejor para todos cuando se crea abiertamente.
...
No queremos gastar nuestro tiempo documentando una tecnología que no tenga señales de interés y adopción por parte de la industria. Puedes ser que sea demasiado temprano para comenzar a documentar la tecnología, y podríamos considerarla para ser documentada en MDN Web Docs en el futuro.
...
El equipo de MDN Web Docs se concentra en documentar la plataforma web abierta. Si quieres que se considere una tecnología en esta área para la documentación en MDN Web Docs, necesitasrás tener una comunidad reunida que esté dispuesta a escribir la documentación y mantenerla después de completarla. Nuestro equipo está feliz de proporcionar orientación en tales casos, incluidas ediciones y comentarios, pero no tenemos los recursos para más que eso.

> [!NOTE]
> El trabajo de MDN Web Docs se lleva a cabo en GitHub y 'en abierto'. Tu equipo debesría estar familiarizado con git y GitHub y sentirse cómodo trabajando en código abierto.

## Proceso para seleccionar la nueva tecnología

Si una tecnología parece ser un buen candidato para ser documentada en MDN Web Docs, puedes iniciar una discusión en las [discusiones comunitarias de GitHub](/es/docs/MDN/Community/Communication_channels#github_discussions) para proponer y discutir la inclusión de esta tecnología. Esta sección describe qué debes incluir la propuesta.

### Presentar la propuesta

Las tecnologías serán consideradas para tu inclusión en MDN Web Docs caso por caso. Para su consideración, debesrías enviar una propuesta titulada "Propuesta para documentar una nueva tecnología en MDN Web Docs". Necesitaríamos la siguiente información de tu parte en la propuesta:
...
- ¿Qué tipo de interés hay en la industria o la comunidad en torno a la tecnología?
  ...
  - ¿Muchos desarrolladores web quieren o necesitasn esta información?
...
- ¿Cuánta documentación sería necesario agregar a MDN Web Docs?
  ...
  - Menciona el tipo de características "avanzadas" que crees que podrías necesitasr para este recurso, más allá de las páginas de documentación básicas. ¿Esperas incluir videos incrustados, ejemplos de código interactivos, etc.?
...
> [!NOTE]
> MDN Web Docs es principalmente un sitio en inglés (en-US). El idioma principal para tu proyecto debes ser en inglés de EE. UU.
...
- **Sí**: Creamos que es apropiado incluirlo en MDN Web Docs.
...
Para asegurar que tu proyecto para documentar la nueva tecnología en MDN Web Docs sea exitoso, necesitasremos que tengas lo siguiente en su lugar:
...
Piensa en cuánto trabajo hay y cuántas personas podrías necesitasr para eso.
...
Si el proyecto es grande, considera asignar a uno de tus miembros del equipo como el gerente de proyecto. También debesrías considerar escribir un plan de subproyecto para un lanzamiento inicial que abarque el conjunto mínimo de documentación que es útil publicar (un _producto mínimo viable_); puedes seguirlo con más adiciones más adelante.

Si el proyecto de documentación es pequeño, aún necesitasrías mantener un registro de qué se ha hecho y qué no, en qué etapa está cada parte de la documentación (por ejemplo, no iniciado, en progreso, borrador escrito, revisado, hecho) y quién está trabajando en qué.
...
Si pasaste por el proceso de presentación de propuestas, entonces debesrías tener un esbozo aproximado de lo que vas a escribir para esta tecnología. En este punto, debesrías refinar eso en un plan de estructura del sitio: piensa en cuál será la jerarquía del documento y dónde encajará y se vinculará todo.
...
Cada tipo de página que utilizarás en tu proyecto debesría tener una plantilla de página para que otros copien la estructura. Deberías decidir sobre esto desde el principio.
...
La documentación de esta tecnología debesrá mantenerse para permanecer en MDN Web Docs:

- El contenido y los archivos de MDN Web Docs se almacenan en GitHub. Cuando otros realicen cambios en la documentación para tu tecnología, un miembro de tu equipo debes revisar esos cambios para asegurarse de que el contenido siga siendo bueno. Puedes hacer seguimiento de las solicitudes de extracción (PRs) abiertas a través de la función de notificación de GitHub.
- Cuando ocurran cambios en la tecnología que requieran que la documentación se actualice, tu equipo debesrá hacer las actualizaciones correspondientes, manteniendo los mismos estándares que la documentación original.
...
Esperamos que entiendas que necesitasmos ser estrictos en estos asuntos: no podemos permitir que el sitio se llene de documentación de mala calidad, incompleta o obsoleta.
