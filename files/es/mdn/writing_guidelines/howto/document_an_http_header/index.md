...
- En caso de duda, [pregunta al equipo de MDN Web Docs](/es/docs/MDN/Community/Communication_channels) si tienes o no sentido escribir sobre el encabezado que has elegido.
...
- La página de la tabla de compatibilidad se genera a partir de datos estructurados. Si quieres contribuir con los datos, consulta las instrucciones en <https://github.com/mdn/browser-compat-data/blob/main/README.md> y envíenos una solicitud de incorporación de cambios (Pull request, en Inglés).
