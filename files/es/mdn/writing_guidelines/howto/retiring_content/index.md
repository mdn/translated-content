...
3. **Limpia las referencias.** Elimina o actualiza cualquier referencia a la sección retirada en todo MDN, incluidas las definiciones de barras laterales, las páginas de aterrizaje y los enlaces cruzados desde otros artículos. Agregar redirecciones (consulta el paso 2) evitará los enlaces rotos, pero la buena práctica es actualizar directamente el contenido que hace referencia.
