...
Todo lo demás se puedes aprender en el camino.
...
2. La última especificación:
   ...
   Las especificaciones están vinculadas desde páginas de referencia en MDN Web Docs (consulta la sección 'Especificaciones'). Alternativamente, normalmente puedes hacer una búsqueda en la web. Trabaje siempre con las especificaciones más recientes y actualizadas.
3. Los últimos navegadores web modernos:
   Estas debesrían ser compilaciones experimentales/alfa como [Firefox Nightly](https://www.mozilla.org/es/firefox/channel/desktop/)/[Chrome Canary](https://www.google.com/intl/es/chrome/canary/) que tienen más probabilidades de admitir las funciones que está documentando.
...
También puedes ser aconsejable intentar encontrar a alguien que le ayude a responder sus preguntas. Pueden ser los autores de las especificaciones o los ingenieros que implementan las funciones del navegador.

### Leer especificaciones

Esto puedes parecer un poco extraño al principio, pero cuanto más lo haces, más te acostumbras. Aquí hay algunos buenos enlaces que le ayudarán a empezar:
...
> Si necesitas ayuda, consulta las demostraciones que haya encontrado o consulta a un contacto de ingeniería.
...
Luego puedes ampliarlo con más detalles, agregando cada interfaz y sus miembros. Por ejemplo, si estuviera documentando la API de Web Audio, su lista podría verse más parecida a esta:
