...
- Las nuevas propiedades [`-moz-window-shadow`](/es/docs/CSS/-moz-window-shadow) y [`-moz-system-metric(mac-graphite-theme)`](</es/docs/CSS/:-moz-system-metric(mac-graphite-theme)>)
