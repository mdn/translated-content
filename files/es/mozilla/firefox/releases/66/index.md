...
- Hemos implementado el modificador de [selector de atributo](/es/docs/Web/CSS/Reference/Selectors/Attribute_selectors) que distingue entre mayúsculas y minúsculas, `s` ([Error 1512386 en Firefox](https://bugzil.la/1512386)).
- Varias [propiedades logicas](/es/docs/Web/CSS/Guides/Logical_properties_and_values) abreviadas han aterrizado, junto con las propiedades del radio del borde relativo al flujo:
