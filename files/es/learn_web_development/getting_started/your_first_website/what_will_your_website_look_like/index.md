...
Para elegir un color, ve al [Selector de color](/es/docs/Web/CSS/Guides/Colors/Color_format_converter) y busca un color que te guste . Al hacer clic en un color, verás un extraño código de seis caracteres como `#660066`. Eso se llama _código hex_ (abreviatura de hexadecimal) y representa tu color. Copia el código en un lugar seguro por ahora.
