...
- [¿Qué son las herramientas de desarrollo del navegador y cómo se accede a ellas?](/es/docs/Learn/Common_questions/Tools_and_setup/What_are_browser_developer_tools)
...
- [¿Cómo se crea un nuevo constructor que herede sus miembros de un constructor principal?](/es/docs/Learn/JavaScript/Objects/Classes_in_JavaScript)
- [¿Cuándo deberías usar la herencia en JavaScript?](/es/docs/Learn/JavaScript/Objects/Classes_in_JavaScript#object_member_summary)
