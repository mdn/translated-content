...
| {{ Cssxref(":blank") }}             | Selecciona un [elemento `<input>`](/es/docs/Web/HTML/Reference/Elements/input) cuyo valor de entrada está vacío.                                                                                                                                                                                                                                                                                                                                      |
...
| {{ Cssxref(":indeterminate") }}     | Selecciona elementos de interfaz de usuario cuyo valor está en un estado no determinado, por lo general se trata de [casillas de verificación](/es/docs/Web/HTML/Reference/Elements/input/checkbox).                                                                                                                                                                                                                                                  |
...
| {{ Cssxref(":lang") }}              | Selecciona un elemento según el idioma (valor del atributo [lang](/es/docs/Web/HTML/Reference/Global_attributes/lang) de HTML).                                                                                                                                                                                                                                                                                                                       |
