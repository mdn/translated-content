...
Ingresemos algunos ejemplos en una nueva consola. A continuación, proporcionamos uno (o si prefieres, usa la [consola de desarrolladores del navegador](/es/docs/Learn/Common_questions/Tools_and_setup/What_are_browser_developer_tools)).
