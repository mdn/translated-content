...
- [JavaScript asíncrono](/es/docs/Learn_web_development/Extensions/Async_JS)
  - : En este módulo, echamos un vistazo a {{Glossary("JavaScript")}} {{Glossary("asynchronous","asíncrono")}}, por qué es importante y cómo se puede utilizar para manejar eficazmente las posibles operaciones de bloqueo, como la obtención de recursos de un servidor.
