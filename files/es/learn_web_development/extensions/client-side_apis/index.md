...
Para aprovechar al máximo este módulo, debería haber trabajado con los módulos anteriores de JavaScript ([Primeros Pasos](/es/docs/conflicting/Learn_web_development/Core/Scripting), [Bloques de construcción](/es/docs/Learn_web_development/Core/Scripting), y [Objetos en JavaScript](/es/docs/Learn_web_development/Extensions/Advanced_JavaScript_objects)). De todos modos, esos módulos involucran el uso de varias APIs simples, ya que es dificil escribir ejemplos en Javascript del lado del cliente sin dar uso de ellos! Para este tutorial, asumiremos que se tiene conocimiento basico sobre JavaScript y exploraremos las API web mas comunes con un poco más de detalle.

Conocimiento basico de [HTML](/es/docs/Learn_web_development/Core/Structuring_content) y [CSS](/es/docs/conflicting/Learn_web_development/Core/Styling_basics_b957eec7deaf1ea2b20721d6838ea6e1) tambien seria util.
...
- [Introducción a web APIs](/es/docs/Learn_web_development/Extensions/Client-side_APIs/Introduction)
...
- [Obteniendo data desde el servidor](/es/docs/Learn_web_development/Core/Scripting/Network_requests)
...
- [Almacenamiento del lado del Cliente](/es/docs/Learn_web_development/Extensions/Client-side_APIs/Client-side_storage)
