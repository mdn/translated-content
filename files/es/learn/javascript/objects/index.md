...
Antes de empezar este módulo deberías estar familiarizado con {{Glossary("HTML")}} and {{Glossary("CSS")}}. Te aconsejamos trabajar los módulos [Introducción a HTML](https://developer.mozilla.org/es/docs/Learn/HTML/Introduccion_a_HTML) y [Introducción a CSS](https://developer.mozilla.org/es/docs/Learn/CSS/Introduction_to_CSS) antes de empezar con JavaScript.
...
- [Principios básicos de los Objetos](https://developer.mozilla.org/es/docs/Learn/JavaScript/Objects/Basics)
...
- [JavaScript Orientado a Objetos para principiantes](https://developer.mozilla.org/es/docs/Learn/JavaScript/Objects/Object-oriented_JS)
...
- [Herencia en JavaScript](/es/docs/Learn/JavaScript/Objects/Inheritance)
  - Además, presentamos algunos consejos sobre cuándo y dónde puede usar OOJS.
- [Trabajando con datos JSON](/es/docs/Learn/JavaScript/Objects/JSON)
  - Lo encontrarás con bastante frecuencia, por lo que en este artículo te proporcionamos todo lo que necesitas para trabajar con JSON mediante JavaScript, incluido el análisis del JSON para que puedas acceder a los elementos de datos y escribir su propio JSON.
- [Práctica de Construcción de Objetos](/es/docs/Learn/JavaScript/Objects/Ejercicio_práctico_de_construcción_de_objetos)
  - En este artículo nos sumergimos en un ejercicio práctico, que te dará más práctica en la construcción de objetos personalizados de JavaScript, que producen algo divertido y colorido: algunas pelotas de colores rebotando.
