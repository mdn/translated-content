...
<table>
  <tbody>
    <tr>
      ...
      <td>
        Conocimientos básicos de computadores. Entendimiento básico de HTML y
        CSS. Familiaridad con los conceptos básicos de JavaScript (vea
        ...
        <a href="/es/docs/Learn/JavaScript/Building_blocks"
          >Elementos básicos de JavaScript</a
        >) y OOJS (vea
        <a href="/es/docs/Learn/JavaScript/Objects/Basics"
          >Conceptos básicos de los objetos JavaScript</a
        >).
      </td>
    </tr>
    <tr>
      ...
      <td>
        Ganar experiencia en el uso de objetos y el uso de programación
