  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        al menos una comprensión básica de lo que implica escribir un programa
        JavaScript.
      </td>
    </tr>
  </tbody>
...
> **Nota:** Aprenderás mucho más sobre las variables/constantes más adelante en el curso, comenzando con el [artículo siguiente](https://developer.mozilla.org/en-US/docs/user:chrisdavidmills/variables).
