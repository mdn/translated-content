  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        CSS, una idea de lo que es JavaScript.
      </td>
    </tr>
    <tr>
      <th scope="row">Objectivo:</th>
      <td>
        Para entender qué son las matrices y cómo manipularlas en JavaScript.
      </td>
    </tr>
  </tbody>
</table>
...
- [¿Qué salió mal? Troubleshooting JavaScript](https://developer.mozilla.org/es/docs/Learn/JavaScript/First_steps/What_went_wrong)
