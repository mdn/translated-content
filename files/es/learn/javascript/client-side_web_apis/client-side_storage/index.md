...
<table>
  <tbody>
    <tr>
      ...
      <td>
        Conceptos básicos de JavaScript (consulta
        {{web.link("/es/docs/Learn/JavaScript/First_steps", "primeros pasos")}},
        {{web.link("/es/docs/Learn/JavaScript/Building_blocks", "bloques de construcción")}},
        {{web.link("/es/docs/Learn/JavaScript/Objects", "objetos JavaScript")}}),
        los
        {{web.link("/es/docs/Learn/JavaScript/Client-side_web_APIs/Introducción", "conceptos básicos de las APIs de lado del cliente")}}
      </td>
    </tr>
    <tr>
      <th scope="row">Objetivo:</th>
      <td>
        Aprender a utilizar las APIs de almacenamiento de lado del cliente para
