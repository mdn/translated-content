...
<p>Antes de empezar con CSS deberemos conocer los fundamentos de HTML. Podemos trabajar este contenido en <a href="/es/docs/Learn/HTML/Introduction_to_HTML">introducción a HTML</a> para posteriormente aprender:</p>
...
<p>Antes de comenzar con este tema, deberemos tener conocimientos básicos sobre el uso de ordenadores y sobre el uso pasivo de la Web (navegar y consumir contenido). Es recomendable tener configurado un entorno de desarrollo como el detallado en <a href="/es/docs/Learn/Getting_started_with_the_web/Installing_basic_software">Instalación de software básico</a>, y saber crear y gestionar archivos como se detalla en <a href="/es/docs/Learn/Getting_started_with_the_web/Dealing_with_files">Manejando archivos</a> — ambos forman parte del módulo <a href="/es/docs/Learn/Getting_started_with_the_web">Primeros pasos en la Web</a> para principiantes.</p>

<p>Se recomienda trabajar el módulo <a href="/es/docs/Learn/Getting_started_with_the_web">Primeros pasos en la Web</a> antes de entrar a este tema, aunque no es completamente necesario; gran parte de lo tratado en el artículo de CSS básico también se trata en el módulo de introducción a CSS, aunque con mucho más detalle.</p>
...
<dl>
 <dt><a href="/es/docs/Learn/CSS/First_steps">Introducción a CSS</a></dt>
 ...
 <dt><a href="/es/docs/Learn/CSS/Building_blocks">Estilos por cajas</a></dt>
 ...
 <dt><a href="/es/docs/Learn/CSS/Styling_text">Estilo del texto</a></dt>
 ...
 <dt><a href="/es/docs/Learn/CSS/CSS_layout">Diseño CSS</a></dt>
 ...
 <dd>Con la gran variedad de dispositivos capaces de navegar por la Web actualmente, el <a href="/es/docs/web/progressive_web_apps/responsive/responsive_design_building_blocks">diseño web adaptable </a>(RWD) es una habilidad imprescindible para el diseño web. En este módulo veremos principios básicos y herramientas de RWD, como aplicar diferentes CSS a un documento dependiendo de las características del dispositivo como el ancho de la pantalla, la orientación y la resolución; veremos las tecnologías disponibles para mostrar videos e imágenes dependiendo de estas características.</dd>
</dl>
...
<dl>
 <dt><a href="/es/docs/Web/CSS">CSS en MDN</a></dt>
