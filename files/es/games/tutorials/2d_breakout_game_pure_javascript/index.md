...
Para aprovechar al máximo esta serie de artículos necesitas tener ya un conocimiento básico o intermedio de [JavaScript](/en-US/Learn/Getting_started_with_the_web/JavaScript_basics). Cuando termines este tutorial serás capaz de construir tus propios juegos Web.
...
1.  [Crea el lienzo (canvas) y dibuja en él](https://developer.mozilla.org/es/docs/Games/Workflows/Famoso_juego_2D_usando_JavaScript_puro/Create_the_Canvas_and_draw_on_it)
2.  [Mueve la bola](https://developer.mozilla.org/es/docs/Games/Workflows/Famoso_juego_2D_usando_JavaScript_puro/Mueve_la_bola)
3.  [Rebota en las paredes](https://developer.mozilla.org/es/docs/Games/Workflows/Famoso_juego_2D_usando_JavaScript_puro/Bounce_off_the_walls)
4.  [Control de la pala y el teclado](https://developer.mozilla.org/es/docs/Games/Workflows/Famoso_juego_2D_usando_JavaScript_puro/Control_pala_y_teclado)
5.  [Fin del juego](https://developer.mozilla.org/es/docs/Games/Workflows/Famoso_juego_2D_usando_JavaScript_puro/Fin_del_juego)
6.  [Construye el muro de ladrillos](https://developer.mozilla.org/es/docs/Games/Workflows/Famoso_juego_2D_usando_JavaScript_puro/Construye_grupo_bloques)
7.  [Detección de colisiones](https://developer.mozilla.org/es/docs/Games/Workflows/Famoso_juego_2D_usando_JavaScript_puro/Deteccion_colisiones)
8.  [Cuenta los puntos y gana](https://developer.mozilla.org/es/docs/Games/Workflows/Famoso_juego_2D_usando_JavaScript_puro/Track_the_score_and_win)
9.  [Controles del ratón](https://developer.mozilla.org/es/docs/Games/Workflows/Famoso_juego_2D_usando_JavaScript_puro/Controles_raton)
10. [Finalizando](https://developer.mozilla.org/es/docs/Games/Workflows/Famoso_juego_2D_usando_JavaScript_puro/Terminando)
...
Vale, ¡vamos a empezar! Dirígete hacia el primer tema — [Crea el lienzo (canvas) y dibuja en él](https://developer.mozilla.org/es/docs/Games/Workflows/Famoso_juego_2D_usando_JavaScript_puro/Create_the_Canvas_and_draw_on_it).
