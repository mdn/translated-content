...
- [Content Security Policy](/en/Security/CSP "en/Security/CSP")
...
- [The X-Frame-Options response header](/es/docs/Web/HTTP/X-Frame-Options "en/The X-FRAME-OPTIONS response header")
