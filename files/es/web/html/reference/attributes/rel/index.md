...
| [`expect`](#expect)                                                                           | Si se usa junto con [`blocking="render"`](/es/docs/Web/HTML/Reference/Elements/link#blocking), permite que la página quede [bloqueada para el renderizado](/es/docs/Glossary/Render_blocking) hasta que se analicen las partes esenciales del documento, de modo que se renderice de forma consistente. | Enlace                  | No permitido                                   | No permitido            |
