...
| [Categorías de Contenido](/es/docs/Web/HTML/Guides/Content_categories) | [Metadata content](/es/docs/Web/HTML/Guides/Content_categories#metadata_content), [flow content](/es/docs/Web/HTML/Guides/Content_categories#flow_content), [phrasing content](/es/docs/Web/HTML/Guides/Content_categories#phrasing_content), script-supporting element                                                                                                                                                                                                     |
| ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| Padres permitidos                                                      | Cualquier elemento que acepte [metadata content](/es/docs/Web/HTML/Guides/Content_categories#metadata_content), [phrasing content](/es/docs/Web/HTML/Guides/Content_categories#phrasing_content), o [script-supporting elements](/es/docs/Web/HTML/Guides/Content_categories#script-supporting_elements). También se permiten como hijos de un elemento {{HTMLElement("colgroup")}} que no tenga un atributo [`span`](/es/docs/Web/HTML/Reference/Elements/colgroup#span) . |
