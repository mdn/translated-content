          ...
          <td>
            ...
            <div class="notecard note">
              <p>
                ...
                <code>&#x3C;link></code> contenga el atributo crossorigin; consulta <a href="/es/docs/Web/HTML/Reference/Attributes/rel/preload#solicitudes_con_cors_habilitado">Solicitudes con CORS habilitado</a>.
              </p>
            </div>
          </td>
        </tr>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <a href="/es/docs/Web/HTML/Guides/Content_categories#contenido_de_flujo">Contenido de flujo</a> y
        <a href="/es/docs/Web/HTML/Guides/Content_categories#contenido_de_frase">Contenido de frase</a>.
      </td>
    </tr>
    <tr>
