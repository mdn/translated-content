...
| Elementos primarios permitidos | Cualquier elemento que acepte [contenido estático](/es/docs/Web/HTML/Guides/Content_categories#phrasing_content) . |
| Documento normativo            | [HTML 5, sección 4.8.3](https://www.w3.org/TR/html5/the-iframe-element.html#the-embed-element)                     |

## Atributos

Este elemento admite los siguientes atributos además de los [atributos globales](/es/docs/Web/HTML/Reference/Global_attributes) .
