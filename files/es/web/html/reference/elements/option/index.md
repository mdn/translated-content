...
| [Contenido de las categorías](/es/docs/Web/HTML/Guides/Content_categories) | Ninguna                                                                                                                                                                                                                                            |
| -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
Este elemento posee los [atributos globales](/es/docs/Web/HTML/Reference/Global_attributes).
