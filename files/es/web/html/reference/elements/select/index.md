...
| [Content categories](/es/docs/Web/HTML/Guides/Content_categories) | Elementos [flow content](/es/docs/Web/HTML/Guides/Content_categories#flow_content), [phrasing content](/es/docs/Web/HTML/Guides/Content_categories#phrasing_content), [interactive content](/es/docs/Web/HTML/Guides/Content_categories#interactive_content), [listed](/es/docs/Web/HTML/Guides/Content_categories#form_listed), [labelable](/es/docs/Web/HTML/Guides/Content_categories#form_labelable), [resettable](/es/docs/Web/HTML/Guides/Content_categories#form_resettable), y [submittable](/es/docs/Web/HTML/Guides/Content_categories#form_submittable) [form-associated](/es/docs/Web/HTML/Guides/Content_categories#form-associated_). |
| ----------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
Este elemento incluye [global attributes](/es/docs/Web/HTML/Reference/Global_attributes).
...
El contenido de este elemento es estático y no [editable](/es/docs/Web/HTML/Reference/Global_attributes/contenteditable).
...
[This is an example](/files/4563/editable_select.html) de un select editable mediante un {{HTMLElement("fieldset")}} de [radioboxes](/es/docs/Web/HTML/Reference/Elements/input) y [textboxes](/es/docs/Web/HTML/Reference/Elements/input) (**escrito en CSS puro**, sin JavaScript),
