...
Google, así como otros de los principales buscadores, admiten el vocabulario para datos estructurados de [Schema.org](schema.org). Este vocabulario define un conjunto estandarizado de nombres de tipos y de propiedades: por ejemplo, [Evento musical de Schema.org](https://schema.org/MusicEvent) señala conciertos, e incluye las propiedades _[startDate](https://schema.org/startDate)_ ('fecha inicial') y _[location](https://schema.org/location)_ ('ubicación') para definir los detalles clave del acontecimiento. En este caso, [Evento musical de Schema.org](https://schema.org/MusicEvent) es el URL usado por _itemtype_ y _startDate_, y la ubicación corresponde a las _itemprop_ que defina [Evento musical de Schema.org](https://schema.org/MusicEvent).

> [!NOTE]
> Para obtener más información sobre los atributos _itemtype_, véase <http://schema.org/Thing> (en inglés)

Los vocabularios de microdatos brindan la semántica, o el significado, de los elementos. Los programadores web pueden diseñar un vocabulario personalizado o servirse de los que existen disponibles en la web, como el ampliamente utilizado vocabulario de [Schema.org](https://schema.org). Schema.org ofrece una colección de vocabularios de etiquetado usados frecuentemente.

Vocabularios usados frecuentemente:

- Obras creativas: _[CreativeWork](https://schema.org/CreativeWork)_ ('obra creativa'),_ [Book](https://schema.org/Book)_ ('libro'), _[Movie](https://schema.org/Movie)_ (película),_ [MusicRecording](https://schema.org/MusicRecording)_ ('grabación musical'),_ [Recipe](https://schema.org/Recipe)_ ('receta'),_ [TVSeries](https://schema.org/TVSeries)_ ('serie de televisión')
- Objetos distintos del texto incrustados: _[AudioObject](https://schema.org/AudioObject)_ ('objeto de audio'), _[ImageObject](https://schema.org/ImageObject)_ ('objeto de imagen'),_ [VideoObject](https://schema.org/VideoObject)_ ('objeto de vídeo')
- _[Event](https://schema.org/Event)_ ('acontecimiento')
- [Tipos relativos a la salud y la medicina](https://schema.org/docs/meddocs.html): las notas sobre los tipos relativos a la salud y la medicina se encuentran bajo _[MedicalEntity](https://schema.org/MedicalEntity)_ ('entidad médica')
- _[Organization](https://schema.org/Organization)_ ('organización')
- _[Person](https://schema.org/Person)_ ('persona')
- _[Place](https://schema.org/Place)_ ('sitio'), _[LocalBusiness](https://schema.org/LocalBusiness)_ ('negocio local'), _[Restaurant](https://schema.org/Restaurant)_ ('restaurante')
- _[Product](https://schema.org/Product)_ ('producto'), _[Offer](https://schema.org/Offer)_ ('oferta'), _[AggregateOffer](https://schema.org/AggregateOffer)_ ('oferta general')
- _[Review](https://schema.org/Review)_ ('reseña'), _[AggregateRating](https://schema.org/AggregateRating)_ ('valoración totalizada')
- _[Action](https://schema.org/Action)_ ('acción')
- _[Thing](https://schema.org/Thing)_ ('cosa')
- _[Intangible](https://schema.org/Intangible)_

Con el objeto de mejorar los resultados de las búsquedas, las empresas operarias de los principales buscadores, como Google, Microsoft y Yahoo!, dependen del vocabulario de [Schema.org](https://schema.org/). Para algunos propósitos específicos, es necesario diseñar un vocabulario especializado. Siempre que resulta posible, se anima a los autores a servirse de vocabularios existentes, dado que esto facilita la reutilización del contenido.
