...
<dl>
<dt><strong>frame</strong> -<em>marcos</em> . Define la organización de los marcos dentro de la ventana del usuario.</dt>

 <dd><strong>Sus etiquetas son</strong>: <code>&lt;frame&gt;</code> (solo tiene una).

 <strong>Está definido como</strong>: Elemento <a href="es/HTML/Elemento/Tipos_de_elementos#paramarcos">para marcos</a>.
 
 <strong>Crea una caja</strong>: .
 
 <strong>Puede contener</strong>: Nada.</dd>
</dl>
