...
<dl>
<dt><strong>meta</strong> de "metainformation" - metainformación. Sirve para aportar información sobre el documento..</dt>

 <dd><strong>Sus etiquetas son</strong>: <code>&lt;meta&gt;</code> (solo tiene una).

 <strong>Está definido como</strong>: Elemento <a href="es/HTML/Elemento/Tipos_de_elementos#de_cabecera">de cabecera</a>.
 
 <strong>Crea una caja</strong>: No.

 <strong>Puede contener</strong>: Nada.

 <strong>Puede ser contenido por</strong>: Elementos <a href="es/HTML/Elemento/head">head</a></dd>
</dl>
