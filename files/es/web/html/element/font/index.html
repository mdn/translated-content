...
<dl>
<dt><strong>font</strong> -<em>fuente</em> . Indica el tamaño, color, o fuente del texto que contiene.</dt>

 <dd><strong>Sus etiquetas son</strong>: &lt;font&gt; y &lt;/font&gt; (ambas obligatorias).

 <strong>Está definido como</strong>: Elemento <a href="es/HTML/Elemento/Tipos_de_elementos#desaprobado">desaprobado</a>.
 
  En un doctype transicional está definido como un elemento <a href="es/HTML/Elemento/Tipos_de_elementos#especial">especial</a> y por lo tanto <a href="es/HTML/Elemento/Tipos_de_elementos#enlinea">en línea</a>.
 
 <strong>Crea una caja</strong>: En línea.

 <strong>Puede contener</strong>: Texto, y/o cero o más elementos <a href="es/HTML/Elemento/Tipos_de_elementos#enlinea">en línea </a>.</dd>
</dl>
...
<p>Texto normal y ...  Texto distinto. </p>
</div>
</div>
