...
Los navegadores que no la soportan, degradan el tipo a texto, creando un problema de constencia en la interfaz de usuario (los controles mostrados son diferentes) y en el manejo de los datos.
