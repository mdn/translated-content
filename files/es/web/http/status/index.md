...
<ul>
 <li><code><span> </span><span> </span><span> </span><span> </span>GET</code>: El recurso se ha obtenido y se transmite en el cuerpo del mensaje.</li>
 ...
 <li><code>TRACE</code>: El cuerpo del mensaje contiene el mensaje de solicitud recibido por el servidor.<span> </span><span> </span><span> </span><span> </span></li>
</ul>
