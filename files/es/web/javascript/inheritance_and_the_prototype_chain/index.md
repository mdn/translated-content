...
<table class="standard-table">
  <caption>
    Pros y contras de usar la clave <code>__proto__</code> en <a href="/en-US/docs/Web/JavaScript/Reference/Operators/Object_initializer">inicializadores de objetos</a>
  </caption>
  <tbody>
    <tr>
