...
<dl>
  <dt>Propiedad</dt>
  <dd><code>[Symbol.iterator]</code></dd>
  <dt>Valor</dt>
  <dd>Una función sin argumentos que retorna un objeto, de acuerdo al <a href="#The_.22iterator.22_protocol">protocolo iterador</a>.</dd>
</dl>
