...
- `thisArg`
  - : El valor del objeto **this** a utilizar dentro de la llamada a _fun_. Cabe mencionar que éste puede no ser el valor visto por el método: si el método es una función del tipo {{jsxref("Strict_mode", "non-strict mode", "", 1)}}, {{jsxref("null")}} o {{jsxref("undefined")}} será reemplazado por el objeto global, y los valores primitivos serán encapsulados.
- `argsArray`
