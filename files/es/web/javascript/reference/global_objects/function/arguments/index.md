...
El valor de la propiedad `arguments` normalmente es {{jsxref("null")}} si no hay una invocación pendiente de la función en progreso (es decir, la función ha sido llamada pero aún no ha devuelto).
