...
- `thisArg` {{optional_inline}}
  - : El valor a usar como `this` cuando se llama a _`function`_.
    ...
    >
    > Si el método es una función en {{jsxref("Strict_mode", "non-strict mode", "", 1)}}, {{jsxref("Operators/null", "null")}} y {{jsxref("undefined")}} serán reemplazados con el objeto global, y valores primitivos serán convertidos a objetos.
