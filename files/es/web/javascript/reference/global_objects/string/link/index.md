...
- `atributoHref`
  - : Cualquier cadena que especifique el atributo [`href`](/es/docs/Web/HTML/Reference/Elements/a#href) de la etiqueta {{HTMLElement("a")}}; debería ser una URL válida (relativa o absoluta).
