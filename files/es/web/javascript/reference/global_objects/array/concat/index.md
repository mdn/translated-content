...
- Tipo de de datos como cadenas, números y boleanos (no objetos {{jsxref("String")}}, {{jsxref("Number")}} o {{jsxref("Boolean")}} objects): `concat` copia los valores de los strings y numeros en el nuevo array.
