...
El objeto `import.meta` es creado por la implementacion ECMAScript , con un prototipo {{JSxRef("Operators/null", "null")}} . El objeto es extensible y sus propiedades son grabables, editables y enumerables.
