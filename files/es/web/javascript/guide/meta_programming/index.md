...
<table class="standard-table">
    ...
    <tbody>
     ...
     <tr>
      <td>{{jsxref("Global_Objects/Proxy/Proxy/is Extensible", "handler.isExtensible()")}}</td>
     ...
     <tr>
      <td>{{jsxref("Global_Objects/Proxy/Proxy/enumerate", "handler.enumerate()")}}</td>
      <td>
       <dl>
...
{{jsxref("Reflect")}} es un objeto integrado que proporciona métodos para operaciones JavaScript interceptables. Los métodos son los mismos que los de {{jsxref ("Global_Objects/Proxy/Proxy", "proxy handlers", "", "true")}}.
