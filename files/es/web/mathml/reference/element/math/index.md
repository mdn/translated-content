...
- mathbackground
  - : El color de fondo. Puedes usar `#rgb`, `#rrggbb` y [palabras clave de colores](/es/docs/Web/CSS/Reference/Values/color_value#palabras_clave_de_colores).
- mathcolor
  - : El color de texto. Puedes usar `#rgb`, `#rrggbb` y [palabras clave de colores](/es/docs/Web/CSS/Reference/Values/color_value#palabras_clave_de_colores).
- display
