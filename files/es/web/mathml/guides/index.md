...
- [Programa de Lovelace para números de Bernoulli](https://people.igalia.com/fwang/lovelace-jsclass-mathml/)
  - : Un emulador del programa de Ada Lovelace para calcular números de Bernoulli, utilizando [Características de clase privada](/es/docs/Web/JavaScript/Reference/Classes/Private_elements).
