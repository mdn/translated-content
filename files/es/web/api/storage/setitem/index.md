...
- _keyName_
  - : Un {{jsxref("String")}} conteniendo la clave que se quiere crear/actualizar.
- _keyValue_
  - : Un {{jsxref("String")}} conteniendo el valor que se le quiere dar a la clave que se está creando/actualizando.
