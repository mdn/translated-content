...
Para que el evento `onfocus` se dispare en elementos que no sean inputs, los mismos deben establecerse con el atributo [`tabindex`](/es/docs/Web/HTML/Reference/Global_attributes#tabindex) (vea [Building keyboard accessibility back in](/es/docs/Learn_web_development/Core/Accessibility/HTML#building_keyboard_accessibility_back_in) para mas detalles).
