...
`keyResult` contiene el codigo numerico para una tecla en particular, dependiendo si la tecla presionada es alfanumerica o no-alfanumerica. Por favor mire [`charCode`](/en-US/DOM/event.charCode) y [`keyCode`](/en-US/DOM/event.keyCode) para mas informacion.
