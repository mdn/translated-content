...
<dl>
 ...
 <dd>Copies the samples from the specified channel of the <span class=""><code>AudioBuffer</code></span> to the <code>destination</code> array.</dd>
 <dt>{{domxref("AudioBuffer.copyToChannel()")}}</dt>
 <dd>Copies the samples to the specified channel of the <span class=""><code>AudioBuffer</code></span>, from the <code>source</code> array.</dd>
</dl>
