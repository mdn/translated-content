...
La propiedad de solo-lectura **`AnimationEvent.animationName`** es un {{jsxref("String")}} conteniendo el valor de la propiedad de CSS {{cssxref("animation-name")}} asociada con la transición.
