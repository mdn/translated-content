...
Después de dibujar la línea, llamamos a [`Array.splice()`](/en-US/JavaScript/Reference/Global_Objects/Array/splice) para reemplazar la información previa sobre el punto de toque con la información actual de la matriz `ongoingTouches`.
