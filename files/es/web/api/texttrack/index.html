...
<p class=""><em>This interface also inherits properties from {{domxref("EventTarget")}}.</em></p>
...
<p class=""><em>This interface also inherits methods from {{domxref("EventTarget")}}.</em></p>
