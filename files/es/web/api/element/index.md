...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| `addEventListener( type, handler, bubble)` Registra un controlador de evento para un tipo de evento específico en un elemento.                                                 | -                                                                                                                             | [Todos](/es/DOM/event)                    |
| `appendChild( appendedNode )` Inserta un nodo así como el último nodo hijo de este elemento.                                                                                   | [Node](/es/DOM/Node)                                                                                            | [Todos](/es/DOM)                                |
| `blur()` Quita el foco del teclado del elemento actual.                                                                                                                        | -                                                                                                                             | para [HTML](/es/HTML), [XUL](/es/XUL) |
| `click()` Simula un clic sobre el elemento actual.                                                                                                                             | -                                                                                                                             | para [HTML](/es/HTML), [XUL](/es/XUL) |
| `cloneNode( deep)` Hace copia de un nudo, y opcionalmente, de todo sus contenidos                                                                                              | [Node](/es/DOM/Node)                                                                                            | para [Todos](/es/DOM)                           |
| `dispatchEvent( event )` Envía un evento a este nodo en el DOM.                                                                                                                | [Boolean](/es/Core_JavaScript_1.5_Reference/Global_Objects/Boolean) | [Todos](/es/DOM)                                |
| `getAttribute( name )` Devuelve el valor de un atributo nombrado desde el nodo actual.                                                                                         | [Object](/es/Core_JavaScript_1.5_Reference/Global_Objects/Object)    | [Todos](/es/DOM)                                |
| `getAttributeNS( namespace, name )` Devuelve el valor del atributo con el nombre especificado, desde el nodo actual.                                                           | [Object](/es/Core_JavaScript_1.5_Reference/Global_Objects/Object)    | [Todos](/es/DOM)                                |
| `getAttributeNode( name )` Devuelve la representación del nodo del atributo nombrado desde el nodo actual.                                                                     | [Attr](/es/DOM/Attr)                                                                                            | [Todos](/es/DOM)                                |
| `getAttributeNodeNS( namespace, name )` Devuelve la representación del nodo del atributo con el nombre especificado, desde el nodo actual.                                     | [Attr](/es/DOM/Attr)                                                                                            | [Todos](/es/DOM)                                |
| Nombre y Descripción                                                                                                                                                           | Devuelve                                                                                                                      | Disponibilidad                                           |
| `getElementsByTagName( name )` Devuelve un conjunto de todos los elementos descendentes, de un nombre de etiqueta particular, desde el elemento actual.                        | [NodeSet](/es/DOM/NodeSet)                                                                                   | [Todos](/es/DOM)                                |
| `getElementsByTagNameNS( namespace, name )` Devuelve un conjunto de todos los elementos descendentes, de un nombre de etiqueta y espacio particular, desde el elemento actual. | [NodeSet](/es/DOM/NodeSet)                                                                                   | [Todos](/es/DOM)                                |
| `hasAttribute( name )` Verifica si el elemento tiene el atributo especificado o no.                                                                                            | [Boolean](/es/Core_JavaScript_1.5_Reference/Global_Objects/Boolean) | [Todos](/es/DOM)                                |
| `hasAttributeNS( namespace, name )` Verifica si el elemento tiene el atributo especificado, en el nombre de espacio especificado o no.                                         | [Boolean](/es/Core_JavaScript_1.5_Reference/Global_Objects/Boolean) | [Todos](/es/DOM)                                |
| `hasAttributes()` Verifica si el elemento tiene o no algún atributo.                                                                                                           | [Boolean](/es/Core_JavaScript_1.5_Reference/Global_Objects/Boolean) | [Todos](/es/DOM)                                |
| `hasChildNodes()` Verifica si el elemento tiene nodos hijos o no.                                                                                                              | [Boolean](/es/Core_JavaScript_1.5_Reference/Global_Objects/Boolean) | [Todos](/es/DOM)                                |
| `insertBefore( insertedNode, adjacentNode )` Inserta el primer nodo antes que el segundo, Nodo hijo en el DOM.                                                                 | [Node](/es/DOM/Node)                                                                                            | [Todos](/es/DOM)                                |
| `normalize()` Limpia todos los nodos de texto debajo de este elemento (une lo adyacente, quita lo vacío).                                                                      | -                                                                                                                             | [Todos](/es/DOM)                                |
| `removeAttribute( name )` Quita el atributo nombrado desde el nodo actual.                                                                                                     | -                                                                                                                             | [All](/es/DOM)                                  |
| `removeAttributeNS( namespace, name )` Quita el atributo con el nombre y nombre de espacio especificado desde el nodo actual.                                                  | -                                                                                                                             | [Todos](/es/DOM)                                |
| Nombre y Descripción                                                                                                                                                           | Devuelve                                                                                                                      | Disponibilidad                                           |
| `removeAttributeNode( name )` Quita la representación del nodo del atributo nombrado desde el nodo actual.                                                                     | -                                                                                                                             | [Todos](/es/DOM)                                |
| `removeChild( removedNode )` Quita el nodo hijo desde el elemento actual.                                                                                                      | [Node](/es/DOM/Node)                                                                                            | [Todos](/es/DOM)                                |
| `removeEventListener( type, handler )` Quita un oyente de evento desde el elemento.                                                                                            | -                                                                                                                             | [Todos](/es/DOM/event)                    |
| `replaceChild( insertedNode, replacedNode )` Reemplaza un nodo hijo en el elemento actual con otro.                                                                            | [Node](/es/DOM/Node)                                                                                            | [Todos](/es/DOM)                                |
| `scrollIntoView( alignWithTop )` Recorre la página hasta que el elemento se obtiene en la vista.                                                                               | -                                                                                                                             | [HTML](/es/HTML)                               |
| `setAttribute( name, value )` Establece el valor de un atributo nombrado desde el nodo actual.                                                                                 | -                                                                                                                             | [Todos](/es/DOM)                                |
| `setAttributeNS( namespace, name, value )` Establece el valor del atributo con el nombre y nombre de espacio especificado desde el nodo actual.                                | -                                                                                                                             | [Todos](/es/DOM)                                |
| `setAttributeNode( name, attrNode )` Establece la representación del nodo del atributo nombrado desde el nodo actual.                                                          | -                                                                                                                             | [Todos](/es/DOM)                                |
| `setAttributeNodeNS( namespace, name, attrNode )` Establece la representación del nodo del atributo con el nombre y nombre de espacio especificado desde el nodo actual.       | -                                                                                                                             | [Todos](/es/DOM)                                |
