...
El evento `transitioncancel` es lanzado cuando una [transición CSS](/es/docs/Web/CSS/Guides/Transitions/Using) es cancelada.
...
| `bubbles` {{readonlyinline}}      | {{jsxref("Boolean")}}      | Si el evento normalmente se propaga o no                                                                                                                                                                                                                                                                                                 |
| `cancelable` {{readonlyinline}}   | {{jsxref("Boolean")}}      | Si el evento es cancelable o no                                                                                                                                                                                                                                                                                                          |
| `propertyName`{{readonlyinline}}  | {{jsxref("String")}}       | El nombre de la propiedad CSS asociada con la transición.                                                                                                                                                                                                                                                                                |
