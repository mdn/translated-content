...
Si el elemento no tiene elemento padre, esto es, si es el elemento raíz del documento, la asignación de su propiedad `outerHTML` lanzará una [`DOMException`](/en-US/DOM/DOMException) con el código de error `NO_MODIFICATION_ALLOWED_ERR`. Por ejemplo:
