...
| `type` {{readonlyInline}}          | [`DOMString`](/es/docs/conflicting/Web/JavaScript/Reference/Global_Objects/String) | The type of event.                                                                                                                                                                                                                                                                                                                                                                                                   |
| `bubbles` {{readonlyInline}}       | [`Boolean`](/es/docs/Web/JavaScript/Reference/Global_Objects/Boolean)              | Whether the event normally bubbles or not                                                                                                                                                                                                                                                                                                                                                                            |
| `cancelable` {{readonlyInline}}    | [`Boolean`](/es/docs/Web/JavaScript/Reference/Global_Objects/Boolean)              | Whether the event is cancellable or not?                                                                                                                                                                                                                                                                                                                                                                             |
...
- [`mousedown`](/es/docs/Web/API/Element/mousedown_event)
- [`mouseup`](/es/docs/Web/API/Element/mouseup_event)
- [`mousemove`](/es/docs/Web/API/Element/mousemove_event)
- [`click`](/es/docs/Web/API/Element/click_event)
- [`dblclick`](/es/docs/Web/API/Element/dblclick_event)
- [`mouseover`](/es/docs/Web/API/Element/mouseover_event)
- [`mouseout`](/es/docs/Web/API/Element/mouseout_event)
- [`mouseenter`](/es/docs/Web/API/Element/mouseenter_event)
- [`mouseleave`](/es/docs/Web/API/Element/mouseleave_event)
- [`contextmenu`](/es/docs/Web/API/Element/contextmenu_event)
