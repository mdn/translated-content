...
> **Nota:** `document.write` en scripts de modo [diferido](/es/docs/Web/HTML/Reference/Elements/script#attr-defer) o [asyncrónico](/es/docs/Web/HTML/Reference/Elements/script#attr-async) serán ignorados, y recibirás un mensaje de error en la consola del tipo "Una llamada a document.write() desde un script cargado asincrónicamente fue ignorado" ("A call to `document.write()` from an asynchronously-loaded external script was ignored").
