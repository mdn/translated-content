...
> [!NOTE]
> Si los selectores indicados incluyen un [pseudo-elemento CSS](/es/docs/Web/CSS/Reference/Selectors/Pseudo-elements), la lista devuelta siempre estará vacía.
...
Este ejemplo usa un [selector de atributos](/es/docs/Web/CSS/Reference/Selectors/Attribute_selectors) para devolver una lista de elementos {{domxref("iframe")}} en el documento que contienen un atributo llamado `"data-src"`:
...
- [Localizando elementos DOM utilizando selectores](/es/docs/Web/API/Document_Object_Model/Selection_and_traversal_on_the_DOM_tree)
- [Selectores de atributo](/es/docs/Web/CSS/Reference/Selectors/Attribute_selectors)
