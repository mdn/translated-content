...
- {{domxref("console.timeStamp()")}} {{Non-standard_inline}}
  - : Agrega un marcador a las herramientas del navegador [Chrome](https://developer.chrome.com/docs/devtools/performance/reference?hl=es-419) o [Firefox](https://profiler.firefox.com/docs/#/./guide-ui-tour-timeline).
