...
- {{domxref("Location.href")}}
  - : Es un {{jsxref("String")}} que contiene la URL completa. Si es cambiada, el documento asociado navegará a la nueva pagina. Puede ser cambiada desde un origen diferente que el asociado al documento.
- {{domxref("Location.protocol")}}
  - : Es un {{jsxref("String")}} que contiene el esquema del protocolo de la URL, incluyendo el `':'` final.
- {{domxref("Location.host")}}
  - : Es un {{jsxref("String")}} que contiene el host, el cual esta compuesta por: _hostname_, `':'`, y el _port_ de la URL.
- {{domxref("Location.hostname")}}
  - : Es un {{jsxref("String")}} que contiene el dominio de la URL.
- {{domxref("Location.port")}}
  - : Es un {{jsxref("String")}} que contiene el numero del puerto de la URL.
- {{domxref("Location.pathname")}}
  - : Es un {{jsxref("String")}} que contiene el `'/'` inicial, seguido por la ruta de la URL.
- {{domxref("Location.search")}}
  - : Es un {{jsxref("String")}} que contiene un `'?'` seguido por los parametros o el "querystring" de la URL. Navegadores modernos proveen [URLSearchParams](/es/docs/Web/API/URLSearchParams/get#Example) y [URL.searchParams](/es/docs/Web/API/URL/searchParams#Example) para hacer mas facil de obtener los parametros desde el querystring.
- {{domxref("Location.hash")}}
  - : Es un {{jsxref("String")}} que contiene un `'#'` seguido por el fragmento identificador de la URL.
- {{domxref("Location.username")}}
  - : Es un {{jsxref("String")}} que contiene el _username_ (usuario) especificado antes del dominio.
- {{domxref("Location.password")}}
  - : Es un {{jsxref("String")}} que contiene el _password_ (contraseña) especificado antes del dominio.
- {{domxref("Location.origin")}} {{readOnlyInline}}
  - : Es un {{jsxref("String")}} que contiene la forma canonica del _origin_ (origen) de la URL.
...
- {{domxref("Location.toString()")}}
  - : Retorna un {{jsxref("String")}} que contiene la URL completa. Es un sinonimo de {{domxref("URLUtils.href")}}, aunque este no puede ser utilizado para modificar el valor.
