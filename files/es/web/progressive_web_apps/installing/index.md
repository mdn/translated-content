...
_**![Una captura de pantalla de un navegador web que muestra el ícono Agregar a la pantalla de inicio en la parte superior](<android-a2hs-icon.png >)**_
...
_![Una captura de pantalla de Firefox para Android que solicita confirmación antes de instalar una aplicación web](fx-a2hs-banner.png)_

### Navegador de Internet Samsung

_Si tiene Samsung Internet en tu dispositivo móvil, verás un icono diferente._

_![Una captura de pantalla del navegador de Internet de Samsung que muestra su icono Agregar a la pantalla de inicio](samsung-internet-add-app.png)_
...
_![Captura de pantalla de un pasquín de Chrome que solicita permiso para instalar la aplicación de muestra Foxes](chrome-a2hs-banner.png)_
...
_![Captura de pantalla que muestra la ubicación del botón Compartir en Safari en iOS 13](safari-ios-a2hs-icon.png)_
...
_![Captura de pantalla del panel para compartir de Safari iOS, que muestra la opción](safari-ios-share-menu.png)_
...
_![Una captura de pantalla de iOS Safari que muestra su panel de configuración y confirmación "Agregar a la pantalla de inicio"](safari-ios-a2hs-banner.png)_
...
_![Captura de pantalla de una pantalla de inicio de Android con la aplicación "Foxes" mostrada](a2hs-on-home-screen.png)_
