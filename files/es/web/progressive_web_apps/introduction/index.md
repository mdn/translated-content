...
![Detectabilidad](discoverable.svg)El objetivo final es que las aplicaciones web tengan una mejor representación en los motores de búsqueda, sean más fáciles de exponer, catalogar y clasificar, y tener metadatos utilizables por los navegadores para brindarles capacidades especiales.
...
![Instalabilidad](installable.svg)
...
![Independencia de la red](network-independent.svg)
...
![Mejora progresiva](progressive.svg)
...
![Reconectable](re-engageable.svg)
...
![Captura de pantalla que muestra una gran cantidad de resultados al buscar "Messenger" al intentar encontrar Facebook Messenger. ¿Cuál es el correcto?](instalingmessengersomanyoptionseek.jpeg)
