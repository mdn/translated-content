...
Consulte [Cascada y herencia](/es/docs/Learn_web_development/Core/Styling_basics/Handling_conflicts) o [Introducción a Cascada en CSS](/es/docs/Web/CSS/Cascade) para obtener más información sobre cómo funciona la herencia en CSS.
