...
- [Using multiple backgrounds](/es/docs/Web/CSS/Guides/Backgrounds_and_borders/Using_multiple_backgrounds)
...
- [Understanding z-index](/es/docs/Web/CSS/Guides/Positioned_layout/Understanding_z-index)
...
- [CSS Animations](/es/docs/Web/CSS/Guides/Animations/Using)
  - : CSS3 Animations allow you to define configurations of style, as [keyframes](/es/docs/Web/CSS/Reference/At-rules/@keyframes), and to transition between them defining an animation.
- [CSS Transitions](/es/docs/Web/CSS/Guides/Transitions/Using)
  - : CSS3 Transitions allow you to define an animation between several styles and to control the way this transition happens.
- [CSS Transforms](/es/docs/Web/CSS/Guides/Transforms/Using)
...
- [CSS Gradients](/es/docs/Web/CSS/Guides/Images/Using_gradients)
...
- [CSS multi-column layouts](/es/docs/Web/CSS/Guides/Multicol_layout/Using)
...
- [CSS flexible boxes layouts](/es/docs/Web/CSS/Guides/Flexible_box_layout/Basic_concepts)
