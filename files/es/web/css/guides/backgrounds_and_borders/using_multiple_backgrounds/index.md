...
En este ejemplo, tres fondos son apilados: el logo de Firefox, un [gradiente lineal](/es/docs/Web/CSS/Reference/Values/gradient/linear-gradient), y una imagen de burbujas:
...
- [Usando gradientes con CSS](/es/docs/Web/CSS/Guides/Images/Using_gradients)
