...
1. [Apilando sin z-index](/es/docs/Web/CSS/Guides/Positioned_layout/Stacking_without_z-index) : Reglas de apilamiento por defecto
2. [Apilamiento y float](/es/docs/Web/CSS/Guides/Positioned_layout/Stacking_floating_elements) : Cómo son manejados los elementos flotantes
3. [Agregando z-index](/es/docs/Web/CSS/Guides/Positioned_layout/Using_z-index) : Usando z-index para cambiar el apilamiento por defecto
4. [El contexto de apilamiento](/es/docs/Web/CSS/Guides/Positioned_layout/Stacking_context) : Notas sobre el contexto de apilamiento
5. [Ejemplo 1 del contexto de apilamiento](/es/docs/Web/CSS/Guides/Positioned_layout/Stacking_context/Example_1) : Jerarquía HTML de 2 niveles, z-index en el último nivel
6. [Ejemplo 2 del contexto de apilamiento](/es/docs/Web/CSS/Guides/Positioned_layout/Stacking_context/Example_2) : Jerarquía HTML de 2 niveles, z-index en todos los niveles
7. [Ejemplo 3 del contexto de apilamiento](/es/docs/Web/CSS/Guides/Positioned_layout/Stacking_context/Example_3) : Jerarquía HTML de 3 niveles, z-index en el segundo nivel
