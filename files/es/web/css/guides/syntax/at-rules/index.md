...
Una **regla-at** es una [declaración CSS](/es/docs/Web/CSS/Guides/Syntax/Introduction#css_statements) que comienza con el símbolo arroba, '@' (U+0040 COMMERCIAL AT), seguido por un identificador, e incluye todo el contenido hasta el siguiente punto y coma, ';' (U+003B SEMICOLON), o el siguiente [bloque CSS](/es/docs/Web/CSS/Guides/Syntax/Introduction#css_declarations_blocks), lo que sea primero.
