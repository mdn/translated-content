...
<h3 id="Propiedades_Constitutivas">Propiedades Constitutivas</h3>
...
<p>La propiedad <code>border</code> permite definir en una única regla todos los bordes de los elementos seleccionados. Se puede utilizar <code>border</code> para definir el o los valores siguientes: {{ Cssxref("border-width") }}, {{ Cssxref("border-style") }}, {{ Cssxref("border-color") }}.</p>
...
{{ Cssxref("border-width") }}.<br><br>
{{ Cssxref("border-style") }}.<br><br>
{{ Cssxref("border-color") }}.<br><br>

<h3 id="Ejemplos" name="Ejemplos">Ejemplos</h3>

<p><a href="/samples/cssref/border.html">Ver ejemplo en vivo</a></p>
