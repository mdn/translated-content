...
<p><span class="notranslate"><a class="external" href="https://www.w3.org/TR/2009/WD-css3-flexbox-20090723/" rel="noopener">En 2009</a> , la especificación se veía bastante diferente.</span> <span class="notranslate"> Para crear un contenedor flexible, usaría <code>display: box</code> y había una serie de propiedades <code>box-*</code> , que hicieron cosas que reconocerá hoy en flexbox.</span></p>

<p><span class="notranslate">Hubo una <a class="external" href="https://www.w3.org/TR/2012/WD-css3-flexbox-20120322/" rel="noopener">actualización de la especificación</a> que actualizó la sintaxis para <code>display: flexbox</code> : esto fue nuevamente prefijado por el proveedor.</span></p>
...
<p><span class="notranslate"><a class="external" href="https://autoprefixer.github.io/" rel="noopener">Autoprefixer Online</a> es una forma útil de ver qué prefijos se recomiendan, dependiendo de cuántas versiones desee volver con el soporte del navegador.</span> <span class="notranslate"> También puede consultar <a class="external" href="https://caniuse.com/#feat=flexbox" rel="noopener">¿Puedo usar?</a> Para obtener información sobre cuándo se eliminaron los prefijos en los navegadores para tomar su decisión.</span></p>

<h2 id="Técnicas_de_respaldo_útiles"><span class="notranslate">Técnicas de respaldo útiles</span></h2>

<p><span class="notranslate">Dado que el uso de flexbox se inicia con el valor de la propiedad de <a href="/en-US/docs/Web/CSS/display"><code>display</code></a> , cuando se necesita admitir navegadores muy antiguos que no admiten flexbox en absoluto, se pueden crear fallos sobrescribiendo un método de diseño con otro.</span> <span class="notranslate"> La especificación define lo que sucede si usa otros métodos de diseño en un elemento que luego se convierte en un elemento flexible.</span></p>

<h3 id="Floated_items">Floated items</h3>

<blockquote>
<p><span class="notranslate">"Flotar y despejar no crea flotación o espacio libre del elemento flexible, y no lo saque del flujo". <a class="external" href="https://www.w3.org/TR/css-flexbox-1/#flex-containers" rel="noopener">3. Contenedores flexibles</a></span></p>
</blockquote>
...
<p><span class="notranslate">El siguiente ejemplo en vivo demuestra el uso de la propiedad de <a href="/en-US/docs/Web/CSS/vertical-align"><code>vertical-align</code></a> junto con <code>display: inline-block</code> .</span> <span class="notranslate"> Tanto <code>display: table-cell</code> como <code>display: inline-block</code> permiten el uso de esta propiedad.</span> <span class="notranslate"> El uso de <code>vertical-align</code> vertical permite la alineación vertical antes de flexbox.</span> <span class="notranslate"> Flexbox ignora la propiedad, por lo que puede usarla junto con <code>display: table-cell</code> o <code>display: inline-block</code> como respaldo y luego usar de forma segura las propiedades de alineación de caja en flexbox.</span></p>
...
<p><span class="notranslate">Puede usar <a href="/en-US/docs/Web/CSS/%2540supports">consultas de funciones</a> para detectar la compatibilidad con flexbox:</span></p>
...
<p><span class="notranslate">Para obtener más información sobre el uso de consultas de características, consulte <a class="external" href="https://hacks.mozilla.org/2016/08/using-feature-queries-in-css/" rel="noopener">Uso de consultas de características en CSS</a> en el blog Mozilla Hacks.</span></p>
