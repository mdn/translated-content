  ...
  <tbody>
    <tr>
      <td style="padding: 1.5em;">
        <div
          style="background-color: lightgreen; border: solid 1px black; border-bottom-right-radius: 40px 40px; width: 100px; height: 100px;">
   ...
   div {
    ...
    <tr>
      <td style="padding: 1.5em;">
        <div
          style="background-color: lightgreen; border: solid 1px black; border-bottom-right-radius: 40px 20px; width: 100px; height: 100px;">
          <div class="hidden">.</div>
        </div>
      </td>
   ...
   div {
    ...
    <tr>
      <td style="padding: 1.5em;">
        <div
          style="background-color: lightgreen; border: solid 1px black; border-bottom-right-radius: 40%; width: 100px; height: 100px;">
          <div class="hidden">.</div>
        </div>
      </td>
   ...
   div {
    ...
    <tr>
      <td style="padding: 1.5em;">
        <div
          style="background-color: lightgreen; border: solid 1px black; border-bottom-right-radius: 40%; width: 100px; height: 200px;">
          <div class="hidden">.</div>
        </div>
      </td>
   ...
   div {
    ...
    <tr>
      <td style="padding: 1.5em;">
        <div
          style="border: black 3px double; border-bottom-right-radius: 40%; height: 100px; width: 100px; background-color: rgb(250,20,70); background-clip: content-box;">
          <div class="hidden">.</div>
        </div>
      </td>
