...
<div class="note">
<p>CSS3 introdujo la notación <code>::first-line</code> (con doble dos puntos) para distinguir <a href="/en-US/docs/Web/CSS/Pseudo-classes" rel="noopener">pseudo-clases</a> de <a href="/en-US/docs/Web/CSS/Pseudo-elements" rel="noopener">pseudo-elementos</a>. Los navegadores también aceptan <code>:first-line</code>, añadido en CSS2.</p>
</div>
