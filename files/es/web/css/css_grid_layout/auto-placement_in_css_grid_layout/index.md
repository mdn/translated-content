...
<p><span class="notranslate">Puede usar <a href="/en-US/docs/Web/CSS/minmax"><code>minmax()</code></a> en su valor para <a href="/en-US/docs/Web/CSS/grid-auto-rows"><code>grid-auto-rows</code></a> permite la creación de filas de un tamaño mínimo pero luego crecer para ajustarse al contenido si es más alto.</span></p>
