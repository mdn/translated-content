...
La regla `@supports` puede ser usada tanto en el nivel superior de una hoja de estilos, como dentro de cualquier [regla de grupo condicional](/en-US/CSS/At-rule#conditional_group_rules) y se puede acceder a ella a través del modelo de objetos de CSS {{domxref("CSSSupportsRule")}}.
