...
Como ayuda para identificar el destino de un enlace que apunta a una parte específica de un documento, los [Selectores CSS3](https://www.w3.org/TR/css3-selectors/#target-pseudo) incluyen la [pseudo-clase](/en-US/CSS/Pseudo-classes) {{ Cssxref(":target") }}.
...
- [Referencia CSS :target](/es/docs/CSS/:target)
