...
La [característica de medios (media feature) de CSS](/es/docs/Web/CSS/Guides/Media_queries/Using#media_features) **`display-mode`** puede ser utilizada para probar el modo de visualización de una aplicación. Puede ser usada para proveer de una experiencia de usuario consistente entre el lanzamiento de un sitio desde una URL y desde un ícono del escritorio.
