...
- [Valor inicial](/es/docs/Web/CSS/Guides/Cascade/Property_value_processing#valor_inicial): {{ Cssxref("color") }} propiedad
- Se aplica a : todos los elementos
- [Heredable](/es/docs/Web/CSS/Guides/Cascade/Inheritance): no
- Porcentajes: N/A
- Media: {{cssxref("Media/Visual", "visual")}}
- [Valor calculado](/es/docs/Web/CSS/Guides/Cascade/Property_value_processing#valor_calculado): cuando son tomados de la propiedad 'color',los valores computarizados de 'color'; de otra manera como sean especificados.
