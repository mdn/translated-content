...
Para animaciones con keyframes, la timing function se aplica entre los [keyframes](/es/docs/Web/CSS/Reference/At-rules/@keyframes) en lugar de sobre toda la animación. Es decir, se aplica al comienzo del keyframe y al final del mismo.
...
Visita [animaciones CSS](/es/docs/Web/CSS/Guides/Animations/Using) para ver algunos ejemplos.
