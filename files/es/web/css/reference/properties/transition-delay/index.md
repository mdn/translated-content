...
La propiedad [CSS](/es/docs/Web/CSS) `transition-delay` especifica la cantidad de tiempo a esperar entre un cambio pedido hacia una propiedad y el comienzo de un efecto de transicion ([transition effect](/es/docs/Web/CSS/Guides/Transitions/Using)).
