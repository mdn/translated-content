...
- [Valor inicial](/es/docs/Web/CSS/Guides/Cascade/Property_value_processing#valor_inicial): 0
...
[box model](/es/docs/Web/CSS/Guides/Box_model/Introduction), {{ Cssxref("min-height") }}, {{ Cssxref("-moz-box-sizing") }}, {{ Cssxref("width") }}, {{ Cssxref("max-width") }}
