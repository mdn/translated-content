...
Usando esta propiedad con un valor diferente a 0 y none se crea un nuevo [contexto de apilamiento](/es/docs/Web/CSS/Guides/Positioned_layout/Stacking_context).
