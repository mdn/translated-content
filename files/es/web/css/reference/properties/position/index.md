...
- Un **elemento posicionado** es un elemento cuyo valor [computado](/es/docs/Web/CSS/Guides/Cascade/Property_value_processing) de `position` es `relative`, `absolute`, `fixed`, o `sticky`. (En otras palabras, cualquiera excepto `static`).
