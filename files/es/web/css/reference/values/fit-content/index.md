...
La función se puede usar como un tamaño de track en las propiedades de [CSS Grid](/es/docs/Web/CSS/Guides/Grid_layout), donde el tamaño máximo es definido por [`max-content`](/es/docs/Web/CSS/Reference/Properties/grid-template-columns#max-content) y el mínimo por [`auto`](/es/docs/Web/CSS/Reference/Properties/grid-template-columns#auto), el cual es calculado por "`auto"` (ej. [`minmax(auto, max-content)`](/es/docs/Web/CSS/Reference/Values/minmax)), excepto que el tamaño del track se restringe al argumento si éste es mas grande que el "auto" mínimo .
