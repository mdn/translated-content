...
**inherit** es un valor permitido en todas las propiedades CSS. Hace que el elemento al cual se aplica tome el [valor calculado](/es/docs/Web/CSS/Guides/Cascade/Property_value_processing) de la propiedad de su elemento padre.
