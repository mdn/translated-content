...
La [pseudo-clase](/es/docs/Web/CSS/Reference/Selectors/Pseudo-classes) **`:optional`** de [CSS](/es/docs/Web/CSS) representa cualquier elemento {{HTMLElement("input")}}, {{HTMLElement("select")}}, o {{HTMLElement("textarea")}} que no tenga el atributo [`required`](/es/docs/Web/HTML/Reference/Elements/input#required) establecido en él.
...
Si un [formulario](/es/docs/Web/HTML/Reference/Elements/form) contiene {{htmlelement("input")}}s opcionales, las entradas requeridas deben indicarse utilizando el atributo [`required`](/es/docs/Web/HTML/Reference/Elements/input#required). Esto se asegurará de que las personas que navegan con la ayuda de la tecnología de asistencia, como un lector de pantalla, puedan comprender qué entradas necesitan contenido válido para garantizar el envío exitoso del formulario.
