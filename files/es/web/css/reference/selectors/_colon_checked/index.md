...
> [!NOTE]
> Debido a que los navegadores a menudo tratan las `<option>` s como [elementos reemplazados](/es/docs/Web/CSS/Guides/Images/Replaced_element_properties), la medida en que se pueden diseñar con la pseudo-clase `:checked` varía de un navegador a otro.
...
> [!NOTE]
> Para un efecto análogo, pero basado en la pseudoclase [`:hover`](/es/docs/Web/CSS/Reference/Selectors/:hover) y sin radioboxes ocultos, vea [esta demostración](css-gallery.zip), tomada de la página de referencia [:hover](/es/docs/Web/CSS/Reference/Selectors/:hover).
