...
> [!NOTE]
> Para un efecto análogo, pero basado en la pseudoclase [`:hover`](/es/docs/Web/CSS/Reference/Selectors/:hover) y sin radioboxes ocultos, vea [esta demostración](css-gallery.zip), tomada de la página de referencia [:hover](/es/docs/Web/CSS/:hover).
