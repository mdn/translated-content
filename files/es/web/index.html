...
<div class="section">
<h2 class="" id="Docs_for_add-on_developers" name="Docs_for_add-on_developers">Documentación para desarrolladores web</h2>
...
<div class="section">
<h2 class="" id="Docs_for_add-on_developers" name="Docs_for_add-on_developers">Referencias de tecnología web</h2>
