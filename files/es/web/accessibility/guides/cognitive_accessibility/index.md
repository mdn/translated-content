...
Un cambio de contexto debe producirse de manera intencional. Por este motivo, cuando una característica de la interfaz recibe [el foco](/es/docs/orphaned/Web/API/HTMLOrForeignElement/focus), no debe desencadenar acciones visibles para el usuario. En su lugar, el usuario debe activar la característica para provocar el cambio.
