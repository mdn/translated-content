...
<p>Vea la entrada en <a href="https://en.wikipedia.org/wiki/ECMAScript">Wikipedia ECMAScript </a> para mas información de la historia de ECMAScript.</p>
...
<ul>
 ...
 <li><a href="https://en.wikipedia.org/wiki/List_of_ECMAScript_engines">Otras implementacion </a>(Wikipedia).</li>
</ul>

<h2 id="Vea_también">Vea también</h2>

<ul>
 <li><a href="https://brendaneich.com/">Brendan Eich's blog</a>. Brendan es el creador de JavaScript y el motor SpiderMonkey JS. El aún trabaja con el grupo de ECMA para desarrollar el lenguaje.</li>
 <li><a href="http://dmitrysoshnikov.com/">El análisis de Dmitry Soshnikov's de ECMA-262 Edición 3 y 5</a></li>
</ul>
