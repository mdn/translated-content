...
<dl>
<dt><strong>basefont</strong> -<em>fuente base</em> . Permite cambiar algunas propiedades del texto.</dt>

<dd><strong>Sus etiquetas son</strong>: &lt;basefont&gt; (solo tiene una).<br><br>

 <dl>
   <dt><strong>Está definido como</strong>: Elemento <a href="es/HTML/Elemento/Tipos_de_elementos#desaprobado">desaprobado</a>.</dt>
