...
HTML ゲームはモバイルアプリなどのネイティブゲームに比べて、ゲームの公開と配布において大きな優位性があります。一つの会社によって管理される単一のストアに固定されるのではなく、 Web 上でゲームを配布したり、プロモーションをしたり、収益化をしたりする自由があります。 Webは本当の意味でマルチプラットフォームなので、その恩恵を受けることができます。この連載では、あなたのゲームを公開及び配布し、有名になるのを待つ間に収入を得たい場合の選択肢について説明します。
