...
> [!NOTE]
> [Make the web work for everyone](https://hacks.mozilla.org/2016/07/make-the-web-work-for-everyone/) では、人々が使っているさまざまなブラウザーの種類やそれぞれのマーケットシェア、それに伴うブラウザー間の懸念点などが説明されています。
