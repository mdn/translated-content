...
最初に[HTML フォーム](/ja/docs/Learn_web_development/Extensions/Forms)の簡単な概要を説明します。ある「チーム」の名前とそれに関連するラベルを入力するための単一のテキストフィールドを持つシンプルな HTML フォームを考えてみましょう。
