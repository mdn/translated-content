...
> [!NOTE]
> [Aside: Compound selectors](https://scrimba.com/frontend-path-c0j/~0br?via=mdn) <sup>[_MDN 学習パートナー_](/ja/docs/MDN/Writing_guidelines/Learning_content#パートナーリンクと埋め込み)</sup>（Scrimba 提供）は、子孫結合子の実践的な解説を提供するインタラクティブなレッスンです。
