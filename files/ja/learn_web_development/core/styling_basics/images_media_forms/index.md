...
画像と動画は、 **[置換要素](/ja/docs/Web/CSS/Guides/Images/Replaced_element_properties)** と呼ばれています。これは、 CSS がこれらの要素の内部レイアウトに影響を与えることはできず、他の要素の中でのページ上の位置のみに影響を与えることを意味します。ただし、これから見ていくように、CSSで画像に対してできることはいろいろあります。
