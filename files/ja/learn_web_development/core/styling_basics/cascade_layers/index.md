...
このレッスンは、より高度な機能である[カスケードレイヤー](/ja/docs/Web/CSS/@layer) を、[CSS カスケード](/ja/docs/Web/CSS/CSS_cascade/Cascade)と [CSS 詳細度](/ja/docs/Web/CSS/CSS_cascade/Specificity)の基本概念を基に紹介することが目標です。
