...
この記事の終わりまで来ましたが、最も重要な情報を覚えていますか？次に進む前に、この情報を覚えているかどうかを確認するためのテストがいくつかあります。[スキルテスト: サイズ設定](/ja/docs/Learn_web_development/Core/Styling_basics/Sizing_tasks)を見てください。
