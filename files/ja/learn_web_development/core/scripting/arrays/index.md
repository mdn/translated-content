...
> [!NOTE]
> Scrimba の [Aside: Intro to arrays](https://scrimba.com/the-frontend-developer-career-path-c0j/~06e?via=mdn) scrim <sup>[_MDN 学習パートナー_](/ja/docs/MDN/Writing_guidelines/Learning_content#パートナーリンクと埋め込み)</sup>は、例題の解説や知識を検査するための課題を交えた、配列に関する有益なインタラクティブな入門ガイドを提供しています。
