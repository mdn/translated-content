...
original_slug: Learn/JavaScript/Objects/Test_your_skills:_Object_basics
---
...
2. [MDNDiscourse フォーラムの学習カテゴリー](https://discourse.mozilla.org/c/mdn/learn/250)で評価や支援を求める投稿を書いてください。投稿には次のものを含める必要があります。
