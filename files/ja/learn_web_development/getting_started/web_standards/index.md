...
このモジュールでは、ウェブがどのように動作するのかという基本的な内容について、高いレベルで説明します。これには、通信に使用されるモデル、関連するコア技術、それらの技術がどのように作成されるのか、ウェブブラウザーがウェブサイトをユーザーにどのようにレンダリングし表示するのか、などが含まれます。
...
このモジュールは主に理論的なものであり、ウェブ技術に関する特定の実用的な知識は前提としていません。しかし、主なウェブ技術が何のために使用されるのか、その基本を理解していると、より理解が深まり、より多くのことを学ぶことができます。「[初めてのウェブサイト](/ja/docs/Learn_web_development/Getting_started/Your_first_website)」モジュールをまだ学習していない人は、一通り学習することをお勧めします。
