...
> [!NOTE]
> MDN Learn Web 開発カリキュラムの全内容は、学生や同僚と共有しやすい便利なPDF形式で提供されています。[カリキュラムをダウンロード](https://github.com/mdn/curriculum/releases/latest/download/MDN-Curriculum.pdf)
...
- セマンティックHTML、CSS、JavaScript の基礎など、中核となる技術スキル。
...
> [!NOTE]
> 教育者はこの資料を参考資料として活用すべきですが、その使用はMozillaによる承認を意味するものではありません。
