...
ブラウザー横断テストとは、ウェブサイトがさまざまなブラウザや端末で確実に動作することを確実にするためのテストです。ウェブ開発者は、次のようなことを考慮する必要があります。
...
> **メモ:** 技術に関するブラウザーの対応情報は、MDN、すなわちあなたが今いるサイトでさまざまな機能を見ていくことで見つけることができます。また、 [caniuse.com](https://caniuse.com/) にも有益な情報があります。
