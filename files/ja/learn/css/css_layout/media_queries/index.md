...
> **Note:** **注**: ここでのメディア種別は、いわゆる {{glossary("MIME type","MIME タイプ")}}とは異なります。

> **Note:** **注**: レベル 3 のメディアクエリー仕様には、他にも多くのメディア種別が定義されています。 これらは非推奨であり、避けるべきです。

> **Note:** **注**: メディア種別はオプションです。 メディアクエリーでメディア種別を指定しない場合、メディアクエリーはデフォルトですべてのメディア種別用になります。
...
![Firefox 開発ツールのモバイルビューのレイアウトのスクリーンショット。](https://mdn.mozillademos.org/files/16867/rwd-mode.png)
