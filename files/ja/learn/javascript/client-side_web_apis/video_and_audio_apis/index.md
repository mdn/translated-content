...
The {{htmlelement("video")}} and {{htmlelement("audio")}} elements allow us to embed video and audio into web pages. As we showed in [Video and audio content](/ja/docs/Learn/HTML/Multimedia_and_embedding/Video_and_audio_content), a typical implementation looks like this:
...
- We use the {{cssxref("content")}} property to set the content to be displayed in each case to be equal to the contents of the [`data-icon`](/ja/docs/Learn/HTML/Howto/Use_data_attributes) attribute. In the case of our play button, `data-icon` contains a capital "P".
...
1.  Next, let's add functionality to handle stopping the video. Add the following [`addEventListener()`](/ja/docs/Web/API/EventTarget/addEventListener) lines below the previous one you added:
...
1.  First of all, add the following two [`addEventListener()`](/ja/docs/Web/API/EventTarget/addEventListener) lines below the previous ones:
...
- [Video and audio content](/ja/docs/Learn/HTML/Multimedia_and_embedding/Video_and_audio_content) — simple guide to `<video>` and `<audio>` HTML.
- [Audio and video delivery](/ja/docs/Web/Apps/Fundamentals/Audio_and_video_delivery) — detailed guide to delivering media inside the browser, with many tips, tricks, and links to further more advanced tutorials.
- [Audio and video manipulation](/ja/docs/Web/Apps/Fundamentals/Audio_and_video_manipulation) — detailed guide to manipulating audio and video, e.g. with [Canvas API](/ja/docs/Web/API/Canvas_API), [Web Audio API](/ja/docs/Web/API/Web_Audio_API), and more.
