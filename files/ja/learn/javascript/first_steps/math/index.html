...
<div class="note">
<p><strong>メモ</strong>: JavaScript の演算子とその優先順位については<a href="/ja/docs/Web/JavaScript/Guide/Expressions_and_Operators#演算子の優先順位">式と演算子</a>で確認することができます。</p>
</div>
...
<div class="note">
<p><strong>メモ</strong>: もっとたくさんの<a href="/ja/docs/Web/JavaScript/Guide/Expressions_and_Operators#代入演算子">代入演算子があります</a>が、とりあえず今は基本的なものだけ知っておけばよいでしょう。</p>
</div>
