...
3. このフォームのフィールドをすべて埋めてください。
   ...
   - README** でこのリポジトリーを初期化する(Initialize this repository with a README**) を調べます。
...
1. GitHubで、緑の **Code** ボタンをクリックします。
   ...
   リポジトリー名 "django_local_library" を使用した場合、URL は `https://github.com/<git_ユーザー_id>/django_local_library.git` のようになります。
