...
> **Note:** Django の Web サイトの [リリースノート](https://docs.djangoproject.com/en/2.0/releases/) をチェックして、最近のバージョンで何が変わったのか、どのような作業が Django を改善しているのか確認してください。
...
> **Note:** Django はこの構成を "モデルビューテンプレート（Model View Template, MVT）" アーキテクチャと呼んでいます。これは [Model View Controller](/ja/docs/Web/Apps/Fundamentals/Modern_web_app_architecture/MVC_architecture) アーキテクチャとよく似ています。
