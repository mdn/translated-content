...
We created our index page routes in a [previous tutorial.](/ja/docs/Learn/Server-side/Express_Nodejs/routes) As a reminder, all the route functions are defined in **/routes/catalog.js**:
...
- Proceed to the next subarticle of part 5: [Book list page](/ja/docs/Learn/Server-side/Express_Nodejs/Displaying_data/Book_list_page).
