...
MDN の[ウェブ開発の学習](/ja/docs/Learn_web_development)コンテンツへの外部リンク追加を考えてみる場合は、[ウェブ開発を学ぶガイドライン > 外部リンクと埋め込み](/ja/docs/MDN/Writing_guidelines/Learning_content#外部リンクと埋め込み)も同時にお読みください。
