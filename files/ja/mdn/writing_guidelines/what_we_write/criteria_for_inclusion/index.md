...
ある技術が MDN Web Docs で文書化するのに適していると思われる場合、その技術を掲載することを [GitHub コミュニティの discussions](https://github.com/mdn/mdn-community/discussions) で議論を始め、提案と議論をすることができます。この節では、提案に掲載すべき内容を記述します。
