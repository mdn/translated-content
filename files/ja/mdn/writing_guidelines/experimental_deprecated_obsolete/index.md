...
- [プルリクエストを送信する](https://github.com/mdn/browser-compat-data/blob/main/docs/contributing.md#updating-the-compat-data)ことで、ブラウザーコンパットデータリポジトリのアイテムのステータスデータを更新します。
