...
<table class="standard-table">
	...
	<tbody>
		<tr>
			<td><code><a href="#attr-alternate">alternate</a></code></td>
			<td>現在の文書の別な表現。</td>
			<td>リンク</td>
			<td>リンク</td>
		...
		<tr>
			<td><code><a href="#attr-author">author</a></code></td>
			<td>現在の文書や記事の著者。</td>
			<td>リンク</td>
			<td>リンク</td>
			<td class="not-allowed">不許可</td>
		...
		<tr>
			<td><code><a href="#attr-bookmark">bookmark</a></code></td>
		...
		<tr>
			<td><code><a href="#attr-canonical">canonical</a></code></td>
			<td>現在の文書の推奨 URL。</td>
			<td>リンク</td>
			<td class="not-allowed">不許可</td>
			<td class="not-allowed">不許可</td>
		...
		<tr>
			<td><code><a href="#attr-external">external</a></code></td>
		...
		<tr>
			<td><code><a href="#attr-help">help</a></code></td>
		...
		<tr>
			<td><code><a href="#attr-icon">icon</a></code></td>
		...
		<tr>
			<td><code><a href="#attr-license">license</a></code></td>
		...
		<tr>
			<td><code><a href="#attr-next">next</a></code></td>
		...
		<tr>
			<td><code><a href="#attr-nofollow">nofollow</a></code></td>
		...
		<tr>
			<td><code><a href="#attr-noreferrer">noreferrer</a></code></td>
		...
		<tr>
			<td><code><a href="#attr-opener">opener</a></code></td>
		...
		<tr>
			<td><code><a href="#attr-pingback">pingback</a></code></td>
		...
		<tr>
			<td><code><a href="#attr-prev">prev</a></code></td>
		...
		<tr>
			<td><code><a href="#attr-search">search</a></code></td>
		...
		<tr>
			<td><code><a href="#attr-stylesheet">stylesheet</a></code></td>
		...
		<tr>
			<td><code><a href="#attr-tag">tag</a></code></td>
...
<dl>
	...
	<ul>
		<li><code><a href="#stylesheet">stylesheet</a></code> キーワードと共に <code>&lt;link&gt;</code> で使用された場合は、代替スタイルシートを生成します。
...
&lt;link rel=alternate href="/fr/pdf" hreflang=fr type=application/pdf title="French PDF"&gt;</pre>
  ...
  <p class="note">メモ: 廃止された <code>rev="made"</code> は <code>rel="alternate"</code> として扱われます。</p>
	...
	<br>
	これは <a href="#opener">opener</a> の逆です。</dd>
	...
	<dd>ハイパーリンクが最上位の閲覧コンテキストを生成し、それが補助的な閲覧コンテキストでない場合 (すなわち "<code>_blank</code>" が <code>target</code> 属性の値として設定されている場合)、補助的な閲覧コンテキストを生成します。事実上、 <a href="#noopener">noopener</a> の逆です。</dd>
	...
	<dd>
	<p><a href="#next">next</a> キーワードと同様に、{{htmlelement('form')}}, {{htmlelement('link')}}, {{htmlelement('a')}}, {{htmlelement('area')}} に関連する <code>prev</code> の値は、現在の文書が一連の文書の一部であり、このリンクが一連の文書内の直前の文書を参照していることを示します。</p>
	...
	<p><a href="#alternate">alternate</a> キーワードと一緒に使われると、代替のスタイルシートを定義します。この場合、空ではない <code><a href="type">title</a></code> を入れてください。</p>
