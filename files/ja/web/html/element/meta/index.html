...
<table class="properties">
 <tbody>
  <tr>
   ...
   <td>メタデータコンテンツ。 {{htmlattrxref("itemprop")}} 属性がある場合は<a href="/ja/docs/Web/HTML/Content_categories#フローコンテンツ">フローコンテンツ</a>および<a href="/ja/docs/Web/HTML/Content_categories#記述コンテンツ">記述コンテンツ</a>。</td>
  </tr>
  <tr>
   <th>許可されている内容</th>
