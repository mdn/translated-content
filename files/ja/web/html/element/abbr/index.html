...
<table class="properties">
 <tbody>
  ...
  <tr>
   ...
   <td><a href="/ja/docs/Web/HTML/Web/Content_categories#記述コンテンツ">記述コンテンツ</a>を受け入れるすべての要素</td>
  </tr>
  <tr>
...
<ul>
 ...
 <li><code>&lt;abbr&gt;</code> は {{HTMLElement("dfn")}} との組み合わせで、略語や頭字語の用語の定義を行なうことができます。以下の<a href="#defining_an_abbreviation">略語の定義</a>の例をご覧ください。</li>
</ul>
