...
<table class="properties">
 <tbody>
  ...
  <tr>
   ...
   <td><a href="/ja/docs/Web/HTML/Content_categories#フローコンテンツ">フローコンテンツ</a> を受け入れるすべての要素。ただし <code>&lt;address&gt;</code> 要素は除く (論理的な対称性の原理によれば、親要素である <code>&lt;address&gt;</code> タグは <code>&lt;address&gt;</code> 要素を入れ子にすることができません。したがって、同じ <code>&lt;address&gt;</code> のコンテンツの親に <code>&lt;address&gt;</code> タグを置くこともできません)。</td>
  </tr>
  <tr>
