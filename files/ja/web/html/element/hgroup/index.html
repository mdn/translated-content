...
<p><code>hgroup</code> が存在すると、見出しグループの小見出し部分について支援技術に報告された情報を削除する可能性があります。</p>
...
<ul>
 ...
 <li><a href="/ja/docs/Web/Guide/HTML/Using_HTML_sections_and_outlines">HTML5 文書のセクションとアウトライン</a></li>
</ul>
