...
[動画プレイヤーのスタイル付けの基本](/ja/docs/Web/Guide/Audio_and_video_delivery/Video_player_styling_basics)は、便利なスタイル付けテクニックをいくつか紹介しています。これは `<video>` の文脈で書かれたものですが、多くは `<audio>` にも同様に適用されます。
...
<audio controls>
  ...
  <p>
    ...
    <a href="myAudio.ogg">OGG</a> の音声をダウンロードしてください。
  </p>
</audio>
```
...
- [ブラウザーに依存しない音声の基本](/ja/docs/Web/Guide/Audio_and_video_delivery/Cross-browser_audio_basics)
