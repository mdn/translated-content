...
<table class="properties">
 <tbody>
  <tr>
   ...
   <td><a href="/ja/docs/Web/HTML/Content_categories#フローコンテンツ">フローコンテンツ</a>、<a href="/ja/docs/HTML/Content_categories#記述コンテンツ">記述コンテンツ</a>、<a href="/ja/docs/HTML/Content_categories#埋め込みコンテンツ">埋め込みコンテンツ</a>。 {{htmlattrxref("controls", "audio")}} 属性を持つ場合は、<a href="/ja/docs/HTML/Content_categories#対話型コンテンツ">対話型コンテンツ</a>と<a href="/ja/docs/HTML/Content_categories#知覚可能コンテンツ">知覚可能コンテンツ</a>。</td>
  </tr>
  <tr>
