---
title: HTML `<meta name="color-scheme">` 属性値
...
指定した場合、配色は `<meta>` 要素の [`content`](/ja/docs/Web/HTML/Reference/Attributes/content) 属性に、 CSS の有効な {{cssxref("color-scheme")}} 値を使用して定義します。
