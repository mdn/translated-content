...
> [!NOTE]
> このようなデータが HTTP の [`GET`](/ja/docs/Web/HTTP/Reference/Methods/GET) を通じて送信されると、コロン文字を URL 引数に含めるために、 `party-date=2024-06-01T08%3A30` のようにエスケープする必要があることもお忘れなく。これを行う方法の一つとして {{jsxref("encodeURI", "encodeURI()")}} を参照してください。
