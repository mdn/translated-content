...
- [`XMLHttpRequest` API の使用](/ja/docs/Web/API/XMLHttpRequest/Using_XMLHttpRequest)
  - : {{domxref("XMLHttpRequest")}} API は、Ajax のコアです。この記事では、次のような Ajax 技術の使用方法について説明します。\* [サーバーのレスポンスの分析と操作](/ja/docs/Web/API/XMLHttpRequest/Using_XMLHttpRequest#handling_responses)
