...
ブラウザーで指定された要素は、[`:hover`](/ja/docs/Web/CSS/:hover) や [`:visited`](/ja/docs/Web/CSS/:visited) などの CSS 擬似クラスを使用して、これらの状態に基づいてスタイルを設定することができます。
...
さらに、[`::part()`](/ja/docs/Web/CSS/::part) 擬似要素に `:state()` 擬似クラスが続くことで、特定の状態にあるカスタム要素の[シャドウパーツ](/ja/docs/Web/CSS/CSS_shadow_parts)と照合することができます。
...
次の CSS は、[`::part()`](/ja/docs/Web/CSS/::part) 擬似要素を使用して `'checkbox'` シャドウパーツと照合する方法を示しています。
