...
> [!NOTE]
> important 宣言はすべてのアニメーションよりも優先されます。 `!important` は[@keyframes アニメーション](/ja/docs/Web/CSS/@keyframes)宣言内では無効です。
