...
- [カスケードオリジンと重要性](/ja/docs/Web/CSS/CSS_cascade/Cascade)
- [値](/ja/docs/Web/CSS/CSS_Values_and_Units/Value_definition_syntax)
...
- [オリジンの種類](/ja/docs/Web/CSS/CSS_cascade/Cascade#origin_types)
  - [ユーザーエージェントオリジン](/ja/docs/Web/CSS/CSS_cascade/Cascade#user-agent_stylesheets)
  - [作者オリジン](/ja/docs/Web/CSS/CSS_cascade/Cascade#author_stylesheets)
  - [ユーザーオリジン](/ja/docs/Web/CSS/CSS_cascade/Cascade#user_stylesheets)
