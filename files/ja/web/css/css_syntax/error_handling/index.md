...
`var()` による代入が無効な場合、宣言は無視されず、プロパティの[初期値](/ja/docs/Web/CSS/CSS_cascade/initial_value)または[継承値](/ja/docs/Web/CSS/CSS_cascade/Inheritance)が代わりに使用されます。プロパティには新しい値が設定されますが、期待した値ではない可能性があります。
