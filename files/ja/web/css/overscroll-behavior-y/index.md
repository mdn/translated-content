...
<p><span class="seoSummary"><strong><code>overscroll-behavior-y</code></strong> は CSS のプロパティで、スクロール領域の垂直方向の境界に達したときのブラウザーの挙動を設定します。</span></p>
...
<p><code>overscroll-behavior-y</code> プロパティは、次の値の一覧のうち一つのキーワードで指定します。</p>
...
<h3 id="Preventing_an_underlying_element_from_scrolling_vertically" name="Preventing_an_underlying_element_from_scrolling_vertically">背後にある要素の縦スクロールの抑止</h3>
...
<p>完全な例と説明については、 {{cssxref("overscroll-behavior")}} を参照してください。</p>
