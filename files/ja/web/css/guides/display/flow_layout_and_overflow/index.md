...
ウェブ上の連続メディアでも、印刷や EPUB などのページメディア形式でも、コンテンツがどのようにあふれるのかを理解することは、どのようなレイアウトメソッドを扱う場合にも役立ちます。通常フローにおけるオーバーフローの仕組みを理解することで、グリッドやフレックスボックスといったレイアウト手法におけるあふれたコンテンツの影響について、より深く理解することができます。
