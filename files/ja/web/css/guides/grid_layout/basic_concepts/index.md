...
次の例は、基本的な線ベースの配置を示しています。アイテムを配置する場合、トラックではなく線を対象とします。これについては、[線に基づく配置を使用したグリッドレイアウト](/ja/docs/Web/CSS/Guides/Grid_layout/Line-based_placement) ガイドで詳しく説明しています。
