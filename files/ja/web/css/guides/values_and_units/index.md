...
- [大ビューポートパーセント単位](/ja/docs/Web/CSS/Reference/Values/length#大ビューポートサイズ) (`lvb`, `lvh`, `lvi`, `lvmax`, `lvmin`, `lvw`)
...
- [小ビューポートパーセント単位](/ja/docs/Web/CSS/Reference/Values/length#小ビューポートサイズ) (`svb`, `svh`, `svi`, `svmax`, `svmin`, `svw`)
