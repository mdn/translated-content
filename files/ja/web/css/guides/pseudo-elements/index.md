...
> [!NOTE]
> このページでは CSS モジュールを紹介しています。CSS の各仕様書で定義されているすべての擬似要素の網羅的な一覧ついては、[擬似要素](/ja/docs/Web/CSS/Reference/Selectors/Pseudo-elements)リファレンスページを参照してください。
...
- {{cssxref(":placeholder-shown")}} セレクター
...
- [擬似要素の一覧](/ja/docs/Web/CSS/Reference/Selectors/Pseudo-elements)
