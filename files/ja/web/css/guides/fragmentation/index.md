...
**CSS 断片化** (CSS fragmentation) モジュールは、コンテンツが[ページ](/ja/docs/Web/CSS/CSS_paged_media)、領域、[段](/ja/docs/Web/CSS/CSS_multicol_layout)をまたがって分割された（断片化された）ときにどのように表示するかを定義します。
