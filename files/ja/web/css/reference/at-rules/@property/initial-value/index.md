...
**`initial-value`** は [CSS](/ja/docs/Web/CSS) の記述子で、構文があらゆる有効なトークンストリームを受け入れない限り {{cssxref("@property")}} [アットルール](/ja/docs/Web/CSS/CSS_syntax/At-rules)を使用する上で必須です。そのプロパティの初期値を設定します。
