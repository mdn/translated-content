...
**`contain-intrinsic-block-size`** は [CSS](/ja/docs/Web/CSS) の[論理プロパティ](/ja/docs/Web/CSS/Guides/Logical_properties_and_values)で、要素が[サイズ拘束](/ja/docs/Web/CSS/Guides/Containment/Using#サイズ拘束)の対象となっている場合に、ブラウザーがレイアウトに使用することができる要素のブロックサイズを定義します。
