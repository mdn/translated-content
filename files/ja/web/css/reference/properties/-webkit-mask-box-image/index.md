...
- [初期値](/ja/docs/Web/CSS/CSS_cascade/Value_processing#initial_value): `none`
- 適用対象: すべての要素
- [継承](/ja/docs/Web/CSS/CSS_cascade/Inheritance): いいえ
- [計算値](/ja/docs/Web/CSS/CSS_cascade/Value_processing#computed_value): 指定どおり
