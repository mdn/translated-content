...
**`:muted`** は [CSS](/ja/docs/Web/CSS) の[擬似クラス](/ja/docs/Web/CSS/Pseudo-classes)セレクターで、 {{htmlelement("audio")}} や {{htmlelement("video")}} のような音を発する可能性がある要素であるが、ミュート（強制的に音を消した）状態にある要素を表します。
