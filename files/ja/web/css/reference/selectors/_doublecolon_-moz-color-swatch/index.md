...
**`::-moz-color-swatch`** は [CSS](/ja/docs/Web/CSS) の[擬似要素](/ja/docs/Web/CSS/Pseudo-elements)であり、 [Mozilla 拡張](/ja/docs/Web/CSS/Reference/Mozilla_extensions)で、 {{HTMLElement("input")}} の `type="color"` で選択された色を表します。
