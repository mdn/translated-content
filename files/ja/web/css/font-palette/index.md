...
- `<palette-identifier>`
  - : [@font-palette-values](/ja/docs/Web/CSS/@font-palette-values) アットルールを使用して、フォントパレットに自分自身で値を指定できるようにします。この値は [&lt;dashed-ident&gt;](/ja/docs/Web/CSS/dashed-ident) 形式を使用して指定します。
