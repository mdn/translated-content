...
[ダッシュ 2 本 (`--`) を使用して](/ja/docs/Web/CSS/Reference/Properties/--*)定義されたカスタムプロパティは、[カスケード](/ja/docs/Web/CSS/CSS_cascade/Cascade)の対象となり、親から値を継承します。
...
ルールセットに指定されたセレクター（例えば、上記の例では [`<section>`](/ja/docs/Web/HTML/Reference/Elements/section) 要素）は、カスタムプロパティを使用できるスコープを定義します。
