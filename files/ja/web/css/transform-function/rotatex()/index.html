...
<p><strong><code>rotateX()</code></strong> は <a href="/ja/docs/Web/CSS">CSS</a> 関数で、要素の形を変化させずに横座標 (水平軸) の周りを回転させる変形を定義します。結果は {{cssxref("&lt;transform-function&gt;")}} データ型になります。</p>
...
<div class="note">
<p><strong>メモ:</strong> <code>rotateX(a)</code> は <code><a href="/ja/docs/Web/CSS/transform-function/rotate3d">rotate3d</a>(1, 0, 0, a)</code> と等価です。</p>
</div>
...
<p><code>rotateX()</code> で生成される回転の量は、 {{cssxref("&lt;angle&gt;")}} で指定します。正の数であれば、移動は時計回りです。負の数であれば、反時計回りになります。</p>

<pre class="syntaxbox">rotateX(<var>a</var>)
</pre>
...
<table class="standard-table">
 ...
 <tbody>
  <tr>
   <td colspan="2">この変形は三次元空間に適用され、平面で表すことはできません。</td>
