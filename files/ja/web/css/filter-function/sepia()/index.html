...
<p><strong><code>sepia()</code></strong> は <a href="/ja/docs/Web/CSS">CSS</a> の関数で、入力画像をセピア色に、より暖かい、より黄色と茶色の表現に変換します。結果は {{cssxref("&lt;filter-function&gt;")}} です。</p>
...
<pre class="syntaxbox notranslate">sepia(<var>amount</var>)</pre>

<h3 id="Parameters" name="Parameters">引数</h3>

<dl>
 <dt><code><var>amount</var></code></dt>
 <dd>変換の度合いで、 {{cssxref("&lt;number&gt;")}} 又は {{cssxref("&lt;percentage&gt;")}} で指定します。 <code>100%</code> の値では完全にセピア色になり、 <code>0%</code> の値では入力が変更されないままになります。 <code>0%</code> と <code>100%</code> の間の値は、効果の割合です。補間時の欠損値は <code>0</code> です。</dd>
</dl>

<h2 id="Examples" name="Examples">例</h2>

<pre class="brush: css notranslate">sepia(0)     /* 効果なし */
sepia(.65)   /* 65% セピア色 */
sepia(100%)  /* 完全にセピア色 */</pre>
