...
- `expression`
  - : この式は [boolean()](/ja/docs/Web/XML/XPath/Functions/boolean) 関数の引数として渡された場合とまったく同じように評価されます。
...
- この関数は [boolean()](/ja/docs/Web/XML/XPath/Functions/boolean) 関数と同様のふるまいをしますが、返される値はその逆です。
