...
XPath 式の使用に関するより詳しい情報は、 [XSLT による XML の変換](/ja/docs/Web/XML/XSLT/Transforming_XML_with_XSLT)の記事の最後の[さらなる読み物](/ja/docs/Web/XML/XSLT/Transforming_XML_with_XSLT#さらなる読み物)の節を参照してください。また、[XPath 仕様書の 'axes' の節](https://www.w3.org/TR/xpath-30/#axes)も参照してください。
