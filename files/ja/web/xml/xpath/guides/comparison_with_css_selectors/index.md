...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`ancestor`](/ja/docs/Web/XML/XPath/Reference/Axes#ancestor), [`parent`](/ja/docs/Web/XML/XPath/Reference/Axes#parent), [`preceding-sibling`](/ja/docs/Web/XML/XPath/Reference/Axes#preceding-sibling) 軸 | {{CSSxRef(":has",":has()")}} セレクター                                                                                                                                |
