...
- [`math:max()`](/ja/docs/Web/XML/EXSLT/Reference/math/max)
- [`math:min()`](/ja/docs/Web/XML/EXSLT/Reference/math/min)
...
<section id="Quick_links">
  <ol>
    ...
    <li class="toggle">
      <details open>
        <summary><a href="/ja/docs/Web/XML/EXSLT/Reference/exsl">共通 (exsl)</a></summary>
        {{ListSubpagesForSidebar("/ja/docs/Web/XML/EXSLT/exsl", "", "", "exsl:", ")")}}
      </details>
    </li>
    <li class="toggle">
      <details open>
        <summary><a href="/ja/docs/Web/XML/EXSLT/Reference/math">Math (math)</a></summary>
