...
当初 [RFC 2324](https://www.rfc-editor.org/info/rfc2324) でエイプリルフールのジョークとして定義されたこのステータスコードは、ジョークとして広く普及したため [RFC 9110](https://www.rfc-editor.org/info/rfc9110/) において広くジョークとして採用されたことを理由に正式に予約されたため、当分の間、ジョーク以外の意味を割り当てることはできません。
