...
> [!NOTE]
> この値は、ブラウザーがレスポンスに対して [MIME スニッフィング](/ja/docs/Web/HTTP/MIME_types#mime_スニッフィング)（またはコンテンツスニッフィング）を行う場合に無視されることがあります。
...
- `<media-type>`
  ...
  - : リソースやデータの [MIME タイプ](/ja/docs/Web/HTTP/MIME_types)です。
    以下の引数を付けることができます。
