...
> **Note:** **メモ:** 言語タグは、使用される[言語コード](https://en.wikipedia.org/wiki/Language_code)の [ISO 639](https://en.wikipedia.org/wiki/ISO_639) 規格 ([ISO 639-1 のコードリスト](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)であることが多い) に依存する、[RFC 5646](https://tools.ietf.org/html/rfc5646) でフォーマットが定義されています。
