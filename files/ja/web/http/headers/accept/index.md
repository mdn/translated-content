...
| {{Glossary("CORS-safelisted request header", "CORS セーフリストリクエストヘッダー")}} | はい、ただし、値に _CORS-unsafe リクエストヘッダーバイト_、 0x00-0x1F (0x09 (HT) を除く)、`"():<>?@[\]{}`、0x7F (DEL) を含むことができないという追加の制限があります。 |
