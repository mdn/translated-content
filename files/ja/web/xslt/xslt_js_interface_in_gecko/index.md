...
4. [パラメータの設定](/ja/docs/The_XSLT_JavaScript_Interface_in_Gecko/Setting_Parameters)
5. [高度な例](/ja/docs/The_XSLT_JavaScript_Interface_in_Gecko/Advanced_Example)
6. [インターフェースリスト](/ja/docs/The_XSLT_JavaScript_Interface_in_Gecko/Interface_List)
7. [リソース](/ja/docs/Web/XSLT/Transforming_XML_with_XSLT/Resources)
