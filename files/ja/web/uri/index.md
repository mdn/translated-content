...
URI は、HTML の `<a>` リンクの [`href`](/ja/docs/Web/HTML/Element/a#href) など、他の場所で使用された場合、リソースを取得する以外の動作、例えばメールクライアントを開いたり、テキストメッセージを送信したり、 JavaScript を実行したりといった動作を起動するために使用することもできます。
