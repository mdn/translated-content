...
<table class="standard-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>
          高性能でロイヤリティフリーの画像形式であるため、画像とアニメーションの両方に適しています。 PNG や JPEG よりもはるかに優れた圧縮を提供し、より高い色深度、アニメーションフレーム、透明度などに対応しています。 AVIF を使用する場合は、よりブラウザーの対応状況が良い形式への代替を含める（つまり、 <code><a href="/ja/docs/Web/HTML/Reference/Elements/picture">&#x3C;picture></a></code> 要素を使用する）べきであることに注意してください。<br>
