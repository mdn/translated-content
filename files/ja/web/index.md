...
- [ウェブ開発者ガイド](/ja/docs/MDN/Guides)
  - : ウェブ開発者ガイドでは、目標やニーズに合ったウェブ技術を使用するのに役立つ、実践的な手引きのコンテンツを提供しています。
- [ウェブ開発者向けチュートリアル](/ja/docs/MDN/Tutorials)
...
- [CSS](/ja/docs/Web/CSS)
  - : カスケードスタイルシート (CSS) は、ウェブの文書やアプリの外観を記述するために使用されます。
...
- [イベント](/ja/docs/conflicting/Web/API/Document_Object_Model/Events_c282731eb05539912e604c2db2986790a254812531e62f190bb83745f45dbb03)
...
- [URI](/ja/docs/Web/URI)
  - : 統一リソース識別子は、アドレスバーを介してブラウザー自体を含むさまざまな技術によって、さまざまな方法でリソースを識別するために使用されます。
...
- [OpenSearch](/ja/docs/Web/XML/Guides/OpenSearch)
  - : OpenSearch を使用すると、ウェブサイトはそれ自体の検索エンジンを記述することができるため、ブラウザーやその他のクライアントアプリケーションがその検索エンジンを使用することができます。
- [XML](/ja/docs/Web/XML)
  - : 拡張可能なマークアップ言語で、[ドキュメントオブジェクトモデル](/ja/docs/Web/API/Document_Object_Model)の厳格なシリアライズです。
