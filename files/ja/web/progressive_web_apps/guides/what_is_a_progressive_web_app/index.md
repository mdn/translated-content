...
マニフェストでは、PWA の外見に関するその他の多くの側面を定義することができます。例えば[テーマ色](/ja/docs/Web/Progressive_web_apps/Manifest/Reference/theme_color)や[背景色](/ja/docs/Web/Progressive_web_apps/Manifest/Reference/background_color)、他のアプリからのデータの[共有対象として機能](/ja/docs/Web/Progressive_web_apps/Manifest/Reference/share_target)する機能や、[特定のファイル形式を処理](/ja/docs/Web/Manifest/file_handlers)する機能などです。
