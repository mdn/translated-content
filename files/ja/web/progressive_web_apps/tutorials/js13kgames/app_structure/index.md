...
このアーキテクチャにより、ウェブサイトはすべての PWA 機能を最大限に活用できます — つまり、アプリシェルをキャッシュし、パフォーマンスを大幅に向上させるように動的コンテンツを管理します。 基本的なシェルに加えて、[ホーム画面への追加](/ja/docs/Web/Progressive_web_apps/Guides/Making_PWAs_installable)や[プッシュ通知](/ja/docs/Web/API/Push_API)などの他の機能を追加でき、ユーザーのブラウザーでサポートされていない場合でも、アプリは正常に動作することがわかっているので安全です — これがプログレッシブエンハンスメントの美しさです。
