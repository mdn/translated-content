...
> [!NOTE]
> [ガイドライン 3.1: 読みやすさ: テキストコンテンツを読みやすく理解しやすいものにする](https://www.w3.org/TR/WCAG21/#readable)（英語）に関する WCAG の説明も参照してください。
...
> [!NOTE]
> [ガイドライン 3.2: 予測可能: ウェブページを予測可能な方法で表示して操作させる](https://www.w3.org/TR/WCAG21/#predictable)（英語）に関する WCAG の説明も参照してください。
...
> [!NOTE]
> [ガイドライン 3.3: 入力支援: ユーザーが間違いを避けて修正できるようにする](https://www.w3.org/TR/WCAG21/#input-assistance)（英語）に関する WCAG の説明も参照してください。
