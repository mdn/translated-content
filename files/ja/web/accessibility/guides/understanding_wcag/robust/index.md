...
original_slug: Web/Accessibility/Understanding_WCAG/Robust
---
...
> [!NOTE]
> [ガイドライン 4.1: 互換性: 支援技術を含む現在および将来のユーザーエージェントとの互換性を最大化する](https://www.w3.org/TR/WCAG21/#compatible)（英語）に関する WCAG の説明も参照してください。
