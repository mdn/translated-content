...
> **警告:** `aria-owns` は [現在全ての最新ブラウザでサポート](https://a11ysupport.io/tech/aria/aria-owns_attribute) されていますが、`aria-owns` は iOS 17.3 および macOS 14.3 より前の iOS および macOS で VoiceOver を使用しているユーザーには公開されない可能性があります。
