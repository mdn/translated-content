...
[combobox](/ja/docs/Web/Accessibility/ARIA/Roles/combobox_role) 要素には、ポップアップとして機能する要素を参照する `aria-controls` の値が設定されています。ポップアップが表示されている場合にのみ `aria-controls` を設定する必要がありますが、表示されていない要素を参照することも有効であり、プログラムが簡単になります。
