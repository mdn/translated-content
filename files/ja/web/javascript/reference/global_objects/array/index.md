...
また、 [`structuredClone()`](/ja/docs/Web/API/structuredClone) メソッドを使用して深い複製を作成することもできます。これは、ソース内の{{Glossary("transferable objects", "移譲可能オブジェクト")}}を、複製するのではなく、新しい複製に移譲できる利点があります。
