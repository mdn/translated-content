...
<p>これは<a href="#dynamic_imports">動的インポート</a>にも対応しています。</p>
...
<p><a href="#dynamic_imports">動的インポート</a>を使用してデフォルトのエクスポートをインポートする場合、動作が少し異なります。返されたオブジェクトから "default" キーを破棄して名前を変更する必要があります。</p>
