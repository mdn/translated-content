...
<table class="standard-table">
 ...
 <tbody>
  ...
  <tr>
   <td><code>\d</code></td>
   <td>
    <p>あらゆる（アラビア）数字にマッチします。<code>[0-9]</code> に相当します。例えば <code>/\d/</code> や <code>/[0-9]/</code> は "B2 is the suite number" の "2" にマッチします。</p>
   </td>
  </tr>
  <tr>
   <td><code>\D</code></td>
   <td>
    <p>あらゆる（アラビア）数字以外の文字にマッチします。<code>[^0-9]</code> に相当します。例えば <code>/\D/</code> や <code>/[^0-9]/</code> は "B2 is the suite number" の "B" にマッチします。</p>
   </td>
  </tr>
  <tr>
   <td><code>\w</code></td>
  ...
  <tr>
   <td><code>\W</code></td>
   <td>
    <p>前述以外の文字にマッチします。<code>[^A-Za-z0-9_]</code> に相当します。例えば <code>/\W/</code> や <code>/[^A-Za-z0-9_]/</code> は、"50%" の "%" にマッチします。</p>
   </td>
  </tr>
  <tr>
   <td><code>\s</code></td>
   <td>
    <p>スペース、タブ、改ページ、改行を含むホワイトスペース文字にマッチします。<code>[ \f\n\r\t\v​\u00a0\u1680​\u180e\u2000​-\u200a​\u2028\u2029\u202f\u205f​\u3000\ufeff]</code> に相当します。例えば <code>/\s\w*/</code> は <code>"foo bar"</code> の <code>" bar"</code> にマッチします。</p>
   </td>
  </tr>
  <tr>
   <td><code>\S</code></td>
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     ...
     <li>特殊文字の前に付けられた場合、次の文字が特別なものでなく、文字通りに評価されることを表します。例えば、<code>"*"</code> は、先行文字の 0 回以上の出現が一致する必要があることを意味する特殊文字です。例えば、<code>/a*/</code> は 0 回以上の <code>"a"</code> とマッチします。文字通りの <code>*</code> にマッチさせるには、その直前にバックスラッシュを入れます。例えば、<code>/a\*/</code> は <code>"a*"</code> とマッチします。</li>
    </ul>
