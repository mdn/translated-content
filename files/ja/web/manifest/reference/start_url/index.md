...
original_slug: Web/Manifest/start_url
---
...
`start_url` メンバーは文字列で、_ウェブアプリケーションの開始 URL_ を表します。 — ユーザーがウェブアプリケーションを起動したとき (例えば、ユーザーが端末のアプリケーションメニューやホーム画面でウェブアプリケーションのアイコンをタップしたときなど) に読み込まれるべき推奨 URL です。
