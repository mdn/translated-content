...
[SVG 座標変換のドキュメントにおける具体例](/ja/docs/Web/SVG/Attribute/transform#general_transformation)を参照してください。このプロパティに関する詳細情報は、[SVG 勧告](https://www.w3.org/TR/SVG/coords.html#TransformMatrixDefined)で得ることができます。
