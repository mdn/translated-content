...
<p><strong><code>&lt;line&gt;</code></strong> 要素は SVG の基本図形であり、2つの点をつなぐ直線を作成するために使用します。</p>
...
<table class="standard-table">
 ...
 <tbody>
  <tr>
   ...
   <td>{{Spec2('SVG2')}}</td>
   <td>x1、y1、x2、y2 属性に{{cssxref("&lt;length&gt;")}}、{{cssxref("&lt;percentage&gt;")}}、{{cssxref("&lt;number&gt;")}}を指定できるように変更</td>
  </tr>
  <tr>
...
<ul>
 <li>その他の SVG 基本図形: {{ SVGElement('circle') }}, {{ SVGElement('ellipse') }}, {{ SVGElement('polygon') }}, <strong>{{ SVGElement('polyline') }}</strong>, {{ SVGElement('rect') }}</li>
</ul>
