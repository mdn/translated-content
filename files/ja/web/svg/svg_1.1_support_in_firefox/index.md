...
---
SVG の構文と使い方の基本的な例は、 [W3C SVG test suite](https://www.w3.org/Graphics/SVG/Test/20061213/) にあります。

> **Note:** **注:** Gecko 2.0 より、Gecko は SMIL を用いた SVG アニメーションに対応しています。簡単な概要については[SMIL を用いた SVG アニメーション](/ja/docs/Web/SVG/SVG_animation_with_SMIL)を参照してください。 SVG の完全なドキュメントは近日公開予定です。いつの日か。

[SVG 2 の変更についての Mozilla の対応](/ja/docs/Web/SVG/SVG_2_support_in_Mozilla)の解説もあります。

## 要素の実装状況

[SVG 1.1](https://www.w3.org/TR/SVG11/) の要素とネイティブサポートの状況の概略です。
...
<table class="standard-table" style="border-collapse: separate">
  <tbody>
    ...
    <tr style="color: black; background-color: lightgreen">
      ...
      <td>
        <ul>
          <li>実装済み。</li>
          <li>
            DOM 属性 <code>currentScale</code> と
            <code>currentTranslate</code>
            は実装されていますが、パンとズームのユーザーインターフェイスはありません。
          </li>
          <li>
            SVGSVGElement
            <ul>
              <li>
                未実装の属性: contentScriptType, contentStyleType, viewport,
                currentView
              </li>
              <li>
                未実装のバインディング: getIntersectionList, getEnclosureList,
    ...
    <tr style="color: black; background-color: lightgreen">
      ...
      <td>
        <ul>
          <li>実装済み。</li>
          <li>
            <code>title</code> は SVG
            オブジェクト上でマウスを静止させるとツールチップとして表示されます。
          </li>
        </ul>
      </td>
    </tr>
    ...
    <tr style="color: black; background-color: lightgreen">
      ...
      <td>
        <ul>
          <li>実装済み。</li>
          <li>
            &#x3C;svg:use> カスケーディング規則に完全に従っていない
            ({{Bug(265894)}})。
          </li>
          <li>
            SVGElementInstance ツリーにイベントを伝えない
            ({{Bug(265895)}})。
          </li>
        </ul>
      </td>
    ...
    <tr>
      <th colspan="2" style="text-align: center">
        <a href="https://www.w3.org/TR/SVG11/struct.html#conditional-mod"
          >Conditional Processing モジュール</a
        >
      </th>
    </tr>
    <tr style="color: black; background-color: lightgreen">
    ...
    <tr style="color: black; background-color: lightgreen">
      ...
      <td>
        <ul>
          <li>実装済み。</li>
          <li>
            SVGPathElement インターフェイス
            <ul>
              <li>
                未実装の属性: normalizedPathSegList,
    ...
    <tr>
      <th colspan="2" style="text-align: center">
        <a href="https://www.w3.org/TR/SVG11/text.html#text-mod"
          >Text モジュール</a
        >
      </th>
    </tr>
    ...
    <tr style="color: black; background-color: salmon">
      ...
      <td>
        <ul>
          <li>
            この機能は、仕様書の早期の草稿にありましたが、のちに削除されたので実装されていません
            ({{Bug(273171)}})。
          </li>
        </ul>
      </td>
    ...
    <tr style="color: black; background-color: khaki">
      ...
      <td>
        <ul>
          <li>
            tspan として実装。 Gecko 2.0 ではフォント機能なし
            ({{Bug(456286)}}, {{Bug(571808)}})。
          </li>
        </ul>
      </td>
    </tr>
    ...
    <tr style="color: black; background-color: lightgreen">
      ...
      <td>
        <ul>
          <li>実装済み。</li>
          <li>
            擬似画像入力は <code>SourceGraphic</code> と
            <code>SourceAlpha</code> のみ実装。
          </li>
          <li>
            未実装の擬似画像入力かフィルター要素を使うとそのフィルターは無視され、参照された画像はフィルター無しで表示されます。
          </li>
        </ul>
      </td>
    </tr>
    ...
    <tr style="color: black; background-color: lightgreen">
      ...
      <td>
        <ul>
          <li>実装済み</li>
          <li>
            文書フラグメント ({{bug(455986)}}) は &#x3C;svg:feImage>
            では対応していません。
          </li>
        </ul>
      </td>
    ...
    <tr style="color: black; background-color: lightgreen">
      ...
      <td>
        <ul>
          <li>
            <code>xlink:href</code>, <code>xlink:show</code>,
            <code>xlink:target</code>,
            <code>xlink:title</code> 属性のみ実装済み。
          </li>
        </ul>
      </td>
    </tr>
