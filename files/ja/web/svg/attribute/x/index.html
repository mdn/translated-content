...
---
<p>« <a href="/ja/docs/Web/SVG/Attribute" title="en/SVG/Attribute">SVG属性リファレンス ホームへ</a></p>
<p>この属性はユーザー座標のx軸座標を指定します。この属性の正確な影響は各要素の座標に依存します。ほとんどの場合、この属性参照している要素の左上を原点とした長方形のx軸座標を示します（例外については個々の要素のドキュメントを参照してください）。</p>
...
<h2 id="要素">要素</h2>
<p>次の要素は <code>x</code> 属性を使用することができます。</p>
<ul>
 <li><a href="/ja/SVG/Element#FilterPrimitive" title="en/SVG/Element#FilterPrimitive">Filter primitive elements</a> »</li>
