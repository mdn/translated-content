...
攻撃者がこれを行うことができれば、メインドメインから設定された[クッキー](/ja/docs/Web/HTTP/Guides/Cookies)を読み取ったり、[クロスサイトスクリプティング](/ja/docs/Web/Security/Types_of_attacks#クロスサイトスクリプティング_xss)を行ったり、[コンテンツセキュリティポリシー](/ja/docs/Web/HTTP/Guides/CSP)を回避したりすることが可能となり、保護された情報（ログインを含む）を取得したり、不審なユーザーに悪意のあるコンテンツを送信したりすることが可能となります。
