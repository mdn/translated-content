...
| ガイド                                                                                                                    | 影響 | 難易度 | 必須   | 説明                                                                                                                                                                                                                                                          |
| ------------------------------------------------------------------------------------------------------------------------- | ---- | ------ | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [TLS 設定](/ja/docs/Web/Security/Practical_implementation_guides/TLS#tls_configuration)                                   | 中   | 中     | はい   | ユーザーベースに最適な最も安全な[トランスポート層セキュリティ](/ja/docs/Glossary/TLS) (TLS) 設定を使用しましょう。                                                                                                                                      |
...
| [クリックジャッキング防止](/ja/docs/Web/Security/Attacks/Clickjacking)                                                    | 高   | 低     | はい   | [クリックジャッキング](/ja/docs/Web/Security/Attacks/Clickjacking)を防止するために、サイトが {{htmlelement("iframe")}} 内にどのように組み込まれるかを制御します。                                                                                             |
| [CSRF 防止](/ja/docs/Web/Security/Attacks/CSRF)                                                                           | 高   | 不明   | 様々   | `SameSite` クッキーと anti-CSRF トークンを使用して、[クロスサイトリクエストフォージェリー](/ja/docs/Glossary/CSRF) (CSRF) を防止します。                                                                                                                      |
...
| [リファラーポリシーの設定](/ja/docs/Web/Security/Practical_implementation_guides/Referrer_policy)                         | 低   | 低     | はい   | ユーザーのプライバシーを向上させ、 {{httpheader("Referer")}} ヘッダー経由の社内 URL の漏洩を防止します。                                                                                                                                                      |
