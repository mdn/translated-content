...
> [!NOTE]
> Google Chrome では、プライバシーサンドボックスの機能の一部が非推奨となり、プライバシーサンドボックスコンソールへの新規組織の登録が一時停止されました。プライバシーサンドボックスの機能の中には、登録が必要なものがいくつかあります。詳細については、[登録](#登録)の節をご覧ください。
...
Google は、プライバシーサンドボックスの一部の機能を非推奨とし、プライバシーサンドボックスコンソールへの新しいウェブサイトや組織の登録を一時停止しました。
...
- [帰属レポート API](/ja/docs/Web/API/Attribution_Reporting_API) {{deprecated_inline}}
- 保護オーディエンス API {{deprecated_inline}}
- プライベートアグリゲーション API {{deprecated_inline}}
- [共有ストレージ API](/ja/docs/Web/API/Shared_Storage_API) {{deprecated_inline}}
- [トピック API](/ja/docs/Web/API/Topics_API) {{deprecated_inline}}

各機能のドキュメントには、登録が完了しなかった場合に具体的にどのサブ機能がどのように動作しなくなるかについて、より詳細な情報が記載されています。
