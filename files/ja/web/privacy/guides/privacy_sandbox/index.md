...
- [独立したパーティション化された状態を持つクッキー (CHIPS)](/ja/docs/Web/Privacy/Guides/Privacy_sandbox/Partitioned_cookies)
  - : **パーティション化されたクッキー**とも呼ばれる CHIPS は、開発者がクッキーをパーティション化されたストレージに格納できるようにするもので、最上位サイトごとに個別のクッキーストアが用意されます。
