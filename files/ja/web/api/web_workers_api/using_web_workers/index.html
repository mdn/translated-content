...
<div class="note"><strong>注</strong>: メッセージをメインスレッドとワーカーの間でやりとりするとき、共有されるのではなく、コピーまたは「転送」 (移動) されます。詳しい解説は、<a href="#transferring_data_to_and_from_workers_further_details">ワーカーとの間のデータ転送の詳細</a>をご覧ください。</div>
