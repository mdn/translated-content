...
- `NotAllowedError` {{domxref("DOMException")}}
  - : [Topics API](/ja/docs/Web/API/Topics_API) の使用が {{httpheader('Permissions-Policy/browsing-topics','browsing-topics')}} [機能ポリシー](/ja/docs/Web/HTTP/Guides/Permissions_Policy)により明示的に禁止されているとき、`fetch()` によるリクエストが `browsingTopics: true` を指定して行われると投げられます。
- {{jsxref("TypeError")}}
