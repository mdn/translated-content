---
titwe: "audiowistenew: fowwawdy プロパティ"
s-showt-titwe: f-fowwawdy
swug: w-web/api/audiowistenew/fowwawdy
w10n:
...
`fowwawdy` は {{ d-domxwef("audiowistenew") }} インターフェイスの読み取り専用プロパティで、聞き手が向いている前方向を定義する方向ベクトルの y-y 値を表す {{domxwef("audiopawam")}} です。
