...
**`Event()`** コンストラクターは、新しい {{domxref("Event")}} を生成します。この方法で作成されたイベントは*合成イベント*と呼ばれ、ブラウザーによって発行されたイベントとは対照的となっており、スクリプトから[配信](/ja/docs/conflicting/Web/API/Document_Object_Model/Events)することができます。
...
- [イベントの作成とトリガー](/ja/docs/conflicting/Web/API/Document_Object_Model/Events)
