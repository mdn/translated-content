...
l10n:
  sourceCommit: 5885c6c72de0970c0eb264d02808658465bf1cee
---
...
| 技術                                                                                                       | 説明                                                                                                                                                                                                                             |
| ---------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Cookie](/ja/docs/Web/HTTP/Cookies)                                                                        | HTTP クッキーは、ウェブサーバーとブラウザーが互いに送信する小さなデータで、ページナビゲーションをまたいで状態情報を記憶します。                                                                                                  |
...
なお、 [Chrome チームの調査](https://web.dev/persistent-storage/)によると、データがブラウザーによって削除されることはとても稀であることを示しています。ユーザーがウェブサイトを定期的に訪問している場合、ベストエフォートモードであっても、格納されるデータがブラウザーによって取得される可能性はとても低いのです。
...
- [ウェブのストレージ (web.dev)](https://web.dev/storage-for-the-web/)
- [永続的ストレージ (web.dev)](https://web.dev/persistent-storage/)
