...
サイトデータが格納されるストレージ標準で定義されているストレージシステムは、通常、{{Glossary("origin")}} ごとに 1 つの _バケット_ で構成されます。
...
- [web.dev のウェブ向けのストレージ](https://web.dev/articles/storage-for-the-web)
- [web.dev の永続ストレージ](https://web.dev/articles/persistent-storage)
- [Chrome の Web ストレージとクォータの概念](https://docs.google.com/document/d/19QemRTdIxYaJ4gkHYf2WWBNPbpuZQDNMpUVf8dQxj4U/edit)
