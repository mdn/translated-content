...
> **メモ:** {{domxref("ConstantSourceNode.ConstantSourceNode", "ConstantSourceNode()")}} コンストラクターは {{domxref("ConstantSourceNode")}} を作成するための推奨される方法です。 [AudioNode の作成](/ja/docs/Web/API/AudioNode#audionode_の生成)を参照してください。
