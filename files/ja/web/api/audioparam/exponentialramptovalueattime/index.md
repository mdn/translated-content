...
> **メモ:** 指数関数的な変化は、周波数や再生レートを変化させる場合、直線的な変化よりも有益であると考えられています。これは、人間の耳の動作に起因しています。
...
> **メモ:** 最後の関数で降下する値には、 0 ではなく 0.01 が使用されました。 0 を使用すると、 _invalid or illegal string_ エラーが発生するためです。
