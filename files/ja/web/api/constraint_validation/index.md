...
> **Note:**: Firefox は、多くのバージョンで `x-moz-errormessage` という独自のエラー属性に対応しており、同様の方法で独自のエラーメッセージを設定することができました。これはバージョン 66 で削除されました ([バグ 1513890](https://bugzilla.mozilla.org/show_bug.cgi?id=1513890) 参照)。
