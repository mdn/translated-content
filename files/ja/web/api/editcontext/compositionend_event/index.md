---
title: "EditContext: compositionend イベント"
...
{{domxref("EditContext")}} インターフェイスの `compositionend` イベントは、{{glossary("Input Method Editor", "インプットメソッドエディター")}} (IME) ウィンドウを用いた変換が終了する時発火します。
