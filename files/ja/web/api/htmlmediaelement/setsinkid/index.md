...
- `NotAllowedError` {{domxref("DOMException")}}
  - : [`speaker-selection`](/ja/docs/Web/HTTP/Headers/Permissions-Policy/speaker-selection) [権限ポリシー](/ja/docs/Web/HTTP/Guides/Permissions_Policy)が音声出力の使用をブロックするために使用された場合に返されます。
...
- アクセスが [`speaker-selection`](/ja/docs/Web/HTTP/Headers/Permissions-Policy/speaker-selection) HTTP [権限ポリシー](/ja/docs/Web/HTTP/Guides/Permissions_Policy)で制限されることがあります。
