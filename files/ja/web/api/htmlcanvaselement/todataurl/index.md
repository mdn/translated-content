...
**`HTMLCanvasElement.toDataURL()`** メソッドは、 `type` 引数で指定された形式で画像を表現したものが入った [data URL](/ja/docs/Web/URI/Reference/Schemes/data) を返します。
...
要求された [data URL](/ja/docs/Web/URI/Reference/Schemes/data) の入った文字列です。
...
- [data URL](/ja/docs/Web/URI/Reference/Schemes/data)（[HTTP](/ja/docs/Web/HTTP) リファレンス）
