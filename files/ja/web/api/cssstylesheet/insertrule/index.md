...
- rule
  - : 挿入される規則が入った {{domxref("DOMString")}} です。どのような規則を挿入するかは、種類に依存します。\* **[規則セット](/ja/docs/Web/CSS/Syntax#CSS_statements)**の場合、[セレクター](/ja/docs/Web/Guide/CSS/Getting_Started/Selectors)とスタイル定義です。
