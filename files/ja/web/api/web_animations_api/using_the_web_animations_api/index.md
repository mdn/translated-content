...
<ul><li class="post__title"><a href="http://codepen.io/collection/bpEza/">Codepen の不思議の国のアリス</a> を使い、フォーク・シェアしてください。</li><li class="post__title"><a href="https://hacks.mozilla.org/2016/08/animating-like-you-just-dont-care-with-element-animate/">Element.animate を気にしないようにアニメーションする方法</a>：Web Animations API の作られた背景・他のアニメーション手法よりパフォーマンスが優れている理由を説明した秀逸な記事です。</li><li class="post__title"><a href="https://github.com/web-animations/web-animations-js">web-animations-js</a> ： Web Animations API の polyfill です。</li></ul>
