...
[![Alice Tumbling down the rabbit's hole.](/en-US/docs/web/api/web_animations_api/using_the_web_animations_api/tumbling-alice_optimized.gif)](http://codepen.io/rachelnabors/pen/rxpmJL)
...
[![Playing the growing and shrinking game with Alice.](/en-US/docs/web/api/web_animations_api/using_the_web_animations_api/growing-shrinking_article_optimized.gif)](http://codepen.io/rachelnabors/pen/PNYGZQ?editors=0010)
...
[![Alice and the Red Queen race to get to the next square in this game.](/en-US/docs/web/api/web_animations_api/using_the_web_animations_api/red-queen-race_optimized.gif)](http://codepen.io/rachelnabors/pen/PNGGaV)
