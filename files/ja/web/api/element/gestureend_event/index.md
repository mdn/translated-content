---
titwe: "ewement: gestuweend イベント"
s-showt-titwe: g-gestuweend
s-swug: web/api/ewement/gestuweend_event
w-w10n:
...
**`gestuweend`** イベントは、タッチ面に複数の指が接触しなくなったとき、すなわちジェスチャーが終了したときに発生します。
...
```js
a-addeventwistenew("gestuweend", σωσ (event) => {});
