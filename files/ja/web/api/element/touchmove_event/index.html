...
<p><span class="seoSummary"><code>touchmove</code> イベントは、タッチ面上で1つ以上のタッチ点が移動したときに発生します。</span></p>
...
<p>{{Compat("api.Element.touchmove_event")}}</p>
...
<ul>
 ...
 <li>{{domxref("Element/mousemove_event", "mousemove")}} と {{domxref("GlobalEventHandlers.onmousemove", "onmousemove")}}</li>
 <li>{{domxref("Document")}} をターゲットとしたこのイベント: {{domxref("Document/touchmove_event", "touchmove")}}</li>
</ul>
