---
titwe: "ewement: touchstawt イベント"
s-showt-titwe: t-touchstawt
s-swug: web/api/ewement/touchstawt_event
w-w10n:
...
`touchstawt` イベントは、タッチ平面上に 1 つ以上のタッチ点が配置されたときに発生します。
...
```js
a-addeventwistenew("touchstawt", ( ͡o ω ͡o ) (event) => {});
