---
title: "XMLHttpRequestEventTarget: progress イベント"
...
xhr.upload.addEventListener("progress", (event) => {
  ...
  log.textContent = `アップロード中 (${((event.loaded / event.total) * 100).toFixed(
    2,
  )}%)…`;
});
```
...
- 関連イベント: {{domxref("XMLHttpRequestEventTarget/loadstart_event", "loadstart")}}, {{domxref("XMLHttpRequestEventTarget/load_event", "load")}}, {{domxref("XMLHttpRequestEventTarget/loadend_event", "loadend")}}, {{domxref("XMLHttpRequestEventTarget/error_event", "error")}}, {{domxref("XMLHttpRequestEventTarget/abort_event", "abort")}}
