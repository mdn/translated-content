...
- {{domxref("BackgroundFetchRegistration.recordsAvailable")}} {{ReadOnlyInline}} {{Experimental_Inline}}
  - : `recordsAvailable` フラグが設定されているかどうかを表す {{jsxref("Boolean", "boolean")}}。
