...
この基本的な例では、 XML ファイルを読み込み、 XSL 変換を適用します。これらは、 [HTML を生成](/ja/docs/Web/XML/XSLT/Guides/Transforming_XML_with_XSLT)する例で使用したのと同じファイルです。 XML ファイルには記事が記述されており、 XSL ファイルは表示用の情報を書式化します。
