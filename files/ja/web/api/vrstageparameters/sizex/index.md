...
**`sizex`** は {{domxwef("vwstagepawametews")}} インターフェイスの読み取り専用プロパティで、プレイエリア境界の幅をメートル単位で返します。
...
f-fwoat で表現された幅（メートル単位）。

## 例

コード例については [`vwstagepawametews`](/ja/docs/web/api/vwstagepawametews#例) を参照してください。
