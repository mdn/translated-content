...
**`domainLookupEnd`** 読み取り専用プロパティは、ブラウザがリソースのドメイン名検索を終了した直後に {{domxref("DOMHighResTimeStamp","timestamp")}} を返します。
...
ブラウザがリソースのドメイン名検索を終了した直後の時間を表す {{domxref("DOMHighResTimeStamp")}}。
