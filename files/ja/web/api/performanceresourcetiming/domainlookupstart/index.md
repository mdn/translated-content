...
**`domainLookupStart`** 読み取り専用プロパティは、ブラウザがリソースのドメイン名検索を開始する直前に {{domxref("DOMHighResTimeStamp","timestamp")}} を返します。
...
ブラウザがリソースのドメイン名検索を開始する直前の {{domxref("DOMHighResTimeStamp")}}。
