...
<div>
 <p>{{domxref("IDBFactory")}}インターフェイスの<code>cmp()</code>メソッドは、2つのキーが等価か決定するために比較し、そして、IndexedDBで保存や統合のような操作を命令します。</p>
</div>
<div class="note">
...
<h3 id="例外">例外</h3>
<p>このメソッドでは、次の型のような{{domxref("DOMError")}} を持つ {{domxref("DOMException")}}が発生するかもしれません。</p>
<table class="standard-table">
 <thead>
  <tr>
   <th scope="col">属性</th>
