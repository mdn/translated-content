...
**`ariaValueMin`** は {{domxref("ElementInternals")}} インターフェイスのプロパティで、範囲ウィジェットの最小許容値を定義する [`aria-valuemin`](/ja/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-valuemax) 属性の値を反映します。
