...
**`ariaValueMax`** は {{domxref("ElementInternals")}} インターフェイスのプロパティで、範囲ウィジェットの最大許容値を定義する [`aria-valuemax`](/ja/docs/Web/Accessibility/ARIA/Attributes/aria-valuemax) 属性の値を反映します。
