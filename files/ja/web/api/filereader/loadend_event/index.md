...
<p><code>loadend</code> イベントは、ファイル読み込みが、成功したかどうかにかかわらず完了したときに発生します。</p>
...
<ul>
 <li>関連イベント: {{domxref("FileReader.load_event", "load")}}, {{domxref("FileReader.loadend_event", "loadend")}}, {{domxref("FileReader.progress_event", "progress")}}, {{domxref("FileReader.error_event", "error")}}, {{domxref("FileReader.abort_event", "abort")}}</li>
</ul>
