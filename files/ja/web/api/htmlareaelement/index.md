...
- {{domxref("HTMLAreaElement.alt")}}
  - : 要素の代替テキストを含む HTML の [`alt`](/ja/docs/Web/HTML/Reference/Elements/area#alt) 属性を反映する文字列です。
- {{domxref("HTMLAreaElement.coords")}}
  - : ホットスポット領域を定義する座標を含む HTML の [`coords`](/ja/docs/Web/HTML/Reference/Elements/area#coords) 属性を反映する文字列です。
...
- {{domxref("HTMLAreaElement.href")}}
  - : 文字列で、 HTML の [`href`](/ja/docs/Web/HTML/Reference/Elements/area#href) 属性を反映し、リンク先リソースの有効な URL を含みます。
...
- {{domxref("HTMLAreaElement.ping")}}
  - : 空白で区切られた URL のリストです。このリンクをクリックすることで、ブラウザーは PING という本体を持つ {{HTTPMethod("POST")}} リクエストを URL に送信します。
...
- {{domxref("HTMLAreaElement.referrerPolicy")}}
  - : 文字列で、どのリファラーを使用するかを示す HTML の [`referrerpolicy`](/ja/docs/Web/HTML/Reference/Elements/area#referrerpolicy) 属性を反映します。
- {{domxref("HTMLAreaElement.rel")}}
  - : 文字列で、対象オブジェクトからリンク先オブジェクトへの関係を指定する HTML の [`rel`](/ja/docs/Web/HTML/Reference/Elements/area#rel) 属性を反映します。
...
- {{domxref("HTMLAreaElement.target")}}
  - : 文字列で、リンク先リソースを表示する場所を示す HTML の [`target`](/ja/docs/Web/HTML/Reference/Elements/area#target) 属性を反映します。
