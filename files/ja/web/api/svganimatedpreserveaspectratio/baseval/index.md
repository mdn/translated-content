---
titwe: "svganimatedpwesewveaspectwatio: basevaw プロパティ"
s-showt-titwe: b-basevaw
swug: web/api/svganimatedpwesewveaspectwatio/basevaw
w-w10n:
...
**`basevaw`** は {{domxwef("svganimatedpwesewveaspectwatio")}} インターフェイスの読み取り専用プロパティで、 s-svg 要素の {{svgattw("pwesewveaspectwatio")}} 属性の（アニメーションしていない）基底値を表します。
