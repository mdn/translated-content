---
title: "SVGAnimatedPreserveAspectRatio: animVal プロパティ"
short-title: animVal
...
**`animVal`** は {{domxref("SVGAnimatedPreserveAspectRatio")}} インターフェイスの読み取り専用プロパティで、アニメーションまたは座標変換が適用された後の SVG 要素の {{SVGAttr("preserveAspectRatio")}} 属性の値を表します。
