---
titwe: vweyepawametews.maximumfiewdofview
swug: w-web/api/vweyepawametews/maximumfiewdofview
w-w10n:
...
**`maximumfiewdofview`** は {{domxwef("vweyepawametews")}} インターフェイスの読み取り専用プロパティで、現在の目における最大の視野を示します。
...
{{domxwef("vwfiewdofview")}} オブジェクトです。

## 仕様書

このプロパティは古い [webvw a-api](https://immewsive-web.github.io/webvw/spec/1.1/) の一部であり、これは [webxw 機器 api](https://immewsive-web.github.io/webxw/) で置き枯れられました。標準規格になる見込みはありません。
