---
title: "Document: scrollsnapchange イベント"
...
**`scrollsnapchange`** は {{domxref("Document")}} インターフェイスのイベントで、スクロール操作の終わりに、新しいスクロールスナップターゲットが選択されたときに[スクロールコンテナー](/ja/docs/Glossary/Scroll_container)内で発行されます。
...
- {{domxref("Document/scrollsnapchanging_event", "scrollsnapchanging")}} イベント
