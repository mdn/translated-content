---
title: "Document: scrollsnapchanging イベント"
...
**`scrollsnapchanging`** は {{domxref("Document")}} インターフェイスのイベントで、新しいスクロールスナップターゲットが待機中であるとブラウザーが判断した場合に、すなわち現在のスクロールジェスチャーが終わったときに選択される場合に、[スクロールコンテナー](/ja/docs/Glossary/Scroll_container)内で発行されます。
...
- {{domxref("Document/scrollsnapchange_event", "scrollsnapchange")}} イベント
