...
- {{domxref("IDBTransaction.objectStore()")}}
  ...
  - : Returns an {{domxref("IDBObjectStore")}} object representing an&#x20;

    <span class="internalDFN">object store</span>

    &#x20;that is part of the&#x20;

    <span class="internalDFN">scope</span>

    &#x20;of this&#x20;

    <span class="internalDFN">transaction</span>
