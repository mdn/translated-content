---
title: "SpeechSynthesisUtterance: end イベント"
short-title: end
...
**`end`** は [ウェブ音声 API](/ja/docs/Web/API/Web_Speech_API) の {{domxref("SpeechSynthesisUtterance")}} オブジェクトのイベントで、発生が終了したときに発生します。
...
`end` イベントを [`addEventListener`](/ja/docs/Web/API/EventTarget/addEventListener) メソッドで使用することができます。
