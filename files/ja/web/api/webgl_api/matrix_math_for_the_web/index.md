...
![行列による平行移動の例](/en-US/docs/web/api/webgl_api/matrix_math_for_the_web/matrix-translation.jpg)
...
![行列による拡大縮小の例](/en-US/docs/web/api/webgl_api/matrix_math_for_the_web/matrix-scale.jpg)
...
![](/en-US/docs/web/api/webgl_api/matrix_math_for_the_web/matrix-rotation.jpg)
...
![行列合成の例](/en-US/docs/web/api/webgl_api/matrix_math_for_the_web/matrix-composition.jpg)
