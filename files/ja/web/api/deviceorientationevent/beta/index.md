---
title: "DeviceOrientationEvent: beta プロパティ"
short-title: beta
...
**`beta`** は {{domxref("DeviceOrientationEvent")}} インターフェイスの読み取り専用プロパティで、 X 軸における端末の回転を返します。つまり、 -180 度から 180 度の範囲で、端末が前方または後方に傾いている度数を返します。
