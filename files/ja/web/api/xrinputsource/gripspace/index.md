...
**左手のグリップ空間の座標系。**![グリップ空間が、世界に対するプレーヤーの手のローカル座標系をどのように示しているかを示す図。](/en-US/docs/web/api/xrinputsource/gripspace/GripSpace-LeftHand-Light.svg)**右手のグリップ空間の座標系。**![グリップ空間が、世界に対するプレーヤーの手のローカル座標系をどのように示しているかを示す図。](/en-US/docs/web/api/xrinputsource/gripspace/GripSpace-RightHand-Light.svg)
