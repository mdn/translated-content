...
<p>{{domxref("ExtendableMessageEvent")}} インターフェイスの <strong><code>data</code></strong> 読み取り専用プロパティは、イベントのデータを返します。 任意のデータ型を使用できます。</p>

<h2 id="Syntax" name="Syntax">構文</h2>

<pre class="syntaxbox notranslate">var <em>myData</em> = <em>extendableMessageEvent</em>.data;</pre>
...
<table class="standard-table">
 <tbody>
  ...
  <tr>
   <td>{{SpecName('Service Workers', '#dom-extendablemessageevent-data', 'ExtendableMessageEvent.data')}}</td>
