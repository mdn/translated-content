...
| 値                          | 型           | 説明                                                                                                                                                                             |
| --------------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| {{Glossary("null")}}        | null         | キーワード [`null`](/ja/docs/Web/JavaScript/Guide/Data_structures#null_型) — 値が存在しないことを示します。                                                                      |
| {{Glossary("undefined")}}   | undefined    | [undefined](/ja/docs/Web/JavaScript/Guide/Data_structures#undefined_型) — プリミティブ値。                                                                                       |
...
| `0`                         | 数値型       | [数値](/ja/docs/Web/JavaScript/Guide/Data_structures#数値型)ゼロ （従って、 `0.0` や `0x0` なども含みます）。                                                                    |
| `-0`                        | 数値型       | [数値](/ja/docs/Web/JavaScript/Guide/Data_structures#数値型)マイナスゼロ（従って、 `-0.0` や `-0x0` 等も含みます）。                                                             |
| `0n`                        | 長整数型     | [長整数型](/ja/docs/Web/JavaScript/Guide/Data_structures#長整数型)のゼロ（従って、 `0x0n` も含みます）。なお、長整数型にはマイナスゼロはありません。 `0n` の負の数は `0n` です。 |
