...
> [!NOTE]
> 上記のブロックレイアウトの動作は、包含ブロックの書字方向 ([`writing-mode`](/ja/docs/Web/CSS/Reference/Properties/writing-mode)) が[既定値](/ja/docs/Web/CSS/Reference/Properties/writing-mode#formal_definition)と異なる場合には変わります。
