...
> [!NOTE]
> 関数に名前があっても、変数を使用してその関数を呼び出すことができます。名前を付けるとコードをデバッグするときに役立ちますが、_呼び出し方法に影響はありません_。
...
> [!NOTE]
> 関数を返す関数、あるいは他の関数を引数として取る関数は、高階関数と呼ばれます。

## 関連情報

- [第一級関数](https://ja.wikipedia.org/wiki/第一級関数) - ウィキペディア
- 関連用語:
