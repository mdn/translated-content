...
{{Glossary("viewport", "ビューポート")}}がリサイズされると、初期の[包含ブロック](/ja/docs/Web/CSS/CSS_display/Containing_block)もリサイズされ、[ビューポート単位](/ja/docs/Web/CSS/Reference/Values/length#ビューポートに基づく相対的な長さの単位)の計算されたサイズに影響を与えます。
