---
title: MDN 製品諮問委員会
slug: orphaned/MDN/MDN_Product_Advisory_Board
original_slug: MDN/MDN_Product_Advisory_Board
l10n:
  sourceCommit: 00749a844d76e4847ffd7d37955174abb8b411a5
---
...
- **Laura Morinigo**
  ...
  - : Laura はソフトウェア開発者、提唱者、指導者です。知識を共有し、世界中のさまざまな技術コミュニティとつながることに情熱を注いでいます。その貢献により、彼女は Google Developer Expert と Woman Techmakers Ambassador として認められています。指導者として、 Google Launchpad や国連の World Food Programme などのアクセラレータープログラムに参加するスタートアップを手伝いました。現在は、サムスンインターネットのウェブ開発者を支援する活動をしています。ウェブ標準に貢献し、先進的なウェブ機能を広め、ウェブ開発者がよりインクルーシブで優れたウェブアプリケーションを作成するのを手伝っています。
- **Sheila Moussavi**
  Principal, Bocoup
  - : Sheila は [Bocoup](https://bocoup.com/about) の代表で、 HTML と CSS のようなウェブ標準と [Scratch](https://www.scratchfoundation.org/) のようなノーコードプログラミングツールの作業をしているチームを率いています。シーラは、 W3C における Bocoup のウェブ標準戦略を監督しており、ウェブ標準においてより公平な空間を開発し、標準化プロセスとウェブ開発者教育をより強く結びつけることに情熱を注いでいます。技術分野でのキャリアを通じて（前職は健康公平と障碍正義）、彼女は効果的で正義志向の組織と作業空間の育成に注力してきました。
- **Robert Nyman**
