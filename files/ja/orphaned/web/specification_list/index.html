...
---
<p>Open Webの基盤は幾つもの仕様書によって定義されています。このページではそれらの仕様書をリストしています。</p>

<p>The Open Web Platform is defined in numerous specifications. This page lists these specifications, as well as links to MDN's documentation (including both tutorials and reference content), and links to status documentation about how complete our documentation project is in that topic.</p>
...
<table class="standard-table">
 ...
 <tbody>
  <tr>
   <td><a class="external" href="http://www.whatwg.org/specs/web-apps/current-work/">HTML</a> (one page)<br>
    {{ SpecName("HTML WHATWG") }}<br>
     </td>
   ...
   <td>
    <ul>
     ...
     <li><a href="/en-US/docs/HTML/Using_the_application_cache" title="/en-US/docs/HTML/Using_the_application_cache">Using the application cache</a></li>
     <li>Drag and Drop</li>
     <li>Using scoped stylesheet</li>
     <li><a href="https://developer.mozilla.org/en-US/docs/DOM/Manipulating_the_browser_history" title="https://developer.mozilla.org/en-US/docs/DOM/Manipulating_the_browser_history">Using the History API</a></li>
     <li><a href="/en-US/docs/Online_and_offline_events" title="/en-US/docs/Online_and_offline_events">Online and offline events</a></li>
     <li><a href="/en-US/docs/Web/Guide/DOM/The_structured_clone_algorithm" title="/en-US/docs/Web/Guide/DOM/The_structured_clone_algorithm">The structured clone algorithm</a></li>
     <li><a href="/en-US/docs/Web/Guide/HTML/Using_data_attributes" title="/en-US/docs/Web/Guide/HTML/Using_data_attributes">Using data attributes</a></li>
    </ul>
   </td>
   <td>
    <p>The <a href="/en-US/docs/HTML/Element" title="/en-US/docs/HTML/Element">HTML Elements</a>.<br>
     ...
     {{event("afterprint")}} {{event("beforeprint")}} {{event("beforeunload")}} {{event("hashchange")}} {{event("message")}} {{event("offline")}} {{event("online")}} {{event("pagehide")}} {{event("pageshow")}} {{event("popstate")}} {{event("resize")}} {{event("storage")}} {{event("unload")}}<br>
  ...
  <tr>
   <td>{{SpecName("HTML5 Web Messaging")}} (also in WHATWG HTML)</td>
   <td>{{Spec2("HTML5 Web Messaging")}}</td>
   <td> </td>
   <td> </td>
   <td>{{domxref("MessageEvent")}} {{domxref("Window.postMessage")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/HTML_API">HTML API</a></td>
  </tr>
  <tr>
   <td>{{SpecName("ES5.1")}}<br>
    {{SpecName("ES6")}}<br>
    {{SpecName("ES Int 1.0")}}</td>
   <td>{{Spec2('ES5.1')}}<br>
    {{Spec2('ES6')}}<br>
    {{Spec2('ES Int 1.0')}}</td>
   <td> </td>
   <td> </td>
   <td><a href="/en-US/docs/Web/JavaScript/Reference">JavaScript reference</a></td>
  ...
  <tr>
   ...
   <td> </td>
   <td>{{ domxref("Attr") }} {{ domxref("CharacterData") }} {{ domxref("ChildNode") }} {{ domxref("Comment") }} {{ domxref("CustomEvent") }} {{ domxref("Document")}} {{ domxref("DocumentFragment") }} {{ domxref("DocumentType") }} {{ domxref("DOMError") }} {{ domxref("DOMImplementation") }} {{ domxref("DOMSettableTokenList") }} {{ domxref("DOMTokenList") }} {{ domxref("Element")}} {{ domxref("Event")}} {{ domxref("EventTarget")}} {{ domxref("Promise")}} {{ domxref("PromiseResolver")}} {{ domxref("HTMLCollection") }} {{ domxref("MutationObserver")}} {{ domxref("MutationRecord")}} {{ domxref("Node") }} {{ domxref("NodeFilter") }} {{ domxref("NodeIterator") }} {{ domxref("NodeList") }} {{ domxref("ParentNode")}} {{ domxref("ProcessingInstruction") }} {{ domxref("Text") }} {{ domxref("TimeRanges") }} {{ domxref("Treewalker") }} {{ domxref("XMLDocument")}} {{ domxref("Range") }}</td>
  ...
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td>{{domxref("UIEvent")}} {{domxref("FocusEvent")}} {{domxref("MouseEvent")}} {{domxref("WheelEvent")}} {{domxref("KeyboardEvent")}} {{domxref("CompositionEvent")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/DOM">DOM</a></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td>{{domxref("DOMPointReadOnly")}} {{domxref("DOMPoint")}} {{domxref("DOMRect")}} {{domxref("DOMRectReadOnly")}} {{domxref("DOMRectList")}} {{domxref("DOMQuad")}} {{domxref("DOMMatrixReadOnly")}} {{domxref("DOMMatrix")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/DOM">DOM</a></td>
  </tr>
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td>{{domxref("DOMParser")}} {{domxref("XMLSerializer")}} {{domxref("Element.innerHTML")}} {{domxref("Element.outerHTML")}} {{domxref("Element.insertAdjacentHTML")}} {{domxref("Text.serializeAsCDATA")}} {{domxref("Range.createContextualFragment")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/DOM">DOM</a></td>
  </tr>
  <tr>
   ...
   <td> </td>
   <td><a href="/en-US/docs/Web/Guide/Performance/Using_web_workers" title="/en-US/docs/Web/Guide/Performance/Using_web_workers">Using web workers</a></td>
   ...
   <td><a href="/en-US/docs/MDN/Doc_status/API/WebWorkers">WebWorkers</a></td>
  </tr>
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td>{{domxref("ElementTraversal")}} {{domxref("Element")}} (new inheritance)</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/DOM">DOM</a></td>
  </tr>
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td>{{domxref("File")}} {{domxref("Blob")}} {{domxref("FileList")}} {{domxref("FileReader")}} {{domxref("FileReaderSync")}} {{domxref("URL.createObjectURL")}} {{domxref("URL.revokeObjectURL")}}</td>
  ...
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td>{{event("addtrack")}} (event) {{domxref("AudioStreamTrack")}} {{domxref("BlobEvent")}} {{event("ended (MediaStream)")}} (event) {{event("ended (MediaStreamTrack)")}} (event) {{domxref("MediaStream")}} {{domxref("MediaStreamConstraints")}} {{domxref("MediaStreamTrack")}} {{domxref("MediaStreamTrackEvent")}} {{domxref("MediaStreamTrackList")}} {{domxref("MediaTrackConstraints")}} {{event("muted")}} (event) {{domxref("NavigatorUserMedia")}} {{domxref("NavigatorUserMediaError")}} {{event("overconstrained")}} (event) {{event("removetrack")}} (event) {{event("started")}} (event) {{event("unmuted")}} (event) {{domxref("URL")}} {{domxref("VideoStreamTrack")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/WebRTC">WebRTC</a></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><a href="/en-US/docs/MDN/Doc_status/API/Device_API">Device API</a></td>
  </tr>
  <tr>
   ...
   <td> </td>
   <td>{{domxref("Navigator.battery")}} {{domxref("BatteryManager")}} {{event("chargingchange")}} (event) {{event("chargingtimechange")}} (event) {{event("dischargingtimechange")}} (event) {{event("levelchange")}} (event)</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/Device_API">Device API</a></td>
  </tr>
  <tr>
   ...
   <td>{{domxref("NavigatorGeolocation")}} {{domxref("Geolocation")}} {{domxref("Navigator")}} (implements <code>NavigatorGeolocation</code>) {{domxref("Position")}} {{domxref("PositionOptions")}} {{domxref("Coordinates")}} {{domxref("PositionError")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/Device_API">Device API</a></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td> </td>
   <td><a href="/en-US/docs/WebAPI/Using_Web_Notifications" title="/en-US/docs/WebAPI/Using_Web_Notifications">Using Web notifications</a></td>
  ...
  <tr>
   ...
   <td> </td>
   <td><a href="/en-US/docs/WebAPI/Using_Light_Events" title="/en-US/docs/WebAPI/Using_Light_Events">Using light events</a></td>
  ...
  <tr>
   ...
   <td><a href="/en-US/docs/Web/API/Proximity_Events">Proximity Events</a></td>
   <td> </td>
  ...
  <tr>
   ...
   <td> </td>
   <td><a href="/en-US/docs/Web/Guide/Using_FormData_Objects" title="/en-US/docs/Web/Guide/Using_FormData_Objects">Using FormData objects</a></td>
  ...
  <tr>
   ...
   <td>{{domxref("WebSocket")}} {{event("open")}} (event) {{event("message")}} (event) {{event("error")}} (event) {{event("close")}} (event) {{domxref("CloseEvent")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/WebSockets">WebSockets</a></td>
  </tr>
  <tr>
   <td>{{SpecName("Page Visibility API")}}</td>
   <td>{{Spec2("Page Visibility API")}}</td>
   <td> </td>
   <td><a href="/en-US/docs/DOM/Using_the_Page_Visibility_API" title="/en-US/docs/DOM/Using_the_Page_Visibility_API">Using the Page Visibility API</a></td>
  ...
  <tr>
   ...
   <td> </td>
   <td><a href="/en-US/docs/WebAPI/Network_Information" title="/en-US/docs/WebAPI/Network_Information">Network Information</a></td>
   <td>{{domxref("NetworkInformation")}} {{domxref("Connection")}} {{domxref("Navigator")}} (implements <code>NetworkInformation</code>) {{event("change")}} (event)</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/Device_API">Device API</a></td>
  </tr>
  <tr>
   ...
   <td> </td>
   <td><a href="/en-US/docs/Web/Guide/DOM/Storage" title="/en-US/docs/Web/Guide/DOM/Storage">DOM Storage Guide</a></td>
   <td>{{domxref("Storage")}} {{domxref("WindowSessionStorage")}} {{domxref("WindowLocalStorage")}} {{event("storage")}} {{domxref("StorageEvent")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/WebStorage">WebStorage</a></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td>{{cssxref(":scope")}} {{domxref("Document.find()")}} {{domxref("Document.findAll()")}} {{domxref("DocumentFragment.find()")}} {{domxref("DocumentFragment.findAll()")}}<br>
    {{domxref("Element.find()")}} {{domxref("Element.findAll()")}} {{domxref("Element.matches()")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/DOM">DOM</a></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>{{domxref("Int8Array")}} {{domxref("Int16Array")}} {{domxref("Int32Array")}} {{domxref("Uint8Array")}} {{domxref("Uint16Array")}} {{domxref("Uint32Array")}} {{domxref("Uint8ClampedArray")}} {{domxref("Float32Array")}} {{domxref("Float64Array")}}, {{domxref("ArrayBuffer")}}, {{domxref("ArrayBufferView")}}, {{domxref("TypedArray")}}, {{domxref("DataView")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/JavaScript">JavaScript</a></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><a href="/en-US/docs/Navigation_timing" title="/en-US/docs/Navigation_timing">Navigation Timing API</a></td>
   <td><a href="/en-US/docs/Navigation_timing/Using_Navigation_Timing" title="/en-US/docs/Navigation_timing/Using_Navigation_Timing">Navigation Timing</a></td>
  ...
  <tr>
   ...
   <td>{{Spec2("WebVTT")}}</td>
   <td><a href="/en-US/docs/HTML/WebVTT" title="/en-US/docs/HTML/WebVTT">WebVTT</a></td>
   <td> </td>
  ...
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td>{{domxref("document.register()")}} {{cssxref(":unresolved")}} {{domxref("document.createElement()")}}  (new optional argument) {{domxref("document.createElementNS()")}} (new optional argument)</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/WebComponents">Web Components</a></td>
  </tr>
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td><em>Still in flux (lists what looks stable enough).</em><br>
    {{HTMLElement("shadow")}} {{domxref("ShadowRoot")}} {{domxref("HTMLShadowElement")}} {{HTMLElement("content")}} {{domxref("HTMLContentElement")}} {{domxref("Element.createShadowRoot()")}} {{domxref("Element.shadowRoot")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/WebComponents">Web Components</a></td>
  </tr>
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td>{{HTMLElement("template")}} {{domxref("HTMLTemplateElement")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/WebComponents">Web Components</a></td>
  </tr>
  <tr>
   ...
   <td> </td>
   <td><a href="/en-US/docs/Web/Guide/Touch_events" title="/en-US/docs/Web/Guide/Touch_events">Touch Events</a></td>
   <td>{{domxref("Touch")}} {{domxref("TouchList")}} {{domxref("TouchEvent")}} {{event("touchstart")}} (event) {{event("touchend")}} (event) {{event("touchmove")}} (event) {{event("touchcancel")}} (event) {{domxref("Document.createTouch()")}} {{domxref("Document.createTouchList()")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/DOM">DOM</a></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td>{{domxref("Selection")}} {{domxref("Document.getSelection()")}} {{domxref("Window.getSelection()")}} {{domxref("EditingBeforeInputEvent")}} {{domxref("EditingInputEvent")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/HTML_API">HTML API</a></td>
  </tr>
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td>{{domxref("Key")}} {{domxref("CryptoOperation")}} {{event("abort")}} (event) {{event("error")}} (event) {{event("progress")}} (event) {{event("complete")}} (event) {{domxref("KeyOperation")}} {{domxref("Crypto")}} {{domxref("SubtleCrypto")}} {{domxref("Window.crypto")}} {{domxref("WorkerCrypto")}} {{domxref("WorkerGlobalScope.crypto")}} {{domxref("KeyPair")}}</td>
  ...
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td>{{domxref("UndoManager")}} {{domxref("Element.undoScope")}} {{domxref("Element.undoManager")}} {{domxref("DOMTransaction")}} {{domxref("DOMTransactionEvent")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/DOM">DOM</a></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td>{{domxref("URL")}} {{domxref("URLUtils")}} (no interface object) {{domxref("URLUtilsReadOnly")}} (no interface object) {{domxref("URLQuery")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/DOM">DOM</a></td>
  </tr>
  <tr>
   <td>{{SpecName("Encoding")}}</td>
   <td>{{Spec2("Encoding")}}</td>
   <td><a href="/en-US/docs/WebAPI/Encoding_API" title="/en-US/docs/WebAPI/Encoding_API">Encoding API</a></td>
   <td> </td>
   <td>{{domxref("TextDecoder")}} {{domxref("TextEncoder")}}</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/DOM">DOM</a></td>
  </tr>
  <tr>
   ...
   <td> </td>
   <td> </td>
   <td>{{domxref("ClipboardEvent")}} {{event("cut")}} (event) {{event("copy")}} (event) {{event("paste")}} (event)</td>
   <td><a href="/en-US/docs/MDN/Doc_status/API/DOM">DOM</a></td>
  </tr>
  <tr>
