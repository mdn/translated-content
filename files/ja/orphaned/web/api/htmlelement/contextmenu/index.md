...
**`HTMLElement.contextMenu`** プロパティは、[`contextmenu`](/ja/docs/Web/HTML/Element/menu) 属性を使用して要素に割り当てられたコンテキストメニューを参照します。 メニュー自体は、{{HTMLElement("menu")}} 要素を使用して作成されます。
...
- [`contextmenu`](/ja/docs/Web/HTML/Element/menu)
- {{HTMLElement("menu")}}
