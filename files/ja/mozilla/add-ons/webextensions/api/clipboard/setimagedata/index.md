...
この API は Chrome の [`clipboard.setImageData()`](https://developer.chrome.com/docs/apps/reference/clipboard?hl=ja) API をベースにしていますが、いくつかの違いがあります。
...
> [!NOTE]
> この API は Chromium の [`chrome.clipboard`](https://developer.chrome.com/docs/apps/reference/clipboard?hl=ja) API をベースにしています。
