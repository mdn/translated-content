...
- CSS ペインのルールビューで、[CSS 変数名](/ja/docs/Web/CSS/Guides/Cascading_variables/Using_custom_properties) の自動補完が可能になりました ([Firefox バグ 1422635](https://bugzil.la/1422635))。プロパティの値に `var(` と入力してダッシュ (`-`) を押下すると、CSS で宣言した変数を自動補完のリストに表示します。
