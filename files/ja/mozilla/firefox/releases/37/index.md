...
- 非標準の `String.prototype.quote()` メソッドを削除しました ([Firefox バグ 1103181](https://bugzil.la/1103181))。
...
- ES6 Proxy の `enumerate` トラップを実装しました ([Firefox バグ 783829](https://bugzil.la/783829))。
