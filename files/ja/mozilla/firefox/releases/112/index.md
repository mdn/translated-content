...
- [指数関数](/ja/docs/Web/CSS/Reference/Values/Functions#exponential_functions) をデフォルトで有効にしました。
...
- `linear()` [イージング関数](/ja/docs/Web/CSS/Reference/Values/easing-function) をサポートしました。
