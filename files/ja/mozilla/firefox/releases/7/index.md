...
> **Note:** **注:** Firefox 7 では、従来のメジャーリリースと同様に、バイナリコンポーネントをコンパイルし直す必要があります。詳しくは [バイナリインタフェース](/ja/docs/Developer_Guide/Interface_Compatibility#Binary_Interfaces "Developer_Guide/Interface_Compatibility#Binary_Interfaces") をご覧ください。
