...
- CSS {{cssxref("@import")}} [アットルール](/ja/docs/Web/CSS/CSS_syntax/At-rules) の `supports()` で `supports-conditions` をデフォルトで有効にしました。この機能で、指定した機能がユーザーのブラウザーでサポートされている場合に限り、スタイルシートをインポートできます ([Firefox bug 1830779](https://bugzil.la/1830779))。
