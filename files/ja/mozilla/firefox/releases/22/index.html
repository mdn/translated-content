...
<ul>
 <li><code>nsITreeView</code> のメソッド <codensITreeView.getCellProperties</code>、<code>nsITreeView.getColumnProperties</code> および <code>nsITreeView.getRowProperties</code> から、引数 <code>properties</code> を削除しました。これらのメソッドは空白で区切られたプロパティ名の文字列を返すようになります。({{bug('407956')}})</li>
 <li><code>inIDOMUtils.getCSSPropertyNames</code> メソッドを実装しました。これはサポートしているすべての <a href="/ja/docs/CSS/CSS_Reference" title="CSS/CSS_Reference">CSS プロパティ</a>名を返します。</li>
