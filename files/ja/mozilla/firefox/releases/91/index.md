...
- [Gamepad API](/ja/docs/Web/API/Gamepad_API) が [安全なコンテキスト](/ja/docs/Web/Security/Secure_Contexts) を要求するようになりました ([Firefox バグ 1704005](https://bugzil.la/1704005))。
