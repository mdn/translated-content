...
- [XHTML の中での SVG についての導入](/ja/docs/SVG_In_HTML_Introduction)
...
- [Canvas での画像の描き方](/ja/docs/Drawing_Graphics_with_Canvas)
  - : 新しい `<canvas>` タグについて、Firefox においてどのようにグラフやその他のオブジェクトを描くかについて学習します。
- [CSS3 Columns](/ja/docs/CSS3_Columns)
  - : CSS3 に提案されている自動マルチカラムテキストレイアウトの新規サポートについて学習します。
- [Firefox 1.5 のキャッシュを利用する](/ja/docs/Using_Firefox_1.5_caching)
  - : `bfcache` と、進む・戻る機能をどのように高速化したかについて学習します。

### XUL と拡張機能開発者向け

- [拡張機能の作成方法](/ja/docs/Building_an_Extension)
...
- Hypertext Markup Language ([HTML](/ja/docs/HTML))、 Extensible Hypertext Markup Language ([XHTML](/ja/docs/XHTML)): [HTML 4.01](http://www.w3.org/TR/html401/) と [XHTML 1.0/1.1](http://www.w3.org/TR/xhtml1/)
- Cascading Style Sheets ([CSS](/ja/docs/CSS)): [CSS Level 1](http://www.w3.org/TR/REC-CSS1), [CSS Level 2](http://www.w3.org/TR/REC-CSS2) と [CSS Level 3](http://www.w3.org/Style/CSS/current-work.html) の一部
- Document Object Model ([DOM](/ja/docs/DOM)): [DOM Level 1](http://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/), [DOM Level 2](http://www.w3.org/DOM/DOMTR#dom2) と [DOM Level 3](http://www.w3.org/DOM/DOMTR#dom3) の一部
- Mathematical Markup Language: [MathML Version 2.0](http://www.w3.org/Math/)
- Extensible Markup Language ([XML](/ja/docs/XML)): [XML 1.0](http://www.w3.org/TR/REC-xml), [XML 名前空間](http://www.w3.org/TR/REC-xml-names/), [XML 文書へのスタイルシートの関連付け 1.0](http://www.w3.org/TR/xml-stylesheet/), [XML のフラグメント同定](http://lists.w3.org/Archives/Public/www-xml-linking-comments/2001AprJun/att-0074/01-NOTE-FIXptr-20010425.htm)
- XSL 変換 ([XSLT](/ja/docs/XSLT)): [XSLT 1.0](http://www.w3.org/TR/xslt)
- XML Path Language ([XPath](/ja/docs/XPath)): [XPath 1.0](http://www.w3.org/TR/xpath)
- Resource Description Framework ([RDF](/ja/docs/RDF)): [RDF](http://www.w3.org/RDF/)
- Simple Object Access Protocol (SOAP): [SOAP 1.1](http://www.w3.org/TR/SOAP/)
- [ECMA-262](/ja/docs/ECMA-262), revision 3 に基づく [JavaScript](/ja/docs/JavaScript) 1.6: [ECMA-262](http://www.ecma-international.org/publications/standards/Ecma-262.htm)
...
2004 年 11 月 9 日の最初のリリース以降、さまざまな変更が Firefox へ導入されています。Firefox は多くの新機能とバグ修正により前進してきました。変更点の詳しい一覧は [squarefree.com](http://www.squarefree.com/burningedge/releases/1.5-comprehensive.html) にあります。
