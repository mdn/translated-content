...
- {{cssxref("@scope")}} の内部の [`&` セレクター](/ja/docs/Web/CSS/Nesting_selector) が、[スコープ開始セレクターの詳細度](/ja/docs/Web/CSS/@scope#scope_の詳細度 /ja/docs/Web/CSS/@scope#specificity_in_scope) を継承しないようになりました。
