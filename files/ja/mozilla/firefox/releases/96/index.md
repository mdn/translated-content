...
- [CSS の色の値](/ja/docs/Web/CSS/Reference/Values/color_value) として使用する [`hwb()`](/ja/docs/Web/CSS/Reference/Values/color_value/hwb) 関数を実装しました。`hwb()` 関数表記は、色相・白さ・黒さで表現した色を表します。省略可能なアルファ値は、色の透明度を表します ([Firefox バグ 1352755](https://bugzil.la/1352755))。
