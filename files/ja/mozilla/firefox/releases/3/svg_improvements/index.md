...
- `foreignObject` 要素のサポート ({{ Bug(326966) }}、[仕様](https://www.w3.org/TR/SVG11/extend.html#ForeignObjectElement)、[参考](https://robert.ocallahan.org/2006/06/future-is-now_20.html)
