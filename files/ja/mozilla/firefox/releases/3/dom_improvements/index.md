...
- Internet Explorer の [`oncut`](/ja/docs/Web/API/Element/cut_event)、[`oncopy`](/ja/docs/Web/API/Element/copy_event)、 [`onpaste`](/ja/docs/Web/API/Element/paste_event) DOM 拡張がサポートされました ([Firefox バグ 280959](https://bugzil.la/280959))。
