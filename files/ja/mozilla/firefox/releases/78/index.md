...
- [スコープペイン](/ja/docs/Tools/Debugger/UI_Tour#Scopes) で **マッピング** を有効にすると、[ログポイント](/ja/docs/Tools/Debugger/Set_a_logpoint) でソースマップを適用したコードの変数名と元の変数名をマッピングできます ([Firefox バグ 1536857](https://bugzil.la/1536857))。
...
- 2020 年中頃の [WebIDL 仕様書の変更](https://github.com/heycam/webidl/pull/357) により、[`Symbol.toStringTag` プロパティをすべての DOM プロトタイプオブジェクトに追加しました](/ja/docs/Web/JavaScript/Reference/Global_Objects/Symbol/toStringTag#toStringTag_available_on_all_DOM_prototype_objects) ([Firefox バグ 1277799](https://bugzil.la/1277799))。
