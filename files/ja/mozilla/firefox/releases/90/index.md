...
- [プライベートスタティックフィールド、プライベートインスタンスフィールドおよびプライベートスタティックメソッド、プライベートインスタンスメソッド](/ja/docs/Web/JavaScript/Reference/Classes/Private_elements) をデフォルトでサポートしました ([Firefox バグ 1708235](https://bugzil.la/1708235) および [Firefox バグ 1708236](https://bugzil.la/1708236))。
