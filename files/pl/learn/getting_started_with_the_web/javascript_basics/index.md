...
> **Warning:** **Ważne**: Jeśli nie podążałeś za wcześniejszą częścią naszego kursu, [pobierz ten przykładowy kod](https://github.com/mdn/beginner-html-site-styled/archive/gh-pages.zip) i użyj go jako punktu wyjścia.
...
> **Warning:** **Ważne**: W tym artykule spróbuj wprowadzać przykładowe linie kodu do konsoli JavaScript, aby zobaczyć, co się zdarzy. Więcej informacji na temat konsoli JavaScript można znaleźć w sekcji [Discover browser developer tools](/en-US/Learn/Discover_browser_developer_tools).
