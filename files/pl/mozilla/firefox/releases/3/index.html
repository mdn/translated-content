...
<dl>
 ...
 <dd>Firefox 3 offers the new <code>nsIIdleService</code> interface, which lets extensions determine how long it's been since the user last pressed a key or moved their mouse.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/nsIZipWriter" title="en-US/docs/nsIZipWriter">ZIP writer</a></dt>
 <dd>The new <code>nsIZipWriter</code> interface lets extensions create ZIP archives.</dd>
</dl>
...
<dl>
 ...
 <dd>Firefox 3 provides the new <code>nsIThreadManager</code> interface, along with new interfaces for threads and thread events, which provides a convenient way to create and manage threads in your code.</dd>
</dl>
...
<dl>
 ...
 <dd>Firefox 3 offers the new <code>nsIJSON</code> interface, which offers high-performance encoding and decoding of <a href="/en-US/docs/JSON" title="en-US/docs/JSON">JSON</a> strings.</dd>
</dl>
