...
Les contextes fragmentés se trouvent dans les [médias CSS paginés](/fr/docs/Web/CSS/Guides/Paged_media) (ou <i lang="en">CSS Paged Media</i> en anglais), où le fragmenteur correspond à la boîte qui définit une page. Dans une [disposition à plusieurs colonnes](/fr/docs/Web/CSS/Guides/Multicol_layout), le fragmenteur est la boîte de colonne créée lorsque les colonnes sont définies sur un conteneur à plusieurs colonnes. Dans les régions CSS, chaque région est un fragmenteur.
