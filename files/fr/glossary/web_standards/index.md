...
Les membres des organismes de normalisation publient souvent un relevé de leur position sur différentes normes, à titre de référence. Par exemple, voir [Mozilla Specification Positions <sup>(angl.)</sup>](https://mozilla.github.io/standards-positions/) et [WebKit Standards Positions <sup>(angl.)</sup>](https://webkit.org/standards-positions/).
