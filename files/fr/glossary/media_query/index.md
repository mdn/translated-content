...
Une **requête média** est une expression logique qui permet à CSS, JavaScript, HTML et d'autres langages web de vérifier certains aspects de l'agent utilisateur ou du dispositif sur lequel le document est affiché, indépendamment du contenu du document, afin de déterminer si le bloc de code ou la fonctionnalité associée doit être appliqué.
