...
Si la licence du logiciel original le permet, vous pouvez copier le code pour développer votre propre version de ce logiciel, avec vos propres ajouts, qui sera alors un «&nbsp;fork&nbsp;».

Les <i lang="en">forks</i> sont communs dans le développement des logiciels libres et <i lang="en">open source</i>. C'est maintenant un terme plus populaire grâce au modèle de contribution utilisant Git (et/ou la plateforme GitHub).
