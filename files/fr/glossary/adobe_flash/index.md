...
- [Annonce de la fin de vie d'Adobe Flash <sup>(angl.)</sup>](https://www.adobe.com/products/flashplayer/end-of-life-alternative.html)
  - Chrome&nbsp;: [Annonce de la fin d'utilisation de Flash sur Chrome <sup>(angl.)</sup>](https://blog.google/products-and-platforms/products/chrome/saying-goodbye-flash-chrome/)
