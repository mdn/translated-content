...
| ECT       | Durée minimale d'{{Glossary("Round Trip Time", "aller-retour")}} | Liaison descendante maximale | Explication                                                                                                                             |
| --------- | ---------------------------------------------------------------- | ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
...
- L'interface JavaScript {{DOMxRef('NetworkInformation')}}
- La propriété JavaScript {{DOMxRef('NetworkInformation.effectiveType')}}
- L'en-tête de requête HTTP {{HTTPHeader("ECT")}}
