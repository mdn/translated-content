...
Il répond au même objectif que les extensions de fichiers traditionnellement utilisées sous Windows.
Le nom vient de la norme {{Glossary("mime","MIME")}} initialement utilisée dans les courriels.
...
- [Liste incomplète des types MIME](/fr/docs/Web/HTTP/Guides/MIME_types/Common_types)
- La propriété {{DOMxRef("MediaRecorder.mimeType")}}
- [Type de médias](https://fr.wikipedia.org/wiki/Type_de_médias) sur Wikipédia
- [Liste des types MIME <sup>(angl.)</sup>](https://www.iana.org/assignments/media-types/media-types.xhtml)
