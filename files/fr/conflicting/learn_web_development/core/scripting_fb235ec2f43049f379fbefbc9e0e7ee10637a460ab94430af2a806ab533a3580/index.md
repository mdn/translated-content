...
- [Prendre des décisions dans votre code — les conditions](/fr/docs/Learn_web_development/Core/Scripting/Conditionals)
...
- [Les boucles](/fr/docs/Learn_web_development/Core/Scripting/Loops)
...
- [Les fonctions — réutiliser des blocs de code](/fr/docs/Learn_web_development/Core/Scripting/Functions)
...
- [Créez votre propre fonction](/fr/docs/Learn_web_development/Core/Scripting/Build_your_own_function)
...
- [Les valeurs de retour des fonctions](/fr/docs/Learn_web_development/Core/Scripting/Return_values)
...
- [Galerie de photos](/fr/docs/Learn_web_development/Core/Scripting/Image_gallery)
