...
Sinon, des événements spécifiques à la souris, tels que [mousedown](/fr/docs/Web/API/Element/mousedown_event) et [mouseup](/fr/docs/Web/API/Element/mouseup_event) créent des problèmes - leurs gestionnaires d'événements ne peuvent pas être appelés à l'aide de contrôles autres que la souris.
...
Nous avons fourni un exemple simple qui montre comment utiliser simultanément les événements de la souris et des événements tactiles — voir [multi-control-box-drag.html](https://github.com/mdn/learning-area/blob/master/accessibility/mobile/multi-control-box-drag.html) ([see the example live](https://mdn.github.io/learning-area/accessibility/mobile/multi-control-box-drag.html) aussi).
