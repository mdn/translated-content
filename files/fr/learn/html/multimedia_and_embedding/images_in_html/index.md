...
> [!NOTE]
> Vous devriez lire [Une brève présentation des URL et des chemins](/fr/Apprendre/HTML/Introduction_à_HTML/Creating_hyperlinks#url) pour vous rafraîchir la mémoire avant de continuer.
...
> [!NOTE]
> Si vous devez absolument modifier une taille d' image, vous devriez vous servir de [CSS](/fr/Apprendre/CSS) .
...
> [!NOTE]
> Vous en apprendrez beaucoup plus sur les [CSS background images](/fr/docs/Learn/CSS/Styling_boxes/Backgrounds) dans notre topic [CSS](/fr/Apprendre/CSS) .
