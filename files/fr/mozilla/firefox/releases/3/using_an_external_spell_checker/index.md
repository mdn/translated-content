...
3. L'extension doit fournir une fonction de rappel d'enregistrement. La fonction de rappel d'enregistrement doit utiliser `nsICategoryManager` pour installer dans la catégorie «&nbsp;spell-check-engine&nbsp;» une entrée avec un nom égal à l'ID de contrat de la classe implémentant la fonctionnalité de correction orthographique.
4. L'extension doit également fournir une fonction de rappel de retrait d'enregistrement, qui doit supprimer l'entrée de la catégorie.
