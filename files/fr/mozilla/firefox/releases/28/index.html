...
<p>Plus de détails dans <a href="https://hacks.mozilla.org/2013/12/split-console-pretty-print-minified-js-and-more-firefox-developer-tools-episode-28/">cet article</a>.</p>

<h3 id="CSS">CSS</h3>

<ul>
 <li>Le support de la <a href="/fr/docs/Web/Guide/CSS/Flexible_boxes">flexbox</a> multi-lignes a été ajouté ({{bug("939901")}}).</li>
 <li>Les <a href="/fr/docs/Web/CSS/list-style-type">styles de compteur</a> Longhand East Asian ont été implémentés ({{bug("934072")}}).</li>
 <li>La prise en charge expérimentale de la propriété {{cssxref("background-blend-mode")}} a été ajoutée, mais elle est désactivée par défaut ({{bug("841601")}}).</li>
...
<ul>
 <li><a href="/fr/docs/Web/JavaScript/ECMAScript_6_support_in_Mozilla">ECMAScript 6</a> (Harmony) l'implémentation continue:
...
<ul>
 <li><code>HTMLVideoElement.canPlayType('video/webm')</code> signale maintenant <code>maybe</code>. ({{bug("884275")}}).</li>
...
<ul>
 <li>Le support de l'attribut <code>mathvariant</code> a été ajouté ({{bug("114365")}}).</li>
</ul>
...
<ul>
 <li>Opus dans WebM est désormais supporté ({{bug("887978")}}).</li>
 <li>Le décodeur vidéo VP9 est désormais pris en charge ({{bug("833023")}}).</li>
</ul>
...
<ul>
 <li>L'interface de <a href="/fr/docs/Mozilla/JavaScript_code_modules/DeferredTask.jsm">DeferredTask.jsm</a> a été modifiée et les méthodes <code>isPending()</code>, <code>start()</code>, <code>flush()</code>, et <code>cancel()</code> ont été supprimées ({{bug("940408")}}).</li>
</ul>
