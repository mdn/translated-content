...
- La [proposition du TC39 d'information Intl.Locale <sup>(angl.)</sup>](https://github.com/tc39/proposal-intl-locale-info) est désormais prise en charge.
...
- La syntaxe [`import source`](/fr/docs/Web/JavaScript/Reference/Statements/import/source) (faisant partie de la proposition du [TC39 des importations de phase source <sup>(angl.)</sup>](https://github.com/tc39/proposal-source-phase-imports)) est désormais prise en charge.
...
- La propriété `images.additional_backgrounds` de la clé de manifeste [`theme`](/fr/docs/Mozilla/Add-ons/WebExtensions/manifest.json/theme) prend désormais en charge les dégradés CSS en plus des URL d'images. Une nouvelle propriété `properties.additional_backgrounds_size` permet de contrôler la taille de chaque élément d'arrière-plan supplémentaire. ([bogue Firefox 2036647 <sup>(angl.)</sup>](https://bugzil.la/2036647))
