...
- Passing an object which has a property named {{jsxref("Symbol.match")}} with a {{Glossary("truthy")}} value to {{jsxref("String.prototype.startsWith")}}, {{jsxref("String.prototype.endsWith")}}, and {{jsxref("String.prototype.includes", "String.prototype.contains")}} now throws a {{jsxref("TypeError")}} ([bug Firefox 1054755](https://bugzil.la/1054755)).
