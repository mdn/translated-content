...
- When unable to parse the [`srcset`](/fr/docs/Web/HTML/Element/image#srcset), the {{domxref("HTMLImageElement.currentSrc")}} method doesn't return `null` anymore but `""`, as requested by the latest specification ([bug Firefox 1139560](https://bugzil.la/1139560)).
