...
- Les méthodes {{jsxref("Number.parseInt", "Number.parseInt()")}} et {{jsxref("Number.parseFloat", "Number.parseFloat()")}} ont été implémentées ([bug Firefox 886949](https://bugzil.la/886949)).
