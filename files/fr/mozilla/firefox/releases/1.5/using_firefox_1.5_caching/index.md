...
<h3 id="Nouveaux_.C3.A9v.C3.A8nements_du_navigateur">Nouveaux évènements du navigateur</h3>
...
<h4 id="L.27.C3.A9v.C3.A8nement_pageshow">L'évènement pageshow</h4>
...
<h4 id="L.27.C3.A9v.C3.A8nement_pagehide">L'évènement pagehide</h4>
...
<h3 id="Exemple_de_code">Exemple de code</h3>
...
<h3 id="D.C3.A9veloppement_d.27extensions_pour_Firefox">Développement d'extensions pour Firefox</h3>

<p>Les <a href="/fr/Construire_une_extension">extensions</a> pour Firefox 1.5 doivent prendre en compte cette fonctionnalité de mise en cache. Si vous développez une extension pour Firefox et que vous désirez qu'elle soit compatible à la fois avec la 1.5 et les versions antérieures, assurez-vous qu'elle écoute l'évènement <code>load</code> pour les déclencheurs qui peuvent être mis en cache et écoute l'évènement <code>pageshow</code> pour les déclencheurs qui ne doivent pas être mis en cache.</p>
