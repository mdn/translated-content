...
- le support de l'attribut HTML [des données personnalisées](/fr/docs/Web/HTML/Reference/Global_attributes/data-*) (data-\*) a été ajouté. La propriété DOM [`element.dataset`](/fr/docs/Web/API/Element/dataset) permet d'y accéder.
...
- La propriété [`element.dataset`](/fr/docs/Web/API/Element/dataset) a été ajoutée à l'interface [`HTMLElement`](/fr/docs/Web/API/HTMLElement) permettant d'accéder aux attributs globaux [`data-*` global attributes](/fr/docs/Web/HTML/Reference/Global_attributes/data-*) d'un élément.
