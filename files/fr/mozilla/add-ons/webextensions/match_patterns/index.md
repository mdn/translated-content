...
Tous les modèles de correspondance sont spécifiés comme des chaînes. Outre le motif spécial « [\<all_urls>](/fr/docs/Mozilla/Add-ons/WebExtensions/Match_patterns#all_urls) », les modèles de correspondance se composent de trois partie : _schéma_, l'hôte, et le _chemin d'accès._ Le schéma et l'hôte sont séparés par « :// ».
