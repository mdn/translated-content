...
Notez que [la syntaxe définie pour la version de Chrome](https://developer.chrome.com/docs/extensions/reference/manifest/version?hl=fr) est plus restrictive que celle utilisée par Firefox :
