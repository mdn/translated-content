...
> [!NOTE]
>
> Cette page comprend les détails de la page du site web des développeurs de Chrome [Manifeste pour les zones de stockage](https://developer.chrome.com/docs/apps/manifest/storage?hl=fr) incluses ici sous la licence Creative Commons Attribution 3.0 United States License.
