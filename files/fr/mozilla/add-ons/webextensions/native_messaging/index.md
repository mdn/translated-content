...
- Le manifeste de l'application est stocké dans un emplacement différent [comparé à Chrome](https://developer.chrome.com/docs/extensions/develop/concepts/native-messaging?hl=fr#native-messaging-host-location).
