...
Chrome s'attend à trouver le manifeste de l'application dans un autre endroit. Se référer à la documentation Chrome pour [l'emplacement de l'hôte de messagerie natif](https://developer.chrome.com/docs/extensions/develop/concepts/native-messaging?hl=fr#native-messaging-host-location).
