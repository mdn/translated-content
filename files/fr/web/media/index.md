...
- [Media Capture and Streams API](/fr/docs/Web/API/Media_Streams_API)
...
- [Overview of media technology on the web](/fr/docs/Web/Media/Overview)
...
- [The Canvas API](/fr/docs/Web/API/Canvas_API)
