...
Les couleurs de transitions s'appliquent progressivement autour d'un cercle. Un tel dégradé est généré avec la fonction {{cssxref("conic-gradient", "conic-gradient()")}}.
