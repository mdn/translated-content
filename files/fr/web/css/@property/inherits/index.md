...
Le {{Glossary("CSS_Descriptor", "descripteur")}} [CSS](/fr/docs/Web/CSS) **`inherits`** de la [règle @](/fr/docs/Web/CSS/CSS_syntax/At-rule) {{cssxref("@property")}} contrôle si la [propriété personnalisée CSS](/fr/docs/Web/CSS/--*) enregistrée hérite ou non de sa valeur par défaut.
