...
Si un `@charset` n'est pas reconnu comme déclaration d'encodage, il est analysé comme une règle at normale. Le module [Syntaxe CSS](/fr/docs/Web/CSS/CSS_syntax) déconseille ce comportement de repli, le définissant comme une règle héritée non reconnue à ignorer lors de la vérification grammaticale d'une feuille de style.
