...
Le {{Glossary("CSS_Descriptor", "descripteur")}} [CSS](/fr/docs/Web/CSS) **`override-colors`** de la [règle @](/fr/docs/Web/CSS/CSS_syntax/At-rule) {{cssxref("@font-palette-values")}} est utilisé pour remplacer les couleurs de la [palette de base](/fr/docs/Web/CSS/@font-palette-values/base-palette) choisie pour une police couleur.
...
Pour chaque paire indice-couleur, la couleur à l'indice spécifié dans la [palette de base](/fr/docs/Web/CSS/@font-palette-values/base-palette) sera remplacée. Si la police couleur ne possède pas de couleur à l'indice indiqué, cette valeur sera ignorée.

### Valeurs

- `[ <integer [0,∞]> <absolute-color-base> ]`
  - : Définit l'indice d'une couleur dans une [palette de base](/fr/docs/Web/CSS/@font-palette-values/base-palette) et la couleur avec laquelle la remplacer.
