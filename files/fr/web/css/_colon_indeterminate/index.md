...
La [pseudo-classe](/fr/docs/Web/CSS/Pseudo-classes) [CSS](/fr/docs/Web/CSS) **`:indeterminate`** permet de cibler un élément de formulaire dont l'état est indéterminé.
