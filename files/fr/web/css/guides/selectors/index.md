...
- [Les sélecteurs de type](/fr/docs/Web/CSS/Reference/Selectors/Type_selectors)
...
- [Les sélecteurs de classe](/fr/docs/Web/CSS/Reference/Selectors/Class_selectors)
...
- [Les sélecteurs d'identifiant](/fr/docs/Web/CSS/Reference/Selectors/ID_selectors)
...
- [Le sélecteur universel](/fr/docs/Web/CSS/Reference/Selectors/Universal_selectors)
...
- [Les sélecteurs d'attribut](/fr/docs/Web/CSS/Reference/Selectors/Attribute_selectors)
...
- [Les sélecteurs de voisin direct](/fr/docs/Web/CSS/Reference/Selectors/Next-sibling_combinator)
...
- [Les sélecteurs de voisins](/fr/docs/Web/CSS/Reference/Selectors/Subsequent-sibling_combinator)
...
- [Les sélecteurs d'éléments enfants](/fr/docs/Web/CSS/Reference/Selectors/Child_combinator)
...
- [Les sélecteurs d'éléments descendants](/fr/docs/Web/CSS/Reference/Selectors/Descendant_combinator)
...
- [Le combinateur de colonne](/fr/docs/Web/CSS/Reference/Selectors/Column_combinator){{experimental_inline}}
...
- [Les pseudo-classes](/fr/docs/Web/CSS/Reference/Selectors/Pseudo-classes) permettent de cibler des éléments selon une information d'état qui n'est pas stockée dans l'arbre du document.
...
- [Les pseudo-éléments](/fr/docs/Web/CSS/Reference/Selectors/Pseudo-elements) représentent des entités du document qui ne sont pas décrites en HTML.
