...
<div id="color-mixer">
  <div>couleur-une</div>
  <div>couleur-mélangée</div>
  <div>couleur-deux</div>
  ...
  <div id="color-background">
    <button
      ...
      type="button"
      class="color-one"
      aria-label="Ouvre la boîte de dialogue du sélecteur de couleur une"></button>
    <div id="mixed-color"></div>
    <button
      id="color-two"
      type="button"
      class="color-two"
      aria-label="Ouvre la boîte de dialogue du sélecteur de couleur deux"></button>
  </div>
  <div>
    <label
  ...
  <label for="color-space">Espace colorimétrique&nbsp;:</label>
  ...
  <select id="interpolation-method">
    <option value="shorter hue" selected>teinte la plus courte</option>
    <option value="longer hue">teinte la plus longue</option>
    <option value="increasing hue">teinte croissante</option>
    <option value="decreasing hue">teinte décroissante</option>
  </select>
  ...
  <dialog id="picker-dialog">
    ...
    <table>
      <tr>
        <td><label for="color-text">Entrez une couleur&nbsp;:</label></td>
        <td><input type="text" id="color-text" value="#bada55" /></td>
      </tr>
      <tr>
        <td><label for="color-input">Choisir une couleur&nbsp;:</label></td>
...
<table id="output-colors">
  <caption>
    Mixage de couleurs dans différents formats&nbsp;:
  </caption>
  <tbody>
    <tr id="rgb-function">
      <th>
        <a
          href="https://developer.mozilla.org/fr/docs/Web/CSS/color_value/rgb"
          target="_blank">
          RGB
        </a>
      </th>
    ...
    <tr id="hex">
      <th>
        <a
          href="https://developer.mozilla.org/fr/docs/Web/CSS/hex-color"
          target="_blank"
          >HEX</a
        >
      </th>
    ...
    <tr id="hsl-function">
      <th>
        <a
          href="https://developer.mozilla.org/fr/docs/Web/CSS/color_value/hsl"
          target="_blank">
          HSL
        </a>
      </th>
    ...
    <tr id="hwb-function">
      <th>
        <a
          href="https://developer.mozilla.org/fr/docs/Web/CSS/color_value/hwb"
          target="_blank">
          HWB
        </a>
      </th>
    ...
    <tr id="color-function">
      <th>
        <a
          href="https://developer.mozilla.org/fr/docs/Web/CSS/color_value/color"
          target="_blank">
          color()
        </a>
      </th>
    ...
    <tr id="lab-function">
      <th>
        <a
          href="https://developer.mozilla.org/fr/docs/Web/CSS/color_value/lab"
          target="_blank">
          Lab
        </a>
      </th>
    ...
    <tr id="lch-function">
      <th>
        <a
          href="https://developer.mozilla.org/fr/docs/Web/CSS/color_value/lch"
          target="_blank">
          LCH
        </a>
      </th>
    ...
    <tr id="oklab-function">
      <th>
        <a
          href="https://developer.mozilla.org/fr/docs/Web/CSS/color_value/oklab"
          target="_blank">
          Oklab
        </a>
      </th>
    ...
    <tr id="oklch-function">
      <th>
        <a
          href="https://developer.mozilla.org/fr/docs/Web/CSS/color_value/oklch"
          target="_blank">
          OkLCh
        </a>
      </th>
...
// éléments de dialogue contextuel
...
function rgbaToHSLA(color) {
  ...
  // Nous voulons que r, g, b soient dans la plage [0, 1]
  r /= 255;
  g /= 255;
  b /= 255;
  ...
  // Nous voulons un angle entre 0 et 360°
  if (h < 0) {
    h += 360;
  }
