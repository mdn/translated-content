...
Si vous connaissez déjà [les boîtes flexibles (_flexbox_)](/fr/docs/Web/CSS/Guides/Flexible_box_layout), vous reconnaitrez certaines propriétés faisant partie de la spécification de niveau 1 pour Flexbox. Toutefois, la spécification indique que la spécification _Box Alignment_ est prioritaire car elle peut décrire certaines fonctionnalités supplémentaires.

## Exemples simples

Dans les exemples suivants, nous allons voir comment certaines des propriétés d'alignement peuvent être appliquées sur des dispositions [en grille](/fr/docs/Web/CSS/Guides/Grid_layout) ou utilisant [les boîtes flexibles](/fr/docs/Web/CSS/Guides/Flexible_box_layout).
...
- [L'alignement des boîtes avec une disposition en colonne](/fr/docs/Web/CSS/Guides/Box_alignment/In_multi-column_layout)
- [L'alignement des boîtes pour les dispositions en bloc, les dispositions absolues et en tableau](/fr/docs/Web/CSS/Guides/Box_alignment/In_block_abspos_tables)
...
- Guide CSS sur Flexbox : _[Les concepts de base de Flexbox](/fr/docs/Web/CSS/Guides/Flexible_box_layout/Basic_concepts)_
- Guide CSS sur Flexbox : _[Aligner les éléments d'un conteneur flexible](/fr/docs/Web/CSS/Guides/Flexible_box_layout/Aligning_items)_
- Guide CSS sur les grilles : _[Aligner les boîtes dans une disposition en grille](/fr/docs/Web/CSS/Guides/Grid_layout/Box_alignment)_
