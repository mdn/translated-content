...
Vous pouvez trouver plusieurs exemples utilisant les polices variables sur [v-fonts.com](https://v-fonts.com/) et [axis-praxis.org](https://www.axis-praxis.org/). Notre [guide sur les polices variables](/fr/docs/Web/CSS/Guides/Fonts/Variable_fonts) contient des informations et des exemples d'utilisation.
...
- [Guide sur les caractéristiques de police OpenType](/fr/docs/Web/CSS/Guides/Fonts/OpenType_fonts)
