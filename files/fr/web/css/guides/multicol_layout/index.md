...
La disposition en colonnes est fortement liée aux [média paginés](/fr/docs/Web/CSS/Guides/Paged_media) pour lesquels chaque colonne devient un fragment (de la même façon qu'une page imprimée devient un fragment d'un document). Aussi, les propriétés désormais définies dans le module de spécification [CSS Fragmentation](/fr/docs/Web/CSS/Guides/Fragmentation) sont nécessaires afin de contrôler la façon dont le contenu est scindé entre les colonnes.
...
- [Concepts de base relatifs à la disposition en colonnes](/fr/docs/Web/CSS/Guides/Multicol_layout/Basic_concepts)
...
- [Équilibrer le remplissement des colonnes](/fr/docs/Web/CSS/Guides/Multicol_layout/Spanning_balancing_columns)
  - : Comment répartir un élément sur plusieurs colonnes et comment contrôler la façon dont les colonnes sont remplies.
- [Gérer le dépassement](/fr/docs/Web/CSS/Guides/Multicol_layout/Handling_overflow)
...
- [Gérer la fragmentation du contenu en multi-colonnes](/fr/docs/Web/CSS/Guides/Multicol_layout/Handling_content_breaks)
...
- [Les boîtes flexibles (_flexbox_)](/fr/docs/Web/CSS/Guides/Flexible_box_layout)
- [Les grilles CSS (_CSS Grid_)](/fr/docs/Web/CSS/Guides/Grid_layout)
