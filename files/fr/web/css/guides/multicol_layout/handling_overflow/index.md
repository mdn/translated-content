...
Dans le dernier guide de cette série, nous verrons [comment la disposition multi-colonnes interagit avec le module de spécification Fragmentation](/fr/docs/Web/CSS/Guides/Multicol_layout/Handling_content_breaks) et nous permet de contrôler la façon dont le contenu est coupé entre les colonnes.
