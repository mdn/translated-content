...
Dans le prochain guide, nous verrons [comment gérer le dépassement au sein d'un conteneur multi-colonnes](/fr/docs/Web/CSS/Guides/Multicol_layout/Handling_overflow), à l'intérieur des colonnes et lorsqu'il y a plus de contenu que le conteneur peut en avoir.
