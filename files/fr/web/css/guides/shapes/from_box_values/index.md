...
Pour obtenir des formes plus complexes, il faudra utiliser les valeurs de [type `<basic-shape>` (les formes simples)](/fr/docs/Web/CSS/Guides/Shapes/Using_shape-outside) ou [définir une forme à partir d'une image](/fr/docs/Web/CSS/Guides/Shapes/From_images), tel que nous le verrons dans les autres guides de cette section.
