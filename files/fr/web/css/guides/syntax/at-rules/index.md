...
- {{CSSxRef("@import")}}
  - : Indique au moteur CSS d'inclure une feuille de style externe ([Cascade et héritage CSS](/fr/docs/Web/CSS/Guides/Cascade)).
- {{CSSxRef("@layer")}}
  - : Définit l'ordre de priorité en cas de couches de cascade multiples ([Cascade et héritage CSS](/fr/docs/Web/CSS/Guides/Cascade)). Utilisée aussi comme [règle @ de bloc](#layer_2) pour définir les styles d'une couche.
- {{CSSxRef("@namespace")}}
...
- {{CSSxRef("@container")}}
  - : Règle conditionnelle de groupe qui applique son contenu si le conteneur satisfait la [`<container-condition>`](/fr/docs/Web/CSS/Reference/At-rules/@container#container-condition) ([Compartimentation CSS](/fr/docs/Web/CSS/Guides/Containment)).
- {{CSSxRef("@font-face")}}
...
- {{CSSxRef("@layer")}}
  - : Crée une couche de cascade nommée avec les règles CSS pour cette couche ([Cascade et héritage CSS](/fr/docs/Web/CSS/Guides/Cascade)). Utilisée aussi comme [règle @ de déclaration](#layer) pour définir l'ordre de priorité en cas de couches multiples.
- {{CSSxRef("@media")}}
...
- {{CSSxRef("@page")}}
  - : Définit les aspects d'une page à imprimer, comme ses dimensions, son orientation et ses marges ([Média paginé CSS](/fr/docs/Web/CSS/Guides/Paged_media)).
...
- {{CSSxRef("@scope")}}
  - : Définit une portée dans laquelle appliquer des styles à des éléments sélectionnés ([Cascade et héritage CSS](/fr/docs/Web/CSS/Guides/Cascade)).
...
- Le module [de syntaxe CSS](/fr/docs/Web/CSS/Guides/Syntax/Introduction)
