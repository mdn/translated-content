...
Le [type de donnée](/fr/docs/Web/CSS/CSS_values_and_units/CSS_data_types) [CSS](/fr/docs/Web/CSS) **`<frequency>`** permet de représenter des fréquences (par exemple la hauteur d'une voix). Ce type n'est actuellement utilisé pour aucune propriété CSS.
