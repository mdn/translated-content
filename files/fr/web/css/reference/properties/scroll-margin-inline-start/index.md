...
- {{CSSxRef("&lt;length&gt;")}}
  - : Un décalage par rapport au bord de début en incise du conteneur de défilement.
...
Cela signifie que lorsque vous faites défiler les éléments enfants du milieu, le défilement s'accrochera à `1rem` en dehors du bord de début en incise du deuxième `<div>`, et à `2rem` en dehors du bord de début en incise du troisième `<div>`.
