...
Pour activer la préférence de jeu de couleurs de l'utilisateur·ice sur l'ensemble de la page, `color-scheme` peut être déclaré sur l'élément {{CSSxRef(":root")}}.
