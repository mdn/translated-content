...
Les marges haute et basse n'ont aucun effet sur les élements en ligne (_inline_) qui ne sont pas [remplacés](/fr/docs/Web/CSS/Guides/Images/Replaced_element_properties) (par exemple les {{HTMLElement("span")}} ou {{HTMLElement("code")}}).
...
Les marges haute et basse des éléments sont parfois fusionnées en une seule marge qui est égale à la plus grande des deux marges. Pour plus d'informations, lire [l'article sur la fusion des marges](/fr/docs/Web/CSS/Guides/Box_model/Margin_collapsing).
