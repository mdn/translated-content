...
- Une valeur {{CSSxRef("view-timeline")}} de `--inner-change inline`, pour déclarer l'élément comme sujet de la chronologie de progression de vue `--inner-change` et faire progresser cette chronologie dans la direction en incise (<i lang="en">inline</i> en anglais) à travers son contenant de défilement ancêtre.
