...
- `<filter-function-list>`
  - : Une liste de fonctions de filtre (cf. [`<filter-function>`](/fr/docs/Web/CSS/Reference/Values/filter-function)), séparées par des espaces et qui seront appliquées à l'ombre. On peut également utiliser [un filtre SVG](/fr/docs/Web/SVG/Reference/Element/filter).
