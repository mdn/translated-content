---
title: Propriété CSS `box-flex-group`
...
Dans la spécification originale, `box-flex-group` peut être utilisée afin d'affecter des enfants flexibles à différents groupes parmi lesquels répartir l'espace flexible&nbsp;:
