...
### Définir les symboles avec `@counter-style`
...
{{EmbedLiveSample("Définir les symboles avec `@counter-style`", "", 160)}}

Voir plus d'exemples sur la [page de démonstration <sup>(angl.)</sup>](https://mdn.github.io/css-examples/counter-style-demo/) ([code <sup>(angl.)</sup>](https://github.com/mdn/css-examples/tree/main/counter-style-demo)).
...
- La fonction {{CSSxRef("counter", "counter()")}}
- La fonction {{CSSxRef("counters", "counters()")}}
- La fonction {{CSSxRef("symbols", "symbols()")}}
- Les propriétés {{CSSxRef("list-style")}}, {{CSSxRef("list-style-image")}}, {{CSSxRef("list-style-position")}}, {{CSSxRef("list-style-type")}}
