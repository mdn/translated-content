...
La [fonction](/fr/docs/Web/CSS/Reference/Values/Functions) [CSS](/fr/docs/Web/CSS) **`layer()`** est utilisée avec la [règle @](/fr/docs/Web/CSS/CSS_syntax/At-rules) [`@import`](/fr/docs/Web/CSS/Reference/At-rules/@import) pour placer la ressource importée dans une [couche de cascade](/fr/docs/Web/CSS/Reference/At-rules/@layer) nommée distincte.
