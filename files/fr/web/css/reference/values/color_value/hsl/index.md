...
Ci‑dessous se trouvent les descriptions des valeurs autorisées pour les couleurs à la fois absolues et [relatives](/fr/docs/Web/CSS/Guides/Colors/Using_relative_colors).
