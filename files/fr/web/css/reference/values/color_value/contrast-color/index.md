...
Dans l'exemple suivant, le navigateur applique automatiquement la couleur sélectionnée à l'arrière-plan de l'élément HTML {{HTMLElement("button")}} intitulé «&nbsp;Bouton&nbsp;», et la couleur contrastée (noir ou blanc) à son texte.
...
{{EmbedLiveSample("Texte contrasté pour un bouton", "", 250)}}
...
{{EmbedLiveSample("Utiliser le mode clair et sombre", "", 250)}}
...
- La fonction {{CSSxRef("filter-function/contrast", "contrast()")}}
