...
Le mot-clé [CSS](/fr/docs/Web/CSS) de dimensionnement `min-content` représente la [taille intrinsèque minimale](/fr/docs/Glossary/Intrinsic_Size#taille_intrinsèque_minimale) d'un élément.
