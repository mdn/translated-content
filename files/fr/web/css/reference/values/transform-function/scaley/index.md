...
{{InteractiveExample("Démonstration CSS&nbsp;: scaleY()")}}
...
- `s`
  - : Est un nombre ({{CSSxRef("&lt;number&gt;")}}) représentant le facteur d'échelle à appliquer sur l'ordonnée (coordonnée verticale, y) de chaque point de l'élément.
