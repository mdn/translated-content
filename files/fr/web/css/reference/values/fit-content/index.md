...
> [!NOTE]
> La spécification <i lang="en">CSS Sizing</i> définit également la fonction [`fit-content`](/fr/docs/Web/CSS/Reference/Values/fit-content_function). Cette page détaille le mot-clé.
