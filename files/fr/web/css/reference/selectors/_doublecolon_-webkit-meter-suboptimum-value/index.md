...
original_slug: Web/CSS/::-webkit-meter-suboptimum-value
l10n:
...
Le [pseudo-élément](/fr/docs/Web/CSS/Reference/Selectors/Pseudo-elements) [CSS](/fr/docs/Web/CSS) **`::-webkit-meter-suboptimum-value`** est une [extension de WebKit](/fr/docs/Web/CSS/Reference/Webkit_extensions) qui donne une couleur jaune à l'élément {{HTMLElement("meter")}} lorsque la valeur de l'attribut est en dehors de l'intervalle haut des valeurs.
