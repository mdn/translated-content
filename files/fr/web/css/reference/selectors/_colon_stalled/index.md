...
La [pseudo-classe](/fr/docs/Web/CSS/Pseudo-classes) [CSS](/fr/docs/Web/CSS) **`:stalled`** représente un élément qui est lisible, tel que {{htmlelement("audio")}} ou {{htmlelement("video")}}, lorsque la lecture est bloquée.
