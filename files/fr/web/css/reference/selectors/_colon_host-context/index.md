...
> [!NOTE]
> Cette pseudo-classe n'a aucun effet si elle est utilisée en dehors d'un DOM d'ombre.
...
- La fonction de pseudo-classe CSS {{CSSxRef(":host_function", ":host()")}}
- La fonction de pseudo-classe CSS {{CSSxRef(":state",":state()")}}
