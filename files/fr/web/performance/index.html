...
<p>The MDN <a href="/fr/docs/Learn/Performance">Web Performance Learning Area</a> contains modern, up-to-date tutorials covering Performance essentials:</p>

<dl>
 <dt><a href="/fr/docs/Learn/Performance/What_is_web_performance">What is web performance</a></dt>
 ...
 <dt><a href="/fr/docs/Learn/Performance/web_performance_basics">Web Performance Basics</a></dt>
 ...
 <dt><a href="/fr/docs/Learn/Performance/perceived_performance">How do users perceive performance?</a></dt>
 <dd>
 ...
 <dt><a href="/fr/docs/Learn/Performance/Multimedia">Multimedia: Images and Video</a></dt>
 ...
 <dt><a href="/fr/docs/Learn/Performance/CSS_performance">CSS performance features</a></dt>
...
<dl>
 <dt><a href="/fr/docs/Web/API/Performance_API/Using_the_Performance_API">Performance API</a></dt>
 <dd>This guide describes how to use the <a href="/fr/docs/Web/API/Performance" title="The Performance interface provides access to performance-related information for the current page. It's part of the High Resolution Time API, but is enhanced by the Performance Timeline API, the Navigation Timing API, the User Timing API, and the Resource Timing API."><code>Performance</code></a> interfaces that are defined in the <a class="external external-icon" href="https://w3c.github.io/hr-time/" rel="noopener">High-Resolution Time</a> standard.</dd>
 <dt><a href="/fr/docs/Web/API/Resource_Timing_API/Using_the_Resource_Timing_API">Resource Timing API</a></dt>
 <dd><a href="/fr/docs/Web/API/Resource_Timing_API">Resource loading and timing</a> the loading of those resources, including managing the resource buffer and coping with CORS</dd>
 <dt><a href="/fr/docs/Web/API/Performance_Timeline/Using_Performance_Timeline">The performance timeline</a></dt>
 <dd>The <a href="/fr/docs/Web/API/Performance_Timeline">Performance Timeline</a> standard defines extensions to the <a href="/fr/docs/Web/API/Performance" title="The Performance interface provides access to performance-related information for the current page. It's part of the High Resolution Time API, but is enhanced by the Performance Timeline API, the Navigation Timing API, the User Timing API, and the Resource Timing API."><code>Performance</code></a> interface to support client-side latency measurements within applications. Together, these interfaces can be used to help identify an application's performance bottlenecks.</dd>
 <dt><a href="/fr/docs/Web/API/User_Timing_API/Using_the_User_Timing_API">User Timing API</a></dt>
 <dd>Create application specific timestamps using the <a href="/fr/docs/Web/API/User_Timing_API">user timing API</a>'s "mark" and "measure" entry types - that are part of the browser's performance timeline.</dd>
 <dt><a href="/fr/docs/Web/API/Frame_Timing_API/Using_the_Frame_Timing_API">Frame Timing API</a></dt>
 <dd>The <code><a href="/fr/docs/Web/API/PerformanceFrameTiming">PerformanceFrameTiming</a></code> interface provides <em>frame</em> timing data about the browser's event loop.</dd>
 <dt><a href="/fr/docs/Web/API/Beacon_API/Using_the_Beacon_API">Beacon API</a></dt>
 <dd><small>The <a href="/fr/docs/Web/API/Beacon_API">Beacon</a> interface schedules an asynchronous and non-blocking request to a web server.</small></dd>
 <dt><a href="/fr/docs/Web/API/Intersection_Observer_API/Timing_element_visibility">Intersection Observer API</a></dt>
 <dd>Learn to time element visibility with the <a href="/fr/docs/Web/API/Intersection_Observer_API">Intersection Observer API</a> and be asynchronously notified when elements of interest becomes visible.</dd>
</dl>

<h2>Other documentation</h2>

<dl>
 <dt><a href="/fr/docs/Tools/Performance">Developer Tools Performance Features</a></dt>
 <dd>This section provides information on how to use and understand the performance features in your developer tools, including <a href="/fr/docs/Tools/Performance/Waterfall">Waterfall</a>, <a href="/fr/docs/Tools/Performance/Call_Tree">Call Tree</a>, and <a href="/fr/docs/Tools/Performance/Flame_Chart">Flame Charts</a>.</dd>
 <dt><a href="/fr/docs/Learn/Performance/Understanding_latency">Understanding Latency</a></dt>
...
<dl>
 <dt><a href="/fr/docs/Learn/Performance/JavaScript">JavaScript performance best practices</a></dt>
 ...
 <dt><a href="/fr/docs/Learn/Performance/Mobile">Mobile performance</a></dt>
 ...
 <dd>Developer tools provide information on performance, memory, and network requests. Knowing how to read <a href="/fr/docs/Tools/Performance/Waterfall">waterfall</a> charts, <a href="/fr/docs/Tools/Performance/Call_Tree">call trees</a>, traces, <a href="/fr/docs/Tools/Performance/Flame_Chart">flame charts</a> , and <a href="/fr/docs/Tools/Performance/Allocations">allocations</a> in your browser developer tools will help you understand waterfall and flame charts in other performance tools.</dd>
 ...
 <dt><a href="/fr/docs/Web/Performance/Lazy_loading">Lazy loading</a></dt>
 ...
 <dt><a href="/fr/docs/Web/Performance/Controlling_resource_delivery_with_resource_hints">Controlling resource delivery with resource hints</a></dt>
 ...
 <dt><a href="/fr/docs/Web/Performance/Performance_budgets">Performance Budgets</a></dt>
 ...
 <dt><a href="/fr/docs/Web/Performance/Checklist">Web performance checklist</a></dt>
 ...
 <dt><a href="/fr/docs/Web/Performance/Mobile_performance_checklist">Mobile performance checklist</a></dt>
...
<dl>
 <dt><a href="/fr/Apps/Developing/Performance/Performance_fundamentals">Performance fundamentals</a></dt>
 ...
 <dt><a href="/fr/Apps/Developing/Performance/Optimizing_startup_performance">Optimizing startup performance</a></dt>
 ...
 <dt><a href="/fr/docs/Performance/Profiling_with_the_Built-in_Profiler">Profiling with the built-in profiler</a></dt>
 <dd>Learn how to profile app performance with Firefox's built-in profiler.</dd>
 <dt><a href="/fr/Apps/Build/Performance/CSS_JavaScript_animation_performance">CSS and JavaScript animation performance</a></dt>
...
<ul>
 <li><a href="/fr/docs/Web/HTML/Element/picture">The <code>&lt;picture&gt;</code> Element</a></li>
 <li><a href="/fr/docs/Web/HTML/Element/video">The <code>&lt;video&gt;</code> Element</a></li>
 <li><a href="/fr/docs/Web/HTML/Element/source">The <code>&lt;source&gt;</code> Element</a></li>
 <li><a href="/fr/docs/Web/HTML/Element/img#Attributes">The <code>&lt;img&gt; srcset</code> attribute</a>
  <ul>
   <li><a href="/fr/docs/Learn/HTML/Multimedia_and_embedding/Responsive_images">Responsive images</a></li>
  </ul>
 </li>
 <li><a href="/fr/docs/Web/HTML/Preloading_content">Preloading content with <code>rel="preload"</code></a> - <a href="https://w3c.github.io/preload/">(https://w3c.github.io/preload/ </a>)</li>
</ul>

<p>CSS</p>

<ul>
 <li><a href="/fr/docs/Web/CSS/will-change">will-change</a></li>
 <li>GPU v CPU</li>
...
<ul>
 <li><a href="/fr/docs/Web/Events/DOMContentLoaded">DOMContentLoaded</a></li>
 <li><a href="/fr/docs/Glossary/Garbage_collection">Garbage collection</a></li>
...
<ul>
 <li><a href="/fr/docs/Web/API/Performance_API">Performance API</a></li>
 <li><a href="/fr/docs/Web/API/Navigation_timing_API">Navigation Timing API</a></li>
 <li><a href="/fr/docs/Web/API/Media_Capabilities_API/Using_the_Media_Capabilities_API">Media Capabilities API</a></li>
 <li><a href="/fr/docs/Web/API/Network_Information_API">Network Information API</a></li>
 <li><a href="/fr/docs/Web/API/PerformanceNavigationTiming">PerformanceNavigationTiming</a></li>
 <li><a href="/fr/docs/Web/API/Battery_Status_API">Battery Status API</a></li>
 <li><a href="/fr/docs/Web/API/Navigator/deviceMemory">Navigator.deviceMemory</a></li>
 <li><a href="/fr/docs/Web/API/Intersection_Observer_API">Intersection Observer</a></li>
 <li><a href="/fr/docs/Web/API/User_Timing_API/Using_the_User_Timing_API">Using the User Timing AP</a>I</li>
 <li><a href="/fr/docs/Web/API/Long_Tasks_API">Long Tasks API</a></li>
 <li><a href="/fr/docs/Web/API/DOMHighResTimeStamp">High Resolution Timing API</a> (<a href="https://w3c.github.io/hr-time/">https://w3c.github.io/hr-time/)</a></li>
 <li><a href="/fr/docs/Web/API/Resource_Timing_API/Using_the_Resource_Timing_API">Resource Timing API</a></li>
 <li><a href="/fr/docs/Web/API/Page_Visibility_API">Page Visibility</a></li>
 <li><p><a href="/fr/docs/Web/API/Background_Tasks_API">Cooperative Scheduling of Background Tasks API</a></p>
  <ul>
   <li><a href="/fr/docs/Web/API/Window/requestIdleCallback">requestIdleCallback() </a></li>
  </ul>
 </li>
 <li><a href="/fr/docs/Web/API/Beacon_API/Using_the_Beacon_API">Beacon API</a></li>
 <li>Resource Hints - <a href="/fr/docs/Web/HTTP/Headers/X-DNS-Prefetch-Control">dns-prefetch</a>, preconnect, <a href="/fr/docs/Web/HTTP/Link_prefetching_FAQ">prefetch</a>, and prerender</li>
 <li><a href="/fr/docs/Web/API/FetchEvent/navigationPreload">Fetchevent.navigationPreload</a></li>
 <li><a href="/fr/docs/Web/API/PerformanceServerTiming">Performance Server Timing API</a></li>
</ul>

<p>Headers</p>

<ul>
 <li><a href="/fr/docs/Web/HTTP/Headers/Content-Encoding">Content-encoding</a></li>
 <li>HTTP/2</li>
 <li><a href="/fr/docs/Glossary/GZip_compression">gZip</a></li>
 <li>Client Hints</li>
</ul>
...
<ul>
 <li><a href="/fr/docs/Tools/Performance">Performance in Firefox Developer Tools</a></li>
 <li>Flame charts</li>
...
<ul>
 ...
 <li><a href="/fr/docs/Web/API/Web_Workers_API/Using_web_workers">Using Web Workers</a>
  <ul>
   <li><a href="/fr/docs/Web/API/Web_Workers_API">Web Workers API</a></li>
  </ul>
 </li>
 <li><a href="/fr/docs/Web/Apps/Progressive/Offline_Service_workers">PWA</a></li>
 <li><a href="/fr/docs/Web/HTTP/Caching">Caching</a></li>
