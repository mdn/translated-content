...
Voir également [les types de données et structures JavaScript](/fr/docs/Web/JavaScript/Guide/Data_structures) pour l'articulation des types primitifs en JavaScript.
