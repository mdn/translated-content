...
L'**opérateur de coalescence des nuls** (`??`), est un opérateur logique qui renvoie son opérande de droite lorsque son opérande de gauche vaut {{jsxref("Operators/null", "null")}} ou {{jsxref("undefined")}} et qui renvoie son opérande de gauche sinon.
