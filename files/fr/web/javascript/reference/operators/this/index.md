...
Lorsqu'une fonction est utilisée comme constructeur (c'est-à-dire qu'elle est invoquée avec le mot-clé {{jsxref("Operators/new","new")}}), le `this` correspondant sera lié au nouvel objet en train d'être construit.
