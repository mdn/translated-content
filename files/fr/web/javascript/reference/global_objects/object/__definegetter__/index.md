...
La méthode `__defineGetter__` permet de définir un {{jsxref("Operators/L_opérateur_get", "accesseur", "", 1)}} sur un objet pré-existant.
...
- L'opérateur {{jsxref("Operators/L_opérateur_get", "get")}}
