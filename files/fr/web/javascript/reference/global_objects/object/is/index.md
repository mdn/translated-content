...
Attention, ce n'est pas la même égalité qu'avec l'opérateur {{jsxref("Operators/Opérateurs_de_comparaison", "==", "#égalité_simple_(==)")}}. L'opérateur == applique différentes conversions à chaque opérande (si ils ne sont pas du même type) avant de tester l'égalité (d'où le comportement `"" == false` qui donne `true`), `Object.is` ne convertit aucune des deux valeurs.

Cette égalité est également différente de l'égalité stricte qu'on peut avoir avec l'opérateur {{jsxref("Operators/Opérateurs_de_comparaison", "===", "#égalité_stricte_(===)")}}. L'opérateur === (et également l'opérateur ==) considère que `-0` et `+0` sont égales et que {{jsxref("Number.NaN")}} n'est pas égal à {{jsxref("NaN")}}.
...
- {{jsxref("Operators/Opérateurs_de_comparaison","Les opérateurs de comparaison","",1)}}
