...
La méthode `__defineSetter__` permet de définir un {{jsxref("Operators/L_opérateur_set", "mutateur", "", 1)}} sur un objet pré-existant.
...
- L'opérateur {{jsxref("Operators/L_opérateur_set", "set")}}
