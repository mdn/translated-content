...
L'objet **`ReferenceError`** représente une erreur qui se produit lorsqu'il est fait référence à une variable qui n'existe pas (ou qui n'a pas encore été initialisée) dans la portée courante.
