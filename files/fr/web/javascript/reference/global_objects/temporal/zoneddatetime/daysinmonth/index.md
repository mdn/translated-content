---
title: "Temporal.ZonedDateTime : propriété daysInMonth"
...
La propriété d'accesseur **`daysInMonth`** des instances de {{JSxRef("Temporal.ZonedDateTime")}} retourne un entier positif représentant le nombre de jours dans le mois de cette date. Elle dépend du [calendrier](/fr/docs/Web/JavaScript/Reference/Global_Objects/Temporal#calendriers).
