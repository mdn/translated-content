---
title: "Temporal.PlainDateTime : propriété daysInMonth"
...
La propriété d'accesseur **`daysInMonth`** des instances de {{JSxRef("Temporal.PlainDateTime")}} retourne un entier positif représentant le nombre de jours dans le mois de cette date. Elle dépend du [calendrier](/fr/docs/Web/JavaScript/Reference/Global_Objects/Temporal#calendriers) utilisé.
