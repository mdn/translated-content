...
La méthode **`handler.has()`** est une trappe pour l'opérateur {{jsxref("Operators/L_opérateur_in", "in")}}.
...
Dans l'exemple qui suit, on intercepte l'opérateur {{jsxref("Operators/L_opérateur_in", "in")}} :
