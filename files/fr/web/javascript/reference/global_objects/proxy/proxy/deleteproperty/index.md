...
La méthode **`handler.deleteProperty()`** est une trappe pour l'opérateur {{jsxref("Operators/delete", "delete")}}.
...
La méthode **`handler.deleteProperty()`** est une trappe permettant d'intercepter les opérations de l'opérateur {{jsxref("Operators/delete", "delete")}}.
...
Dans l'exemple qui suit, on intercepte les opérations de {{jsxref("Operators/delete", "delete")}}.
...
- L'opérateur {{jsxref("Operators/delete", "delete")}}
- {{jsxref("Reflect.deleteProperty()")}}
