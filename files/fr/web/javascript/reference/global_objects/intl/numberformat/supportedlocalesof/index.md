---
title: "Intl.NumberFormat : méthode statique supportedLocalesOf()"
...
{{InteractiveExample("Démonstration JavaScript&nbsp;: Intl.NumberFormat.supportedLocalesOf()", "shorter")}}
...
- `locales`
  - : Une chaîne de caractères qui est une {{Glossary("BCP 47 language tag", "balise de langue BCP 47")}}, ou un tableau de telles chaînes de caractères. Pour plus d'informations sur la forme générale de l'argument `locales`, voir [la description du paramètre sur la page principale de `Intl`](/fr/docs/Web/JavaScript/Reference/Global_Objects/Intl#argument_locales).
