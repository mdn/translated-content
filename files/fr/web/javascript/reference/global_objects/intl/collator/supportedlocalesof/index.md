...
La méthode statique **`Intl.Collator.supportedLocalesOf()`** retourne un tableau contenant celles des locales fournies qui sont prises en charge pour la collation sans avoir à recourir à la locale par défaut de l'environnement d'exécution.
...
### Utiliser la méthode `Intl.Collator.supportedLocalesOf()`
