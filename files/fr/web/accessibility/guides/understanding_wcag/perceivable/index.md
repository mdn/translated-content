...
Dans cet article, nous voyons des conseils pratiques pour écrire du contenu web qui respecte le principe de **perceptibilité** décrit dans les règles pour l'accessibilité des contenus web (WCAG) 2.0 et 2.1. Les états du contenu doivent pouvoir être perçus par les utilisateur·ice·s d'une façon ou d'une autre en utilisant un de leurs sens.

> [!NOTE]
> Les définitions du W3C pour cette catégorie, les règles associées et les critères de réussite sont présentes sur la page [Principe 1&nbsp;: l'information et les composants de l'interface utilisateur doivent être présentés à l'utilisateur·ice de façon à ce qu'il puisse les percevoir <sup>(angl.)</sup>](https://w3c.github.io/wcag/guidelines/22/#perceivable).

## Règle 1.1 — Des équivalents textuels doivent être fournis pour tout contenu non textuel

L'information principale à retenir ici est que le texte peut être converti sous d'autres formes que les personnes avec un handicap peuvent utiliser. Il peut ainsi être vocalisé par un lecteur d'écran, converti en grands caractères ou représenté sur un affichage en braille. Le contenu non textuel fait référence au multimédia comme les images, les fichiers audio et les vidéos.
...
<table class="standard-table">
  ...
  <tbody>
    <tr>
      ...
      <td>
        Toutes les images qui ont un contenu significatif doivent avoir un texte alternatif approprié.
      </td>
      <td>
    ...
    <tr>
      <td>
        Les images ou graphiques doivent avoir une alternative accessible de fournie, qu'elle soit située sur la même page ou accessible avec un lien. On utilise un lien normal plutôt qu'un attribut <code>longdesc</code>.
      </td>
      <td>
        <p>
    ...
    <tr>
      <td>
        Le contenu multimédia (c'est-à-dire audio ou vidéo) doit au moins avoir une identification descriptive disponible, telle qu'une légende ou quelque chose de similaire.
      </td>
      <td>
        <p>
    ...
    <tr>
      <td>
        Les contrôles qui forment l'interface utilisateur comme les éléments de formulaire et les boutons doivent disposer de libellés textuels qui décrivent leur objectif.
      </td>
      <td>
...
<table>
  ...
  <tbody>
    <tr>
       ...
       <td>Une transcription doit être fournie pour les médias pré-enregistrés qui sont uniquement audio. Une transcription ou une description audio doit être fournie pour les médias pré-enregistrés qui sont uniquement vidéo (par exemple, une vidéo muette).</td>
    ...
    <tr>
       ...
       <td>Des sous-titres doivent être fournis pour les vidéos web (par exemple celles qui utilisent l'élément HTML <code>&lt;video&gt;</code>). Cela rend la vidéo accessible aux personnes qui ne peuvent pas entendre le son de la vidéo.</td>
    ...
    <tr>
       ...
       <td>Des sous-titres synchronisés doivent être fournis pour l'ensemble des médias en direct qui contiennent de l'audio (par exemple des conférences vidéo, des diffusions sonores en direct).</td>
       <td></td>
    </tr>
    <tr>
       <td>1.2.5 Fournir des descriptions audio pour les vidéos pré-enregistrées (AA)</td>
       <td>Des descriptions audio doivent être fournies pour les vidéos pré-enregistrées, uniquement lorsque l'audio existant ne suffit pas à exprimer pleinement la vidéo.</td>
       <td></td>
    </tr>
    <tr>
       <td>1.2.6 Fournir un équivalent en langue des signes pour l'audio pré-enregistré (AAA)</td>
       <td>Une vidéo équivalente en langue des signes doit être fournie pour tout contenu pré-enregistré contenant de l'audio.</td>
       <td></td>
    </tr>
    <tr>
       <td>1.2.7 Fournir une vidéo plus longue avec des descriptions audio (AAA)</td>
       <td>Lorsqu'il n'est pas possible de fournir des descriptions audio (voir 1.2.5) en raison des limites de temps (par exemple lorsqu'il n'y a pas suffisamment de pauses dans le contenu où insérer les descriptions audio), une version alternative de la vidéo doit être fournie et contenir des pauses insérées, avec les descriptions audio.</td>
       <td></td>
    </tr>
    <tr>
       <td>1.2.8 Fournir une alternative aux médias pré-enregistrés (AAA)</td>
       <td>Pour tous les contenus utilisant une vidéo, une transcription textuelle descriptive doit être fournie, par exemple le script d'un film. Il s'agit de rendre accessible le contenu pour les personnes qui ne peuvent pas l'entendre.</td>
    ...
    <tr>
       ...
       <td>Pour toute diffusion audio en direct, un texte descriptif doit être fourni, tel qu'un script de la pièce ou les paroles de la chanson diffusée. Il s'agit de rendre accessible le contenu pour les personnes qui ne peuvent pas l'entendre.</td>
       <td>Voir <a href="/fr/docs/Learn_web_development/Core/Accessibility/Multimedia#transcriptions_audio">les transcriptions audio</a> pour plus d'informations à ce sujet.</td>
    </tr>
 </tbody>
</table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <ul>
          <li>
            Les libellés textuels et les éléments de formulaire auxquels ils correspondent. Cette association est construite de façon non-ambigüe avec l'élément {{HTMLElement("label")}}, qui peut être utilisé par les lecteurs d'écran.
          </li>
          <li>
            Inclure des textes alternatifs pour les images. Le contenu sous forme d'image doit avoir un texte disponible qui décrit de façon claire le contenu de l'image et ce texte doit pouvoir être associé à l'image par un programme informatique (par exemple avec le texte porté par l'attribut <code>alt</code>), ou pouvoir facilement y être associé (la description est par exemple à côté de l'image). De cette façon, on peut connaître l'intégralité du contenu, même sans pouvoir voir l'image.
          </li>
          <li>
            Pour les listes, si l'ordre des éléments est important, on utilise une liste ordonnée ({{HTMLElement("ol")}}).
          </li>
        </ul>
      </td>
      <td>
        L'article <a href="/fr/docs/Learn_web_development/Core/Accessibility/HTML">HTML&nbsp;: une bonne base pour l'accessibilité</a> contient de nombreuses informations à ce propos, on peut notamment consulter <a href="/fr/docs/Learn_web_development/Core/Accessibility/HTML#une_bonne_sémantique">une bonne sémantique</a>, <a href="/fr/docs/Learn_web_development/Core/Accessibility/HTML#contrôles_de_linterface_utilisateur">les contrôles de l'interface utilisateur</a>,
    ...
    <tr>
      ...
      <td>
        Un ordre de lecture pertinent et logique doit pouvoir être déterminé facilement pour tout contenu, même si ce dernier est présenté visuellement de façon inhabituelle. L'ordre doit être clair grâce à l'utilisation d'éléments sémantiques (titres, paragraphes, etc.), le CSS étant utilisé pour toute mise en forme.
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <p>
          Les instructions pour manipuler des contrôles ou comprendre le contenu ne doivent pas reposer sur un seul sens. Le contraire peutit rendre le contenu inaccessible aux personnes ayant un handicap sur ce sens ou qui utilisent un appareil sans interface pour ce sens. Par exemple&nbsp;:
        </p>
        <ul>
          <li>
            <p>«&nbsp;Cliquez sur le bouton rond afin de continuer&nbsp;»</p>
            <p>Le bouton doit être libellé de façon claire afin qu'on puisse clairement identifier le bouton sur lequel il faut appuyer. S'il y a plusieurs boutons, on s'assure que leurs libellés sont clairs et permettent de distinguer leurs fonctions.</p>
          </li>
          <li>
            <p>«&nbsp;Écoutez les instructions audio pour de l'aide&nbsp;»</p>
            <p>Un exemple problématique&nbsp;: l'audio n'est pas accessible aux personnes ayant un handicap auditif, alors que le texte peut être lu par un lecteur d'écran si nécessaire.</p>
          </li>
          <li>
...
<table class="standard-table">
  <thead>
    ...
    <tr>
      ...
      <td>
          La couleur ne doit pas être utilisée seule pour véhiculer des informations. Ainsi, pour un formulaire, on ne marque pas un champ obligatoire avec seulement une couleur (comme le rouge). En complément ou à la place, on peut utiliser un astérisque avec un libellé «&nbsp;obligatoire&nbsp;», qui est plus approprié.
      </td>
      <td>
        Voir
    ...
    <tr>
      ...
      <td>
        Pour tout média audio dont la lecture dure plus de trois secondes, on fournit des contrôles accessibles afin de suspendre/reprendre la lecture et pour mettre en sourdine/ajuster le volume.
      </td>
      <td>
        On utilise des éléments <code>&lt;button&gt;</code> natifs afin de fournir des contrôles accessibles au clavier, comme montré dans <a href="/fr/docs/Web/Media/Guides/Audio_and_video_delivery/Video_player_styling_basics">Fondamentaux pour la mise en forme d'un lecteur vidéo</a>.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        La page doit être lisible et utilisable lorsque la taille du texte est doublée. Cela signifie que la disposition doit être adaptative afin que, lorsque la taille du texte est augmentée, le contenu soit toujours accessible.
      </td>
      <td></td>
    </tr>
    <tr>
      ...
      <td>
        Les images ne doivent <strong>pas</strong> être utilisées pour présenter du contenu où du texte simple peut suffire. Ainsi, si une image est principalement constituée de texte, on utilise plutôt ce texte.
      </td>
      <td></td>
    </tr>
    <tr>
      ...
      <td>
        ...
        <ul>
          <li>
            Le texte et son arrière-plan doit avoir un ratio de contraste supérieur à 7:1.
          </li>
          <li>
            Les titres (ou les textes plus grands) doivent avoir un ratio de contraste supérieur à 4.5:1. Le texte plus grand est défini comme ayant une taille supérieure ou égale à 18pt, ou 14pt en gras.
          </li>
        </ul>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <p>Pour la présentation du contenu textuel, les règles suivantes doivent être respectées&nbsp;:</p>
        <ul>
          <li>Les couleurs de premier plan et d'arrière-plan doivent pouvoir être sélectionnées par l'utilisateur·ice.</li>
          <li>
            Les blocs de texte ne doivent pas être plus larges que 80 caractères ou glyphes pour garantir une lisibilité maximale.
          </li>
          <li>
            Le texte ne doit pas être justifié (<code>text-align: justify;</code>).
          </li>
          <li>
            La hauteur des lignes doit être supérieure ou égale à 1,5 fois la taille du texte au sein des paragraphes (par exemple `line-height: 1.5;`), et au moins 2,25 fois la taille du texte entre les paragraphes (par exemple <code>padding: 2.25rem;</code>).
          </li>
          <li>
            Lorsque la taille du texte est doublée, le contenu ne doit pas avoir besoin du défilement.
          </li>
        </ul>
      </td>
      <td></td>
    ...
    <tr>
      ...
      <td>
        Le texte ne doit pas être présenté comme partie d'une image à moins qu'il s'agisse uniquement d'une décoration (c'est-à-dire qu'il ne véhicule aucun contenu) ou qu'il ne puisse être présenté d'une autre façon.
      </td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>1.4.13 Contenu au survol ou à la sélection (AA)</td>
      <td>
        <p>
          Bien que du contenu supplémentaire puisse apparaître et disparaître en fonction du survol et de la sélection au clavier, ce contenu doit respecter les trois critères suivants&nbsp;:
        </p>
        <ul>
          <li>
          ...
          <li>
            il est persistant (le contenu supplémentaire ne disparaît pas sans action de l'utilisateur·ice)
          </li>
        </ul>
      </td>
      <td>
        <a href="https://www.w3.org/WAI/WCAG21/Understanding/content-on-hover-or-focus.html">Comprendre le contenu au survol ou à la sélection <sup>(angl.)</sup></a>
      </td>
    </tr>
  </thead>
</table>
