...
Le rôle ARIA switch est très similaire au [role checkbox](/fr/docs/Web/Accessibility/ARIA/Roles/checkbox_role), à la sémantique près — il a deux états représentant on/off, au lieu de checked/unchecked.
