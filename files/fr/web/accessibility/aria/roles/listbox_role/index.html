...
<p>Cette technique présente l’utilisation du rôle <a href="http://www.w3.org/TR/wai-aria/roles#listbox">listbox</a> et décrit les effets produits sur les navigateurs et les technologies d’assistance.</p>
...
<p>Voir l’<a href="http://codetalks.org/source/widgets/listbox/listbox.html">exemple</a> CodeTalks pour plus de détails.</p>
...
<ul>
 <li>Pour être accessible au clavier, les développeurs doivent <a href="http://www.w3.org/TR/wai-aria/roles#option">gérer le focus</a> de chaque descendant de ce rôle.</li>
 ...
 <li>Si la boîte liste ne fait pas partie d’un autre composant, il faut définir sa propriété <a href="http://www.w3.org/TR/2010/WD-wai-aria-20100916/states_and_properties#aria-labelledby"><code>aria-labelledby</code></a>.</li>
 <li>Si une ou plusieurs entrées ne sont pas des descendants DOM de la boîte liste, il faudra définir des propriétés <code>aria-*</code> supplémentaires (voir <a href="http://www.w3.org/TR/wai-aria-practices/#listbox_div">Bonnes pratiques ARIA</a>).</li>
 <li>S’il existe une bonne raison pour <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-expanded">étendre</a> la boîte liste, le rôle <a href="http://www.w3.org/TR/wai-aria/roles#combobox">combobox</a> peut être plus approprié.</li>
</ul>
...
<ul>
 <li>Rôle <a href="http://www.w3.org/TR/wai-aria/roles#combobox">combobox</a>.</li>
</ul>

<h3 id="Autres_ressources">Autres ressources</h3>

<ul>
 <li>Bonnes pratiques ARIA – Listbox : <a href="http://www.w3.org/TR/wai-aria-practices/#listbox_div">#listbox_div</a></li>
