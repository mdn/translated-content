...
<i lang="en">Accessible Rich Internet Applications</i> **(<abbr>ARIA</abbr>)** (qu'on peut traduire par «&nbsp;applications internet riches et accessibles&nbsp;») est un ensemble de [rôles](/fr/docs/Web/Accessibility/ARIA/Reference/Roles) et [d'attributs](/fr/docs/Web/Accessibility/ARIA/Reference/Attributes) qui définissent comment rendre le contenu et les applications web accessibles (notamment ceux développés avec JavaScript) pour les personnes avec des handicaps.
...
> [!WARNING]
> La plupart de ces widgets ont été intégrés au sein d'HTML5 et **mieux vaut donc utiliser les éléments sémantiques** HTML lorsqu'ils sont disponibles. Ainsi, les éléments natifs disposent de fonctionnalités [de navigation au clavier](/fr/docs/Web/Accessibility/Guides/Keyboard-navigable_JavaScript_widgets), de rôles et d'états définis en standard. Toutefois, lorsque vous choisissez d'utiliser ARIA, il vous revient de recoder les fonctionnalités équivalentes dans vos scripts.
...
Voici un composant utilisé pour une barre de progression&nbsp;:
...
- [Implémenter des widgets JavaScript navigables au clavier](/fr/docs/Web/Accessibility/Guides/Keyboard-navigable_JavaScript_widgets)
  - : Les éléments HTML natifs tels que {{HTMLElement("input")}}, {{HTMLElement("button")}} disposent d'une accessibilité au clavier native. Si on imite ces fonctionnalités avec des éléments {{HTMLElement("div")}} et ARIA, il fauta s'assurer que les widgets ainsi créés restent accessibles au clavier.
...
- [Les ressources en français de WAI <sup>(angl.)</sup>](https://www.w3.org/WAI/translations/#fr)
  - Notamment [les règles pour l'accessibilité des contenus web (WCAG) 2.2 <sup>(angl.)</sup>](https://www.w3.org/Translations/WCAG22-fr/)
