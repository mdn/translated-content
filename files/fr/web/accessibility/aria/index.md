...
À la place, il aurait été beaucoup plus simple d'utiliser l'élément natif [`<progress>`](/fr/docs/Web/HTML/Reference/Elements/progress) à la place&nbsp;:
...
> [!NOTE]
> L'attribut `min` n'est pas autorisé pour l'élément [`<progress>`](/fr/docs/Web/HTML/Reference/Elements/progress), sa valeur minimale est toujours `0`.

> [!NOTE]
> Les éléments qui sont des points de repère dans la navigation du document ([`<main>`](/fr/docs/Web/HTML/Reference/Elements/main), [`<header>`](/fr/docs/Web/HTML/Reference/Elements/header), [`<nav>`](/fr/docs/Web/HTML/Reference/Elements/nav), etc.) ont des rôles ARIA implicites natifs, il n'est pas nécessaire de les dupliquer.
...
- [Implémenter des widgets JavaScript navigables au clavier](/fr/docs/Web/Accessibility/Guides/Keyboard-navigable_JavaScript_widgets)
  - : Les éléments natifs tels que [`<input>`](/fr/docs/Web/HTML/Reference/Elements/input), [`<button>`](/fr/docs/Web/HTML/Reference/Elements/button) disposent d'une accessibilité au clavier native. Si on imite ces fonctionnalités avec des éléments [`<div>`](/fr/docs/Web/HTML/Reference/Elements/div) et ARIA, il faudra s'assurer que les widgets ainsi créés restent accessibles au clavier.
