...
- L'interface API {{DOMxRef('DataTransfer')}}
- La propriété API {{DOMxRef('DataTransfer.dropEffect')}}
- L'évènement API {{DOMxRef("HTMLElement/dragstart_event", "dragstart")}}
