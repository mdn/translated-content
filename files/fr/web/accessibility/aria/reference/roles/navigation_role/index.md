...
- [`aria-label`](/fr/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-label)
  - : Brève description de la fonction de la navigation, sans inclure le terme «&nbsp;navigation&nbsp;», car le lecteur d'écran annonce à la fois le rôle et le contenu du label.
