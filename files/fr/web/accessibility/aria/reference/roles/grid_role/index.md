...
| Touche                             | Action                                                                                                                                                                                                                                                                                                               |
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <kbd>→</kbd>                       | Déplace le focus d'une cellule vers la droite. En option (grilles de mise en page), si le focus est sur la cellule la plus à droite de la ligne, le focus peut passer à la première cellule de la ligne suivante. Si le focus est sur la dernière cellule de la grille, le focus ne bouge pas.                       |
| <kbd>←</kbd>                       | Déplace le focus d'une cellule vers la gauche. En option (grilles de mise en page), si le focus est sur la cellule la plus à gauche de la ligne, le focus peut passer à la dernière cellule de la ligne précédente. Si le focus est sur la première cellule de la grille, le focus ne bouge pas.                     |
| <kbd>↓</kbd>                       | Déplace le focus d'une cellule vers le bas. En option (grilles de mise en page), si le focus est sur la cellule du bas de la colonne, le focus peut passer à la cellule du haut de la colonne suivante. Si le focus est sur la dernière cellule de la grille, le focus ne bouge pas.                                 |
| <kbd>↑</kbd>                       | Déplace le focus d'une cellule vers le haut. En option (grilles de mise en page), si le focus est sur la cellule du haut de la colonne, le focus peut passer à la cellule du bas de la colonne précédente. Si le focus est sur la première cellule de la grille, le focus ne bouge pas.                              |
| <kbd>Page&nbsp;bas</kbd>           | Déplace le focus vers le bas d'un nombre de lignes déterminé par l'auteur, faisant généralement défiler la grille pour que la dernière ligne de l'ensemble de lignes actuellement visibles devienne l'une des premières lignes visibles. Si le focus est sur la dernière ligne de la grille, le focus ne bouge pas.  |
| <kbd>Page&nbsp;haut</kbd>          | Déplace le focus vers le haut d'un nombre de lignes déterminé par l'auteur, faisant généralement défiler la grille pour que la première ligne de l'ensemble de lignes actuellement visibles devienne l'une des dernières lignes visibles. Si le focus est sur la première ligne de la grille, le focus ne bouge pas. |
| <kbd>Début</kbd>                   | Déplace le focus vers la première cellule de la ligne contenant le focus.                                                                                                                                                                                                                                            |
| <kbd>Fin</kbd>                     | Déplace le focus vers la dernière cellule de la ligne contenant le focus.                                                                                                                                                                                                                                            |
| <kbd>Ctrl</kbd> + <kbd>Début</kbd> | Déplace le focus vers la première cellule de la première ligne.                                                                                                                                                                                                                                                      |
| <kbd>Ctrl</kbd> + <kbd>Fin</kbd>   | Déplace le focus vers la dernière cellule de la dernière ligne.                                                                                                                                                                                                                                                      |
...
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <kbd>Ctrl</kbd> + <kbd>Espace</kbd> | Sélectionne la colonne contenant le focus.                                                                                                                                                                                                               |
| <kbd>Maj</kbd> + <kbd>Espace</kbd>  | Sélectionne la ligne contenant le focus. Si la grille comprend une colonne avec des cases à cocher pour sélectionner des lignes, cette combinaison de touches peut être utilisée pour cocher cette case même si le focus n'est pas sur la case à cocher. |
