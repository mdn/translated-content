...
N'utilisez pas la propriété raccourcie [`background`](/fr/docs/Web/CSS/background), car cela écraserait la propriété [`background-clip`](/fr/docs/Web/CSS/background-clip) utilisée pour créer l'effet bouton radio.
