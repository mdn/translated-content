...
Si vous utilisez un lecteur d'écran, avez-vous remarqué que, dans Firefox, ce réglage est annoncé comme «&nbsp;Supprimer l'historique après 21 jours&nbsp;», suivi de l'annonce que vous êtes dans un champ de saisie contenant le nombre 21&nbsp;? Pratique&nbsp;: il n'est pas nécessaire de naviguer pour connaître l'unité. «&nbsp;Jours&nbsp;» peut être remplacé par «&nbsp;mois&nbsp;» ou «&nbsp;années&nbsp;», et dans de nombreux dialogues classiques, il n'y a aucun moyen de le savoir sans naviguer avec des commandes de revue d'écran.
