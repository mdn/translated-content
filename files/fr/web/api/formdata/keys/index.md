...
La méthode `FormData.keys()` renvoie une {{jsxref("Iteration_protocols", "itération")}} permettant de parcourir toutes les clés contenues dans cet objet. Les clés sont des objets {{domxref("USVString")}}.
