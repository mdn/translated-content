---
title: "HTMLTemplateElement : propriété shadowRootMode"
...
La propriété **`shadowRootMode`** de l'interface {{DOMxRef("HTMLTemplateElement")}} reflète la valeur de l'attribut [`shadowrootmode`](/fr/docs/Web/HTML/Reference/Elements/template#shadowrootmode) de l'élément HTML {{HTMLElement("template")}} associé.
...
Reflète la valeur de l'attribut [`shadowrootmode`](/fr/docs/Web/HTML/Reference/Elements/template#shadowrootmode) de l'élément HTML {{HTMLElement("template")}} associé.
...
- L'attribut [`shadowrootmode`](/fr/docs/Web/HTML/Reference/Elements/template#shadowrootmode) de l'élément `<template>`
