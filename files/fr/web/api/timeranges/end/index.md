...
La méthode **`end()`** de l'interface {{DOMxRef("TimeRanges")}} retourne le décalage temporel (en secondes) auquel se termine une plage de temps définie.
...
- `index`
  - : Un nombre indiquant la plage pour laquelle l'heure de fin doit être retournée.
