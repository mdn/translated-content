...
Le mode image dans l'image est disponible par défaut, sauf si cela est interdit par les [politiques de permission](/fr/docs/Web/HTTP/Reference/Headers/Permissions-Policy/picture-in-picture) de la page.
