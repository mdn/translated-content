...
Une promesse ({{JSxRef("Promise")}}) qui se résout avec un tableau contenant jusqu'à trois objets représentant les sujets sélectionnés par l'utilisateur·ice pour les trois dernières époques. Chaque objet contient les propriétés suivantes&nbsp;:
...
Les valeurs exactes des propriétés peuvent varier selon l'implémentation du navigateur. Un exemple d'objet provenant de Chrome peut ressembler à ce qui suit&nbsp;:
...
- `NotAllowedError` {{DOMxRef("DOMException")}}
  - : Levée si&nbsp;:
    ...
    - Le site appelant n'a pas inclus l'API Topics dans un [processus d'inscription réussi au bac à sable de confidentialité](/fr/docs/Web/Privacy/Guides/Privacy_sandbox#inscription).
