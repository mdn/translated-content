...
- La chaînes de caractères de la valeur du cookie peut utiliser {{JSxRef("encodeURIComponent()")}} pour s'assurer que la chaîne de caractères ne contient pas de virgules, de points-virgules ou d'espaces (qui ne sont pas autorisés dans les valeurs des cookies).
