...
- `namespace` l'URI d'espace de noms des éléments à rechercher (voir [`element.namespaceURI`](/fr/docs/DOM/Node.namespaceURI)).
- `name` est, soit le nom local des éléments à rechercher, soit la valeur spéciale `"*"` pour tous les éléments (voir [`element.localName`](/fr/docs/DOM/Node.localName)).
