...
La propriété **`xmlVersion`** de l'interface {{DOMxRef("Document")}} retourne le numéro de version comme défini dans la déclaration XML (par exemple, `<?xml version="1.0"?>`) ou «&nbsp;1.0&nbsp;» si la déclaration est absente.
