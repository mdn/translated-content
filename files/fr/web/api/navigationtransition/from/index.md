---
title: "NavigationTransition : propriété from"
short-title: from
...
La propriété en lecture seule **`from`** de l'interface {{DOMxRef("NavigationTransition")}} retourne le {{DOMxRef("NavigationHistoryEntry")}} depuis lequel la transition provient.
