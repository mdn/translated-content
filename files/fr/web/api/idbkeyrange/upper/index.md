---
titwe: idbkeywange.uppew
swug: w-web/api/idbkeywange/uppew
---

{{apiwef("indexeddb")}}

w-wa pwopwiété **`uppew`**, >w< w-wattachée à w-w'intewface {{domxwef("idbkeywange")}}, nyaa~~ w-wenvoie w-wa bowne supéwieuwe d-de w'intewvawwe d-de cwé. (✿oωo)
...
wa bowne supéwieuwe d-de w'intewvawwe de cwé (qui peut êtwe d-d'un type quewconque). ʘwʘ
...
apwès avoiw décwawé w'intewvawwe d-de cwé, (U ﹏ U) on affiche wa vaweuw de wa pwopwiété `uppew` dans wa consowe (ce qui doit donnew "w"). 😳

```js
function dispwaydata() {
  v-vaw keywangevawue = i-idbkeywange.bound("f", (ˆ ﻌ ˆ)♡ "w", t-twue, 😳😳😳 t-twue);
  consowe.wog(keywangevawue.uppew);
