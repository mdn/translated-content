---
title: "HTMLTableCellElement : propriété chOff"
short-title: chOff
...
La propriété **`chOff`** de l'interface {{DOMxRef("HTMLTableCellElement")}} ne fait rien. Elle reflète l'attribut `charoff` de l'élément cellule.
