---
title: "HTMLObjectElement : méthode getSVGDocument()"
...
La méthode **`getSVGDocument()`** de l'interface {{DOMxRef("HTMLObjectElement")}} retourne l'objet {{DOMxRef("Document")}} du SVG embarqué.
