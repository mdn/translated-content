...
La propriété en lecture seule **`AnimationEvent.pseudoElement`** est une {{jsxref("String")}}, commençant par `'::'`, contenant le nom du [pseudo-élément](/fr/docs/Web/CSS/Reference/Selectors/Pseudo-elements) sur lequel tourne l'animation. Si l'animation ne tourne pas sur un pseudo-élément, mais sur un élément, c'est une chaîne de caractère vide : `''`.
