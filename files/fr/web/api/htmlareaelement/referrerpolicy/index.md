...
- `same-origin`
  - : Un référent sera envoyé pour les [origines de même site](/fr/docs/Web/Security/Same-origin_policy), mais les requêtes d'origine croisée ne contiendront aucune information de référent.
- `strict-origin`
