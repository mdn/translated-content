...
Le format de la chaîne de caractères doit respecter l'une des microsyntaxes HTML suivantes (voir {{CSSxRef("color_value", "&lt;color&gt;")}})&nbsp;:

| Microsyntaxe             | Description                           | Exemples                  |
| ------------------------ | ------------------------------------- | ------------------------- |
| Nom de couleur valide    | _nameOfColor (insensible à la casse)_ | `Green`, `green`, `GREEN` |
| Chaîne hexadécimale      | _#RRVVBB_                             | `#008000`                 |
