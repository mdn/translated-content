...
Cet exemple utilise `onblur` et [`onfocus`](/fr/docs/Web/API/GlobalEventHandlers/onfocus) pour changer le texte au s'in d'un élément [`<input>`](/fr/docs/Web/HTML/Element/Input).
