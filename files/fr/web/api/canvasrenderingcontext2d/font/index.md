...
La propriété **`CanvasRenderingContext2D.font`** de l'API Canvas 2D API spécifie le style de texte à utiliser pour dessiner du texte. Cette chaîne utilise la même syntaxe que le spécificateur de [police CSS](/fr/docs/Web/CSS/Reference/Properties/font). La police par défaut est 10px sans-serif.
