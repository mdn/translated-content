---
title: "NavigationDestination : propriété url"
short-title: url
...
La propriété en lecture seule **`url`** de l'interface {{DOMxRef("NavigationDestination")}} retourne l'URL vers laquelle la navigation est effectuée.
...
### Gérer une navigation utilisant `intercept()`
