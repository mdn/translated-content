---
title: "Accelerometer : propriété z"
short-title: z
...
La propriété en lecture seule **`z`** de l'interface {{DOMxRef("Accelerometer")}} retourne un nombre définissant l'accélération de l'appareil le long de son axe z.
