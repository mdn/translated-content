...
> Les navigateurs accédant à des pages web ne rencontrent jamais ce code d'état&nbsp;; dans les cas erronés où cela se produit, ils le traitent comme un code d'état générique {{HTTPStatus(400)}}.
