...
Le code de statut de [réponse d'erreur client](/fr/docs/Web/HTTP/Reference/Status#réponses_derreur_côté_client) HTTP **`425 Too Early`** indique que le serveur n'a pas voulu prendre le risque de traiter une requête qui peut être rejouée afin d'éviter d'éventuelles attaques par rejeu.
