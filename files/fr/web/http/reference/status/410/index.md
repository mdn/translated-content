...
Si vous ne savez pas si cette absence est temporaire ou permanente, il est préférable de renvoyer un code de statut [`404`](/fr/docs/Web/HTTP/Reference/Status/404).
...
- [`404`](/fr/docs/Web/HTTP/Reference/Status/404)
