...
Un serveur doit envoyer l'en-tête [`Connection: close`](/fr/docs/Web/HTTP/Headers/Connection) en réponse, puisque `408` implique que le serveur a décidé de fermer la connexion plutôt que de continuer à attendre.
