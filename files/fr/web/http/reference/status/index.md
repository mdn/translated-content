...
- [`100 Continue`](/fr/docs/Web/HTTP/Reference/Status/100)
...
- [`101 Switching Protocols`](/fr/docs/Web/HTTP/Reference/Status/101)
  - : Ce code est envoyé en réponse à un en-tête de requête [`Upgrade`](/fr/docs/Web/HTTP/Reference/Headers/Upgrade) de la part du client et indique le protocole sur lequel passe le serveur.
...
- [`103 Early Hints`](/fr/docs/Web/HTTP/Reference/Status/103)
  - : Ce code de statut est conçu pour être utilisé avec l'en-tête [`Link`](/fr/docs/Web/HTTP/Reference/Headers/Link), ce qui permet à l'agent utilisateur de commencer [le préchargement](/fr/docs/Web/HTML/Reference/Attributes/rel/preload) des ressources tandis que le serveur prépare une réponse.
...
- [`201 Created`](/fr/docs/Web/HTTP/Reference/Status/201)
...
- [`202 Accepted`](/fr/docs/Web/HTTP/Reference/Status/202)
...
- [`203 Non-Authoritative Information`](/fr/docs/Web/HTTP/Reference/Status/203)
...
- [`204 No Content`](/fr/docs/Web/HTTP/Reference/Status/204)
...
- [`205 Reset Content`](/fr/docs/Web/HTTP/Reference/Status/205)
...
- [`300 Multiple Choices`](/fr/docs/Web/HTTP/Reference/Status/300)
...
- [`302 Found`](/fr/docs/Web/HTTP/Reference/Status/302)
...
- [`303 See Other`](/fr/docs/Web/HTTP/Reference/Status/303)
...
- [`307 Temporary Redirect`](/fr/docs/Web/HTTP/Reference/Status/307)
...
- [`400 Bad Request`](/fr/docs/Web/HTTP/Reference/Status/400)
  - : Cette réponse indique que le serveur n'a pas pu comprendre la requête à cause d'une syntaxe invalide.
- [`401 Unauthorized`](/fr/docs/Web/HTTP/Reference/Status/401)
...
- [`402 Payment Required`](/fr/docs/Web/HTTP/Reference/Status/402) {{experimental_inline}}
...
- [`403 Forbidden`](/fr/docs/Web/HTTP/Reference/Status/403)
  - : Le client n'a pas les droits d'accès au contenu, donc le serveur refuse de donner la véritable réponse.
- [`404 Not Found`](/fr/docs/Web/HTTP/Reference/Status/404)
...
- [`405 Method Not Allowed`](/fr/docs/Web/HTTP/Reference/Status/405)
...
- [`406 Not Acceptable`](/fr/docs/Web/HTTP/Reference/Status/406)
...
- [`407 Proxy Authentication Required`](/fr/docs/Web/HTTP/Reference/Status/407)
  - : Similaire au code `401`, sauf que l'authentification doit être effectuée au travers d'un proxy.
- [`408 Request Timeout`](/fr/docs/Web/HTTP/Reference/Status/408)
...
- [`409 Conflict`](/fr/docs/Web/HTTP/Reference/Status/409)
  - : Cette réponse est envoyée quand une requête entre en conflit avec l'état actuel du serveur.
- [`410 Gone`](/fr/docs/Web/HTTP/Reference/Status/410)
...
- [`415 Unsupported Media Type`](/fr/docs/Web/HTTP/Reference/Status/415)
...
- [`417 Expectation Failed`](/fr/docs/Web/HTTP/Reference/Status/417)
...
- [`418 I'm a teapot`](/fr/docs/Web/HTTP/Reference/Status/418)
...
- [`422 Unprocessable Entity`](/fr/docs/Web/HTTP/Reference/Status/422) ([WebDAV](/fr/docs/Glossary/WebDAV))
...
- [`425 Too Early`](/fr/docs/Web/HTTP/Reference/Status/425) {{experimental_inline}}
...
- [`426 Upgrade Required`](/fr/docs/Web/HTTP/Reference/Status/426)
  - : Le serveur refuse de traiter la requête en utilisant le protocole actuel mais peut accepter de le faire si le client opte pour un autre protocole. Le serveur _doit_ envoyer un en-tête [`Upgrade`](/fr/docs/Web/HTTP/Reference/Headers/Upgrade) dans la réponse 426 pour indiquer le(s) protocole(s) demandé(s) ([Section 6.7 de \[RFC7230\]](https://tools.ietf.org/html/rfc7230#section-6.7)).
- [`428 Precondition Required`](/fr/docs/Web/HTTP/Reference/Status/428)
...
- [`429 Too Many Requests`](/fr/docs/Web/HTTP/Reference/Status/429)
  - : L'utilisateur a émis trop de requêtes dans un laps de temps donné.
- [`431 Request Header Fields Too Large`](/fr/docs/Web/HTTP/Reference/Status/431)
...
- [`451 Unavailable For Legal Reasons`](/fr/docs/Web/HTTP/Reference/Status/451)
...
- [`500 Internal Server Error`](/fr/docs/Web/HTTP/Reference/Status/500)
  - : Le serveur a rencontré une situation qu'il ne sait pas traiter.
- [`501 Not Implemented`](/fr/docs/Web/HTTP/Reference/Status/501)
...
- [`502 Bad Gateway`](/fr/docs/Web/HTTP/Reference/Status/502)
...
- [`503 Service Unavailable`](/fr/docs/Web/HTTP/Reference/Status/503)
...
- [`504 Gateway Timeout`](/fr/docs/Web/HTTP/Reference/Status/504)
...
- [`505 HTTP Version Not Supported`](/fr/docs/Web/HTTP/Reference/Status/505)
  - : La version de HTTP utilisée dans la requête n'est pas prise en charge par le serveur.
- [`506 Variant Also Negotiates`](/fr/docs/Web/HTTP/Reference/Status/506)
...
- [`507 Insufficient Storage`](/fr/docs/Web/HTTP/Reference/Status/507) ([WebDAV](/fr/docs/Glossary/WebDAV))
...
- [`508 Loop Detected`](/fr/docs/Web/HTTP/Reference/Status/508) ([WebDAV](/fr/docs/Glossary/WebDAV))
  - : Le serveur a détecté une boucle infinie en traitant la requête.
- [`510 Not Extended`](/fr/docs/Web/HTTP/Reference/Status/510)
  - : Des extensions supplémentaires sont requises afin que le serveur puisse satisfaire la requête.
- [`511 Network Authentication Required`](/fr/docs/Web/HTTP/Reference/Status/511)
