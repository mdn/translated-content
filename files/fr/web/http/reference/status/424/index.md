...
Par exemple, dans {{Glossary("WebDAV")}}, si une requête `PROPPATCH` est envoyée et qu'une commande échoue, alors toutes les autres commandes échouent automatiquement avec `424 Failed Dependency`.
