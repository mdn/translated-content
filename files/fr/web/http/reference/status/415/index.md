...
Le problème de format peut être causé par les valeurs des en-têtes [`Content-Type`](/fr/docs/Web/HTTP/Reference/Headers/Content-Type) ou [`Content-Encoding`](/fr/docs/Web/HTTP/Reference/Headers/Content-Encoding) dans la requête ou, plus directement, à cause de l'inspection des données.
