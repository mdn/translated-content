...
Un navigateur recevant ce statut demande automatiquement la ressource à l'URL de l'en-tête `Location`, redirigeant l'utilisateur·ice vers la nouvelle page.
Les moteurs de recherche recevant cette réponse n'attribuent pas les liens de l'URL d'origine à la nouvelle ressource, ce qui signifie qu'aucune valeur de {{Glossary("SEO")}} n'est transférée à la nouvelle URL.
...
```http
HTTP/1.1 302 Found
Location: https://www.example.com/url-nouveau-profil
