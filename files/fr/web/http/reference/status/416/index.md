...
Lorsqu'il rencontre cette erreur, le navigateur interrompt généralement l'opération (par exemple, un téléchargement est considéré comme ne pouvant pas reprendre) ou demande à nouveau l'intégralité du document sans plages.
...
Le serveur prend en charge les requêtes de plage et retourne la longueur actuelle de la représentation sélectionnée dans l'en-tête {{HTTPHeader("Content-Range")}}&nbsp;:
