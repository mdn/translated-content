...
Bien qu'initialement défini dans la [RFC 2324 <sup>(angl.)</sup>](https://www.rfc-editor.org/info/rfc2324) comme une blague du 1er avril, ce code de statut a été officiellement réservé dans la [RFC 9110 <sup>(angl.)</sup>](https://www.rfc-editor.org/info/rfc9110) en raison de sa large utilisation comme blague, il ne peut donc pas recevoir de sémantique sérieuse dans un avenir prévisible.
