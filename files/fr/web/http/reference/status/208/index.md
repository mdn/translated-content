...
Les réponses pour tous les autres liens signalent ce code de statut `208`, afin qu'aucun conflit ne soit créé et que la réponse reste plus courte.
...
<D:multistatus xmlns:D="DAV:">
  ...
  <D:response>
    <D:href>http://www.example.com/Coll/Tata</D:href>
    <D:propstat>
      <D:prop>
        <D:displayname>Boucle de démonstration</D:displayname>
        <D:resource-id>
