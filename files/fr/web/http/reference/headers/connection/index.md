...
> [!NOTE]
> [Les champs d'en-tête spécifiques à la connexion (tels que `Connection`) ne doivent pas être utilisés avec HTTP/2.](https://tools.ietf.org/html/rfc7540#section-8.1.2.2)
...
<table class="properties">
  <tbody>
    <tr>
      ...
      <td><a href="/fr/docs/Glossary/General_header">En-tête général</a></td>
    </tr>
    <tr>
      <th scope="row">
