...
- Autres en-têtes en rapport : [`TE`](/fr/docs/Web/HTTP/Headers/TE), [`Accept`](/fr/docs/Web/HTTP/Reference/Headers/Accept), [`Accept-Charset`](/fr/docs/Web/HTTP/Headers), [`Accept-Language`](/fr/docs/Web/HTTP/Reference/Headers/Accept-Language)
