...
Le code de réponse d'erreur HTTP **`406 Not Acceptable`** indique qu'il est impossible de servir une réponse qui satisfait aux critères définis dans les en-têtes [`Accept-Charset`](/fr/docs/Web/HTTP/Headers/Accept-Charset) et [`Accept-Language`](/fr/docs/Web/HTTP/Headers/Accept-Language).
...
- [`Accept-Charset`](/fr/docs/Web/HTTP/Headers/Accept-Charset)
