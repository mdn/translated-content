...
<table class="properties">
  <tbody>
    <tr>
      ...
      <td>
        Contenu de métadonnées. Si [itemprop](/fr/docs/Web/HTML/Global_attributes#itemprop) est
        présent :
    ...
    <tr>
      ...
      <td>
        ...
        [itemprop](/fr/docs/Web/HTML/Global_attributes#itemprop) est présent, tout élément qui
        accepte du
        <a href="/fr/docs/Web/HTML/Catégorie_de_contenu#Contenu_phrasé"
          >contenu phrasé</a
        >.
