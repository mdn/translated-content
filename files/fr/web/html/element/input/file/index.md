...
<table class="properties">
  <tbody>
    ...
    <tr>
      ...
      <td>
        [accept](/fr/docs/Web/HTML/Element/input/file#accept),
        [capture](/fr/docs/Web/HTML/Element/input/file#capture),
        [files](/fr/docs/Web/HTML/Element/input/file#files),
        [multiple](/fr/docs/Web/HTML/Element/input/file#multiple)
      </td>
    </tr>
    <tr>
