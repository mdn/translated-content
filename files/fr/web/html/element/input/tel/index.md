...
La valeur de ce champ, portée par l'attribut [`value`](/fr/docs/Web/HTML/Element/input#attr-value) est une chaîne de caractères ([`DOMString`](/fr/docs/Web/JavaScript/Reference/Global_Objects/String)) qui peut être une chaîne vide ou un numéro de téléphone.
...
Le champ [ne sera pas valide](/fr/docs/Web/HTML/Constraint_validation) si la longueur du numéro de téléphone dépasse `maxlength` en nombre de points de code UTF-16.
...
Le champ [ne sera pas valide](/fr/docs/Web/HTML/Constraint_validation) si la longueur du numéro de téléphone est inférieure à `minlength` en nombre de points de code UTF-16.
