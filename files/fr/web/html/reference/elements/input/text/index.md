...
En complément des attributs communs à l'ensemble des éléments [`<input>`](/fr/docs/Web/HTML/Reference/Elements/input), les champs textuels prennent en charge les attributs suivants&nbsp;:
