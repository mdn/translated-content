...
- `media`
  - : [Une requête média](/fr/docs/Web/CSS/Guides/Media_queries/Using) pour sélectionner la source du média. Cet attribut doit uniquement être utilisé pour un élément {{HTMLElement("picture")}}.
- `sizes`
