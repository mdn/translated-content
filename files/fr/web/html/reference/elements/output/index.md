...
- `for`
  - : Une liste d'[identifiants](/fr/docs/Web/HTML/Reference/Global_attributes/id) d'autres éléments, séparés par des espaces, qui ont joué un rôle dans le calcul (en tant que valeurs d'entrée ou autrement).
- `form`
