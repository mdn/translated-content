...
Par défaut, la plupart des outils d'assistance n'annoncent pas la présence de l'élément `del`. On peut le rendre annonçable via la propriété CSS [`content`](/fr/docs/Web/CSS/Reference/Properties/content) et grâce aux pseudo-éléments [`::before`](/fr/docs/Web/CSS/Reference/Selectors/::before) et [`::after`](/fr/docs/Web/CSS/Reference/Selectors/::after).
