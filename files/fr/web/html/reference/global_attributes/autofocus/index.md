...
L'[attribut universel](/fr/docs/Web/HTML/Reference/Global_attributes) **`autofocus`** est un attribut booléen indiquant qu'un élément devrait recevoir le focus au chargement de la page ou lorsque l'élément HTML {{HTMLElement("dialog")}} dont il fait éventuellement partie est affiché.
