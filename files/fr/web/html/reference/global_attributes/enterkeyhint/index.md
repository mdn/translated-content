...
[L'attribut universel](/fr/docs/Web/HTML/Reference/Global_attributes) **`enterkeyhint`**
...
Les [contrôles de formulaires](/fr/docs/conflicting/Learn_web_development/Extensions/Forms) (tels que les éléments [`<textarea>`](/fr/docs/Web/HTML/Reference/Elements/textarea)
...
[`type`](/fr/docs/Web/HTML/Reference/Elements/input#input_types),
ou [`pattern`](/fr/docs/Web/HTML/Reference/Elements/input#htmlattrdefpattern) pour afficher une clé de saisie (ou une icône) adaptée.
