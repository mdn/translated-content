...
Les {{HTMLElement("dialog")}} modaux générés avec {{DOMxRef("HTMLDialogElement/showModal", "showModal()")}} échappent à l'inertie, ce qui signifie qu'ils n'héritent pas de l'inertie de leurs ancêtres, mais peuvent être rendus inertes si l'attribut `inert` leur est explicitement appliqué. Aucun autre élément ne peut échapper à l'inertie.
