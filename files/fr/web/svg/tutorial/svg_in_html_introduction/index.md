...
<p>Voici le code source de cet exemple :</p>
...
<h3 id="Liens_sur_le_sujet">Liens sur le sujet</h3>

<ul>
 <li>L'article wikipedia sur le format <a href="http://fr.wikipedia.org/wiki/Scalable_Vector_Graphics">SVG</a></li>
 <li>La page <a href="http://svg-whiz.com/wiki/index.php?title=Inline_SVG">Inline SVG</a> sur le wiki SVG</li>
</ul>