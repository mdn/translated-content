...
- [Les concepts de WebAssembly](/fr/docs/WebAssembly/Guides/Concepts)
  - : Découvrez les concepts clés de WebAssembly : ce que c'est, son utilité, l'intégration dans le Web et comment l'utiliser.
- [Compiler du code C/C++ en WebAssembly](/fr/docs/WebAssembly/Guides/C_to_Wasm)
...
- [Charger et exécuter du code WebAssembly](/fr/docs/WebAssembly/Guides/Loading_and_running)
  - : Dans cet article, on aborde comment récupérer, compiler et instancier en associant l'API [WebAssembly JavaScript](/fr/docs/WebAssembly/Reference/JavaScript_interface) avec les API [Fetch](/fr/docs/Web/API/Fetch_API) ou [XHR](/fr/docs/Web/API/XMLHttpRequest).
...
- [Les fonctions WebAssembly exportées](/fr/docs/WebAssembly/Guides/Exported_functions)
...
- {{jsxref("Objets_globaux/WebAssembly/Instance", "WebAssembly.Instance")}}
  - : Un objet `WebAssembly.Instance` est une instance exécutable (disposant d'un état) d'un `Module`. Les objets `Instance` contiennent toutes les [fonctions WebAssembly exportées](/fr/docs/WebAssembly/Guides/Exported_functions) qui permettent d'utiliser du code WebAssembly via du code JavaScript.
