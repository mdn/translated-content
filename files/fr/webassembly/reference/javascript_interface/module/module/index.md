...
- _bufferSource_
  - : Un [tableau typé](/fr/docs/Web/JavaScript/Guide/Typed_arrays) ou un [`ArrayBuffer`](/fr/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer) contenant le code binaire du module .wasm qu'on souhaite compiler.
