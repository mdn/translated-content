...
- [`WebAssembly.Tag()`](/fr/docs/WebAssembly/Reference/JavaScript_interface/Tag/Tag)
  - : Crée un nouvel objet `WebAssembly.Tag`.

## Méthodes des instances

- [`Tag.prototype.type()`](/fr/docs/WebAssembly/Reference/JavaScript_interface/Tag/type)
...
> [!NOTE]
> Il existe d'autres façons&nbsp;: on pourrait aussi utiliser la balise afin de créer un objet [`WebAssembly.Exception`](/fr/docs/WebAssembly/Reference/JavaScript_interface/Exception) et la déclencher depuis une fonction appelée côté WebAssembly.
