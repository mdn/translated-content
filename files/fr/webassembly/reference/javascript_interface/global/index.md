...
- [`WebAssembly.Global()`](/fr/docs/WebAssembly/Reference/JavaScript_interface/Global/Global)
...
- `Global.prototype.constructor`
  - : Renvoie la fonction qui a créé cette instance d'objet. Par défaut, c'est le constructeur [`WebAssembly.Global()`](/fr/docs/WebAssembly/Reference/JavaScript_interface/Global/Global).
