...
- [Emscripten <sup>(angl.)</sup>](https://github.com/emscripten-core/emscripten/wiki)
...
- [Firefox Profiler <sup>(angl.)</sup>](https://profiler.firefox.com/docs/#/)
...
<table class="no-markdown standard-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="/fr/docs/Web/API/WebGL_API">WebGL</a> (<a href="https://www.khronos.org/opengles/">OpenGL ES <sup>(angl.)</sup></a> 2.0)
      </td>
    </tr>
    <tr>
...
- [L'API de verrouillage du pointeur](/fr/docs/Web/API/Pointer_Lock_API)
...
- [L'API audio Web](/fr/docs/Web/API/Web_Audio_API)
...
- [À propos d'Emscripten <sup>(angl.)</sup>](https://emscripten.org/docs/introducing_emscripten/about_emscripten.html) pour une introduction, y compris les détails de haut niveau.
- [Télécharger et installer <sup>(angl.)</sup>](https://emscripten.org/docs/getting_started/downloads.html) la chaîne d'outils.
- [Tutoriel Emscripten <sup>(angl.)</sup>](https://emscripten.org/docs/getting_started/Tutorial.html) pour un tutoriel pour vous apprendre à commencer.
