...
> [!NOTE]
> La plupart des communautés publient un document appelé **Code de conduite** (ou **règles de participation**) qui définit les comportements attendus des participant·e·s à leur projet. Ces règles incluent généralement la définition des comportements inacceptables, les conséquences associées et la façon de les signaler. Par exemple, MDN est régi par les [Règles de participation de la communauté Mozilla](https://www.mozilla.org/fr/about/governance/policies/participation/).

## Aider les autres, poser des questions

Si un·e collègue ou un contact de votre réseau rencontre des difficultés, proposez-lui votre aide. Les développeur·euse·s web qui aident les autres ont beaucoup plus de chances de tisser des liens solides et de recevoir de l'aide en retour.
...
Les relectures entre pair·e·s sont aussi un bon moyen de s'entraîner à cela ([voir ci-dessous](#travail_d_équipe_et_relectures_entre_pairs)).
...
Si vous ne savez pas ce qu'est l'open source, pourquoi ou comment commencer à contribuer, les ressources suivantes sont très utiles&nbsp;:

- [Comment contribuer à des projets open source - Guide du·de la débutant·e <sup>(angl.)</sup>](https://www.freecodecamp.org/news/how-to-contribute-to-open-source-projects-beginners-guide/)
- [L'étiquette open source](/fr/docs/MDN/Community/Open_source_etiquette)
...
- Communiquer régulièrement et ouvertement pour détecter les problèmes tôt et que tout le monde sache ce qui se passe.
...
Un problème courant qui pousse les étudiant·e·s et les nouveaux·elles développeur·euse·s à éviter d'expérimenter ou de prendre des risques (par exemple en lançant de nouveaux projets ou en explorant de nouvelles idées) est la peur de l'échec et du jugement des pair·e·s ou de l'équipe. Prenez le temps de comprendre la valeur de l'apprentissage par l'erreur.

L'échec n'est qu'une petite étape sur le chemin du succès. Tous·tes les développeur·euse·s les plus expérimenté·e·s ont échoué de nombreuses fois, et ce n'est pas l'échec en soi qui compte, mais la façon dont vous le gérez et les leçons que vous en tirez.

Voici quelques conseils&nbsp;:

- Définissez un espace ou groupe de pair·e·s où chacun·e peut poser des questions librement — il n'y a pas de «&nbsp;mauvaises questions&nbsp;», seulement des personnes qui n'osent pas demander. Favorisez une culture où les pair·e·s s'entraident et où l'échec n'est pas jugé sévèrement.
- Appuyez-vous sur votre réseau et essayez de trouver des groupes en ligne ou en présentiel qui peuvent vous aider, vous conseiller, ou qui rencontrent les mêmes difficultés et peuvent vous soutenir ou expérimenter avec vous.
- (Pour les enseignant·e·s) Prévoyez des barèmes d'évaluation qui permettent d'obtenir une note correcte même si le résultat n'est pas parfait, à condition que la démarche soit bien documentée. Donnez des points supplémentaires pour l'innovation.
- Organisez des sessions de partage ou des entretiens individuels en cours de projet avec des pair·e·s ou des mentors pour obtenir des retours et des conseils sur la façon de progresser.
- Organisez des réunions de rétrospective pour analyser les projets, voir ce qui n'a pas bien fonctionné et discuter des pistes d'amélioration pour la prochaine fois.
