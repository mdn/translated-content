...
Ce module est principalement théorique et ne suppose aucune connaissance pratique spécifique des technologies web. Cependant, nous vous recommandons de suivre les modules précédents avant d'aborder celui-ci.
...
- [Trouver un emploi](/fr/docs/Learn_web_development/Getting_started/Soft_skills/Finding_a_job)
  - : Les entretiens techniques peuvent être exigeants, et certains ont des critères très spécifiques. Trouver les bons postes à viser peut être difficile&nbsp;! Cet article donne des conseils et ressources pour toutes les étapes, de la recherche d'offres à la réussite des entretiens.
