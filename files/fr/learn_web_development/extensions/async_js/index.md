...
- [Introduction au JavaScript asynchrone](/fr/docs/Learn_web_development/Extensions/Async_JS/Introducing)
...
- [Comment utiliser les promesses](/fr/docs/Learn_web_development/Extensions/Async_JS/Promises)
...
- [Implémenter une API fonctionnant avec les promesses](/fr/docs/Learn_web_development/Core/Scripting/Asynchronous/Implementing_a_promise-based_API)
  - : Cet article détaille comment implémenter sa propre API utilisant les promesses.
- [Introduction aux <i lang="en">workers</i>](/fr/docs/Learn_web_development/Extensions/Async_JS/Introducing_workers)
...
- [Ordonnancer des animations](/fr/docs/Learn_web_development/Core/Scripting/Asynchronous/Sequencing_animations)
