...
Vous devez vraiment apprendre les bases des langages [HTML](/fr/docs/Learn_web_development/Core/Structuring_content), [CSS](/fr/docs/Learn_web_development/Core/Styling_basics), et [JavaScript](/fr/docs/Learn_web_development/Core/Scripting) de base avant d'essayer d'utiliser les outils détaillés ici.
...
- [Implémentation de la détection des fonctionnalités](/fr/docs/Learn_web_development/Extensions/Testing/Feature_detection)
...
- [Introduction aux tests automatisés](/fr/docs/Learn_web_development/Extensions/Testing/Automated_testing)
...
- [Configuration de votre propre environnement d'automatisation de test](/fr/docs/Learn_web_development/Extensions/Testing/Your_own_automation_environment)
