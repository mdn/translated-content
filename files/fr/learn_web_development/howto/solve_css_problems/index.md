...
- [Comment sélectionner des éléments par leur nom, leur classe ou leur ID](/fr/docs/Learn_web---
title: Apprendre à utiliser CSS pour résoudre des problèmes
slug: Learn_web_development/Howto/Solve_CSS_problems
original_slug: Learn/CSS/Howto
---
...
- [Comment donner un style au texte](/fr/docs/Learn_web_development/Core/Text_styling/Fundamentals)
- [Comment personnaliser une liste d'éléments](/fr/docs/Learn_web_development/Core/Text_styling/Styling_lists)
- [Comment donner un style aux liens](/fr/docs/Learn_web_development/Core/Text_styling/Styling_links)
- [Comment ajouter des ombres au texte](/fr/docs/Learn_web_development/Core/Text_styling/Fundamentals#ombres_du_texte)
...
- [Comment contrôler les bordures](/fr/docs/Learn_web_development/Core/Styling_basics/Backgrounds_and_borders)
- [Comment donner un style à une table HTML](/fr/docs/Learn_web_development/Core/Styling_basics/Tables)
- [Comment ajouter des ombres aux boîtes](/fr/docs/Learn_web_development/Core/Styling_basics/Advanced_styling_effects#box_shadows)
...
- [Comment calculer la spécificité d'un sélecteur de CSS](/fr/docs/Learn_web_development/Core/Styling_basics/Handling_conflicts#specificity)
- [Comment contrôler l'héritage en CSS](/fr/Apprendre/CSS/Introduction_à_CSS/La_cascade_et_l_héritage#L%27héritage)

### Effets avancés

- [Comment utiliser des filtres en CSS](/fr/docs/Learn_web_development/Core/Styling_basics/Advanced_styling_effects#filters)
- [Comment utiliser les modes fusion](/fr/docs/Learn_web_development/Core/Styling_basics/Advanced_styling_effects#blend_modes)
...
[CSS FAQ](/fr/docs/Learn_web_development/Howto/Solve_CSS_problems/CSS_FAQ) — Une collection d'informations ponctuelles couvrant une variété de sujets, du débogage à l'utilisation de sélecteurs.
