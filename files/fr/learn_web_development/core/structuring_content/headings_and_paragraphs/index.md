    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>Utiliser du HTML sémantique plutôt que du HTML de présentation, et pourquoi c'est important.</li>
...
- De préférence, vous devez utiliser un seul `<h1>` par page — c'est le titre de niveau supérieur, tous les autres se situent en dessous dans la hiérarchie.
- Veillez à utiliser les titres dans le bon ordre hiérarchique. N'utilisez pas des éléments `<h3>` pour représenter des sous-titres, suivis d'éléments `<h2>` pour représenter des sous-sous-titres — cela n'a pas de sens et produit des résultats étranges.
