...
L'idéal serait que vous débutiez votre parcours d'apprentissage par l'étude du HTML. Commencez par lire [Introduction au HTML](/fr/docs/Learn_web_development/Core/Structuring_content). Vous pouvez ensuite passer à l'étude de sujets plus avancés comme&nbsp;:
...
- [Multimedia et intégration](/fr/docs/Learn_web_development/Core/Structuring_content)
...
- [Tableaux HTML](/fr/docs/Learn_web_development/Core/Structuring_content/HTML_table_basics)
...
- [Formulaire HTML](/fr/docs/Learn_web_development/Extensions/Forms)
