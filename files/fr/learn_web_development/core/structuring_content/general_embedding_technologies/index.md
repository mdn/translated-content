...
> **Note :** [Github pages](/fr/docs/Learn_web_development/Howto/Tools_and_setup/Using_GitHub_pages) permet au contenu d'être servi via HTTPS par défaut, ce qui est utile pour l'hébergement de contenu. Si vous utilisez un autre type d'hébergement et que vous n'êtes pas sûr, demandez à votre hébergeur ce qu'il en est.
