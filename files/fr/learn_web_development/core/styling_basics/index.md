...
Vous devriez vraiment apprendre les bases du HTML avant d'essayer n'importe quelles CSS. Nous vous recommandons de travailler d'abord notre module [Introduction au HTML —](/fr/docs/conflicting/Learn_web_development/Core/Structuring_content_2f5dc6d6e575054cc70e0a8faa24bef31907d53cee6754dd2c92e644e705a7d8) vous pourrez ensuite en apprendre davantage au sujet&nbsp;:
...
- [Composer du texte](/fr/docs/Learn_web_development/Core/Text_styling)
...
- [Mise en page avec les CSS](/fr/docs/Learn_web_development/Core/CSS_layout)
...
[Apprendre à utiliser CSS pour résoudre des problèmes](/fr/docs/Learn_web_development/Howto/Solve_CSS_problems) fournit des liens vers des sections dont les contenus expliquent comment utiliser les CSS pour résoudre des problèmes banals lors de la création d'une page Web.
