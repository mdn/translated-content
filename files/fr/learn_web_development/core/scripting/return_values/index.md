...
<table>
  <tbody>
    <tr>
      ...
      <td>
        Notions de base en informatique, compréhension élémentaire de HTML et CSS, avoir lu <a href="/fr/docs/Learn_web_development/Core/Scripting">Premiers pas en JavaScript</a>, et <a href="/fr/docs/Learn_web_development/Core/Scripting/Functions">Fonctions — blocs de code réutilisable</a>.
      </td>
    </tr>
    <tr>
