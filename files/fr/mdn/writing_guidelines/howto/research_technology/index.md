...
short-title: Chercher une technologie
...
Avant de commencer à documenter ou à mettre à jour quelque chose sur MDN Web Docs, il y a certaines choses que vous devez préparer et planifier au préalable.
...
- Lecture des spécifications des technologies web. Vous les consultez souvent lorsque vous documentez les API.
...
Certains des exemples de code pour MDN Web Docs sont conservés dans des dépôts séparés. Il s'agit notamment des exemples interactifs qui apparaissent dans la section «&nbsp;Exemple interactif&nbsp;» des pages de référence et du code de démonstration plus volumineux nécessaire pour les guides. Si vous devez ajouter ou modifier l'un de ces dépôts, il est bon de le noter dans votre liste.
...
Si vous documentez une nouvelle API web, votre liste initiale de sections à documenter peut ressembler à ceci&nbsp;:
...
Vous pouvez ensuite l'enrichir avec plus de détails, en ajoutant chaque interface et ses membres. Par exemple, si vous documentiez l'API Web Audio, votre liste peut ressembler à ceci&nbsp;:
...
À ce stade, il est conseillé d'ouvrir un [ticket de suivi <sup>(angl.)</sup>](https://github.com/mdn/content/issues) sur le dépôt `mdn/content`, en répertoriant les pages sous forme de liste de tâches (avec des cases à cocher). Cela permet non seulement à vous, mais aussi aux autres personnes travaillant sur la documentation, de suivre publiquement l'avancement du projet. Vous pouvez également associer vos pull requests à ce ticket afin de fournir à tout le monde davantage de contexte.
