...
---
<div>{{MDNSidebar}}</div>
<p>MDN dispose d'un système d'exemples "<a href="/en-US/docs/MDN/Contribute/Editor/Live_samples">live</a>", grâce auxquels le code présent sur une page est exécuté pour afficher les résultats de l'exécution de ce code. Cependant, beaucoup d'articles existants affichent du code sans utiliser ce système, et ont donc besoin d'être convertis.</p>

<p>Les exemples "live", vous permettent de voir à quoi ressemble le résultat d'un exemple, faire une documentation plus dynamique et instructive. Ce guide vous explique comment prendre des exemples existants et leur rajouter la fonctionnalité "live".</p>

<h2>Compétences nécessaires pour cette tâche</h2>
...
<h2>Quelles étapes pour réaliser cette tâche ?</h2>
