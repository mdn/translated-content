...
- [CSS 소개](/ko/docs/Learn/CSS/First_steps)부터 시작하는 CSS
...
본 주제를 시작하기 전에 [Web과 함께 시작하기](/ko/docs/Learn/Getting_started_with_the_web)를 먼저 해보시는게 좋겠습니다. 그러나 CSS 기초 글에서 다루는걸 여기 [CSS 소개](/ko/docs/Learn/CSS/First_steps)에서 훨씬 상세하게 다루므로 필수는 아닙니다.
...
- [박스 스타일링](/ko/docs/Learn/CSS/Building_blocks)
