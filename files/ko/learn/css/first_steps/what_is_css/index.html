...
<table class="learn-box standard-table">
 <tbody>
  <tr>
   ...
   <td>컴퓨터 기본 활용 능력, <a href="/ko/docs/Learn/Getting_started_with_the_web/Installing_basic_software">기본 소프트웨어 설치</a>, <a href="/ko/docs/Learn/Getting_started_with_the_web/Dealing_with_files">파일 작업</a> 에 대한 기본 지식 및 HTML 기본 사항 (<a href="/ko/docs/Learn/HTML/Introduction_to_HTML">HTML 소개</a> 학습)</td>
  </tr>
  <tr>
   <th scope="row">목적:</th>
   <td>CSS가 무엇인지 배우기.</td>
...
<p><strong>참고</strong>: 브라우저는 {{Glossary("User agent","user agent")}} 라고도 하며, 기본적으로 컴퓨터 시스템 내부의 개인을 나타내는 컴퓨터 프로그램을 의미합니다. 브라우저는 CSS 에 대해 이야기 할 때, 우리가 생각하는 주요 유형의 user agent 이지만, 유일한 user agent는 아닙니다. HTML 및 CSS 문서를 인쇄할 PDF로 변환하는 것과 같은 사용 가능한 다른 user agent 가 있습니다.</p>
</div>

<p>CSS 는 매우 기본적인 텍스트 문서 스타일링에 사용될 수 있습니다 — 예를 들어, 제목 및 링크의 <a href="/ko/docs/Web/CSS/color_value">색상</a> 과 <a href="/ko/docs/Web/CSS/font-size">크기</a> 변경. 또한, 레이아웃을 만드는 데 사용 할 수 있습니다 — 예를 들어, <a href="/ko/docs/Web/CSS/Layout_cookbook/Column_layouts">단일 텍스트 열을 변환</a> (기본 콘텐츠 영역과 관련 정보에 대한 사이드 바가 있는 레이아웃으로) 하는 등 레이아웃을 만드는 데 사용 할 수 있습니다. <a href="/ko/docs/Web/CSS/CSS_Animations">애니메이션</a> 과 같은 효과에도 사용 할 수 있습니다. 구체적인 예는 이 단락의 링크를 살펴 보십시오.</p>
...
<p>콜론 앞에는, 속성이 있고 콜론 뒤에는 값이 있습니다. CSS {{Glossary("property/CSS","properties")}} 는 지정되는 속성에 따라 허용되는 값이 다릅니다. 이 예제에서는 다양한 <a href="/ko/docs/Learn/CSS/Building_blocks/Values_and_units#color">색상 값</a> 을 사용 할 수 있는 <code>color</code> 속성이 있습니다. 또한 <code>font-size</code> 속성도 있습니다. 이 속성은 다양한 <a href="/ko/docs/Learn/CSS/Building_blocks/Values_and_units#numbers_lengths_and_percentages">크기 단위</a> 를 값으로 사용 할 수 있습니다.</p>
...
<div class="blockIndicator note">
<p><strong>참고</strong>: MDN <a href="/ko/docs/Web/CSS/Reference">CSS 참조</a> 에 나열된 모든 CSS 속성 페이지 (다른 CSS 기능과 함께) 에 대한 링크를 찾을 수 있습니다.  또는, CSS 기능에 대한 자세한 정보를 찾아야 할 때 마다, 자주 사용하는 검색 엔진에서 "mdn <em>css-feature-name</em>" 을 검색하는 데 익숙해야 합니다. 예를 들어, "mdn color" 및 "mdn font-size" 를 검색해 보십시오!</p>
</div>

<h2 id="CSS_Modules">CSS Modules</h2>

<p>CSS 를 사용하여 스타일을 지정할 수 있는 것이 너무 많으므로, 언어는 <em>module</em> 로 분류됩니다. MDN 을 탐색할 때 이러한 module 에 대한 참조가 표시되면, 많은 설명서 페이지가 특정 module 을 중심으로 구성되어 있습니다. 예를 들어, <a href="/ko/docs/Web/CSS/CSS_Backgrounds_and_Borders">배경 및 테두리</a> module 에 대한 MDN 참조를 통해 그 용도가 무엇이며, 그 용도에 포함된 다른 속성 및 기타 기능을 확인할 수 있습니다. 또한 기술을 정의하는 <em>CSS Specification</em> 에 대한 링크를 찾을 수 있습니다 (아래 참조).</p>
...
<p>구체적인 예를 들어, 배경 및 테두리 module 로 돌아가 보겠습니다 — 이 module 에서 <code><a href="/ko/docs/Web/CSS/background-color">background-color</a></code> 및 <code><a href="/ko/docs/Web/CSS/border-color">border-color</a></code> 속성을 정의하는 것이 논리적이라고 생각 할 수 있습니다. 당신이 옳을 겁니다.</p>
...
<p>다음은 CSS <code><a href="/ko/docs/Web/CSS/font-family">font-family</a></code> 속성에 대한 데이터 차트입니다.</p>

<p>{{Compat("css.properties.font-family")}}</p>

<h2 id="다음은_뭐죠">다음은 뭐죠</h2>

<p>CSS 가 무엇인지 이해했으니, 이제 <a href="/ko/docs/Learn/CSS/First_steps/Getting_started">CSS 시작하기</a> 로 넘어가서 CSS 를 직접 작성할 수 있습니다.</p>
...
<ol>
 <li><a href="/ko/docs/Learn/CSS/First_steps/What_is_CSS">CSS 란 무엇인가?</a></li>
 <li><a href="/ko/docs/Learn/CSS/First_steps/Getting_started">CSS 로 시작하기</a></li>
 <li><a href="/ko/docs/Learn/CSS/First_steps/How_CSS_is_structured">CSS 의 구조</a></li>
 <li><a href="/ko/docs/Learn/CSS/First_steps/How_CSS_works">CSS 작동 방식</a></li>
 <li><a href="/ko/docs/Learn/CSS/First_steps/Using_your_new_knowledge">새로운 지식 사용</a></li>
</ol>
