...
2. [CSS 소개](/en-US/docs/Learn/CSS/First_steps) 과정에서 논의한 대로 CSS 기본 사항에 대해 익숙해야 합니다.
3. [박스 스타일 지정](/en-US/docs/Learn/CSS/Building_blocks) 방법에 대한 이해가 있어야 합니다.
...
- [일반 흐름](/ko/docs/Learn/CSS/CSS_layout/Normal_Flow)
...
- [포지셔닝(Positioning)](/ko/docs/Learn/CSS/CSS_layout/Positioning)
...
- [미디어 쿼리 초보자 안내서](/ko/docs/Learn/CSS/CSS_layout/Media_queries)
