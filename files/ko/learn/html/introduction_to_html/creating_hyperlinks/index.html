...
<p>A basic link is created by wrapping the text (or other content, see <a href="#block_level_links">Block level links</a>) you want to turn into a link inside an {{htmlelement("a")}} element, and giving it an {{htmlattrxref("href", "a")}} 속성은 (also known as a <strong>target</strong>) 사이트의 주소가 포함된 링크를 당신에게 줍니다.</p>
