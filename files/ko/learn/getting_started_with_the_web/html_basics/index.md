...
> [!NOTE]
> 접근성에 대한 더 많은 것은 [MDN의 페이지 접근성 시작하기](/ko/docs/Web/Accessibility)에서 찾아보세요.
...
> [!NOTE]
> 처음엔 `href` 라는 속성 이름이 꽤 어렵게 보일수도 있습니다. 만약 기억하기가 어려우시다면, 이것은 _**h**ypertext **ref**erence_(하이퍼 텍스트 참조)를 나타낸다는 것을 기억하세요.
