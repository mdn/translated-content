...
<p class="summary">{{Glossary("JavaScript")}} 는 웹 페이지의 복잡한 것들을 구현할 수 있는 프로그래밍 언어입니다. 웹페이지는 단순히 변하지 않고 정적인 정보들만 보여주는 것 이상의 일을 합니다. 시간의 흐름에 따라 업데이트 되는 콘텐츠, 동적인 지도와 움직이는 2D/3D 그래픽, 또는 스크롤 가능한 비디오 쥬크박스들과 여러 가지들을 보여줍니다. 여러분은 '아마도 JavaScript가 그 일들을 하고 있겠구나'라고 생각하실 수 있습니다.</p>

<div class="callout">
  <h4 id="Looking_to_become_a_front-end_web_developer">프런트엔드 개발자가 되길 희망하나요?</h4>

  <p>우리는 모든 필수 정보를 포함하는 과정을 구성했습니다. 목표를 향해 노력할 일만 남았습니다.</p>

  <p><a href="/ko/docs/Learn/Front-end_web_developer"><strong>시작하기</strong></a></p>

</div>

<h2 id="Prerequisites">전제 조건</h2>

<p>JavaScript 는 <a href="/ko/docs/Learn/HTML">HTML</a> 이나 <a href="/ko/docs/Learn/CSS">CSS</a> 와 같은 관련 기술들보다 배우기가 더 어렵습니다. JavaScript 에 입문하기 전에, 적어도 아래의 두가지 기술을 먼저 배우고, 아마도 다른 것들도 배우는 것이 좋습니다. 다음 과정들을 통해 시작하세요.</p>

<ul>
 <li><a href="/ko/docs/Learn/Getting_started_with_the_web">Web과 함께 시작하기</a></li>
 <li><a href="/ko/docs/Learn/HTML/Introduction_to_HTML"><abbr title="Hypertext Markup Language">HTML</abbr> 소개</a></li>
 <li><a href="/ko/docs/Learn/CSS/Introduction_to_CSS"><abbr title="Cascading Style Sheets">CSS</abbr> 소개</a></li>
</ul>
...
<ul>
 ...
 <li><a href="/ko/docs/Web/API">웹 <abbr title="application programming interface">APIs</abbr> 참조문서</a></li>
</ul>
...
<dl>
 ...
 <dd>
 <p>이 부분에서 우리는 Javascript의 비동기적 실행이 왜 중요한지, 서버에서 리소스를 가져올 때와 같은 시간 지연을 유발하는 동작들을 어떻게 효과적으로 다룰지 등에 대해 살펴봅니다.</p>
 </dd>
...
<h2 id="Solving_common_JavaScript_problems">일반적인 JavaScript 문제 해결</h2>
...
<dl>
 ...
 <dd>Web 개발자 지망생을 위한 훌륭한 자료  — 짧은 강좌와 대화형 테스트, 자동화된 평가로 지도하는 인터랙티브 환경에서 JavaScript를 배웁니다. 처음 40개 강좌는 무료이며, 한번의 작은 금액 지불로 전체코스를 수강할 수 있습니다.</dd>
 <dt><a href="https://exlskills.com/learn-en/courses/javascript-fundamentals-basics_javascript">EXLskills의 JavaScript 기초</a></dt>
 <dd>EXLskills의 오픈소스 코스로 JavaScript를 무료로 배우세요 JS로 어플리케이션 제작을 시작하는데 필요한 모든 것을 배울수 있습니다.</dd>
