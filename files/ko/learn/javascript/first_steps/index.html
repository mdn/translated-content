...
<p class="summary">우리의 첫번째 JavaScript 모듈에서는 JavaScript를 써보는 첫번째 현실적인 경험을 하기에 앞서, "JavaScript란 무엇인가", "그것은 어떻게 생겼는가", "그것은 무엇을 할 수 있는가"와 같은 핵심적인 질문에 답을 할 것입니다. 그 이후에 우리는 예컨대 변수, 문자열, 숫자, 배열과 같은 핵심적인 단위를 상세히 논의해볼 것입니다.</p>

<div class="callout">
  <h4 id="Looking_to_become_a_front-end_web_developer">프론트엔드 웹 개발자가 되기를 바라나요?</h4>

  <p>우리는 당신이 목적을 이루기 위해 필요한 핵심적인 개념을 모두 포함하는 강좌를 하나 만들었어요.</p>

  <p><a href="/en-US/docs/Learn/Front-end_web_developer"><strong>시작하기</strong></a></p>

</div>

<h2 id="준비_과정">준비 과정</h2>

<p>이번 과정을 시작하기 전에 JavaScript에 대해 몰라도 되지만, HTML, CSS와는 어느 정도 친숙해야 합니다. JavaScript를 시작하기 이전에 우선 다음 과정부터 진행하시는게 좋습니다.</p>

<ul>
 <li><a href="/ko/docs/Learn/Getting_started_with_the_web">Web으로 시작하기</a> (아주 기본적인 <a href="/ko/docs/Learn/Getting_started_with_the_web/JavaScript_basics">JavaScript 소개</a>도 포함)</li>
...
<dl>
 ...
 <dd>야망있는 웹 개발자를 위한 완벽한 자료입니다. JavaScript를 자동화된 평가에 의해 안내되는 짧은 강의와 인터렉티브한 테스트와 함께 상호작용하는 환경에서 배워보세요. 처음 40개의 레슨은 무료이며, 전체 코스는 적은 비용을 지불하면 가능합니다.</dd>
</dl>
