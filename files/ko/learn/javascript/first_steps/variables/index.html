...
<h2 id="Test_your_skills!">당신의 실력을 시험해 보세요!</h2>

<p>이 문서를 끝까지 읽으셨지만, 중요한 것들을 여전히 기억하고 계신가요? 다음 문서를 읽기 전에 이 문서의 내용을 잘 학습하고 이해하셨는지 확인하실 수 있습니다 — <a href="/ko/docs/Learn/JavaScript/First_steps/Test_your_skills:_variables">당신의 실력을 시험해 보세요: 변수(variables)</a>.</p>
