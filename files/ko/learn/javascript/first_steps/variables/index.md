...
배열에 대한 더 많은 것을 [배열](https://developer.mozilla.org/ko/docs/Learn/JavaScript/First_steps/Arrays)에서 확인할 수 있습니다.
...
지금은 객체에 대해 더 이상 살펴보지 않으므로 [향후 과정](https://developer.mozilla.org/ko/docs/Learn/JavaScript/Objects)에서 객체에 대해 더 많이 배울 수 있습니다.
