...
여러분이 자바스크립트에서 쓸 단연코 가장 일반적인 형태의 조건문을 살펴봅시다 — 변변찮은 [`if ... else`](/ko/docs/Web/JavaScript/Reference/Statements/if...else)[ 문](/ko/docs/Web/JavaScript/Reference/Statements/if...else)입니다.
