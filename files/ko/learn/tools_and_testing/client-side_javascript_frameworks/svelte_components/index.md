...
> **참고:** 처음 몇 개의 컴포넌트를 만드는 과정에서, 컴포넌트 간의 통신 방법과 각각의 장단점에 대해 배우게 될 것입니다.
...
> **참고:** Svelte의 사용자 정의 이벤트는 일반 DOM 이벤트와 동일한 API를 공유합니다. 또한, 핸들러 없이 `on:event`를 지정함으로써 이벤트를 부모 컴포넌트로 버블링시킬 수 있습니다.
