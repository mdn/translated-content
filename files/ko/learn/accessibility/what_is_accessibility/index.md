...
아래에는 생각해보아야 하는 장애의 주요 유형들이 설명되어 있습니다. 웹 컨텐츠에 접근하기 위해 사용하는 특별한 도구가 있다면 함께 살펴보겠습니다. 이런 도구들은 보조 기술(**assistive technology**, 또는 **AT**)이라고 불립니다.

> **참고:** 세계 보건 기구(WHO)의 [장애 및 보건 현황 보고서](https://www.who.int/en/news-room/fact-sheets/detail/disability-and-health)에 따르면 전 세계 인구의 약 15%에 해당하는 10억명 이상의 사람들이 장애를 갖고 있으며 1억 1천만명에서 1억 9천만명의 성인들이 심각한 장애를 갖고 있습니다.
...
통계적으로 세계 보건 기구(WHO)는 다음과 같이 추정합니다. "전 세계적으로 2억 8,500만 명이 시각 장애를 가진 것으로 추정된다. 그 중 3,900만 명이 맹인이고 2억 4,600만 명이 저시력자이다." ([Visual impairment and blindness](http://www.who.int/mediacentre/factsheets/fs282/en/) 참고) 이것은 미국 인구와 비슷한 크기를 가진 중요한 비중의 인구입니다. 당신의 사이트는 제대로 코딩되지 않았다는 이유만으로 이 사용자들을 놓칠 수 있습니다.

### 청각 장애가 있는 사람

[Deaf and hard-of-hearing(DHH)](https://www.nad.org/resources/american-sign-language/community-and-culture-frequently-asked-questions/) 사람들은 경도에서 심도까지 다양한 수준의 난청을 가지고 있습니다. 이들 중 일부는 보조 기술(AT, [Assistive Devices for People with Hearing, Voice, Speech, or Language Disorders](https://www.nidcd.nih.gov/health/assistive-devices-people-hearing-voice-speech-or-language-disorders) 참고)을 사용하지만 보편적이지는 않습니다.
...
- 당신의 국가에 웹 사이트의 접근성 제공 필요성에 대한 법률이 있을 수도 있습니다.
    - EU [EN 301 549](https://www.etsi.org/deliver/etsi_en/301500_301599/301549/02.01.02_60/en_301549v020102p.pdf), 미국 [Section 508 of the Rehabilitation Act](https://www.section508.gov/training/), 독일 [Federal Ordinance on Barrier-Free Information Technology](https://www.einfach-fuer-alle.de/artikel/bitv_english/), 영국 [Accessibility Regulations 2018](https://www.legislation.gov.uk/uksi/2018/952/introduction/made), 이탈리아 [Accessibilità](https://www.agid.gov.it/it/design-servizi/accessibilita), 호주 [Disability Discrimination Act](https://humanrights.gov.au/our-work/disability-rights/world-wide-web-access-disability-discrimination-act-advisory-notes-ver) 등
- WC3에서 나라 별로 [Web Accessibility Laws & Policies](https://www.w3.org/WAI/policies/) 목록을 관리하고 있습니다.
