---
title: "멀티미디어: 이미지"
slug: Web 개발 학습하기/웹 성능/멀티미디어
page-type: learn-module-chapter
---

{{LearnSidebar}}{{PreviousMenuNext("Learn/Performance/measuring_performance", "Learn/Performance/video", "Learn/Performance")}}

이미지, 비디오와 같은 미디어는 평균적인 웹사이트 다운로드 용량의 70%를 차지한다. 다운로드 성능의 면에서 미디어를 제거하거나, 파일의 사이즈를 줄이는 것은 가장 손쉬운 해결방식이다. 이 글은 이미지와 비디오를 최적화하는 방식을 들여다 볼 것이다.
...
<table>
  <tbody>
    <tr>
      ...
      <td>
        기초적인 컴퓨터 사용 능력,
        <a href="/en-US/docs/Learn/Getting_started_with_the_web/Installing_basic_software">기본적인 소프트웨어</a>,
        <a href="/en-US/docs/Learn/Getting_started_with_the_web">클라이언트 사이드 웹 기술</a>에 대한 기본 지식.
      </td>
    </tr>
    <tr>
      <th scope="row">목적:</th>
      <td>
        다양한 이미지 포맷과 그 포맷이 웹 성능에 미치는 영향, 그리고 페이지 로딩 시간에 미치는 영향을 줄이는 방법에 대해 배운다.
      </td>
    </tr>
  </tbody>
</table>

> **알림:** This is a high-level introduction to optimizing multimedia delivery on the web, covering general principles and techniques. For a more in-depth guide, see <https://images.guide>.

## 멀티미디어를 최적화 해야 하는 이유

평균적인 웹사이트에서For the average website, [51% of its bandwidth comes from imagery, followed by video at 25%](https://discuss.httparchive.org/t/state-of-the-web-top-image-optimization-strategies/1367), so it's safe to say it's important to address and optimize your multimedia content.
