...
CSP (콘텐츠 보안 정책[Content Security Policy](/ko/docs/Web/HTTP/CSP))는 {{Glossary("XSS")}}, [clickjacking](/ko/docs/Web/Security/Attacks/Clickjacking)이나 데이터 주입과 같은 특정 웹사이트 관련 공격을 탐지 하거나 완화 하기 위해 사용됩니다.
