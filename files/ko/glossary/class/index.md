...
{{glossary("OOP","객체 지향 프로그래밍")}}에서, '클래스'는 {{glossary("object","객체의")}} 특성을 정의합니다. 클래스는 객체의 {{glossary("property","속성")}} 및 {{glossary("method","메서드")}}의 템플릿 정의이며, 객체의 더 구체적인 인스턴스를 표현하는 "청사진"입니다.
