...
**[동일 출처 정책 (Same-origin policy)](/ko/docs/Web/Security/Defenses/Same-origin_policy)** 은 하나의 {{Glossary("origin", "출처")}}에서 로드된 문서나 스크립트가 다른 출처의 리소스와 상호작용할 수 있는 방법을 제한하는 중요한 보안 메커니즘입니다.
