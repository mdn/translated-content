...
[AngularJS](http://en.wikipedia.org/wiki/AngularJS "AngularJS") 및 [Ember.js](http://en.wikipedia.org/wiki/Ember.js "Ember.js") 와 같은 웹 프레임워크들은 약간씩은 방식이 다르지만, 모두 MVC 구조를 구현합니다.
