...
**품질 값(Quality values)** 또는 'q-values' 또는 'q-factors'는 쉼표로 구분된 목록에서 값의 우선순위 순서를 설명하는 데 사용됩니다. 일부 [HTTP 헤더](/ko/docs/Web/HTTP/Headers) 및 HTML에서 허용되는 특수 구문입니다.
...
- [HTTP 헤더](/ko/docs/Web/HTTP/Headers) 구문에 q-values를 사용하는 경우가 있습니다(예, {{HTTPHeader("Accept")}}, {{HTTPHeader("Accept-Encoding")}}, {{HTTPHeader("Accept-Language")}}, {{HTTPHeader("TE")}}, {{HTTPHeader("Want-Digest")}}).
