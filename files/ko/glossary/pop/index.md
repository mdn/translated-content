...
**우체국 프로토콜 (Post Office Protocol, POP3)** 은 {{glossary("TCP")}} 연결을 통해 메일 서버에서 이메일을 받기 위한 매우 일반적인 {{glossary("protocol", "프로토콜")}}입니다. POP3는 보다 더 복잡한 구조로 인해 구현하기가 더 어려운 최신 {{Glossary("IMAP")}}와 달리 폴더를 지원하지 않습니다.
