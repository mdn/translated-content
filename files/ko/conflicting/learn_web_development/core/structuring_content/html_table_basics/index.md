...
이 모듈을 시작하기 전에, 당신은 이미 HTML의 기본 지식을 가지고 있어야 합니다. — [Introduction to HTML](/ko/docs/conflicting/Learn_web_development/Core/Structuring_content).
...
- [HTML 테이블 기본](/ko/docs/Learn_web_development/Core/Structuring_content/HTML_table_basics)
...
- [HTML 테이블 고급 기능 및 접근성](/ko/docs/Learn_web_development/Core/Structuring_content/Table_accessibility)
...
- [행성 데이터 구성](/ko/docs/Learn_web_development/Core/Structuring_content/Planet_data_table)
