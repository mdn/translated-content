...
original_slug: Web/Media/Formats/Video_codecs
---
...
| ------------------------------ | ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [AV1](#av1)                    | AOMedia Video 1               | [MP4](/ko/docs/Web/Media/Guides/Formats/Containers#mp4), [WebM](/ko/docs/Web/Media/Guides/Formats/Containers#webm)                                                                            |
| [AVC (H.264)](#avc_h.264)      | Advanced Video Coding         | [3GP](/ko/docs/Web/Media/Guides/Formats/Containers#3gp), [MP4](/ko/docs/Web/Media/Guides/Formats/Containers#mp4), [WebM](/ko/docs/Web/Media/Guides/Formats/Containers#webm)                   |
| [H.263](#h.263)                | H.263 Video                   | [3GP](/ko/docs/Web/Media/Guides/Formats/Containers#3gp)                                                                                                                                       |
| [HEVC (H.265)](#hevc_h.265)    | High Efficiency Video Coding  | [MP4](/ko/docs/Web/Media/Guides/Formats/Containers#mp4)                                                                                                                                       |
| [MP4V-ES](#mp4v-es)            | MPEG-4 Video Elemental Stream | [3GP](/ko/docs/Web/Media/Guides/Formats/Containers#3gp), [MP4](/ko/docs/Web/Media/Guides/Formats/Containers#mp4)                                                                              |
| [MPEG-1](#mpeg-1_part_2_video) | MPEG-1 Part 2 Visual          | [MPEG](/ko/docs/Web/Media/Guides/Formats/Containers#mpegmpeg-2), [QuickTime](/ko/docs/Web/Media/Guides/Formats/Containers#quicktime)                                                          |
| [MPEG-2](#mpeg-2_part_2_video) | MPEG-2 Part 2 Visual          | [MP4](/ko/docs/Web/Media/Guides/Formats/Containers#mp4), [MPEG](/ko/docs/Web/Media/Guides/Formats/Containers#mpegmpeg-2), [QuickTime](/ko/docs/Web/Media/Guides/Formats/Containers#quicktime) |
| [Theora](#theora)              | Theora                        | [Ogg](/ko/docs/Web/Media/Guides/Formats/Containers#ogg)                                                                                                                                       |
| [VP8](#vp8)                    | Video Processor 8             | [3GP](/ko/docs/Web/Media/Guides/Formats/Containers#3gp), [Ogg](/ko/docs/Web/Media/Guides/Formats/Containers#ogg), [WebM](/ko/docs/Web/Media/Guides/Formats/Containers#webm)                   |
| [VP9](#vp9)                    | Video Processor 9             | [MP4](/ko/docs/Web/Media/Guides/Formats/Containers#mp4), [Ogg](/ko/docs/Web/Media/Guides/Formats/Containers#ogg), [WebM](/ko/docs/Web/Media/Guides/Formats/Containers#webm)                   |
...
원래 목적은 {{Glossary("RTP")}} 세션에서 MPEG-4 오디오 및 비디오 스트림을 사용하기 위해서였습니다. 하지만 [3GP](/ko/docs/Web/Media/Guides/Formats/Containers#3gp)를 통한 모바일 통신에서도 쓰이고 있습니다.
...
\[1] Firefox supports MP4V-ES in [3GP](/ko/docs/Web/Media/Guides/Formats/Containers#3gp) containers only.
...
HTML 콘텐츠로써 특히 [WebM](/ko/docs/Web/Media/Guides/Formats/Containers#webm) 파일에 포함된 VP8을 지원하는 좋은 브라우저가 많습니다. 이는 VP8이 여러분의 콘텐츠로 좋은 선택이 될 수 있으며 가능하다면 더 좋은 VP9를 선택할 수도 있습니다. 웹브라우저는 WebRTC를 위해 VP8을 _반드시_ 지원해야 합니다. 하지만 HTML Audio video 엘리먼츠에는 꼭 VP8을 지원할 필요는 없습니다.
...
VP9는 광범위한 브라우저가 지원하고 있으며 하드웨어 구현체로 상당히 퍼져있습니다. VP9는 [WebM](/ko/docs/Web/Media/Guides/Formats/Containers#webm)에서만 사용할 수 있는 두 코덱 중 하나입니다(나머지 하나는 [VP8](#vp8)). 하지만 Safari는 WebM 및 VP9 모두 지원하지 않으므로 VP9를 사용할 경우 iPhone, iPad, Mac에서 AVC나 HEVCS등 다른 포맷을 대체할 수 있도록 만들어야 합니다.
...
1. **[WebM](/ko/docs/Web/Media/Guides/Formats/Containers#webm)** 컨테이너에 비디오는 **[VP8](#vp8), 오디오는** **[Opus](/ko/docs/Web/Media/Formats/Audio_codecs#Opus)** 코덱을 사용합니다. 이들은 로열티-프리 오픈 포맷이지만 최근 브라우저에서만 폭넓게 지원하는 경향이 있어 폴백 지원이 필수적입니다.

   ```js
   <video controls src="filename.webm"></video>
   ```

2. **[MP4](/ko/docs/Web/Media/Guides/Formats/Containers#mp4)** 컨테이너에 비디오 코덱은 **[AVC](#avc_h.264)** (**H.264**) 오디오 코덱은 **[AAC](/ko/docs/Web/Media/Formats/Audio_codecs#AAC)** 를 사용합니다. MP4 컨테이너에 AVC, AAC 조합은 모든 주요 브라우저에서 폭넓게 지원하는 조합이며 대부분의 유즈케이스에서 좋은 품질을 보여주기 때문입니다. 하지만 라이선스 요구사항에 대해 컴플라이언스 이슈는 없는 지 확인이 필요하죠.
...
- [미디어 컨테이너 포맷(파일 타입)](/ko/docs/Web/Media/Guides/Formats/Containers)
