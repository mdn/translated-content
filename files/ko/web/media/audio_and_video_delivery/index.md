...
For further info see [Cross Browser Audio Basics (HTML Audio In Detail)](/ko/docs/Web/Media/Audio_and_video_delivery/Cross-browser_audio_basics#html5_audio_in_detail)
...
> **Note:** The `autoplay` attribute may be ignored by some mobile browsers. Also, the autoplay feature can be controversial when misused. It's strongly recommended that you read the [Autoplay guide for media and Web Audio APIs](/ko/docs/Web/Media/Autoplay_guide) to learn how to use autoplay wisely.

For further info see [\<video> element](/ko/docs/Web/HTML/Element/video) and [Creating a cross-browser video player](/ko/docs/Web/Media/Audio_and_video_delivery/cross_browser_video_player).
...
Find more about Web Audio API basics in [Using the Web Audio API](/ko/docs/Web/API/Web_Audio_API/Using_Web_Audio_API).
...
See [MediaStream Recording API](/ko/docs/Web/API/MediaStream_Recording_API) for more details.
...
For further information see [Live streaming web audio and video](/ko/docs/Web/Media/Audio_and_video_delivery/Live_streaming_web_audio_and_video).
...
You can [try this example out here](https://jsbin.com/jujeladu/2/edit). For more information, see [Creating your own custom audio player](/ko/docs/Web/Media/Audio_and_video_delivery/Cross-browser_audio_basics#creating_your_own_custom_audio_player).
...
A number of audio and video JavaScript libraries exist. The most popular libraries allow you to choose a consistent player design over all browsers and provide a fallback for browsers that don't support audio and video natively. Fallbacks have historically used now-obsolete plugins such as Adobe Flash or Microsoft Silverlight plugins to provide a media player in non-supporting browsers, although these are no longer supported on modern computers. Other functionality such as the [`<track>`](/ko/docs/Web/HTML/Element/track) element for subtitles can also be provided through media libraries.
...
- [Creating a cross-browser video player](/ko/docs/Web/Media/Audio_and_video_delivery/cross_browser_video_player)
  - : A guide to creating a basic cross browser video player using the {{ htmlelement("video") }} element.
- [Video player styling basics](/ko/docs/Web/Media/Audio_and_video_delivery/Video_player_styling_basics)
...
- [Cross-browser audio basics](/ko/docs/Web/Media/Audio_and_video_delivery/Cross-browser_audio_basics)
...
- [Media buffering, seeking, and time ranges](/ko/docs/Web/Media/Audio_and_video_delivery/buffering_seeking_time_ranges)
  - : Sometimes it's useful to know how much {{ htmlelement("audio") }} or {{ htmlelement("video") }} has downloaded or is playable without delay — a good example of this is the buffered progress bar of an audio or video player. This article discusses how to build a buffer/seek bar using [TimeRanges](/ko/docs/Web/API/TimeRanges), and other features of the media API.
- [HTML playbackRate explained](/ko/docs/Web/Media/Audio_and_video_delivery/WebAudio_playbackRate_explained)
...
- [Live streaming web audio and video](/ko/docs/Web/Media/Audio_and_video_delivery/Live_streaming_web_audio_and_video)
...
- [Setting up adaptive streaming media sources](/ko/docs/Web/Media/Audio_and_video_delivery/Setting_up_adaptive_streaming_media_sources)
...
- [DASH Adaptive Streaming for HTML 5 Video](/ko/docs/Web/Media/DASH_Adaptive_Streaming_for_HTML_5_Video)
  - : Details how to set up adaptive streaming using DASH and WebM.

## Advanced tutorials

- [Adding captions and subtitles to HTML video](/ko/docs/Web/Media/Audio_and_video_delivery/Adding_captions_and_subtitles_to_HTML5_video)
  - : This article explains how to add captions and subtitles to HTML {{ htmlelement("video") }}, using [Web_Video_Text_Tracks_Format](/ko/docs/Web/API/WebVTT_API) and the {{ htmlelement("track") }} element.
...
- [The video element](/ko/docs/Web/HTML/Element/video)
...
- [Event reference > Media](/ko/docs/Web/Events#media)
