...
![격자에 그려진 베지어 곡선](cubic_bézier_curves_with_grid.png)
...
![베지어 곡선으로 그린 두개의 매끄러운 S자형 곡선. 두 번째 곡선은 첫 번째 곡선과 동일한 제어점의 기울기를 유지하며, 이 기울기는 다른 쪽에 반영됩니다.](shortcut_cubic_bézier_with_grid.png)
