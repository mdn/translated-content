...
<p><img alt="A Web document is the composition of different resources" src="https://user-images.githubusercontent.com/13804810/191727034-a0fbcc05-d1b7-45ef-978d-230389f5c23e.png" style="height: 319px; width: 545px;"></p>
...
<p>각각의 개별적인 요청들은 서버로 보내지며, 서버는 요청을 처리하고 <em>response</em>라고 불리는 응답을 제공합니다. 이 요청과 응답 사이에는 여러 개체들이 있는데, 예를 들면 다양한 작업을 수행하는 게이트웨이 또는 {{glossary("Cache", "캐시")}} 역할을 하는 {{glossary("Proxy_server", "프록시")}} 등이 있습니다.</p>
