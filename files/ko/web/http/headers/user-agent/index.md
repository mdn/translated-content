...
> **경고:** 브라우저별로 다른 웹 페이지 또는 서비스를 제공하는 것은 일반적으로 좋지 않은 생각입니다. 해당 이유에 대해서는 [사용자 에이전트를 사용한 브라우저 감지](/ko/docs/Web/HTTP/Browser_detection_using_the_user_agent)를 참고하세요.
