...
> [!NOTE]
> [브라우저의 개발자도구 네트워크 패널](https://firefox-source-docs.mozilla.org/devtools-user/network_monitor/index.html)은 304 응답으로 이어지는 많은 요청을 생성하며, 로컬 캐시로 액세스 하는 것을 개발자에게 보여준다.
