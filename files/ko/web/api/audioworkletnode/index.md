...
> [!NOTE]
> 이 인터페이스는 [secure contexts](/ko/docs/Web/Security/Defenses/Secure_Contexts) 바깥에서 이용 가능하지만, {{domxref("BaseAudioContext.audioWorklet")}} 속성은 그렇지 않습니다. 따라서 사용자 정의 {{domxref("AudioWorkletProcessor")}}는 [secure contexts](/ko/docs/Web/Security/Defenses/Secure_Contexts) 바깥에서 정의될 수 없습니다.
