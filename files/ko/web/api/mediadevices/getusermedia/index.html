...
<p><strong>참고:</strong> 현재 문서를 안전하게 불러온 경우가 아니라면 <code>navigator.mediaDevices</code>는 <code>undefined</code>이므로 <code>getUserMedia()</code>도 사용할 수 없습니다. <a href="#개인정보와_보안">개인정보와 보안</a> 항목에서 <code>getUserMedia()</code>와 관련된 보안 문제를 자세히 살펴보세요.</p>
</div>
