...
화면의 방향을 다루기 위한 여러 방법이 있는데, CSS 와 JavaScript 이다. 첫 번째는 [orientation media query](/ko/docs/Web/CSS/Guides/Media_queries/Using#orientation) 이다. 이것은 내용이 CSS를 사용해서 레이아웃을 조정하게 하는데, 브라우저 창이 가로 모드 (너비가 높이보다 큼) 또는 세로모드 (높이가 너비보다 큼) 여부에 달려 있다.
...
- [The orientation media query](/ko/docs/Web/CSS/Guides/Media_queries/Using#orientation)
