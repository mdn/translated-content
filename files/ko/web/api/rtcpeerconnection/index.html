...
<dl>
 <dt>{{domxref("RTCPeerConnection.createDTMFSender()")}} {{deprecated_inline}}</dt>
...
<dl>
 <dt>{{domxref("RTCPeerConnection.addstream_event", "addstream")}} {{deprecated_inline}}</dt>
 ...
 <dt>{{domxref("RTCPeerConnection.identityresult_event", "identityresult")}} {{deprecated_inline}}</dt>
 ...
 <dt>{{domxref("RTCPeerConnection.idpassertionerror_event", "idpassertionerror")}} {{deprecated_inline}}</dt>
 ...
 <dt>{{domxref("RTCPeerConnection.idpvalidationerror_event", "idpvalidationerror")}} {{deprecated_inline}}</dt>
 ...
 <dt>{{domxref("RTCPeerConnection.peeridentity_event", "peeridentity")}} {{deprecated_inline}}</dt>
