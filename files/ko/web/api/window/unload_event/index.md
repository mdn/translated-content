...
`unload` 이벤트와 관련된 문제에 대한 자세한 내용은 [페이지 수명 주기 API](https://developer.chrome.com/docs/web-platform/page-lifecycle-api?hl=ko#the-unload-event) 안내서를 참조하세요.
...
- [페이지 수명 주시 API](https://developer.chrome.com/docs/web-platform/page-lifecycle-api?hl=ko#developer-recommendations-for-each-state)
