...
{{domxref("window.open()")}}을 사용하거나 [`target`](/ko/docs/Web/HTML/Reference/Elements/a#target) 특성을 지정한 링크로 현재 창을 연 {{domxref("Window")}}. 현재 창이 다른 창에 의해 생성됐거나 링크로 열리지 않았다면 {{jsxref("Operators/null", "null")}}.
