...
>
> 정상적으로 지원하는 코드를 확인하기 위해서는 다음 링크를 참조하시기 바랍니다. [crossbrowser possible solution for image preview](https://developer.mozilla.org/files/3699/crossbrowser_image_preview.html).
> 또는 [this more powerful example](https://developer.mozilla.org/files/3698/image_upload_preview.html).
