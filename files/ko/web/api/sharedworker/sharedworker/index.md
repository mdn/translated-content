...
>
> 이 위험은 스크립트 로드 위치를 제한하는 [콘텐츠 보안 정책(CSP)](/ko/docs/Web/HTTP/Guides/CSP)을 적용하고, 문자열 대신 항상 {{domxref("TrustedScriptURL")}} 객체를 할당하며, [신뢰할 수 있는 타입 강제](/ko/docs/Web/API/Trusted_Types_API#csp를_사용하여_신뢰할_수_있는_타입_강제하기)를 통해 완화할 수 있습니다.
