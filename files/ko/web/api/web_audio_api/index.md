...
- {{domxref("MediaStreamAudioSourceNode")}}
  - : **`MediaStreamAudio`\*\***`SourceNode`\*\* 인터페이스는 [WebRTC](/ko/docs/Web/API/WebRTC_API "/en-US/docs/WebRTC") {{domxref("MediaStream")}}(웹캠, 마이크 혹은 원격 컴퓨터에서 전송된 스트림)으로 구성된 오디오 소스를 나타냅니다. 이것은 오디오 소스 역할을 하는 {{domxref("AudioNode")}}입니다.
...
- {{domxref("MediaStreamAudioDestinationNode")}}
  - : **`MediaStreamAudio`\*\***`DestinationNode`\*\* 인터페이스는 단일 `AudioMediaStreamTrack` 을 가진 [WebRTC](/ko/docs/Web/API/WebRTC_API "/en-US/docs/WebRTC") {{domxref("MediaStream")}}로 구성된 오디오 목적지를 나타내며, 이는 {{ domxref("MediaDevices.getUserMedia", "getUserMedia()") }}에서 얻은 {{domxref("MediaStream")}}과 비슷한 방식으로 사용할 수 있습니다. 이것은 오디오 목적지 역할을 하는 {{domxref("AudioNode")}}입니다.
