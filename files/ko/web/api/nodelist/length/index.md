...
reference에서 이 페이지의 위치에도 불구하고, `length`는 [Element](/ko/docs/DOM/element)의 프로퍼티가 아니고, `NodeList`의 프로퍼티입니다. NodeList 개체는 [document.getElementsByTagName](/ko/docs/DOM/document.getElementsByTagName)과 같은 많은 DOM 메소드에서 반환됩니다.
