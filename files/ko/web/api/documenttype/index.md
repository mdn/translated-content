...
- {{domxref("DocumentType.internalSubset")}} {{readonlyInline}} {{deprecated_inline}}
  - : 내부 하위 집합의 {{jsxref("String")}} 입니다. 하위 집합이 존재하지 않을 경우 `null`입니다. 예, `"<!ELEMENT foo (bar)>"`.
- {{domxref("DocumentType.name")}} {{readonlyInline}}
  - : {{jsxref("String")}} 입니다. 예, `<!DOCTYPE HTML>` 의 경우 `"html"`.
...
- {{domxref("DocumentType.publicId")}} {{readonlyInline}}
  - : {{jsxref("String")}} 입니다. 예, `"-//W3C//DTD HTML 4.01//EN"`, HTML5의 경우 빈 문자열.
- {{domxref("DocumentType.systemId")}} {{readonlyInline}}
  - : {{jsxref("String")}} 입니다. 예, `"http://www.w3.org/TR/html4/strict.dtd"`, HTML5의 경우 빈 문자열.
