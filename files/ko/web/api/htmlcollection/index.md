...
- {{domxref("HTMLCollection.item()")}}
  - : 리스트에서 주어진 인덱스의 노드를 반환합니다. 인덱스가 범위 밖일 경우 {{jsxref("Operators/null", "null")}}을 반환합니다.
- {{domxref("HTMLCollection.namedItem()")}}
  - : 리스트에서 ID 또는 이름 속성이 주어진 문자열과 일치하는 노드를 반환합니다. 이름 속성 판별은 HTML에서만 최후의 수단으로 쓰이며 참조하는 요소가 `name` 속성을 지원해야 합니다. 일치하는 요소가 없으면 {{jsxref("Operators/null", "null")}}을 반환합니다.
