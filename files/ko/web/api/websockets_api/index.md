...
- [Socket.IO](http://socket.io): [Node.js](https://nodejs.org)를 위한 강력한 크로스 플랫폼 웹 소켓 API
- [WebSocket-Node](https://github.com/Worlize/WebSocket-Node): [Node.js](https://nodejs.org)를 위한 웹 소켓 서버 API 구현
