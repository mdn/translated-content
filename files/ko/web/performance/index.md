...
MDN의 [웹 성능 학습 안내서](/en-US/docs/Learn/Performance)에는 웹 성능의 필수 개념들에 대한 최신 튜토리얼들이 있습니다. 웹 성능의 세계에 막 발을 들여놓았다면 여기에서 시작하세요.

- [웹 성능: 개요](/en-US/docs/Learn/Performance/What_is_web_performance)
  - : 본격적으로 웹 성능에 대해 배우기 전 내용을 전반적으로 살펴봅니다. 여기에서 여정을 시작하세요.
- [웹 성능이란 무엇인가?](/en-US/docs/Learn/Performance/What_is_web_performance)
...
- [사용자는 성능을 어떻게 인지하는가?](/en-US/docs/Learn/Performance/Perceived_performance)
...
- [웹 성능 기초](/en-US/docs/Learn/Performance/Web_Performance_Basics)
...
- [HTML과 웹 성능](/en-US/docs/Learn/Performance/HTML)
...
- [멀티미디어: 이미지와 비디오](/en-US/docs/Learn/Performance/Multimedia)
...
- [CSS와 웹 성능](/en-US/docs/Learn/Performance/CSS)
...
- [웹 성능을 높이는 JavaScript 모범 사례](/en-US/docs/Learn/Performance/JavaScript)
...
- [모바일 환경에서의 웹 성능](/en-US/docs/Learn/Performance/Mobile)
...
- [Performance API](/en-US/docs/Web/API/Performance_API/Using_the_Performance_API)
  - : 이 안내서는 [High-Resolution Time](https://w3c.github.io/hr-time/) 기준에 정의된 [`Performance`](/en-US/docs/Web/API/Performance) 인터페이스를 어떻게 사용하는지 설명합니다.
- [Resource Timing API](/en-US/docs/Web/API/Resource_Timing_API/Using_the_Resource_Timing_API)
  - : [Resource loading and timing](/en-US/docs/Web/API/Resource_Timing_API) 리소스를 로딩하고, 리소스 버퍼와 CORS에 대응하는 법을 다룹니다.
- [The performance timeline](/en-US/docs/Web/API/Performance_Timeline/Using_Performance_Timeline)
  - : [Performance Timeline](/en-US/docs/Web/API/Performance_Timeline) 기준은 [`Performance`](/en-US/docs/Web/API/Performance) 인터페이스의 확장으로, 클라이언트 차원의 대기 시간을 어플리케이션 내부에서 측정할 수 있도록 돕습니다. 두 인터페이스를 함께 사용하여 어플리케이션의 어떤 지점이 성능에 병목 현상을 일으키는지 찾을 수 있습니다.
- [User Timing API](/en-US/docs/Web/API/User_Timing_API/Using_the_User_Timing_API)
  - : [user timing API](/en-US/docs/Web/API/User_Timing_API)의 "mark"와 "measure" 타입을 활용하여 어플리케이션에 특화된 타임스탬프를 만들어 보세요. 이들은 브라우저의 Performance timeline의 일부가 됩니다.
- [Beacon API](/en-US/docs/Web/API/Beacon_API)
  - : [Beacon](/en-US/docs/Web/API/Beacon_API) 인터페이스는 비동기적이고 차단되지 않는 요청을 웹 서버에 보내도록 예약합니다.
- [Intersection Observer API](/en-US/docs/Web/API/Intersection_Observer_API/Timing_element_visibility)
  - : [Intersection Observer API](/en-US/docs/Web/API/Intersection_Observer_API)를 활용하여 요소가 보이는 시간을 지정하고 관심 요소가 보일 때 비동기적으로 알림을 받으세요.
...
- [`<picture>` 요소](/en-US/docs/Web/HTML/Element/picture)
- [`<video>` 요소](/en-US/docs/Web/HTML/Element/video)
- [`<source>` 요소](/en-US/docs/Web/HTML/Element/source)
- [`<img> srcset` 요소](/en-US/docs/Web/HTML/Element/img#attributes)

  - [반응형 이미지](/en-US/docs/Learn/HTML/Multimedia_and_embedding/Responsive_images)

- [`rel="preload"`를 사용해 콘텐츠 미리 불러오기](/en-US/docs/Web/HTML/Link_types/preload) - <https://w3c.github.io/preload/>
