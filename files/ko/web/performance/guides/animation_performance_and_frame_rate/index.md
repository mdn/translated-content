...
[CSS 애니메이션](/ko/docs/Web/CSS/Guides/Animations/Using)에서는 여러 [키프레임](/ko/docs/Web/CSS/Reference/At-rules/@keyframes)을 지정하며, 각 키프레임은 CSS를 사용하여 애니메이션의 특정 단계에서 요소의 모습을 정의합니다. 브라우저는 각 키프레임에서 다음 키프레임으로 전환하여 애니메이션을 생성합니다.
