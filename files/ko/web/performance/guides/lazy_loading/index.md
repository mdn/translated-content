...
웹페이지에는 데이터 사용량과 페이지 로드 속도에 영향을 미치는 많은 이미지가 포함되어 있는 경우가 많습니다. 이러한 이미지의 대부분은 화면 밖([중요하지 않음](Guides/Critical_rendering_path))에 있으므로 스크롤과 같은 사용자 상호 작용이 있어야 볼 수 있습니다.
