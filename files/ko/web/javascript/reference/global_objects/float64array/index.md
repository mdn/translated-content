...
**`Float64Array`** 형식화 배열(TypedArray)은 플랫폼의 바이트 순서를 따르는 64비트 부동 소수점(C의 `double`
...
- [`Float64Array()`](/ko/docs/Web/JavaScript/Reference/Global_Objects/Float64Array/Float64Array)
...
- {{jsxref("TypedArray.name", "Float64Array.name")}}
  - : 생성자 이름을 문자열로 반환합니다. `Float64Array` 타입의 경우 `"Float64Array"`입니다.
