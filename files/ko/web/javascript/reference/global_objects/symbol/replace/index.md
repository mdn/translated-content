...
자세한 내용은 [`RegExp.prototype[@@replace]()`](/ko/docs/Web/JavaScript/Reference/Global_Objects/RegExp/@@replace), {{jsxref("String.prototype.replace()")}} 및 {{jsxref("String.prototype.replaceAll()")}}를 참고하시기 바랍니다.
