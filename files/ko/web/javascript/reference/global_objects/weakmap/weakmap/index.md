...
- `iterable`
  - : 요소 2개(첫 번째 요소가 `WeakMap` 키로 사용될 값이고 두 번째 요소가 해당 키에 연결할 값)로 구성된 유사 배열 객체를 생성하는 반복자 객체를 반환하는 [`Array`](/ko/docs/Web/JavaScript/Reference/Global_Objects/Array) 또는 [@@iterator](/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/@@iterator). 각 키-값 쌍은 새로운 `WeakMap`에 추가됩니다. null은 undefined으로 취급합니다.
