...
> **경고:** `@@species` 존재는 임의의 코드가 실행될 수 있게하며 보안 취약점이 발생할 수 있습니다. 또한 어떠한 최적화를 훨씬 어렵게 만들 수 있습니다. 엔진 구현자들은 [이 기능을 제거할지 여부를 검토 중 입니다](https://github.com/tc39/proposal-rm-builtin-subclassing). 가능하면 이 기능에 의존하지 마시기 바랍니다.
