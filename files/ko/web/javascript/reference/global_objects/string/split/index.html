...
<div class="notecard note">
  <p><code>separator</code>가 배열일 경우 분할에 사용하기 전에 우선 문자열로 변환됩니다.</p>
</div>
...
<div class="notecard note">
  <p>빈 문자열이 주어졌을 경우 <code>split()</code>은 빈 배열이 아니라 빈 문자열을 포함한 배열을 반환합니다. 문자열과 <code>separator</code>가 모두 빈 문자열일 때는 빈 배열을 반환합니다.</p>
</div>
