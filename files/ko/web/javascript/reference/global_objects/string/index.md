...
<dl>
  <dt>{{jsxref("String.fromCharCode()", "String.fromCharCode(<var>num1</var> [, ...[,
    <var>numN</var>]])")}}</dt>
  <dd>
    <p>지정된 유니코드 값의 순서를 이용하여 만든 문자열을 반환합니다.</p>
  </dd>
  <dt>{{jsxref("String.fromCodePoint()", "String.fromCodePoint(<var>num1</var> [, ...[,
    <var>numN</var>)")}}</dt>
  <dd>
    <p>지정된 코드 포인트 순서를 이용하여 만든 문자열을 반환합니다.</p>
  </dd>
  <dt>{{jsxref("String.raw()")}}</dt>
  <dd>
    <p>원형 템플릿 문자열(raw template string)에서 생성된 문자열을 반환합니다.</p>
  </dd>
</dl>
...
<dl>
  ...
  <dt>{{jsxref("String.prototype.lastIndexOf()",
    "String.prototype.lastIndexOf(<var>searchValue</var> [, <var>fromIndex</var>])")}}</dt>
  <dd>
    <p>
  ...
  <dt>{{jsxref("String.prototype.toLocaleLowerCase()",
    "String.prototype.toLocaleLowerCase( [<var>locale</var>, ...<var>locales</var>])")}}</dt>
  <dd>
    <p>
  ...
  <dt>{{jsxref("String.prototype.toLocaleUpperCase()",
    "String.prototype.toLocaleUpperCase( [<var>locale</var>, ...<var>locales</var>])")}}</dt>
  <dd>
    <p>
