...
> **참고:** 모든 [HTML 래퍼 메서드](/ko/docs/Web/JavaScript/Reference/Global_Objects/String#html_wrapper_methods)는 더 이상 사용되지 않으며 호환성 목적으로만 표준화되었습니다. 대신 [`document.createElement()`](/ko/docs/Web/API/Document_Object_Model)와 같은 [DOM API](/ko/docs/Web/API/Document/createElement)를 사용하시기 바랍니다. 웹 개발자들은 삭제된 컨텐츠에는 {{HTMLElement("del")}}을 사용하거나 더 이상 정확하지 않거나 더 이상 관련성이 없는 콘텐츠에는 {{HTMLElement("s")}}를 대신 사용해야 합니다.
