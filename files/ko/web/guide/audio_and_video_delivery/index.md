...
- [Audio/Video Codec Compatibility Table](/ko/docs/Web/HTML/Supported_media_formats#Browser_compatibility)
...
> **참고:** The preload attribute may be ignored by some mobile browsers.
...
> **참고:** The autoplay attribute may be ignored by some mobile browsers.

For further info see [\<video> element](/ko/docs/Web/HTML/Element/video) and [Creating a cross-browser video player](/en-US/Apps/Build/Manipulating_media/cross_browser_video_player).
...
> **참고:** Play will be ignored by some mobile browsers unless issued by a user-initiated event.
...
See [MediaRecorder API](/ko/docs/Web/API/MediaRecorder_API) for more details.
...
> **참고:** Currently Safari does not support DASH although dash.js will work on newer versions of Safari scheduled for release with OSX Yosemite.
...
- [DASH Adaptive Streaming for HTML 5 Video](/ko/docs/Web/HTML/DASH_Adaptive_Streaming_for_HTML_5_Video)
...
> **참고:** Firefox OS versions 1.3 and above support the [RTSP](http://en.wikipedia.org/wiki/Real_Time_Streaming_Protocol) protocol for streaming video delivery. A fallback solution for older versions would be to use `<video>` along with a suitable format for Gecko (such as WebM) to serve fallback content. More information will be published on this in good time.

## References

- [The video element](/ko/docs/Web/HTML/Element/video)
- [Media events API](/ko/docs/Web/Guide/Events/Media_events)
- [HTMLVideoElement API](/ko/docs/Web/API/HTMLVideoElement)
- [MediaSource API](/ko/docs/Web/API/MediaSource)
- [Web Audio API](/ko/docs/Web/API/Web_Audio_API)
- [MediaRecorder API](/ko/docs/Web/API/MediaRecorder_API)
