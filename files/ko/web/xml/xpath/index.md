...
XPath는 주로 [XSLT](/ko/XSLT)에서 쓰입니다. 하지만 또한 [getElementById](/ko/docs/Web/API/Document/getElementById) 메소드, [childNodes](/ko/docs/Web/API/Node/childNodes) 특성들에 의존하는 대신 HTML과 [XUL](/ko/XUL) 같은 다른 XML에 기반을 둔 언어 문서를 [DOM](/ko/docs/Web/API/Document_Object_Model)을 통해 항해하는 더 나은 강력한 방법으로도 쓰입니다. 다음은 모호합니다: 이는 확장기능 안에서 특히 쓸모 있습니다, 특히 [overlays](/ko/XUL_Overlays)를 고려하면.
...
<section id="Quick_links">
  <ol>
    <li><strong><a href="/ko/docs/Web/XML/XSLT">XSLT</a></strong></li><li><strong><a href="/ko/docs/Web/XML/EXSLT">EXSLT</a></strong></li>
    ...
    <li class="toggle"><details open><summary><a href="/ko/docs/Web/XML/XPath/Reference/Axes">XPath Axes</a></summary>{{ListSubpagesForSidebar("/ko/docs/Web/XPath/Axes")}}</details></li>
    <li class="toggle"><details open><summary><a href="/ko/docs/Web/XML/XPath/Reference/Functions">XPath Functions</a></summary>{{ListSubpagesForSidebar("/ko/docs/Web/XPath/Functions")}}</details></li>
  </ol>
</section>
