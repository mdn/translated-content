...
- [`slot`](/ko/docs/Web/HTML/Global_attributes/slot)
  - : 요소에 [shadow DOM](/ko/docs/Web/API/Web_components/Using_shadow_DOM)의 shadow tree에 있는 슬롯을 할당합니다: `slot` 특성을 가진 요소는 [`name`](/ko/docs/Web/HTML/Element/slot#name) 특성의 값이 해당 `slot` 특성의 값과 일치하는 {HTMLElement("slot")}} 요소가 생성한 슬롯에 할당됩니다.
