...
<table class="standard-table">
  ...
  <tbody>
      ...
      <td>
        <ul>
          <li>
            ...
            <a href="/ko/docs/Web/HTML/Reference/Elements/link#rel"><code>rel</code></a> 속성값에
            <code>stylesheet</code>라는 값이 들어 있다면, 링크가
            <a href="/ko/docs/Web/HTML/Reference/Attributes/rel/alternate_stylesheet">대체 스타일 시트</a
            >로 정의된 것입니다. 이 경우,
            <a href="/ko/docs/Web/HTML/Reference/Elements/link#title"><code>title</code></a> 속성은 반드시 존재해야
            하고 빈 문자열 값을 가지고 있으면 안됩니다.
          </li>
          <li>
            만약 <a href="/ko/docs/Web/HTML/Reference/Elements/link#type"><code>type</code></a>의 값이
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                페이지(<a href="/ko/docs/Web/HTML/Reference/Elements/link#media"><code>media</code></a> 속성이
                정의되어 있을 시)
              </li>
              <li>
                외국어로 된
                페이지(<a href="/ko/docs/Web/HTML/Reference/Elements/link#hreflang"><code>hreflang</code></a> 속성이
                정의되어 있을 시)
              </li>
              <li>
                PDF처럼 다른 형식으로 된
                페이지(<a href="/ko/docs/Web/HTML/Reference/Elements/link#type"><code>type</code></a> 속성이 정의되어
                있을 시)
              </li>
    ...
    <tr>
      ...
      <td>
        ...
        <p>
          ...
          <a href="/ko/docs/Web/HTML/Reference/Elements/link#rev"><code>rev</code></a> 속성을 사용하고 링크 타입을
          <code>made</code>로 넣으면 인식이 되기는 하지만 부정확한 값이므로
          <a href="/ko/docs/Web/HTML/Reference/Elements/link#rel"><code>rel</code></a> 속성값을
    ...
    <tr>
      ...
      <td>
        <p>
          ...
          아이콘을 정의합니다.<br /><br /><a href="/ko/docs/Web/HTML/Reference/Elements/link#media"><code>media</code></a>,
          <a href="/ko/docs/Web/HTML/Reference/Elements/link#type"><code>type</code></a>,
          <a href="/ko/docs/Web/HTML/Reference/Elements/link#sizes"><code>sizes</code></a> 특성을 사용하면
          ...
          <a href="/ko/docs/Web/HTML/Reference/Elements/link#sizes"><code>sizes</code></a> 특성을 사용하지 않습니다.
          대신, 각각에 대응하는 비표준
          <a
    ...
    <tr>
      ...
      <td>
        연결한 파일이 <a href="/ko/docs/Web/Progressive_web_apps/Manifest">Web App Manifest</a>임을
        나타냅니다.
      </td>
      <td>{{HTMLElement("link")}}</td>
      <td>{{HTMLElement("a")}}, {{HTMLElement("area")}}</td>
    ...
    <tr>
      ...
      <td>
        ...
        resources.<br /><br />If the <a href="/ko/docs/Web/HTML/Reference/Elements/link#type"><code>type</code></a>
        attribute is set to
    ...
    <tr>
      ...
      <td>
        ...
        an
        <a href="/ko/docs/Web/HTML/Reference/Attributes/rel/alternate_stylesheet"
          >alternative style sheet</a
        >; in that case the <a href="/ko/docs/Web/HTML/Reference/Elements/link#title"><code>title</code></a>
