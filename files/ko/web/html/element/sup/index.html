...
<ul>
 <li>"x<sup>3</sup>" 등 거듭제곱 연산의 지수 표기. 더 복잡한 표기를 해야 할 경우 <a href="/ko/docs/Web/MathML">MathML</a>을 고려하세요. 아래의 <a href="#지수_표기">지수 표기</a> 예제를 참고하세요.</li>
 <li class="hidden">Displaying <a href="https://en.wikipedia.org/wiki/Superior_letter">superior letter</a>, which is used in some languages when rendering certain abbreviations. For example, in French, the word "mademoiselle" can be abbreviated "M<sup>lle</sup>"); this is an acceptable use case. See <a href="#superior_lettering">Superior lettering</a> for examples.</li>
 <li>"4<sup>th</sup>" 등 서수 표기. 아래의 <a href="#서수_표기">서수 표기</a> 예제를 참고하세요.</li>
</ul>
