...
<ul>
 <li>각주 표기. 아래의 <a href="#각주_표기">각주 표기</a> 예제를 참고하세요.</li>
 <li>수학 변수의 숫자 표기. <a href="/ko/docs/Web/MathML">MathML</a>을 사용하는 방향을 고려하세요. <a href="#변수_표기">변수 표기</a> 예제를 참고하세요.</li>
 <li>화학식에서 원소의 수를 나타낼 때. (개발자의 친구, C<sub>8</sub>H<sub>10</sub>N<sub>4</sub>O<sub>2</sub>, 카페인) 아래의 <a href="#화학식">화학식</a> 예제를 참고하세요.</li>
</ul>
