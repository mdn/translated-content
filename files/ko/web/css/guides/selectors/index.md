...
- [전체 선택자](/ko/docs/Web/CSS/Reference/Selectors/Universal_selectors)
  - : 모든 요소를 선택합니다. 추가로 네임스페이스 제한을 둘 수 있습니다.
    **구문:** `*` `ns|*` `*|*`
    **예제:** `*`은 문서 내의 모든 요소와 일치합니다.
- [유형 선택자](/ko/docs/Web/CSS/Reference/Selectors/Type_selectors)
  - : 주어진 노드 이름을 가진 모든 요소를 선택합니다.
    **구문:** `elementname`
    **예제:** `input`은 모든 {{HTMLElement("input")}} 요소와 일치합니다.
- [클래스 선택자](/ko/docs/Web/CSS/Reference/Selectors/Class_selectors)
  - : 주어진 `class` 특성을 가진 모든 요소를 선택합니다.
    **구문:** `.classname`
    **예제:** `.index`는 "index" 클래스를 가진 모든 요소와 일치합니다.
- [ID 선택자](/ko/docs/Web/CSS/Reference/Selectors/ID_selectors)
  - : `id` 특성에 따라 요소를 선택합니다. 문서 내에는 주어진 ID를 가진 요소가 하나만 존재해야 합니다.
    **구문:** `#idname`
    **예제:** `#toc`는 "toc" ID를 가진 요소와 일치합니다.
- [특성 선택자](/ko/docs/Web/CSS/Reference/Selectors/Attribute_selectors)
...
- [선택자 목록](/ko/docs/Web/CSS/Reference/Selectors/Selector_list)
...
- [인접 형제 결합자](/ko/docs/Web/CSS/Reference/Selectors/Next-sibling_combinator)
  - : `+` 결합자는 인접 형제, 즉 첫 번째 요소의 바로 뒤에 위치하면서 같은 부모를 공유하는 두 번째 요소를 선택합니다.
    **구문:** `A + B`
    **예제:** `h2 + p`는 {{HTMLElement("h2")}} 바로 뒤에 위치하는 {{HTMLElement("p")}} 요소와 일치합니다.
- [열 결합자](/ko/docs/Web/CSS/Reference/Selectors/Column_combinator) {{Experimental_Inline}}
...
[의사 클래스](/ko/docs/Web/CSS/Reference/Selectors/Pseudo-classes#명세)와 [의사 요소](/ko/docs/Web/CSS/Reference/Selectors/Pseudo-elements#명세)의 명세 표에서 각각의 상세 정보를 볼 수 있습니다.

## 같이 보기

- [CSS 명시도](/ko/docs/Web/CSS/Guides/Cascade/Specificity)
