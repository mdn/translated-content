...
- [상속 속성](/ko/docs/Web/CSS/Guides/Cascade/Inheritance#inherited_properties)의 경우, [지정값](/ko/docs/conflicting/Web/CSS/CSS_cascade/Value_processing)이 없는 이상 초깃값은 **루트 요소에만** 쓰입니다.
- [비상속 속성](/ko/docs/Web/CSS/Guides/Cascade/Inheritance#non-inherited_properties)의 경우, [지정값](/ko/docs/conflicting/Web/CSS/CSS_cascade/Value_processing)이 없는 이상 초깃값은 **모든 요소**에 쓰입니다.
