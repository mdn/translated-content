...
- [다수의 배경 사용하기](/ko/docs/Web/CSS/Guides/Backgrounds_and_borders/Using_multiple_backgrounds)
  - : 하나의 요소에 여러 배경을 적용하는 법을 배웁니다.
- [배경 이미지 크기 조정하기](/ko/docs/Web/CSS/Guides/Backgrounds_and_borders/Resizing_background_images)
...
- [Box-shadow 생성기](/ko/docs/Web/CSS/Guides/Backgrounds_and_borders/Box-shadow_generator)
