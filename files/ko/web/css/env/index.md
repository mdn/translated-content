...
> [!NOTE]
> 유저 에이전트 속성들은 [all](/ko/docs/Web/CSS/Reference/Properties/all) 속성에 의해 초기화되지 않습니다.
...
> [!NOTE]
> `position:fixed` 를 사용하면 헤더가 나머지 컨텐츠와 함께 스크롤되지 않고, 탄성 오버스크롤(rubber banding 으로도 알려져 있습니다)을 지원하는 기기/브라우저에서도 창 제어 버튼과 정렬되어 유지됩니다.
