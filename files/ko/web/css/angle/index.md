...
| ![Angle90.png](https://developer.mozilla.org/@api/deki/files/5704/=Angle90.png) | `90deg = 100grad = 0.25turn ≈ 1.5708rad` |
| ------------------------------------------------------------------------------- | ---------------------------------------- |

### 반대로 회전

| ![Angle180.png](https://developer.mozilla.org/@api/deki/files/5706/=Angle180.png) | `180deg = 200grad = 0.5turn ≈ 3.1416rad` |
| --------------------------------------------------------------------------------- | ---------------------------------------- |

### 시계 반대 방향 우측 90도

| ![AngleMinus90.png](https://developer.mozilla.org/@api/deki/files/5707/=AngleMinus90.png) | `-90deg = -100grad = -0.25turn ≈ -1.5708rad` |
| ----------------------------------------------------------------------------------------- | -------------------------------------------- |

### 회전 없음

| ![Angle0.png](https://developer.mozilla.org/@api/deki/files/5708/=Angle0.png) | `0 = 0deg = 0grad = 0turn = 0rad` |
| ----------------------------------------------------------------------------- | --------------------------------- |
