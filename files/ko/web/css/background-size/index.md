...
<ul>
 ...
 <li>너비 값만 사용. 높이는 자동으로 <code><a href="#auto">auto</a></code>가 됩니다.</li>
 <li>너비와 높이 값을 모두 사용. 첫 번째 값은 너비로, 두 번째 값은 높이를 설정합니다. 각 값은 {{cssxref("&lt;length&gt;")}}, {{cssxref("&lt;percentage&gt;")}}, <code><a href="#auto">auto</a></code>를 사용할 수 있습니다.</li>
</ul>
