...
[CSS](/ko/docs/Web/CSS) **`align-content`** 속성은 콘텐츠 사이와 콘텐츠 주위 빈 공간을 [플렉스 박스](/ko/docs/Web/CSS/Guides/Flexible_box_layout)'의 교차축 또는 [그리드](/ko/docs/Web/CSS/Guides/Grid_layout)의 블록 축을 따라 배치하는 방식을 결정합니다.
