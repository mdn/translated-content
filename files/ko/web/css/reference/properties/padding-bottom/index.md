...
**`padding-bottom`** [CSS](/ko/docs/Web/CSS) 속성은 요소의 아래쪽에 [안쪽 여백 영역](/ko/docs/Web/CSS/Guides/Box_model/Introduction#padding-area)을 설정합니다.
...
- {{cssxref("&lt;length&gt;")}}
  - : 여백의 크기로 고정값 사용.
- {{cssxref("&lt;percentage&gt;")}}
  - : 여백의 크기로 [컨테이닝 블록](/ko/docs/Web/CSS/Guides/Display/Containing_block) **너비**의 백분율 사용.
