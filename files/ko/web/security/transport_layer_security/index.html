...
<p>TLS 핸드쉐이크가 협상하는 주요 파라메터들은 <a href="https://en.wikipedia.org/wiki/Cipher_suite">cipher suite</a>입니다.</p>
...
<ul>
 ...
 <li>Numerous mechanisms have been disabled: renegotiation, generic data compression, <a href="https://en.wikipedia.org/wiki/Digital_Signature_Algorithm">Digital Signature Algorithm</a> (DSA) certificates, static RSA key exchange, and key exchange with custom Diffie-Hellman (DH) groups.</li>
</ul>
