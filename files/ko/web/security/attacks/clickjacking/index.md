...
[콘텐츠 보안 정책(frame-ancestors)](/ko/docs/Web/HTTP/Headers/Content-Security-Policy/frame-ancestors) 및 [Set-Cookie 속성](/ko/docs/Web/HTTP/Reference/Headers/Set-Cookie#attributes)를 구현하면 클릭재킹을 방지할 수 있습니다.
