...
- [인식의 용이성:](/en-US/docs/Web/Accessibility/Understanding_WCAG/Perceivable) 사용자가 하나 또는 다수의 감각을 사용해 어떤 방식으로든 인지할 수 있어야 합니다.
- [운용의 용이성](/en-US/docs/Web/Accessibility/Understanding_WCAG/Operable): 사용자가 UI 요소들을 컨트롤 할 수 있어야 합니다(예를 들어, 버튼은 마우스, 키보드, 음성 명령 등의 방식으로 클릭이 가능해야 합니다).
- [이해의 용이성](/en-US/docs/Web/Accessibility/Understanding_WCAG/Understandable): 컨텐츠를 사용자가 이해할 수 있어야 합니다.
- [견고성](/en-US/docs/Web/Accessibility/Understanding_WCAG/Robust): 컨텐츠는 각기 다른 브라우저에서, 현재와 미래에 모두 동작할 수 있도록 널리 알려진 웹 표준을 준수하여 개발되어야 합니다.
