...
모든 `Memory` 인스턴스는 `Memory()`생성자의 [prototype object](/ko/docs/WebAssembly/Reference/JavaScript_interface/Memory)를 상속합니다.이 인스턴스는 모든 `Memory` 인스턴스에 적용되도록 수정할 수 있습니다.
