...
주어진 [`WebAssembly.Module`](/ko/docs/WebAssembly/Reference/JavaScript_interface/Module) 객체를 동기적으로 인스턴스화하기 위해 `WebAssembly.Instance()` 생성자 함수를 호출 할 수 있습니다. 하지만 `Instance`를 가져 오는 주요 방법은 비동기 [`WebAssembly.instantiateStreaming ()`](/ko/docs/WebAssembly/Reference/JavaScript_interface/instantiateStreaming) 함수를 사용하는 것입니다.
...
- [`Instance.prototype.exports`](/ko/docs/WebAssembly/Reference/JavaScript_interface/Instance/exports)
