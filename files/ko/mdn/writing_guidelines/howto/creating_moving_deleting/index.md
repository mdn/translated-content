...
2. 이름을 선택하고, 편집기의 툴바에서 링크 아이콘 클릭(**click the Link icon (![](https://developer.mozilla.org/files/3810/link-icon.png))**)을 클릭합니다. "**Update Link**" 다이얼로그가 열리고, "**Link To**" 항목에 선택된 텍스트로 채워집니다.
3. 기본적으로, URL 항목의 시작 부분은 "/en-US/docs/"가 삽입됩니다. \_\_"/en-US/docs/" 다음에 페이지의 이름을 입력하세요. (페이지 이름은 링크 텍스트와 동일하지 않아도 됩니다.)
