...
As an example, the first value that can be parsed as a [`<time>`](/ko/docs/Web/CSS/time) is assigned to the [`animation-duration`](/ko/docs/Web/CSS/animation-duration), and the second one is assigned to [`animation-delay`](/ko/docs/Web/CSS/animation-delay). For more details, read the full [animation syntax](/ko/docs/Web/CSS/animation#Syntax) details.
