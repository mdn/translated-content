...
> [!NOTE]
> 이 글에서는 MDN Web Docs의 글로벌 커뮤니티를 다룹니다. 한국어 소통 창구는 [지역화](/ko/docs/MDN/Community/Translated_content) 문서에서 확인하세요.
...
- Mozilla Element 웹 앱의 [mdn 방](https://chat.mozilla.org/#/room/#mdn:mozilla.org)
- Matrix Element 웹 앱의 [mdn 방](https://app.element.io/#/room/#mdn:mozilla.org)
...
각 현지화 팀은 [자체적으로 소통 방법](/ko/docs/MDN/Community/Translated_content)을 가지고 있습니다.

## 이메일

비공개 소통이 필요한 경우,[mdn-admins](mailto:mdn-admins@mozilla.org)으로 이메일을 보내 주세요.
