...
작업하고 싶은 항목을 결정했으면 [기여자 작업 게시판](https://github.com/orgs/mdn/projects/25/views/1)에 가서 문제를 선택한 후, 문제에 코멘트를 남기고 `@mdn/community` 팀을 태그해 주세요. 팀원이 응답하고 문제를 할당해 드릴 것입니다.
