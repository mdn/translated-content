...
- [인터넷은 어떻게 작동합니까?](/ko/docs/Learn_web_development/Howto/Web_mechanics/How_does_the_Internet_work)
...
- [하이퍼링크란 무엇인가요?](/ko/docs/Learn_web_development/Howto/Web_mechanics/What_are_hyperlinks)
...
- [도메인 네임이란 무엇인가요?](/ko/docs/Learn_web_development/Howto/Web_mechanics/What_is_a_domain_name)
  - : 도메인 네임은 인터넷 인프라의 핵심 구성 요소입니다. 도메인 네임은 인터넷에서 사용할 수 있는 모든 웹 서버에 사람이 읽을 수 있는 주소를 제공합니다.
- [웹 서버란 무엇인가요?](/ko/docs/Learn_web_development/Howto/Web_mechanics/What_is_a_web_server)
