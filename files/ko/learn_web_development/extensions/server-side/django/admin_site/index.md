...
> [!NOTE]
> **주의**: 책의 언어를 나타내기 위한 모델을 생성하는 도전과제를 수행했다면 ([see the models tutorial article](/ko/docs/Learn_web_development/Extensions/Server-side/Django/Models)), 그 모델도 import 한 후 등록하세요!
