...
이 글의 끝에 도달했지만 가장 중요한 정보를 기억하고 있나요? 이 정보를 기억했는지 확인하기 위한 몇 가지 추가 테스트를 찾을 수 있습니다. 다음으로 이동하기 전에 [기술 테스트: HTML5 컨트롤](/ko/docs/Learn_web_development/Extensions/Forms)을 확인하십시오.
