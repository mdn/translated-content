...
- [`rel=preconnect`](/ko/docs/Web/HTML/Attributes/rel/preconnect), [`rel=dns-prefetch`](/ko/docs/Web/HTML/Attributes/rel/dns-prefetch), [`rel=prefetch`](/ko/docs/Web/HTML/Attributes/rel/prefetch), [`rel=preload`](/ko/docs/Web/HTML/Reference/Attributes/rel/preload)와 같은 리소스 힌트를 사용하세요.
...
- [CSS](/ko/docs/Learn_web_development/Extensions/Performance/CSS) 성능 요소 고려.
...
- 뷰포트 외부의 애플리케이션 부분을 지연 로딩하기. 그렇게 할 경우, SEO를 위한 백업 계획을 마련하세요 (예: 봇 트래픽에 대해 전체 페이지 렌더). 예를 들어, {{HTMLElement("img")}} 요소에 [`loading`](/ko/docs/Web/HTML/Reference/Elements/img#loading) 속성 사용하기.
- 사용자에게 정말 중요한 것이 무엇인지 인지하는 것도 중요합니다. 절대적인 타이밍이 아닌 [사용자 인식](/ko/docs/Learn_web_development/Extensions/Performance/Perceived_performance)이 중요할 수 있습니다.
...
[async](/ko/docs/Web/HTML/Reference/Elements/script) 또는 [defer](/ko/docs/Web/HTML/Reference/Elements/script) 속성을 사용하거나 페이지의 DOM 요소 뒤에 JavaScript 애셋을 연결하여 JavaScript 렌더링 차단을 피하세요. JavaScript는 DOM 트리에서 스크립트 태그 뒤에 나타나는 요소들의 렌더링만 차단합니다.
