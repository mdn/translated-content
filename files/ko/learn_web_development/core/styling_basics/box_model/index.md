    ...
    <tr>
      ...
      <td>
        ...
        <a
          ...
          >파일 작업에 대한 기본 지식</a
        >, HTML 기본기 (<a href="/ko/docs/conflicting/Learn_web_development/Core/Structuring_content"
          >HTML</a
        >
...
그러나 박스에는 _내부_ 디스플레이 유형도 있으며 당 박스 내부의 요소가 배치되는 방법을 나타냅니다. 기본적으로 박스 내부의 요소는 [**일반 대열**](/ko/docs/conflicting/Learn_web_development/Core/CSS_layout/Introduction)로 배치되며, 이는 (위에서 설명한 바와 같이) 여타 블록 및 인라인 요소와 마찬가지로 작동한다는 것을 의미합니다.
...
> [!NOTE]
> 여백은 박스의 실제 크기에 포함되지 않습니다. 물론 여백은 박스가 페이지에서 차지하는 총 공간에 영향을 미치지만, 박스의 외부 공간에만 영향을 미칩니다. 박스의 영역은 테두리에서 멈추게 됩니다. 여백으로 확장되지 않습니다.
...
> [!NOTE]
> 흥미로운 기록이 있습니다. 인터넷 익스플로러는 기본적으로 대체 박스 모델로 사용되었으며 전환할 수있는 메커니즘이 없습니다.
