...
1. **Thousands**: 선언이 인라인 스타일인 [`style`](/ko/docs/Web/HTML/Reference/Global_attributes#style) 속성 안에 있으면, 열에서 1점을 얻습니다. 이러한 선언에는 선택자가 없으므로 그 우선 순위는 항상 1000 입니다.
...
| 요소의 [`style`](/ko/docs/Web/HTML/Reference/Global_attributes#style) 속성 안에 규칙이 있는 선택자가 없습니다 | 1         | 0        | 0    | 0    | 1000              |
