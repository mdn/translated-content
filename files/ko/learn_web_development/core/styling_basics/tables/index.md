...
<table class="learn-box standard-table">
  <tbody>
    <tr>
      ...
      <td>
        HTML 기본 사항 (<a href="/ko/docs/conflicting/Learn_web_development/Core/Structuring_content"
          >HTML 소개</a
        >
        학습), <a href="/ko/docs/conflicting/Learn_web_development/Core/Structuring_content/HTML_table_basics">HTML 표</a> 에 대한 지식
