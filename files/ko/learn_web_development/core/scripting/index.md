...
> [!CALLOUT]
> 프론트엔드 웹 개발자가 되기를 생각해보고 계신가요?저희는 여러분의 목표를 향해 공부할 필요가 있는 모든 필수적인 정보를 담고 있는 코스를 준비해 놓았습니다.[**시작하기**](/ko/docs/orphaned/Learn/Front-end_web_developer)

## 필요한 사전 지식

시작하기 전에, 기본적인 [HTML](/ko/docs/conflicting/Learn_web_development/Core/Structuring_content)과 [CSS](/ko/docs/conflicting/Learn_web_development/Core/Styling_basics) 지식을 알고 계셔야 하고, 또한 지난 모듈인 [JavaScript 첫걸음](/ko/docs/conflicting/Learn_web_development/Core/Scripting)을 학습하셔야 합니다.
...
- [판단 내리기 — 조건문](/ko/docs/Learn_web_development/Core/Scripting/Conditionals)
...
- [반복문](/ko/docs/Learn_web_development/Core/Scripting/Loops)
...
- [함수 — 코드 재사용](/ko/docs/Learn_web_development/Core/Scripting/Functions)
...
- [함수 만들기](/ko/docs/Learn_web_development/Core/Scripting/Build_your_own_function)
...
- [함수 반환 값](/ko/docs/Learn_web_development/Core/Scripting/Return_values)
...
- [이미지 갤러리](/ko/docs/Learn_web_development/Core/Scripting/Image_gallery)
