...
original_slug: Learn/JavaScript/Building_blocks/Test_your_skills:_Events
---

{{learnsidebar}}

이 실력 테스트의 목적은 여러분이 우리의 [이벤트 입문](/ko/docs/Learn_web_development/Core/Scripting/Events) 문서를 이해했는지 평가하기 위함입니다.
