...
> [!NOTE]
> 인라인 항목을 flexbox로 취급해 레이아웃하길 희망한다면 {{cssxref("display")}} 속성값을 `inline-flex`로 지정할 수도 있습니다.
...
> [!NOTE]
> 당신은 `row-reverse`와 `column-reverse` 속성값을 사용하여 역방향으로 배치할 수 있습니다. 이들 값으로도 실험해보십시오!
