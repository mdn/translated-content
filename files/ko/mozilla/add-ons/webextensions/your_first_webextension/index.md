...
대신 [web-ext](https://extensionworkshop.com/documentation/develop/getting-started-with-web-ext/) 툴을 사용해 커맨드라인에서 확장기능을 실행할 수도 있습니다.
...
다른 사람들이 확장기능을 사용할 수 있게 하려면, 확장을 패키징하고 Mozilla에 제출해 서명을 받아야 합니다. [확장기능 배포에 대해 더 알아보기.](https://extensionworkshop.com/documentation/publish/package-your-extension/)
