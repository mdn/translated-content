...
- [1. Getting started with Ember](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
...
- [2. Ember app structure and componentization](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
  - : In this article we'll get right on with planning out the structure of our TodoMVC Ember app, adding in the HTML for it, and then breaking that HTML structure into components.
- [3. Ember interactivity: Events, classes and state](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
...
- [4. Ember Interactivity: Footer functionality, conditional rendering](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
...
- [5. Routing in Ember](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
...
- [6. Ember resources and troubleshooting](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
...
- [1. Getting started with Vue](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
  - : Now let's introduce Vue, the third of our frameworks. In this article, we'll look at a little bit of Vue background, learn how to install it and create a new project, study the high-level structure of the whole project and an individual component, see how to run the project locally, and get it prepared to start building our example.
- [2. Creating our first Vue component](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
  - : Now it's time to dive deeper into Vue, and create our own custom component — we'll start by creating a component to represent each item in the todo list. Along the way, we'll learn about a few important concepts such as calling components inside other components, passing data to them via props and saving data state.
- [3. Rendering a list of Vue components](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
...
- [4. Adding a new todo form: Vue events, methods, and models](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
...
- [5. Styling Vue components with CSS](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
...
- [6. Using Vue computed properties](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
...
- [7. Vue conditional rendering: editing existing todos](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
...
- [8. Focus management with Vue refs](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
...
- [9. Vue resources](/pt-BR/docs/Learn_web_development/Core/Frameworks_libraries)
