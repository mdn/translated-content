...
- [Iniciando com a Web](/pt-BR/docs/Learn_web_development/Getting_started/Your_first_website) (o que inclui uma [introdução rápida ao JavaScript](/pt-BR/docs/Learn_web_development/Getting_started/Your_first_website/Adding_interactivity))
...
- [O que é JavaScript?](/pt-BR/docs/Learn_web_development/Core/Scripting/What_is_JavaScript)
...
- [Um primeiro mergulho no JavaScript](/pt-BR/docs/Learn_web_development/Core/Scripting/A_first_splash)
...
- [O que deu errado? Solucionando problemas em JavaScript](/pt-BR/docs/Learn_web_development/Core/Scripting/What_went_wrong)
...
- [Armazenando a informação necessária — Variáveis](/pt-BR/docs/Learn_web_development/Core/Scripting/Variables)
...
- [Matemática básica com JavaScript — números e operadores](/pt-BR/docs/Learn_web_development/Core/Scripting/Math)
...
- [Manuseando textos — cadeia de caracteres (strings) em JavaScript](/pt-BR/docs/Learn_web_development/Core/Scripting/Strings)
...
- [Métodos úteis sobre cadeias de caracteres (strings)](/pt-BR/docs/Learn_web_development/Core/Scripting/Useful_string_methods)
...
- [Matrizes](/pt-BR/docs/Learn_web_development/Core/Scripting/Arrays)
...
- [Gerador de histórias bobas](/pt-BR/docs/Learn_web_development/Core/Scripting/Silly_story_generator)
