...
Faça com que scripts JavaScript sejam compatíveis tanto com [async](/pt-BR/docs/Web/HTML/Reference/Elements/script#attributes) como [defer](/pt-BR/docs/Web/HTML/Element/script#attributes) e use [async](/pt-BR/docs/Web/HTML/Element/script#attributes) sempre que possível, especialmente se você tiver múltiplas tags de script.
