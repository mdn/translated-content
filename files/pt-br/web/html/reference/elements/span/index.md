...
| Categorias de conteúdo   | [Flow content](/pt-BR/docs/Web/HTML/Guides/Content_categories#flow_content), [phrasing content](/pt-BR/docs/Web/HTML/Guides/Content_categories#phrasing_content)                                  |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
