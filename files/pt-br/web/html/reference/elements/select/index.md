...
| [Categorias de conteúdo](/pt-BR/docs/Web/HTML/Guides/Content_categories) | [conteúdo fluido](/pt-BR/docs/Web/HTML/Guides/Content_categories#conteúdo_de_fluxo), [conteúdo fraseado](/pt-BR/docs/Web/HTML/Guides/Content_categories#conteúdo_fraseado), [conteúdo interativo](/pt-BR/docs/Web/HTML/Guides/Content_categories#conteúdo_interativo), [listado](/pt-BR/docs/Web/HTML/Guides/Content_categories#listed), [rotulável](/pt-BR/docs/Web/HTML/Guides/Content_categories#labelable), [resetável](/pt-BR/docs/Web/HTML/Guides/Content_categories#resettable), e [enviável](/pt-BR/docs/Web/HTML/Guides/Content_categories#submittable) [associado a formulários](/pt-BR/docs/Web/HTML/Guides/Content_categories#conteúdo_associado_ao_form) |
| ------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
O conteúdo deste elemento é estático e não [editável](/pt-BR/docs/Web/HTML/Reference/Global_attributes/contenteditable).
