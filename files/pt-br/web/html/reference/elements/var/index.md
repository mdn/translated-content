...
| Permitted parent elements | Any element that accepts [phrasing content](/pt-BR/docs/Web/HTML/Guides/Content_categories#phrasing_content). |
| Normative document        | [HTML, "The `var` element"](https://www.whatwg.org/html/#the-var-element)                                     |

## Atributos

Este elemento somente inclui os [global attributes](/pt-BR/docs/Web/HTML/Reference/Global_attributes).
