...
> - A data e hora de publicação de um elemento `<article>` pode ser descrita usando o atributo [`pubdate`](/pt-BR/docs/Web/HTML/Reference/Elements/time#pubdate) de um elemento {{ HTMLElement("time") }}.
...
| Elementos pai permitidos | Qualquer elemento que aceita [flow content](/pt-BR/docs/Web/HTML/Guides/Content_categories#flow_content). Note-se que um elemento `<article>` não pode ser descendente de um elemento {{ HTMLElement("address") }}. |
...
Este elemento não possui outros elementos se não os [global attributes](/pt-BR/docs/Web/HTML/Reference/Global_attributes), comuns a todos os elementos.
