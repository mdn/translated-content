...
| [Categorias de conteúdo](/pt-BR/docs/Web/HTML/Guides/Content_categories) | [flow content](/pt-BR/docs/Web/HTML/Guides/Content_categories#flow_content), [phrasing content](/pt-BR/docs/Web/HTML/Guides/Content_categories#phrasing_content) |
| ------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Permitted content                                                        | [Phrasing content](/pt-BR/docs/Web/HTML/Guides/Content_categories#phrasing_content), but no descendant `time` elements.                                          |
...
Como todo outro elemento HTML, este elemento suporta os [atributos globais](/pt-BR/docs/Web/HTML/Reference/Global_attributes).
