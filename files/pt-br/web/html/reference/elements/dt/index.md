...
- _[Content categories](/pt-BR/docs/Web/HTML/Guides/Content_categories)_ Vazio.
- _Permitted content_<!-- TODO: add content --> [Flow content](/pt-BR/docs/Web/HTML/Guides/Content_categories#flowing_content), but with no {{HTMLElement("header")}}, {{HTMLElement("footer")}}, sectioning content or heading content descendants.
...
Este elemento inclui somente [atributos globais](/pt-BR/docs/Web/HTML/Reference/Global_attributes).

## Exemplo

Para exemplo veja [definição de lista](/pt-BR/docs/Web/HTML/Reference/Elements/dl#examples).
