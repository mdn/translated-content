...
| Categorias de conteúdo | [Flow content](/pt-BR/docs/Web/HTML/Guides/Content_categories#flow_content), [phrasing content](/pt-BR/docs/Web/HTML/Guides/Content_categories#phrasing_content), [listed](/pt-BR/docs/Web/HTML/Guides/Content_categories#form_listed), [labelable](/pt-BR/docs/Web/HTML/Guides/Content_categories#form_labelable), [resettable](/pt-BR/docs/Web/HTML/Guides/Content_categories#form_resettable) [form-associated element](/pt-BR/docs/Web/HTML/Guides/Content_categories#form-associated_content). |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Conteúdo permitido     | [Phrasing content](/pt-BR/docs/Web/HTML/Guides/Content_categories#phrasing_content).                                                                                                                                                                                                                                                                                                                                                                                                                |
...
Como qualquer elemento HTML, este elemento suporta os [global attributes](/pt-BR/docs/Web/HTML/Reference/Global_attributes).
