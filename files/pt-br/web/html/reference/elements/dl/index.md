...
| Permite elementos pai  | Qualquer elemento que aceite [conteúdo de fluxo](/pt-BR/docs/Web/HTML/Guides/Content_categories#flow_content).                                                              |
...
Como todo elemento HTML, ele fornece os [attributos globais](/pt-BR/docs/Web/HTML/Reference/Global_attributes).
...
Para mudar a indentação de um termo, use a propriedade [CSS](/pt-BR/docs/Web/CSS) [margin](/pt-BR/docs/Web/CSS/Reference/Properties/margin).
