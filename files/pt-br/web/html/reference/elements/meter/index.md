...
| [Content categories](/pt-BR/docs/Web/HTML/Guides/Content_categories) | [flow content](/pt-BR/docs/Web/HTML/Guides/Content_categories#flow_content), [phrasing content](/pt-BR/docs/Web/HTML/Guides/Content_categories#phrasing_content), [Labelable](/pt-BR/docs/Web/HTML/Guides/Content_categories#form-labelable) [Form-associated content](/pt-BR/docs/Web/HTML/Guides/Content_categories#form-associated) |
| -------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Conteúdo permitido                                                   | [Phrasing content](/pt-BR/docs/Web/HTML/Guides/Content_categories#phrasing_content), mas nenhum elemento `meter` descendente.                                                                                                                                                                                                          |
...
Como todos os elementos HTML, esse elemento suporta [attributes](/pt-BR/docs/Web/HTML/Reference/Global_attributes).
