...
- _[Content categories](/pt-BR/docs/Web/HTML/Guides/Content_categories)_[Metadata content](/pt-BR/docs/Web/HTML/Guides/Content_categories#metadata_content), e se o atributo `scoped` é apresentado: [flow content](/pt-BR/docs/Web/HTML/Guides/Content_categories#flow_content).
