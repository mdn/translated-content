...
- _Conteúdo permitido_ [Flutuantes](/pt-BR/docs/Web/HTML/Guides/Content_categories#flow_content).
...
Para exemplos mais detalhados veja as páginas [\<ol>](/pt-BR/docs/Web/HTML/Reference/Elements/ol#examples) e [\<ul>](/pt-BR/docs/Web/HTML/Reference/Elements/ul#examples).
...
- Propriedades CSS que podem ser úteis, especialmente para dar um charme ao elemento`<li>`:
  ...
  - [contadores CSS](/pt-BR/docs/Web/CSS/Guides/Counter_styles/Using_counters) para controlar listas aninhadas complexas,
