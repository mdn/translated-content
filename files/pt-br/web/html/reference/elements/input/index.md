...
- _[Categorias de conteúdo](/pt-BR/docs/Web/HTML/Guides/Content_categories)_ [Conteúdo de fluxo](/pt-BR/docs/Web/HTML/Guides/Content_categories#conteúdo_de_fluxo), listado, enviável, resetável, elemento associado a formulário, [conteúdo fraseado](/pt-BR/docs/Web/HTML/Guides/Content_categories#conteúdo_fraseado).
...
- _Elementos pais permitidos_ Qualquer elemento que aceite [conteúdo fraseado](/pt-BR/docs/Web/HTML/Guides/Content_categories#conteúdo_fraseado).
