...
| [Categorias de conteúdo](/pt-BR/docs/Web/Guide/HTML/Categorias_de_conteudo) | [conteúdo fluido](/pt-BR/docs/Web/Guide/HTML/Categorias_de_conteudo#Conteúdo_fluido), [conteúdo fraseado](/pt-BR/docs/Web/Guide/HTML/Categorias_de_conteudo#Conteúdo_fraseado), [conteúdo interativo](/pt-BR/docs/Web/Guide/HTML/Categorias_de_conteudo#Conteúdo_interativo), [listado](/pt-BR/docs/Web/Guide/HTML/Categorias_de_conteudo#Listado_em_formulários), [rotulável](/pt-BR/docs/Web/Guide/HTML/Categorias_de_conteudo#Rotulável_em_formulários), [resetável](/pt-BR/docs/Web/Guide/HTML/Categorias_de_conteudo#Resetável_em_formulários), e [enviável](/pt-BR/docs/Web/Guide/HTML/Categorias_de_conteudo#Enviável_em_formulários) [associado a formulários](/pt-BR/docs/Web/Guide/HTML/Categorias_de_conteudo#Associado_a_formulários) |
| ----------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
