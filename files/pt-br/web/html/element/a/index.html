...
<p>Os atributos do elemento incluem os <a href="/pt-BR/docs/Web/HTML/Global_attributes">atributos globais</a>.</p>

<dl>
 <dt id="download">{{HTMLAttrDef("download")}}{{HTMLVersionInline(5)}}</dt>
 <dd><p>Leva o usuário a salvar a URL em vez de navegar até ela. Pode ser usado com ou sem um valor:</p>
 <p>
 <ul>
