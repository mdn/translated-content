...
<ul>
 ...
 <li><dfn>Elementos pai permitidas</dfn> Qualquer elemento que aceita <a href="/en-US/docs/Web/HTML/Content_categories#Phrasing_content">phrasing content</a>.</li>
...
<dl>
 ...
 <div class="note"><strong>Nota: </strong>Um elemento etiqueta pode ter tanto um for o atributo e um elemento de controlo continham, enquanto os pontos de atributo para o elemento de controlo contido.</div>
 </dd>
