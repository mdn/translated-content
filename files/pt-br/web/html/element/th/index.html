...
<dl>
 ...
 <dd><p>Este atributo define as células a que o cabeçalho (definido no elemento {{HTMLElement("th")}}) se relaciona.<br>
 Possíveis valores:</p>
 <ul>
...
<dl>
 ...
 <dd><p>Este atributo especifica como o alinhamento horizontal do conteúdo da célula será tratado.</p>
 ...
 <dd><p>Esse atributo especifica como o texto é alinhado verticalmente na célula.</p>
 <p>Possíveis valores:</p>
 <ul>
