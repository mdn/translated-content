...
| [Content categories](/pt-BR/docs/Web/HTML/Content_categories "HTML/Content_categories") | [Transparent content](/pt-BR/docs/Web/HTML/Content_categories#Transparent_content_model "HTML/Content_categories#Transparent_content_model"). |
| --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
