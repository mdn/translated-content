...
<p>A seguir, vamos conferir casos de uso básicos e complexos do <code>&lt;input type="time"&gt;</code>, além de dar conselhos sobre como contornar a questão dos navegadores na seção (see <a href="#lidando_com_navegadores_sem_suporte">Lidando com navegadores sem suporte</a>).</p>
