...
| Categorias de conteúdo | [Flow content](/pt-BR/docs/Web/HTML/Content_categories#Flow_content), [sectioning root](/pt-BR/docs/Web/HTML/Sections_and_Outlines_of_an_HTML5_document#Sectioning_roots) |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Permitted content      | [Flow content](/pt-BR/docs/Web/HTML/Content_categories#Flow_content)                                                                                                      |
| Tag omission           | {{no_tag_omission}}                                                                                                                                                  |
| Permitted parents      | Qualquer elemento que aceite [flow content](/pt-BR/docs/Web/HTML/Content_categories#Flow_content)                                                                         |
