...
<p>O elemento <strong>HTML <code>&lt;head&gt;</code> providencia informações gerais</strong> (metadados) sobre o documento, incluindo seu título e links para scripts e folhas de estilos.</p>
...
<p>Estes elementos incluem os <a href="https://developer.mozilla.org/pt-BR/docs/Web/HTML/Global_attributes">atributos globais</a>.</p>
