...
<p><span class="seoSummary">A propriedade <a href="/en-US/docs/Web/CSS">CSS</a> <strong><code>scrollbar-color</code></strong> define as cores da barra de rolagem do navegador.</span></p>
