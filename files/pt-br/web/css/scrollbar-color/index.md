...
- `<scrollbar-color>`
  - | : Define a cor da scrollbar. | `auto`                                                                                                                      | Valor padrão de renderização do background da scrollbar (Track), caso não sejam definidos outros valores. |
    | ---------------------------- | --------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
    ...
    | `<color> <color>`            | A primeira cor é aplicada à **thumb**, a segunda cor ao **track**                                                           | > **Note:** User Agents must apply any `scrollbar-color` value set on the root element to the viewport.   |
