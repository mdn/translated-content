...
- `normal`
  - : O efeito desta palavra-chave depende do modo de layout em que nos encontramos:\* Em layouts absolutamente posicionados, a palavra-chave se comporta como `start` em _replaced_ de caixas absolutamente posicionadas, e como `stretch` em _all others_ de caixas absolutamente posicionadas.
