...
tags:
  - CSS
  - CSS Alinhamento Caixa
  - CSS Caixas flexíveis
  - CSS Propriedade
  - Referencia
...
- `normal`
  - : O efeito dessa palavra-chave depende do modo de layout em que nos encontramos:\* Em layouts absolutamente posicionados, a palavra-chave se comporta como `start` em caixas absolutamente posicionadas _replaced_, e como `stretch` em caixas absolutamente posicionadas _all other_.
