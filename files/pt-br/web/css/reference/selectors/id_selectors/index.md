...
Em um documento HTML, os seletores de ID do CSS selecionam um elemento baseado no conteúdo de seu atributo [`ID`](/pt-BR/docs/Web/HTML/Reference/Global_attributes#id), o qual deve ser exatamente igual ao valor dado ao seletor.
