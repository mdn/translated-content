...
Em CSS, **`::after`** cria um [pseudo-elemento](/pt-BR/docs/Web/CSS/Reference/Selectors/Pseudo-elements) que é o último filho do elemento selecionado. Muitas vezes é usado para adicionar e melhorar o conteúdo de um elemento como a propriedade {{cssxref("content")}}. É inline por padrão.
...
O exemplo a seguir mostra o uso do `::after` [pseudo-elemento](/pt-BR/docs/Web/CSS/Reference/Selectors/Pseudo-elements) em conjunto com a expressão CSS [`attr()`](/pt-BR/docs/Web/CSS/Reference/Values/attr) e um [atributo data personalizado](/pt-BR/docs/Web/HTML/Reference/Global_attributes#dataset) `data-descr` para criar uma _dica_ em forma de glossário feito em CSS puro. Verifique a visualização abaixo, ou veja este exemplo em [página separada.](/files/4591/css-only_tooltips.html)
