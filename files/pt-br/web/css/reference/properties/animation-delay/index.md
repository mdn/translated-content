...
> [!NOTE]
> Quando você especifica vários valores separados por vírgula em uma propriedade `animation-*` , eles serão atribuídos às animações especificadas na propriedade {{cssxref("animation-name")}} em diferentes modos, dependendo de quantos existam. Para mais informações veja [Setting multiple animation property values](/pt-BR/docs/Web/CSS/Guides/Animations/Using#setting_multiple_animation_property_values).
...
Veja [CSS animations](/pt-BR/docs/Web/CSS/Guides/Animations/Using) para exemplos.
