...
A propriedade `height` do CSS determina a altura da área do conteúdo de um elemento. A [área de conteúdo](/pt-BR/docs/Web/CSS/Guides/Box_model/Introduction#content) consiste no `padding`, `margin` e `border` do elemento.
...
- [box model](/pt-BR/docs/Web/CSS/Guides/Box_model/Introduction), {{Cssxref("width")}}, {{Cssxref("box-sizing")}}, {{Cssxref("min-height")}}, {{Cssxref("max-height")}}
