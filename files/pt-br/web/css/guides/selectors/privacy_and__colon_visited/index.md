...
Em adição, mesmo para os estilos acima, você não poderá alterar a transparência entre links visitados e não visitados, ou de outra maneira você seria capaz de usar [`rgba()`](</pt-BR/docs/Web/CSS/Reference/Values/color_value#rgba()>), [`hsla()`](</pt-BR/docs/Web/CSS/Reference/Values/color_value#hsla()>), ou a palavra chave [`transparent`](/pt-BR/docs/Web/CSS/Reference/Values/color_value#transparent).
