...
Usando a função [`var()`](/pt-BR/docs/Web/CSS/Reference/Values/var), você pode definir vários **valores alternativos** quando a variável dada ainda não está definida; isso pode ser útil ao trabalhar com [Elementos personalizados](/pt-BR/docs/Web/API/Web_components/Using_custom_elements) e [Shadow DOM](/pt-BR/docs/Web/API/Web_components/Using_shadow_DOM).
...
Quando o navegador encontra uma substituição `var()` inválida, então o [inicial](/pt-BR/docs/conflicting/Web/CSS/Guides/Cascade/Property_value_processing_bcdd1173c035d5a1f45a73ceb7da30cc58d8ff6e84066662a7d88acaf52fcc37) ou [herdado](/pt-BR/docs/Web/CSS/Guides/Cascade/Inheritance) valor da propriedade é usado.
...
- [Sintaxe de propriedade personalizada](/pt-BR/docs/Web/CSS/Reference/Properties/--*)
- [`var()`](/pt-BR/docs/Web/CSS/Reference/Values/var)
