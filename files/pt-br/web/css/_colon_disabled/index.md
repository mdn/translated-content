...
Este exemplo mostra um formulário básico de envio. Ele usa o evento [JavaScript](/pt-BR/docs/Web/JavaScript) [`change`](https://developer.mozilla.org/en-US/docs/Web/Events/change) para permitir que o usuário ative / desative os campos de faturamento.
