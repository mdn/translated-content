...
<pre class="brush: css">/* Valores &lt;length-percentage&gt; únicos */
...
<pre class="syntaxbox">translate({{cssxref("length-percentage")}} , {{cssxref("length-percentage")}}<a href="/en-US/docs/Web/CSS/Value_definition_syntax#Question_mark_()">?</a>)
</pre>
...
<pre class="brush: html">&lt;div&gt;Estático&lt;/div&gt;
