...
<dl>
 <dt><code>&lt;uri&gt;</code> {{experimental_inline}}</dt>
 ...
 <table class="standard-table">
  <tbody>
   ...
   <tr style="cursor: vertical-text;">
    ...
    <td>Indica que o texto vertical pode ser selecionado, normalmente um I maiúsculo virado de lado.</td>
   </tr>
   ...
   <tr style="cursor: no-drop;">
    ...
    <td>Cursor mostrando que não é permitido largar um elemento no local atual.<br>
     {{bug("275173")}}no Windows e no Mac OS X, "sem soltar é o mesmo que não permitido".</td>
   </tr>
   ...
   <tr style="cursor: n-resize;">
    ...
    <td><img alt="Example of a resize towards the top cursor" src="n-resize.gif" style="border-style: solid; border-width: 0px; height: 26px; width: 26px;"></td>
...
<h2 id="Definição formal">Definição formal</h2>
<p>{{ cssinfo }}</p>
