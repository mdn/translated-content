...
<p>Além dos muitos tipos diferentes de exibição de caixa, o valor  <code style="font-size: 14px;">none </code>permite desativar a exibição de um elemento; quando você usa <code style="font-size: 14px;">none</code>, todos os elementos descendentes também tem a sua exibição desativada. O documento é renderizado como se o elemento não existisse na árvore do documento.</p>
...
<p>É a palavra-chave para definir tipo de renderização que será usada no elemento. Os valores possiveis e seus significados são:</p>
