...
---
<p class="summary">Os aplicativos web progressivos usam APIs web modernas, juntamente com a estratégia tradicional de aprimoramento progressivo para criar aplicativos web entre plataformas. Esses aplicativos funcionam em todos os lugares e fornecem vários recursos que lhes dão as mesmas vantagens de experiência do usuário que os aplicativos nativos. Este conjunto de médicos diz tudo o que você precisa saber sobre eles.</p>

<h2 id="PWA_advantages">PWA advantages</h2>

<p>PWAs should be discoverable, installable, linkable, network independent, progressive, re-engageable, responsive, and safe. To find out more about what these mean, read <a href="/en-US/docs/Web/Apps/Progressive/Advantages">Progressive web app advantages</a>. To find out how to implement PWAs, consult the guides listed in the below section.</p>
...
<ol>
 <li><a href="/en-US/docs/Web/Apps/Progressive/Introduction">Introduction to progressive web apps</a></li>
 <li><a href="/en-US/docs/Web/Apps/Progressive/App_structure">Progressive web app structure</a></li>
 <li><a href="/en-US/docs/Web/Apps/Progressive/Offline_Service_workers">Making PWAs work offline with Service workers</a></li>
 <li><a href="/en-US/docs/Web/Apps/Progressive/Installable_PWAs">How to make PWAs installable</a></li>
 <li><a href="/en-US/docs/Web/Apps/Progressive/Re-engageable_Notifications_Push">How to make PWAs re-engageable using Notifications and Push</a></li>
 <li><a href="/en-US/docs/Web/Apps/Progressive/Loading">Progressive loading</a></li>
</ol>
