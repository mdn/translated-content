...
---
« [Página inicial da referência de atributos do SVG](/en/SVG/Attribute "en/SVG/Attribute")
...
| Categorias          | Nenhuma                                                                                       |
| ------------------- | --------------------------------------------------------------------------------------------- |
| Valor               | [\<list-of-class-names>](/en/SVG/Content_type#List-of-Ts "en/SVG/Content type#List-of-Ts")    |
| Animável            | Sim                                                                                           |
