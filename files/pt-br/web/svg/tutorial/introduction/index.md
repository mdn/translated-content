...
SVG é uma especificação imensa. Este tutorial combre apenas o conteúdo básico. Uma vez que você se familiarizar você estará habilitado a usar o [Element Reference](/en-US/SVG/Element "en-US/SVG/Element") e o [Interface Reference](/pt-BR/docs/DOM/DOM_Reference#SVG_interfaces "en-US/SVG/Interface") para encontrar qualquer outra coisa que precisa saber.
