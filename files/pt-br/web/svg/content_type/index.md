...
- \<IRI>
  ...
  - : An Internationalized Resource Identifier.
    ...
    On the Internet, resources are identified using _IRI_s (Internationalized Resource Identifiers). For example, an SVG file called someDrawing.svg located at `https://example.com` might have the following _IRI_:

    ```
    https://example.com/someDrawing.svg
    ```
    ...
    ```
    https://example.com/someDrawing.svg#Lamppost
    ```
