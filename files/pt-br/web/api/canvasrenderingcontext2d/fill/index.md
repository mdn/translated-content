...
- `fillRule`
  ...
  - : O algoritmo que determina se um ponto está do lado de dentro do path ou do lado fora do path.
    ...
    - **`"nonzero`**": A [regra de controle não-zero](https://en.wikipedia.org/wiki/Nonzero-rule), que é a regra padrão.
    - **`"evenodd"`**: A [regra de controle par-ímpar](https://en.wikipedia.org/wiki/Even%E2%80%93odd_rule).
