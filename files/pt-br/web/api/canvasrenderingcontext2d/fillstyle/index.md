...
Veja também o capítulo [Aplicando estilos e cores](/pt-BR/docs/Web/API/Canvas_API/Tutorial/Applying_styles_and_colors) no [Canvas Tutorial](/pt-BR/docs/Web/API/Canvas_API/Tutorial).
