...
Quando a operação de leitura acaba, a flag {{domxref("FileReader.readyState","readyState")}} muda para **DONE** e o evento [`loadend`](/pt-BR/docs/Web/Events/loadend) é disparado.
