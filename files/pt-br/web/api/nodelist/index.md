...
> **Note:** Apesar de `NodeList` não ser um `Array`, é possível ser iterada usando o método `forEach()`. Muitos navegadores antigos ainda não implementaram este método.
...
[`for...of`](/pt-BR/docs/JavaScript/Reference/Statements/for...of "/en-US/docs/JavaScript/Reference/Statements/for...of") iterará sobre os objetos da `NodeList` de maneira correta:
