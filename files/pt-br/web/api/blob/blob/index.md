...
- _array_ é um {{jsxref("Array")}} de objetos {{jsxref("ArrayBuffer")}}, {{jsxref("TypedArray")}}, {{domxref("Blob")}}, {{jsxref("String")}}, ou uma combinação de quaisquer um destes objetos, que serão colocados dentro do {{domxref("Blob")}}. DOMStrings são codificadas como UTF-8.
