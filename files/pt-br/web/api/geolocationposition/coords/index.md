...
<p>A propriedade <code><strong>Position.coords</strong></code> é somente leitura. É um objeto de {{domxref("Coordinates")}} que contém uma representação geográfica: a localização, que é a latitude e longitude na Terra, a altitude e a velocidade do objeto em questão. Também contempla a precisão da informação sobre estes valores.</p>
...
<ul>
 ...
 <li>A interface {{domxref("Position")}} a qual ela pertence.</li>
</ul>
