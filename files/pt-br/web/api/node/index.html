...
<dl>
 ...
 <dd>Retorna um objeto <code>nsIURI</code>, representando o URL base do nó. <em>(Indisponível para conteúdo Web)</em></dd>
 ...
 <dd>Uma interface <code>nsIPrincipal</code> representando o nó principal.</dd>
