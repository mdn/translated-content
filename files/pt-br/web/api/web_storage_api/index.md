...
Nós também fornecemos um [event output page](http://mdn.github.io/web-storage-demo/event.html) — para quando você abrir a página em outra aba, as informações sejam atualizadas através da chamada de um [`StorageEvent`](/pt-BR/docs/Web/Events/StorageEvent).
