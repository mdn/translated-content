...
Usado pelo atributo HTML [`dataset`](/pt-BR/docs/Web/HTML/Reference/Global_attributes#dataset) para representar atributos próprios adicionados ao elemento.
...
- [`dataset`](/pt-BR/docs/Web/HTML/Reference/Global_attributes#dataset)
