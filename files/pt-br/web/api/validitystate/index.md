...
- {{domxref("ValidityState.patternMismatch")}} {{ReadOnlyInline}}
  - : É um {{jsxref("Boolean")}} informando se o valor não combina com o padrão ([`pattern`](/pt-BR/docs/Web/HTML/Reference/Elements/input#pattern)) especificado.
- {{domxref("ValidityState.rangeOverflow")}} {{ReadOnlyInline}}
  - : É um {{jsxref("Boolean")}} informando se o valor é maior do que o máximo especificado pelo atributo [`max`](/pt-BR/docs/Web/HTML/Reference/Elements/input#max).
- {{domxref("ValidityState.rangeUnderflow")}} {{ReadOnlyInline}}
  - : É um {{jsxref("Boolean")}} informando se o valor é menor do que o mínimo especificado pelo atributo [`min`](/pt-BR/docs/Web/HTML/Reference/Elements/input#min).
- {{domxref("ValidityState.stepMismatch")}} {{ReadOnlyInline}}
  - : É um {{jsxref("Boolean")}} informando se o valor não segue a regra definida pelo atributo [`step`](/pt-BR/docs/Web/HTML/Reference/Elements/input#step).
...
- {{domxref("ValidityState.typeMismatch")}} {{ReadOnlyInline}}
  - : É um {{jsxref("Boolean")}} informando se o valor não corresponde ao tipo de entrada definida. (Um exemplo é quando [`type`](/pt-BR/docs/Web/HTML/Reference/Elements/input#type) é `email` ou `url`).
...
- {{domxref("ValidityState.valueMissing")}} {{ReadOnlyInline}}
  - : É um {{jsxref("Boolean")}} informando que o elemento tem o atributo [`required`](/pt-BR/docs/Web/HTML/Reference/Elements/input#required), mas não tem [`value`](/pt-BR/docs/Web/HTML/Reference/Elements/input#value).
