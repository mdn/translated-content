...
> **Note:** É uma boa idéia usar a palavra chave using para escrever menos. Isso significa que não é preciso você reescrever o namespace toda vez que usar uma classe dele.
...
> **Note:** Para setar facilmente o tipo esperado no primeiro parâmetro, use o método estático Parse da classe IPAddress.
...
> **Warning:** Este código tem um defeito. Digamos que a propriedade client.`Available` retorna o valor 2 porque somente a requisição GET está disponível até agora. a expressão regular iria falhar mesmo que os dados recebidos sejam perfeitamente válidos.
...
> **Note:** Eu posso escolher 128, porque o primeiro bit sempre será 1.
