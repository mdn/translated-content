...
> **Note:** WebVR API is replaced by [WebXR API](/pt-BR/docs/Web/API/WebXR_API). WebVR was never ratified as a standard, was implemented and enabled by default in very few browsers and supported a small number of devices.
...
Our demo features the holy grail of WebGL demos — a rotating 3D cube. We've implemented this using raw [WebGL API](/pt-BR/docs/Web/API/WebGL_API) code. We won't be teaching any basic JavaScript or WebGL, just the WebVR parts.
...
> **Note:** To find out more about basic JavaScript and WebGL, consult our [JavaScript learning material](/pt-BR/docs/Learn/JavaScript), and our [WebGL Tutorial](/pt-BR/docs/Web/API/WebGL_API/Tutorial).
...
The WebVR spec features a number of events that are fired, allowing our app code to react to changes in the state of the VR display (see [Window events](/pt-BR/docs/Web/API/WebVR_API#Window_events)). For example:
