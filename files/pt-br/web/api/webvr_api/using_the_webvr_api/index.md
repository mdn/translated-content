...
> **Nota:** To find out more about basic JavaScript and WebGL, consult our [JavaScript learning material](/pt-BR/docs/Learn/JavaScript), and our [WebGL Tutorial](/pt-BR/docs/Web/API/WebGL_API/Tutorial).
...
> **Nota:** It is unlikely that you'll have multiple VR displays connected to your computer, and this is just a simple demo, so this will do for now.
