...
<ul>
 ...
 <li>Para o <a href="/en-US/docs/Chrome" title="/en-US/docs/Chrome">Mozilla Chrome</a>, veja <code>nsIPromptService.alert()</code> e <code>nsIPromptService.alertCheck()</code></li>
</ul>
