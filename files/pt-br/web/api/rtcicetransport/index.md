...
- {{domxref("RTCIceTransport.getLocalCandidates", "getLocalCandidates()")}}
  - : Retorna um array de objetos {{domxref("RTCIceCandidate")}}, cada descrevendo um dos candidatos ICE que foram reunidos para o dispositivo local até o momento. Esses são os mesmos candidatos que já foram enviados para o peer remoto, enviando um evento [`icecandidate`](/pt-BR/docs/Web/Events/icecandidate) ao {{domxref("RTCPeerConnection")}} para transmissão.
