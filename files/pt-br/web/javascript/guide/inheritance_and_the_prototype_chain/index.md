...
> [!NOTE]
> **Não** é suficiente apenas verificar se o valor da propriedade é [`undefined`](/pt-BR/docs/Web/JavaScript/Reference/Global_Objects/undefined) para saber se ela existe. A propriedade pode muito bem existir e não ter sido inicializada, sendo assim o seu valor undefined.
