...
> **Note:** **Nota :** Um array literal é um tipo de inicializador de objetos. Veja [Usando inicializadores de Objetos](/pt-BR/docs/Web/JavaScript/Guide/Working_with_Objects#Using_object_initializers "en-US/docs/JavaScript/Guide/Working with Objects#Using Object Initializers").
...
> **Note:** **Nota :** Vírgulas à direita podem criar erros em algumas versões de navegadores web antigos, é recomendável removê-las.
