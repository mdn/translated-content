...
<pre><em>operando1</em> <em>operador</em> <em>operando2</em>
</pre>
...
<pre><em>operador</em> <em>operando</em>
</pre>

<p>ou</p>

<pre><em>operando</em> <em>operador</em>
</pre>
...
<pre class="brush: js">console.log(1 / 2); /* imprime 0.5 */
...
<pre> console.log("minha " + "string"); // exibe a string "minha string".</pre>

<p>O operador de atribuição encurtado += também pode ser utilizado para concatenar strings.</p>

<p>Por exemplo,</p>

<pre>var minhaString = "alfa";
minhaString += "beto"; // É avaliada como "alfabeto" e atribui este valor a minhastring.</pre>
...
<pre><em>condicao</em> ? <em>valor1</em> : <em>valor2</em>
</pre>
...
<pre class="brush: js">var status = (idade &gt;= 18) ? "adulto" : "menor de idade";
</pre>
...
<pre class="brush: js">delete nomeObjeto;
...
<pre class="brush: js">var arvores = new Array("pau-brasil", "loureiro", "cedro", "carvalho", "sicômoro");
delete arvores[3];
if (3 in arvores) {
...
<pre class="brush: js">typeof operando
typeof (operando)
</pre>
...
<pre class="brush: js">var meuLazer = new Function("5 + 2");
var forma = "redondo";
var tamanho = 1;
var hoje = new Date();
</pre>
...
<pre class="brush: js">typeof meuLazer;  // retorna "function"
...
<pre class="brush: js">void (expressao)
void expressao
</pre>
...
<pre class="brush: html">&lt;a href="javascript:void(0)"&gt;Clique aqui para fazer nada&lt;/a&gt;
</pre>
...
<pre class="brush: js">nomePropriedadeOuNumero in nomeObjeto
</pre>
...
<pre class="brush: js">nomeObjeto instanceof tipoObjeto
</pre>
...
<pre class="brush: js">this["nomePropriedade"]
...
<pre class="brush: js">function valide(obj, minimo, maximo){
...
<pre class="brush: html">&lt;b&gt;Informe um número entre 18 e 99:&lt;/b&gt;
...
<pre class="brush: js">var nomeObjeto = new tipoObjeto([parametro1, parametro2, ..., parametroN]);
</pre>
...
<pre class="syntaxbox">super([argumentos]); //chama o construtor pai.
...
<pre class="brush: js">var partes = ['ombro', 'joelhos'];
var musica = ['cabeca', ...partes, 'e', 'pés'];</pre>
