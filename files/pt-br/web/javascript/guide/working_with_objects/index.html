...
<pre class="brush: js">// Encapsulamento das propriedades e métodos de Animal
var Animal = {
...
peixe.tipo = "Peixes";
peixe.qualTipo(); // Saída: Peixes</pre>
...
<pre class="brush: js">objeto.nomedometodo(parametros);
</pre>
...
console.log(now);
// Wed Apr 18 11:13:25 GMT-0700 (Pacific Daylight Time) 2001</pre>
...
<pre class="brush: js">// Duas variáveis, dois objetos distintos com as mesmas propriedades
...
<pre class="brush: js">// Duas variáveis, um único objeto
var fruit = {name: "apple"};
