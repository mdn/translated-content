...
<pre class="brush: js">var fatorial = function fac(n) {return n&lt;2 ? 1 : n*fac(n-1)};
...
<p>Além de definir funções, você também pode usar o construtor {{jsxref("Function")}} para criar funções a partir de uma string<code> </code>em tempo real, como no método {{jsxref("eval()")}}.</p>
...
<h2 id="Function_scope" name="Function_scope">Escopo da função</h2>
...
<pre class="brush: js">function multiplicar(multiplicador, ...args) {
...
<pre class="brush: js">function Pessoa() {
