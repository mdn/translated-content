 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    <p>Por exemplo, <code>[abcd]</code> é o mesmo que <code>[a-d]</code>. Com a expressão será encontrado o 'b' em "beijo" e o 'c' em "chop". A expressão <code>/[a-z.]+/</code> e <code>/[\w.]+/</code> ambos encontraram as letras que formam "test.i.ng".</p>
   </td>
  </tr>
  <tr>
