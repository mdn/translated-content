...
<p>Enquanto o <a href="/en-US/docs/Web/HTML">HTML</a> é usado para armazenar o conteúdo e a formatação de uma página web e o <a href="/en-US/docs/Web/CSS">CSS</a> define a formatação e a aparência, o<a href="/en-US/docs/Web/JavaScript"> JavaScript</a> é usado para adicionar interatividade a uma página web e criar aplicações web ricas.</p>

<p>No entanto, o termo genérico "JavaScript" tal como é entendido no contexto do navegador contém vários elementos bem diferentes. Um deles é a linguagem principal (ECMAScript), outra é a coleção das <a href="/en-US/docs/Web/Reference/API">Web APIs</a>, incluindo o DOM (Document Object Model).</p>

<h2 id="JavaScript_a_linguagem_principal_(ECMAScript)">JavaScript, a linguagem principal (ECMAScript)</h2>

<p>O núcleo da linguagem JavaScript é padronizado pelo comitê ECMA TC39 como uma linguagem chamada <a href="/en-US/docs/JavaScript/Language_Resources" title="en-US/docs/JavaScript/Language_Resources">ECMAScript</a>. A última versão da especificação é <a class="external" href="http://ecma-international.org/ecma-262/5.1/">ECMAScript 5.1</a>.</p>
...
<h3 id="O_que_se_enquadra_no_escopo_ECMAScript">O que se enquadra no escopo ECMAScript?</h3>
...
<p>A 6ª edição principal do ECMAScript foi oficialmente aprovada e publicada como norma em 17 de junho de 2015 pela Assembléia Geral da ECMA. Desde então, as Edições ECMAScript são publicadas anualmente.</p>

<h3 id="API_de_Internacionalização">API de Internacionalização</h3>

<p>A <a href="http://ecma-international.org/ecma-402/1.0/">API de Especificação de Internacionalização do ECMASCRIPT</a> é uma adição para a Especificação de Linguagem ECMAScript, também padronizada pela Ecma TC39. A API de internacionalização fornece intercalação (comparação de string), formatação numérica, formatação de data e tempo para aplicações JavaScript, permitindo que aplicativos escolham o idioma e adaptem a funcionalidade às suas necessidades. O padrão foi aprovado em dezembro de 2012; O status das implementações nos navegadores é rastreado na documentação do objeto Intl. A especificação de Internacionalização hoje em dia também é ratificada anualmente e os navegadores aprimoram as suas implementações constantemente.</p>
