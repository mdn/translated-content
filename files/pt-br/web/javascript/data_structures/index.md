...
- Strings são o denominador comum entre várias APIs ([input fields](/pt-BR/docs/Web/API/HTMLInputElement "HTMLInputElement"), [local storage](/pt-BR/docs/Storage "Storage") values, {{ domxref("XMLHttpRequest") }} responses ao usar `responseText`, etc.) e pode ser tentador trabalhar apenas com strings.
