...
- [`Float64Array()`](/pt-BR/docs/Web/JavaScript/Reference/Global_Objects/Float64Array/Float64Array)
...
- {{jsxref("TypedArray.name", "Float64Array.name")}}
  - : Retorna uma string com o nome do contructor. no caso de`Float64Array` type: "Float64Array".
