...
<p>Dessa maneira também se evita problemas se a magnitude dos seus número for muito grande. O maio número que se pode representar em um <em>double float</em> em JavasScript é <code>Number.MAX_VALUE</code> = 1.797...e+308. Se os seu números são maior que 1e154, calcular o quadrado deles resultará em <code>Infinity</code>, estragando os seus resultados. Por exemplo, <code>Math.sqrt(1e200*1e200 + 1e200*1e200) = Infinity</code>. Se você usar a função <code>Math.hypot()</code>, você receberá uma resposta aceitável: <code>Math.hypot(1e200, 1e200) = 1.4142...e+200</code>. Isto também é verdade para número muito pequenos. <code>Math.sqrt(1e-200*1e-200 + 1e-200*1e-200) = 0</code>, mas <code>Math.hypot(1e-200, 1e-200) = </code><code>1.4142...e-200</code> é uma boa resposta.</p>
