...
<h3 id="Example:_Using_Number_to_convert_a_Date_object" name="Example:_Using_Number_to_convert_a_Date_object">Exemplo: Usando <code>Number para converter um objeto Date</code></h3>
