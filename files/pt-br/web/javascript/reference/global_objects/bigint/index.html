...
<dl>
 ...
 <dd>Permite a adição de propriedades a um objeto <code style="letter-spacing: -0.00278rem;">BigInt</code>.</dd>
</dl>

<h2 id="BigInt_instances">Instâncias <code>BigInt</code></h2>

<p>Todas as instâncias <code>BigInt</code> são herdades de <font face="consolas, Liberation Mono, courier, monospace">BigInt.prototype</font>. O protótipo do objeto do construtor do <font face="consolas, Liberation Mono, courier, monospace">BigInt</font> pode ser modificado para afetar todas as instâncias de <code>BigInt</code>.</p>
