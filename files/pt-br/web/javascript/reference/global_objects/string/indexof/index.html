...
<pre class="syntaxbox"><em>str</em>.indexOf(<em>searchValue</em>[, <em>fromIndex</em>])</pre>
...
<pre class="brush: js">'Olá, mundo'.indexOf('') // retorna 0
'Olá, mundo'.indexOf('', 0) // retorna 0
'Olá, mundo'.indexOf('', 3) // retorna 3
'Olá, mundo'.indexOf('', 8) // retorna 8</pre>
...
<pre class="brush: js">'Olá, mundo'.indexOf('', 11) // retorna 10
'Olá, mundo'.indexOf('', 13) // retorna 10
'Olá, mundo'.indexOf('', 22) // retorna 10</pre>
...
<pre class="brush: js">const str = 'Serx ou não ser, eisx a questão'
count = 0;
