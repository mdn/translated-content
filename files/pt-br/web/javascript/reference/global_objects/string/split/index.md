...
- `separator`
  - : Opcional. Especifica o caractere, ou conjunto de caracteres, a ser usado para separar a string. O separador pode ser uma string ou uma {{jsxref("RegExp", "expressão regular", "", 1)}}.
