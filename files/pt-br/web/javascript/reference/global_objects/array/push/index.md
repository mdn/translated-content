...
Os únicos objetos que implementam nativamente array são as {{jsxref("String", "strings", "", 1)}}, porém elas não são adequadas para a aplicação desse método, pois são imutáveis.
