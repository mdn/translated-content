...
<p>O método <strong><code>flatMap()</code></strong> primeiro mapeia cada elemento usando uma função de mapeamento e, em seguida, nivela o resultado em um novo array. É idêntico a um <code>map</code> seguido por um <code>flat</code> de profundidade 1, mas <strong><code>flatMap</code></strong> é bastante útil e mescla ambos em um método um pouco mais eficiente.</p>

<div>{{EmbedInteractiveExample("pages/js/array-flatmap.html","shorter")}}</div>
...
<dl>
 ...
 <dl>
  ...
  <dd>O <code>map</code> da array que foi chamado.</dd>
 </dl>
