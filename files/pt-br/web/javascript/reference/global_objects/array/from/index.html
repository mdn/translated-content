...
<p>No  ES6, a sintaxe de classe permite a subclassificação de classes nativas e classes definidas pelo usuário; como resultado, os métodos estáticos pertencentes a classe, como  <code><strong>Array.from,</strong></code> são "herdadas" por subclasses do <code><strong>Array</strong></code> e criam novas instâncias da subclasse, não do <code><strong>Array</strong></code>.</p>
