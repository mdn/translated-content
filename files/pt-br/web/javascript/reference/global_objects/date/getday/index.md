...
O segundo statement abaixo atribui o valor 1 à variável weekday (dia da semana), baseado no valor do objeto {{jsxref("Date")}} `Xmas95`. A data 25 de Dezembro de 1995 é uma Segunda-Feira.
