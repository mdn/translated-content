...
<dl>
 <dt><code>obj</code></dt>
 <dd>O objeto pelo o qual deseja obter todos os descritores de propriedade próprios.</dd>
</dl>
...
<dl>
 ...
 <dd><code>true</code> se e somente se o tipo da propriedade descritora pode ser alterada e se a propriedade pode ser deletada do objeto correspondente.</dd>
 <dt><code>enumerable</code></dt>
 <dd><code>true</code> se e somente se essa propriedade se mostrar durante a enumeração da propriedade no objeto correspondente.</dd>
</dl>
