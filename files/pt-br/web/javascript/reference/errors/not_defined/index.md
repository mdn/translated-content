...
<p>Uma variável precisa estar disponível no atual contexto de execução. Variáveis definidas dentro de uma  <a href="/en-US/docs/Web/JavaScript/Reference/Functions">function</a> não podem ser acessadas de outros lugares fora da função, porque a variável é definida apenas no escopo da função</p>
