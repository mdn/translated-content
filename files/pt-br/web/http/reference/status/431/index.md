...
O código de stauts de resposta HTTP **`431 Request Header Fields Too Large`** indica que o servidor se recusou a processar a requisição por que os [cabeçalhos HTTP](/pt-BR/docs/Web/HTTP/Reference/Headers) da mesma são muito grandes. A requisição _pode_ ser resubmetida depois de o tamanho dos cabeçalhos serem reduzidos.
...
- Existem muitos [Cookies](/pt-BR/docs/Web/HTTP/Guides/Cookies) sendo enviados na requisição
