...
> **Note:** Vários [painéis de rede de ferramentas de desenvolvedor](/pt-BR/docs/Tools/Network_Monitor) dos navegadores criam requisições irrelevantes direcionando para respostas `304`, logo este acesso ao cache local é visível aos desenvolvedores.
