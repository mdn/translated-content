...
- \<identifier>
  - : Um identificador divulgando a informação que é alterada ou perdida usando um proxy. Ela pode ser tanto:\* um endereço IP (v4 ou v6, opicionalmente com a porta, e IPv6 encapsulado por colchetes e aspas),
