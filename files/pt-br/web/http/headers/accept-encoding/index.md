...
- `gzip`
  - : Formato de compressão usando o [Lempel-Ziv coding](https://en.wikipedia.org/wiki/LZ77_and_LZ78#LZ77) (LZ77), com CRC de 32-bits.
- `compress`
  - : Formato de compressão usando o algoritmo [Lempel-Ziv-Welch](https://en.wikipedia.org/wiki/LZW) (LZW).
- `deflate`
  - : Formato de compressão usando a estrutura [zlib](https://en.wikipedia.org/wiki/Zlib), com o algoritmo de compressão [_deflate_](https://en.wikipedia.org/wiki/DEFLATE).
- `br`
