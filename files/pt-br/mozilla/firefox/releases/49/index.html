...
<ul>
 ...
 <li>Suporte ao paramtro third de {{domxref("EventTarget.addEventListener()")}}, ou um {{jsxref("Boolean")}} ou a <code>EventListenerOptions</code> foi adicionado ({{bug(1266164)}} and {{bug(1266066)}}).</li>
