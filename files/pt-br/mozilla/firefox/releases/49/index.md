...
- As armadilhas para ES2015 (ES6) {{jsxref("Proxy.Proxy.getPrototypeOf", "getPrototypeOf()")}} e {{jsxref("Proxy.Proxy.setPrototypeOf", "setPrototypeOf()")}} {{jsxref("Proxy")}} foram implementadas ([Erro do Firefox 888969](https://bugzil.la/888969)).
