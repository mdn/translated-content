...
Antes de iniciar este módulo, você deve ter familiaridade com os conceitos básicos de [HTML](/pt-BR/docs/Learn_web_development/Core/Structuring_content) e [CSS](/pt-BR/docs/Learn_web_development/Core/Styling_basics), além de ter estudado nosso módulo anterior, [primeiros passos no Javacript](/pt-BR/docs/Learn_web_development/Core/Scripting).
...
- [Tomando decisões em seu código — condicionais](/pt-BR/docs/Learn_web_development/Core/Scripting/Conditionals)
...
- [Re-executando código](/pt-BR/docs/Learn_web_development/Core/Scripting/Loops)
...
- [Funções — blocos reutilizáveis de código](/pt-BR/docs/Learn_web_development/Core/Scripting/Functions)
...
- [Construa sua própria função](/pt-BR/docs/Learn_web_development/Core/Scripting/Build_your_own_function)
...
- [Funções retornam valores](/pt-BR/docs/Learn_web_development/Core/Scripting/Return_values)
...
- [Galeria de imagens](/pt-BR/docs/Learn_web_development/Core/Scripting/Image_gallery)
