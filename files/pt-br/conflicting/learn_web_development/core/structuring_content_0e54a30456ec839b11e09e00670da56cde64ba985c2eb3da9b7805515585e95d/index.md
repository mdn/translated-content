...
Você deve, preferencialmente, iniciar sua jornada aprendendo HTML. Comece lendo [Introdução ao HTML](/pt-BR/docs/Learn_web_development/Core/Structuring_content). Você pode então passar a aprender sobre tópicos mais avançados, tais como:

- [CSS](/pt-BR/docs/conflicting/Learn_web_development/Core/Styling_basics) e como usá-lo para estilizar o HTML (como por exemplo alterar o tamanho e a fonte usados, adicionar bordas e sombras, definir o layout da sua página com várias colunas, adicionar animações e outros efeitos visuais).
...
Antes de iniciar este tópico, você deve pelo menos ter uma familiaridade básica com o uso de computadores e com a web (por exemplo: apenas olhando para ele, consumindo o conteúdo). Você deve ter um ambiente básico de trabalho configurado como detalhado em [Instalando os programas básicos](/pt-BR/docs/Learn_web_development/Getting_started/Environment_setup/Installing_software) e entender como criar e gerenciar arquivos, como detalhado em [Lidando com arquivos](/pt-BR/docs/Learn_web_development/Getting_started/Environment_setup/Dealing_with_files) — ambos fazem parte do nosso módulo para iniciantes [Introdução à Web](/pt-BR/docs/Learn_web_development/Getting_started/Your_first_website).

Recomenda-se que você complete o módulo [Introdução à Web](/pt-BR/docs/Learn_web_development/Getting_started/Your_first_website) antes de tentar este tópico, mas isto não é absolutamente necessário; muito do que é abordado no artigo [HTML básico](/pt-BR/docs/Learn_web_development/Getting_started/Your_first_website/Creating_the_content) é também abordado no nosso módulo [Introdução ao HTML](/pt-BR/docs/Learn_web_development/Core/Structuring_content), embora com muito mais detalhes.
...
- [Multimídia e incorporação](/pt-BR/docs/conflicting/Learn_web_development/Core/Structuring_content)
...
[Usar HTML para resolver problemas comuns](/pt-BR/docs/Learn_web_development/Howto/Solve_HTML_problems) fornece links para seções com conteúdos que explicam como usar HTML para resolver problemas muito comuns ao criar uma página da web: lidar com títulos, adicionar imagens ou vídeos, enfatizar conteúdo, criar um formulário básico, etc.
