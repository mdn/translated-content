...
- [Visão geral sobre HTTP](/pt-BR/docs/Web/HTTP/Guides/Overview)
...
- [Recursos e URIs](/pt-BR/docs/Web/HTTP/Guides/MIME_types)
...
- [MIME types](/pt-BR/docs/Web/HTTP/Guides/MIME_types)
...
- [Gerenciamento de conexão no HTTP/1.x](/pt-BR/docs/Web/HTTP/Guides/Connection_management_in_HTTP_1.x)
...
- [Conteúdo da negociação](/pt-BR/docs/Web/HTTP/Guides/Content_negotiation)
