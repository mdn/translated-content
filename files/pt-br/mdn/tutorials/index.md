...
- [Iniciando com a Web](/pt-BR/docs/Learn_web_development/Getting_started/Your_first_website)
...
- [Tabelas em HTML](/pt-BR/docs/Learn_web_development/Core/Structuring_content/HTML_table_basics)
...
- [CSS Básico](/pt-BR/docs/Learn_web_development/Core/Styling_basics)
...
- [Estilizando _Boxes_](/pt-BR/docs/conflicting/Learn_web_development/Core/Styling_basics_fa344166552fbe2c038b1254d9d96dc0de5d79eb64d0ca3e5784a17f79fd0333)
...
- [Estilizando texto](/pt-BR/docs/Learn_web_development/Core/Text_styling)
...
- **[Questões comuns de CSS](/pt-BR/docs/Learn_web_development/Howto/Solve_CSS_problems/CSS_FAQ)**
...
- [Construindo blocos com JavaScript](/pt-BR/docs/conflicting/Learn_web_development/Core/Scripting)
...
- [Começando com JavaScript](/pt-BR/docs/Learn_web_development/Getting_started/Your_first_website/Adding_interactivity)
...
- [APIs da web do lado do cliente](/pt-BR/docs/Learn_web_development/Extensions/Client-side_APIs)
...
- [WebExtensions](/pt-BR/docs/Mozilla/Add-ons/WebExtensions)
  - : WebExtensions é um sistema entre navegadores para desenvolver complementos de navegador. Em larga escala o sistema é compatível com a [API de extensão](https://developer.chrome.com/docs/extensions) suportada pelos navegadores Google Chrome e Opera. Extensões escritas para estes navegadores na maioria dos casos funcionam no Firefox ou [Microsoft Edge](https://developer.microsoft.com/en-us/microsoft-edge/platform/documentation/extensions/) [com poucas mudanças](/pt-BR/docs/Mozilla/Add-ons/WebExtensions/Porting_from_Google_Chrome). A API é também completamente compatível com [multiprocessos Firefox](/pt-BR/docs/Mozilla/Firefox/Multiprocess_Firefox).
