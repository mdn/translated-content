...
<p>{{glossary('JavaScript')}} é uma linguagem de programação que permite implementar funcionalidades mais complexas em páginas web. Sempre que uma página web faz mais do que apenas mostrar informações estáticas para você - ela mostra em tempo real conteúdos atualizados, mapas interativos, animações gráficas em 2D/3D, vídeos, etc. -  você pode apostar que o Javascript provavelmente está envolvido.</p>

<h2 id="O_caminho_para_o_aprendizado">O caminho para o aprendizado</h2>

<p>O JavaScript não é tão fácil de aprender como outras linguagens, como <a href="https://developer.mozilla.org/pt-BR/docs/Aprender/HTML">HTML</a> e <a href="https://developer.mozilla.org/pt-BR/docs/Aprender/CSS">CSS</a>, que são outros dois pilares do desenvolvimento front-end. Antes de tentar aprender JavaScript, é altamente recomendável que você aprenda e se familiarize com pelo menos estas duas tecnologias primeiro. Você pode começar através dos seguintes módulos:</p>

<ul>
 <li><a href="/pt-BR/docs/Aprender/Getting_started_with_the_web">Começando na Web</a></li>
 <li><a href="/pt-BR/docs/Aprender/HTML/Introducao_ao_HTML">Introdução ao HTML</a></li>
 <li><a href="/pt-BR/docs/Aprender/CSS/Introduction_to_CSS">Introdução ao CSS</a></li>
</ul>

<p>Possuir experiência em outras linguagens de programação pode também ser útil.</p>

<p>Depois de aprender o básico de JavaScript, você estará apto a estudar tópicos mais avançados, como:</p>

<ul>
 <li>JavaScript aprofundado, como ensinado em <a href="/pt-BR/docs/Web/JavaScript/Guide">Guia JavaScript</a></li>
 <li><a href="/pt-BR/docs/Web/Reference/API">Referências API Web</a></li>
</ul>
...
<p>Uma vez que você se acostumar com o mundo do JavaScript aqui estão alguns outros módulos em que você pode mergulhar:</p>

<dl>
 <dt><a href="/pt-BR/docs/Web/JavaScript/Reference">Biblioteca de referência JavaScript</a></dt>
 <dd>Em nossa extensa biblioteca de referência você encontrará cada aspecto de Javascript tratado em detalhes: objetos globais, operadores, declarações e funções.</dd>
 <dt><a href="/pt-BR/docs/Web/JavaScript/Introduction_to_Object-Oriented_JavaScript">Introdução à Orientação a Objetos (OO) em JavaScript</a></dt>
 <dd>Introdução aos conceitos de {{glossary("OOP","Programação orientada a objetos")}} em JavaScript.</dd>
</dl>

<h2 id="Resolvendo_problemas_comuns_com_Javascript">Resolvendo problemas comuns com Javascript</h2>

<p><a href="https://developer.mozilla.org/pt-BR/docs/Learn/JavaScript/Howto">Use Javascript para resolver problemas comuns</a>, este link proporciona contéudos explicativos de como usar o JavaScript para solucionar problemas muito comuns ao criar uma página da Web.</p>

<h2 id="Veja_também">Veja também</h2>

<ul>
 <li><a href="/pt-BR/docs/Web/JavaScript">JavaScript</a>: O ponto de entrada principal para a documentação básica do JavaScript no MDN - é aqui que você encontrará extensos documentos de referência em todos os aspectos do JavaScript e alguns tutoriais avançados destinados a JavaScripters experientes.</li>
 <li><a href="https://www.youtube.com/user/codingmath">Matemática do programador</a>: Uma excelente série de vídeos que ensina a matemática necessária para ser um bom programador, por <a href="https://twitter.com/bit101">Keith Peters</a>.</li>
</ul>
