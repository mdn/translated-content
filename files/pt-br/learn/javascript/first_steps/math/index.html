...
<p><strong><a href="https://mdn.github.io/learning-area/javascript/introduction-to-js-1/variables/">Abra em uma nova janela</a></strong></p>

<ol>
 <li>Primeiramente, vamos declarar duas variáveis e as inicializar com um <em>integer</em> e um <em>float</em>, respectivamente, então digitaremos os nomes das variáveis para verificar se está tudo em ordem:
...
<ul>
 ...
 <li>Exibir uma mensagem de 'game over' se um jogo acabou ou uma mensagem de vitória se o jogo foi vencido</li>
