...
![Updated form handling process doc.](https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django/Forms/form_handling_-_standard.png)
...
![](https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django/Forms/forms_example_renew_default.png)

O formulário com um valor inválido inserido terá a seguinte aparência:

![](https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django/Forms/forms_example_renew_invalid.png)

A lista de todos os livros com o link de renovação será assim:

![](https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django/Forms/forms_example_renew_allbooks.png)
...
![Form Example: Create Author](https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django/Forms/forms_example_create_author.png)
...
![](https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django/Forms/forms_example_delete_author.png)
