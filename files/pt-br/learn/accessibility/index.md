...
> **Note:** **Nota**: Se você está estudando em um dispositivo que não pode criar novos arquivos, voce pode testar os exemplos em alguma aplicação de codificação online, como [JSBin](http://jsbin.com/) ou [Thimble](https://thimble.mozilla.org/).
