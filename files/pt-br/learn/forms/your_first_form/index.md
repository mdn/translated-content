...
Em nosso exemplo, o formulário irá enviar 3 informações, chamados "usuario*nome", "usuario_email" e "usuario_msg" e os dados serão enviados para a URL "***/pagina-processa-dados-do-form**\_" com o método HTTP: **POST** .
