...
A distinção entre elementos em nível de bloco e elementos em linha foi usada nas especificações HTML até 4.01. No HTML5, essa distinção binária é substituída por um conjunto mais complexo de [categorias de conteúdo](/pt-BR/docs/Web/HTML/Guides/Content_categories). Enquanto a categoria "em linha" corresponde aproximadamente à categoria de [conteúdo de frases](/pt-BR/docs/Web/HTML/Guides/Content_categories#phrasing_content), a categoria "nível de bloco" não corresponde diretamente a nenhuma categoria de conteúdo HTML5. Mas, os elementos "nível de bloco" e "embutido" combinados, correspondem ao [conteúdo de fluxo](/pt-BR/docs/Web/HTML/Guides/Content_categories#flow_content), em HTML5. Existem também categorias adicionais, por exemplo [conteúdo interativo](/pt-BR/docs/Web/HTML/Guides/Content_categories#interactive_content).
