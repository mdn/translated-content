...
Na web, um caret é usado para representar o ponto de inserção em {{HTMLElement("input")}} e {{HTMLElement("textarea")}} elementos, bem como quaisquer elementos cujo atributo [`contenteditable`](/pt-BR/docs/Web/HTML/Reference/Global_attributes#contenteditable) está definido, permitindo assim que o conteúdo do elemento seja editado pelo usuário.
...
- [`<input type="password">`](/pt-BR/docs/Web/HTML/Reference/Elements/input/password)
- [`<input type="search">`](/pt-BR/docs/Web/HTML/Element/input/search)
- [`<input type="date">`](/pt-BR/docs/Web/HTML/Reference/Elements/input/date), [`<input type="time">`](/pt-BR/docs/Web/HTML/Reference/Elements/input/time), [`<input type="datetime">`](/pt-BR/docs/Web/HTML/Element/input/datetime-local) e [`<input type="datetime-local">`](/pt-BR/docs/Web/HTML/Element/input/datetime-local)
- [`<input type="number">`](/pt-BR/docs/Web/HTML/Element/input/number), [`<input type="range">`](/pt-BR/docs/Web/HTML/Reference/Elements/input/range)
...
- Qualquer elemento com seu conjunto de atributo [`contenteditable`](/pt-BR/docs/Web/HTML/Reference/Global_attributes#contenteditable).
