...
> [!NOTE]
> MDN Web Docs 的內容由 Mozilla 內部與外部的作者共同撰寫。除非另有說明，否則內容皆以[姓名標示-相同方式分享](https://creativecommons.org/licenses/by-sa/2.5/deed.zh-hant)（CC-BY-SA）第 2.5 版或任何後續版本授權。
...
Mozilla 基金會的標誌、商標、服務標章，以及本網站的整體設計，皆不在創用 CC 授權條款範圍內。若這些標誌與設計屬於著作權作品，則不包含在授權內容中。若你希望在引用文件文字時同時使用這些權利，或對本授權條款有其他疑問，請聯絡 Mozilla 基金會：[licensing@mozilla.org](mailto:licensing@mozilla.org)。

## 在 MDN Web Docs 使用其他來源的內容

我們原則上不贊成將其他來源的內容複製到 MDN。MDN 應盡可能由原創內容組成。若我們收到拉取要求並發現內容為抄襲，將會關閉該請求，並要求提交者以自行撰寫的內容重新提交。
...
- [建立 GitHub 議題](https://github.com/mdn/mdn/issues/new/choose)說明你的意圖。
  - 描述你想複製或再發布的內容。
  - 提供該資源的網址。
  - 解釋你認為合適的理由。
...
- 若你不擁有該內容的權利，請盡可能將作者／出版者加入議題，或提供聯絡方式，以便我們徵求授權。
