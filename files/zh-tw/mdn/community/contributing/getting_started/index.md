...
別擔心你無法做到完美，會有 MDN 成員來幫忙修復問題與錯誤。有任何疑問，都歡迎到[社群網頁](/zh-TW/docs/MDN/Community)上查詢郵件群組、聊天頻道等資訊，協助你找尋答案。
...
> [!NOTE]
> 如果你要審查或撰寫新文章，建議先看一下[文件體例](/zh-TW/docs/MDN/Writing_guidelines/Writing_style_guide)。這樣能確保文章的一貫性。

### 選項 2: 給熱愛程式碼的人

我們需要更多的代碼示例！你也可以幫助建立我們的網站平臺，[Kuma](https://github.com/mdn/yari/tree/main/docs/what-yari-does.md)！

- [轉換示例代碼是「可用的」](/zh-TW/docs/MDN/Writing_guidelines/Page_structures/Live_samples)（30 分鐘）
