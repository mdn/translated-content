...
<p>如果你對這裡提到的內容有任何問題或疑慮，請聯絡 <a href="mailto:eshepherd@mozilla.com">Eric Shepherd</a>。</p>

<p>Mozilla 基金會的商標、Logo、服務標誌，以及這個網站的風格外觀，皆不屬於創用 CC 授權的範圍。它們是其原作者的作品（例如 Logo 和圖形設計），不包含在上述的授權條款中。如果你使用文件中的文字、並同時希望使用以上任一權利，或者你對於遵守我們的授權條款有任何的問題，你應該聯絡 Moziila 基金會：<a href="mailto:licensing@mozilla.org">licensing@mozilla.org</a>。</p>
