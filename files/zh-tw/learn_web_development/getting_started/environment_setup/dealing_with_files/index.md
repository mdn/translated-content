...
要讓一個檔案能夠與另一個檔案"溝通"，你需要提供一個他們之間的相對檔案路徑以讓檔案能夠找到另一個檔案在哪裡。為了要展示，我們將插入一小段的 HTML 到我們的 `index.html` 檔案中，並且讓它顯示你在 ["What will your website look like?"](/zh-TW/docs/Learn_web_development/Getting_started/Your_first_website/What_will_your_website_look_like) 這篇文章中所選的圖片。
