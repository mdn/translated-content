...
在開始前你需要了解什麼是伺服器端 web 程式和什麼是 web 框架，推薦閱讀[伺服器端網站開發第一步](/zh-TW/docs/Learn_web_development/Extensions/Server-side/First_steps)。建議了解基本的程式知識和[JavaScript](/zh-TW/docs/Web/JavaScript)，但不需要知道核心概念。

> [!NOTE]
> 本網站有許多學習 JavaScript 應用在客戶端開發的有用資源，如：[JavaScript](/zh-TW/docs/Web/JavaScript)、[JavaScript 指南](/zh-TW/docs/Web/JavaScript/Guide)、[JavaScript 基礎](/zh-TW/docs/Learn_web_development/Getting_started/Your_first_website/Adding_interactivity)、[JavaScript](/zh-TW/docs/Learn_web_development/Core/Scripting) (learning)。使用 Node.js 開發伺服器端使用的 JavaScript 語言與概念和客戶端是一樣的。Node.js 提供[額外的 APIs](https://nodejs.org/dist/latest-v6.x/docs/api/)以支援無瀏覽器環境，例如：建立 HTTP 服務和讀取檔案系統。但不支援 DOM 及瀏覽器相關的 JavaScript API。
>
...
- [Express/Node 介紹](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Express_Nodejs/Introduction)
...
- [設定 Node (Express) 開發環境](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Express_Nodejs/development_environment)
...
- [Express 教學(1): The Local Library website](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Express_Nodejs/Tutorial_local_library_website)
  - : 在第一篇實務教學系列文章中將說明你將會學到什麼？以及提供範例網站 local library 的概覽，我們將在後續的文章中繼續改進它。
- [Express 教學(2): 建構網站骨架](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Express_Nodejs/skeleton_website)
  - : 本文章展示如何建構網站的骨架，接著你可以自己添加路由、模板/畫面和資料庫。
- [Express 教學(3): 使用資料庫(以 Mongoose 為例)](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Express_Nodejs/mongoose)
...
- [Express 教學(4): 路由和控制器](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Express_Nodejs/routes)
...
- [Express 教學(5): 顯示圖書館的資料](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Express_Nodejs/Displaying_data)
  - : 現在已經準備好新增頁面來展示館藏和其他資料了。這些頁面包括一個展示我們有多少種 model 型態的首頁、所有 models 的列表和詳細資料頁面。透過本教學你可以得到從資料庫取得紀錄和使用模板的實務經驗。
- [Express 教學(6): 使用表單](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Express_Nodejs/forms)
  - : 本教學中展示如何使用 Express 的插件-Pug 來使用 HTML Forms，以及如何編寫表單來創造、更新和刪除資料庫的文件。
- [Express 教學(7): 網站佈署](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Express_Nodejs/deployment)
