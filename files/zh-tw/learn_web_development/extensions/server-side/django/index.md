...
開始學習本模塊，並不需要任何 Django 知識. 但你要理解什麼是服務器端網絡編程、什麼是網絡框架，最好能夠閱讀我們的[服務端網站編程的第一步模塊](/zh-TW/docs/Learn_web_development/Extensions/Server-side/First_steps)。
...
- [Django 簡介](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Django/Introduction)
...
- [架設 Django 開發環境](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Django/development_environment)
...
- [Django 教學 1: 本地圖書館網站](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Django/Tutorial_local_library_website)
  - : 我們實用教程系列的第一篇文章，會解釋你將學習到什麼，並提供 "本地圖書館" 網站這個例子的概述。我們會在接下來的文章裡，完成並不斷的改進這個網站。
- [Django 教學 2: 創建骨架網站](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Django/skeleton_website)
  - : 這篇文章會教你，怎樣創建一個網站的 "框架" 。以這個網站為基礎，你可以填充網站特定的 settings、urls、models、views 和 templates。
- [Django 教學 3: 使用模型](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Django/Models)
...
- [Django 教學 8: 使用者身份驗証和權限](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Django/Authentication)
...
- [Django 小部落格 DIY](/zh-TW/docs/Learn_web_development/Extensions/Server-side/Django/django_assessment_blog)
