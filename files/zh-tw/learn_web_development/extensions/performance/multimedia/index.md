...
為了確保你不會將不必要的大文件發送給用戶，最好 [壓縮所有你要傳輸的影像](#壓縮所有影像)、[優化`<source>` 順序](#優化_source_順序)、設定 [autoplay](#影像自動播放)、[移除靜音影像的聲音](#移除靜音影像的聲音)、[優化影像預載](#影像預載)，還有[考慮串流](#考慮串流)這部影像。
...
根據你的影像創作軟體，你也許可以在匯出和壓縮過程中刪除聲音。 如果沒有，那麼有一個免費的工具 [FFmpeg](https://www.ffmpeg.org/) ，可以使用以下指令來為你完成此任務
