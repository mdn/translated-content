  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <a href="/zh-TW/docs/Learn_web_development/Core/Scripting">JavaScript</a> 語言，並了解
        <a
...
現在你已經完成了應用程式的開發，可以執行 Angular CLI 的 `build` 指令。
當你在 `todo` 目錄中執行 `build` 指令時，你的應用程式會被編譯到一個名為 `dist/` 的輸出目錄中。
