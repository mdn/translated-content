...
<h2 id="Documentation">HTML 教學</h2>
...
<dl>
 ...
 <dt><strong><a href="/zh-TW/docs/HTML/Element">MDN HTML 元素引用</a></strong></dt>
...
<dl>
 ...
 <dt><strong><a href="http://wikiversity.org/wiki/Web_Design/HTML_Challenges">HTML 挑戰 </a> (Wikiversity)</strong></dt>
...
<dl>
 ...
 <dt><strong><a href="/zh-TW/docs/Tips_for_Authoring_Fast-loading_HTML_Pages"> 給程式創作者快速載入 HTML 網頁的提示 </a></strong></dt>
 <dd>優化網頁，為使用者提供響應式網站，減少 web 服務器和 Internet 連線的負擔。</dd>
</dl>
</div>
</div>

<h2 id="Documentation">CSS 教學</h2>
...
<dl>
 ...
 <dt><strong><a href="/zh-TW/docs/Common_CSS_Questions">常見的CSS問題</a></strong></dt>
 <dd>初學者的常見問題及解答。</dd>
</dl>
</div>
</div>
...
<dl>
 ...
 <dt><strong><a href="/zh-TW/docs/CSS/CSS_Reference">CSS 參考</a></strong></dt>
...
<div>
<dl>
 <dt><strong><a href="http://www.alistapart.com/articles/fluidgrids/">流變格線框架</a> (A List Apart)</strong></dt>
 <dd>在瀏流器視窗大小調整的同時，能夠流暢地調整內容大小的設計佈局，同時使用字體排版格線。</dd>
 <dt><strong><a href="http://en.wikiversity.org/wiki/Web_Design/CSS_challenges">CSS 挑戰</a> (Wikiversity)</strong></dt>
...
<dl>
 ...
 <dt><strong><a href="/zh-TW/docs/CSS/CSS_transitions">CSS transitions</a></strong></dt>
...
<div>
<dl>
 <dt><strong><a href="http://www.html5rocks.com/tutorials/webfonts/quick/">Quick Guide to Implement Web Fonts with @font-face</a> (HTML5 Rocks)</strong></dt>
 ...
 <dt><strong><a href="http://davidwalsh.name/starting-css">Starting to Write CSS</a> (David Walsh)</strong></dt>
...
<dl>
 ...
 <dt><strong><a href="http://html5doctor.com/">HTML5 Doctor</a></strong></dt>
 <dd>Articles about using HTML5 right now.</dd>
</dl>
</div>

<h2 id="Documentation">JavaScript 教學</h2>
...
<div>
<dl>
 <dt><strong><a href="/zh-TW/docs/A_re-introduction_to_JavaScript">A re-Introduction to JavaScript</a></strong></dt>
 <dd>A recap of the JavaScript programming language aimed at intermediate-level developers.</dd>
 <dt><strong><a href="http://eloquentjavascript.net/">Eloquent JavaScript</a></strong></dt>
 ...
 <dt><strong><a href="http://www.addyosmani.com/resources/essentialjsdesignpatterns/book/">Essential JavaScript Design Patterns</a> (Addy Osmani)</strong></dt>
...
<dl>
 ...
 <dt><strong><a href="https://github.com/getify/You-Dont-Know-JS">You Don't Know JS</a> (Kyle Simpson)</strong></dt>
 <dd>A series of books diving deep into the core mechanisms of the JavaScript language.</dd>
 <dt><strong><a href="http://bonsaiden.github.com/JavaScript-Garden/">JavaScript Garden</a></strong></dt>
...
<dl>
 <dt><strong><a href="http://shichuan.github.io/javascript-patterns">Javascipt Patterns</a></strong></dt>
...
<dl>
 ...
 <dd>WebExtensions is a cross-browser system for developing browser add-ons. To a large extent the system is compatible with the <a href="https://developer.chrome.com/extensions">extension API</a> supported by Google Chrome and Opera. Extensions written for these browsers will in most cases run in Firefox or <a href="https://developer.microsoft.com/en-us/microsoft-edge/platform/documentation/extensions/">Microsoft Edge</a> with <a href="/zh-TW/Add-ons/WebExtensions/Porting_from_Google_Chrome">just a few changes</a>. The API is also fully compatible with <a href="/zh-TW/Firefox/Multiprocess_Firefox">multiprocess Firefox</a>.</dd>
</dl>
</div>
</div>
