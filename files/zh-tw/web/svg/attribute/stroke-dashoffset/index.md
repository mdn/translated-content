...
« [SVG 屬性引用首頁](/zh-TW/docs/SVG/Attribute)

`stroke-dashoffset` 屬性指定一個數值至虛線的開頭。

如果使用 [\<percentage>](/zh-TW/docs/SVG/Content_type#percentage) ，值則會代表當前 viewport 的百分比。
...
- [Shape elements](/zh-TW/docs/SVG/Element#shape) »
- [Text content elements](/zh-TW/docs/SVG/Element#textcontent) »
