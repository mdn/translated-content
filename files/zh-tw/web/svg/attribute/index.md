...
---
<p>« <a href="/en/SVG">SVG</a> / <a href="/en/SVG/Element">SVG Element reference</a> »</p>
...
<h3 id="AnimationAttributeTarget">Animation attribute target attributes</h3>
...
<div class="note">
  <p><strong>備註：</strong> Note that all SVG presentation attributes can be used as CSS properties.</p></div>
