...
[`canvas`](/zh-TW/HTML/Canvas)元素支援在[標準 HTML 5 特色](https://html.spec.whatwg.org/#text-0)以及少許實驗性的 Mozilla 方法和功能上繪製文字。
...
- 請見 [WHATWG specification](https://whatwg.org/specs/web-apps/current-work/#text) 關於 HTML 5 canvas text 的說明。
