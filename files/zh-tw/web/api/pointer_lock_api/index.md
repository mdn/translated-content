...
Pointer lock 與 [mouse capture](/zh-TW/docs/DOM/element.setCapture) 相關。在拖曳滑鼠時，Mouse capture 可持續向目標元素傳遞事件，且只要放開滑鼠按鈕隨即跟著停止。Pointer lock 與 mouse capture 不同之處在於：
