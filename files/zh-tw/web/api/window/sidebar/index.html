...
<table class="fullwidth-table">
 <tbody>
  ...
  <tr>
   ...
   <td colspan="2">Installs a search provider (OpenSearch). <a href="/en-US/docs/Web/API/Window/sidebar/Adding_search_engines_from_Web_pages#Installing_OpenSearch_plugins">Adding OpenSearch search engines </a>contains more details. Added in Firefox 2.</td>
  </tr>
  <tr>
   ...
   <td colspan="2">Installs a search engine (Sherlock). <a href="/en-US/docs/Web/API/Window/sidebar/Adding_search_engines_from_Web_pages#Installing_Sherlock_plugins">Adding Sherlock search engines </a>contains more details.</td>
  </tr>
  <tr>
