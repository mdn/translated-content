...
<div class="note"><strong>注意：</strong> <code>KeyboardEvent</code> 僅顯示在鍵盤上發生的事。當你需要進行文字輸入的操作，請使用 HTML5 <code><a href="/en-US/docs/DOM/DOM_event_reference/input">input</a></code> event 代替 <code>KeyboardEvent</code> 。舉例來說，當使用者在手寫系統，例如平板電腦，輸入文字時，並不會啟動 key events 。</div>
