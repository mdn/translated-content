...
<p><strong><code>HTMLElement</code></strong> 介面表示了所有的 <a href="/docs/Web/HTML">HTML</a> 元素。部分元素直接實作了此介面，其它則是實作繼承自 <code>HTMLElement</code> 的子介面。</p>
...
<dl>
 ...
 <dd>Is a {{jsxref("Boolean")}} that controls <a href="/en-US/docs/HTML/Controlling_spell_checking_in_HTML_forms">spell-checking</a>. It is present on all HTML elements, though it doesn't have an effect on all of them.</dd>
