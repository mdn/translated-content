...
<p>Although this may look like a <a href="https://zh.wikipedia.org/wiki/cross-site_scripting">cross-site scripting</a> attack, the result is harmless. HTML5 specifies that a {{HTMLElement("script")}} tag inserted with <code>innerHTML</code> <a href="https://www.w3.org/TR/2008/WD-html5-20080610/dom.html#innerhtml0">should not execute</a>.</p>
