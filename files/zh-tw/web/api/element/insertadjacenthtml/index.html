...
<p>It is not recommended you use <code>insertAdjacentHTML</code> when inserting plain text; instead, use the <a href="/en-US/docs/Web/API/Node/textContent"><code>Node.textContent</code></a> property or <a href="/en-US/docs/Web/API/Element/insertAdjacentText"><code>Element.insertAdjacentText()</code></a> method. This doesn't interpret the passed content as HTML, but instead inserts it as raw text.</p>
