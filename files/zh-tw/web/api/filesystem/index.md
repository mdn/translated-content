...
此介面並不會讓你直接存取使用者電腦的檔案系統，而是在瀏覽器的沙盒內建立一個「虛擬磁碟」讓你操作。如果要直接操作使用者的檔案系統，需要向使用者請求，像是安裝 Google Chrome 擴充功能之類的。相關的 Chrome API 可[在 Chrome 開發者文件中](https://developer.chrome.com/docs/apps/reference/fileSystem)找到。
