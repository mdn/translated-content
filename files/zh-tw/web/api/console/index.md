...
<div><img src="css-styling.png"></div>
...
<p><img alt="nesting.png" src="/@api/deki/files/6082/=nesting.png"></p>
...
<p><img alt="timerresult.png" src="/@api/deki/files/6084/=timerresult.png"></p>
...
<ul>
 ...
 <li>It's worth noting that the Firefox's built-in <code>Console</code> object is compatible with the one provided by <a href="http://getfirebug.com/">Firebug</a>.</li>
</ul>
...
<ul>
 ...
 <li><a href="/en-US/docs/Tools/Web_Console">Web Console</a> — how the Web Console in Firefox handles console API calls</li>
 ...
 <li><a href="/en-US/docs/Mozilla/Firefox_OS/Debugging/On-device_console_logging">On-device console logging</a> — how to do logging on Firefox OS devices</li>
</ul>
