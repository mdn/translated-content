...
<p><code><strong>Coordinates.heading</strong></code> 是個唯讀的正複數用來代表裝置前進的方向。這個數值代表你偏離北方多少度，0度代表你向著正北方，照著順時針的方向遞增(90度代表正東方，270度代表正西方)。如果{{domxref("Coordinates.speed")}} 為0度，則此值為 <code><a href="/en-US/docs/JavaScript/Reference/Global_Objects/NaN">NaN</a></code>。如果這個裝置無法提供這個值則回傳 null。</p>
