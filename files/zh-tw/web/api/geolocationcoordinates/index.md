...
- {{domxref("Coordinates.heading")}} {{readonlyInline}}
  - : 回傳一個 double 代表裝置前進的方向，這個數值代表你偏離北方多少度，0 度代表你向著正北方，照著順時針的方向遞增(90 度代表正東方，270 度代表正西方) 。如果速度值為 0 度，則此值為 [`NaN`](/zh-TW/docs/Web/JavaScript/Reference/Global_Objects/NaN)。如果無法提供這個值則回傳 null。
