...
<dl>
 <dt><a href="/en-US/docs/Web/HTTP/Overview">HTTP的概觀</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Web/HTTP/Basics_of_HTTP/Evolution_of_HTTP">HTTP的演化</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Web/HTTP/Messages">HTTP 訊息</a></dt>
 <dd>描述HTTP/1與HTTP/2不同類別與結構。</dd>
 <dt><a href="/en-US/docs/Web/HTTP/Session">一個典型HTTP對話</a></dt>
 <dd>顯示並解釋HTTP的通常對話流程。</dd>
 <dt><a href="/en-US/docs/Web/HTTP/Connection_management_in_HTTP_1.x">HTTP/1.x的連接管理</a></dt>
...
<dl>
 ...
 <dt><a href="/en-US/docs/Web/HTTP/Methods">HTTP 請求方法</a></dt>
 ...
 <dt><a href="/en-US/docs/Web/HTTP/Response_codes">HTTP 狀態回應碼</a></dt>
