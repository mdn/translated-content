...
HTTP **`203 Non-Authoritative Information`** [成功回應](/zh-TW/docs/Web/HTTP/Reference/Status#成功回應)狀態碼表示請求成功，但一個*轉換*{{Glossary("Proxy server", "代理伺服器")}}修改原始伺服器 {{HTTPStatus("200")}}（`OK`）回應的標頭或附加內容。
