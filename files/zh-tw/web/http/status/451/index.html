...
<p>此示例擷取自 IETF RFC（參見以下章節）、包含了<a href="https://zh.wikipedia.org/wiki/萬世魔星">萬世魔星</a>的引用。</p>
...
<ul>
 <li><a href="https://zh.wikipedia.org/wiki/HTTP_451">維基百科的 HTTP 451</a></li>
 <li><a href="https://zh.wikipedia.org/wiki/華氏451度">維基百科的華氏451度</a>（該請求碼的數字詞源）</li>
</ul>
