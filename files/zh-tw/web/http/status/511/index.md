...
HTTP **`511 Network Authentication Required`** [伺服器錯誤回應](/zh-TW/docs/Web/HTTP/Status#伺服器錯誤回應)狀態碼表示用戶端需要進行驗證以獲得網路訪問權限。此狀態碼不是由原始伺服器產生，而是由攔截流量的{{Glossary("Proxy_server", "代理伺服器")}}發送，以控制對網路的訪問。
