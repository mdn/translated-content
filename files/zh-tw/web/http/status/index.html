...
<p>HTTP 狀態碼表明一個 <a href="/zh-TW/docs/Web/HTTP">HTTP</a> 要求是否已經被完成。回應分為五種：</p>
...
<p>以下的狀態碼定義在 <a href="https://tools.ietf.org/html/rfc2616#section-10">section 10 of RFC 2616</a> 中。你可以在 <a href="https://tools.ietf.org/html/rfc7231#section-6.5.1">RFC 7231</a> 查看更新過的規範。</p>

<div class="blockIndicator note">
<p>如果你收到任何不在清單內的回應，那很可能伺服器自行軟體實作的非標準規範。</p>
</div>
...
<dl>
 ...
 <dd>此請求已經被接受但尚未處理。此狀態為非承諾性，代表 HTTP 無法在之後傳送一個非同步的回應告知請求的處理結果。最初目的為外部程序或其他伺服器處理請求的情況，或用於批次處理中。</dd>
...
<dl>
 ...
 <dd>此回應代表伺服器未能滿足請求標頭的<code>Expect</code>欄位所提出的期望回應。</dd>
 ...
 <dd>請求格式正確，但有部分語意上的錯誤而無法執行請求。</dd>
...
<dl>
 ...
 <dd>伺服器不支援請求的方法，僅有<code>GET</code>與<code>HEAD</code>是伺服器必須支援的方法。</dd>
 <dt>{{HTTPStatus(502, "502 Bad Gateway")}}</dt>
 <dd>作為閘道的伺服器，在獲取處理請求所需的回應時，得到無效回應。</dd>
