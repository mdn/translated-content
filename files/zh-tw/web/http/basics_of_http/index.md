...
- [Negotiating an HTTP version](/en-US/docs/Web/HTTP/Basics_of_HTTP/Negotiating_an_HTTP_version)
...
- [Flow of an HTTP session](/en-US/docs/Web/HTTP/Flow_of_an_HTTP_session)
