...
| `.abw` | [AbiWord](https://en.wikipedia.org/wiki/AbiWord) 文件 | `application/x-abiword` |
...
| `.3gp` | [3GPP](https://en.wikipedia.org/wiki/3GP_and_3G2) 音訊／視訊容器 | `video/3gpp`；若不含視訊則為 `audio/3gpp` |
| `.3g2` | [3GPP2](https://en.wikipedia.org/wiki/3GP_and_3G2) 音訊／視訊容器 | `video/3gpp2`；若不含視訊則為 `audio/3gpp2` |
