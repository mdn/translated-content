...
要在包含於 {{HTMLElement("blockquote")}} 或 {{HTMLElement("q")}} 元素內的引用材料的來源之後加上引用，請在該元素上使用 [`cite`](/zh-TW/docs/Web/HTML/Reference/Elements/blockquote#cite) 屬性。
...
- 用於內嵌引用的元素 {{HTMLElement("q")}} 以及 [`cite`](/zh-TW/docs/Web/HTML/Reference/Elements/q#cite) 屬性。
