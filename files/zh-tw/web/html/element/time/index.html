...
---
<p><strong>HTML <code>&lt;time&gt;</code> element</strong> 用以表示時間，可以是24小時制時間或以<a href="https://zh.wikipedia.org/zh-tw/%E5%85%AC%E5%8E%86">公曆</a>紀年的日期（日期可以添加時間和時區的資訊）</p>
...
<table class="properties">
 <tbody>
  <tr>
   <th scope="row"><a href="/zh-TW/docs/Web/HTML/Content_categories">內容分類</a></th>
   <td><a href="/en-US/docs/Web/HTML/Content_categories#Flow_content">Flow content</a>, <a href="/en-US/docs/HTML/Content_categories#Phrasing_content">phrasing content</a>, palpable content.</td>
  </tr>
  <tr>
...
<p>和其他HTML elements一樣，接受所有 <a href="/en-US/docs/HTML/Global_attributes">global attributes</a>。</p>

<dl>
 <dt>{{htmlattrdef("datetime")}}</dt>
 <dd>此 attribute 用以表示日期或時間，其格式必須是<a href="http://www.w3.org/TR/html-markup/datatypes.html#common.data.datetime">有效的日期/時間格式</a>。若其值不正確，則 element 就不會有關連的 time stamp.</dd>
</dl>
