...
---
<p><strong>HTML <code>&lt;script&gt;</code> 元素</strong>能嵌入或引用要執行的程式碼。最常見的用途是嵌入或引用 JavaScript 程式碼。&lt;script&gt; 元素也能執行其他語言，例如 <a href="/zh-TW/docs/Web/API/WebGL_API">WebGL</a> 的 GLSL shader 程式語言。</p>
...
<dl>
 <dt>{{htmlattrdef("fetchpriority")}}</dt>
 <dd>
...
<dl>
 ...
 <ul>
  ...
  <li><strong><code>module</code></strong>：針對相容 HTML5 的瀏覽器來說，這段程式碼會當成 JavaScript 模組（module）。腳本內容的處理不受 <code>charset</code> 與 <code>defer</code> 屬性影響。針對 <code>module</code> 的資訊，請參閱 <a href="https://hacks.mozilla.org/2015/08/es6-in-depth-modules/">ES6 in Depth: Modules</a>。在使用 <code>module</code> 關鍵字時，程式碼的行為會有所不同。</li>
