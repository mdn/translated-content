...
- [`itemprop`](/en-US/docs/Web/HTML/Global_attributes/itemprop) {{experimental_inline}}
...
- [`slot`](/en-US/docs/Web/HTML/Global_attributes/slot) {{experimental_inline}}
...
- [`spellcheck`](/en-US/docs/Web/HTML/Global_attributes/spellcheck) {{experimental_inline}}
