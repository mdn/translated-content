...
<ul>
 ...
 <li>The multiple <a href="/en-US/docs/Web/Accessibility/ARIA"><strong><code>aria-*</code></strong></a> attributes, used for improving accessibility.</li>
...
<dl>
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/accesskey">accesskey</a></code></dt>
 ...
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/class">class</a></code></dt>
 ...
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/contenteditable">contenteditable</a></code></dt>
 ...
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/contextmenu">contextmenu</a></code></dt>
 <dd>Is the <a href="#attr-id"><strong><code>id</code></strong></a> of an {{HTMLElement("menu")}} to use as the contextual menu for this element.</dd>
 ...
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/hidden">hidden</a></code></dt>
 ...
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/id">id</a></code></dt>
...
<div class="note">
<p><strong>註：</strong>The following 5 attributes are part of the <a href="https://html.spec.whatwg.org/multipage/microdata.html#microdata">WHATWG HTML Microdata feature</a>.</p>
</div>

<dl>
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/itemid">itemid</a></code> {{experimental_inline}}</dt>
 <dd>The unique, global identifier of an item.</dd>
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/itemprop">itemprop</a></code> {{experimental_inline}}</dt>
 ...
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/itemref">itemref</a></code> {{experimental_inline}}</dt>
 ...
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/itemscope">itemscope</a> </code>{{experimental_inline}}</dt>
 ...
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/itemtype">itemtype</a></code> {{experimental_inline}}</dt>
 ...
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/lang">lang</a></code></dt>
 <dd>Participates in defining the language of the element, the language that non-editable elements are written in or the language that editable elements should be written in. The tag contains one single entry value in the format defines in the <a href="https://www.ietf.org/rfc/bcp/bcp47.txt"><em>Tags for Identifying Languages (BCP47)</em></a> IETF document. <a href="#attr-xml:lang"><strong>xml:lang</strong></a> has priority over it.</dd>
</dl>

<dl>
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/slot">slot</a></code> {{experimental_inline}}</dt>
...
<dl>
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/spellcheck">spellcheck</a></code> {{experimental_inline}}</dt>
 ...
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/style">style</a></code></dt>
 ...
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/tabindex">tabindex</a></code></dt>
 ...
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/title">title</a></code></dt>
 ...
 <dt><code><a href="/en-US/docs/Web/HTML/Global_attributes/translate">translate</a></code></dt>
