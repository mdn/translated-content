...
<dl>
 <dt>ShortName</dt>
 <dd>搜尋引擎簡稱。<strong>Restrictions:</strong> The value must contain 16 or fewer characters of plain text. The value must not contain HTML or other markup.</dd>
 <dt>Description</dt>
 <dd>搜尋引擎的簡要描述。<strong>Restrictions:</strong> The value must contain 1024 or fewer characters of plain text. The value must not contain HTML or other markup.</dd>
 <dt>InputEncoding</dt>
...
&lt;Image height="16" width="16"&gt;data:image/x-icon;base64,AAABAAEAEBAAA ... DAAA=&lt;/Image&gt;
 ...
 <div class="note"><p><strong>備註：</strong> For icons loaded remotely (i.e. from <code>https://</code> URIs as opposed to <code>data:</code> URIs), Firefox will reject icons larger than 10 kilobytes in size.</p></div>

 <p><img alt="Search suggestions from Google displayed in Firefox's search box" src="/@api/deki/files/358/=SearchSuggestionSample.png"></p>
 </dd>
 <dt><strong>Url</strong></dt>
 <dd>描述搜尋用的 URL。以 <code>template</code> 屬性指定其搜尋 URL。Firefox 支援以下型態的 URL：
 <ul>
 ...
 <p><img src="searchsuggestionsample.png" alt="Search suggestions from Google displayed in Firefox's search box"></p>
 </dd>
 <dt>Param</dt>
 <dd>隨搜尋要求一併送出的參數，每組皆有參數名稱及其值。指定參數時可放入 <code>{searchTerms}</code> 字串來取得使用者輸入的搜尋關鍵字。</dd>
 <dt>moz:SearchForm</dt>
 <dd>搜尋網站的網址，提供 Firefox 使用者不搜尋、直接連到搜尋網站的方法。
 <div class="note"><strong>備註：</strong> 由於此元素非 OpenSearch 標準規格而是 Firefox 獨有，故加上「<code>moz:</code>」名稱空間，已確保不支援的用戶端能直接跳過此元素。</div>
 </dd>
</dl>
...
<div class="note"><strong>備註：</strong>目前的<a href="http://addons.mozilla.org">addons.mozilla.org</a>（AMO）不支援自動更新 OpenSearch 套件。如果要把搜尋套件放到 AMO，請不要用上自動更新的功能。</div>
