...
<pre class="brush: bash">cat input.html | itex2MML &gt; output.html</pre>
...
<pre class="brush: bash">   mk4ht mzlatex foo.tex # Linux/Mac platforms
...
<pre class="brush: bash">  latexml --dest foo.xml foo.tex
...
<pre class="brush: bash">  latexmlpost --dest foo.html --format=html5 --javascript=mathjax.js foo.xml
</pre>
...
<pre class="brush: bash">  latexmlpost --dest foo.html --format=html5 --splitat=section foo.xml
</pre>
<p>Finally, to generate an EPUB document, you can do</p>
<pre class="brush: bash">  latexmlc --dest foo.epub --splitat=section foo.xml
</pre>
