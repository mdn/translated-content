...
<p>藉由 <a href="/en/CSS/CSS3">CSS3</a> 我們可以對元素使用 <strong>多重背景</strong>。每個設定的背景被一個個分層，第一個背景在最上面，最後一個背景是在最下面一層。 記得只有最後一個背景可以設定 background color。</p>
...
<p>下面的範例中，重疊三個背景：Firefox logo、<a href="/en/CSS/linear-gradient">線性漸層</a>、一張泡泡的圖片</p>
...
<ul>
 <li><a href="/en-US/docs/CSS/Using_CSS_gradients">使用 CSS 漸層</a></li>
</ul>
