...
- CSS 介紹
  ...
  若你剛接觸網路開發，請確定讀過我們的 [CSS 基礎](/zh-TW/docs/Learn_web_development/Getting_started/Your_first_website/Styling_the_content)以了解何謂 CSS 並知道要怎麼用。

- CSS 教學

  我們的 [CSS 學習專區](/zh-TW/docs/Learn_web_development/Core/Styling_basics)包含所有必要的基礎資訊，能讓你從完全新手開始，帶向熟悉 CSS。
...
我們的 [CSS 學習專區](/zh-TW/docs/Learn_web_development/Core/Styling_basics)有很多從頭教起的 CSS 模組。你不需要背景知識。

- [CSS 介紹](/zh-TW/docs/Learn_web_development/Core/Styling_basics)
