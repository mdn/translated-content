...
---
<p><strong>層疊樣式表（Cascading Style Sheets, CSS）</strong>是用來描述 <a href="/zh-TW/docs/HTML">HTML</a> 或 <a href="/zh-TW/docs/XML">XML</a>（包含 <a href="/zh-TW/docs/SVG">SVG</a> 或 <a href="/zh-TW/docs/XHTML">XHTML</a> 等各種 XML 變形）文件外觀的<a href="/zh-TW/docs/DOM/stylesheet">樣式表</a>語言。CSS 會描述文件裡的結構化元素，該如何呈現在螢幕、紙、語音報讀、或其他媒介上。</p>

<p><strong>CSS</strong> 是<strong>開放網路</strong>的核心語言之一，具有標準化的 <a href="http://w3.org/Style/CSS/#specs">W3C 規範</a>。歷經不同層級的開發，CSS1 目前已被棄用、CSS2.1 是建議規範，而 <a href="/zh-TW/docs/CSS/CSS3">CSS3</a> 目前被分作數個較小的模組，持續在標準化的路上行進。</p>
...
<ul>
 ...
 <li>CSS 參考
  <p>這是給經驗豐富的網頁開發者的<a href="/zh-TW/docs/Web/CSS/Reference">完整參考資訊</a>，說明 CSS 的每一個屬性與概念。</p>
 </li>
</ul>
...
<dl>
 ...
 <dd>到了這裡，我們已經看完 CSS 的基礎（樣式化文字、樣式化與操作盒子使你的內容可以合適的展示）。現在該來看看如何把你的盒子放在相對於可視區正確的地方。我們已經擁有必要的知識，所以你可以更深入了解 CSS 排版、看不同的顯示設定、傳統排版方法如浮動或定位、新的排版方法如彈性盒子。</dd>
</dl>
...
<ul>
 ...
 <li>CSS 關鍵概念：
  <ul>
   ...
   <li><a href="/zh-TW/docs/CSS/Understanding_z-index/The_stacking_context">堆疊</a>和<a href="/zh-TW/docs/CSS/block_formatting_context">格式化區塊</a></li>
...
<h2 id="CSS_開發工具">CSS 開發工具</h2>

<ul>
 <li>The <a href="http://jigsaw.w3.org/css-validator/">W3C CSS 驗證服務</a> 能檢查 CSS 的有效性。<a href="http://www.onlinewebcheck.com/">OnlineWebCheck.com</a> 也在做相同的事情。它們都是很重要的除錯工具。</li>
 ...
 <li>Firefox 的<a href="https://addons.mozilla.org/zh-TW/firefox/addon/1843">Firebug 套件</a>，navigator 裡面，能直接觀察、編輯網頁的 CSS 的人氣套件。要測試某些變化的時候會非常實用，而這套件還能做得更多。</li>
 <li>Firefox 的<a href="https://addons.mozilla.org/zh-TW/firefox/addon/60">Web Developer 套件</a> 也能能直接觀察、編輯網頁的 CSS。與 Firebug 相比更簡單、但相比下也沒那麼強大。</li>
