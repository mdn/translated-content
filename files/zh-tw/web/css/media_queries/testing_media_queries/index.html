...
<h2 id="Creating_a_media_query_list">創建 media query list 物件</h2>
...
<h2 id="Checking_the_result_of_a_query">檢查 media query 結果</h2>
...
<h2 id="Receiving_query_notifications">接收測試結果通知</h2>
...
<h2 id="Ending_query_notifications">停止接收測試結果通知</h2>
