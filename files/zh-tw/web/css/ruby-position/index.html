...
<dl>
 ...
 <dd><img alt="Over example" src="screen_shot_2015-03-04_at_13.02.20.png">如果文件以橫式排列，該關鍵字會指引旁註標記（ruby）出現在主文的上方。如果文件以直式排列，則會出現在主文的右方。</dd>
 <dt><code>under</code></dt>
 <dd><img alt="Under example" src="screen_shot_2015-03-04_at_13.02.07.png">如果文件以橫式排列，該關鍵字會指引旁註標記出現在在主文的下方。如果文件以直式排列，則會出現在主文的左方。</dd>
