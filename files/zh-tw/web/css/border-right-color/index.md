...
- 與邊框相關的 CSS 簡寫屬性：{{cssxref("border")}}、{{cssxref("border-right")}} 及 {{cssxref("border-color")}}。
- 其他邊框的顏色相關 CSS 屬性：{{cssxref("border-left-color")}}、{{cssxref("border-bottom-color")}} 及 {{cssxref("border-top-color")}}。
- 適用於相同邊框的其他邊框相關 CSS 屬性：{{cssxref("border-right-style")}} 及 {{cssxref("border-right-width")}}。
