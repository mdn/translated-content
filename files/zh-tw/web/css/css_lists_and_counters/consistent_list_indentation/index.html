...
<p>  使用 CSS 來協助縮排列表看來簡單實則卻否，原因很簡單 - 各大瀏覽器其實作方式不盡相同。一個很大的原因來自於對距離的掌握，但這很讓人喪志，因為瀏覽器沒有一致的排版方式。舉例來說，倘若你宣告一個 list 沒有 left margin，在 IE 中他可以被移動，但在 Gecko-based 的瀏覽器中他們將很固執的固定在那。</p>
  ...
  <p><img alt="Figure 1" src="/@api/deki/files/619/=Consistent-list-indentation-figure1.gif"></p>
  <p>  這裡的紅點線框是 list 內容的外框。在這裡的例子中， list item 並沒有設定 padding 或 borders。現在我們加上兩個 list item，如圖二：</p>
  <p><img alt="Figure 2" src="/@api/deki/files/620/=Consistent-list-indentation-figure2.gif"></p>
  ...
  <p><img alt="Figure 3" src="/@api/deki/files/621/=Consistent-list-indentation-figure3.gif"></p>
  <p>  然後我們加上 list item markers。因為我們用的是 unordered list，因此使用預設的 filled-circle "bullets"。結果如下：</p>
  <p><img alt="Figure 4" src="/@api/deki/files/622/=Consistent-list-indentation-figure4.gif"></p>
  ...
  <p><img alt="Figure 5" src="/@api/deki/files/623/=Consistent-list-indentation-figure5.gif"></p>
  <p>  Gecko 則不太一樣，他為 <code>&lt;ul&gt;</code> element 設定了 40 pixel 的 left <em>padding</em>。因此造成上圖的程式碼會在 Gecko 中變成下圖：</p>
  <p><img alt="Figure 6" src="/@api/deki/files/624/=Consistent-list-indentation-figure6.gif"></p>
