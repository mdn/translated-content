...
---
<p><strong><code>animation-fill-mode</code></strong>  <a href="/en/CSS">CSS</a> 属性指定CSS动画应该如何在其执行前后的样式展示情况。</p>
...
<dl>
 ...
 <dd>【（the animation will apply the values defined in the first relevant <a href="/en-US/docs/CSS/@keyframes">keyframe</a> as soon as it is applied to the target, and retain this during the <code>"animation-delay"</code> period.）原文大概意思是会停留第一个关键帧，并会保留 <code>"animation-delay"</code> 延迟属性的所设定周期。】</dd>
...
<p>查看 <a href="/en/CSS/CSS_animations">CSS animations</a> 更多有關的例子</p>
