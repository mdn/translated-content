...
« [CSS](/zh-TW/docs/Web/CSS) « [理解 CSS 的 z-index](/zh-TW/docs/CSS/Understanding_z-index)
...
- [無堆疊的 z-index](/zh-TW/docs/CSS/Understanding_z-index/Stacking_without_z-index)：默認規則疊加
...
- [堆疊環境例子 2](/zh-TW/docs/CSS/Understanding_z-index/Stacking_context_example_2)：在所有層面上 2 級 HTML 層次，Z 指數
- [堆疊上下文例 3](/zh-TW/docs/CSS/Understanding_z-index/Stacking_context_example_3)：3 級的 HTML 等級，在第二級上的 z 索引
