...
<div class="warning">
<p>只有可以變形的元素可以被變形，這包括所有被CSS box model掌管輸出的元素，除了<a href="/en-US/docs/Web/CSS/Visual_formatting_model#Inline-level_elements_and_inline_boxes">視覺格式化模型, </a><a href="/zh-CN/docs/Web/HTML/Element/col">table-column boxes</a> 和 <a href="/zh-CN/docs/Web/HTML/Element/colgroup">table-colunm-group boxes</a>。</p>
</div>
