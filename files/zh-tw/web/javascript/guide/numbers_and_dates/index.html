...
<p>在 JavaScript 中, Number所使用的標準依照 <a href="https://en.wikipedia.org/wiki/Double-precision_floating-point_format">double-precision 64-bit binary format IEEE 754</a> (i.e. number的區間是 -(2^53 -1) 到 2^53 -1)。<strong>整數是沒有特定的類型</strong>。</p>
