...
<ul>
 ...
 <li>有寫過程式的經驗，若您是完全的新手，可嘗試在主頁上有關<a href="/en-US/docs/Web/JavaScript">JavaScript</a>的教程。</li>
</ul>
...
<div class="note"><p><strong>備註：</strong> ECMA-262 第2版是由已修正錯誤的第1版並加上些微的更動構成。現今由 Ecma International 的 TC39 工作組（TC39 Working Group）所發行的版本是 ECMAScript 5.1版</p></div>

<p><a href="/zh-TW/docs/JavaScript/Reference">JavaScript Reference</a> 指出了哪些 JavaScript 的特性是相容於 ECMAScript 的。</p>
