...
<p>函式square有一個參數，叫作number。這個函式只有一行程式碼，它會回傳number自乘的結果。函式的 <a href="/en-US/docs/JavaScript/Reference/Statements/return"><code>return</code></a> 語法描述函式的返回值。</p>
...
<p>如果傳遞一個物件（例如 <a href="/en-US/docs/JavaScript/Reference/Global_Objects/Array"><code>Array</code></a> 或自定義的其它物件）作為參數，而函式改變了這個物件的屬性，這樣的改變對函式外部是有作用的(因為是傳遞物件的位址)，如下面的例子所示：</p>
...
<p>除了上述的定義方式以外，我們也可以透過 <a href="/en-US/docs/JavaScript/Guide/Predefined_Core_Objects#Function_Object"><code>Function</code> constructor</a> 來定義, 類似 <a href="/en-US/docs/JavaScript/Guide/Functions#eval_Function"><code>eval()</code></a>.</p>
...
<p>See the <a href="/en-US/docs/JavaScript/Reference/Global_Objects/Function"><code>Function</code> object</a> in the JavaScript Reference for more information.</p>
...
<p>The following sections introduce these functions. See the <a href="/en-US/docs/JavaScript/Reference">JavaScript Reference</a> for detailed information on all of these functions.</p>
...
<p>下列範例將<code><a href="/en-US/docs/JavaScript/Reference/Global_Objects/Date"> 日期</a></code> 物件轉換為可讀字串。</p>
...
<p>下列範例將 <code><a href="/en-US/docs/JavaScript/Reference/Global_Objects/String">字串</a></code> 物件轉換為 <code><a href="/en-US/docs/JavaScript/Reference/Global_Objects/Number">數字</a></code> 物件。</p>
...
<p><code>escape</code> 與 <code>unescape</code> 對於非ASCII 字元無法處理。 在 JavaScript 1.5 之後改用 <code><a href="/en-US/docs/JavaScript/Reference/Global_Objects/encodeURI">encodeURI</a></code>, <code><a href="/en-US/docs/JavaScript/Reference/Global_Objects/decodeURI">decodeURI</a></code>, <code><a href="/en-US/docs/JavaScript/Reference/Global_Objects/encodeURIComponent">encodeURIComponent</a></code>, 與 <code><a href="/en-US/docs/JavaScript/Reference/Global_Objects/decodeURIComponent">decodeURIComponent</a></code>.</p>
