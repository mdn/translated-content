...
<p><strong>備註：</strong>如果你有在使用 ES6 語法，建議參考<a href="/zh-TW/docs/Web/JavaScript/Reference/Functions/rest_parameters">其餘參數</a>。</p>
</div>
...
<dl>
 ...
 <dt><code><a href="/en-US/docs/Web/JavaScript/Reference/Functions/arguments/caller">arguments.caller</a></code> {{Deprecated_Inline}}</dt>
