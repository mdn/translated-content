...
<p>這個問題已計畫<a href="http://wiki.ecmascript.org/doku.php?id=harmony:typeof_null">在下一版 ECMAScript 予以修正</a> (會以 opt-in 方式提供). 屆時它將會做出如 <code>typeof null === 'null'</code> 的正確回傳結果。</p>
...
<ul>
 <li><a href="/en-US/docs/JavaScript/Reference/Operators/instanceof">instanceof</a></li>
</ul>
