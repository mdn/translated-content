...
<p>在這個主題中，我們將 CSS 套用到一個簡單的 HTML 文件上，在過程中學習這個語言一些實際的東西。</p>
...
<p><strong>備註：</strong> 如果您用來閱讀這篇文章的環境沒辦法簡單地建立檔案，也別擔心。底下會提供線上程式編輯器讓你就在這個頁面中撰寫範例程式。</p>
</div>
...
<p><strong>備註：</strong> 如您所見， CSS 提供我們一些方法來選擇元素，而目前為止我們只涉及到表面！我們將在課程後面的<a href="/zh-TW/docs/Learn/CSS/Building_blocks/Selectors">選擇器</a>章節裡有更深入的探討。</p>
</div>
...
<div class="notecard note">
<p><strong>備註：</strong> 你將會在 MDN 網站以及這些課程中經常看到<a href="/zh-TW/docs/Learn/Accessibility">可用性</a>的觀點被提起。當我們討論可用性的時候，指的是為了讓我們網頁能被每個人了解及使用所必須的東西。</p>
