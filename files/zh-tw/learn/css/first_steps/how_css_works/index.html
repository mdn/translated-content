...
<p>我們已經學會基本 CSS 的用途與用法了，這堂課我們就來看看瀏覽器是如何將 CSS 和 HTML 變化成網頁的吧。</p>

<table class="learn-box standard-table">
 <tbody>
  <tr>
   <th scope="row">需求：</th>
   <td>基本電腦操作、<a href="/en-US/Learn/Getting_started_with_the_web/Installing_basic_software">已安裝基本的軟體</a>、 <a href="/en-US/Learn/Getting_started_with_the_web/Dealing_with_files">檔案處理的基本知識</a>、HTML 基礎 (請參閱 <a href="/en-US/docs/Learn/HTML/Introduction_to_HTML">HTML 入門</a>)。</td>
  </tr>
  <tr>
   <th scope="row">目標：</th>
...
<p>{{EmbedLiveSample('瀏覽器遇到不認識的 CSS 時會發生什麼事？', '100%', 200)}}</p>
