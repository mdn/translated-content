...
<table class="learn-box standard-table">
  <tbody>
    ...
    <tr>
      ...
      <td>
        設置Svelte本地開發環境，建立初始應用程式，瞭解Svelte基本運作方式。
      </td>
    </tr>
  </tbody>
</table>
