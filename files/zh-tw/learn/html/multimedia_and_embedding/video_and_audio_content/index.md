...
<p><a href="/en-US/docs/Learn/HTML/Multimedia_and_embedding/Video_and_audio_content/containersandtracks.png"><img alt="Diagram conceptualizing the contents of a media file at the track level." src="containersandtracks.png"></a></p>
...
<h3 id="Restarting_media_playback_requires_JavaScript">Restarting media playback (requires JavaScript)</h3>
...
<h3 id="Detecting_track_addition_and_removal_requires_JavaScript">Detecting track addition and removal (requires JavaScript)</h3>
...
<div class="note">
<p><strong>備註：</strong> "Transcribe" means "to write down spoken words as text." The resulting text is a "transcript."</p>
</div>
...
<div class="note">
<p><strong>備註：</strong> Text tracks also help you with {{glossary("SEO")}}, since search engines especially thrive on text. Text tracks even allow search engines to link directly to a spot partway through the video.</p>
</div>
