...
<p>{{glossary("HTML")}} 不僅能夠定義網頁的單獨部分（例如“段落”或“圖片”），還可以使用區塊級元素（例如“標題欄”、“導覽選單”、“主內容列”）來定義網站中的複合區域。本文將探討如何規劃基本的網站結構，並根據規劃的結構來編寫 HTML。</p>
...
<div class="warning">
<p><strong>警告：</strong> Divs are so convenient to use that it's easy to use them too much. As they carry no semantic value, they just clutter your HTML code. Take care to use them only when there is no better semantic solution and try to reduce their usage to the minimum otherwise you'll have a hard time updating and maintaining your documents.</p>
</div>
...
<h4 id="br_the_line_break_element">&lt;br&gt;: the line break element</h4>
...
<h4 id="hr_the_thematic_break_element">&lt;hr&gt;: the thematic break element</h4>
...
<div class="note">
<p><strong>備註：</strong> Save your work somewhere; you might need it later on.</p>
</div>
