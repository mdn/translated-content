...
It is recommended that you work through [Getting started with the web](/en-US/docs/Learn/Getting_started_with_the_web) before proceeding with this topic. However, doing so isn't absolutely necessary.
...
- [HTML performance features](/en-US/docs/Learn/Performance/HTML_Performance_Features)
...
- [Understanding latency](/en-US/docs/Learn/Performance/Understanding_latency)
