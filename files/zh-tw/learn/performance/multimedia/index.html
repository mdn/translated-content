...
<p><strong>備註：</strong> 這是一篇進階的在 web 上優化多媒體的介紹，包含基本的原則還有技巧，想了更多的話，可以看  <a href="https://images.guide">https://images.guide</a>。</p>
</div>
...
<p>你必須考慮流量的使用. 很多的人都是使用流量有限制的上網方案， 或是用多少付多少的上網方案，也就是根據用了多少 MB 來付費。這樣的問題不是只發生在新興國家的市場. 在 2018 年, <a href="https://www.ofcom.org.uk/__data/assets/pdf_file/0021/113169/Technology-Tracker-H1-2018-data-tables.pdf">英國仍有 24% 在使用「用多少付多少」的方案</a>。</p>
...
<ul>
 ...
 <li>你載入的尺寸正確嗎？</li>
 <li>你已經壓縮圖像了嗎？ (查看 <a href="https://imageoptim.com/">ImageOptim</a>)</li>
</ul>
...
<p>為了確保您不會將不必要的大文件發送給用戶，最好<a href="#compress"> 壓縮所有你要傳輸的影像</a>，<a href="#omptimize">優化<code>&lt;source&gt;</code> 順序</a>, 設定 <a href="/en-US/docs/Learn/Performance/Multimedia#Video_autoplay">autoplay</a>, <a href="#muted">移除靜音影像的聲音</a>, <a href="/en-US/docs/Learn/Performance/Multimedia#Video_preload">優化影像預載</a>, 還有 <a href="/en-US/docs/Learn/Performance/Multimedia#Consider_streaming">考慮串流</a> 這部影像。</p>
