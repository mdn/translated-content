...
<div class="note">
<p><strong>備註：</strong> Django的一大優點是，您無需考慮將會話綁定到視圖中當前請求的機制。 如果我們在視圖中使用以下片段，我們將知道有關<code>my_car</code> 的信息僅與發送當前請求的瀏覽器相關聯。</p>
</div>
...
<div class="note">
<p><strong>備註：</strong> 您可以更改行為，以便站點可以通過在您的項目設置（<strong>locallibrary/locallibrary/settings.py</strong>）中添加<code>SESSION_SAVE_EVERY_REQUEST = True</code> 來更新每個請求的數據庫/發送cookie。</p>
</div>
...
<div class="note">
<p><strong>備註：</strong> 我們也可能會在此處測試瀏覽器是否甚至支持cookie（例如，請參閱<a href="https://docs.djangoproject.com/en/2.0/topics/http/sessions/">How to use sessions</a>）或設計我們的UI，以便無論是否支持cookie都無關緊要。</p>
</div>
