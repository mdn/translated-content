...
<div class="note">
<p><strong>備註：</strong> Client-side frameworks are often used to help speed up development of client-side code, but you can also choose to write all the code by hand; in fact, writing your code by hand can be quicker and more efficient if you only need a small, simple web site UI.</p>
...
<div class="note">
<p><strong>備註：</strong> Your imagination doesn't have to work hard to see the benefit of server-side code for efficient storage and delivery of information:</p>
...
<div class="note">
<p><strong>備註：</strong> <a href="https://maps.google.com/">Google Maps</a> saves your search and visit history. Frequently visited or frequently searched locations are highlighted more than others.</p>
...
<div class="note">
<p><strong>備註：</strong> Consider other real examples where access to content is controlled. For example, what can you see if you go to the online site for your bank? Log in to your account — what additional information can you see and modify? What information can you see that only the bank can change?</p>
</div>
...
<div class="note">
<p><strong>備註：</strong> If you're a Facebook user, go to your main feed and look at the stream of posts. Note how some of the posts are out of numerical order - in particular, posts with more "likes" are often higher on the list than more recent posts.</p>
