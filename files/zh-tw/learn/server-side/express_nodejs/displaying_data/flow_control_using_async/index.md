...
<div class="note">
<p><strong>備註：</strong> 在 JavaScript 中有許多其他方法，可以管理異步行為和流控制，包括相對較新的 JavaScript 語言功能，如 <a href="/en-US/docs/Mozilla/Add-ons/Techniques/Promises">Promises</a>。</p>
</div>
