...
<p>HTML 是一種<em>標記語言（markup language）</em>，而非一般熟知的程式設計語言；它會告訴瀏覽器該如何呈現你的網頁──單純簡易或是極其複雜的頁面都沒問題。HTML 包含了一系列的<strong>元素（{{Glossary("element", "elements")}}）</strong>，而元素包含了<strong>標籤（{{Glossary("tag", "tags")}}）</strong>與<strong>內容（content）</strong>，我們用標籤來控制內容的呈現樣貌，例如字體大小、斜體粗體、在文字或圖片設置超連結等。舉例來說，請看看以下這個句子：</p>
...
<p><img src="grumpy-cat-attribute-small.png"></p>
...
<p><img src="alt-text-example.png"></p>

<p>說明文字應該要好好呈現這個圖片的內容，上面這個例子就很差。好的例子像是：「Firefox  Logo：有一隻狐狸繞著地球」</p>

<div class="note">
<p><strong>備註：</strong> 你可以在 <a href="/zh-TW/docs/Web/Accessibility">MDN's Accessibility landing page</a> 查看無障礙頁面的資訊。</p>
</div>
...
<ol>
 ...
 <li>在&lt;a&gt; element 中加上href attribute這個屬性：
...
<p>網址的開頭使用<code>https://</code> 或 <code>http://</code> （網路文字傳送標準的不同）可能會給你不一樣的結果。因此，在寫連結時，請自己先點擊過，確認無誤。</p>

<p><strong>請試試在練習網頁加上一個超連結。</strong></p>

<div class="note">
<p><strong>備註：</strong> <code>href</code> 這個屬性名稱比較不直觀，不太好記，但它代表的是：<em><strong>h</strong>ypertext <strong>ref</strong>erence</em>的縮寫。</p>
</div>
