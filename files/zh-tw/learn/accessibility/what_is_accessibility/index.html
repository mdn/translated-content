...
<p>這篇文章給「到底什麼是無障礙網頁」的模塊，開了個好起頭：以下將包括我們該考慮什麼樣的用戶以及理由、不同的人要在 web 用什麼工具互動、還有如何令無障礙網頁成為 web 開發的一部分。</p>
...
<div class="note">
<p><strong>備註：</strong> 世界衛生組織的<a href="http://www.who.int/mediacentre/factsheets/fs352/zh/">殘疾與健康</a>指出「超過10億人，約佔世界人口的15%，患有某種形式的殘疾。」、且「1.1億至1.9億成年人有很嚴重的功能性障礙。」。</p>
</div>
...
<ul>
 <li>有些是商業軟體，例如 <a href="http://www.freedomscientific.com/Products/Blindness/JAWS">JAWS</a>（Windows）和 <a href="http://www.gwmicro.com/window-eyes/">Window Eyes</a>（Windows）。</li>
 <li>也有些是自由軟體，例如 <a href="http://www.nvaccess.org/">NVDA</a>（Windows）、<a href="http://www.chromevox.com/">ChromeVox</a>（Chrome、Windows、Mac OS X）、<a href="https://wiki.gnome.org/Projects/Orca">Orca</a>（Linux）</li>
 <li>還有些是系統內建，例如 <a href="http://www.apple.com/accessibility/osx/voiceover/">VoiceOver</a>（Mac OS X 與 iOS）、<a href="https://support.microsoft.com/en-us/help/22798/windows-10-narrator-get-started">Narrator</a>（Microsoft Windows）、<a href="http://www.chromevox.com/">ChromeVox</a>（Chrome OS）、<a href="https://play.google.com/store/apps/details?id=com.google.android.marvin.talkback">TalkBack</a>（Android）。</li>
</ul>
...
<div class="note">
<p><strong>備註：</strong> WebAIM 的<a href="http://webaim.org/articles/cognitive/">認知頁面</a>提供了更多資訊，值得一讀</p>
</div>
...
<div class="note">
<p><strong>備註：</strong> 我們的 <a href="/zh-TW/docs/Learn/Tools_and_testing/Cross_browser_testing/Accessibility">Handling common accessibility problems article</a> 包含了應該進行詳細測試的無障礙網頁規範。</p>
</div>
