...
<p>在本次評估中，您被賦予的任務內容將與本單元學習到的知識息息相關，並將其應用於創建一個能隨機生成傻故事的有趣應用程式。 祝玩的開心！</p>
...
<div class="note">
<p><strong>備註：</strong> 除了將檔案下載到自己的電腦中，您也能使用線上編輯程式的網頁，像是： <a href="http://jsbin.com/">JSBin</a> 或者<a href="https://thimble.mozilla.org/">Thimble</a> 來完成評估測驗。您可以將 HTML, CSS 以及 JavaScript 貼到前述的線上編輯器中。如果您使用的線上編輯器沒有獨立給 JavaScript 的編輯區，您也能透過<code>&lt;script&gt;</code>直接將JS語法放到 HTML檔案中。</p>
</div>
...
<p><img src="screen_shot_2018-09-19_at_10.01.38_am.png"></p>
...
<ul>
 ...
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Useful_string_methods">Useful string methods</a> <a href="/zh-TW/docs/Learn/JavaScript/First_steps/Useful_string_methods">有用的字串方法</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Arrays">Arrays</a> <a href="/zh-TW/docs/Learn/JavaScript/First_steps/Arrays">陣列</a></li>
 <li><a href="/zh-TW/docs/Learn/JavaScript/First_steps/Silly_story_generator">傻故事產生器</a></li>
</ul>
