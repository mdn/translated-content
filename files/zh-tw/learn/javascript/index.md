...
JavaScript 相較於 [HTML](/zh-TW/docs/Learn/HTML) 和 [CSS](/zh-TW/docs/Learn/CSS) 這些技術可以說比較困難。開始嘗試學習 JavaScript 之前，強烈建議你起碼先熟悉上述兩項技術，或者了解其它的更好。可以透過以下單元開始：

- [入門認識 Web](/zh-TW/docs/Learn/Getting_started_with_the_web)
- [HTML 簡介](/zh-TW/docs/Learn/HTML/Introduction_to_HTML)
- [CSS 簡介](/en-US/docs/Learn/CSS/First_steps)

若你之前有其他程式語言的撰寫經驗，也許會有幫助。

當熟悉 JavaScript 的基本知識之後，你應該進入一些更進階的主題，像是：

- 深入 JavaScript，像是 [JavaScript 指南](/zh-TW/docs/Web/JavaScript/Guide)
...
- [JavaScript 初探](/zh-TW/docs/Learn/JavaScript/First_steps)
...
- [JavaScript 構成元素](/zh-TW/docs/Learn/JavaScript/Building_blocks)
  - : 在這個單元，我們繼續含蓋 JavaScript 關鍵的基本元素，把焦點放在常見程式碼區塊的類型，像是條件陳述式、迴圈、函數以及事件。你已經在這個課程中看過這些東西，但只是匆匆一瞥，在這裡我們會明確地討論。
- [JavaScript 物件介紹](/zh-TW/docs/Learn/JavaScript/Objects)
...
- [非同步的 JavaScript](/zh-TW/docs/Learn/JavaScript/Asynchronous)
  - : 這個單元我們來討論非同步的 JavaScript，它為什麼重要，以及它能如何有效處理像是由伺服器抓取資料這種阻塞性操作（它會造成網頁停頓）。
- [用戶端的 web API](/zh-TW/docs/Learn/JavaScript/Client-side_web_APIs)
...
在你寫網頁時，可參閱〈[透過 JavaScript 解決常見的問題](/zh-TW/docs/Learn/JavaScript/Howto)〉內所提供的連結，解決許多常見問題。
...
- [Coding math](https://www.youtube.com/user/codingmath)
  - : 一系列優質的教學影片，教你需要了解哪些數學知識，來讓你成為有效率的程式設計師。（作者：[Keith Peters](https://twitter.com/bit101)）
