...
在開始閱讀本文之前，你應該已經對 HTML 與 CSS 有一定程度的認識。建議你先看過〈[HTML 介紹](/zh-TW/docs/Web/Guide/HTML/Introduction)〉以及〈[CSS 介紹](/zh-TW/docs/Learn/CSS/Introduction_to_CSS)〉，再開始了解 JavaScript。
...
- [適合初學者的 OO JaveScript](/zh-TW/docs/Learn/JavaScript/Objects/Object-oriented_JS)
...
- [JavaScript 中的繼承](/zh-TW/docs/Learn/JavaScript/Objects/Inheritance)
