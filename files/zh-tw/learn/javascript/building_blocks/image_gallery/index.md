...
<div class="note">
<p><strong>備註：</strong> 你也可以在某些網站進行評鑑，如 <a href="http://jsbin.com/">JSBin</a> 或<a href="https://thimble.mozilla.org/">Thimble</a>。你可以把這些HTML、CSS和JavaScript貼到這些線上編輯器中。如果你用了一個沒法把JavaScript/CSS分別放在不同面板的線上編輯器，你可以放心的把這些<code>&lt;script&gt;</code>/<code>&lt;style&gt;</code>元件改成inline貼進HTML網頁裡。</p>
</div>
