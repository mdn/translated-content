...
<p><br>
 <img alt="" src="https://mdn.mozillademos.org/files/13755/loop_js-02-farm.png"></p>
...
<p>{{ EmbedLiveSample('不用麻煩', '100%', 400) }}</p>
...
<pre class="brush: js">for (initializer; exit-condition; final-expression) {
  // code to run
}</pre>
...
<p>{{ EmbedLiveSample('不用麻煩', '100%', 60, "", "", "hide-codepen-jsfiddle") }}</p>

<div class="note">
<p><strong>備註：</strong> You can find this <a href="https://github.com/mdn/learning-area/blob/master/javascript/building-blocks/loops/basic-for.html">example code on GitHub</a> too (also <a href="http://mdn.github.io/learning-area/javascript/building-blocks/loops/basic-for.html">see it running live</a>).</p>
</div>
...
<div class="note">
<p><strong>備註：</strong> You can find this <a href="https://github.com/mdn/learning-area/blob/master/javascript/building-blocks/loops/basic-for-improved.html">example code on GitHub</a> too (also <a href="http://mdn.github.io/learning-area/javascript/building-blocks/loops/basic-for-improved.html">see it running live</a>).</p>
</div>

<div class="warning">
<p><strong>警告：</strong> With for — as with all loops — you must make sure that the initializer is iterated so that it eventually reaches the exit condition. If not, the loop will go on forever, and either the browser will force it to stop, or it will crash. This is called an <strong>infinite loop</strong>.</p>
</div>
...
<p>{{ EmbedLiveSample('中斷退出循環', '100%', 100) }}</p>
...
<div class="note">
<p><strong>備註：</strong> You can view the <a href="https://github.com/mdn/learning-area/blob/master/javascript/building-blocks/loops/contact-search.html">full source code on GitHub</a> too (also <a href="http://mdn.github.io/learning-area/javascript/building-blocks/loops/contact-search.html">see it running live</a>).</p>
</div>
...
<p>{{ EmbedLiveSample('Skipping iterations with continue', '100%', 100) }}</p>
...
<div class="note">
<p><strong>備註：</strong> You can view the <a href="https://github.com/mdn/learning-area/blob/master/javascript/building-blocks/loops/integer-squares.html">full source code on GitHub</a> too (also <a href="http://mdn.github.io/learning-area/javascript/building-blocks/loops/integer-squares.html">see it running live</a>).</p>
</div>
...
<p>{{ EmbedLiveSample('Active learning: Launch countdown', '100%', 880) }}</p>
...
<p>{{ EmbedLiveSample('Active learning: Filling in a guest list', '100%', 680) }}</p>
