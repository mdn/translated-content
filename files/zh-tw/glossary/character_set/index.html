...
---
<p><strong>字符集</strong>是能讓電腦知道如何解讀{{Glossary("character", "字符")}}的編碼系統。解讀範圍包括字母、數字、標點符號、還有空白等。</p>
...
<ul>
  <li>{{Interwiki("wikipedia", "字元編碼")}}（維基百科）</li>
  <li>{{Interwiki("wikipedia", "亂碼")}}（維基百科）</li>
 <li><a href="/zh-TW/docs/Glossary">術語表</a>
  <ul>
   <li>{{Glossary("character", "字符")}}</li>
