...
<p>我們指派一個 匿名函式 到 <code>變數</code> 中，然後在這個變數後面加上括弧 <code>()</code> 的方式來調用那個函式。</p>
...
<p>我們將 <code>sayHello()</code> 函式當成是變數傳遞到 <code>greeting()</code> 函式，這說明了我們將函式視為是一個  值 來使用它。</p>

<div class="note">
<p><strong>備註：</strong> 將函式作為參數傳遞到另一個函式時，被當作參數傳遞的那個函式我們稱之為回調函式 <strong><a href="/en-US/docs/Glossary/Callback_function">Callback function</a>。</strong> <em><code>sayHello</code> 就是一個回調函式。</em></p>
</div>
