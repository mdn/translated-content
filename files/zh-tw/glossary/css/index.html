...
---
<p><strong>階層式樣式表</strong>，或稱<strong>層疊樣式表</strong>（Cascading Style Sheets，<strong>CSS</strong>）是控制網頁的外觀，要在{{glossary("瀏覽器")}}裡面如何表現的陳述式語言。瀏覽器會套用 CSS 樣式宣告、以期被選中的元素能正確顯示之。樣式宣告包含了屬性（Property）與屬性值（Value）。它們會判斷網頁如何顯示。</p>
...
<ul>
 <li><a href="/zh-TW/docs/Learn/CSS">Learn CSS</a></li>
...
<ul>
 ...
 <li><a href="http://www.w3.org/Style/CSS/current-work">CSS 工作小組當前的工作進度</a></li>
</ul>

<h3 id="深入了解_CSS">深入了解 CSS</h3>

<ul>
 <li><a href="http://www.codecademy.com/en/tracks/web">codecademy.com 的課程</a></li>
</ul>
