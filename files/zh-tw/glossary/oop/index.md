...
{{glossary("JavaScript")}}為重度物件導向語言，其遵循 **prototype-based model**（[與 class-based 相對](/zh-TW/docs/Web/JavaScript/Guide/Inheritance_and_the_prototype_chain#class-based_vs._prototype-based_languages)）
