...
<div class="note">
<p><strong>備註：</strong> Firefox 54 以後可以使用這個功能。</p>
</div>
...
<p>套件現在可以在檢測器視窗透過 <a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/API/devtools.inspectedWindow/eval"><code>devtools.inspectedWindow.eval()</code></a> 或透過後端腳本傳送訊息來插入內容腳本兩種方式執行。你可以在<a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/Extending_the_developer_tools">擴充開發者工具</a>找到更多相關訊息。</p>
