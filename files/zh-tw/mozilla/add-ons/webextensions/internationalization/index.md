...
國際化套件能包含與其他套件相同的功能：[background scripts](/zh-TW/Add-ons/WebExtensions/Anatomy_of_a_WebExtension#Background_scripts)、[content scripts](/zh-TW/docs/Mozilla/Add-ons/WebExtensions/Content_scripts)……等。但它也擁有一些能允許在語言間切換的部份。目錄樹大概是這樣：
