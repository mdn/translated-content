...
---
<div>{{FirefoxSidebar}}</div><h3 id="Firefox_3_.E7.B6.B2.E7.AB.99.E9.96.8B.E7.99.BC.E9.A0.88.E7.9F.A5">Firefox 3 網站開發須知</h3>
<p> </p>
<dl>
 <dt>
 ...
 <dd>
  Firefox 3 支援 <a href="http://wiki.whatwg.org/wiki/FAQ#What_is_the_WHATWG.3F">WHATWG</a> 的 online/offline event，讓 applications/extensions 可以偵測目前是否有 active 的網際網路連線、目前是在線上還是斷線中。</dd>
 <dt>
  <a href="zh_tw/Firefox_3_supports_Cross-site_XMLHttpRequest">Cross-site XMLHttpRequest</a></dt>
 <dd>
  Firefox 3 支援了 <a href="http://www.w3.org/TR/access-control/">W3C Access Control</a> working draft，這讓你可以對其他網站作 XMLHttpRequests 以取得其他網站的資料，並加以管理，這讓你可以在自己建立的網站中，混入來自多個其他網站的內容。</dd>
 <dt>
  Alternate style sheet</dt>
 <dd>
  Firefox 3 支援 CSS object model alternate style sheet API。(見 <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=200930">Bug 200930</a>)</dd>
 <dt>
 ...
 <dd>
  Firefox 3 支援 HTML 5 新增給 DOM 的兩個屬性 <a href="/en/docs/DOM:document.activeElement">activeElement</a> 與 <a href="/en/docs/DOM:document.hasFocus">hasFocus</a>。</dd>
 <dt>
 ...
 <dd>
  Firefox 3 現在支援 Javascript 1.8。(見 <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=380236">Bug 380236</a>)</dd>
 <dt>
  EXSLT 的支援</dt>
 <dd>
...
<p><a href="/en/docs/Firefox_3_for_developers#For_web_site_and_application_developers">Firefox 3 for developers</a></p>
<h3 id=".E5.BB.B6.E4.BC.B8.E9.96.B1.E8.AE.80">延伸閱讀</h3>
<ul>
 <li><a href="/en/docs/Updating_extensions_for_Firefox_3">Updating extensions for Firefox 3</a></li>
 <li><a href="/en/docs/Updating_web_applications_for_Firefox_3">Updating web applications for Firefox 3</a></li>
 <li><a href="/en/docs/Firefox_2_for_developers">Firefox 2 for developers</a></li>
 <li><a href="/en/docs/Firefox_1.5_for_developers">Firefox 1.5 for developers</a></li>
</ul>
