...
- {{ xulelem("panel") }} elements can now be configured to [let the user drag them by clicking anywhere on their background](/zh-TW/XUL/PopupGuide/Panels#Letting_panels_be_dragged_by_grabbing_the_background) by using the new {{ XULAttr("backdrag") }} attribute.
