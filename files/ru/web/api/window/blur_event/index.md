...
Свойство **`onblur`** из {{domxref("GlobalEventHandlers")}} событий [`event handler`](/ru/docs/Web/API/Document_Object_Model/Events) для [`blur`](/ru/docs/Web/API/Element/blur_event) события. Оно доступно для{{domxref("Element")}}, {{domxref("Document")}} и {{domxref("Window")}}.
