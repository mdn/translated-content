...
Свойство `WindowEventHandlers.onafterprint` устанавливает и возвращает обработчик [`event handler`](/ru/docs/Web/API/Document_Object_Model/Events) события [`afterprint`](/ru/docs/Web/API/Window/afterprint_event) в текущем окне.
