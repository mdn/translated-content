...
Синхронный JavaScript останавливает парсинг DOM.

Существуют различные библиотеки, как общего назначения так и специализированные, предлагающие кросс-браузерные методы, позволяющие определить, что DOM готов к использованию.
