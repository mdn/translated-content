...
Fetch-запросы контролируются посредством директивы `connect-src` ([Content Security Policy](/ru/docs/Web/HTTP/Headers/Content-Security-Policy)), а не директивой извлекаемых ресурсов.
