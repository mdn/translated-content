...
> [!NOTE]
> Это свойство не влияет на запросы, отправленные на тот же домен.

> [!NOTE]
> Ответы с другого домена не могут установить куки для своего собственного домена в случае, если перед созданием запроса флаг `withCredentials` не установлен в `true`, несмотря на значение заголовков `Access-Control-`.
