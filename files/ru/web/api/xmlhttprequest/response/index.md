...
| Значение                    | Описание                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `""`                        | Пустая строка `responseType` обрабатывается так же, как `"text"`, тип по умолчанию (следовательно, как [`DOMString`](/en-US/docs/Web/API/DOMString).)                                                                                                                                                                                                                                                                                                                                                                      |
