...
- [Использование shadow DOM](/ru/docs/Web/API/Web_components/Using_shadow_DOM)
...
- [Обратные вызовы жизненного цикла](/ru/docs/Web/API/Web_components/Using_custom_elements#использование_lifecycle_callbacks)
...
- Псевдоклассы CSS
  - : Псевдоклассы, относящиеся конкретно к настраиваемым элементам:
    ...
    - {{cssxref(":host")}}: Выбирает теневой хост [теневого DOM](/ru/docs/Web/API/Web_components/Using_shadow_DOM), содержащего CSS, внутри которого он используется.
    - {{cssxref(":host()")}}: Выбирает теневой хост [теневой DOM](/ru/docs/Web/API/Web_components/Using_shadow_DOM), содержащий CSS, внутри которого он используется (так что вы можете выбрать пользовательский элемент изнутри его теневой DOM) - но только если селектор, указанный в качестве параметра функции, совпадает с теневым хостом.
    - {{cssxref(":host-context()")}}: Выбирает теневой хост [теневой DOM](/ru/docs/Web/API/Web_components/Using_shadow_DOM), содержащий CSS, внутри которого он используется (так что вы можете выбрать пользовательский элемент изнутри его теневой DOM) - но только если селектор, указанный в качестве параметра функции, совпадает с предком(-ами) теневого хоста в том месте, где он находится внутри иерархии DOM.
...
- Событие [`slotchange`](/ru/docs/Web/API/HTMLSlotElement/slotchange_event)
