...
> [!NOTE]
> Сервис-воркеры функционально похожи на прокси-серверы, они позволяют модифицировать запросы и ответы, замещая записями из собственного кеша, и многое другое.
...
> [!NOTE]
> При необходимости хранить данные в сервис-воркерах можно использовать [IndexedDB](/ru/docs/Web/API/IndexedDB_API).
