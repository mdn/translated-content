...
- {{domxref("Node.hasAttributes()")}}
  - : Возвращает {{jsxref("Boolean")}} показывающий, есть ли у элемента какие-либо атрибуты или нет.
- {{domxref("Node.hasChildNodes()")}}
  - : Возвращает {{jsxref("Boolean")}} показывающий, есть ли у элемента дочерние узлы или нет.
