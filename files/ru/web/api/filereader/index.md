...
- {{domxref("FileReader.onabort")}}
  - : Обработчик для события [`abort`](/ru/docs/Web/Events/abort). Это событие срабатывает каждый раз, когда прерывается операция чтения.
- {{domxref("FileReader.onerror")}}
  - : Обработчик для события [`error`](/ru/docs/Web/API/HTMLElement/error_event). Это событие срабатывает каждый раз, когда при чтении возникает ошибка.
- {{domxref("FileReader.onload")}}
  - : Обработчик для события [`load`](/ru/docs/Web/API/Window/load_event). Это событие срабатывает при каждом успешном завершении операции чтения.
- {{domxref("FileReader.onloadstart")}}
  - : Обработчик для события [`loadstart`](/ru/docs/Web/API/XMLHttpRequest/loadstart_event). Это событие срабатывает каждый раз, при запуске процесса чтения.
- {{domxref("FileReader.onloadend")}}
  - : Обработчик для события [`loadend`](/ru/docs/Web/Events/loadend). Это событие срабатывает каждый раз по окончании процесса чтения (не важно, успешном или нет).
- {{domxref("FileReader.onprogress")}}
  - : Обработчик для события [`progress`](/ru/docs/Web/Events/progress). Это событие срабатывает во время чтения данных из {{domxref("Blob")}}.
