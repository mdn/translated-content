...
Свойство **`HTMLAnchorElement.port`** — это строка, содержащая номер порта URL. Если у URL явно не указан номер порта, то значение этого свойства будет установлено в `''`.
