...
- _array_ - массив {{jsxref("Array")}} из объектов {{jsxref("ArrayBuffer")}}, {{jsxref("TypedArray")}}, {{domxref("Blob")}}, {{jsxref("String")}}, или смесь любых из подобных объектов, которая может быть размещена внутри {{domxref("Blob")}}. DOMStrings представлены в кодировке UTF-8.
