...
HTMLDocument - это абстрактный интерфейс [DOM](/ru/docs/DOM "en/DOM"), который обеспечивает доступ к специальным свойствам и методам, не представленным по умолчанию в регулярном (XML) документе.
