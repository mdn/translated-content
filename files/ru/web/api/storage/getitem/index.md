...
- _название Ключа_
  - : Является строкой {{jsxref("String")}}, содержащей название ключа, по которому получается значение из хранилища.

### Возвращаемые значения

Является строкой {{jsxref("String")}}, содержащей значение для соответствующего ключа. Если ключ не существует, то будет возвращено значение `null`.
