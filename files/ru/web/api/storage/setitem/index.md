...
- _название Ключа_
  - : Является строкой {{jsxref("String")}} содержащей название ключа, значение которого будет добавлено/обновлено.
- _значение Ключа_
  - : Является строкой {{jsxref("String")}} содержащей значение ключа, которое будет добавлено/обновлено.
