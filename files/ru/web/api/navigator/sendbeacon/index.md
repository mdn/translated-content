...
- `data` {{optional_inline}}
  - : Параметр `data` может содержать объект типа {{jsxref("TypedArray")}}, {{domxref("Blob")}}, {{jsxref("String")}}, или {{domxref("FormData")}}, который будет передан.
