...
- {{domxref("HTMLTrackElement.kind")}}
  - : Тип данных {{jsxref("String")}}, так как отображает значение HTML-атрибута [`kind`](/ru/docs/Web/HTML/Reference/Elements/track#kind). Показывает, как будет использоваться текстовый трек. Возможные значения: `subtitles`, `captions`, `descriptions`, `chapters`, `metadata` (субтитры, подписи, описания, главы или метаданные).
- {{domxref("HTMLTrackElement.src")}}
  - : Тип данных {{jsxref("String")}}, так как отображает значение HTML-атрибута [`src`](/ru/docs/Web/HTML/Reference/Elements/track#src). Указывает адрес файла текстового трека.
- {{domxref("HTMLTrackElement.srclang")}}
  - : Тип данных {{jsxref("String")}}, так как отображает значение HTML-атрибута [`srclang`](/ru/docs/Web/HTML/Reference/Elements/track#srclang). Указывает язык текстового трека.
