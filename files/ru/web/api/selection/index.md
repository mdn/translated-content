...
- `editing host`
  - : An editable element (e.g., an HTML element with [`contenteditable`](/ru/docs/Web/HTML/Global_attributes#contenteditable) set, or the HTML child of a document that has {{DOMxRef("Document.designMode", "designMode")}} enabled).
