...
<dl>
 ...
 <dd>Добавляет указанную {{domxref("DOMString")}} к строке <code>CharacterData.data</code>; после выполненияданные содержат объединённый(элемент) {{domxref("DOMString")}}.</dd>
