...
Это свойство предоставляет информацию только о том, какая кнопка или несколько кнопок были нажаты или отпущены для инициации события, и не имеет отношения к таким событиям как [`mouseenter`](/ru/docs/Web/Events/mouseenter), [`mouseleave`](/ru/docs/Web/API/Element/mouseleave_event), [`mouseover`](/ru/docs/Web/Events/mouseover), [`mouseout`](/ru/docs/Web/Events/mouseout) или [`mousemove`](/ru/docs/Web/Events/mousemove).
