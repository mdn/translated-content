...
Существует другое событие — {{domxref("Window/load_event", "load")}}, которое следует использовать только для обнаружения полностью загруженной страницы. Распространенной ошибкой является использование `load` вместо `DOMContentLoaded`.
