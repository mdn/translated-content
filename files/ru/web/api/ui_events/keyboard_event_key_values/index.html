...
<table class="standard-table">
 <thead>
  ...
  <tr>
   ...
   <td>Клавиша <kbd>Shift</kbd>. Изменяет нажатия клавиш, чтобы разрешить ввод букв в верхнем (или другом) регистре, а также для поддержки ввода знаков препинания и других специальных символов.</td>
  ...
  <tr>
   ...
   <td>Клавиша-модификатор <kbd>Symbol</kbd> (есть на некоторых виртуальных клавиатурах).</td>
   <td></td>
   <td></td>
   <td></td>
...
<p>[4] Firefox генерирует значение ключа <code>"OS</code>" для клавиш <kbd>Super</kbd> и <kbd>Hyper</kbd> вместо <code>"Super"</code> и <code>"Hyper"</code>.</p>

<p>[5] Chrome 67 и Firefox 63 теперь правильно интерпретируют правую клавишу <kbd>Alt</kbd> для раскладок клавиатуры, которые сопоставляют эту клавишу с <kbd>AltGr</kbd>. См. Дополнительные сведения об ошибке {{bug(900750)}} и <a href="https://bugs.chromium.org/p/chromium/issues/detail?id=25503">Chrome bug 25503</a> для подробных деталей.</p>
...
<table class="standard-table">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>Клавиша <kbd>Page Down</kbd> (или <kbd>PgDn</kbd>). Прокручивает вниз или отображает следующую страницу содержимого.</td>
  ...
  <tr>
   ...
   <td>Клавиша <kbd>Page Up</kbd> (или <kbd>PgUp</kbd>). Прокручивает вверх или отображает предыдущую страницу содержимого.</td>
...
<p>[1] <code>VK_HANGUL</code> и <code>VK_KANA</code> используют один и тот же числовой код клавиши в Windows, также как <code>VK_HANJA</code> и <code>VK_KANJI</code>.</p>
...
<p>[2] <code>VK_HANGUL</code> и <code>VK_KANA</code> используют один и тот же числовой код клавиши в Windows, также как <code>VK_HANJA</code> и <code>VK_KANJI</code>.</p>
...
<p>[4] Internet Explorer (проверено в версиях 9 и 11) возвращал <code>"Unidentified"</code> для клавиши <kbd>Zenkaku</kbd>; Firefox 36 и более ранние определяли эту клавишу как <code>"FullWidth"</code> на японских раскладках клавиатуры и <code>"Unidentified"</code> на всех остальных раскладках клавиатуры. Firefox 37 и выше, а также все версии Google Chrome, корректно возвращают <code>"Zenkaku"</code>.</p>
...
<table class="standard-table">
 <thead>
  ...
  <tr>
   ...
   <td>Кнопка <kbd>Home</kbd>. Возвращает пользователя на главный экран телефона (обычно это средство запуска приложений).</td>
   <td></td>
   <td></td>
   <td></td>
...
<h2 id="Мультимедийные_клавиши">Мультимедийные клавиши</h2>

<p>Мультимедийные клавиши - это дополнительные кнопки или клавиши для управления мультимедийными устройствами, которые есть на некоторых клавиатурах.</p>
...
<table class="standard-table">
 <thead>
  ...
  <tr>
   ...
   <td>Запускает, продолжает или увеличивает скорость быстрой перемотки мультимедиа вперёд.</td>
  ...
  <tr>
   ...
   <td>Останавливает текущую медиа-активность (такую как воспроизведение, запись, пауза, перемотка вперёд или назад). Не действует, если медиафайл уже остановлен.</td>
...
<p>[2] До Firefox 37, Firefox генерировал значение <code>"FastFwd"</code> на некоторых платформах и <code>"Unidentified"</code> на других вместо <code>"MediaFastForward"</code>.</p>

<h2 id="Клавиши_управления_звуком">Клавиши управления звуком</h2>
...
<table class="standard-table">
 <thead>
  ...
  <tr>
   ...
   <td>Уменьшает степень усиления басов или циклически перемещается вниз по набору режимов или состояний усиления басов.</td>
  ...
  <tr>
   ...
   <td>Увеличивает степень усиления басов или циклически перемещается вверх по набору режимов или состояний усиления басов.</td>
...
<p>[1] Internet Explorer, Edge, и Firefox (48 и более ранние) используют <code>"VolumeUp"</code>, <code>"VolumeDown"</code>, и <code>"VolumeMute"</code> вместо <code>"AudioVolumeUp"</code>, <code>"AudioVolumeDown"</code>, и <code>"AudioVolumeMute"</code>. В Firefox 49 они были обновлены в соответствии с последней спецификацией. Старые имена все ещё используются в <a href="/en-US/docs/Mozilla/B2G_OS">Boot to Gecko</a>.</p>

<h2 id="Клавиши_управления_ТВ">Клавиши управления ТВ</h2>

<p>Эти ключевые значения представляют собой кнопки или клавиши на телевизионных устройствах, компьютерах или телефонах с поддержкой телевидения.</p>
...
<table class="standard-table">
 <thead>
  ...
  <tr>
   ...
   <td>Уменьшает громкость микширования аудиоописаний; уменьшает громкость аудиоописаний относительно звука программы.</td>
   <td></td>
   <td></td>
   <td></td>
  ...
  <tr>
   ...
   <td>Увеличивает громкость микширования аудиоописаний; увеличивает громкость аудиоописаний относительно звука программы.</td>
   <td></td>
   <td></td>
   <td></td>
  ...
  <tr>
   ...
   <td>Отображает или скрывает мультимедийное содержимое, доступное для воспроизведения (это может быть руководство по каналам, показывающее программы, транслируемые в данный момент, или список мультимедийных файлов для воспроизведения).</td>
   <td></td>
   <td></td>
   <td></td>
  ...
  <tr>
   ...
   <td>Выбирает услугу аналогового наземного телевидения (аналоговый кабельный или антенный приём).</td>
   <td></td>
   <td></td>
   <td></td>
...
<h2 id="Клавиши_медиа-контроллера">Клавиши медиа-контроллера</h2>

<p>Поскольку современные пульты дистанционного управления для мультимедийных устройств часто включают кнопки, помимо базовых элементов управления, описанных в другом месте в этом документе, ключевые значения определены для широкого набора этих дополнительных кнопок.</p>

<p>Приведённые ниже значения частично получены из ряда технических характеристик бытовой электроники:</p>
...
<div class="note">
<p><strong>Примечание:</strong> Пульт дистанционного управления обычно содержит кнопки, значения которых уже определены где-то ещё, например <em>Мультимедийные клавиши</em> или <em>Клавиши управления звуком</em>. Значения этих кнопок будут соответствовать тому, что задокументировано в этих таблицах.</p>
</div>
...
<table class="standard-table">
 <thead>
  ...
  <tr>
   ...
   <td>Изменяет источник сигнала на внешнем аудио / видео ресивере (AVR).</td>
   <td></td>
   <td></td>
   <td></td>
  ...
  <tr>
   ...
   <td>Универсальная функциональная клавиша мультимедиа красного цвета. Она имеет индекс 0 среди цветных клавиш.</td>
  ...
  <tr>
   ...
   <td>Универсальная функциональная клавиша мультимедиа зелёного цвета. Она имеет индекс 1 среди цветных клавиш.</td>
  ...
  <tr>
   ...
   <td>Универсальная функциональная клавиша мультимедиа жёлтого цвета. Она имеет индекс 2 среди цветных клавиш.</td>
  ...
  <tr>
   ...
   <td>Универсальная функциональная клавиша мультимедиа синего цвет. Она имеет индекс 3 среди цветных клавиш.</td>
  ...
  <tr>
   ...
   <td>Универсальная функциональная клавиша мультимедиа серого цвета. Она имеет индекс 4 среди цветных клавиш.</td>
  ...
  <tr>
   ...
   <td>Универсальная функциональная клавиша мультимедиа коричневого цвета. Она имеет индекс 5 среди цветных клавиш.</td>
  ...
  <tr>
   <td><code>"DVR"</code></td>
   <td>Переключает источник входного сигнала на цифровой видеорегистратор (DVR).</td>
   <td></td>
   <td></td>
   <td></td>
  ...
  <tr>
   ...
   <td>Выбирает (вызывает) программу или содержимое, хранящееся в первом слоте списка избранного.</td>
  ...
  <tr>
   ...
   <td>Выбирает (вызывает) программу или содержимое, хранящееся во втором слоте списка избранного.</td>
  ...
  <tr>
   ...
   <td>Выбирает (вызывает) программу или содержимое, хранящееся в третьем слоте списка избранного.</td>
  ...
  <tr>
   ...
   <td>Выбирает (вызывает) программу или содержимое, хранящееся в четвёртом слоте списка избранного.</td>
  ...
  <tr>
   ...
   <td>Сохраняет текущую программу или контент в первый слот списка избранного.</td>
  ...
  <tr>
   ...
   <td>Сохраняет текущую программу или контент во второй слот списка избранного.</td>
  ...
  <tr>
   ...
   <td>Сохраняет текущую программу или контент в третий слот списка избранного.</td>
  ...
  <tr>
   ...
   <td>Сохраняет текущую программу или контент в четвёртый слот списка избранного.</td>
  ...
  <tr>
   ...
   <td>Переключает отображение программы или содержимого, содержащего руководство.</td>
  ...
  <tr>
   ...
   <td>Если руководство отображается в данный момент, эта кнопка указывает руководству отобразить содержимое на следующий день.</td>
  ...
  <tr>
   ...
   <td>Если руководство отображается в данный момент, эта кнопка указывает руководству отобразить содержимое предыдущего дня.</td>
  ...
  <tr>
   ...
   <td>Переключает отображение информации о текущем выбранном содержимом, программе или медиа.</td>
  ...
  <tr>
   ...
   <td>Указывает устройству выполнить мгновенное перевоспроизведение (обычно это некоторая форма возврата на короткий промежуток времени с последующим воспроизведением, возможно, но обычно не в замедленном режиме).</td>
  ...
  <tr>
   ...
   <td>Открывает содержимое, связанное с текущей программой, если это возможно и доступно.</td>
  ...
  <tr>
   ...
   <td>Переключает отображение списка доступного в данный момент live-содержимого или программ.</td>
  ...
  <tr>
   ...
   <td>Представляет список мультимедийных приложений, таких как программы просмотра фотографий, аудио- и видеоплееры, а также игры. [1]</td>
  ...
  <tr>
   ...
   <td>Возврат к последнему просмотренному содержимому, программе или другому медиафайлу.</td>
  ...
  <tr>
   ...
   <td>Открывает пользовательский интерфейс для выбора содержимого или программ по запросу для просмотра.</td>
  ...
  <tr>
   ...
   <td>Запускает процесс сопряжения пульта дистанционного управления с управляемым устройством.</td>
   <td></td>
   <td></td>
   <td></td>
  ...
  <tr>
   ...
   <td>Кнопка для управления перемещением изображения «картинка в картинке».</td>
  ...
  <tr>
   ...
   <td>Включает и выключает отображение изображения в «картинка в картинке».</td>
  ...
  <tr>
   ...
   <td>Включает и выключает случайные медиафайлы (также известно как «режим случайного воспроизведения»).</td>
  ...
  <tr>
   ...
   <td>Код, отправляемый при низком заряде батареи пульта ДУ. Это вообще не соответствует физической кнопке/клавише.</td>
  ...
  <tr>
   ...
   <td>Включает и выключает режим пропуска радиочастотного (RF) входа. В режиме пропуска РЧ входной сигнал передаётся непосредственно на выход РЧ без какой-либо обработки или фильтрации.</td>
  ...
  <tr>
   ...
   <td>Включает и выключает режим сканирования каналов. Это режим, который автоматически переключает каналы, пока пользователь не остановит сканирование.</td>
  ...
  <tr>
   ...
   <td>Переключение между источниками сигнала на внешней приставке (STB).</td>
   <td></td>
   <td></td>
   <td></td>
...
<h2 id="Клавиши_распознавания_речи">Клавиши распознавания речи</h2>

<p>Эти специальные мультимедийные клавиши используются для управления функциями распознавания речи.</p>
...
<table class="standard-table">
 <thead>
  ...
  <tr>
   ...
   <td>Представляет список возможных исправлений неверно определённого слова.</td>
  ...
  <tr>
   ...
   <td>Переключение между режимом диктовки и режимом команд/управления. Это позволяет механизму обработки речи знать, интерпретировать ли произносимые слова как вводимый текст или как команды.</td>
...
<p>На некоторых клавиатурах есть специальные клавиши для запуска определённых распространённых приложений или переключения на них. Значения клавиш для них перечислены здесь.</p>
...
<p>[1] Internet Explorer, Edge, и Firefox (36 и ранее) используют <code>"SelectMedia"</code> вместо <code>"LaunchMediaPlayer"</code>. Firefox 37 и Firefox 48 используют <code>"MediaSelect"</code>. Firefox 49 был обновлён в соответствии с последней спецификацией и теперь возвращает <code>"LaunchMediaPlayer"</code>.</p>
...
<p>На некоторых клавиатурах есть специальные клавиши для управления веб-браузерами. Это следующие клавиши.</p>
...
<table class="standard-table">
 <thead>
  ...
  <tr>
   ...
   <td>Переход к предыдущему содержимому или странице в истории текущего веб-представления.</td>
  ...
  <tr>
   ...
   <td>Переход к следующему содержимому или странице в истории текущего веб-представления.</td>
...
<div class="note">
<p>Клавиша <kbd>10</kbd>, если она присутствует, генерирует события со значением ключа <code>"0"</code>.</p>
</div>
...
<table class="standard-table">
 <thead>
  ...
  <tr>
   ...
   <td>
    <p>Клавиша десятичной точки (обычно <kbd>.</kbd> или <kbd>,</kbd> в зависимости от региона).</p>

    <p>В новых браузерах это значение должно быть просто символом, сгенерированным клавишей десятичной точки (одним из этих двух символов). [1]</p>
   </td>
  ...
  <tr>
   ...
   <td>Клавиша <kbd>11</kbd>  встречается на некоторых цифровых мультимедиа клавиатурах.</td>
   <td></td>
   <td></td>
   <td></td>
   <td></td>
  ...
  <tr>
   ...
   <td>Клавиша <kbd>12</kbd> встречается на некоторых цифровых мультимедиа клавиатурах..</td>
   <td></td>
   <td></td>
   <td></td>
   <td></td>
...
<p>[1] В то время как старые браузеры использовали такие слова, как «Добавить», «Десятичное число», «Умножить» и т. д., современные браузеры идентифицируют их по фактическому символу («+», «.», «*» и т. д.).</p>
