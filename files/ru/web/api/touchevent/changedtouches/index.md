...
В этом фрагменте кода обработчик события [`touchmove`](/ru/docs/Web/Events/touchmove) выполняет перебор списка `changedTouches` и выводит в консоль идентификатор каждой точки касания, где произошло изменение с последнего события.
