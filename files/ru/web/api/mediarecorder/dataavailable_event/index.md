...
> [!NOTE]
> Медиаданные, содержащиеся в объекте типа {{domxref("Blob")}} доступны в свойстве `data` , возвращаемого в параметре объекта события [`dataavailable`](/ru/docs/Web/Events/dataavailable).
