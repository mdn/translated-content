...
Таким образом переключение стилей элемента `display: none` приводит к прерыванию анимации. In browsers that support [`animationcancel`](/ru/docs/Web/Events/animationcancel), the event is fired and this handler is called.
...
- The [`animationcancel`](/ru/docs/Web/Events/animationcancel) event this event handler is triggered by.
- {{domxref("AnimationEvent")}}
