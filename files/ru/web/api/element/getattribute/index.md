...
По [соображениям безопасности](/ru/docs/Web/HTTP/Guides/CSP) получение криптографических одноразовых номеров («nonce») из источников, отличных от скриптов (таких как CSS селекторы и вызовы `.getAttribute("nonce")`), недоступно.
