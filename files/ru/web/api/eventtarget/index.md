...
Многие источники событий (включая элементы, документ и окно) также поддерживают установку [обработчиков событий](/ru/docs/Web/API/Document_Object_Model/Events) с помощью on`...` свойств и атрибутов.
