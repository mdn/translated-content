...
Согласно [данным о совместимости с браузерами](/Web/API/Touch_events#Browser_compatibility), поддержка событий касания среди мобильных браузеров относительно неплохая. Десктопные браузеры немного отстают, хотя над этим уже ведётся работа.
