...
- {{domxref("StyleSheet.disabled")}}
  - : Свойство имеет тип {{jsxref("Boolean")}}, принимающий одно из двух значений и определяющий, применяется или нет текущая таблица стилей.
- {{domxref("StyleSheet.href")}} {{readonlyInline}}
  - : Свойство возвращает строку {{jsxref("String")}}, указывающую расположение таблицы стилей. Свойство не изменяется.
...
- {{domxref("StyleSheet.title")}} {{readonlyInline}}
  - : Свойство возвращает строку {{jsxref("String")}}, указывающую на заголовок текущей таблицы стилей. Свойство не изменяется.
- {{domxref("StyleSheet.type")}}{{readonlyInline}}
  - : Свойство возвращает строку {{jsxref("String")}}, указывающую на язык, используемый таблицей стилей. Свойство не изменяется.
