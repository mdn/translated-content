...
- {{domxref("HTMLTimeElement.dateTime")}}
  - : Это {{jsxref("String")}} который отражает [`datetime`](/ru/docs/Web/HTML/Reference/Elements/time#datetime) HTML атрибут, содержащий понятный для машин формат даты и времени.
