...
<dl>
 ...
 <dd>Returns <code style="font-style: normal; line-height: 1.5;">true</code> if the element's child controls satisfy their validation constraints. When <code style="font-style: normal; line-height: 1.5;">false</code> is returned, cancelable <code><a href="https://developer.mozilla.org/en-US/docs/Web/Events/invalid" title="/en-US/docs/Web/Events/invalid">invalid</a></code> events are fired for each invalid child and validation problems are reported to the user.</dd>
</dl>
