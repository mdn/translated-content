...
<table class="standard-table">
  <tbody>
    ...
    <tr>
      ...
      <td>
        Reflects the [`accept`](/ru/docs/Web/HTML/Element/input#accept) HTML
        attribute, containing comma-separated list of file types accepted by the
        server when [`type`](/ru/docs/Web/HTML/Element/input#type) is
        <code>file</code>.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`alt`](/ru/docs/Web/HTML/Element/input#alt) HTML
        attribute, containing alternative text to use when
        [`type`](/ru/docs/Web/HTML/Element/input#type) is <code>image.</code>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`autocomplete`](/ru/docs/Web/HTML/Element/input#autocomplete)
        ...
        [`type`](/ru/docs/Web/HTML/Element/input#type) attribute is hidden,
    ...
    <tr>
      ...
      <td>
        Reflects the [`autofocus`](/ru/docs/Web/HTML/Element/input#autofocus) HTML
        ...
        [`autofocus`](/ru/docs/Web/HTML/Element/input#autofocus) attribute. It cannot be
        applied if the [`type`](/ru/docs/Web/HTML/Element/input#type) attribute is
    ...
    <tr>
      ...
      <td>
        ...
        [`type`](/ru/docs/Web/HTML/Element/input#type) is <code>checkbox</code> or
        <code>radio</code>.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>{{domxref("Boolean")}}</td>
      <td>
        Reflects the [`disabled`](/ru/docs/Web/HTML/Element/input#disabled) HTML
        ...
        [`readOnly`](/ru/docs/Web/HTML/Element/input#readOnly)
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        ...
        <ul>
          <li>
            this can be the
            [`id`](/ru/docs/Web/HTML/Element/form#id) attribute of any
    ...
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`formaction`](/ru/docs/Web/HTML/Element/input#formaction)
        ...
        overrides the [`action`](/ru/docs/Web/HTML/Element/form#action) attribute
    ...
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`formenctype`](/ru/docs/Web/HTML/Element/input#formenctype)
        ...
        [`enctype`](/ru/docs/Web/HTML/Element/form#enctype) attribute of the
    ...
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`formmethod`](/ru/docs/Web/HTML/Element/input#formmethod)
        ...
        [`method`](/ru/docs/Web/HTML/Element/form#method) attribute of the
        {{ HTMLElement("form") }} element that owns this element.
      </td>
    </tr>
    <tr>
      ...
      <td>
        Reflects the
        [`formnovalidate`](/ru/docs/Web/HTML/Element/input#formnovalidate) HTML
        attribute, indicating that the form is not to be validated when it is
        submitted. If specified, this attribute overrides the
        [`novalidate`](/ru/docs/Web/HTML/Element/form#novalidate) attribute of the
        {{ HTMLElement("form") }} element that owns this element.
      </td>
    </tr>
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`formtarget`](/ru/docs/Web/HTML/Element/input#formtarget)
        ...
        [`target`](/ru/docs/Web/HTML/Element/form#target) attribute of the
        {{ HTMLElement("form") }} element that owns this element.
      </td>
    </tr>
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`height`](/ru/docs/Web/HTML/Element/input#height) HTML
        attribute, which defines the height of the image displayed for the
        button, if the value of [`type`](/ru/docs/Web/HTML/Element/input#type) is
        image.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        ...
        [`type`](/ru/docs/Web/HTML/Element/input#type) attribute's value is
    ...
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`max`](/ru/docs/Web/HTML/Element/input#max) HTML
    ...
    <tr>
      ...
      <td>
        Reflects the [`maxlength`](/ru/docs/Web/HTML/Element/input#maxlength) HTML
    ...
    <tr>
      ...
      <td></td>
      <td>
        Reflects the [`multiple`](/ru/docs/Web/HTML/Element/input#multiple) HTML
    ...
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`name`](/ru/docs/Web/HTML/Element/input#name) HTML
    ...
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`pattern`](/ru/docs/Web/HTML/Element/input#pattern) HTML
        ...
        subset. Use the [`title`](/ru/docs/Web/HTML/Element/input#title) attribute
        to describe the pattern to help the user. This attribute applies when
        the value of the [`type`](/ru/docs/Web/HTML/Element/input#type) attribute
    ...
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`placeholder`](/ru/docs/Web/HTML/Element/input#placeholder)
        ...
        [`type`](/ru/docs/Web/HTML/Element/input#type) attribute is text, search,
    ...
    <tr>
      ...
      <td>
        <p>
          Reflects the [`readonly`](/ru/docs/Web/HTML/Element/input#readonly) HTML
          attribute, indicating that the user cannot modify the value of the
          control.<br />This is ignored if the
          value of the [`type`](/ru/docs/Web/HTML/Element/input#type) attribute is
    ...
    <tr>
      ...
      <td>{{domxref("Boolean")}}</td>
      <td>
        Reflects the [`required`](/ru/docs/Web/HTML/Element/input#required) HTML
    ...
    <tr>
      ...
      <td><code>unsigned long</code></td>
      <td>
        Reflects the [`size`](/ru/docs/Web/HTML/Element/input#size) HTML
        attribute, containing size of the control. This value is in pixels
        unless the value of [`type`](/ru/docs/Web/HTML/Element/input#type) is text
        or password, in which case, it is an integer number of characters.
        Applies only when
        [`type`](/ru/docs/Web/HTML/Element/input#type) is set to text, search,
    ...
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`src`](/ru/docs/Web/HTML/Element/input#src) HTML
        attribute, which specifies a URI for the location of an image to display
        on the graphical submit button, if the value of
        [`type`](/ru/docs/Web/HTML/Element/input#type) is image; otherwise it is
        ignored.
      </td>
    </tr>
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`step`](/ru/docs/Web/HTML/Element/input#step) HTML
        attribute, which works with<strong
        > </strong>[`min`](/ru/docs/Web/HTML/Element/input#min) and
        [`max`](/ru/docs/Web/HTML/Element/input#max) to limit the increments at
    ...
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`type`](/ru/docs/Web/HTML/Element/input#type) HTML
        attribute, indicating the type of control to display. See
        [`type`](/ru/docs/Web/HTML/Element/input#type) attribute of
    ...
    <tr>
      ...
      <td>
        ...
        ([`willValidate`](/ru/docs/Web/HTML/Element/input#willValidate) is
    ...
    <tr>
      ...
      <td>{{domxref("DOMString")}}</td>
      <td>
        Reflects the [`width`](/ru/docs/Web/HTML/Element/input#width) HTML
...
<table class="standard-table">
  <tbody>
    ...
    <tr>
      ...
      <td><code>void</code></td>
      <td>
        Decrements the [`value`](/ru/docs/Web/HTML/Element/input#value) by
        ([`step`](/ru/docs/Web/HTML/Element/input#step) * <code>n</code>), where
        ...
        <ul>
          <li>
            ...
            [`type`](/ru/docs/Web/HTML/Element/input#type) value.
          </li>
          <li>
            if the element has no [`step`](/ru/docs/Web/HTML/Element/input#step)
            value.
          </li>
          <li>
            if the [`value`](/ru/docs/Web/HTML/Element/input#value) cannot be
            converted to a number.
          </li>
          <li>
            if the resulting value is above the
            [`max`](/ru/docs/Web/HTML/Element/input#max) or below the
            [`min`](/ru/docs/Web/HTML/Element/input#min).
          </li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td><code>void</code></td>
      <td>
        Increments the [`value`](/ru/docs/Web/HTML/Element/input#value) by
        ([`step`](/ru/docs/Web/HTML/Element/input#step) * <code>n</code>), where
        <code>n</code> defaults to <code>1</code> if not specified. Throws an
        <code>INVALID_STATE_ERR</code> exception:
        <ul>
