...
- Документ должен соответствовать семантическим правилам языка (которые обычно заданны в схеме XML или DTD (англ. **[Document Type Definition](/ru/docs/Glossary/Doctype)**)).
...
Не смотря на то, что по умолчанию создано всего пять сущностей, вы можете добавить в документ свои сущности используя [Document Type Definition](/ru/docs/Glossary/Doctype). Например, создать новую `&warning;` сущность, можно так:
...
Есть также много других мощных методов отображения XML, например, [XSLT](/ru/docs/Web/XML/XSLT)(англ. **Extensible Stylesheet Language Transformations**), который может использоваться для преобразование XML в другие языки такие, как HTML. Это делает XML очень универсальным.
...
Статья [Using XML](https://www.alistapart.com/articles/usingxml/) - отличный ресурс с большим количеством информации о создании своего языка на основе XML.
