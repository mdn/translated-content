...
> [!NOTE]
> На самом деле существует интерфейс {{domxref ("HTMLDocument")}}, но это не обязательно отдельный тип. В некоторых браузерах это так, а в других это просто псевдоним для интерфейса `Document`.
