...
l10n:
  sourceCommit: cd025e8fa8b0af302a95657d01340971cf590cd7
---
...
Любой элемент, который может получать фокусировку с клавиатуры, должен иметь видимый стиль, указывающий, когда элемент находится в фокусе. Вы можете сделать это с помощью псевдоклассов CSS {{CSSxRef(":focus")}} и {{CSSxRef(":focus-visible")}}.
