...
Если страница написана в [XHTML](/ru/docs/Glossary/XHTML) формате с указанием типа MIME `application/xhtml+xml` в заголовке `Content-Type`, то не нужно указывать DOCTYPE для активации стандартного режима, так как подобные документы всегда отображаются в стандартном режиме. Важно иметь в виду, что Internet Explorer 8 вместо контента такой страницы отображает [диалоговое окно загрузки](/ru/docs/Glossary/XHTML#support) как для неизвестного формата, поскольку поддержка XHTML реализована в Internet Explorer, начиная с 9 версии.
