...
- {{htmlattrdef("align")}} {{obsolete_inline}}
  ...
  > **Примечание:** **Примечание к использованию:** Не используйте этот атрибут, так как он устарел. Элемент {{HTMLElement("caption")}} должен быть стилизован с использованием свойств [CSS](/ru/docs/CSS) {{cssxref("caption-side")}} и{{cssxref("text-align")}}.
