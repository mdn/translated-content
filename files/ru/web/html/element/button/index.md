...
| [Категории контента](/ru/docs/HTML/Content_categories/) | [Общий поток](/ru/docs/Web/HTML/Content_categories#flow_content), [текстовый контент](/ru/docs/Web/HTML/Content_categories#phrasing_content), [интерактивный контент](/ru/docs/Web/HTML/Content_categories#interactive_content), [listed](/ru/docs/Web/HTML/Content_categories#form_listed), [labelable](/ru/docs/Web/HTML/Content_categories#form_labelable), и [submittable](/ru/docs/Web/HTML/Content_categories#form_submittable) [form-associated](/ru/docs/Web/HTML/Content_categories#form-associated_) элемент, очевидный контент.                                                                                                                                                                                           |
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
