...
<div class="note">
<p><strong>Примечание: </strong>Если приведённый выше пример не работает, см. <a href="#browser_compatibility">Browser compatibility</a> , чтобы определить поддерживает ли вообще ваш браузер эту функцию. </p>
</div>
