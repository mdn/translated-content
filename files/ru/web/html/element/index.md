...
> **Примечание:** **Замечание:** Эти элементы определены в {{Glossary("W3C","World Wide Web Consortium")}} (W3C) [Web Components collection of specifications](http://www.w3.org/TR/components-intro/) скорее, чем в HTML спецификации. К тому же, спецификация Веб-компонентов не завершена и является темой для обсуждений.
