...
> **Примечание:** `<head>` в основном содержит информацию для машинной обработки, а не для восприятия человеком. Информацию в человекочитаемом виде, такую как заголовки верхнего уровня и список авторов, смотрите в элементе {{HTMLElement("header")}}.
