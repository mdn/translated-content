...
| Разрешённые родительские элементы                                | Элемент {{HTMLElement("html")}} (`<head>` является его первым дочерним элементом).                                                                                                                                                                                                                                                                                                                                                   |
