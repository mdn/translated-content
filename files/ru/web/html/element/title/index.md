...
| ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| Разрешённое содержимое                                           | Текст, который не является межэлементным {{glossary("Whitespace", "разделителем")}}.                                 |
...
| Разрешённые родительские элементы                                | Элемент {{ HTMLElement("head") }}, который не содержит других элементов {{ HTMLElement("title") }}.                               |
