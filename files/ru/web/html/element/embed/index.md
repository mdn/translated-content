...
Имейте в виду, что большинство современных браузеров удалили поддержку встраивания плагинов посчитав технологию устаревшей, так что использование `<embed>`, как правило, не рекомендуется, если вы хотите, чтобы ваш сайт одинаково работал у всех пользователей.
