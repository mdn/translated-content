...
<dl>
 ...
 <dd><p>Указывает на относительную важность ресурса. Приоритетные подсказки передаются используя значения:</p>
 ...
 <dd>Этот атрибут указывает медиа, который применяет связываемый ресурс. Его значение должно быть типом медиа или <a href="/en-US/docs/Web/CSS/Media_queries">медиавыражением</a>. Этот атрибут, в основном, полезен при связывании с внешними таблицами стилей — он позволяет пользовательскому агенту выбрать наиболее подходящее устройство для запуска.
 <div class="blockIndicator note">
 ...
 <ul>
  ...
  <li>Браузеры, не поддерживающие <a href="/en-US/docs/Web/CSS/Media_queries">медиавыражения</a>, могут не распознать соответствующую ссылку; не забудьте установить резервные ссылки, ограниченные набором медиавыражений, определённым в HTML 4.</li>
 </ul>
 </div>
 </dd>
...
<h3 id="Условная_загрузка_ресурсов_с_медиавыражениями">Условная загрузка ресурсов с медиавыражениями</h3>
