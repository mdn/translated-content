...
- `accept`
  - : Список типов содержимого, разделённых запятой, которые принимает сервер.
    > [!NOTE]
    > Этот атрибут был удалён в HTML5 и его не следует больше использовать. Взамен, используйте [`accept`](/ru/docs/Web/HTML/Element/input#accept) атрибут заданного {{HTMLElement("input")}} элемента.
- `accept-charset`
