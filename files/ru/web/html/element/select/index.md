...
| [Категории содержимого](/ru/docs/Web/HTML/Content_categories) | [Основной поток](/ru/docs/Web/Guide/HTML/Content_categories#Основной_поток), [текстовый контент](/ru/docs/Web/Guide/HTML/Content_categories#Phrasing_content), [интерактивный контент](/ru/docs/Web/HTML/Content_categories#Interactive_content), [списочный](/ru/docs/Web/HTML/Content_categories#Form_listed), [labelable](/ru/docs/Web/HTML/Content_categories#Form_labelable), [сбрасываемый](/ru/docs/Web/HTML/Content_categories#Form_resettable), и [submittable](/ru/docs/Web/HTML/Content_categories#Form_submittable) [form-associated](/ru/docs/Web/HTML/Content_categories#Form-associated_) element |
| --------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
