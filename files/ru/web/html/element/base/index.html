...
<dl>
 ...
 <dd>Значение атрибута определяет имя контекста, которое применяется для ссылок (<code>&lt;a&gt;</code>) и форм (<code>&lt;form&gt;</code>). Они нужны <em>для отображения контекста</em> (пример: вкладка, окно или встроенный фрейм). Следующие ключевые слова имеют специальные значения:
 <ul>
