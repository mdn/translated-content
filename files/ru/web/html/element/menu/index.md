...
| Разрешённые роли ARIA                                      | {{ARIARole("directory")}}, {{ARIARole("group")}}, [`listbox`](/en-US/docs/Web/Accessibility/ARIA/Roles/listbox_role), {{ARIARole("menu")}}, {{ARIARole("menubar")}}, {{ARIARole("none")}}, {{ARIARole("presentation")}}, {{ARIARole("radiogroup")}}, {{ARIARole("tablist")}}, {{ARIARole("toolbar")}} или {{ARIARole("tree")}}                                                                                                                                                                                                                                                                                              |
