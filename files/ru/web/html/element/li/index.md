...
| Разрешённые ARIA-роли                                            | {{ARIARole("menuitem")}}, {{ARIARole("menuitemcheckbox")}}, {{ARIARole("menuitemradio")}}, {{ARIARole("option")}}, {{ARIARole("presentation")}}, {{ARIARole("radio")}}, {{ARIARole("separator")}}, {{ARIARole("tab")}}, {{ARIARole("treeitem")}} |
...
- {{htmlattrdef("type")}} {{Deprecated_inline}}
  - : Этот символьный атрибут указывает на тип нумерации:\* `a`: строчные буквы
    - `A`: заглавные буквы
    - `i`: строчные римские цифры
    - `I`: заглавные римские цифры
    - `1`: цифрыЭтот атрибут переопределяет тип унаследованный от родительского элемента {{HTMLElement("ol")}} или любого другого.> **Примечание:** **Примечание к использованию:** Этот атрибут был убран: используйте CSS-свойство {{cssxref("list-style-type")}} взамен.
