...
| [Категории контента](/ru/docs/Web/HTML/Content_categories) | [Потоковый контент](/ru/docs/Web/HTML/Content_categories#потоковый_контент), [фразовый контент](/ru/docs/Web/HTML/Content_categories#phrasing_content), [встроенный контент](/ru/docs/Web/HTML/Content_categories#встроенный_контент), [явный контент](/ru/docs/Web/HTML/Content_categories#явный_контент). Если элемент имеет атрибут `usemap`, он так же принадлежит к категории [интерактивного контента](/ru/docs/Web/HTML/Content_categories#интерактивный_контент). |
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
