...
- адаптивные изображения рекомендуется использовать с атрибутами `sizes` и `srcset` (смотрите также элемент {{htmlelement("picture")}} и наше руководство "[Адаптивные изображения](/ru/docs/Web/HTML/Responsive_images)").
...
- [Адаптивные изображения](/ru/docs/Web/HTML/Responsive_images).
