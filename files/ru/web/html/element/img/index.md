...
Если ошибка происходит во время загрузки или отрисовки изображения и обработчик события [`onerror`](/ru/docs/Web/HTML/Global_attributes#onerror) был настроен на обработку события [`error`](/ru/docs/Web/API/HTMLElement/error_event), тогда этот обработчик события будет вызван. Это может произойти в ряде ситуаций, в том числе когда:
