...
<ul>
 ...
 <li>Вы можете использовать <code>&lt;abbr&gt;</code> вместе с {{HTMLElement("dfn")}}, чтобы установить определения для терминов, которые являются аббревиатурами или акронимами. Смотрите пример <a href="#определение_в_аббревиатуре">Определение в аббревиатуре</a> ниже.</li>
</ul>
