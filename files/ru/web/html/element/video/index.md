...
- {{htmlattrdef("preload")}}
  ...
  > **Примечание:** **Usage notes:\*** The `autoplay` attribute has precedence over `preload`. If `autoplay` is specified, the browser would obviously need to start downloading the video for playback.
