...
<h2 id="How_does_Mozilla_determine_which_mode_to_use.3F">Как браузеры понимают, какой режим использовать?</h2>
...
<h2 id="What_are_the_differences_between_the_modes.3F">Как узнать, какой режим используется?</h2>
...
<h2 id="What_are_the_differences_between_the_modes.3F">В чем разница между режимами?</h2>
