...
- Если нет семантической причины использовать элемент \<b>, использование css свойства [font-weight](/ru/docs/Web/CSS/Reference/Properties/font-weight) со значением bold будет более грамотным выбором для изменения толщины текста.
