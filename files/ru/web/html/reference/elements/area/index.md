...
[HTML](/ru/docs/Web/HTML)-элемент **`<area>`** определяет область внутри карты изображения, в которой есть предварительно определённые области, доступные для кликов. _Карта изображения_ позволяет связывать геометрические области изображения с {{Glossary("Hyperlink", "гипертекстовыми ссылками")}}.

Этот элемент используется только внутри элемента {{HTMLElement("map")}}.
...
| [Категории содержимого](/ru/docs/Web/HTML/Guides/Content_categories) | [Элементы потока](/ru/docs/Web/HTML/Guides/Content_categories#flow_content), [фразового контента](/ru/docs/Web/HTML/Guides/Content_categories#phrasing_content).                                                     |
| -------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| Допустимые родители                                                  | Любой элемент, допускающий [фразовый контент](/ru/docs/Web/HTML/Guides/Content_categories#phrasing_content). У элемента `<area>` должен быть родитель {{HTMLElement("map")}}, но он не должен быть прямым родителем. |
...
- `download`
  - : Этот атрибут, если он добавлен, указывает, что ссылка используется для скачивания файла. Смотри {{HTMLElement("a")}} для полного описания атрибута [`download`](/ru/docs/Web/HTML/Reference/Elements/a#download).
- `href`
