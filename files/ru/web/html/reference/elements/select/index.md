...
| [Категории содержимого](/ru/docs/Web/HTML/Guides/Content_categories) | [Основной поток](/ru/docs/Web/HTML/Guides/Content_categories#основной_поток), [текстовый контент](/ru/docs/Web/HTML/Guides/Content_categories#phrasing_content), [интерактивный контент](/ru/docs/Web/HTML/Guides/Content_categories#interactive_content), [списочный](/ru/docs/Web/HTML/Guides/Content_categories#form_listed), [labelable](/ru/docs/Web/HTML/Guides/Content_categories#form_labelable), [сбрасываемый](/ru/docs/Web/HTML/Guides/Content_categories#form_resettable), и [submittable](/ru/docs/Web/HTML/Guides/Content_categories#form_submittable) [form-associated](/ru/docs/Web/HTML/Guides/Content_categories#form-associated_) element |
| -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
Контент этого элемента статичен и не [редактируемый](/ru/docs/Web/HTML/Reference/Global_attributes/contenteditable).
