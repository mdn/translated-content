...
HTML-элемент `<a>` (или якорный элемент), с атрибутом `href` определяет гиперссылку для перехода на определённое место на странице или на другую страницу в Интернете, гиперссылку на файлы, адреса электронной почты, или на что-либо ещё, к чему может обращаться URL-адрес.
...
| ----------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Разрешённый контент                                               | [Логический контент](/ru/docs/Web/HTML/Guides/Content_categories#%d0%9b%d0%be%d0%b3%d0%b8%d1%87%d0%b5%d1%81%d0%ba%d0%b8%d0%b9_%d0%ba%d0%be%d0%bd%d1%82%d0%b5%d0%bd%d1%82), содержащий либо [основной поток](/ru/docs/Web/HTML/Guides/Content_categories#%d0%9e%d1%81%d0%bd%d0%be%d0%b2%d0%bd%d0%be%d0%b9_%d0%bf%d0%be%d1%82%d0%be%d0%ba) (исключая [интерактивный контент](/ru/docs/Web/HTML/Guides/Content_categories#interactive_content)), либо [заголовочный контент](/ru/docs/Web/HTML/Guides/Content_categories#phrasing_content). |
| Опускание тегов                                                   | Открывающий и закрывающий теги обязательны.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Разрешённые родительские элементы                                 | Любые элементы, в которых разрешён [текстовый контент](/ru/docs/Web/HTML/Guides/Content_categories#%d0%97%d0%b0%d0%b3%d0%be%d0%bb%d0%be%d0%b2%d0%be%d1%87%d0%bd%d1%8b%d0%b9_%d0%ba%d0%be%d0%bd%d1%82%d0%b5%d0%bd%d1%82) или элементы, в которых разрешёны элементы [основного потока](/ru/docs/Web/HTML/Guides/Content_categories#%d0%9e%d1%81%d0%bd%d0%be%d0%b2%d0%bd%d0%be%d0%b9_%d0%bf%d0%be%d1%82%d0%be%d0%ba).                                                                                                                      |
| DOM-интерфейс                                                     | {{domxref("HTMLAnchorElement")}}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |

## Атрибуты

Этот элемент включает в себя [общие атрибуты](/ru/docs/Web/HTML/Reference/Global_attributes).
...
- `href`
  - : Единственный обязательный атрибут для определения ссылки в HTML4, но больше необязательный в HTML5. Упущение этого атрибута создаёт ссылку-заполнитель. Атрибут `href` указывает ссылку: либо URL, либо якорь. Якорь — это название после символа `#`, который указывает на элемент ([ID](/ru/docs/Web/HTML/Reference/Global_attributes#id)) на текущей странице. URL не ограничены только ссылками на HTTP, они могут использовать любой протокол, поддерживающийся браузером. Например, `file`, `ftp` и `mailto` работают в большинстве браузеров.
...
> [!NOTE]
> Желательно использовать атрибут `usemap` для элемента [`<img>`](/ru/docs/Web/HTML/Reference/Elements/img) и связанного элемента [`<map>`](/ru/docs/Web/HTML/Reference/Elements/map), чтобы определить горячие точки вместо атрибутов формы.
...
Для дополнительных деталей использования `mailto`, таких как тема, текст или другое, смотрите [Email-ссылки](/ru/docs/Learn_web_development/Core/Structuring_content/Creating_links#ссылки_электронной_почты) или {{RFC(6068)}}.
