...
Этот элемент может инициировать (вызывать) различные [события](/ru/docs/Web/API/Document_Object_Model/Events#media).
...
| [Категории контента](/ru/docs/Web/HTML/Guides/Content_categories) | [Потоковый контент](/ru/docs/Web/HTML/Guides/Content_categories#потоковый_контент), [фразовый контент](/ru/docs/Web/HTML/Guides/Content_categories#phrasing_content), [встроенный контент](/ru/docs/Web/HTML/Guides/Content_categories#встроенный_контент). Если элемент имеет атрибут `controls`, он так же принадлежит к категориям [интерактивного](/ru/docs/Web/HTML/Guides/Content_categories#интерактивный_контент) и [явного](/ru/docs/Web/HTML/Guides/Content_categories#явный_контент) контента.                                                                                                |
| ----------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Допустимое содержимое                                             | Если элемент имеет атрибут `src`: ноль или более элементов {{HTMLElement("track")}}, за которыми следует [прозрачный контентет](/ru/docs/Web/HTML/Guides/Content_categories#прозрачная_модель_контента), который не содержит элементов `<audio>` или {{HTMLElement("video")}}. Иначе: ноль или более элементов {{HTMLElement("source")}}, за которыми следует ноль или более элементов {{HTMLElement("track")}}, за которыми следует [прозрачный контент](/ru/docs/Web/HTML/Guides/Content_categories#прозрачная_модель_контента), который не содержит элементов `<audio>` или {{HTMLElement("video")}}. |
