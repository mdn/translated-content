...
| [Категории содержимого](/ru/docs/Web/HTML/Guides/Content_categories) | [Содержимое потока](/ru/docs/Web/HTML/Guides/Content_categories#flow_content), [фразовый контент](/ru/docs/Web/HTML/Guides/Content_categories#phrasing_content), ощутимое содержимое. |
| -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
