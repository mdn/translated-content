...
- [`accesskey`](/ru/docs/Web/HTML/Reference/Global_attributes/accesskey)
...
- [`class`](/ru/docs/Web/HTML/Reference/Global_attributes/class)
  - : Это список разделённых пробелами классов элемента. Классы позволяют CSS и JavaScript выбирать и получать доступ к конкретным элементам через [селекторы по классу](/ru/docs/Web/CSS/Reference/Selectors/Class_selectors) или через функции, такие как метод {{domxref("Document.getElementsByClassName()")}}.
- [`contenteditable`](/ru/docs/Web/HTML/Reference/Global_attributes/contenteditable)
...
- [`itemid`](/ru/docs/Web/HTML/Reference/Global_attributes/itemid) {{experimental_inline}}
...
- [`style`](/ru/docs/Web/HTML/Reference/Global_attributes/style)
...
- [`tabindex`](/ru/docs/Web/HTML/Reference/Global_attributes/tabindex)
