...
- Введение в HTML
  ...
  Если вы новичок в веб-разработке, обязательно прочитайте нашу статью ["Основы HTML"](/ru/docs/Learn_web_development/Getting_started/Your_first_website/Creating_the_content), чтобы узнать, что такое HTML и как его использовать.

- Руководства по HTML

  Статьи о том, как использовать HTML, а также обучающие материалы и исчерпывающие примеры можно найти в разделе "[Пространство изучения HTML](/ru/docs/Learn_web_development/Core/Structuring_content)".

- Справка по HTML

  В нашем обширном разделе "[Справка по HTML](/ru/docs/Web/HTML/Reference)" вы найдёте подробности о каждом элементе и атрибуте в HTML.

## Руководства для начинающих

Наше [Пространство изучения HTML](/ru/docs/Learn_web_development/Core/Structuring_content) содержит множество модулей, которые обучают HTML с нуля — начальные знания не требуются.
...
- [Используйте HTML для решения распространённых задач.](/ru/docs/Learn_web_development/Howto/Solve_HTML_problems)
...
- [CORS: включённые изображения](/ru/docs/Web/HTML/How_to/CORS_enabled_image)
  - : Атрибут [`crossorigin`](/ru/docs/Web/HTML/Reference/Elements/img#crossorigin) в сочетании с соответствующим заголовком {{glossary("CORS")}}, позволяет загружать изображения, определённые элементом {{HTMLElement("img")}}, из внешних источников и использовать в элементе {{HTMLElement("canvas")}}, как если бы они были загружены из текущего источника.
- [CORS: Настройки атрибутов](/ru/docs/Web/HTML/Reference/Attributes/crossorigin)
  - : Некоторые HTML-элементы, предоставляющие поддержку [CORS](/ru/docs/Web/HTTP/Guides/CORS), такие как {{HTMLElement("img")}} или {{HTMLElement("video")}}, имеют атрибут `crossorigin` (свойство `crossOrigin`), который позволяет вам настраивать CORS-запросы для получаемых элементом данных.
...
- [Глобальные атрибуты](/ru/docs/Web/HTML/Reference/Global_attributes)
  - : Глобальные атрибуты могут быть указаны для всех [элементов HTML](/ru/docs/Web/HTML/Reference/Elements), _даже тех, которые не указаны в стандарте_. Это означает, что любые нестандартные элементы обязаны по-прежнему разрешать эти атрибуты, даже если эти элементы делают документ несовместимым с {{glossary("HTML5")}}.
- [Строчные](/ru/docs/Web/HTML/Строчные_Элементы) и [блочные](/ru/docs/Glossary/Block-level_content) элементы
...
- [Виды HTML-контента](/ru/docs/Web/HTML/Guides/Content_categories)
...
- [Режим совместимости и стандартный режим](/ru/docs/Web/HTML/Guides/Quirks_mode_and_standards_mode)
