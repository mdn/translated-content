...
- [Управление фокусом в HTML](/ru/docs/Web/API/Document/hasFocus)
  - : DOM-Атрибут [`activeElement`](/en-US/docs/Web/API/Document/activeElement) и DOM-метод [`hasFocus()`](/ru/docs/Web/API/Document/hasFocus) помогают отслеживать и контролировать взаимодействие пользователя с элементами на веб-странице.
