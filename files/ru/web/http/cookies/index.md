...
> [!NOTE]
> В [таблице совместимости](/ru/docs/Web/HTTP/Headers/Set-Cookie/SameSite#browser_compatibility) вы можете найти информацию о том, как обрабатываются атрибуты в конкретных версиях браузеров.
...
> [!NOTE]
> Бэкенд может (и должен) устанавливать у кук [атрибут SameSite](/ru/docs/Web/HTTP/Headers/Set-Cookie/SameSite) для управления отправкой кук на сторонние серверы.
