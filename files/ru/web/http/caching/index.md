...
<h2 id="Свежесть_сохранённой_копии"><a id="Freshness">Свежесть сохранённой копии</a></h2>
...
<h2 id="Валидация_кеша"><a id="Cache_validation">Валидация кеша</a></h2>
...
<h2 id="Изменяющиеся_ответы"><a id="Varying_responses">Изменяющиеся ответы</a></h2>
