...
<p><img alt="A Web document is the composition of different resources" src="https://developer.mozilla.org/en-US/docs/Web/HTTP/Overview/fetching_a_page.png" style="height: 319px; width: 545px;"></p>
...
<p><img alt="Client server chain" src="https://developer.mozilla.org/en-US/docs/Web/HTTP/Overview/client-server-chain.png"></p>
...
<p><img alt="A basic HTTP request" src="https://developer.mozilla.org/en-US/docs/Web/HTTP/Overview/http_request.png" style="height: 336px; width: 693px;"></p>
...
<ul>
 ...
 <li>Путь к ресурсу: URL ресурсы лишены элементов, которые очевидны из контекста, например без {{glossary("protocol","протокола")}} (<code>http://</code>), {{glossary("domain","домена")}} (здесь <code>developer.mozilla.org</code>), или TCP {{glossary("port","порта")}} (здесь <code>80</code>).</li>
...
<p><img alt="" src="https://developer.mozilla.org/en-US/docs/Web/HTTP/Overview/http_response.png" style="height: 494px; width: 758px;"></p>
