...
> **Примечание:** `nosniff` применяется только к типам "`script`" и "`style`". Также применение `nosniff` к изображениям оказалось [несовместимым с существующими веб-сайтами](https://github.com/whatwg/fetch/issues/395).
