...
<dl>
 ...
 <dt><a href="/ru/docs/Web/HTTP/Caching">HTTP-кеширование (HTTP Cache)</a></dt>
 ...
 <dt><a href="/ru/docs/Web/HTTP/Cookies">HTTP-куки (HTTP cookies)</a></dt>
 ...
 <dt><a href="/ru/docs/Web/HTTP/CORS">Контроль доступа (совместное использование ресурсов между разными источниками, HTTP access control (CORS))</a></dt>
 ...
 <dt><a href="/ru/docs/Web/HTTP/Basics_of_HTTP/Evolution_of_HTTP">Эволюция HTTP</a></dt>
 ...
 <dt><a href="/ru/docs/Web/HTTP/Messages">HTTP-сообщения (HTTP Messages)</a></dt>
 <dd>Описывает тип и структуру разных видов сообщений HTTP/1.x и HTTP/2.</dd>
 <dt><a href="/ru/docs/Web/HTTP/Session">Обычный сеанс HTTP</a></dt>
 <dd>Показывает и описывает течение обычного сеанса HTTP.</dd>
 <dt><a href="/ru/docs/Web/HTTP/Connection_management_in_HTTP_1.x">Управление подключениями в HTTP/1.x</a></dt>
...
<dl>
 <dt><a href="/ru/docs/Web/HTTP/Headers" title="/ru/docs/Web/HTTP/Headers">HTTP-заголовки (HTTP Headers)</a></dt>
 ...
 <dt><a href="/ru/docs/Web/HTTP/Methods">Методы HTTP-запроса</a></dt>
 ...
 <dt><a href="/ru/docs/Web/HTTP/Status">Коды ответа (HTTP response codes)</a></dt>
...
<ul>
 ...
 <li><a href="/ru/docs/Web/HTTP/Cookies" title="HTTP cookies">HTTP-куки (HTTP cookies)</a></li>
 <li><a href="/ru/docs/Web/HTTP/Headers" title="/ru/docs/Web/HTTP/Headers">HTTP заголовки</a></li>
 ...
 <li><a href="/ru/docs/Web/HTTP/CORS" title="/ru/docs/Web/HTTP/CORS">HTTP контроль доступа (CORS)</a></li>
</ul>
