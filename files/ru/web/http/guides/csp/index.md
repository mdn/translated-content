...
Возьмём страницу, расположенную по адресу [`http://example.com/signup.html`](https://example.com/signup.html). Для неё используется следующая политика, запрещающая загрузку всего кроме CSS-файлов с `cdn.example.com`.
