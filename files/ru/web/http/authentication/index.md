...
<h2 id="Basic_authentication_scheme">Базовая (Basic) схема аутентификации</h2>
...
<p>Чтобы защитить паролем каталог на сервере Apache, вам понадобятся файлы <code>.htaccess</code> и <code>.htpasswd</code>.
</p>
