...
> ```
>
> Я включил пространство имён xlink прямо в ноду, хотя обычно вы хотели бы определить его в верхней части вашего документа. Подробнее об этом мы [поговорим в разделе изображений](/ru/docs/Web/SVG/Tutorials/SVG_from_scratch/Other_content_in_SVG).
...
Вы также можете применить иную трансформацию к градиенту, используя атрибут **`gradientTransform`**, но мы пока что [его не изучали](/ru/docs/Web/SVG/Tutorials/SVG_from_scratch/Basic_transformations), я оставлю это на потом.
