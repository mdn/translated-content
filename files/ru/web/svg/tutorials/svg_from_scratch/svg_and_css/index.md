...
Это вторая секция Части II [Руководство по CSS](/ru/docs/conflicting/Learn_web_development/Core/Styling_basics).
Предыдущая секция: [JavaScript](/ru/docs/Learn_web_development/Getting_started/Your_first_website/Adding_interactivity)
