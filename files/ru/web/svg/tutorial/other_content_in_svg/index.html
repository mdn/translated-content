...
<div class="note"><strong>Примечание:</strong> Имейте в виду, что контент в <code>foreignObject</code> должен поддерживаться обозревателем. Обычная программа для просмотра SVG вряд ли сможет отобразить HTML или MathML.</div>
