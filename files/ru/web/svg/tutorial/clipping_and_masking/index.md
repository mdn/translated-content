...
<p>{{ EmbedLiveSample('Кадрирование_изображений','240','240','/files/3224/clipdemo.png') }}</p>
...
<p>{{ EmbedLiveSample('Маска','240','240','/files/3234/maskdemo.png') }}</p>
...
<p>{{ EmbedLiveSample('Прозрачность_opacity','240','240','/files/3231/opacitydemo.png') }}</p>
