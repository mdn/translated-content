...
---
**XSLT** (_Extensible Stylesheet Language Transformations_) — является языком на основе XML, используемым вместе со специализированным программным обеспечением для преобразования [XML](http://ru.wikipedia.org/wiki/XML "XML")-документов. Спецификация XSLT является рекомендацией [W3C](http://ru.wikipedia.org/wiki/W3C "W3C").
