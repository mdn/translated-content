...
- Строки, числа и булевы значения (но не объекты {{jsxref("String")}}, {{jsxref("Number")}} или {{jsxref("Boolean")}}): метод `concat` копирует значения строк и чисел в новый массив.
