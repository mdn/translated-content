...
Метод **`with()`** возвращает новый массив с изменённым значением одного из элементов исходного массива. Является копирующей версией замены значения элемента по заданному индексу с помощью [скобочной записи](/ru/docs/Web/JavaScript/Reference/Operators/Property_accessors#скобочная_запись).
