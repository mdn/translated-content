...
Выбрасывает исключение {{jsxref("TypeError")}}, если параметр `proto` не является {{jsxref("null")}} или объектом (исключение составляют объекты-обёртки примитивных типов).
