...
Обратите внимание, что метод `Object.assign()` не выкидывает исключения, если в качестве исходных значений выступают {{jsxref("Operators/null", "null")}} или {{jsxref("undefined")}}.
