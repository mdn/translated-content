...
Для понимания того, как прототипы используются для наследования, смотрите статью руководства [«Наследование и цепочки прототипов»](/ru/docs/Web/JavaScript/Inheritance_and_the_prototype_chain).
