...
- length
  - : При вызове в памяти создаётся буфер длины _**`length`**_ \* _BYTES_PER_ELEMENT_ байт, содержащий нули
- typedArray
...
\_Все TypedArray_s-массивы наследуют от {{jsxref("TypedArray.prototype")}}.
