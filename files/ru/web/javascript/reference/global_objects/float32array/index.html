...
<dl>
 ...
 <dd>Возвращает индекс найденного значения в массиве, если найден элемент соответствующий условию, в противном случае возвращает <code>-1</code>. Смотрите также {{jsxref("Array.prototype.findIndex()")}}.</dd>
