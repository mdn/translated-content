...
Метод **`exec()`** выполняет поиск сопоставления регулярного выражения в указанной строке. Возвращает массив с результатами или {{jsxref("Operators/null", "null")}}.
...
Если сопоставление не удалось, метод `exec()` возвращает {{jsxref("Operators/null", "null")}}.
