...
Если на указанной позиции нет элементов, будет возвращено значение {{jsxref("undefined")}}. Если суррогатная пара UTF-16 не начинается в позиции `pos`, будет возвращено кодовое значение в позиции `pos`.
