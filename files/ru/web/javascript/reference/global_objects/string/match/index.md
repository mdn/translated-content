...
- `array`
  - : Объект {{jsxref("Global_Objects/Array", "Array")}}, содержащий результаты сопоставления, или {{jsxref("Operators/null", "null")}}, если ничего не было сопоставлено.
...
Если регулярное выражение содержит флаг `g`, метод вернёт {{jsxref("Global_Objects/Array", "массив", "", 1)}}, содержащий все сопоставления. Если сопоставлений не было, метод вернёт значение {{jsxref("Operators/null", "null")}}.
