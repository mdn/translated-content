...
Метод **`substring()`** возвращает часть строки от начального индекса до конечного (не включая его), или, если конечный индекс не указан, — до конца строки.
...
- Если любой из аргументов меньше, либо равен нулю или равен {{jsxref("NaN")}}, он будет трактоваться как равный 0.
