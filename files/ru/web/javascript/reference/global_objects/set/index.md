...
- {{jsxref("Set.prototype.delete()")}}
  - : Удаляет элемент, связанный с переданным значением, и возвращает логическое значение, подтверждающее, был ли элемент успешно удален или нет. `Set.prototype.has(value)` в последствии вернет `false`.
