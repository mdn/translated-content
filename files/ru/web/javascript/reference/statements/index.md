...
- {{jsxref("Statements/for-await...of", "for await...of")}}
  - : Проходит по асинхронным итерируемым объектам, массивоподобным объектам и [итераторам с генераторами](/ru/docs/Web/JavaScript/Guide/Iterators_and_generators), выполняя пользовательский хук с инструкциями, исполняющимися для значения каждого уникального свойства.
