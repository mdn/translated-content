...
Для более детального изучения алгоритма сравнения обратитесь к странице [оператор строгого равенства](/ru/docs/Web/JavaScript/Reference/Operators/Strict_equality).
