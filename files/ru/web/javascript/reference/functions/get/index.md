...
Использование ключевого слова `get` и {{jsxref("Object.defineProperty()")}} даёт похожие результаты, но при использовании в {{jsxref("Classes", "classes")}} между ними есть тонкая разница.
