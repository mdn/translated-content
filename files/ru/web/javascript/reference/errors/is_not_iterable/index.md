...
В JavaScript, {{jsxref("Object", "object")}} не повторяется, если они реализуют итерационный протокол . Поэтому нельзя использовать for...of для перебора свойств объекта.
