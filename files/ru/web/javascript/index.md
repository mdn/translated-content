...
<dl>
 ...
 <dd>Этот документ описывает интерфейс для использования <a href="https://developer.mozilla.org/en-US/docs/XPath" title="en/XPath">XPath</a> в JavaScript напрямую, внутри расширений и на веб-сайтах.</dd>
</dl>

<h2 id="Справочник">Справочник</h2>
...
<h2 id="Инструменты_и_дополнительные_ресурсы">Инструменты и дополнительные ресурсы</h2>
