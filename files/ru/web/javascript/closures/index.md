...
До того, как в версии ECMAScript 6 ввели ключевое слово [`let`](/ru/docs/JavaScript/Reference/Statements/let "let"), постоянно возникала следующая проблема при создании замыканий внутри цикла. Рассмотрим пример:
