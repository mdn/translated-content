...
Когда выполняется унаследованная функция, значение `this`(/ru/docs/Web/JavaScript/Reference/Operators/this) указывает на объект-потомок, а не на прототип, в котором функция является собственным свойством.
