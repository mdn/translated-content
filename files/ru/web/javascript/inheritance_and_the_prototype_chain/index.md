...
В области видимости унаследованной функции ссылка [`this`](/en/JavaScript/Reference/Operators/this "this") указывает на наследующий объект (на наследника), а не на прототип, в котором данная функция является собственным свойством.
...
В JavaScript "конструктор" — это "просто" функция, вызываемая с оператором [new](/en/JavaScript/Reference/Operators/new "new").
...
В ECMAScript 5 представлен новый метод создания объектов: [Object.create](/en/JavaScript/Reference/Global_Objects/Object/create "create"). Прототип создаваемого объекта указывается в первом аргументе этого метода:
