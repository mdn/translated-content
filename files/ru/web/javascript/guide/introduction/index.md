...
[Web Console](https://firefox-source-docs.mozilla.org/devtools-user/web_console/index.html) отображает информацию о текущей загруженной веб-странице, а также включает [командную строку](https://firefox-source-docs.mozilla.org/devtools-user/web_console/index.html#the_command_line_interpreter), которую вы можете использовать, чтобы выполнить выражения JavaScript на текущей странице.
