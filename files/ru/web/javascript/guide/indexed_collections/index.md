...
> **Примечание:** **Замечание:** Если вы используете нецелое значение в операторе \[] обращения к элементу массива, то будет создано соответствующее свойство в объекте, представляющем массив, вместо элемента массива (так как массивы в JavaScript являются объектами).
...
> **Примечание:** **Замечание:** оператор обращения к элементу массива (квадратные скобки \[]) также используется для доступа к свойствам массива (массивы также являются объектами в JavaScript). Например:
