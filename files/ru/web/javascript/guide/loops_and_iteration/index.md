...
Следующий пример показывает разницу между циклами `for...of` и [`for...in`](/ru/docs/Web/JavaScript/Reference/Statements/for...in "ru/docs/JavaScript/Reference/Statements/for...in"). Тогда как `for...in` проходит по именам свойств, `for...of` проходит по значениям свойств:
