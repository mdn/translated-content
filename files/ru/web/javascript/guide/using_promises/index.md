...
- Колбэки никогда не будут вызваны до [завершения обработки текущего события](/ru/docs/Web/JavaScript/Reference/Execution_model#никогда_не_блокируется) в событийном цикле JavaScript.
