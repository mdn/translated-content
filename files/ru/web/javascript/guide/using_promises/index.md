...
Простые цепочки promise лучше оставлять без вложений, так как вложенность может быть результатом небрежной структуры. Смотрите [распространённые ошибки](/ru/docs/Web/JavaScript/Guide/Ispolzovanie_promisov$edit#Common_mistakes).
