...
Подробнее про использование обратных косых кавычек (\` \`), [читайте ниже](/ru/docs/Web/JavaScript/Guide/Text_formatting#Многострочные_шаблонные_строки).
...
Например, в Германии есть два различных порядка сортировки строк в зависимости от документа: телефонная книга или словарь.\_ \_Сортировка по типу телефонной книги подчёркивает звуки.
