...
- {{ web.link("#Операторы_присваивания", "Операторы присваивания") }}
- {{ web.link("#Операторы_сравнения", "Операторы сравнения") }}
- {{ web.link("#Арифметические_операторы", "Арифметические операторы") }}
- {{ web.link("#Битовые_(поразрядные)_операторы", "Битовые (поразрядные) операторы") }}
- {{ web.link("#Логические_операторы", "Логические операторы") }}
- {{ web.link("#Строковые_операторы", "Строковые операторы") }}
- {{ web.link("#Условный_(тернарный)_оператор", "Условный (тернарный) оператор")}}
- {{ web.link("#Оператор_запятая", "Оператор запятая")}}
- {{ web.link("#Унарные_операторы", "Унарные операторы")}}
- {{ web.link("#Операторы_отношения", "Операторы отношения")}}
- {{ web.link("#Приоритет_операторов", "Приоритет операторов")}}
...
| [Строго равно](/ru/docs/Web/JavaScript/Reference/Operators/Операторы_сравнения#Identity) (`===`)                          | Возвращает true, если операнды равны и имеют одинаковый тип. Смотрите также {{jsxref("Object.is")}} и [sameness in JS](/ru/docs/Web/JavaScript/Equality_comparisons_and_sameness "/ru/docs/Web/JavaScript/Guide/Sameness"). | `3 === var1`                         |
...
- **Арифметические**: вычисляются в число, например: 3.14159 (Используют {{ web.link("#Arithmetic_operators", "арифметические операторы") }}).
- **Строковые**: вычисляются в текстовую строку, например: "Fred" или "234" (Используют {{ web.link("#String_operators", "строковые операторы") }}).
- **Логические**: вычисляются в true или false (Используют {{ web.link("#Logical_operators", "логические операторы") }}).
