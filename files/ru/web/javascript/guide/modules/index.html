...
<div class="blockIndicator note">
<p><strong>Примечание</strong>: «as» синтаксис для переименования экспортируемых элементов поясняется ниже в разделе <a href="#переименование_импорта_и_экспорта">Переименование импорта и экcпорта</a>.</p>
</div>
