...
## Экспорт возможностей модуля

Первое, что нужно сделать, чтобы получить доступ к возможностям модуля, — экспортировать его. Это делается с помощью инструкции {{JSxRef("Statements/export", "export")}}.
...
## Импорт возможностей в ваш скрипт
...
> **Примечание:** «as» синтаксис для переименования экспортируемых элементов поясняется ниже в разделе [Переименование импорта и экспорта](#переименование_импорта_и_экспорта).
