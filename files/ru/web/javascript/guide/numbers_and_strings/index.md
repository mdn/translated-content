...
| {{jsxref("Number.isNaN()")}}         | Определяет, является ли число, переданное в качестве аргумента, {{jsxref("NaN")}} (не числом). Аналогичный, но более надёжный метод чем глобальная функция {{jsxref("isNaN", "isNaN()")}}.              |
