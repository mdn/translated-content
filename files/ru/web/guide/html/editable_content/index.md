...
> **Примечание:** если вы хотите увидеть, как стандартизировать создание и вставку вашего редактора на свою страницу, см. [наш более полный пример редактора.](https://developer.mozilla.org/@api/deki/files/6243/=rich-text-editor.zip "rich-text-editor.zip")
