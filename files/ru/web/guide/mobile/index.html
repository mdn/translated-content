...
<h2 id="Разработка_под_мобильные_устройства"><a id="разработка_под_мобильные_устройства">Разработка под мобильные устройства</a></h2>
...
<ul>
 ...
 <li>использование <a href="/en/CSS/Media_queries" title="en/CSS/Media_queries">медиавыражений</a>, подключающих стили по условию, соответственно, <a href="/en/CSS/Media_queries#width" title="en/CSS/Media_queries#width">ширине</a> и <a href="/en/CSS/Media_queries#height" title="en/CSS/Media_queries#height">высоте</a> экрана.</li>
</ul>
...
<p>Вы можете использовать медиавыражение <a href="/en/CSS/Media_queries#-moz-touch-enabled" title="en/CSS/Media_queries#-moz-touch-enabled">-moz-touch-enabled</a>, чтобы использовать нужные вам правила CSS на устройствах, поддерживающих обработку нажатий на экран.</p>

<h3 id="Оптимизация_изображений">Оптимизация изображений</h3>

<p>Для оптимизации скорости загрузки у пользователей мобильных устройств вы имеете возможность загружать различные версии изображений в соответствии со спецификациями экрана устройства. Описать правила загрузки можно в CSS при помощи медиавыражений <a href="/en/CSS/Media_queries#height" title="en/CSS/Media_queries#height">height</a>, <a href="/en/CSS/Media_queries#width" title="en/CSS/Media_queries#width">width</a>, и <a href="/en/CSS/Media_queries#-moz-device-pixel-ratio" title="en/CSS/Media_queries#-moz-device-pixel-ratio">pixel ratio</a>.</p>
...
<h2 id="Кросс-браузерная_вёрстка"><a id="кросс_браузерная_вёрстка">Кросс-браузерная вёрстка</a></h2>
