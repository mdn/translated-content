...
- Соответствует HTML-элементам: [`<a>`](/en-US/docs/Web/HTML/Element/a), [`<area>`](/en-US/docs/Web/HTML/Element/area) и [`<link>`](/en-US/docs/Web/HTML/Element/link) с атрибутом [`href`](/ru/docs/Web/HTML/Element/a#href)
