...
@-правило `@media` можно разместить на верхнем уровне CSS или внутри любого фрагмента [условной группы @-правил](/ru/docs/Web/CSS/At-rule#conditional_group_rules).
