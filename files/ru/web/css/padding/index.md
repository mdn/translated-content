...
Свойство **`padding`** устанавливает внутренние отступы/поля со всех сторон элемента. [Область отступов](/en-US/CSS/box_model#padding) это пространство между содержанием элемента и его границей. Отрицательные значения не допускаются.
...
- [CSS Box Model](/en-US/CSS/box_model)
