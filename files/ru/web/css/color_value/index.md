...
> [!NOTE]
> Список принятых ключевых слов претерпел много изменений в ходе эволюции CSS:
>
...
> [!NOTE]
> Начиная с уровня цветов CSS 4, `rgba()` является псевдонимом для `rgb()`. В браузерах, реализующих стандарт уровня 4, они принимают одни и те же параметры и ведут себя одинаково.
...
> [!NOTE]
> Начиная с уровня цветов CSS 4, `hsla()` является псевдонимом для `hsl()`. В браузерах, реализующих стандарт уровня 4, они принимают одни и те же параметры и ведут себя одинаково.
