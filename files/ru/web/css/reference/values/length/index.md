...
- px
  - : Один пиксель. Для устройств с дисплеем традиционно представляет одну точку. Тем не менее, на _принтерах_ и _экранах с высоким разрешением_ один пиксель CSS равен нескольким пикселям дисплея. `1px` = 1/96 от `1in`.
- cm
