...
Применяя в [наследуемых свойств](/ru/docs/Web/CSS/Guides/Cascade/Inheritance#inherited_properties), это ключевое слово подчеркивает использование значения по умолчанию, поэтому требуется только для переопределения другого правила.
