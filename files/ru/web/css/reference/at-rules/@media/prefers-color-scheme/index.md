...
[CSS](/ru/docs/Web/CSS) [медиа функция](/ru/docs/Web/CSS/Guides/Media_queries/Using) **`prefers-color-scheme`** может использоваться для определения того, светлую или тёмную тему использует пользователь в операционной системе.
