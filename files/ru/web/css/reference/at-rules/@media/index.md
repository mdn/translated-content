...
| [`orientation`](/ru/docs/Web/CSS/Reference/At-rules/@media/orientation)                                    | Orientation of the viewport                                                                                                                       |                                                                                                                                    |
...
| [`update`](/ru/docs/Web/CSS/Reference/At-rules/@media/update)                                              | How quickly (if at all) can the output device modify the appearance of the content                                                                | Added in Media Queries Level 4                                                                                                     |
...
| [`inverted-colors`](/ru/docs/Web/CSS/Reference/At-rules/@media/inverted-colors)                            | Is the user agent or underlying OS inverting colors?                                                                                              | Added in Media Queries Level 4                                                                                                     |
...
| [`scripting`](/ru/docs/Web/CSS/Reference/At-rules/@media/scripting)                                        | Is scripting (e.g. JavaScript) available?                                                                                                         | Added in Media Queries Level 4                                                                                                     |
