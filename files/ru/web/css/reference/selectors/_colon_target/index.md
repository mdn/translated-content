...
[Псевдокласс](/ru/docs/Web/CSS/Reference/Selectors/Pseudo-classes) [CSS](/ru/docs/Web/CSS) **`:target`** представляет уникальный элемент (целевой элемент) с подходящим [`id`](/ru/docs/Web/HTML/Reference/Global_attributes#id) URL-фрагментом.
