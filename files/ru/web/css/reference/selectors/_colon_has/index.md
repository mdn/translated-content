...
Стили, указанные для элемента с [псевдоклассом](/ru/docs/Web/CSS/Reference/Selectors/Pseudo-classes) **`:has()`**, будут применены, если хотя бы один из относительных селекторов, переданных в качестве аргумента, соответствует хотя бы одному элементу.
