...
> [!NOTE]
> В отличие от псевдоклассов, [псевдоэлементы](/ru/docs/Web/CSS/Reference/Selectors/Pseudo-elements) могут быть использованы для стилизации _определённой части_ элемента.
