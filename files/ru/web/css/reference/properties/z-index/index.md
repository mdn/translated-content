...
1. Порядок наложения в текущем [контексте наложения](/ru/docs/Web/CSS/Guides/Positioned_layout/Stacking_context).
...
- [Понимание CSS z-index](/ru/docs/Web/CSS/Guides/Positioned_layout/Understanding_z-index)
