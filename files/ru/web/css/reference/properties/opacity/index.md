...
Использование `opacity` со значением, отличным от `1`, помещает элемент в новый [контекст наложения](/ru/docs/Web/CSS/Guides/Positioned_layout/Stacking_context).
