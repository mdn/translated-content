...
<p>Заметьте, что определения CSS-правил полностью (ASCII)  <a href="https://www.w3.org/TR/css-syntax-3/#intro">текста-ориентированы</a>, в то время как определения правил DOM-CSS / CSSOM <a href="https://www.w3.org/TR/cssom/#introduction">объектно-ориентированы</a>.</p>
...
<ul>
 <li><a href="/ru/docs/Web/Guide/CSS/Media_queries">Медиавыражения</a></li>
