...
Когда селекторы используют одинаковые CSS-правила, они могут быть сгруппированы в один список селекторов разделённых запятыми. Списки селекторов также могут быть переданы в качестве параметра в некоторые функциональные CSS-псевдоклассы. Можно использовать пробельный символ перед и/или после запятой.
...
При применении одинаковых стилей к разным элементам, группировка селекторов в список разделённый запятыми может улучшить консистентность одновременно уменьшив размер таблицы стилей.
