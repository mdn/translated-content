...
- `normal`
  - : Эффект этого атрибута зависит от выбранного способа разметки:\* Используя разметку с помощью блоков (block-level layout), это ключевое слово является синонимом слова `start`
