...
<dl>
 <dt><em>width</em></dt>
 <dd>Is a value denoting the width of the image used as a border to apply to all four edges. It is used only in the one-value syntax.</dd>
...
<dl>
 ...
 <dd>Represents the width of the border as a percentage of the element. The percentage must not be negative.</dd>
...
<p>{{ EmbedLiveSample('Примеры', '480', '320', '', 'Web/CSS/border-image-width') }}</p>
