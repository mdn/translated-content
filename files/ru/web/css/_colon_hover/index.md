...
> **Примечание:** **Замечания:** Для аналогичного эффекта, но основанного на псевдоклассе[`:checked`](/en/CSS/%3Achecked) (применяется к скрытым радиокнопкам), смотрите [это демо](/@api/deki/files/6268/=css-checked-gallery.zip), взятое со страницы [ru/CSS/:checked](/ru/docs/Web/CSS/:checked).
