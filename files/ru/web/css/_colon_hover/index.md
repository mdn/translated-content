...
С псевдоклассом `:hover` вы можете создавать сложные каскадные алгоритмы. Эта техника часто используется, например, чтобы создать **выпадающие меню на чистом CSS** (только на CSS, без использования [JavaScript](/en-US/JavaScript)). Сущность этой техники - создание правил, типа следующего:
