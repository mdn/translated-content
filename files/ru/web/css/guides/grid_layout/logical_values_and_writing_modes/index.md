...
[Спецификация логических свойств CSS](https://drafts.csswg.org/css-logical/) имеет целью изменить это и в будущем мы сможем использовать [логические эквиваленты](/ru/docs/Web/CSS/CSS_logical_properties_and_values) для свойств, такие как {{cssxref ("margin-left")}} и {{cssxref ("margin-right") }}, в нашем CSS. Firefox уже реализовал их, поэтому вы можете попробовать их прямо сейчас в Firefox. Я знаю в будущем, как только эти корабли повсюду, ваши знания «Блокировать и встроить» с помощью Grid означают, что вы точно знаете, как их использовать.
