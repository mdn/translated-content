...
Отступы [margin-top](/ru/docs/Web/CSS/Reference/Properties/margin-top) и [margin-bottom](/ru/docs/Web/CSS/Reference/Properties/margin-bottom) иногда объединяются в один, с размером равным наибольшему из них (или размеру одного, если они равны).
Это поведение известно как **схлопывание внешних отступов (margin collapsing).**
Обратите внимание, что отступы [плавающих](/ru/docs/Web/CSS/Reference/Properties/float) и [абсолютно позиционированных](/ru/docs/Web/CSS/Reference/Properties/position#absolute) элементов никогда не схлопываются.
...
- Внешние отступы [плавающих](/ru/docs/Web/CSS/Reference/Properties/float) и [абсолютно позиционируемых](/ru/docs/Web/CSS/Reference/Properties/position) элементов никогда не схлопываются.
