...
<dl>
 ...
 <dd>Слова разрываются при переносе строки только там, где символы внутри слов указывают точки разрыва. Подробнее смотреть ниже  <a href="#предлагаемые_возможности_разрыва_строки">Предлагаемые возможности разрыва строки</a>.</dd>
 <dt><code>auto</code></dt>
 <dd><font>Браузер может автоматически разбивать слова в соответствующих точках переноса, следуя любым правилам, которые он выбирает. </font><font>Однако предлагаемые возможности разрыва строки </font>(смотреть <a href="#предлагаемые_возможности_разрыва_строки">Предлагаемые возможности разрыва строки</a> ниже) переопределят автоматический выбор точки разрыва, если таковые имеются.</dd>
</dl>
...
<p>В этом примере используются три класса, по одному для каждой возможной конфигурации свойства <code>hyphens</code>.</p>
...
<p>{{EmbedLiveSample("Указание_переносов_текста", "100%", 490)}}</p>
