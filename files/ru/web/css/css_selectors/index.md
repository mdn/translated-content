...
- [Комбинатор потомков](/ru/docs/Web/CSS/Descendant_combinator)
...
- [Дочерние селекторы](/ru/docs/Web/CSS/Child_combinator)
...
- [Комбинатор всех соседних элементов](/ru/docs/Web/CSS/Subsequent-sibling_combinator)
...
- [Комбинатор следующего соседнего элемента](/ru/docs/Web/CSS/Next-sibling_combinator)
