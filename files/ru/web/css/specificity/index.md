...
<div class="note">Примечание: Взаимное расположение элементов в дереве документа не влияет на специфичность.</div>
...
<ol>
 ...
 <li>
  ...
  <pre class="brush: html"><code>&lt;div id="test"&gt;
  &lt;span&gt;Text&lt;/span&gt;
&lt;/div&gt;</code></pre>

  <pre class="brush: css"><code>div#test span { color: green }
div span { color: blue }
span { color: red }
</code></pre>
 </li>
...
<pre class="default"><code>#someElement p {
    color: blue;
}
...
<pre class="default"><code>table td    {height: 50px !important;}
.myTable td {height: 50px !important;}
#myTable td {height: 50px !important;}</code></pre>
...
<pre class="default"><code>td {height: 50px !important;}</code></pre>
...
<h3 id="Независимость_от_расположения">Независимость от расположения</h3>
...
<h3 id="Непосредственно_соответствующие_элементы_и_унаследованные_стили">Непосредственно соответствующие элементы и унаследованные стили</h3>
