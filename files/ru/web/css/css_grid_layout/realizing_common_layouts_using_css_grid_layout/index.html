...
<h2 id="Адаптивный_1-3_колоночный_макет_с_использованием_grid-template-areas">Адаптивный 1-3 колоночный макет с использованием <code>grid-template-areas</code></h2>
...
<h2 id="Гибкий_12-колоночный_макет.">Гибкий 12-колоночный макет.</h2>
...
<h3 id="Построение_макета_с_использованием_12-столбцовой_системы">Построение макета с использованием 12-столбцовой системы</h3>
