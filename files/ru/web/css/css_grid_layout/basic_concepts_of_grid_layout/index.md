...
![Использование инструмента подсвечивания грида в инструментах веб-разработчика для просмотра грида](https://mdn.mozillademos.org/files/14631/1-grid-inspector.png)
...
![Диаграма, показывающая номера грид-линий.](https://mdn.mozillademos.org/files/14761/1_diagram_numbered_grid_lines.png)
...
![Выделена первая ячейка грида](https://mdn.mozillademos.org/files/14643/1_Grid_Cell.png)
...
![Грид-область](https://mdn.mozillademos.org/files/14645/1_Grid_Area.png)
...
![Вложенные гриды в потоке](https://mdn.mozillademos.org/files/14641/1_Nested_Grids_in_flow.png)
