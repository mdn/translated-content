...
> [!NOTE]
> Не забывайте, что вы можете использовать [Grid Inspector](/ru/docs/Tools/Page_Inspector/How_to/Examine_grid_layouts) в Firefox Developer Tools, чтобы посмотреть, как элементы размещаются по линиям грида.
