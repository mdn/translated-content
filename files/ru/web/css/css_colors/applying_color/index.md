...
Существует краткая запись {{cssxref("border")}}, которая позволяет задать сразу все свойства границы, включая даже не связанные с цветом свойства, такие как толщина линии ([width](/ru/docs/Web/CSS/Reference/Properties/border-width)), стиль линии ([style](/ru/docs/Web/CSS/border-style)): сплошная (solid), штриховая (dashed) и так далее.
...
См. [Color keywords](/ru/docs/Web/CSS/Reference/Values/color_value#ключевые_цвета) - полный перечень всех доступных ключевых слов.
