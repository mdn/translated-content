...
- `break-spaces`
  - : Поведение идентично `pre-wrap` со следующими отличиями:\* Последовательности пробелов сохраняются так, как они указаны в источнике, включая пробелы на концах строк.
