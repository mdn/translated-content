...
CSS-свойство **`color-scheme`** позволяет указать, в каких цветовых схемах нужно отобразить элемент.
...
- `normal`
  - : Указывает элементу отображаться в цветовой схеме, используемой браузером по умолчанию.
- `light`
  - : Указывает, что элемент должен отображаться в светлой цветовой схеме операционной системы.
- `dark`
  - : Указывает, что элемент должен отображаться в тёмной цветовой схеме операционной системы.
...
Чтобы применить к всей странице цветовую схему пользователя нужно определить свойство `color-scheme` для элемента {{cssxref(":root")}}.
