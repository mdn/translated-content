...
- mathbackground
  - : Цвет фона (если изображение имеет прозрачность). Вы можете использовать `#rgb`, `#rrggbb` и [имена цветов HTML](/ru/docs/Web/CSS/Reference/Values/color_value).
- mathcolor
  - : Цвет текста. Вы можете использовать `#rgb`, `#rrggbb` и [имена цветов HTML](/ru/docs/Web/CSS/Reference/Values/color_value).
- mathsize
  - : Размер контента. Смотрите [length](/ru/docs/Web/CSS/Reference/Values/length) для возможных значений.
