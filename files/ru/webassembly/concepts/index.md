...
- Портирование приложения C/C++ с [Emscripten](/ru/docs/Mozilla/Projects/Emscripten).
...
Из множества вариантов создания кода WASM есть два наиболее популярных - это онлайн-сборщик wasm или [Emscripten](/ru/docs/Mozilla/Projects/Emscripten). Существует ещё несколько вариантов сборки WASM, таких как:
