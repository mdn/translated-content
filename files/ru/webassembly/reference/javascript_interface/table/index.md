...
- `Table.prototype.constructor`
  - : Возвращает функцию которая создала этот объект. По умолчанию это конструктор [`WebAssembly.Table()`](/ru/docs/WebAssembly/Reference/JavaScript_interface/Table).
- [`Table.prototype.length`](/ru/docs/WebAssembly/Reference/JavaScript_interface/Table/length)
  - : Возвращает длину таблицы (количество элементов в таблице).

### Instance methods

- [`Table.prototype.get(index)`](/ru/docs/WebAssembly/Reference/JavaScript_interface/Table/get)
  - : Возвращает указанное значение из таблицы.
- [`Table.prototype.grow(count)`](/ru/docs/WebAssembly/Reference/JavaScript_interface/Table/grow)
  - : Увеличивает размер таблицы на указанное количество элементов.
- [`Table.prototype.set(index, value)`](/ru/docs/WebAssembly/Reference/JavaScript_interface/Table/set)
  - : Сохраняет указанное значение в таблицу под указанным индексом.

## Примеры

Следующий пример (смотри [исходный код](https://github.com/mdn/webassembly-examples/blob/master/js-api-examples/table2.html) и [живую версию](https://mdn.github.io/webassembly-examples/js-api-examples/table2.html) table2.html) создаёт новый экземпляр WebAssembly Table с 2 элементами. После этого выводит длину таблицы и содержимое первых двух элементов (полученных через [`Table.prototype.get()`](/ru/docs/WebAssembly/Reference/JavaScript_interface/Table/get) чтобы показать что длина равняется 2 и элементы равны {{jsxref("Operators/null", "null")}}.
