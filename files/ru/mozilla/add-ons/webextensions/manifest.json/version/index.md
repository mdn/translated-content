...
Обратите внимание, что [синтаксис ключа `version` для Chrome](https://developer.chrome.com/docs/extensions/reference/manifest/version?hl=ru) более ограниченный, чем у Firefox:
