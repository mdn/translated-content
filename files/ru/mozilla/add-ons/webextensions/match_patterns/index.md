...
> [!NOTE]
> Некоторые браузеры не поддерживают определённые схемы.
> Смотрите [таблицу совместимости с браузерами](#совместимость_с_браузерами) для дополнительной информации.
