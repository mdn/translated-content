...
- [Совместимость дополнений с Australis](/en-US/docs/Mozilla/Firefox/Australis_add-on_compat) - Это существенное изменение темы Firefox, что влияет на большинство расширений, связанных с пользовательским интерфейсом Firefox.
