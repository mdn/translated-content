...
Выше приведён пример [синхронного](/en-US/docs/Glossary/Synchronous) колбэка, поскольку функция `processUserInput` выполняется синхронно.

Колбэки часто используются для продолжения выполнения кода после завершения [асинхронной](/ru/docs/Glossary/Asynchronous) операции - они называются асинхронными колбэками.
...
- [Callback на Wikipedia](<https://en.wikipedia.org/wiki/Callback_(computer_programming)>)
