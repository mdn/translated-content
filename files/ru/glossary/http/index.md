...
Протокол передачи гипертекста (HTTP) является базовым сетевым {{glossary("protocol","протоколом")}}, который позволяет передавать гипермедиа документы в {{glossary("World Wide Web","Web")}} (обычно между браузером и сервером) таким образом, чтобы люди могли их читать. Текущая версия спецификации HTTP называется [HTTP/2](/ru/docs/%D0%A1%D0%BB%D0%BE%D0%B2%D0%B0%D1%80%D1%8C/HTTP_2).
