...
- [Properly Configuring Server MIME Types](/en-US/docs/Properly_Configuring_Server_MIME_Types)
- Детальная информация об использовании [MIME Types](/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types) в контексте Веб.
