...
Система может быть любым продуктом или приложением, с которым должен взаимодействовать конечный пользователь. Например, исследования UX, проведенные на веб-странице, могут продемонстрировать, легко ли пользователям понимать содержимое страницы, легка ли навигация по ней, не возникает ли трудностей в выполнении каких-либо действий и наоборот.
