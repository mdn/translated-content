...
Объявление doctype не зависит от регистра. В примерах кода на MDN принято использовать строчные буквы, но также часто можно встретить вариант записи как "<!DOCTYPE html>"
