...
Контекст приложения - это {{glossary("browsing context","контекст просмотра")}} верхнего уровня, к которому применяется [манифест](/ru/docs/Web/Progressive_web_apps/Manifest).
