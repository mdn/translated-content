...
2.  Выделите это новое имя и нажмите на **значок ссылки** **(![](https://developer.mozilla.org/files/3810/link-icon.png))** в панеле инструментов редактора. Окно "**Обновить ссылку**" откроется с выделенным текстом в поле "**Ссылка на**".
