...
- [Обработка аудио и видео](/ru/docs/Web/Media/Audio_and_video_manipulation)
...
- [Руководство разработчика событий](/ru/docs/Web/Events)
...
- [Веб-разработка под мобильные устройства](/ru/docs/Learn/CSS/CSS_layout/Responsive_Design)
...
- [Прямая и обратная обработка XML](/ru/docs/Web/XML/Parsing_and_serializing_XML)
...
- [Пользовательский ввод и управление](/ru/docs/Learn/Forms/User_input_methods)
