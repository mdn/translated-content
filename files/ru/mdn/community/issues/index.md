...
Конечно, наше писательское сообщество занято, поэтому иногда самый быстрый способ решить проблему с документацией – это исправить её самостоятельно. Дополнительные сведения см. в разделе [создание и редактирование страниц](/ru/docs/MDN/Writing_guidelines/Howto/Creating_moving_deleting).
