...
Теперь, когда вы вошли в систему, изучите список различных типов задач на [основной странице](/ru/docs/MDN/Community). Вы можете взять в работу любую понравившуюся задачу и начать помогать MDN.
...
- Веб-технологии: если вы новичок в HTML, CSS, JavaScript, и т.д., посмотрите наши руководства: [Изучение веб-разработки](/ru/docs/Learn_web_development)
- Открытый код: если вы пока не учавствовали в проектах с открытым исходным кодом, прочтите [основы этикета для проектов с открытым исходным кодом (EN)](/ru/docs/MDN/Community/Open_source_etiquette).
- Git и GitHub: если вы не знакомы с этими инструментами, [GitHub для начинающих (EN)](/ru/docs/MDN/Community/Getting_started) поможет вам изучить основы.
- Структура репозитория MDN: если вы не уверены, какие репозитории редактировать, для внесения изменений в различные части контента MDN, [где всё на MDN? (EN)](/ru/docs/MDN/Community/Our_repositories) укажет правильные места.
