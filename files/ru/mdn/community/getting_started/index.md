...
Теперь, когда вы вошли в систему, изучите список различных типов задач на [основной странице](/ru/docs/MDN/Community/Contributing). Вы можете взять в работу любую понравившуюся задачу и начать помогать MDN.
...
- Git и GitHub: если вы не знакомы с этими инструментами, [GitHub для начинающих (EN)](/ru/docs/MDN/Community/Contributing/Getting_started) поможет вам изучить основы.
- Структура репозитория MDN: если вы не уверены, какие репозитории редактировать, для внесения изменений в различные части контента MDN, [где всё на MDN? (EN)](/ru/docs/MDN/Community/Contributing/Our_repositories) укажет правильные места.
