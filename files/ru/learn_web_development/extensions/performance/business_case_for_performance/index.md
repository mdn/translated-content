...
| Необходимо: | Базовое понимание компьютерной терминологии, знание [клиентской части веб-технологий](/ru/docs/Learn_web_development/Getting_started/Your_first_website), понимание базовых принципов [оптимизации производительности](/ru/docs/Web/Performance). |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
