...
Первый краткий обзор [HTML Forms](/ru/docs/Learn/Forms). Рассмотрим простую HTML-форму с одним текстовым полем для ввода имени некоторой "команды" и связанной с ней меткой:
