...
| Необходимые знания: | Прочтите [Введение в Express](/ru/docs/Learn_web_development/Extensions/Server-side/Express_Nodejs/Introduction). Для следования статьям вам также надо будет [установить среду разработки Node](/ru/docs/Learn_web_development/Extensions/Server-side/Express_Nodejs/development_environment). |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
