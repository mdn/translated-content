...
| Необходимые навыки: | Базовая компьютерная грамотность. Высокое понимание того, как серверный код обрабатывает и отвечает на HTTP-запросы (см. [Client-Server overview](/ru/docs/Learn_web_development/Extensions/Server-side/First_steps/Client-Server_overview)). |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
> [!NOTE]
> Многие другие системы шаблонов используют аналогичный синтаксис, например: Jinja2 (Python), handlebars (JavaScript), moustache (JavaScript) и т. п.
...
> [!NOTE]
> Давайте перейдём к основным веб-сайтам для [Django](https://www.djangoproject.com/) (Python) и [Express](http://expressjs.com/) (Node/JavaScript) и ознакомимся с их документацией и сообществом.
>
...
> [!NOTE]
> Описания взяты (частично) с веб-сайтов фреймворка!
