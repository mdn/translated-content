...
Веб-браузеры взаимодействуют с [веб-серверами](/ru/docs/Learn/Common_questions/Web_mechanics/What_is_a_web_server) при помощи протокола передачи гипертекста ([HTTP](/ru/docs/Web/HTTP)). Когда вы кликаете на ссылку на странице, заполняете форму или производите поиск, браузер отправляет на сервер _HTTP-запрос_.
