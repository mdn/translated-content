...
| Предпосылки | [Django Tutorial Part 2: Creating a skeleton website](/ru/docs/Learn_web_development/Extensions/Server-side/Django/skeleton_website). |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------- |
...
В этом учебнике показано, как определить и получить доступ к моделям на примере [LocalLibrary website](/ru/docs/Learn_web_development/Extensions/Server-side/Django/Tutorial_local_library_website).
