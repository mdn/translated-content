...
- [Введение в Django](/ru/docs/Learn_web_development/Extensions/Server-side/Django/Introduction)
...
- [Установка среды разработки Django](/ru/docs/Learn_web_development/Extensions/Server-side/Django/development_environment)
...
- [Учебник Django: Веб-сайт местной библиотеки](/ru/docs/Learn_web_development/Extensions/Server-side/Django/Tutorial_local_library_website)
...
- [Учебник Django часть 2: Создание скелета веб-сайта](/ru/docs/Learn_web_development/Extensions/Server-side/Django/skeleton_website)
...
- [Учебник Django часть 3: Использование моделей](/ru/docs/Learn_web_development/Extensions/Server-side/Django/Models)
...
- [Учебник Django часть 4: Django admin веб-сайта](/ru/docs/Learn_web_development/Extensions/Server-side/Django/Admin_site)
...
- [Учебник Django часть 5: Создание главной страницы](/ru/docs/Learn_web_development/Extensions/Server-side/Django/Home_page)
...
- [Учебник Django часть 6: Общий список и подробные представления](/ru/docs/Learn_web_development/Extensions/Server-side/Django/Generic_views)
...
- [Учебник Django часть 7: Структура сессий](/ru/docs/Learn_web_development/Extensions/Server-side/Django/Sessions)
...
- [Учебник Django часть 8: Авторизация и права пользователей](/ru/docs/Learn_web_development/Extensions/Server-side/Django/Authentication)
...
- [Учебник Django часть 9: Работа с формами](/ru/docs/Learn_web_development/Extensions/Server-side/Django/Forms)
  - : В этом уроке мы покажем вам, как работать с [HTML Forms](/ru/docs/Learn_web_development/Extensions/Forms) в Django, и в частности, самый простой способ писать формы для создания, обновления и удаления экземпляров модели. В рамках этой демонстрации мы расширим сайт местной библиотеки, чтобы библиотекари могли вносить новые книги, создавать, обновлять и удалять авторов, используя наши собственные формы (а не использовать приложение администратора).
- [Учебник Django часть10: Тестирование веб-приложения Django](/ru/docs/Learn_web_development/Extensions/Server-side/Django/Testing)
...
- [Учебник Django часть 11: Деплой Django на продакшн](/ru/docs/Learn_web_development/Extensions/Server-side/Django/Deployment)
...
- [Безопасность веб-приложений Django](/ru/docs/Learn_web_development/Extensions/Server-side/Django/web_application_security)
...
- [DIY Django мини-блог](/ru/docs/Learn_web_development/Extensions/Server-side/Django/django_assessment_blog)
