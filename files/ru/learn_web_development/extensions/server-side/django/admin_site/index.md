...
| Предусловия: | Сначала завершите: [Руководство часть 3:](/ru/docs/Learn_web_development/Extensions/Server-side/Django/Models) использование моделей. |
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------- |
...
> [!NOTE]
> В строках выше предполагается, что вы приняли вызов создать модель, отражающую естественный язык книги ([см. обучающую статью о моделях](/ru/docs/Learn_web_development/Extensions/Server-side/Django/Models))!
