...
- [Как создавать собственные виджеты форм](/ru/docs/Learn/Forms/How_to_build_custom_form_controls)
...
- [Отправка форм при помощи JavaScript](/ru/docs/Learn/Forms/Sending_forms_through_JavaScript)
