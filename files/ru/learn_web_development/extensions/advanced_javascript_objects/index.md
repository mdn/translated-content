...
Перед тем, как начать изучение данного модуля, Вы должны иметь некоторое представление о HTML и CSS. Мы советуем вам поработать над разделами [Введение в HTML](/ru/docs/Learn/HTML/Introduction_to_HTML) и [Введение в CSS](/ru/docs/Learn/CSS/First_steps) перед изучением этого модуля JavaScript.
...
- [Объектно-ориентированный JavaScript для начинающих](/ru/docs/Learn/JavaScript/Objects/Classes_in_JavaScript)
...
- [Наследование в JavaScript](/ru/docs/Learn/JavaScript/Objects/Classes_in_JavaScript)
