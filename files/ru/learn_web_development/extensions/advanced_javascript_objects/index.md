...
Перед тем, как начать изучение данного модуля, Вы должны иметь некоторое представление о HTML и CSS. Мы советуем вам поработать над разделами [Введение в HTML](/ru/docs/conflicting/Learn_web_development/Core/Structuring_content) и [Введение в CSS](/ru/docs/conflicting/Learn_web_development/Core/Styling_basics) перед изучением этого модуля JavaScript.

Также вам необходимо знать основы JavaScript перед подробным изучением объектов JavaScript. Предварительно поработайте с разделами [Первые шаги в JavaScript](/ru/docs/conflicting/Learn_web_development/Core/Scripting) и [Структурные элементы в JavaScript](/ru/docs/Learn_web_development/Core/Scripting) перед началом изучения данного модуля.

> [!NOTE]
> Если вы работаете за компьютером/планшетом/другим устройством, на котором у вас нет возможности создавать собственные файлы, то можете поработать с примерами кода на платформах онлайн-программирования, таких как [JSBin](https://jsbin.com/) или [Glitch](https://glitch.com/).
...
- [Объектно-ориентированный JavaScript для начинающих](/ru/docs/Learn_web_development/Extensions/Advanced_JavaScript_objects/Classes_in_JavaScript)
...
- [Прототипы объектов](/ru/docs/Learn_web_development/Extensions/Advanced_JavaScript_objects/Object_prototypes)
...
- [Наследование в JavaScript](/ru/docs/Learn_web_development/Extensions/Advanced_JavaScript_objects/Classes_in_JavaScript)
...
- [Практика построения объектов](/ru/docs/Learn_web_development/Extensions/Advanced_JavaScript_objects/Object_building_practice)
...
- [Добавление функциональности к демо с прыгающими шариками](/ru/docs/Learn_web_development/Extensions/Advanced_JavaScript_objects/Adding_bouncing_balls_features)
