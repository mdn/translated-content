...
| Необходимые знания: | Базовая компьютерная грамотность, базовые знания HTML и CSS, знакомство с основами JavaScript (see [First steps](/ru/docs/conflicting/Learn_web_development/Core/Scripting) and [Building blocks](/ru/docs/Learn_web_development/Core/Scripting)) и основами OOJS (см. [Introduction to objects](/ru/docs/Learn_web_development/Core/Scripting/Object_basics)). |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
