...
Для того, чтобы файлы общались друг с другом, вы должны указать файлам путь друг к другу - обычно один файл знает, где находится другой. Чтобы продемонстрировать это, мы вставим немного HTML в наш файл `index.html` и научим его отображать изображение, которое вы выбрали в статье ["Каким должен быть ваш веб-сайт?"](/ru/docs/Learn_web_development/Getting_started/Your_first_website/What_will_your_website_look_like)
