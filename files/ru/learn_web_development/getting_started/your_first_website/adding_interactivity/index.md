...
> [!WARNING]
> Если вы не следили за остальным нашим курсом, [скачайте этот пример кода](https://github.com/mdn/beginner-html-site-styled/archive/gh-pages.zip) и используйте его в качестве стартовой точки.
