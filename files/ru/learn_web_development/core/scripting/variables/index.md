...
> [!NOTE]
> В JavaScript все инструкции кода должны заканчиваться точкой с запятой (;) - ваш код может работать правильно для отдельных строк, но, вероятно, не будет, когда вы пишете несколько строк кода вместе. Попытайтесь превратить написание точки с запятой в привычку.
...
> [!NOTE]
> Не путайте переменную, которая существует, но не имеет значения, с переменной, которая вообще не существует - это разные вещи.
...
> [!NOTE]
> По ссылке можно найти довольно полный список зарезервированных ключевых слов: [Lexical grammar — keywords](/ru/docs/Web/JavaScript/Reference/Lexical_grammar#keywords).
