...
- **Шестнадцатеричная** — 16-ти разрядная, используют 0–9 и потом a–f в каждом столбце. Вы, возможно, уже встречали эти числа, когда задавали [цвет в CSS](/ru/docs/Learn_web_development/Core/Styling_basics/Values_and_units#hexadecimal_values).
