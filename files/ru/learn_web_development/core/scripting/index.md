...
До начала изучения следующего раздела вам нужно тщательно ознакомиться с основами [HTML](/ru/docs/conflicting/Learn_web_development/Core/Structuring_content) и [CSS](/ru/docs/conflicting/Learn_web_development/Core/Styling_basics), так же обязательно прочтите курс "[Первые шаги в JavaScript](/ru/docs/Learn/JavaScript/%D0%9F%D0%B5%D1%80%D0%B2%D1%8B%D0%B5_%D1%88%D0%B0%D0%B3%D0%B8)".

Если устройство на котором вы изучаете данный курс не позволяет создавать/сохранять файлы, в большинстве случаев примеры кода могут быть запущены в таких онлайн приложениях как [CodePen](https://codepen.io/), [JSFiddle](https://jsfiddle.net/) или [Glitch](https://glitch.com/).

## Руководства

- [Принятие решений в вашем коде — условные конструкции](/ru/docs/Learn_web_development/Core/Scripting/Conditionals)
...
- [Зацикливание кода](/ru/docs/Learn_web_development/Core/Scripting/Loops)
...
- [Функции — блоки кода используемые многократно](/ru/docs/Learn_web_development/Core/Scripting/Functions)
...
- [Создай свою функцию](/ru/docs/Learn_web_development/Core/Scripting/Build_your_own_function)
...
- [Функции возвращают значения](/ru/docs/Learn_web_development/Core/Scripting/Return_values)
...
- [Фотогалерея](/ru/docs/Learn_web_development/Core/Scripting/Image_gallery)
