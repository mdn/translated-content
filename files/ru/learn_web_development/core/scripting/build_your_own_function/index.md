...
| Предпосылки: | Базовая компьютерная грамотность, базовое понимание HTML и CSS, [первые шаги в JavaScript](/ru/docs/Learn/JavaScript/First_steps), [Функции — блоки кода используемые многократно](/ru/docs/Learn/JavaScript/Building_blocks/Functions). |
| ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
> [!NOTE]
> Для согласований имён функций нужно следовать тем же правилам, что и [правила именования переменных](/ru/docs/Learn/JavaScript/First_steps/Variables#правила_именования_переменных). Отличить имена функций от имён переменных просто: после имён функций указываются круглые скобки, а после имён переменных их нет.
