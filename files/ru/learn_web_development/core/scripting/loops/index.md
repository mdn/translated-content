...
> [!NOTE]
> цикл все ещё работает так же, как и ожидалось - посмотрите, [как он работает на GitHub](https://mdn.github.io/learning-area/javascript/building-blocks/loops/while.html) (также посмотрите [полный исходный код](https://github.com/ConstantineZz/javaScript/blob/master/while.html)).
