...
<table>
  <tbody>
    <tr>
      ...
      <td>Базовая компьютерная грамотность, базовое понимание <a href="/ru/Learn_web_development/Core/Structuring_content">HTML</a> и <a href="/ru/Learn_web_development/Core/Styling_basics">CSS</a>.</td>
    </tr>
    <tr>
...
Люди с ограниченными возможностями так же разнообразны, как и люди без них, и так же разнообразны их ограничения. Ключевой урок заключается в том, чтобы думать за пределами вашего собственного компьютера и того, как вы используете Интернет, и начать изучать как его используют другие — _вы не ваши пользователи._ Ниже разъясняются основные виды инвалидности, а также любые специальные инструменты, которые используются для доступа к веб-контенту (известные как **ассистивные (вспомогательные) технологии**).
...
К людям с нарушениями зрения относятся незрячие (слепые), слабовидящие и дальтоники. Многие из них пользуются экранными лупами, которые представляют собой либо физические лупы (видеоувеличители), либо программное обеспечение с возможностью масштабирования. Большинство браузеров и операционных систем в наши дни имеют возможность масштабирования.  Некоторые пользоваватели, в частности незрячие люди, используют программы экранного доступа (скринридеры) - программное обеспечение, которое читает цифровой текст вслух или выводит его на брайлевский дисплей. Некоторые примеры программ экранного доступа:
...
Ознакомиться с программами экранного доступа - это хорошая идея; вам также следует установить программу экранного доступа и "поиграть" с ней, чтобы получить представление о том, как она работает. Более подробную информацию об использовании программ экранного доступа можно найти в наших учебниках [учебные пособия по программам экранного доступа](/ru/Learn_web_development/Core/Accessibility/Tooling#screen_readers). В приведённом ниже видеоролике также показан краткий пример того, как это работает.
...
- Может ли мой виджет выбора даты использоваться людьми, использующими скринридеры?
- Если контент обновляется динамически, знают ли об этом слабовидящие посетители?
- Доступны ли кнопки  интерфейса с помощью клавиатуры и сенсорного интерфейса?
