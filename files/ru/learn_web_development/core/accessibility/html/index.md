...
> [!NOTE]
> Для более подробной информации об изображениях и лучших практиках читайте «[Изображения в HTML»](/ru/docs/Learn_web_development/Core/Structuring_content/HTML_images) и «[Адаптивные изображения](/ru/docs/Web/HTML/Responsive_images)».
