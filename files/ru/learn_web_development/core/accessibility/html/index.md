...
| Необходимые знания: | Базовая компьютерная грамотность, базовое понимание HTML (смотрите [Введение в HTML](/ru/docs/Learn/HTML/Introduction_to_HTML)), и понимания, [что такое доступность](/ru/docs/Learn/Accessibility/What_is_accessibility). |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
> [!NOTE]
> Для более подробной информации об изображениях и лучших практиках читайте «[Изображения в HTML»](/ru/docs/Learn/HTML/Multimedia_and_embedding/Images_in_HTML) и «[Адаптивные изображения](/ru/docs/Learn/HTML/Multimedia_and_embedding/Responsive_images)».
