...
В идеале вы должны начать своё учебное путешествие с изучения HTML. Начните с прочтения раздела ["Введение в HTML"](/ru/docs/Learn/HTML/Introduction_to_HTML). Затем вы можете перейти к изучению более продвинутых тем, таких как:
...
Перед тем, как начать эту тему, рекомендуется пройтись по разделу ["Начало работы с вебом"](/ru/docs/Learn/Getting_started_with_the_web), однако это необязательно; многое из того, что описано в статье ["Основы HTML"](/ru/docs/Learn/Getting_started_with_the_web/HTML_basics), также рассматривается и во ["Введении в HTML"](/ru/docs/Learn/HTML/Introduction_to_HTML), причём даже более подробно.
