...
В основах работы с текстом в HTML мы рассмотрели, как [разметить основные типы списков](/ru/docs/Learn_web_development/Core/Structuring_content/Headings_and_paragraphs#lists), но мы не упомянули о третьем типе списков, с которым вы иногда сталкиваетесь, — списке описаний. Назначение этих списков состоит в том, чтобы разметить набор элементов и их описаний, таких как термины и определения или вопросы и ответы. Давайте рассмотрим пример набора терминов и определений:
