...
| Для изучения вам потребуется: | Основы компьютерной грамотности, базовые знания HTML (изучите [Введение в HTML](/ru/docs/conflicting/Learn_web_development/Core/Structuring_content)), основы CSS (изучите [Введение в CSS](/ru/docs/conflicting/Learn_web_development/Core/Styling_basics)), [базовые знания о текстах и шрифтах CSS](/ru/docs/Learn_web_development/Core/Text_styling/Fundamentals). |
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
Первое, что нужно понять, это концепция состояний ссылок — разные состояния в которых могут существовать ссылки, которые могут быть стилизованы используя различные [псевдоклассы](/ru/docs/Learn_web_development/Core/Styling_basics/Basic_selectors#pseudo-classes):
...
И последнее слово — как мы выбрали только внешние ссылки? Ну, если вы пишете свои [HTML ссылки](/ru/docs/Learn_web_development/Core/Structuring_content/Creating_links) правильно, то вы должны были использовать только абсолютные URL для внешних ссылок — гораздо эффективнее использовать относительные ссылки для связи с другими частями вашего сайта. Текст "http" таким образом должен появляться только во внешних ссылках и можем выбрать его при помощи [селектора атрибутов](/ru/docs/Learn_web_development/Core/Styling_basics/Basic_selectors#attribute_selectors): `a[href*="http"]` выбирает элементы {{htmlelement("a")}}, но только если они имеют атрибут [`href`](/ru/docs/Web/HTML/Reference/Elements/a#href) со значением содержащим "http" где-то внутри него.

Ну вот и все — попробуйте посетить секцию активного изучения выше и испытайте этот новый метод!

> [!NOTE]
> Не переживайте если вы ещё не знакомы с [фоном](/ru/docs/Learn_web_development/Core/Styling_basics) и [адаптивным (отзывчивым) веб-дизайном](/ru/docs/Learn_web_development/Core/CSS_layout/Responsive_Design); это объяснено в других местах
