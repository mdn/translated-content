...
> [!NOTE]
> Не переживайте если вы ещё не знакомы с [фоном](/ru/docs/Learn/CSS/Building_blocks) и [адаптивным (отзывчивым) веб-дизайном](/ru/docs/Learn/CSS/CSS_layout/Responsive_Design); это объяснено в других местах
