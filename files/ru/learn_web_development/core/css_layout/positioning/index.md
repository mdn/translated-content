...
Вы достигли конца этой статьи, но помните ли вы самую важную информацию? Вы можете найти дальнейшую проверку что вы усвоили эту информацию прежде чем, отправитесь дальше — см. [Проверьте свои навыки: Позиционирование](/ru/docs/Learn_web_development/Core/CSS_layout/Test_your_skills/Position).
