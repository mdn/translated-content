...
| Необходимые знания: | Основы HTML (изучите [Введение в HTML](/ru/docs/conflicting/Learn_web_development/Core/Structuring_content)), идея о том как работает CSS (изучите [Введение в CSS](/ru/docs/conflicting/Learn_web_development/Core/Styling_basics).) |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
> [!NOTE]
> Значения этих свойств могут принимать любые [единицы](/ru/docs/Learn_web_development/Core/Styling_basics/Values_and_units) которые вы ожидаете по логике: пиксели, мм, rems, %, и т.д.
...
Липкие элементы являются "липкими" относительно ближайшего предка с "прокручивающимся механизмом", который определяется свойством [позиции](/ru/docs/Web/CSS/Reference/Properties/position) его предка.
...
Вы достигли конца этой статьи, но помните ли вы самую важную информацию? Вы можете найти дополнительные тесты, чтобы убедиться, что усвоили эту информацию, прежде чем двигаться дальше в [Проверьте свои навыки: Позиционирование](/ru/docs/Learn_web_development/Core/CSS_layout/Test_your_skills/Position).
...
- [Примеры практического позиционирования](/ru/docs/Learn_web_development/Core/CSS_layout/Practical_positioning_examples), для дополнительных полезных идей
