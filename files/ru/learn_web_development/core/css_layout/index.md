...
1. Иметь общее представление об HTML, как указано в разделе [Вступление в HTML](/ru/docs/conflicting/Learn_web_development/Core/Structuring_content).
2. Ориентироваться в основах CSS, как указано в разделе [Вступление в CSS](/ru/docs/conflicting/Learn_web_development/Core/Styling_basics).
3. Понимать, как [стилизовать блочные элементы](/ru/docs/Learn_web_development/Core/Styling_basics).

> [!NOTE]
> Если вы работаете на компьютере/планшете/других устройствах, где нет возможности создать ваш собственный файл, вы можете попробовать (большую часть) примеры кода в онлайн-программах для написания кода [JSBin](https://jsbin.com/) и [Glitch](https://glitch.com/).
...
- [Введение в CSS вёрстку](/ru/docs/Learn_web_development/Core/CSS_layout/Introduction)
...
- [Нормальный поток](/ru/docs/conflicting/Learn_web_development/Core/CSS_layout/Introduction)
...
- [Позиционирование](/ru/docs/Learn_web_development/Core/CSS_layout/Positioning)
...
- [Мульти-колоночная вёрстка](/ru/docs/Learn_web_development/Core/CSS_layout/Multiple-column_Layout)
...
- [Отзывчивый дизайн](/ru/docs/Learn_web_development/Core/CSS_layout/Responsive_Design)
...
- [Фундаментальное понятие вёрстки](/ru/docs/Learn_web_development/Core/CSS_layout/Fundamental_Layout_Comprehension)
  - : Оценка ваших знаний различных методов вёрстки посредством вёрстки веб-страницы.

## Смотрите также

- [Практические примеры позиционирования](/ru/docs/Learn_web_development/Core/CSS_layout/Practical_positioning_examples)
