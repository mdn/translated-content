...
| Необходимые знания: | Базовая компьютерная грамотность, [основное программное обеспечение](/ru/docs/Learn_web_development/Getting_started/Environment_setup/Installing_software), понимание [работы с файлами](/ru/docs/Learn_web_development/Getting_started/Environment_setup/Dealing_with_files), базовые знания HTML (смотрите [Введение в HTML](/ru/docs/conflicting/Learn_web_development/Core/Structuring_content)), и представление о том, как работает CSS (смотрите [Введение в CSS](/ru/docs/conflicting/Learn_web_development/Core/Styling_basics)). |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| ------------------------------------------------------------------------------------------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Селектор по типу](/ru/docs/Web/CSS/Reference/Selectors/Type_selectors)                           | `h1 { }`            | [Селектор по типу](/ru/docs/conflicting/Learn_web_development/Core/Styling_basics/Basic_selectors#%d0%a1%d0%b5%d0%bb%d0%b5%d0%ba%d1%82%d0%be%d1%80%d1%8b_%d0%bf%d0%be_%d1%82%d0%b8%d0%bf%d1%83)                                          |
| [Универсальный селектор](/ru/docs/Web/CSS/Reference/Selectors/Universal_selectors)                | `* { }`             | [Универсальный селектор](/ru/docs/conflicting/Learn_web_development/Core/Styling_basics/Basic_selectors#%d0%a3%d0%bd%d0%b8%d0%b2%d0%b5%d1%80%d1%81%d0%b0%d0%bb%d1%8c%d0%bd%d1%8b%d0%b9_%d1%81%d0%b5%d0%bb%d0%b5%d0%ba%d1%82%d0%be%d1%80) |
| [Селектор класса](/ru/docs/Web/CSS/Reference/Selectors/Class_selectors)                           | `.box { }`          | [Селекторы классов](/ru/docs/conflicting/Learn_web_development/Core/Styling_basics/Basic_selectors#%d0%a1%d0%b5%d0%bb%d0%b5%d0%ba%d1%82%d0%be%d1%80%d1%8b_%d0%ba%d0%bb%d0%b0%d1%81%d1%81%d0%be%d0%b2)                                    |
| [Селектор ID](/ru/docs/Web/CSS/Reference/Selectors/ID_selectors)                                  | `#unique { }`       | [Селекторы по ID](/ru/docs/conflicting/Learn_web_development/Core/Styling_basics/Basic_selectors#%d0%a1%d0%b5%d0%bb%d0%b5%d0%ba%d1%82%d0%be%d1%80%d1%8b_%d0%bf%d0%be_id)                                                                 |
| [Селектор атрибутов](/ru/docs/Web/CSS/Reference/Selectors/Attribute_selectors)                    | `a[title] { }`      | [Селекторы атрибутов](/ru/docs/Learn_web_development/Core/Styling_basics/Attribute_selectors)                                                                                                                                            |
| [Селектор псевдоклассов](/ru/docs/Web/CSS/Reference/Selectors/Pseudo-classes)                     | `p:first-child { }` | [Псевдоклассы](/ru/docs/Learn_web_development/Core/Styling_basics/Pseudo_classes_and_elements#%d0%a7%d1%82%d0%be_%d1%82%d0%b0%d0%ba%d0%be%d0%b5_%d0%bf%d1%81%d0%b5%d0%b2%d0%b4%d0%be%d0%ba%d0%bb%d0%b0%d1%81%d1%81)                      |
| [Селектор псевдоэлементов](/ru/docs/Web/CSS/Reference/Selectors/Pseudo-elements)                  | `p::first-line { }` | [Псевдоэлементы](/ru/docs/Learn_web_development/Core/Styling_basics/Pseudo_classes_and_elements#%d0%a7%d1%82%d0%be_%d1%82%d0%b0%d0%ba%d0%be%d0%b5_%d0%bf%d1%81%d0%b5%d0%b2%d0%b4%d0%be%d1%8d%d0%bb%d0%b5%d0%bc%d0%b5%d0%bd%d1%82)        |
| [Селектор потомков](/ru/docs/Web/CSS/Reference/Selectors/Descendant_combinator)                   | `article p`         | [Селектор потомков](/ru/docs/Learn_web_development/Core/Styling_basics/Combinators#%d0%a1%d0%b5%d0%bb%d0%b5%d0%ba%d1%82%d0%be%d1%80_%d0%bf%d0%be%d1%82%d0%be%d0%bc%d0%ba%d0%be%d0%b2)                                                    |
| [Селектор дочерних элементов](/ru/docs/Web/CSS/Reference/Selectors/Child_combinator)              | `article > p`       | [Селектор дочерних элементов](/ru/docs/Learn_web_development/Core/Styling_basics/Combinators#%d0%9a%d0%be%d0%bc%d0%b1%d0%b8%d0%bd%d0%b0%d1%82%d0%be%d1%80)                                                                               |
| [Смежные селекторы](/ru/docs/Web/CSS/Reference/Selectors/Next-sibling_combinator)                 | `h1 + p`            | [Смежные селекторы](/ru/docs/Learn_web_development/Core/Styling_basics/Combinators#%d0%a1%d0%bc%d0%b5%d0%b6%d0%bd%d1%8b%d0%b5_%d1%81%d0%b5%d0%bb%d0%b5%d0%ba%d1%82%d0%be%d1%80%d1%8b)                                                    |
| [Селектор братских элементов](/ru/docs/Web/CSS/Reference/Selectors/Subsequent-sibling_combinator) | `h1 ~ p`            | [Селектор братских элементов](/ru/docs/Learn_web_development/Core/Styling_basics/Combinators#%d0%91%d1%80%d0%b0%d1%82%d1%81%d0%ba%d0%b8%d0%b5_%d1%8d%d0%bb%d0%b5%d0%bc%d0%b5%d0%bd%d1%82%d1%8b)                                          |
