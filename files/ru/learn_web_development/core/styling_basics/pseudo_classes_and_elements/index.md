...
- [`:last-child`](/ru/docs/Web/CSS/Reference/Selectors/:last-child)
- [`:only-child`](/ru/docs/Web/CSS/Reference/Selectors/:only-child)
- [`:invalid`](/ru/docs/Web/CSS/Reference/Selectors/:invalid)
...
- [`:hover`](/ru/docs/Web/CSS/Reference/Selectors/:hover) — упоминался выше; он применяется только в том случае, если пользователь наводит указатель мыши на элемент, обычно на ссылку.
- [`:focus`](/ru/docs/Web/CSS/Reference/Selectors/:focus) — применяется только в том случае, если пользователь фокусируется на элементе, используя управление с клавиатуры.
...
Существует пара специальных псевдоэлементов, которые используются вместе со свойством [`content`](/ru/docs/Web/CSS/Reference/Properties/content) для вставки содержимого в документ с помощью CSS.
...
| {{ Cssxref(":blank") }}             | Соответствует [элементу `<input>`](/ru/docs/Web/HTML/Reference/Elements/input), для которого значение ввода является пустым.                                                                                                                                                                                                                                                                                      |
...
| {{ Cssxref(":dir") }}               | Выбирает элемент на основе его направленности (значение атрибута HTML [`dir`](/ru/docs/Web/HTML/Global_attributes/dir) или свойства CSS [`direction`](/ru/docs/Web/CSS/Reference/Properties/direction) ).                                                                                                                                                                                                         |
...
| {{ Cssxref(":lang") }}              | Соответствует элементу, основанному на языке (значение атрибута HTML [lang](/ru/docs/Web/HTML/Reference/Global_attributes/lang)).                                                                                                                                                                                                                                                                                 |
