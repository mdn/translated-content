...
Вместо этого вы можете использовать для проверки такие сайты как [CodePen](https://codepen.io/), [JSFiddle](https://jsfiddle.net/) или [Glitch](https://glitch.com/). Вы можете скопировать HTML и CSS в один из этих онлайн-редакторов и использовать [это изображение](https://mdn.github.io/learning-area/css/introduction-to-css/fundamental-css-comprehension/chris.jpg) для элемента `<img>`.
