...
> [!NOTE]
> Вы можете заметить, что Opera Mini не поддерживает размер шрифта в rem. В конечном итоге он будет устанавливать свой собственный размер шрифта, так что не утруждайте себя кормлением его единицами шрифта.
...
> [!NOTE]
> Если необходимо поддерживать старые браузеры, придётся использовать `em` и сделать немного больше вычислений.
