...
> [!NOTE]
> Прежде чем начать заниматься с примерами, откройте [пример сайта для начинающих](https://mdn.github.io/beginner-html-site-scripted/), с которым мы работали на [предыдущих занятиях](/ru/docs/Learn_web_development/Getting_started/Your_first_website). Вам следует держать его открытым, чтобы выполнить описанные ниже действия.
