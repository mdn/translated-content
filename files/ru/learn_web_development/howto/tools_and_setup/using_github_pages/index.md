...
> [!NOTE]
> Также можно использовать [графический пользовательский интерфейс Git](https://git-scm.com/downloads/guis) для выполнения тех же задач, если неудобно работать с командной строкой.
