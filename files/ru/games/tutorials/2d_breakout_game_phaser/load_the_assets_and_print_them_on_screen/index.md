...
> **Предупреждение:** **Важно:** Если вы храните ваш JavaScript код отдельно от HTML и используете файл для этого, например, `game.js`, тогда вам нужно расположить директорию `img` и JavaScript файл в одной папке, иначе картинка не загрузится.
