...
Диапазон игр, которые вы можете встретить в web поражает и не уступает "нативным" играм, реализованным с использованием языка программирования С++ и Java. Причём это касается не только относительно небольших игр, но и объёмных игр жанра РПГ, 3d шутерах и многом другом. Это уже не аналоги простых карточных игр или многопользовательских социальных играх, реализованных с помощью Flash®, а гораздо более сложные вещи. Благодаря значительным улучшениям языка программирования [JavaScript](/ru/docs/Web/JavaScript) и появлению новых API браузера, вы можете создавать игры, не зависящие от операционной системы. Для их работы необходим только браузер. А иногда, например на устройствах с поддержкой [HTML5](/ru/docs/Glossary/HTML5), таких как [Firefox OS](/ru/docs/Glossary/Firefox_OS), не нужен даже он.
...
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Аудио**   | [Web Audio API](/ru/docs/Web/API/Web_Audio_API)                                                                                                                                                                                                                                        |
| **Графика** | [WebGL](/ru/docs/Web/API/WebGL_API) ([OpenGL ES](https://www.khronos.org/opengles/) 2.0)                                                                                                                                                                                               |
| **Ввод**    | [Touch events](/ru/docs/Web/API/Touch_events), [Gamepad API](/ru/docs/Web/API/Gamepad_API/Using_the_Gamepad_API), датчики устройства, [WebRTC](/ru/docs/Web/API/WebRTC_API), [Full Screen API](/ru/docs/Web/API/Fullscreen_API), [Pointer Lock API](/ru/docs/Web/API/Pointer_Lock_API) |
| **Язык**    | [JavaScript](/ru/docs/Web/JavaScript) (или C/C++ используйте [Emscripten](https://github.com/kripken/emscripten/wiki) для компиляции в JavaScript)                                                                                                                                     |
| **Сеть**    | [WebRTC](/ru/docs/Web/API/WebRTC_API) и/или [WebSockets](/ru/docs/Web/API/WebSockets_API)                                                                                                                                                                                              |
| **Данные**  | [IndexedDB](/ru/docs/Web/API/IndexedDB_API) или "облако"                                                                                                                                                                                                                               |
| **Веб**     | [HTML](/ru/docs/Web/HTML), [CSS](/ru/docs/Web/CSS), [SVG](/ru/docs/Web/SVG) (и многое другое!)                                                                                                                                                                                         |
...
- [XMLHttpRequest](/ru/docs/Web/API/XMLHttpRequest) и [File API](/ru/docs/Web/API/File_and_Directory_Entries_API)
