...
<table class="standard-table">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td><a href="/en-US/docs/JavaScript" title="/en-US/docs/JavaScript">JavaScript</a> (или C/C++ используйте <a href="https://github.com/kripken/emscripten/wiki">Emscripten</a> для компиляции в JavaScript)</td>
  </tr>
  <tr>
...
<dl>
 ...
 <dd>Позволяет создавать высокопроизводительную аппаратно-ускоренную 3D (и 2D) графику из веб-контента. Это веб-реализация <a href="http://www.khronos.org/opengles/">OpenGL ES</a> 2.0.</dd>
