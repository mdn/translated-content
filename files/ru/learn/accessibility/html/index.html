...
<ol>
 <li><strong>Легче разрабатывать</strong> — как сказано выше, вы получаете функциональность «из коробки», плюс проще для восприятия.</li>
...
<pre class="brush: html example-good line-numbers language-html"><code class="language-html">&lt;h1&gt;Мой заголовок&lt;/h1&gt;
...
&lt;p&gt;Это второй подраздел. Думаю, он намного интереснее, чем предыдущий.&lt;/p&gt;</code></pre>
...
<pre class="brush: html example-bad line-numbers  language-html"><code class="language-html">&lt;font size="7"&gt;Мой заголовок&lt;/font&gt;
&lt;br&gt;&lt;br&gt;
...
<pre class="brush: js line-numbers  language-js"><code class="language-js">document.onkeydown = function(e) {
