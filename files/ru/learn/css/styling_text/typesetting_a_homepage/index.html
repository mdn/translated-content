...
<p><strong>Обратите внимание</strong>: Если вы застрянете, то попросите помощи — см. секцию <a href="#оценка_или_дальнейшая_помощь">Оценка или дальнейшая помощь</a> в конце этой страницы.</p>
</div>
