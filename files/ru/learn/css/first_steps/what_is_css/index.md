...
![](https://mdn.mozillademos.org/files/17072/Basic_styling__ru.png)
...
Для конкретного примера давайте вернёмся к модулю Свойства фона и границ — вы можете подумать, что это логично для свойств [`background-color`](/en-US/docs/Web/CSS/background-color) и [`border-color`](/en-US/docs/Web/CSS/border-color), которые будут определены в этом модуле. И Вы правы.
...
Ниже приведена диаграмма данных для CSS свойства [`font-family`](/en-US/docs/Web/CSS/font-family):
