...
<p>Если вы застрянете, попросите нас о помощи — см. раздел <a href="#оценка_и_дальнейшая_помощь">Оценка и дальнейшая помощь</a> в конце страницы.</p>
</div>
