...
<p>Цель этого задания - чтобы вы поработали со свойствами CSS {{CSSxRef("float")}} и {{CSSxRef("clear")}} которые описаны в нашем уроке <a href="/en-US/docs/Learn/CSS/CSS_layout/Floats">Floats</a>. Вы будете работать над тремя небольшими задачами, использующими различные элементы из пройденного материала.</p>
...
<p>Если вы застрянете, попросите нас о помощи — см. раздел <a href="#оценка_или_дальнейшая_помощь">Оценка или дальнейшая помощь</a> в конце страницы</p>
</div>
