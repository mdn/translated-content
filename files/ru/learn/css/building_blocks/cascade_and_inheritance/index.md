...
> **Примечание:** Смотрите {{SectionOnPage("/ru-RU/docs/Web/CSS/Cascade", "Origin of CSS declarations")}} для более подробной информации о каждом из них, и о том, как они работают.
...
| Без селектора, с правилом внутри атрибута {{htmlattrxref("style")}} элемента. | 1      | 0     | 0       | 0       | 1000          |
