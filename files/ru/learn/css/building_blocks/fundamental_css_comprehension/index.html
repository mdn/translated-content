...
<p><img alt="A view of the finished business card, show a reader header and footer, and a darker center panel containing the main details and image." src="business-card.png" style="display: block; margin: 0 auto;"></p>
...
<ul>
 <li><a href="/ru/docs/Learn/CSS/First_steps">Вступление в CSS</a></li>
 <li><a href="/ru/docs/Learn/CSS/First_steps/How_CSS_works">Как работает CSS</a></li>
 <li><a href="/ru/docs/Learn/CSS/First_steps/How_CSS_is_structured">Синтаксис CSS</a></li>
 <li><a href="/ru/docs/Learn/CSS/Building_blocks/Selectors">Введение в селекторы</a></li>
 <li><a href="/ru/docs/Learn/CSS/Building_blocks/Selectors/Type_Class_and_ID_Selectors">Простые селекторы</a></li>
 <li><a href="/ru/docs/Learn/CSS/Building_blocks/Selectors/Attribute_selectors">Селекторы по атрибутам</a></li>
 ...
 <li><a href="/ru/docs/Learn/CSS/Building_blocks/Selectors/Combinators">Комбинаторы и множественные селекторы</a></li>
 <li><a href="/ru/docs/Learn/CSS/Building_blocks/Values_and_units">CSS значения и единицы</a></li>
 <li><a href="/ru/docs/Learn/CSS/Building_blocks/Cascade_and_inheritance">Каскадность и наследование</a></li>
