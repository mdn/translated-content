...
<div class="note">
<p><strong>Note</strong>: Большая часть признаков обсуждаемых в этой статье имеют широкую поддержку в браузерах; мы отметим исключения из этого правила. Если вы хотите больше точных сведений, вам следует обратиться к <a href="/en-US/docs/Web/HTML/Element#forms">HTML forms element reference, </a>и в частости к нашей обширной ссылке <a href="/en-US/docs/Web/HTML/Element/input">&lt;input&gt; types.</a></p>
</div>
...
<ul>
 ...
 <li>Существуют общие характеристики {{htmlattrxref("size","input")}} (физический размер поля) и <a href="/en-US/docs/Web/HTML/Element/input#attr-maxlength" title="/en-US/docs/HTML/Element/input#attr-maxlength">длину</a> (максимальное количество символов, которые может ввести пользователь).</li>
 <li>Они могут быть определены с помощью <a href="/en-US/docs/Web/HTML/Element/input#attr-spellcheck" title="/en-US/docs/HTML/Element/input#attr-spellcheck">spell checking</a>, если браузер поддерживает данную функцию.</li>
</ul>
...
<p><img alt="Screenshots of single line text fields on several platforms." src="all-single-line-text-field.png"></p>
...
<p><img alt="An invalid email input showing the message Please enter an email address." src="email-invalid.png" style="border-style: solid; border-width: 1px; display: block; margin: 0px auto;"></p>
...
<div class="note">
<p><strong>Note</strong>: You can find out more about form validation in the article <a href="/en-US/docs/Learn/Forms/Form_validation">Form data validation</a>.</p>
</div>
...
<div class="note">
<p><strong>Note</strong>: Fields that have special constraints and are in error prevent the form from being sent; in addition, they can be styled so as to make the error clear. We will discuss this in detail in the article: <a href="/en-US/docs/Learn/Forms/Form_validation" title="/en-US/docs/HTML/Forms/Data_form_validation">Data form validation</a>.</p>
</div>
...
<table>
 <tbody>
  <tr>
   ...
   <td><img alt="Screenshot of the datalist element fallback with Safari on Mac OS" src="datalist-safari.png"></td>
  </tr>
  <tr>
   <th scope="row">Firefox 18</th>
   <td><img alt="Screenshot of the datalist element with Firefox on Mac OS" src="datalist-firefox-macos.png"></td>
  </tr>
 </tbody>
</table>
...
<p>HTML forms are able to send files to a server; this specific action is detailed in the article <a href="/en-US/docs/Learn/Forms/Sending_and_retrieving_form_data" title="/en-US/docs/HTML/Forms/Sending_and_retrieving_form_data">Sending and retrieving form data</a>. The file picker widget is how the user can choose one or more files to send.</p>
...
<p>This is a very convenient way to build a "hot map". How these values are sent and retrieved is detailed in the <a href="/en-US/docs/Learn/Forms/Sending_and_retrieving_form_data" title="/en-US/docs/HTML/Forms/Sending_and_retrieving_form_data">Sending and retrieving form data</a> article.</p>
...
<ul>
 ...
 <li><a href="https://www.quirksmode.org/html5/inputs.html" rel="external">HTML5 Tests - inputs</a> on Quirksmode (also <a href="https://www.quirksmode.org/html5/inputs_mobile.html" rel="external">available for mobile</a> browsers)</li>
</ul>
