...
- [Google App Engine](https://cloud.google.com/appengine/ "App Engine - Build Scalable Web & Mobile Backends in Any Language  |  Google Cloud Platform") - это мощная платформа, которая позволяет создавать и запускать приложения в инфраструктуре Google — нужно ли вам создать многоуровневое веб-приложение с нуля или разместить статический веб-сайт. Смотрите [как разместить ваш веб-сайт на Google App Engine](/ru/docs/Learn/Common_questions/How_do_you_host_your_website_on_Google_App_Engine) чтобы узнать больше информации.
