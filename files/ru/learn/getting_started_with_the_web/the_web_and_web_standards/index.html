...
<p dir="ltr">Статья содержит общую информацию о всемирной сети (the Web) — откуда она взялась, что такое веб-стандарты, как они связанны, почему "веб разработчик" отличный карьерный выбор и чему полезному можно научиться изучая этот курс.</p>

<h2 dir="ltr" id="Краткая_история_сети_веб">Краткая история сети веб</h2>

<p dir="ltr">Мы постарались максимально кратко изложить здесь информацию. Если вы более детально заинтересованы в истории веб сети, то попробуйте поискать это в интернете.</p>

<p dir="ltr">В конце 1960-х военные США разработали коммуникационную сеть <a href="/en-US/docs/Glossary/Arpanet">ARPANET</a>. Вполне можно её рассматривать в качестве прародителя современной сети, так как она работала с помощью <a href="https://ru.wikipedia.org/wiki/%D0%9A%D0%BE%D0%BC%D0%BC%D1%83%D1%82%D0%B0%D1%86%D0%B8%D1%8F_%D0%BF%D0%B0%D0%BA%D0%B5%D1%82%D0%BE%D0%B2">коммутации пакетов</a>, и для неё впервые была внедрена сетевая модель <a href="https://ru.wikipedia.org/wiki/TCP/IP">TCP/IP</a>. Эти две технологии послужили основой, на которой затем был построен интернет.</p>

<p dir="ltr">В 1980 году Тим Бернерс-Ли (aka TimBL) написал программу под названием ENQUIRE, которая позволяла устанавливать связь между двумя узлами. Ничего не напоминает?</p>

<p dir="ltr">В 1989 году TimBL выступил в организации <a href="https://ru.wikipedia.org/wiki/%D0%A6%D0%95%D0%A0%D0%9D">ЦЕРН</a> с идеями о методах структурирования, обработке и обмена информацией (<a href="https://www.w3.org/History/1989/proposal.html">Information Management: A Proposal</a>), предложив при этом концепцию "<a href="https://ru.wikipedia.org/wiki/%D0%93%D0%B8%D0%BF%D0%B5%D1%80%D1%82%D0%B5%D0%BA%D1%81%D1%82">гипертекста</a>". Идеи Тима были одобрены и он начал воплощать в реальность свой проект. Современная сеть построена на основании его работ. </p>
