...
<h2 id="Остальные_части_панели_инструментов">Остальные части панели инструментов</h2>

<p>Клиент и сервер, о которых мы рассказали выше, не раскрывают всю суть. Есть много других компонентов, и мы опишем их ниже.</p>

<p>А сейчас давайте представим, что Веб - это дорога. Одна сторона дороги является клиентом, который представляет собой ваш дом. Другая сторона дороги является сервером, который представляет собой магазин. Вы хотите что-то купить в нём.</p>
...
<p>Помимо клиента и сервера, мы также должны уделить внимание:</p>
...
<ul>
 ...
 <li><strong>Файлы компонентов</strong>: сайт состоит из нескольких различных файлов, которые подобны различным отделам с товарами в магазине. Эти файлы бывают двух основных типов:
  <ul>
   <li><strong>Файлы кода</strong>: сайты построены преимущественно на HTML, CSS и JavaScript, хотя вы познакомитесь с другими технологиями чуть позже.</li>
   <li><strong>Материалы</strong>: это собирательное название для всех других вещей, составляющих сайт, такие как изображения, музыка, видео, документы Word и PDF.</li>
  </ul>
 </li>
</ul>

<h2 id="Что_же_на_самом_деле_происходит">Что же на самом деле происходит?</h2>
...
<p>Такой набор чисел называется {{Glossary("IP Address", "IP-адресом")}} и представляет собой уникальное местоположение в Интернете. Впрочем, его не очень легко запомнить, правда? Вот почему изобрели DNS. Это специальные сервера, которые связывают веб-адрес, который вы вводите в браузере (например, "mozilla.org"), с реальным IP-адресом сайта.</p>

<p>Сайты можно найти непосредственно через их IP-адреса. Вы можете найти IP-адрес веб-сайта, введя его домен в инструмент, как <a href="https://www.nslookup.io/website-to-ip-lookup/">IP Checker</a>.</p>
...
<ul>
 <li><a href="/ru/Learn/How_the_Internet_works">Как работает Интернет</a></li>
 <li><a href="https://dev.opera.com/articles/http-basic-introduction/">HTTP — Протокол уровня приложений</a></li>
 <li><a href="https://dev.opera.com/articles/http-lets-get-it-on/">HTTP: Давайте изучим его!</a></li>
 <li><a href="https://dev.opera.com/articles/http-response-codes/">HTTP: Коды ответов</a></li>
</ul>

<h2 id="Благодарность">Благодарность</h2>

<p>Фото улицы: <a href="https://www.flickr.com/photos/kdigga/9110990882/in/photolist-cXrKFs-c1j6hQ-mKrPUT-oRTUK4-7jSQQq-eT7daG-cZEZrh-5xT9L6-bUnkip-9jAbvr-5hVkHn-pMfobT-dm8JuZ-gjwYYM-pREaSM-822JRW-5hhMf9-9RVQNn-bnDMSZ-pL2z3y-k7FRM4-pzd8Y7-822upY-8bFN4Y-kedD87-pzaATg-nrF8ft-5anP2x-mpVky9-ceKc9W-dG75mD-pY62sp-gZmXVZ-7vVJL9-h7r9AQ-gagPYh-jvo5aM-J32rC-ibP2zY-a4JBcH-ndxM5Y-iFHsde-dtJ15p-8nYRgp-93uCB1-o6N5Bh-nBPUny-dNJ66P-9XWmVP-efXhxJ">Street composing</a>, <a href="https://www.flickr.com/photos/kdigga/">Kevin D</a>.</p>
