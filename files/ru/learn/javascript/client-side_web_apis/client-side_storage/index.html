...
<p>Использование Cache и Service Workers - сложная тема, и мы не будем подробно останавливаться на ней в этой статье, хотя приведём простой пример <a href="#offline_asset_storage">Offline asset storage</a> в разделе ниже.</p>
