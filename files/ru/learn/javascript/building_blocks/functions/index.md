...
> [!NOTE]
> Вы можете вставить эти строки в консоль вашего браузера, чтобы посмотреть, как работают эти функции.
...
> [!NOTE]
> Параметры иногда называются аргументами, свойствами или атрибутами.
...
> [!NOTE]
> Если необходимо указать несколько параметров, их разделяют запятыми.
...
> [!NOTE]
> Этот пример можно увидеть в режиме [Live на GitHub](https://mdn.github.io/learning-area/javascript/building-blocks/functions/conflict.html) (см. также [исходный код](https://github.com/mdn/learning-area/tree/master/javascript/building-blocks/functions)).
