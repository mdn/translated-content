...
<h3 id="Стилизация_и_размещение_с_помощью_CSS">Стилизация и размещение с помощью CSS</h3>
...
<ul>
 ...
 <li><a href="/ru/docs/Learn/CSS/Building_blocks">Структурные элементы CSS</a> (35–45 часов чтения/упражнений)</li>
