...
- _**Панель Меню.**_
  ...
  - **Firefox.** Открыть меню ![](https://mdn.mozillademos.org/files/9637/2014-01-10-13-08-08-f52b8c.png) _➤ ![](screenshot_from_2014-11-26_14-24-56.png) _➤ Инструменты разработки, или_ _Инструменты ➤_ _Веб-разработка ➤ Инструменты разработки_
