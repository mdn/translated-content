...
| Перед началом: | Сначала вам следует прочитать [What is accessibility?](/en-US/docs/Learn/Common_questions/Design_and_accessibility/What_is_accessibility), поскольку мы не рассматриваем здесь **доступность** подробно.                                   |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
