...
> [!NOTE]
> Прежде чем начать заниматься с примерами, откройте [пример сайта для начинающих](https://mdn.github.io/beginner-html-site-scripted/), с которым мы работали на [предыдущих занятиях](/en-US/docs/Learn/Getting_started_with_the_web). Вам следует держать его открытым, чтобы выполнить описанные ниже действия.
