...
> **Примечание:** **На заметку:** [Google Maps](https://maps.google.com/) сохраняет вашу историю поиска и посещений. Часто посещаемые или часто вводимые в поиск локации выделяются больше, чем остальные.
>
