...
- `catalog/author/<id>` — Детальная информация для определённого автора со значением первичного ключа равного _`<id>`. Например, `/catalog/author/11`, для автора с `id = 11`.
