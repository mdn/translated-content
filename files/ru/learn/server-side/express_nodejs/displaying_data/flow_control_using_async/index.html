...
<h2 class="highlight-spanned" id="Почему_это_необходимо">Почему это необходимо?</h2>
...
<h2 class="highlight-spanned" id="Параллельные_асинхронные_операции">Параллельные асинхронные операции</h2>
...
<h2 class="highlight-spanned" id="Последовательные_асинхронные_операции">Последовательные асинхронные операции</h2>
...
<h2 class="highlight-spanned" id="Последовательные_зависимые_асинхронные_операции">Последовательные зависимые асинхронные операции</h2>
...
<h2 class="highlight-spanned" id="Установка_async">Установка async</h2>
