...
3.  Запустите скрипт из командной строки, используя node. В качестве параметра укажите URL вашей БД _MongoDB_ (тот самый, которым вы ранее заменили _insert_your_database_url_here_ в\_ \_файле `app.js` ):
