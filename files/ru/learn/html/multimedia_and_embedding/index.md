...
> **Примечание:** **Внимание:** Если вы работаете на компьютере/планшете/другом устройстве, на котором у вас нет возможности создавать файлы, вы можете попробовать сделать упражнения на программирование (большинство из них) в онлайн сервисах, например в [JSBin](http://jsbin.com/) или [Thimble](https://thimble.mozilla.org/).
...
- [Основы Веб-грамотности 2](https://learning.mozilla.org/en-US/activities/web-lit-basics-two/)
