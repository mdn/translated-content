...
<dl>
 <dt>Ремарка</dt>
 <dd><p>В драме: речь персонажа, при которой делается замечание с юмористическим или драматическим эффектом; чаще всего это чувства, мысли или предпосылки к чему-либо.</p>
 <p>В письменности: отметка, примечание (<em>устар.</em>).</p></dd>
</dl>
...
<p>Например, следующая разметка берётся из страницы элемента MDN <code><strong>&lt;blockquote&gt;</strong></code>:</p>
...
<pre class="brush: html">&lt;time datetime="2020-01-20"&gt;20 Января 2020&lt;/time&gt;</pre>
...
&lt;!-- Вызов номера недели --&gt;
&lt;time datetime="2020-W04"&gt;Четвёртая неделя 2020&lt;/time&gt;</pre>
