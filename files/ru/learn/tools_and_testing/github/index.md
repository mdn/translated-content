...
> [!NOTE]
> Github не единственный сайт/инструментарий который можно использовать с Git. Есть и альтернативы, такие как [GitLab](https://about.gitlab.com/), а также можно настроить свой собственный сервер Git и использовать его вместо GitHub. Мы в этом курсе остановились на GitHub, чтобы показать один из рабочих способов.
