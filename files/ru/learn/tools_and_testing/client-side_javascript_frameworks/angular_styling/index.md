...
Angular CLI генерирует два типа файлов стилей:
...
В зависимости от того, используете ли вы препроцессор, расширение ваших CSS-файлов может различаться.
Angular поддерживает простой CSS, SCSS, Sass, Less и Stylus.

В `src/styles.css`, вставьте следующие стили:
...
CSS в `src/styles.css` применяется ко всему приложению, однако эти стили не влияют на всё на странице .
Следующим шагом является добавление стилей, которые применяются конкретно к `AppComponent`.

В `app.component.css`, добавьте следующие стили:
...
Последний шаг - вернуться в браузер и посмотреть, как обновились стили. Теперь все стало немного понятнее.
...
- Angular
  ...
  - [Начало работы с Angular](/en-US/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Angular_getting_started)
  - [Начинаем приложение списка дел с использованием Angular](/en-US/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Angular_todo_list_beginning)
  - [Стилизация Angular приложения](/en-US/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Angular_styling)
