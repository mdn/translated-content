...
<div class="note">
<p><strong>Note</strong>: HTML errors don't tend to show up so easily in dev tools, as the browser will try to correct badly-formed markup automatically; the W3C validator is the best way to get HTML errors — see <a href="#validation">Validation</a> above.</p>
</div>
...
<pre class="brush: html"><code class="language-html">&lt;video id="video" controls preload="metadata" poster="img/poster.jpg"&gt;
