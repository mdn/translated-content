...
> [!WARNING]
> **Важно**: Если свойство или значение не определено, то объявление считается _недействительным_ — и будет попросту проигнорировано.

> [!WARNING]
> **Важно**: В CSS (и прочих веб-стандартах) американское написание является стандартом. Например, `color` надо _всегда_ писать `color`; британский вариант `colour` не будет работать.
