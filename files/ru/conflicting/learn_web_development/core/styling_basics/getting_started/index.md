...
- **Свойства**
  ...
  - : Определяют, какую характеристику вы желаете изменить (например, [`font-size`](/ru/docs/Web/CSS/Reference/Properties/font-size), [`width`](/ru/docs/Web/CSS/Reference/Properties/width), [`background-color`](/ru/docs/Web/CSS/Reference/Properties/background-color)).
