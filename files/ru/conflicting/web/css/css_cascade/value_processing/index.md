...
**Начальное значение**, данное в кратком описании [каждого CSS-свойства](/ru/docs/Web/CSS/Reference) имеет различное значение для [наследуемых и не наследуемых свойств](/ru/docs/Web/CSS/Guides/Cascade/Inheritance).

Для [наследуемых](/ru/docs/Web/CSS/Guides/Cascade/Inheritance#inherited_properties), начальное значение установлено **только** для корневого элемента, если не указано никакого значения для элемента.

Для [ненаследуемых свойств](/ru/docs/Web/CSS/Guides/Cascade/Inheritance#non-inherited_properties) используется начальное значение для **каждого** элемента, даже когда значение для элемента не указано.
