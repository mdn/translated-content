...
此外，`<flex>` 可以作为[弹性长度](/zh-CN/docs/Web/CSS/Reference/Values/flex_value)在 CSS 网格布局中使用。
...
- _[CSS 弹性盒布局模型第一版规范](https://www.w3.org/TR/css-flexbox-1/)_
- CSS 弹性盒子指南：
  - [弹性盒子的基本概念](/zh-CN/docs/Web/CSS/Guides/Flexible_box_layout/Basic_concepts)
  - [弹性盒子与其他布局方法的关系](/zh-CN/docs/Web/CSS/Guides/Flexible_box_layout/Relationship_with_other_layout_methods)
  ...
  - [控制主轴上弹性项目的比率](/zh-CN/docs/Web/CSS/Guides/Flexible_box_layout/Controlling_flex_item_ratios)
