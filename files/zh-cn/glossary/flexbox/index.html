...
---
<p>Flexbox 是 <a href="https://www.w3.org/TR/css-flexbox-1/">CSS Flexible Box Layout Module</a> 的常用名称，这是一种用于在单个维度（行或列）中显示项目的布局模型。</p>
...
<ul>
 ...
 <li>CSS Flexbox Guide: <em><a href="/zh-CN/docs/Web/CSS/CSS_Flexible_Box_Layout/Contrulling_Ratios_of_Flex_Items_Along_the_Main_Ax">Contrulling Ratios of flex items along the main axis</a></em></li>
