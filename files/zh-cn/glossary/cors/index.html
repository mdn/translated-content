...
---
<p><strong>CORS </strong>（Cross-Origin Resource Sharing，跨域资源共享）是一个系统，它由一系列传输的{{Glossary("Header", "HTTP 头")}}组成，这些 HTTP 头决定浏览器是否阻止前端 JavaScript 代码获取跨域请求的响应。</p>

<p><a href="/zh-CN/docs/Web/Security/Same-origin_policy">同源安全策略</a> 默认阻止“跨域”获取资源。但是 CORS 给了 web 服务器这样的权限，即服务器可以选择，允许跨域请求访问到它们的资源。</p>
...
<ul>
 <li>MDN 上的 <a href="/zh-CN/docs/Web/HTTP/CORS">Cross-Origin Resource Sharing (CORS)</a></li>
