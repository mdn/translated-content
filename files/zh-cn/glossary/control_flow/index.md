...
l10n:
  sourceCommit: f2823829ac0cd48e67e1c1b978790a5dce6354d4
---
...
在 {{glossary("JavaScript")}} 或者 {{glossary("PHP")}}（还有很多类似的语言）中存在许多控制结构，比如条件语句、循环和函数。还有部分语句可能被设定为当{{Glossary("Event", "事件")}}发生的时候才执行。
