...
在数据或对象[**包装器**](/zh-CN/docs/Glossary/Wrapper)的概念下，值是对象包装器包含的[**原始值**](/zh-CN/docs/Glossary/Primitive)。在[**变量**](/zh-CN/docs/Glossary/Variable)[**属性**](/zh-CN/docs/Glossary/Property)的概念下，值可以是原始类型或[**对象引用**](/zh-CN/docs/Glossary/Object_reference)。
