...
**有效负荷标头**是一种 {{Glossary("HTTP_header", "HTTP 标头")}}，从一个或多个消息中描述与安全传输和原始资源{{Glossary("Representation header", "表示")}}重建的相关的有效负荷信息。这包括了如消息有效负荷的长度、（对于多部分的消息而言）此有效负荷中承载了资源的哪部分、应用于传输的任意的编码、消息完整性检查等。
...
- [RFC 7231，3.3 节：负荷语义](https://datatracker.ietf.org/doc/html/rfc7231#section-3.3)
