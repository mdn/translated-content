...
自那以后，W3C 几乎放弃了 HTML 而转向 {{glossary("XHTML")}}，并于 2004 年成立了另一个独立的小组 {{glossary("WHATWG")}}。幸运的是，WHATWG 后来又转回来参与了 {{glossary("HTML5")}} 标准的制定，这两个组织在 2008 年发布了第一份草案，并在 2014 年发布了 HTML5 标准的现行版。HTML5 这个术语只是一个指代 [HTML 现行标准](https://html.spec.whatwg.org) 中一组现代 Web 技术的流行用语。
