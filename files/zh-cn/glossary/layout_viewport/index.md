...
**布局视口**是浏览器绘制网页的视口，本质上代表了可见的区域，而{{Glossary("visual viewport", "视觉视口")}}则代表用户显示设备上当前可见的部分。
...
- [两个视区的来历](https://www.quirksmode.org/mobile/viewports.html)（怪异模式）
- MDN 术语{{Glossary("Viewport", "视口")}}
- MDN 术语{{Glossary("Visual viewport", "视觉视口")}}
