...
由于[替换元素](/zh-CN/docs/Web/CSS/Replaced_element)始终建立一个独立的[格式化上下文](/zh-CN/docs/Web/CSS/CSS_display/Introduction_to_formatting_contexts)，任何替换内容的溢出始终是墨水溢出（而非[可滚动溢出](/zh-CN/docs/Learn_web_development/Core/Styling_basics/Overflow)）。
