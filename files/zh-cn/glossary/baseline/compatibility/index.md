...
![带对号标记的蓝色小部件：基线 2022，最新可用。四个浏览器徽标，均带有对号标记。](limited.png)
...
![带叉号的灰色小部件：支持有限。四个浏览器徽标，两个带对号，两个带叉号。](low.png)

如果你看到的是**有限可用**（limited availability）徽章，那么该功能就*不是*基线特性。在依赖该特性之前，请对网站的用户进行更多的研究和测试，或者等待该功能成为基线特性。
