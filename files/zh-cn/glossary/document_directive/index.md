...
{{Glossary("CSP", "内容安全策略")}}中，**文档指令**（document directive）用于 {{HTTPHeader("Content-Security-Policy")}} 标头，支配着应用安全策略的文档的属性或者 [worker](/zh-CN/docs/Web/API/Web_Workers_API) 运行环境的特征。
