...
- {{cssxref("@media")}} [at-规则](/zh-CN/docs/Web/CSS/CSS_syntax/At-rules)：根据媒体查询的结果，有条件地应用[样式表](/zh-CN/docs/Learn_web_development/Core/Styling_basics/What_is_CSS#应用_css_到_dom)的一部分。
