...
<p>选择器例如： "p" (文档中的 p 标签都会拥有绿色字体的样式),  "div.warning" (文档中所有 class 包含 warning 的 div 元素都会有一个看起来像警告框的样式)，"#customized" (id 为 "customized" 的元素中的文本为 16px 高，字体是 Lucida Grande, Arial, Halvetica 等 无衬线字体。)</p>
...
<p>{{EmbedLiveSample("示例", 640, 210)}}</p>

<h2 id="参见">参见</h2>

<ul>
 <li>查看我们的关于选择器的介绍 <a href="/zh-CN/docs/Learn/CSS/Building_blocks/Selectors">CSS 选择器</a></li>
 <li>基础选择器
  <ul>
