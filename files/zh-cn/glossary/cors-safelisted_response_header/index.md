...
_列入 CORS 白名单的响应标头_（CORS-safelisted response header，也被称作“简单相应标头”）是 [CORS](/zh-CN/docs/Web/HTTP/CORS) 响应中可以*安全地*暴露给客户端脚本的 [HTTP 标头](/zh-CN/docs/Web/HTTP/Headers)。只有列入白名单的响应标头才会对网页开放。
