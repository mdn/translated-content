...
DNS（Domain Name System）域名系统，是一个层次化、分散化的互联网连接资源命名系统。DNS 维护着一个{{glossary("domain name","域名")}}列表以及与之相关联的资源（例如 {{Glossary("IP address","IP 地址")}}）。
...
- 在维基百科上的[域名系统](https://zh.wikipedia.org/wiki/Domain_Name_System)
