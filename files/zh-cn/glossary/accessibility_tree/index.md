...
**无障碍树**（Accessible Tree）包含大多数 HTML 元素的与{{Glossary("accessibility", "无障碍")}}相关的信息。
...
截至 2022 年 4 月，**[无障碍对象模型](https://wicg.github.io/aom/explainer.html)**（**AOM**）在 Web 孵化社区群组中仍处于草案形式，目的是实现 API 接口，让无障碍语义的表达更容易，并且可能允许读取计算出的可访问性树。
