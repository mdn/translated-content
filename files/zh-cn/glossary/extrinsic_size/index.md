...
当你使用 [CSS 盒模型](/zh-CN/docs/Learn_web_development/Core/Styling_basics/Box_model) 属性（例如 {{cssxref("width")}}、{{cssxref("height")}}、{{cssxref("block-size")}}、{{cssxref("inline-size")}}、{{cssxref("max-width")}} 和 {{cssxref("min-height")}}）显式设置或约束元素尺寸时，使用的就是外在尺寸。例如，当你设置 `width: 200px` 时，实际上就是在指定外在尺寸。
