...
---
<p><strong>falsy</strong> 值（虚值）是在 {{Glossary("Boolean")}} 上下文中认定为 false 的值。</p>
...
<div class="note">
<p><strong>备注：</strong> 这意味着当 JavaScript 期望一个布尔值，并被给与下面值中的一个时，它总是会被当做 false。</p>
</div>
...
<table>
 ...
 <tbody>
  ...
  <tr>
   <td>"", '', ``</td>
   <td>这是一个空字符串 (字符串的长度为零). JavaScript 中的字符串可用双引号 <code><strong>""</strong></code>, 单引号 <code>''</code>, 或 <a href="/zh-CN/docs/Web/JavaScript/Reference/Template_literals">模板字面量</a> <strong><code>``</code></strong> 定义。</td>
  </tr>
  <tr>
   <td>{{Glossary("null")}}</td>
