...
<p>不应该把 JavaScript 和 <a href="/zh-CN/docs/Web/JavaScript/Guide/Introduction#JavaScript_and_Java">Java</a> 混淆。“Java”和“JavaScript”都是 Oracle 公司在美国和其他国家注册的商标，但是这两种编程语言在语法、语义和使用方面都明显不同。</p>

<p>Brendan Eich（彼时受雇于 Netscape）为服务器端构想的语言 JavaScript，不久便在 1995 年 9 月被加入 Netscape Navigator 2.0。JavaScript 很快获得了成功，而 {{glossary("Microsoft Internet Explorer", "Internet Explorer 3.0")}} 也在 1996 年 8 月，引入了对 JavaScript 的支持，冠以 JScript 之名。</p>
