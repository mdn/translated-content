...
<p><strong>备注：</strong> 当前的 HTTP/1.1 规范中不再提及实体、实体报头和实体的体。这中的有些字段现在被称为表示头字段（<a href="https://datatracker.ietf.org/doc/html/rfc7231#section-3">RFC 7231, section 3: Representations</a>）。</p>
</div>
...
<p>在下面的例子中，{{HTTPHeader("Content-Length")}} 是实体报头，而 {{HTTPHeader("Host")}} 和 {{HTTPHeader("User-Agent")}} 是请求报头。</p>
