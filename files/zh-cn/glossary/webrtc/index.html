...
---
<p><strong>WebRTC</strong> (<em>Web Real-Time Communication</em>) 是一个可以用在视频聊天，音频聊天或 P2P 文件分享等 Web App 中的 {{Glossary("API")}}。</p>

<p>WebRTC 主要由以下几个部分组成：</p>

<dl>
 <dt><a href="/zh-CN/docs/Web/API/Navigator/getUserMedia"><code>getUserMedia</code></a></dt>
 <dd>为一个 RTC 连接获取设备的摄像头与 (或) 麦克风权限，并为此 RTC 连接接入设备的摄像头与 (或) 麦克风的信号。</dd>
