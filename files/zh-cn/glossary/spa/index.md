...
SPA（单页应用，Single-page application）是只加载一个单独网页的 Web 应用的实现。当需要显示不同的内容时，它通过 JavaScript API（例如 {{domxref("XMLHttpRequest")}} 和 [Fetch](/zh-CN/docs/Web/API/Fetch_API)）更新主体内容。
