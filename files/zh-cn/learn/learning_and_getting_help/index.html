...
<p>有趣的是，你的大脑学习东西有两种主要方式——<strong>专注</strong>和<strong>分散学习</strong>：</p>
...
<p><strong>备注：</strong> 上面的文本应该给你一个重要的事实 - 你不应该记住一切！专业的 Web 开发人员使用 MDN Web 文档等工具查找他们一直忘记的内容。正如您会发现，学习 Web 开发更多的是关于问题解决和学习模式，而不是学习大量语法。</p>
</div>
...
<div class="blockIndicator note">
<p><strong>备注：</strong> 在线代码编辑器对于共享您编写的代码也非常有用，例如，如果您正在与不在同一位置的其他人协作学习，或者正在向他人发送代码以寻求帮助。您可以与他们共享代码示例的网址，以便他们可以查看。</p>
</div>

<div class="blockIndicator note">
<p><strong>备注：</strong> 与其他学习方法相比，你可能更喜欢一种学习方法，但实际上，你最终可能得到的是一种混合方法。你可能还会想出另外其他的方法，而不是我们上面提到的三种。</p>
</div>
...
<div class="blockIndicator note">
<p><strong>备注：</strong> 请注意，上面我们讨论了我们首先要解决的问题，然后是用来解决这个问题的技术。这几乎总是最好的方法--不要从一个你看起来很酷但陌生的新技术开始，然后试着把它塞进用例中。</p>
</div>

<div class="blockIndicator note">
<p><strong>备注：</strong> 最简单的解决方案往往是最好的。</p>
</div>
...
<h2 id="Getting_help">寻求帮助</h2>

<p>网络开发需要你学习一套复杂的技能——有时你肯定会陷入困境，需要帮助。正如我们之前所说，即使是专业开发人员在某些时刻也需要让他人来帮助解决问题。</p>

<p>获得帮助的方法有很多种，下面是一些非常有效的方法。</p>

<h3 id="Effective_web_searches">高效的网络搜索</h3>

<p>需要学习的一项重要技能是高效网络搜索的技巧——你需要在你最喜欢的搜索引擎中使用哪些搜索词来找到你需要的文章？</p>
...
<p>如果你想搜索一些没有那么明显的专业术语的东西，你需要考虑最有可能搜索到想要的东西是什么。</p>
...
<div class="blockIndicator note">
<p><strong>备注：</strong> <a href="https：//stackoverflow.com/">Stack Overflow</a> 是一个非常有用的网站——它基本上是一个关于各种技术和相关技术的精心挑选有质量的问题和答案的巨大数据库。你可能会找到一个回答你问题的答案。如果没有，你可以问一个问题，看看是否有人能帮助你。</p>
</div>

<h4 id="Browser_testing">浏览器调试</h4>

<p>看看你的问题是否在所有浏览器中都出现，或者它是否只发生在一个或少数浏览器中，这通常是一个好主意。例如，如果它只影响一个浏览器，则可以使用该浏览器缩小搜索范围。示例搜索可能看起来像：</p>
...
<h3 id="Using_MDN">使用 MDN</h3>

<p>您现在所在的网站上有大量信息可供您使用，既有查找代码语法的参考资料，也有学习技巧的指南/教程。</p>

<p>在 MDN 的这一部分中，我们提供了关于 web 开发基础知识的大部分问题的答案。如果你陷入困境，最好重新阅读相关文章，看看你是否遗漏了什么。</p>

<p>如果你不确定该读哪篇文章，那么尝试在 MDN 中搜索一些相关的关键字（如上所述），或者尝试一般的网络搜索。要在 MDN 上搜索，你可以使用网站内置的搜索功能，或者使用你最喜欢的搜索引擎，在搜索词前面加上“MDN”。例如，“mdn responsive web design“或者”mdn background-color“。</p>

<h3 id="Other_online_resources">其他在线资源</h3>
...
<p>然而，在 Twitter 或 Facebook 等社交网站上寻找有用的群组也是有意义的。寻找讨论你感兴趣的网络开发主题的小组，并加入其中。在 twitter 上关注那些你知道有影响力、聪明或平易近人的人，他们似乎分享了很多有用的建议。</p>

<h3 id="Physical_meetups">线下聚会</h3>

<p>最后，你应该尝试参加一些线下聚会，认识其他志同道合的人，尤其是那些对初学者友好的人。 <a href="https：//www.meetup.com/find/tech/">meetup.com</a> 是一个很好的地方，可以找到当地的身体聚会，你也可以尝试搜索你当地的媒体/网站上的内容。</p>

<p>你也可以尝试参加正式的网络会议。虽然这些费用可能很高，但你可以尝试在那里做志愿者，许多会议都提供优惠票，例如学生票或多样性票。</p>
