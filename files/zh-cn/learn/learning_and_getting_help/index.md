...
另外，网络上有 [开发者工具](/en-US/docs/Learn/Common_questions/What_are_browser_developer_tools)，它使您可以查看用在 web 上构建任何网站的代码。如果你手头没有解决方案，一个好的研究方法是在网络某处地方找到具有类似功能的网站，并找出它们是如何做到的。
