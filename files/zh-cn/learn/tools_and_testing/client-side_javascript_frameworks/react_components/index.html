...
<p><strong>备注：</strong> Components must always return something. If at any point in the future you try to render a component that does not return anything, React will display an error in your browser.</p>
</div>
...
<div class="blockIndicator note">
<p><strong>备注：</strong> <code>ALL_CAPS</code> constant names have no special meaning in JavaScript; they’re a convention that tells other developers "this data will never change after being defined here”.</p>
</div>
...
<div class="blockIndicator note">
<p><strong>备注：</strong> You might notice that we are making the same mistake here as we first made for the <code>&lt;Todo /&gt;</code> component, in that each button will be the same. That’s fine! We’re going to fix up this component later on, in <a href="/en-US/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/React_interactivity_filtering_conditional_rendering#Back_to_the_filter_buttons">Back to the filter buttons</a>.</p>
</div>
