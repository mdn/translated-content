...
<p>现在终于到了使我们的应用程序看起来更好的时候了。在本文中，我们将探讨使用 CSS 样式 Vue 组件的不同方法。</p>
 ...
 <tbody>
  <tr>
   ...
   <td>
    ...
    <p>Vue 组件是由管理应用程序数据的 JavaScript 对象和映射到基础 DOM 结构的基于 HTML 的模板语法组成的。为了进行安装并使用 Vue 的一些更高级的功能（例如“单个文件组件”或渲染功能），您将需要一个装有 node + npm 的终端。</p>
   </td>
  </tr>
  <tr>
   <th scope="row">目的：</th>
...
<h2 id="使用CSS样式化Vue组件">使用 CSS 样式化 Vue 组件</h2>

<p>在继续向我们的应用程序添加更多高级功能之前，我们应该添加一些基本的 CSS 使其看起来更好。Vue 具有三种样式化应用程序的方法：</p>
...
<h2 id="外部CSS文件的样式">外部 CSS 文件的样式</h2>

<p>您可以包括外部 CSS 文件，并将其全局应用于您的应用程序。让我们看看这是如何完成的。</p>

<p>首先，<code>reset.css</code>在<code>src/assets</code>目录中创建一个名为的文件。Webpack 将处理此文件夹中的文件。这意味着我们可以使用 CSS 预处理器（如 SCSS）或后处理器（如 PostCSS）。</p>
...
<p><img alt="已添加部分样式的todo应用程序； 该应用现在位于卡片中，但某些内部功能仍需要样式" src="todo-app-unstyled.png"></p>

<p>后：<img alt="已添加部分样式的todo应用程序； 该应用现在位于卡片中，但某些内部功能仍需要样式" src="todo-app-reset-styles.png"></p>

<p>显着的更改包括删除列表项目符号，更改背景颜色以及更改基本按钮和输入样式。</p>

<h2 id="向单个文件组件添加全局样式">向单个文件组件添加全局样式</h2>

<p>现在，我们已将 CSS 重置为在浏览器之间统一，我们需要对样式进行更多自定义。我们希望将某些样式应用于应用程序中的各个组件。虽然可以直接将这些文件添加到<code>reset.css</code>样式表中，但是我们将它们添加到的<code>&lt;style&gt;</code>标签中，<code>App.vue</code>以演示如何使用它们。</p>
...
<p><img alt="已添加部分样式的todo应用程序； 该应用现在位于卡片中，但某些内部功能仍需要样式" src="todo-app-partial-styles.png"></p>
...
<p><img alt="具有完整样式的待办事项应用程序。 现在可以正确设置输入表单的样式，并且待办事项现在具有间距和自定义复选框" src="todo-app-complete-styles.png"></p>
...
<ul>
 ...
 <li>Ember
  <ul>
   ...
   <li><a href="/en-US/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Ember_structure_componentization">Ember 应用程序的结构和组件化</a></li>
 ...
 <li>斯维尔特
  <ul>
   <li><a href="/en-US/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Svelte_getting_started">Svelte 入门</a></li>
   <li><a href="/en-US/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Svelte_Todo_list_beginning">启动我们的 Svelte Todo 列表应用</a></li>
   <li><a href="/en-US/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Svelte_variables_props">Svelte 中的动态行为：使用变量和道具</a></li>
   <li><a href="/en-US/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Svelte_components">组成我们的 Svelte 应用程序</a></li>
   <li><a href="/en-US/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Svelte_reactivity_lifecycle_accessibility">先进的 Svelte：反应性，生命周期，可访问性</a></li>
   <li><a href="/en-US/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Svelte_stores">与 Svelte 商店合作</a></li>
