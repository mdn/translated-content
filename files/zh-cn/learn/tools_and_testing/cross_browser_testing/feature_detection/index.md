...
<table class="learn-box standard-table">
  <tbody>
    <tr>
      ...
      <td>
        熟悉核心的 <a href="/zh-CN/docs/Learn/HTML">HTML</a>、<a
          ...
          >CSS</a
        >
        以及 <a href="/zh-CN/docs/Learn/JavaScript">JavaScript</a> 语言，以及<a
    ...
    <tr>
      <th scope="row">目标：</th>
      <td>
        了解什么是特性检测的概念，并能够在 CSS 和 JavaScript
        中实现合适的解决方案。
      </td>
    </tr>
  </tbody>
...
<table class="standard-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        See
        <a href="http://diveinto.html5doctor.com/detect.html#video-formats"
    ...
    <tr>
      ...
      <td>
        See
        <a href="http://diveinto.html5doctor.com/detect.html#input-types"
...
> **备注：** You can find a list of what all the class names mean — see [Features detected by Modernizr](https://modernizr.com/docs#features).
