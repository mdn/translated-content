...
<div class="note">
<p><strong>备注：</strong> 关于使用 JavaScript 生成网页的选择，抛开一切非决定性的因素，最终的关键还是我们开发者。<br>
...
<p><strong>备注：</strong> CSS 和 HTML 之间的一个常见问题，就是不同的 CSS 规则之间发生冲突。当您使用第三方代码时，问题可能大到难以修补。例如，你可能正用着一个 CSS 框架，并发现它使用的一个类名与你已经用于某处的类名冲突。或者，您可能会发现，由某种第三方 API（例如生成广告横幅的脚本）生成的 HTML 包含您已经用于别处的类名称或者 ID。<br>
...
<div class="note">
<p><strong>备注：</strong> 在开发工具中，HTML 错误不会直接显示，因为浏览器会尝试自动纠正错误形成的标记；目前，W3C 验证器是获取 HTML 错误的最佳方法——请参阅上面的<a href="/zh-CN/docs/preview-wiki-content#Validation">验证</a>。</p>
</div>
...
<div class="blockIndicator note">
<p><strong>备注：</strong> 请参阅<a href="/zh-CN/docs/preview-wiki-content#IE_conditional_comments">IE 条件注释</a>以获取最佳实践。</p>
</div>
...
<p>{{EmbedGHLiveSample("learning-area/tools-testing/cross-browser-testing/html-css/forms-test", '100%', 150)}}</p>

<div class="note">
<p><strong>备注：</strong> 您也可以在 GitHub 上以<a href="http://mdn.github.io/learning-area/tools-testing/cross-browser-testing/html-css/forms-test.html">forms-test.html 的形式直接</a>看到这个运行（参见<a href="https://github.com/mdn/learning-area/blob/master/tools-testing/cross-browser-testing/html-css/forms-test.html">源代码</a>）。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 你也可以在 GitHub 上浏览这个例子：<a href="https://github.com/mdn/learning-area/blob/master/tools-testing/cross-browser-testing/html-css/button-with-fallback.html">button-with-fallback.html 的形式运行</a>（另见<a href="http://mdn.github.io/learning-area/tools-testing/cross-browser-testing/html-css/button-with-fallback.html">源代码</a>）。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 这同样适用于其他 CSS 功能，如真正的<a href="/en-US/docs/Web/CSS/Media_Queries/Using_media_queries">媒体查询</a>，<a href="/zh-CN/docs/Web/CSS/@font-face">@font-face</a> 以及 <a href="/zh-CN/docs/Web/CSS/@supports">@supports</a> 块 - 如果不支持他们，浏览器只是忽略它们。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> Sitepoint 的 <a href="https://www.sitepoint.com/web-foundations/internet-explorer-conditional-comments/">Internet Explorer 条件注释</a>提供了一个有用的初学者教程/参考，详细解释了条件注释语法。</p>
</div>
...
<pre class="brush: plain">last 2 versions, ie &gt; 9</pre>
...
<div class="note">
<p><strong>备注：</strong> 过去，Web 开发人员使用 reset CSS 删除应用于 HTML 的所有默认浏览器样式，然后将自己的样式应用于顶部的所有样式 - 这样做是为了使项目的样式更加一致，并减少可能的跨浏览器问题，特别是像布局的东西。然而现在它被认为过头了。我们现在最好的等价物是<a href="https://necolas.github.io/normalize.css/">normalize.css</a>，这是一个整齐的 CSS，在默认的浏览器样式上略微增加一点，使事情更加一致，并解决一些布局问题。建议您将 normalize.css 应用于所有的 HTML 页面。</p>
</div>

<div class="note">
<p><strong>备注：</strong> 当试图追踪一个棘手的布局问题，一个好方法是添加一个明亮的颜色<a href="/zh-CN/docs/Web/CSS/outline">outline</a>到有问题的元素，或附近的所有元素。这使得更容易看到一切放置在哪里。请参阅<a href="http://www.otsukare.info/2016/10/05/debugging-css">使用大纲可视化调试您的 CSS 以</a>获取更多详细信息。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> CSS 中还有一个相当新的特性 <a href="/zh-CN/docs/Web/CSS/@supports">@supports</a>，它允许你实现原生特征检测测试。</p>
</div>
