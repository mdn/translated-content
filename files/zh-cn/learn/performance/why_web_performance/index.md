...
Web 性能关乎网站的快速加载，以及让缓慢过程看起来更快。本文将介绍 web 性能对于网站访问者和你的业务目标的重要性。
...
Web 性能及其相关的最佳实践对于网站访问者拥有良好的体验至关重要。从某种意义上说，web 性能可以被认为是[网络可访问性](/zh-CN/docs/Learn/Accessibility) 的一个子集。在性能和可访问性方面，你需要考虑网站访问者使用的设备以及设备的连接速度。
