...
<p>{{Glossary("JavaScript")}} 编程语言允许你在 Web 页面上实现复杂的功能。如果你看到一个网页不仅仅显示静态的信息，而是显示依时间更新的内容，或者交互式地图，或者 2D/3D 动画图像，或者滚动的视频播放器，等等——你基本可以确定，这需要 JavaScript 的参与。</p>

<h2 id="学习路线">学习路线</h2>

<p>很多人认为，与相关技术如 <a href="/zh-CN/docs/Learn/HTML">HTML</a> 和 <a href="/zh-CN/docs/Learn/CSS">CSS</a> 相比，学习 JavaScript 更为困难。在尝试学习 JavaScript 之前，我们强烈建议你首先至少熟悉上述这两种技术，一些其他知识可能也会有帮助。你可以从以下模块开始学习之旅：</p>
...
<ul>
 ...
 <li><a href="/zh-CN/docs/Web/API">Web APIs</a></li>
</ul>
...
<dl>
 ...
 <dt><a href="/zh-CN/docs/Learn/JavaScript/Asynchronous">异步 JavaScript</a></dt>
 <dd>
 <p>这个模块介绍异步 JavaScript：为什么重要，如何用它来处理 可能引起阻塞的操作（比如从服务器获取资源）</p>
 </dd>
...
<h2 id="解决常见的JavaScript问题">解决常见的 JavaScript 问题</h2>

<p><a href="/zh-CN/docs/Learn/JavaScript/Howto">解决常见的 JavaScript 问题</a> 提供一些链接，解释如何使用 JavaScript 来解决创建网页时非常常见的问题。</p>
