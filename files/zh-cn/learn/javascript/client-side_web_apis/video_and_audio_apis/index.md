...
想要使用这个示例的代码来入门，请下载[media-player-start.zip](https://github.com/mdn/learning-area/raw/master/javascript/apis/video-audio/start/media-player-start.zip) 并解压到您的硬盘上的一个新建目录里。如果想要下载[examples repo]()，它位于`javascript/apis/video-audio/start/ `路径下。
