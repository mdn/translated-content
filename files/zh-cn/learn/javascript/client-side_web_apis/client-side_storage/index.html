...
<div class="note">
<p><strong>备注：</strong> 使用客户端存储 API 可以存储的数据量是有限的（可能是每个 API 单独的和累积的总量）;具体的数量限制取决于浏览器，也可能基于用户设置。有关更多信息，获取更多信息，请参考<a href="/zh-CN/docs/Web/API/IndexedDB_API/Browser_storage_limits_and_eviction_criteria">浏览器存储限制和清理标准</a>。</p>
</div>
...
<p><img alt="" src="https://mdn.mozillademos.org/files/15734/cookies-notice.png"></p>
...
<p><img src="web-storage-demo.png"></p>
...
<div class="note">
<p><strong>备注：</strong> 在 <a href="/en-US/docs/Web/API/Web_Storage_API/Using_the_Web_Storage_API">Using the Web Storage API</a> 中还有一个稍微复杂点儿的示例。</p>
</div>

<div class="note">
<p><strong>备注：</strong> 在完成版本的源代码中， <code>&lt;script src="index.js" defer&gt;&lt;/script&gt;</code> 一行里， <code>defer</code> 属性指明在页面加载完成之前，{{htmlelement("script")}}元素的内容不会执行。</p>
</div>
