...
- [What does the `addEventListener()` function do, and how do you use it?](</zh-CN/docs/Learn/JavaScript/Building_blocks/Events#addEventListener()_and_removeEventListener()>)
