...
<p>以下链接指向您需要修复的日常常见问题的解决方案，以使您的 JavaScript 代码正确运行。</p>

<h2 id="初学者常见的错误">初学者常见的错误</h2>

<h3 id="正确的拼写和使用">正确的拼写和使用</h3>

<p>如果你的代码不工作或浏览器抱怨某些东西是未定义的，请检查你是否正确拼写了所有的变量名称，函数名称等。 <br>
  <br>
 导致问题的一些常见的内置浏览器函数有：</p>
...
<p>最常见的错误之一是函数被声明了却没有被调用。例如：</p>

<pre class="brush: js">function myFunction() {
  alert('This is my function.');
};</pre>

<p>这个函数不会执行，除非你调用它，例如：</p>

<pre class="brush: js">myFunction();</pre>

<h4 id="函数作用域">函数作用域</h4>

<p>记住<a href="/en-US/docs/Learn/JavaScript/Building_blocks/Functions#Function_scope_and_conflicts">函数拥有自己的作用域</a>——你不能从函数外部访问一个函数内的变量值，除非你在全局声明了该变量（即不在任何函数内），或者从函数外部获得它的<a href="/en-US/docs/Learn/JavaScript/Building_blocks/Return_values">返回值</a>。</p>

<h4 id="在return语句之后运行代码">在 return 语句之后运行代码</h4>

<p>还要记住，当你向一个函数外部返回一个值时，JavaScript 解释器会退出这个函数——在 return 语句运行之后，没有声明任何代码。</p>

<p>事实上，如果您在返回语句之后有代码，某些浏览器（如 Firefox）会在开发人员控制台中给您一条错误消息。Firefox 在返回语句后给你提示“无法访问的代码”。</p>

<h3 id="对象标记法与正常赋值">对象标记法与正常赋值</h3>

<p>当你在 JavaScript 中正常赋值时，使用等号：</p>

<pre class="brush: js">var myNumber = 0;</pre>

<p>但是在<a href="/en-US/docs/Learn/JavaScript/Objects">对象</a>中，你需要使用冒号来分隔成员名称和值，并用逗号分隔每个成员，例如：</p>
...
<ul>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/What_is_JavaScript#A_high-level_definition">JavaScript 是什么？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Variables#What_is_a_variable">变量是什么？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Strings">字符串是什么？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Arrays#What_is_an_Array">数组是什么？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/Building_blocks/Looping_code">循环是什么？</a></li>
</ul>

<ul>
 <li><a href="/en-US/docs/Learn/JavaScript/Building_blocks/Functions">函数是什么？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/Building_blocks/Events">事件是什么？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/Objects/Basics#Object_basics">对象是什么？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/Objects/JSON#No_really_what_is_JSON">JSON 是什么？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/Client-side_web_APIs/Introduction#What_are_APIs">web API 是什么？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/Client-side_web_APIs/Manipulating_documents#The_document_object_model">DOM 是什么？</a></li>
</ul>
...
<ul>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/What_is_JavaScript#How_do_you_add_JavaScript_to_your_page">怎么在页面中添加 JavaScript?</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/What_is_JavaScript#Comments">怎么在 JavaScript 中添加注释？</a></li>
</ul>

<h3 id="变量">变量</h3>

<ul>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Variables#Declaring_a_variable">如何声明一个变量？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Variables#Initializing_a_variable">如何初始化一个变量的值？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Variables#Updating_a_variable">如何更新变量的值？</a> (参见 <a href="/en-US/docs/Learn/JavaScript/First_steps/Math#Assignment_operators">赋值操作符</a>)</li>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Variables#Variable_types">JavaScript 中有哪些数据类型？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Variables#Loose_typing">'弱类型'是什么意思？</a></li>
</ul>
...
<ul>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Arrays#Creating_an_array">怎么创建数组？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Arrays#Accessing_and_modifying_array_items">如何访问和修改数组中的元素？</a> (包括多维数组)</li>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Arrays#Finding_the_length_of_an_array">怎么获取数组的长度？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Arrays#Adding_and_removing_array_items">怎么添加和移除数组中的元素？</a></li>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/Arrays#Converting_between_strings_and_arrays">如何将一个字符串拆分为数组，或将数组拼接成一个字符串？</a></li>
</ul>

<h3 id="JavaScript_调试">JavaScript 调试</h3>

<ul>
 <li><a href="/en-US/docs/Learn/JavaScript/First_steps/What_went_wrong#Types_of_error">什么是错误的基本类型？</a></li>
 <li><a href="/en-US/docs/Learn/Common_questions/What_are_browser_developer_tools">什么是浏览器开发工具，如何使用它？</a></li>
 <li><a href="/en-US/docs/Learn/Tools_and_testing/Cross_browser_testing/JavaScript#The_Console_API">怎么在 JavaScript 控制台打印值？</a></li>
 <li><a href="/en-US/docs/Learn/Tools_and_testing/Cross_browser_testing/JavaScript#Using_the_JavaScript_debugger">怎么使用断点和其他 JavaScript 调试工具？</a></li>
</ul>
...
<h3 id="面向对象的JavaScript">面向对象的 JavaScript</h3>
