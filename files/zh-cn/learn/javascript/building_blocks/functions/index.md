...
我们建议你使用箭头函数，因为它们可以使你的代码更简短、更易读。要了解更多信息，请参阅 [JavaScript 指南中的有关部分](/zh-CN/docs/Web/JavaScript/Guide/Functions#arrow_functions)，以及我们[有关箭头函数的参考文档](/zh-CN/docs/Web/JavaScript/Reference/Functions/Arrow_functions)。
