...
<p>{{ EmbedLiveSample('一个简单的例子', '100%', 200) }}</p>
...
<div class="note">
<p><strong>备注：</strong> 您可以在<a href="https://github.com/mdn/learning-area/blob/master/javascript/building-blocks/events/random-color-eventhandlerattributes.html">GitHub</a>上找到这个示例的完整源代码 (也可以<a href="http://mdn.github.io/learning-area/javascript/building-blocks/events/random-color-eventhandlerattributes.html">在线运行</a>).</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 您可以在<a href="https://github.com/mdn/learning-area/blob/master/javascript/building-blocks/events/random-color-addeventlistener.html">Github</a>上找到这个示例的完整源代码 (也可以<a href="http://mdn.github.io/learning-area/javascript/building-blocks/events/random-color-addeventlistener.html"> 在线运行</a>)。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 您可以在 Github 上查看这个示例的 <a href="https://github.com/mdn/learning-area/blob/master/javascript/building-blocks/events/random-color-eventobject.html">完整代码</a> ，或者在这里查看 <a href="http://mdn.github.io/learning-area/javascript/building-blocks/events/random-color-eventobject.html">实时演示</a>。</p>
</div>
...
<p>{{ EmbedLiveSample('事件对象', '100%', 400) }}</p>
...
<p>{{ EmbedLiveSample('阻止默认行为', '100%', 140) }}</p>

<div class="note">
<p><strong>备注：</strong> 查看完整的源代码 <a href="https://github.com/mdn/learning-area/blob/master/javascript/building-blocks/events/preventdefault-validation.html">preventdefault-validation.html</a> (也可以 <a href="http://mdn.github.io/learning-area/javascript/building-blocks/events/preventdefault-validation.html">running live</a> )</p>
</div>
...
<p>{{ EmbedLiveSample('事件冒泡及捕获', '100%', 500) }}</p>
...
<pre class="brush: js hidden">const btn = document.querySelector('button');
...
<div class="note">
<p><strong>备注：</strong> 如上所述，默认情况下，所有事件处理程序都是在冒泡阶段注册的，这在大多数情况下更有意义。如果您真的想在捕获阶段注册一个事件，那么您可以通过使用<code><a href="/en-US/docs/Web/API/EventTarget/addEventListener">addEventListener()</a></code>注册您的处理程序，并将可选的第三个属性设置为 true。</p>
</div>
