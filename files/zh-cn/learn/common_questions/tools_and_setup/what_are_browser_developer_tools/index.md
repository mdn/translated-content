...
- [Chrome DOM 检查器](https://developer.chrome.google.cn/docs/devtools/dom?hl=zh-cn)（Opera 的 inspector 和它一样）
...
- [Chrome JavaScript 控制台](https://developer.chrome.google.cn/docs/devtools/console?hl=zh-cn)（Opera 与它相同）
