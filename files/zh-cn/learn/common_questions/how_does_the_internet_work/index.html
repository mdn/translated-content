...
<p><a href="http://en.wikipedia.org/wiki/Internet#History">互联网的历史有些模糊不清</a>。它始于 1960 年美国军方资助的研究项目。1980 年在许多公共大学和公司的支持下，它演变为一种公共基础设施。随着时间的变化，各种各样的技术支持着互联网的发展，但是它的工作方式却没有改变多少：互联网确保所有的电脑之间的连接，无论发生什么他们依旧保持连接。</p>

<h2 id="自主学习">自主学习</h2>

<ul>
 <li><a href="https://www.youtube.com/watch?v=7_LPdttKXPc">五分钟告诉你互联网是如何工作的</a>: Aaron Titus 在五分钟的一个视频中告诉你非常基础的互联网知识。</li>
</ul>
...
<p>当两台电脑需要通信的时候，你必须要连接他们，无论通过有线方式 (通常是<a href="http://en.wikipedia.org/wiki/Ethernet_crossover_cable">网线</a>) 还是无线方式（比如 <a href="http://en.wikipedia.org/wiki/WiFi">WiFi</a> 或 <a href="http://en.wikipedia.org/wiki/Bluetooth">蓝牙</a> )。所有现代电脑都支持这些连接。</p>

<div class="note">
<p><strong>备注：</strong> 接下来的内容，我们将只谈论有线连接， 而无线连接的原理与此相同。</p>
</div>

<p><img alt="Two computers linked together" src="internet-schema-1.png"></p>

<p>通常一个网络不仅限于两台电脑。你可以尽你所想地连接电脑，但是情况立刻变得复杂了。如果你尝试连接，比如说十台电脑，每台电脑有九个插头，总共需要 45 条网线。</p>

<p><img alt="Ten computers all together" src="internet-schema-2.png"></p>

<p>为了解决这个问题，网络上的每台电脑需要链接到一个叫做路由器（<em>router</em>）的特殊小电脑。路由器只干一件事：就像火车站的信号员，它要确保从一台电脑上发出的一条信息可以到达正确的电脑。为了把信息发送给电脑 B，电脑 A 必须把信息发送给路由器，路由器将收到的信息转发给电脑 B，并且确保信息不会发送给电脑 C。</p>
...
<p>这样，我们可以通过电话基础设施相互连接。下一步是把信息从我们的网络发送到我们想要到达的地方。为了做这些，我们需要把我们的网络连接到互联网服务提供商（ISP）。ISP 是一家可以管理一些特殊的路由器的公司，这些路由器连接其他 ISP 的路由器。你的网络消息可以被 ISP 捕获并发送到相应的网络。互联网就是由这些所有的网络设施所组成。</p>

<p><img alt="Full Internet stack" src="internet-schema-7.png"></p>

<h3 id="寻找电脑">寻找电脑</h3>

<p>如果你想给一台电脑发送一条信息，你必须指明它是哪台电脑。因此，任何连接到网络中的电脑都需要有一个唯一的地址来标记它，叫做 "IP 地址" （IP 代表网络协议）。这个地址由四部分被点分隔的数字序列组成，比如：<code>192.168.2.10。</code></p>

<p>对于电脑这样已经很好了，但是人类却很难记忆这一串地址。为了简单处理，我们给 IP 地址取一个容易阅读的别名：域名。比如，<code>google.com</code> 被用于 IP 地址 <code>172.217.7.14。</code>这样我们通过这些域名可以很容易的通过网络连接到电脑。</p>
