...
<p>在这个测验中，我们将测试你对于本模块文章所讨论的技术的掌握程度，让你将一些有关于 Mozilla 的图片和视频添加到一个漂亮的页面上！</p>

<table class="learn-box standard-table">
 <tbody>
  <tr>
   <th scope="row">学习本章节的要求：</th>
   <td>在开始这个测验之前，你应该了解了 <a href="/zh-CN/docs/Learn/HTML/Multimedia_and_embedding">多媒体与嵌入</a> 模块的其他文章。</td>
  </tr>
  <tr>
   <th scope="row">目的：</th>
...
<p>为了开始这次测验，你需要从 <a href="https://github.com/roy-tian/learning-area/tree/master/html/multimedia-and-embedding/mdn-splash-page-start">mdn-splash-page-start</a> 这个 GitHub 目录下下载 HTML 和图片。保存在你本地设备上。</p>
...
<div class="note">
<p><strong>备注：</strong> 这个示例的 HTML 文件包含一些页面的 CSS 样式。你不需要去碰 CSS 的内容，而只是 {{htmlelement("body")}} 元素中的 HTML 部分，只要你插入了正确的标记，样式就会正确显示。</p>
</div>

<h2 id="项目概要">项目概要</h2>

<p>在这个测验中，我们为你呈现了一个接近完成了的 Mozilla 醒目页面，旨在说明一些关于 Mozilla 的有趣的事情，以及提供一些更一步的资源链接。但目前还没有添加任何视频或图片，这份工作就交给你了！你需要添加一些图片、视频等多媒体元素，好让页面变得更漂亮和更有意义。下一小节详细描述了你需要做的工作：</p>
...
<div class="note">
<p><strong>备注：</strong> 你应该在看起来还行的前提下尽量优化 JPG 和 PNG 图片的大小，<a href="https://tinypng.com/">tinypng.com</a>为此提供了很好的服务。</p>
</div>
...
<p>我们希望每张图片（除了某个本身就是响应式的）在浏览器的视口的宽度小于等于 480px 时使用的 120px 宽的图片，其他情况下选择 400px 的版本。</p>

<p>确保正确的链接匹配了正确的图片！</p>

<div class="note">
<p><strong>备注：</strong> 为了正确的测试 <code>srcset</code>/<code>sizes</code> 示例，你需要把你的网站上传到服务器（使用 <a href="/zh-CN/docs/Learn/Common_questions/Using_Github_pages">Github pages</a> 是一个简单免费的方法），访问服务器上的网页，你就可以使用浏览器开发者工具来测试它们是否正常工作，如 <a href="/zh-CN/Learn/HTML/Multimedia_and_embedding/Responsive_images#Useful_developer_tools">响应式图片：有用的开发工具</a>中所说</p>
</div>

<h3 id="一张小熊猫的艺术照">一张小熊猫的艺术照</h3>

<p>在<code>red-panda</code>类的{{htmlelement("div")}} 中，我们希望插入一个{{htmlelement("picture")}}元素，在视口宽度小于等于 600px 时使用那张比较小的纵向的熊猫图片，在其他情况下则使用大的横向的图片。</p>

<h2 id="示例">示例</h2>

<p>下面的截图展示了在正确标记后，醒目页面在宽屏和窄屏下的样子。（可 <a href="https://roy-tian.github.io/learning-area/html/multimedia-and-embedding/mdn-splash-page-finished/">在线查看</a>）</p>
...
<p>如果这个评估是一系列课程的一部分，你应该可以让你的老师或导师为你批改。 如果你是自学，可以很容易地在 <a href="https://discourse.mozilla.org/t/mozilla-splash-page-assignment/24679">discussion thread about this exercise</a>或<a href="https://wiki.mozilla.org/IRC">Mozilla IRC</a>的<a href="irc://irc.mozilla.org/mdn">#mdn</a> IRC 频道回复得到批改指南。请先自己试着做——作弊学不到任何东西！</p>

<h2 id="在这个模块中">在这个模块中</h2>

<ul>
 <li><a href="/zh-CN/docs/Learn/HTML/Multimedia_and_embedding/Images_in_HTML">HTML 中的图片</a></li>
 <li><a href="/zh-CN/docs/Learn/HTML/Multimedia_and_embedding/Video_and_audio_content">音视频内容</a></li>
 <li><a href="/zh-CN/docs/Learn/HTML/Multimedia_and_embedding/Other_embedding_technologies">从&lt;object&gt; 到&lt;iframe&gt; — 其他嵌入技术</a></li>
 <li><a href="/zh-CN/docs/Learn/HTML/Multimedia_and_embedding/Adding_vector_graphics_to_the_Web">给网页添加矢量图</a></li>
 <li><a href="/zh-CN/docs/Learn/HTML/Multimedia_and_embedding/Responsive_images">响应式图片</a></li>
 <li><a href="/zh-CN/docs/Learn/HTML/Multimedia_and_embedding/Mozilla_splash_page">Mozilla 醒目页面</a></li>
</ul>
