...
<div class="note">
<p><strong>备注：</strong> 为了更好地了解客户端—服务器架构是如何工作的，请阅读我们的<a href="/en-US/docs/Learn/Server-side/First_steps">服务器端网站编程的第一个步骤</a>模块。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 可以指定使用 HTTPS(安全 HTTP) 协议的 URL。当您这样做时，数据将与请求的其余部分一起加密，即使表单本身是托管在使用 HTTP 访问的不安全页面上。另一方面，如果表单是在安全页面上托管的，但是您指定了一个不安全的 HTTP URL，它带有{{htmlattrxref("action","form")}}属性，所有的浏览器都会在每次尝试发送数据时向用户显示一个安全警告，因为数据不会被加密。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 你可以在 GitHub 上看到本例子——见 <a href="https://github.com/mdn/learning-area/blob/master/html/forms/sending-form-data/get-method.html">get-method.html</a> (<a href="https://mdn.github.io/learning-area/html/forms/sending-form-data/get-method.html">预览版</a>).</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 你可以在 GitHub 上看到本例—— 见 <a href="https://github.com/mdn/learning-area/blob/master/html/forms/sending-form-data/post-method.html">post-method.html</a> (<a href="https://mdn.github.io/learning-area/html/forms/sending-form-data/post-method.html">预览版</a>).</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 当您将本例加载到本地浏览器中时，这个示例将无法工作---浏览器无法解析 PHP 代码，因此当提交表单时，浏览器只会为您提供下载 PHP 文件。为了让它生效，您需要通过某种类型的 PHP 服务器运行这个示例。本地 PHP 测试的好选择有<a href="https://www.mamp.info/en/downloads/">MAMP</a>(Mac 和 Windows) 和<a href="http://ampps.com/download">AMPPS</a>(Mac、Windows、Linux)。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 向您介绍任何服务器端语言或框架超出了本文的范围。如果你想要学习这些它们，上面的链接会给你一些帮助。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 一些浏览器支持{{HTMLElement("input")}}的{{htmlattrxref("multiple","input")}}属性，它允许只用一个 <code>&lt;input&gt;</code> 元素选择一个以上的文件上传。服务器如何处理这些文件取决于服务器上使用的技术。如前所述，使用框架将使您的生活更轻松。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 我们的<a href="/en-US/docs/Learn/Server-side">服务器端</a>学习主题的<a href="/en-US/docs/Learn/Server-side/First_steps/Website_security">网站安全性文章</a>更详细地讨论了上述威胁和潜在的解决方案。</p>
</div>
