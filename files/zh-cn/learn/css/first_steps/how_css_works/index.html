...
<p>我们已经知道了 CSS 是做什么的以及怎么写简单的样式这样基础的 CSS，接下来我将了解到浏览器如何获取 CSS、HTML 和将他们加载成网页。</p>
...
<table class="learn-box standard-table">
 <tbody>
  ...
  <tr>
   <th scope="row">目标：</th>
   <td>理解浏览器如何加载 CSS 和 HTML、浏览器遇到无法解析的 CSS 会发生什么</td>
  </tr>
 </tbody>
</table>

<h2 id="CSS究竟是怎么工作的？">CSS 究竟是怎么工作的？</h2>
...
<p><img src="rendering.svg"></p>

<h2 id="关于DOM">关于 DOM</h2>
...
<h2 id="一个真实的DOM案例">一个真实的 DOM 案例</h2>

<p>不同于很长且枯燥的案例，这里我们通过一个 HTML 片段来了解 HTML 怎么转化成 DOM</p>
...
<p>{{EmbedLiveSample('一个真实的 DOM 案例', '100%', 55)}}</p>

<div class="hidden">
<pre class="brush: css">p {margin:0;}</pre>
</div>

<h2 id="应用CSS到DOM">应用 CSS 到 DOM</h2>

<p>接下来让我们看看添加一些 CSS 到文件里加以渲染，同样的 HTML 代码：</p>
...
<p>{{EmbedLiveSample('应用 CSS 到 DOM', '100%', 55)}}</p>

<p>在我们下一个模块的 <a href="/en-US/docs/Learn/CSS/Building_blocks/Debugging_CSS">Debugging CSS</a> 文章中我们将会使用 F12 调试 CSS 的问题并且更进一步的了解浏览器如何解析 CSS。</p>

<h2 id="当浏览器遇到无法解析的CSS代码会发生什么">当浏览器遇到无法解析的 CSS 代码会发生什么</h2>

<p>在<a href="/zh-CN/docs/Learn/CSS/First_steps/What_is_CSS#浏览器支持">之前的文章中</a>我们提到了浏览器并不会同时实现所有的新 CSS，此外很多人也不会使用最新版本的浏览器。鉴于 CSS 一直不断的开发，因此领先于浏览器可以识别的范围，那么你也许会好奇当浏览器遇到无法解析的 CSS 选择器或声明的时候会发生什么呢？</p>
...
<p>恭喜你完成本模块，下面的文章你将会<a href="/zh-CN/docs/Learn/CSS/First_steps/Using_your_new_knowledge">使用你的新知识</a>来完成覆盖样式的案例，在这个过程中测试一些 CSS 样式。</p>
...
<ol>
 ...
 <li><a href="/zh-CN/docs/Learn/CSS/First_steps/开始">入门 CSS</a></li>
 <li><a href="/zh-CN/docs/Learn/CSS/First_steps/How_CSS_is_structured">CSS 的结构</a></li>
 <li><a href="/en-US/docs/Learn/CSS/First_steps/How_CSS_works">CSS 如何运行</a></li>
