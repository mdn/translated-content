...
> [!NOTE]
> 如果你在一个无权创建自己文件的电脑/平板/其他设备上工作，你可以在在线编程工具上尝试（大部分）代码示例，如 [JSBin](https://jsbin.com/) 或者 [Glitch](https://glitch.com/) 等。
...
- [为传记页面添加样式](/zh-CN/docs/Learn/CSS/First_steps/Styling_a_biography_page)
  - : 借助你在最近几篇文章中学到的内容，你应该发现可以使用 CSS 格式化简单的文本文档，从而为它们添加自己的样式。该测验为你提供了这样做的机会。
