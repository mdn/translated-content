...
<p>此任务的目的是让您使用在我们的 position 课程中介绍的 CSS {{CSSxRef("position")}}属性以及对应值，您将通过两个小任务来复习刚才课程材料中介绍的不同元素。</p>

<div class="blockIndicator note">
<p><strong>备注：</strong> 您可以在下面的交互式编辑器中尝试解决方案，下载代码并使用在线工具（如 CodePen、jsFiddle 或 Glitch）处理任务可能会有帮助。</p>

<p>如果您遇到困难，请向我们寻求帮助 - 请参阅本页底部的 <a href="#assessment_or_further_help">Assessment or further help</a> 部分</p>
</div>

<h2 id="定位练习一">定位练习一</h2>

<p>在这项任务中，您需要将目标类别为 5px 灰色边框的元素定位到外部容器的右上角。</p>
...
<div class="blockIndicator note">
<p><strong>备注：</strong> 为了评估和进一步编辑，<a href="https://github.com/mdn/css-examples/blob/master/learn/tasks/position/position1-download.html">下载源代码</a>在本地编辑器或在线编辑器中编辑</p>
</div>
...
<div class="blockIndicator note">
<p><strong>备注：</strong> 为了评估和进一步编辑，<a href="https://github.com/mdn/css-examples/blob/master/learn/tasks/position/position2-download.html">下载源代码</a>在本地编辑器或在线编辑器中编辑</p>
</div>
