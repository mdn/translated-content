...
<p>如果您已经完成了这个模块的学习，那么您将已经学习了今天进行 CSS 布局以及使用旧的 CSS 所需的基本知识。</p>
...
<p>我们已经为你提供了一些原始的 html、基本的 css 文件和图像——现在你需要设计一个跟下面图片相似的布局页面。<img src="layout-task-complete.png"></p>

<h3 id="基本步骤">基本步骤</h3>

<p>你可以在这下载基本的 html css 和图片素材 <a href="https://github.com/mdn/learning-area/tree/master/css/css-layout/fundamental-layout-comprehension">here</a>.</p>

<p>将 HTML 文档和 css 保存到你自己计算机的目录中，并将图像添加到名为 images 的文件夹中，在浏览器中打开 index.html 文件应该会给您提供一个具有基本样式但没有布局的页面，该页面应该类似下面所示的图像。</p>

<p>此页面开始于浏览器在正常流中显示的布局的所有内容。</p>

<p><img src="layout-task-start.png"></p>
