...
<p>如果你想给人留下好印象，把信写在一张精美的信纸上会是个不错的开始，在这个评估里我们希望你能创建一个在线模版来达到这样的效果。</p>
...
<ul>
 ...
 <li>给信纸添加一个 1mm 的上下实线边框，选一个符合信纸的颜色主题的边框颜色。</li>
</ul>
...
<p><img src="letterhead.png"></p>

<p> </p>

<h2 id="评估">评估</h2>

<p>如果这个评估是一系列课程的一部分，你应该可以让你的老师或导师为你批改。 如果你是自学，可以很容易地在 <a href="https://discourse.mozilla.org/t/creating-fancy-letterheaded-paper-assessment/24684/1">discussion thread for this exercise</a> 或<a href="https://wiki.mozilla.org/IRC">Mozilla IRC</a>的<a href="irc://irc.mozilla.org/mdn">#mdn</a> IRC 频道回复得到批改指南。请先自己试着做——作弊学不到任何东西！</p>
