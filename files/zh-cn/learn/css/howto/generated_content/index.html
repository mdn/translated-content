...
original_slug: Web/Guide/CSS/Getting_started/Content
---
{{LearnSidebar}}

这是 <a href="/en-US/docs/Web/Guide/CSS/Getting_Started" title="en-US/docs/Web/Guide/CSS/Getting Started">CSS 入门教程</a>的第9部分，介绍了一些通过CSS改变文档内容的方法。这样，仅修改样式表你就能把文本内容及图片添加到文档。</p>
...
<p>下面这条规则在所有类名包含 ref 的元素前面加上 <strong>Reference:</strong></p>
...
<p>下面这条规则在所有类名包含glossary的a标签后面插入一个空格和一个图标：</p>
