...
<p>本文作为本模块的开篇阐述了究竟什么是“可访问性” — 主要包括哪些用户群体是我们所需要和为什么需要考虑的，不同用户使用哪些工具与网页交互，以及我们在网站开发流程中如何构建可访问性。</p>
...
<table class="learn-box standard-table">
 <tbody>
  ...
  <tr>
   <th scope="row">目标：</th>
   <td>熟悉可访问性，包括它是什么，以及它对 web 开发人员的影响。</td>
  </tr>
 </tbody>
</table>
...
<ul>
 <li>
  <p>使用原语 HTML(译注：仅使用非样式标记而样式用 CSS 定义的 HTML 称为原语 HTML。那些描述内容呈现效果的标记如&lt;b&gt;标记是样式标记，这些样式标记在 HTML5 中已经废弃），不仅提升了可访问性，也增强了搜索引擎优化，使你的网站更容易被找到。</p>
 </li>
 <li>
...
<p>残疾人士和正常人一样是多样化的，他们身患的残疾也多种多样。此处课题的关键是抛开思考你自己的电脑和你自己使用网页的方式，而是要开始了解别人如何使用网页——你不是你的用户。接下来会讲解需要考虑的主要残疾类型，以及他们访问网页内容时用到的一些特殊工具 (被称为辅助技术或 ATs)。</p>

<div class="note">
<p><strong>备注：</strong> 世界卫生组织的“残疾和健康”状况说明书指出：“超过 10 亿人，约占世界总人口的 15%，患有某种形式的残疾”，而且“有 1.1 亿至 1.9 亿之间的成年人在身体功能上存在重大困难。”</p>
</div>
...
<ul>
 ...
 <li>有些是免费产品， 比如 <a href="http://www.nvaccess.org/">NVDA</a> (Windows)， <a href="http://www.chromevox.com/">ChromeVox</a> (Chrome, Windows 和 Mac OS X)， 和 <a href="https://wiki.gnome.org/Projects/Orca">Orca</a> (Linux).</li>
 <li>有些内置在操作系统中，比如 <a href="http://www.apple.com/accessibility/osx/voiceover/">VoiceOver</a> (Mac OS X and iOS)， <a href="https://support.microsoft.com/en-us/help/22798/windows-10-narrator-get-started">Narrator</a> (Microsoft Windows)， <a href="http://www.chromevox.com/">ChromeVox</a> (on Chrome OS)，和 <a href="https://play.google.com/store/apps/details?id=com.google.android.marvin.talkback">TalkBack</a> (Android).</li>
</ul>
...
<p>据统计，世界卫生组织估计“全球有 2.85 亿人视力受损：3900 万人失明，2.46 亿人视力低下。”(参见<a href="http://www.who.int/mediacentre/factsheets/fs282/en/">视力障碍和失明</a>)。这是一个庞大而重要的用户群却仅因为你的网站没有合理的设计代码而流失——几乎相当于美国的人口总数。</p>
...
<p>听力受损的人也代表着一个重要的用户群体——“全世界有 4.66 亿人患有听力障碍”，世界卫生组织的耳聋和听力受损状况报告如此宣称。</p>
...
<p>这些残疾通常影响 Web 开发工作的方式是要求通过键盘就可以访问控件——我们将在本模块的后续文章中讨论键盘可访问性，但最好是仅通过使用键盘来尝试访问一些网站，看看你能够做些什么。例如，您可以使用 Tab 键在 Web 表单的不同控件之间移动吗？您可以在我们的“<a href="/zh-CN/docs/Learn/Tools_and_testing/Cross_browser_testing/Accessibility#Using_native_keyboard_accessibility">跨浏览器测试使用本机键盘的可访问性</a>”章节中找到有关键盘控制的更多详细信息。</p>

<p>据统计，有相当多的人患有行动障碍症。美国疾病控制与防御中心的“<a href="https://www.cdc.gov/nchs/fastats/disability.htm">残疾与机能（18 岁及以上的非住院成年人）</a>”报道称美国有 15.1% 的成年人都患有身体功能疾病。</p>
...
<ul>
 ...
 <li>许多有认知障碍的人也可能患有身体残疾。网站必须遵循 W3C 的“<a href="https://www.w3.org/WAI/standards-guidelines/wcag/">网页内容可访问性指南</a>”包括<a href="/en-US/docs/Web/Accessibility/Cognitive_accessibility#Guidelines">认知可访问性指南</a>。</li>
 <li>W3C 的“<a href="https://www.w3.org/WAI/GL/task-forces/coga/">认知和学习残疾无障碍专案组</a>”为认知障碍人士制作了 web 可访问性指南。</li>
 <li>WebAIM 有一个<a href="https://webaim.org/articles/cognitive/">认知网页</a>提供了相关的信息和资源。</li>
 <li>美国疾病控制中心估计，截至 2018 年，美国四分之一的公民有残疾，<a href="https://www.cdc.gov/media/releases/2018/p0816-disability.html">其中认知障碍是年轻人最常见的疾病</a>。</li>
...
<ul>
 ...
 <li>我的 UI 按钮是否可以使用键盘和触碰界面进行访问？</li>
</ul>

<p>您可以并且应该在内容中记下潜在的问题区域，这些地方需要进行一些工作才能使其变得可访问，确保对其进行了彻底的测试并考虑解决方案/替代方法。文本内容（如您将在下一篇文章中看到的）相对容易，但是多媒体内容和时髦的 3D 图形又如何呢？您应该查看项目预算，并考虑可以使用哪些解决方案来实现这类内容的可访问性。转录所有多媒体内容是一种选择，当然成本可能很高。</p>

<p>还有，现实一点。“100% 的可访问性”是一个无法实现的理想——你总是会遇到某种边缘情况，导致某个用户发现某些内容难以使用——但你应该尽你所能去做。如果您计划包含一个使用 WebGL 呈现的时髦三维饼图，您可能希望也包含一个数据表，作为数据的可访问的替代表示。或者，您可能只需要包含表而去除 3D 饼图——这样每个人都可以访问该表，编写起来也更快，还能减少运行时的 CPU 耗费，维护也更容易。</p>

<p>另一方面，如果您正在一个画廊网站上展示有趣的 3D 艺术，期望每件艺术品都能被视觉障碍人士完美的访问是不合理的，毕竟它是一种完全的视觉媒体。</p>

<p>为了表明您关心并考虑了可访问性，请在您的网站上发布可访问性声明，其中详细说明您对可访问性的政策以及为使该站点可访问而采取的步骤。如果有人确实反映您的网站存在可访问性问题，请与他们展开对话，保持同情心，并采取合理的步骤尝试解决问题。</p>

<div class="note">
<p><strong>备注：</strong> 我们的“<a href="/zh-CN/docs/Learn/Tools_and_testing/Cross_browser_testing/Accessibility">处理常见的可访问性问题</a>”一文涵盖了应更详细地测试的可访问性细节。</strong></p>
</div>

<p>总结：</p>

<ul>
 <li>从项目一开始就考虑可访问性，并尽早进行测试。就像任何其他 bug 一样，越晚发现可访问性问题，修复它的代价会更高。</li>
...
<ul>
 <li>首先，W3C 发布了一个庞大而详细的文档，其中包含了非常精确的、与技术无关的可访问性一致性标准。这些被称为 Web 内容可访问性指南 (WCAG)，它们绝不是短读的。这些标准分为四大类，它们指定如何使实现具有可感知性、可操作性、可理解性和鲁棒性。最好的地方得到一个简单的介绍和开始学习是一目了然。没有必要用心学习 WCAG——注意主要关注的领域，并使用各种技术和工具来突出任何不符合 WCAG 标准的区域 (更多信息见下文)。</li>
 <li>贵国还可能有具体立法，规定为其人口提供服务的网站必须能够访问 - 例如，美国“康复法”第 508 条、德国关于无障碍信息技术的联邦法令、联合王国的“平等法”、意大利的“无障碍法”、澳大利亚的“残疾歧视法”等。</li>
</ul>

<p>因此，虽然 WCAG 是一套指导方针，但您的国家可能会有关于网络可访问性的法律，或者至少是对公众提供的服务的无障碍 (包括网站、电视、物理空间等)。找出你的法律是个好主意。如果您不努力检查您的内容是否可访问，您可能会陷入法律的麻烦，如果有二重性的人抱怨它。</p>

<p>这听起来很严肃，但正如上文所述，您只需要将可访问性视为 Web 开发实践的主要优先事项。如果有疑问，请咨询合格的律师。我们不会提供比这更多的建议，因为我们不是律师。</p>

<h2 id="可访问性API">可访问性 API</h2>

<p>Web 浏览器使用特殊的可访问性 API(由底层操作系统提供)，这些 API 公开对辅助技术 (ATS) 有用的信息-ATS 大多倾向于使用原语信息，因此这些信息不包括样式信息或 javascript 之类的内容。此信息是在一个称为可访问性树的信息树中构造的。</p>

<p>不同的操作系统有不同的可访问性 API：</p>
...
<p>如果 Web 应用中的 HTML 元素提供的本机语义信息失效，则可以使用 <a href="https://www.w3.org/TR/wai-aria/">WAI-ARIA specification</a> 的功能来补充该信息，这些功能向辅助功能树添加语义信息以提高可访问性。在 <a href="/en-US/docs/Learn/Accessibility/WAI-ARIA_basics">WAI-ARIA basics</a> 文章中了解有关 WAI-ARIA 的更多详细信息。</p>

<h2 id="摘要">摘要</h2>

<p>本文应该给您提供一个有用的可访问性的高级概述，向您展示为什么它是重要的，并研究如何将它融入您的工作流程。现在，您还应该渴望了解可以使站点可访问的实现细节，我们将在下一节中开始，了解为什么 HTML 是可访问性的良好基础。</p>
...
<ul>
 <li><a href="/zh-CN/docs/">   </a>     <a href="/en-US/docs/Web/Accessibility/Understanding_WCAG">WCAG</a>      
