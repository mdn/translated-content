...
<table class="learn-box standard-table">
 <tbody>
  <tr>
   ...
   <td>基本的计算机素养，对 HTML，CSS 和 JavaScript 的基本理解，<a href="/en-US/docs/Learn/Accessibility/What_is_accessibility">对可访问性</a> 的理解。</td>
  </tr>
  <tr>
   <th scope="row">目的：</th>
...
<p>到目前为止，在这个模块中，我们已经查看了各种内容以及需要做些什么来确保其可访问性，从简单的文本内容到数据表，图像，本机控件（如表单元素和按钮）以及更复杂的标记结构（具有<a href="/en-US/docs/Learn/Accessibility/WAI-ARIA_basics">WAI-ARIA</a>属性）。</p>

<p>另一方面，这篇文章着眼于另一个一般的内容类别，可以说它不容易确保对多媒体的可访问性。图像，视频，<a href="/en-US/docs/Web/HTML/Element/canvas"><code>&lt;canvas&gt;</code></a>元素，Flash 电影等不易被屏幕阅读器理解或被键盘导航，我们需要帮助他们。</p>
...
<p>控件属性提供播放/暂停按钮、搜索栏等 - 您期望从媒体播放器获得的基本控件。它看起来像在 Firefox 和 Chrome:</p>
...
<ul>
 <li>在除 Opera 以外任何浏览器中，它们不可通过键盘访问。</li>
...
<h4 id="JavaScript基本设置">JavaScript 基本设置</h4>
...
<p>这样做，而不是仅仅不包括控件属性摆在首位有一个优势，如果我们的 JavaScript 失败，用户仍然有一些控件可用。</p>
...
<p>在 {{domxref("HTMLMediaElement")}}s 上没有可用的 <code>stop() </code>函数，因此我们改为<code>pause()</code>它，同时将当前时间设置为 0。</p>
...
<div class="note">
<p><strong>备注：</strong> 音频脚本通常有助于多个用户组。除了让聋人用户访问音频中包含的信息外，还考虑一个带宽连接较低的用户，他们会发现下载音频不方便。还要考虑在嘈杂的环境中 (如酒吧或酒吧) 中的用户，他们试图访问信息，但无法通过噪音听到信息。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 文本轨道对于潜在的任何用户也很有用，而不仅仅是那些残障用户。例如，有些用户可能无法听到音频，因为他们处于嘈杂的环境中 (如显示体育游戏时的拥挤的酒吧),或者如果其他人在安静的地方 (如图书馆),则可能不想打扰其他人。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 文本轨道和转录也可以帮助您使用{{glossary("SEO")}},因为搜索引擎在文本上尤其繁荣。文本轨道甚至允许搜索引擎通过视频直接链接到一个点部分。</p>
</div>
