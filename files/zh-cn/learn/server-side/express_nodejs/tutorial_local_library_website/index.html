...
<p>在实战教程第一节中，你将了解要学习哪些内容，对「本地图书馆」示例网站有一个初步的印象 。本章接下来的内容就是逐步完成这个网站。</p>

<table class="learn-box standard-table">
 <tbody>
  <tr>
   <th scope="row">预备知识：</th>
   <td>阅读 <a href="/zh-CN/docs/Learn/Server-side/Express_Nodejs/Introduction">Express 入门</a>。进行以后的小节还需要阅读 <a href="/zh-CN/docs/Learn/Server-side/Express_Nodejs/development_environment">配置 Node 开发环境</a>。</td>
  </tr>
  <tr>
...
<p>你可能已经学过（或之前接触过）其中的部分主题。学完系列教程后，你就拥有足够技能独立开发简单的 Express 应用了。</p>
...
<div class="note">
<p><strong>备注：</strong> 本教程中的代码，已在特定版本（项目的<a href="https://github.com/mdn/express-locallibrary-tutorial/blob/master/package.json"> package.json</a> 所列版本）的 node、Express 及其它模组的环境下通过测试。</p>
</div>
