...
<div class="note">
<p><strong>备注：</strong> Github 上的<a href="https://github.com/ctavan/express-validator#express-validator">express-validator</a>指南，提供了 API 的良好概述。我们建议您阅读该内容，以了解其所有功能（包括创建自定义验证程序）。下面我们只介绍一个对 LocalLibrary 有用的子集。</p>
</div>
