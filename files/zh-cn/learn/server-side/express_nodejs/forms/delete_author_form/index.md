...
<p>运行应用程序，并将浏览器打开，到<a href="http://localhost:3000/">http://localhost:3000/</a>。然后选择所有作者链接<em> All authors</em>，然后选择一个特定作者。最后选择删除作者链接 <em>Delete</em> author。</p>
