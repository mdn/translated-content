...
<div class="note">
<p><strong>备注：</strong> 以下内容将介绍在上述三种 OS 上安装 Node 和 NPM 的最简便方法。对于其它操作系统，以及更多的安装方法，可以参考 <a href="https://nodejs.org/zh-cn/download/package-manager/">通过包管理器方式安装 Node.js</a> (nodejs.org).</p>
</div>
...
<strong>  "dependencies": {
 ...
 <li>可以调用 <code>require()</code> 函数来使用库：
  <pre class="brush: js"><code><strong>const express = require('express');
...
<div class="note">
<p><strong>备注：</strong> "<a href="https://zh.wikipedia.org/wiki/Lint">lint</a>" 是用于对软件进行静态分析的工具，可以发现并报告软件是否遵循某些最佳编程惯例。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> <a href="http://gulpjs.com/">Gulp</a> 和 <a href="http://gruntjs.com/">Grunt</a> 等任务运行器可用于运行测试单元或其它外部工具。</p>
</div>
