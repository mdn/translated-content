...
<div class="note">
<p><strong>备注：</strong> 注意到<code>INSTALLED_APPS已经有许多其他的应用了</code> (还有 <code>MIDDLEWARE</code>, 在 settings 的下面)。这些应用为  <a href="/en-US/docs/Learn/Server-side/Django/Admin_site">Django administration site</a> 提供了支持和许多功能 (包括会话，认证系统等)。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 看 <a href="https://docs.djangoproject.com/en/1.10/topics/migrations/">Migrations</a> (Django docs) ，了解较少使用的迁移命令的其他信息。</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 这个开发网络服务器并不够强大以及不足以用于生产使用，但是它能非常容易得使你在开发期间，获得你的 Django 网站和运行它，以此来进行快速测试。<br>
