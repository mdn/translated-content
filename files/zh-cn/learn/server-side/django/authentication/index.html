...
<ol>
 <li>单击“添加” <strong>Add </strong>按钮（“分组”Group 旁边）以创建新的分组；在分组的名称<strong> Name</strong> ，输入“Library Members”。<img alt="Admin site - add group" src="admin_authentication_add_group.png"></li>
...
<ol>
 <li>回到管理站点的主页</li>
 <li>单击“用户”旁边的“添加”按钮 <strong>Add</strong>，以打开“添加用户”对话框。<img alt="Admin site - add user pt1" src="admin_authentication_add_user_prt1.png"></li>
 ...
 <li>在“分组”（<em>Groups</em>）部分中，从“可用分组”（<em>Available groups</em>）列表中，选择“图书馆成员”分组 <strong>Library Member</strong>，然后点击这些框之间的<strong>右箭头</strong>，将其移动到“选择的分组”（<em>Chosen groups</em>）框中。<img alt="Admin site - add user to group" src="admin_authentication_user_add_group.png"></li>
...
<div class="note">
<p><strong>备注：</strong> 您的文件夹结构，现在应如下所示：<br>
