...
<p>然后再将该 CSS 文件连接至 HTML 文档，否则 CSS 代码不会对 HTML 文档在浏览器里的显示效果有任何影响。（如果你没有完成前几节的实践，请复习 <a href="/zh-CN/docs/Learn/Getting_started_with_the_web/Dealing_with_files">处理文件</a> 和 <a href="/zh-CN/docs/Learn/Getting_started_with_the_web/HTML_basics">HTML 基础</a>。）</p>
...
<p><img alt="测试页面，文字设置为红色" src="website-screenshot-styled.png">如果段落文字变红，那么祝贺你，你已经成功地迈出了 CSS 学习的第一步。</p>

<h3 id="“CSS_规则集”详解">“CSS 规则集”详解</h3>

<p>让我们来仔细看一看上述 CSS：</p>

<p><img alt="图解CSS声明" src="css-declaration-small.png"></p>
...
<p><strong>备注：</strong> 再一次说明，中文字体文件较大，不适合直接用于 Web Font。</p>
</div>
...
<ol>
 ...
 <li>
  ...
  <div class="note">
  <p><strong>备注：</strong> CSS 文档中所有位于 <code>/*</code> 和 <code>*/</code> 之间的内容都是 CSS 注释，它会被浏览器在渲染代码时忽略。你可以在这里写下对你现在要做的事情有帮助的笔记。</p>
  </div>

  <div class="note">
  <p><strong>备注：</strong> <code>/*</code><code>*/</code> 不可嵌套，<code>/*这样的注释是/*不行*/的*/</code>。CSS 不接受 <code>//</code> 注释。</p>
  </div>
 </li>
...
<p><img alt="测试页面，设置了文字间距和行间距等格式。" src="website-screenshot-font-small.png"></p>
...
<p>这条规则将整个页面的背景颜色设置为 <a href="/zh-CN/docs/Learn/Getting_started_with_the_web/What_will_your_website_look_like">所计划的颜色</a>。</p>
...
<div class="note">
<p><strong>备注：</strong> 以上说明假定所选图片小于页面宽度（600 pixels）。更大的图片会溢出 body 并占据页面的其他位置。要解决这个问题，可以：<br>
...
<div class="note">
<p><strong>备注：</strong> 如果你暂时不能理解 <code>display: block</code> 和块级元素与行内元素的差别也没关系；随着你对 CSS 学习的深入，你将明白这个问题。<code>display</code> 属性的更多信息请查看 <a href="/zh-CN/docs/Web/CSS/display">参考页面</a> 。</p>
</div>
...
<p><img alt="测试页面，设置了标题、正文字体，图片居中，背景色、文字块颜色。" src="website-screenshot-final.png"></p>
