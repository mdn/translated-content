...
<h4 id="寻找主机服务和域名的建议">寻找主机服务和域名的建议</h4>
...
<p>有许多 web 应用能够仿真一个网站开发环境。你可以在这种应用——通常只有一个标签页——里输入 HTML、CSS 和 JavaScript 代码然后像显示网页一样显示代码的结果。通常这些工具都很简单，对学习很有帮助，而且至少有免费的基本功能，它们在一个独特的网址显示你提交的网页。不过，这些应用的基础功能很有限，而且应用通常不提供空间来存储图像等内容。</p>
...
<p><img src="jsbin-screen.png"></p>

<h2 id="通过GitHub发布">通过 GitHub 发布</h2>

<p>现在，让我们通过 Github 页面告诉你公布的你的代码是如此的简单。</p>

<ol>
 <li>首先， <a href="https://github.com/join">注册一个 GitHub 账号，</a> 并确认你的邮箱地址。</li>
 <li>接下来，你需要创建一个新的资源库 ( repository ) 来存放你的文件。</li>
 <li>在这个页面上，在 <em>Repository name</em> 输入框里输入  <em>username</em>.github.io，username 是你的用户名。比如，我们的朋友 bobsmith 会输入  <em>bobsmith.github.io。同时勾选</em>  <em>Initialize this repository with a README</em> ，然后点击 <em>Create repository</em>。<img src="github-create-repo.png"></li>
 <li>然后，将你的网站文件夹里的内容拖拽到你的资源库 ( repository )，再点击 <em>Commit changes</em> 。
  <div class="note">
  <p><strong>备注：</strong> 确保你的文件夹有一个 <em>index.html</em> 文件。</p>
  </div>
 </li>
 <li>
  <p>现在将你的浏览器转到 <em>username</em>.github.io 来在线查看你的网站。比如，<em>如果用户名为 chrisdavidmills</em>, 请转到 <a href="http://chrisdavidmills.github.io/">chrisdavidmills.github.io</a>。</p>

  <div class="note">
  <p><strong>备注：</strong> 你的网站可能需要几分钟的时间才能投入使用。如果它不能立即工作，你可能需要等待几分钟，然后再试一次。</p>
  </div>
 </li>
</ol>
