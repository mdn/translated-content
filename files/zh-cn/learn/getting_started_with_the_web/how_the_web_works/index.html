...
<div>
<p>这篇文章简单描述了你在计算机或手机上通过浏览器访问网页时发生了什么。</p>
</div>

<p>这个理论在短期内对你编写网页代码不会有实质性的帮助，但是不久之后你就会真正受益于理解了后台究竟发生了什么。</p>

<h2 id="客户端和服务器">客户端和服务器</h2>

<p>连接到互联网的计算机被称作客户端和服务器。下面是一个简单描述它们如何交互的图表：</p>

<p><img alt="" src="https://mdn.mozillademos.org/files/8973/Client-server.jpg"></p>

<ul>
 <li>客户端是典型的 Web 用户入网设备（比如，你连接了 Wi-Fi 的电脑，或接入移动网络的手机）和设备上可联网的软件（通常使用像 Firefox 和 Chrome 的浏览器）。</li>
 <li>服务器是存储网页，站点和应用的计算机。当一个客户端设备想要获取一个网页时，一份网页的拷贝将从服务器上下载到客户端机器上来在用户浏览器上显示。</li>
</ul>

<h2 id="其他部分">其他部分</h2>

<p>我们讲的客户端和服务器并不能完成全部工作。还有其他必要的部分，我们将在下面讲述。</p>

<p>现在，让我们假设 Web 就是一条路。路的一端是客户端，就像你的家。另一端则是服务器，就像你想去的商店。</p>

<p><img src="road.jpg"></p>

<p>除了客户端和服务器，我们还需要了解：</p>

<div class="note notecard">
<p><strong>备注：</strong> 我感觉下面的比喻还不是很契合。我感觉再合理一点的比喻：</p>
...
<ul>
 ...
 <li><strong>HTTP</strong>: 超文本传输协议是一个定义客户端和服务器间交流的语言的协议（{{Glossary("Protocol" , "protocol")}} ）。就像你下订单时所说的话一样。</li>
...
<p>当你在浏览器里输入一个网址时（在我们的例子里就是走向商店的路上时）：</p>
...
<h2 id="DNS解析">DNS 解析</h2>

<p>真正的网址看上去并不像你输入到地址框中的那样美好且容易记忆。它们是一串数字，像 63.245.217.105。</p>

<p>这叫做 IP 地址，它代表了一个互联网上独特的位置。然而，它并不容易记忆，不是吗？那就是域名系统（DNS）被发明的原因。它们是将你输入浏览器的地址（像 "mozilla.org"）与实际 IP 地址相匹配的特殊的服务器。</p>

<p>网页可以通过  {{Glossary("IP Address", "IP 地址")}}直接访问。您可以通过在 <a href="https://www.nslookup.io/website-to-ip-lookup/">IP Checker</a> 等工具中输入域名来查找网站的 IP 地址。</p>

<p><img alt="A domain name is just another form of an IP address" src="https://mdn.mozillademos.org/files/8405/dns-ip.png"></p>

<h2 id="数据包详解">数据包详解</h2>

<p>前面我们用“包”来描述了数据从服务器到客户端传输的格式。这是什么意思？基本上，当数据在 Web 上传输时，是以成千上万的小数据块的形式传输的。大量不同的用户都可以同时下载同一个网页。如果网页以单个大的数据块形式传输，一次就只有一个用户下载，无疑会让 Web 非常没有效率并且失去很多乐趣。</p>

<h2 id="扩展阅读">扩展阅读</h2>

<ul>
 <li><a href="/zh-CN/docs/learn/How_the_Internet_works">互联网是如何工作的</a></li>
 <li><a href="https://dev.opera.com/articles/http-basic-introduction/">HTTP — 一种应用级协议</a></li>
 <li><a href="https://dev.opera.com/articles/http-lets-get-it-on/">HTTP: 让我们开始吧！</a></li>
 <li><a href="https://dev.opera.com/articles/http-response-codes/">HTTP: 响应代码</a></li>
</ul>

<h2 id="感谢">感谢</h2>

<p>街景照片 : <a href="https://www.flickr.com/photos/kdigga/9110990882/in/photolist-cXrKFs-c1j6hQ-mKrPUT-oRTUK4-7jSQQq-eT7daG-cZEZrh-5xT9L6-bUnkip-9jAbvr-5hVkHn-pMfobT-dm8JuZ-gjwYYM-pREaSM-822JRW-5hhMf9-9RVQNn-bnDMSZ-pL2z3y-k7FRM4-pzd8Y7-822upY-8bFN4Y-kedD87-pzaATg-nrF8ft-5anP2x-mpVky9-ceKc9W-dG75mD-pY62sp-gZmXVZ-7vVJL9-h7r9AQ-gagPYh-jvo5aM-J32rC-ibP2zY-a4JBcH-ndxM5Y-iFHsde-dtJ15p-8nYRgp-93uCB1-o6N5Bh-nBPUny-dNJ66P-9XWmVP-efXhxJ">Street composing</a>, by <a href="https://www.flickr.com/photos/kdigga/">Kevin D</a>.</p>
