...
- 学习区旨在让你实现从“萌新”到“舒适”（而非“萌新”到“专家”）的蜕变，并帮助你学会如何利用更多进一步的资源（例如 [MDN 的其他内容](/zh-CN)）。
...
如果出错，可以使用 Playground 的重置按钮清除你的操作。如果实在卡住了，通常可以在每道题的底部查看参考答案，或[联系我们](#联系我们)。

> [!NOTE]
> 如果你更喜欢在自己的编辑器或在线编辑器（如 [CodePen](https://codepen.io/) 或 [JSFiddle](https://jsfiddle.net/)）中操作，你也可以将 Playground 的代码复制到你选择的环境中。

有些问题没有提供起始代码块，而是让你下载起始文件并在本地操作完成。这通常是因为问题较为复杂，或者我们希望你换种方式练习。

## 获取我们的代码示例

你在学习区遇到的所有代码示例都[托管在 GitHub 上](https://github.com/mdn/learning-area/)：

- 最简单的方式是[下载最新主分支的 ZIP 压缩包](https://codeload.github.com/mdn/learning-area/zip/main)。
- 如果你熟悉 Git 和 GitHub，也可以选择克隆仓库。

## 联系我们

如果你有任何想法或问题，欢迎通过[交流渠道](/zh-CN/docs/MDN/Community/Communication_channels)联系我们。无论是发现了网站内容的问题或遗漏、希望新增学习主题、遇到不理解的内容需要帮助，还是其他任何建议或疑问，我们都很乐意听取。

如果你有兴趣参与内容开发或改进，请查看[如何参与](/zh-CN/docs/MDN/Community)并联系我们！无论你是学习者、教师、经验丰富的开发者，还是其他希望提升学习体验的人，我们都非常欢迎。
