...
在尝试使用这里列举的工具之前，你应该先好好学习一下 [HTML](/zh-CN/docs/Learn_web_development/Core/Structuring_content)、[CSS](/zh-CN/docs/Learn_web_development/Core/Styling_basics) 和 [JavaScript](/zh-CN/docs/Learn_web_development/Core/Scripting) 的核心基础知识。

## 指南

- [1. 客户端工具概览](/zh-CN/docs/Learn_web_development/Extensions/Client-side_tools/Overview)
  - : 在这篇文章中，我们会简要介绍现代 web 工具：在 web 应用开发的生命周期中的何时使用何种工具，以及如何寻求帮助。
- [2. 命令行速成课程](/zh-CN/docs/Learn_web_development/Getting_started/Environment_setup/Command_line)
  - : 毫无疑问，在开发过程中，你需要在终端（或者在“命令行”，它们其实是同一个东西）中运行一些命令。这篇文章将会提供对终端的介绍，包括一些你需要输入的基本命令，如何将命令链接在一起，以及何如添加你自己的命令行（CLI）工具。
- [3. 包管理基础](/zh-CN/docs/Learn_web_development/Extensions/Client-side_tools/Package_management)
  - : 在这篇文章中，我们将会详细看一看包管理器，从而理解如何在我们自己的工程中使用它们——安装工程工具依赖、更新等等。
- [4. 一个完整的工具链](/zh-CN/docs/Learn_web_development/Extensions/Client-side_tools/Introducing_complete_toolchain)
...
- [5. 发布你的应用](/zh-CN/docs/Learn_web_development/Extensions/Client-side_tools/Deployment)
