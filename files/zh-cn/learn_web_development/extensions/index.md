...
我们的**扩展模块**是 web 开发人员开始扩展知识和发展专业时需要学习的有用的额外技能。

## 前提

虽然开始学习这些模块没有特定的前提知识，但如果你是 web 技术的新手，建议先学习我们的[核心模块](/zh-CN/docs/Learn_web_development/Core)。

特别是，如果以前从未做过任何编码工作，我们建议学习[你的第一个网站](/zh-CN/docs/Learn_web_development/Getting_started/Your_first_website)模块，该模块将非常简单地介绍 web 技术，并带领你完成建立一个简单网站的过程。

## 模块

- [JavaScript 对象进阶](/zh-CN/docs/Learn_web_development/Extensions/Advanced_JavaScript_objects)
