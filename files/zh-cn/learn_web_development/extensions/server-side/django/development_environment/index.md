...
我们使用[virtualenvwrapper](https://virtualenvwrapper.readthedocs.io/en/latest/index.html)（Linux 及 macOS）和 [virtualenvwrapper-win](https://pypi.python.org/pypi/virtualenvwrapper-win)（WIndows）来创建 Python 虚拟环境，而它们又使用了[virtualenv](https://github.com/mdn/archived-content/tree/main/files/en-us/mozilla/virtualenv)。封装工具创建了一个一致的接口来管理各个平台上的接口。
