...
布局的安排应该相当明白，假如你已经阅读了之前的[模板入门](/zh-CN/docs/Learn_web_development/Extensions/Server-side/Express_Nodejs/Displaying_data#template_primer)。注意，使用 `block content` 当做定位符号，放到页面内容将要放置的地方。
...
- 继续教程 5 的下個部分：[主页](/zh-CN/docs/Learn_web_development/Extensions/Server-side/Express_Nodejs/Displaying_data/Home_page)
