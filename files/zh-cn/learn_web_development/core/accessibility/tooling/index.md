...
要使用旁白，你需要频繁使用“旁白修饰键”——这是除了实际的旁白键盘快捷键之外，还需要按下的单个键或组合键，才能使快捷键生效。使用此类修饰键在屏幕阅读器中很常见，目的是避免其命令与其他命令发生冲突。对于旁白而言，修饰键可以是 <kbd>CapsLock</kbd>，也可以是 <kbd>Ctrl</kbd> + <kbd>Option</kbd>。

旁白拥有许多键盘命令，我们在此无法一一列举。下表列出了网页测试所需的基本命令。在键盘快捷键中，“VO”代表“旁白修饰键”。
