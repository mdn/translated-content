...
- 移动端设备布局的适用性。例如，在窄屏上多列布局不能很好的工作，需要增加文字大小以提高可读性。这些问题可以通过[媒体查询](/zh-CN/docs/Web/CSS/CSS_media_queries)、[视口](/zh-CN/docs/Web/HTML/Reference/Elements/meta/name/viewport)、[弹性盒子](/zh-CN/docs/Learn_web_development/Core/CSS_layout/Flexbox)来解决。
