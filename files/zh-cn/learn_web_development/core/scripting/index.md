...
在开始这部分模块之前，你应该熟悉基本的 HTML 和 CSS, 并且已经看完我们之前的模块：[JavaScript 第一步](/zh-CN/docs/Learn_web_development/Core/Scripting)。
...
- [在代码中做决定 — 条件](/zh-CN/docs/Learn_web_development/Core/Scripting/Conditionals)
...
- [循环语句](/zh-CN/docs/Learn_web_development/Core/Scripting/Loops)
  - : 有时候你需要在一个行中重复执行某一个任务。例如，查看一整列的名字。在程序中，循环能非常好的处理好这个问题。在本章中我们将介绍 JavaScript 的循环语句。
- [函数 — 可重用的代码块](/zh-CN/docs/Learn_web_development/Core/Scripting/Functions)
...
- [打造自己的函数](/zh-CN/docs/Learn_web_development/Core/Scripting/Build_your_own_function)
  - : 本文结合前几篇文章中所涉及的基本理论，提供了一个实践经验。在这里你会得到一些实践，并且编写自己的自定义函数。随后，我们也将进一步解释一些与函数相关的有用的细节。
- [函数返回值](/zh-CN/docs/Learn_web_development/Core/Scripting/Return_values)
...
- [图片画廊](/zh-CN/docs/Learn_web_development/Core/Scripting/Image_gallery)
