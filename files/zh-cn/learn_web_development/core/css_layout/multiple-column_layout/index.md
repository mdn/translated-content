...
我们可以使用 [CSS Fragmentation](/zh-CN/docs/Web/CSS/Guides/Fragmentation) 中声明的属性控制这一特性。这份规范提供了一些属性来控制 multicol 和多页媒体中的内容拆分、折断。比如，在规则 `.card` 上添加属性{{cssxref("break-inside")}}，并设值 `avoid` 。`.card` 是标题和文本的容器，我们不想拆开这个盒子。
...
- [CSS Fragmentation](/zh-CN/docs/Web/CSS/Guides/Fragmentation)
- [Using multi-column layouts](/zh-CN/docs/Web/CSS/Guides/Multicol_layout/Using)
