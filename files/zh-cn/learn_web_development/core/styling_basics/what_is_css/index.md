...
如果所有网站都长得一样，网络将变得非常无趣。这就是你需要学习 CSS 的原因。
...
- **呈现**文档是指将其转换为用户可用的形式。{{Glossary("browser","浏览器")}} 如 {{Glossary("Mozilla Firefox","Firefox")}}、{{Glossary("Google Chrome","Chrome")}}、{{Glossary("Apple_Safari","Safari")}} 和 {{Glossary("Microsoft Edge","Edge")}} 旨在以视觉方式呈现文档，例如在电脑屏幕、投影仪、移动设备或打印机上。在 Web 环境中，这通常称为“渲染”；我们在 [浏览器如何加载网站](/zh-CN/docs/Learn_web_development/Getting_started/Web_standards/How_browsers_load_websites) 中提供了简化的渲染过程描述。
...
CSS 语言按模块组织，每个模块包含相关功能。例如，你可以查看 [背景与边框模块](/zh-CN/docs/Web/CSS/CSS_backgrounds_and_borders)的 MDN 参考页面，了解其用途及包含的属性和功能。在我们的模块页面中，你还可以找到定义这些技术的规范链接。

## CSS 语法基础

CSS 是一种基于规则的语言——你通过定义一组样式规则来指定网页上哪些元素应该应用哪些样式。
