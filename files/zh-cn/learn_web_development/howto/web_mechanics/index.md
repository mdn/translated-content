...
- [网页、网站、网络服务器和搜索引擎的区别是什么？](/zh-CN/docs/Learn_web_development/Getting_started/Environment_setup/Browsing_the_web)
  - : 本文中我们讲述了各种和 Web 相关的概念：网页、网站、网络服务器，以及搜索引擎。这些概念常常被网络新手混淆，或者被误用。让我们看看它们到底代指的是什么吧！
- [什么是超链接？](/zh-CN/docs/Learn_web_development/Howto/Web_mechanics/What_are_hyperlinks)
