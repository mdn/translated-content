...
- Dynamic splitting: separates code where [dynamic import()](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Statements/import) statements are used
...
It is possible to override the default behaviour and preload web font resources using `<link rel="preload">`, the [CSS font-display property](https://developer.mozilla.org/zh-CN/docs/Web/CSS/@font-face/font-display), and the [Font Loading API](https://developer.mozilla.org/zh-CN/docs/Web/API/CSS_Font_Loading_API).

See also: [Element Link](https://developer.mozilla.org/zh-CN/docs/Web/HTML/Element/link)

### Images and iframes

Very often, webpages contain many images that contribute to data-usage and how fast a page can load. Most of those images are off-screen ([non-critical](https://developer.mozilla.org/zh-CN/docs/Web/Performance/Critical_rendering_path)), requiring user interaction (an example being scroll) in order to view them.
...
**交叉观察者 API**
[Intersection Observers](https://developer.mozilla.org/zh-CN/docs/Web/API/IntersectionObserver) allow the user to know when an observed element enters or exits the browser’s viewport.
