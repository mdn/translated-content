...
<p><strong>Note</strong>: 如果页面需要建立与许多第三方域的连接，则将它们预先连接会适得其反。 <code>preconnect</code> 提示最好仅用于最关键的连接。对于其他的，只需使用 <code>&lt;link rel="dns-prefetch"&gt;</code> 即可节省第一步的时间-DNS 查找。</p>
</div>
...
<ul>
 ...
 <li><a href="/zh-CN/docs/Web/HTTP/Headers/Link">HTTP header </a><a href="/zh-CN/docs/Web/HTTP/Headers/Link">Link</a></li>
</ul>
