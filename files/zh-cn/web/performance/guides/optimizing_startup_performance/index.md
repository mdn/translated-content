...
- 启动时，在需要异步执行的脚本标签上使用 [`defer`](/zh-CN/docs/Web/HTML/Reference/Global_attributes#defer) 或 [`async`](/zh-CN/docs/Web/HTML/Reference/Global_attributes#async) 属性。这会允许 HTML 解析器更高效地处理文档。 [Async scripts for asm.js](/zh-CN/docs/Games/Techniques/Async_scripts) 中有更多关于这方面的信息。
