...
<p><strong>注释：</strong> 从 SVG2 开始， <code>rx</code> 是一个几何属性，也就是说，这个属性也可以用作椭圆的 CSS 属性。</p>
...
<p><strong>注释：</strong> 从 SVG2 开始，<code>rx</code> 是一个几何属性，也就是说，这个属性也可以用作矩形（rect）的 CSS 属性。</p>
