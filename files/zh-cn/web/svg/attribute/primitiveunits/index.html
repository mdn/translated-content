...
<p><code>primitiveUnits 属性为过滤器原语和定义过滤器原语子域中的各种各样的长度单位指定坐标系统</code>.</p>

<p>如果 primitiveUnits 属性未指定，那么效果就如同指定值为 userSpaceOnUse 的效果是一样的。</p>
...
<dl>
 ...
 <dd>在 filter 中定义的任意长度值表示引用该 filter 的元素的包围盒的分数或百分比。</dd>
</dl>
...
<p>下列元素可以使用 primitiveUnits 属性：</p>
