...
---
<p>« <a href="/en/SVG/Attribute">SVG</a>属性参考主页</p>

<p><code>stroke-dashoffset</code> 属性指定了 dash 模式到路径开始的距离</p>

<p>如果使用了一个 <a href="/en/SVG/Content_type#Percentage">&lt;百分比&gt;</a> 值， 那么这个值就代表了当前 viewport 的一个百分比。<br>
 <br>
 值可以取为负值。</p>
...
<p>以下元素可使用 stroke-dashoffset 属性</p>
