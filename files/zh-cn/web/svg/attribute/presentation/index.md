...
---
<p>SVG 表现属性是能够被用在 SVG 元素属性上的 CSS 属性。</p>
...
<dl>
 ...
 <small><em>Value</em>: <code>currentColor</code>|<a href="/en/SVG/Content_type#Color">&lt;color&gt;</a>|<a href="/en/SVG/Content_type#ICCColor">&lt;icccolor&gt;</a>|<code>inherit</code>; <em>Animatable</em>: <strong>Yes</strong></small></dd>
 <dt>{{SVGAttr('stop-opacity')}}</dt>
 <dd>Defines the opacity of a given gradient stop.<br>
 <small><em>Value</em>: <a href="/en/SVG/Content_type#Opacity_value">&lt;opacity-value&gt;</a>|<code>inherit</code>; <em>Animatable</em>: <strong>Yes</strong></small></dd>
 ...
 <small><em>Value</em>: <a href="/en/SVG/Content_type#Percentage">&lt;percentage&gt;</a>|<a href="/en/SVG/Content_type#Length">&lt;length&gt;</a>; <em>Animatable</em>: <strong>Yes</strong></small></dd>
 ...
 <small><em>Value</em>: <a href="/en/SVG/Content_type#Number">&lt;number&gt;</a>; <em>Animatable</em>: <strong>Yes</strong></small></dd>
 <dt><strong>{{SVGAttr('stroke-opacity')}}</strong></dt>
 <dd>Defines the opacity of the stroke of a shape.<br>
 <small><em>Value</em>: <a href="/en/SVG/Content_type#Opacity_value">&lt;opacity-value&gt;</a>|<a href="/docs/Web/SVG/Content_type#Paint">&lt;percentage&gt;</a>; <em>Animatable</em>: <strong>Yes</strong></small></dd>
 ...
 <small><em>Value</em>: <a href="/en/SVG/Content_type#Length">&lt;length&gt;</a>|<code><strong>inherit</strong></code>; <em>Animatable</em>: <strong>Yes</strong></small></dd>
