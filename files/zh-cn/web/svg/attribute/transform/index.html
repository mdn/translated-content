...
<p><strong><code>transform</code></strong> 属性定义了一系列应用于元素和元素子元素的变换规则集合</p>
...
<p><strong>提示：</strong> 从 SVG2 开始，transform 是一种图像属性，这意味着它可以用作 CSS 属性。但是请注意，CSS 属性和属性之间在语法上存在一些差异。有关在这种情况下使用的特定语法，请参见 CSS 属性{{cssxref('transform')}}的文档</p>

<p>作为表示属性，任何元素都可以使用<strong><code>transform</code></strong> （在 SVG 1.1 中，仅这 16 个元素被允许使用：{{SVGElement('a')}}, {{SVGElement('circle')}}, {{SVGElement('clipPath')}}, {{SVGElement('defs')}}, {{SVGElement('ellipse')}}, {{SVGElement('foreignObject')}}, {{SVGElement('g')}}, {{SVGElement('image')}}, {{SVGElement('line')}}, {{SVGElement('path')}}, {{SVGElement('polygon')}}, {{SVGElement('polyline')}}, {{SVGElement('rect')}}, {{SVGElement('switch')}}, {{SVGElement('text')}}, and {{SVGElement('use')}})。<br>
 <br>
 另外，作为 SVG 1.1 的遗留物，{{SVGElement('linearGradient')}}和{{SVGElement('radialGradient')}}支持 <code>gradientTransform </code>属性，而{{SVGElement('pattern')}}支持 <code>patternTransform </code>属性，两者的行为完全相同于 <code>transform</code> 属性</p>
...
<p><strong>警告：</strong> 根据规范，您还应该能够使用 CSS {{cssxref('transform-function', 'transform functions')}}，但是，这不能保证兼容性。</p>
...
<p><code>rotate(&lt;a&gt; [&lt;x&gt; &lt;y&gt;])</code> 变换方法通过一个给定角度对一个指定的点进行旋转变换。如果 x 和 y 没有提供，那么默认为当前元素坐标系原点。否则，就以<code>(x,y)</code>为原点进行旋转。</p>
