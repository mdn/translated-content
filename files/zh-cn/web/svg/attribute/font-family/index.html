...
<p>作为一个表现层的属性，<code>font-family</code>属性也可以被直接用在 CSS 样式表中，详见 {{ cssxref("font-family","CSS font-family") }} 。</p>
...
<table class="standard-table">
 <tbody>
  ...
  <tr>
   <th scope="row">可动画 Animatable</th>
   <td>Yes</td>
  </tr>
  <tr>
   <th scope="row">规范文档</th>
   <td><a href="http://www.w3.org/TR/SVG11/text.html#FontFamilyProperty">SVG 1.1 (2nd Edition)</a></td>
  </tr>
 </tbody>
</table>
<h2 id="例子">例子</h2>
...
<ul>
 <li><a href="/en/SVG/Element#Text_content_elements">Text content elements</a> »</li>
</ul>
