...
> ```
>
> 尽管通常你可能在文档的顶部就定义了 Gradient1，但我在结点上直接包含了 xlink 的命名空间，关于这点的更多信息我们会在[讨论图片](/zh-CN/docs/Web/SVG/Tutorials/SVG_from_scratch/Other_content_in_SVG)的时候详解。
...
你也可以利用属性 `gradientTransform` 给渐变添加额外的变化，但是因为我们还没有介绍 [`transforms`](/zh-CN/docs/Web/SVG/Tutorials/SVG_from_scratch/Basic_transformations)，所以我们将在后续的章节中介绍它。
