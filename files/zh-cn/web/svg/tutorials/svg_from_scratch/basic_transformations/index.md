...
请看[关于 SVG 变形文档的具体实例](/zh-CN/docs/Web/SVG/Reference/Attribute/transform#general_transformation)。关于该属性的详细信息可以在 [SVG 推荐标准](https://www.w3.org/TR/SVG/coords.html#TransformMatrixDefined)上找到。
