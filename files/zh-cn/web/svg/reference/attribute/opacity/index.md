...
original_slug: Web/SVG/Attribute/opacity
---
...
- \<opacity-value>
  - : 一致的不透明度设置，作为一个[\<number>](/zh-CN/docs/SVG/Content_type#number)被应用到整个对象上。任何超过范围 0.0 到 1.0 的值都会被压回这个范围。0.0 表示完全透明，1.0 表示完全不透明。
