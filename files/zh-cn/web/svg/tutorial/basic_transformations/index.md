...
请看[关于 SVG 变形文档的具体实例](/en-US/docs/Web/SVG/Attribute/transform#General_Transformation)。关于该属性的详细信息可以在[SVG 推荐标准](http://www.w3.org/TR/SVG/coords.html#TransformMatrixDefined)上找到。
