...
---
<p>作为 <a href="/en-US/docs/Glossary/XML">XML</a> 的一个方言，<a href="/en-US/docs/Web/SVG">SVG</a> 需要在一个命名空间内（is namespaced）。理解命名空间的概念，以及在你打算编辑 SVG 内容时，命名空间如何使用，是很重要的。SVG 查看器的版本早于 Firefox 1.5 的发布的，都几乎没有注意命名空间的问题， but they are essential to multi-XML dialect supporting user agents such as <a href="/en-US/docs/Mozilla/Gecko">Gecko</a>-based browsers which must be very strict. 现在，花一点时间来理解命名空间，这会让你以后避免各种麻烦。</p>

<h3 id="背景">背景</h3>

<p>W3C 的长期目标是使不同类型的 XML 基本内容可以混合在同一个 XML 文件中。例如，SVG 和 <a href="/en-US/docs/Web/MathML">MathML</a> 可以直接并入基于 XHTML 的科学文档中。 能够混合这样的内容类型有很多优点，但也需要解决一个非常实际的问题。</p>
...
<h3 id="Declaring_namespaces">声明命名空间</h3>
...
<h4 id="Redeclaring_the_default_namespace">重新定义默认命名空间</h4>
