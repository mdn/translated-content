...
<p><code>polygon 元素定义了一个由一组首尾相连的直线线段构成的闭合多边形形状。最后一点连接到第一点。欲了解开放形状，请看{{SVGElement("polyline")}}元素。</code></p>
...
<p>» <a href="https://developer.mozilla.org/files/3259/polygon.svg">polygon.svg</a></p>
...
<p>该元素实现了<code><a href="/en/DOM/SVGPolygonElement">SVGPolygonElement</a>接口。</code></p>
