...
<p>该滤镜用{{ SVGAttr("flood-color") }}元素定义的颜色和{{ SVGAttr("flood-opacity") }}元素定义的不透明度填充了滤镜子区域。</p>
...
<p>该元素实现了<code><a href="/en/DOM/SVGFEFloodElement">SVGFEFloodElement</a>接口。</code></p>
