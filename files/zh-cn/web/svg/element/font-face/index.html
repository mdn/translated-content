...
<p>font-face 元素相当于 (corresponds to) CSS 的 @font-face 规则声明，font-face 元素定义了一个字体的外部属性 (a font's outer properties)。</p>
...
<h2 id="属性_Attributes">属性 Attributes</h2>

<h3 id="全局属性_Global_attributes">全局属性 Global attributes</h3>

<ul>
 <li><a href="/en/SVG/Attribute#Core">Core attributes</a> »</li>
</ul>

<h3 id="特定属性_Specific_attributes">特定属性 Specific attributes</h3>
...
<p>这个元素实现了 <code><a href="/en/DOM/SVGFontFaceElement">SVGFontFaceElement</a></code> 接口。</p>
