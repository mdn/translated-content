...
<p>SVG 图像是使用各种元素创建的，这些元素分别应用于矢量图像的结构、绘制与布局。在这里，您可以找到每个 SVG 元素的参考文档。</p>
...
<p><strong>警告：</strong> 这些是旧的 SVG 元素，已弃用且不应使用。<strong>您绝不应在新项目中使用它们，并应尽快在旧项目中替换它们。</strong>在此列出，仅供参考。</p>
</div>
