...
<p>映射置换滤镜，该滤镜用来自图像中从{{SVGAttr("in2")}}到空间的像素值置换图像从{{SVGAttr("in")}}到空间的像素值。</p>
...
<p>该元素实现了<code><a href="/en/DOM/SVGFEDisplacementMapElement">SVGFEDisplacementMapElement</a></code>接口。</p>
