...
由于克隆的节点不可导出，因此在使用 [CSS](/zh-CN/docs/Web/CSS) 为 `use` 元素及其克隆的后代添加样式时必须小心。除非通过 [CSS 继承](/zh-CN/docs/Web/CSS/CSS_cascade/Inheritance)显式请求，否则无法保证克隆的 DOM 会继承 CSS 属性。
