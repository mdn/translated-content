...
- [在 HTML 内容中应用 SVG 效果](/zh-CN/docs/Web/SVG/Applying_SVG_effects_to_HTML_content)
  - : SVG 与 {{Glossary("HTML")}}、{{Glossary("CSS")}} 和 {{Glossary("JavaScript")}} 一起工作，使用 SVG [增强常规 HTML 页面和 Web 应用](/zh-CN/docs/SVG_In_HTML_Introduction)。
