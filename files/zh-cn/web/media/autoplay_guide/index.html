...
<p>以下网络功能和 API 可能会受到自动播放阻止的影响：</p>
...
<h3 id="Autoplay功能">Autoplay 功能</h3>

<p>据新政策，媒体内容将在满足以下至少一个的条件下自动播放：</p>

<ul>
 <li>音频被静音或其音量设置为 0</li>
...
<h4 id="例子1_autoplay属性">例子 1: autoplay 属性</h4>
...
<h4 id="例子2：检测自动播放失败">例子 2：检测自动播放失败</h4>
...
<p>如果您能够调整查看内容的方向，那么更好的方法是，依靠知道媒体播放已成功开始，而不是在媒体启动失败时知道。您可以通过侦听要在媒体元素上触发的{{event("play")}}事件来轻松实现此目的。</p>
