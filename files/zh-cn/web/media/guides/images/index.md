...
- {{cssxref("object-fit")}}
  - : **`object-fit`** [CSS](/zh-CN/docs/Web/CSS) 属性设置了如何调整{{glossary("Replaced elements", "可替换元素")}}的内容大小以适应其容器，例如 [`<img>`](/zh-CN/docs/Web/HTML/Element/img) 或 [`<video>`](/zh-CN/docs/Web/HTML/Element/video)。
