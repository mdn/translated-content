...
---
<h2 id="常见的CSS属性参考">常见的 CSS 属性参考</h2>

<p>以下是最常见的 CSS 属性的基本列表，其中包含通常从 JavaScript 访问的 DOM 表示法：</p>

<div class="note"><strong>Note:</strong> 此列表不完整。有关更多 CSS 属性，请参阅 CSS 参考和 Mozilla CSS 扩展。参考文章还包括有关如何使用所有属性的示例。</div>
