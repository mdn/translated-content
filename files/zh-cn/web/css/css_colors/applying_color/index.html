...
<p>色彩的运用是人类表达的一种基本形式。小孩子在学会绘画前就开始尝试色彩的运用。也许这就是为什么颜色是人们在学习开发网站时最想尝试的东西之一。借助 <a href="/en-US/docs/Web/CSS">CSS</a>，有很多方法可以为 <a href="/en-US/docs/Web/HTML">HTML</a> <a href="/en-US/docs/Web/HTML/Element">元素</a> 添加颜色，以创建所需的外观。本文是一篇入门文章，介绍了 CSS 颜色在 HTML 中的各种使用方法。</p>
...
<p>从 HTML 元素层面来看，所有的元素都可设置颜色。但除了元素本身之外，元素中所绘制的事物也可设置颜色，如文本，边框等等。我们将会看到一系列用于设置颜色的 CSS 属性。</p>

<p>在这些设置颜色的 CSS 属性中，最基础的就是 {{cssxref("color")}} 属性和 {{cssxref("background-color")}} 属性了。分别用于设置 HTML 元素内容的前景色和背景色。这两个属性几乎可用用于所有的 HTML 元素。</p>
...
<p>CSS 并不是唯一支持颜色的 web 技术。同时还有其它支持颜色的图形技术。</p>
...
<dl>
 ...
 <dt><a href="/en-US/docs/Web/SVG">SVG</a> (可缩放矢量图形)</dt>
...
<h3 id="HSL_函数表示法">HSL 函数表示法</h3>

<p>Designers and artists often prefer to work using the <a href="https://zh.wikipedia.org/wiki/HSL_and_HSV">HSL</a> (Hue/Saturation/Luminosity) color method. On the web, HSL colors are represented using HSL functional notation. The <code>hsl()</code> CSS function is very similar to the <code>rgb()</code> function in usage otherwise.</p>

<img alt="HSL color cylinder" src="https://mdn.mozillademos.org/files/15445/1200px-HSL_color_solid_cylinder_alpha_lowgamma.png">

<p><em><strong>Figure 1. An HSL color cylinder.</strong> Hue defines the actual color based on the position along a circular color wheel representing the colors of the visible spectrum. Saturation is a percentage of how much of the way between being a shade of gray and having the maximum possible amount of the given hue. As the value of luminance (or lightness) increases, the color transitions from the darkest possible to the brightest possible (from black to white). Image courtesy of user <a href="http://commons.wikimedia.org/wiki/User:SharkD">SharkD</a> on <a href="https://www.wikipedia.org/">Wikipedia</a>, distributed under the <a href="http://creativecommons.org/licenses/by-sa/3.0">CC BY-SA 3.0</a> license.</em></p>
...
<h2 id="让用户选择颜色">让用户选择颜色</h2>

<p>There are many situations in which your website may need to let the user select a color. Perhaps you have a customizable user interface, or you're implementing a drawing app. Maybe you have editable text and need to let the user choose the text color. Or perhaps your app lets the user assign colors to folders or items. Although historically it's been necessary to implement your own <a href="https://zh.wikipedia.org/wiki/color_picker">color picker</a>, HTML now provides support for browsers to provide one for your use through the {{HTMLElement("input")}} element, by using <code>"color"</code> as the value of its {{htmlattrxref("type", "input")}} attribute.</p>
...
<p>The first step is to choose your <strong>base color</strong>. This is the color that in some way defines your website or the subject matter of the site. Just as we associate green with the beverage <a href="https://zh.wikipedia.org/wiki/Mountain_Dew">Mountain Dew</a> and one might think of the color blue in relationship with the sky or the ocean, choosing an appropriate base color to represent your site is a good place to start. There are plenty of ways to select a base color; a few ideas include:</p>
...
<dl>
 ...
 <dt><a href="https://zh.wikipedia.org/wiki/Color_theory">Color theory</a> on Wikipedia</dt>
...
<h3 id="颜色、背景、对比和印刷">颜色、背景、对比和印刷</h3>
