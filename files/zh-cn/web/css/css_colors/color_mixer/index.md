...
此工具可通过 {{cssxref("color_value/color-mix")}} 函数在任意色彩空间中混合两种颜色，并将混合后的颜色以任何 CSS 颜色格式复制出来。

两个输入颜色 `color-one` 和 `color-two` 显示在外侧，函数返回的混合颜色显示在中间。点击外侧色块可选择新的混合颜色。使用滑块调整每种输入颜色的混合比例。通过下拉菜单可更改函数输出的色彩空间。最终生成的颜色值以多种格式呈现于控件下方表格中，可直接复制。点击颜色格式名称可查看详细说明。
...
<div id="color-mixer">
  ...
  <div id="color-background">
    <button
      ...
      type="button"
      class="color-one"
      aria-label="打开第一个颜色选择器对话框"></button>
    <div id="mixed-color"></div>
    <button
      id="color-two"
      type="button"
      class="color-two"
      aria-label="打开第二个颜色选择器对话框"></button>
  </div>
  <div>
    <label
      id="percentage-one-label"
      for="percentage-one"
      aria-label="第一个颜色的百分比">
      50%
    </label>
  ...
  <div>
    <label
      ...
      for="percentage-two"
      aria-label="第二个颜色的百分比">
      50%
    </label>
    <input id="percentage-two" type="range" name="percent2" step="0.01" />
  </div>

  <label for="color-space">颜色空间</label>
  <select id="color-space">
    <option value="srgb">sRGB</option>
    <option value="srgb-linear">sRGB 线性</option>
  ...
  <select id="interpolation-method">
    <option value="shorter hue" selected>短路径色相插值</option>
    <option value="longer hue">长路径色相插值</option>
    <option value="increasing hue">色相增加方向</option>
    <option value="decreasing hue">色相减少方向</option>
  </select>
  ...
  <dialog id="picker-dialog">
    ...
    <table>
      <tr>
        <td><label for="color-text">输入颜色：</label></td>
        <td><input type="text" id="color-text" value="#bada55" /></td>
      </tr>
      <tr>
        <td><label for="color-input">选择颜色：</label></td>
        <td><input type="color" id="color-input" value="#bada55" /></td>
      </tr>
      <tr>
        <td><label for="color-opacity">选择透明度：</label></td>
        <td>
          <input
            type="range"
            id="color-opacity"
    ...
    <div><button id="picker-ok-button">确定</button></div>
  </dialog>
</div>
<hr />
<table id="output-colors">
  ...
  <tbody>
    <tr id="rgb-function">
      <th>
        <a
          href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/color_value/rgb"
          target="_blank">
          RGB
        </a>
      </th>
    ...
    <tr id="hex">
      <th>
        <a
          href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/hex-color"
          target="_blank"
          >HEX</a
        >
      </th>
    ...
    <tr id="hsl-function">
      <th>
        <a
          href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/color_value/hsl"
          target="_blank">
          HSL
        </a>
      </th>
    ...
    <tr id="hwb-function">
      <th>
        <a
          href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/color_value/hwb"
          target="_blank">
          HWB
        </a>
      </th>
    ...
    <tr id="color-function">
      <th>
        <a
          href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/color_value/color"
          target="_blank">
          color()
        </a>
      </th>
    ...
    <tr id="lab-function">
      <th>
        <a
          href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/color_value/lab"
          target="_blank">
          Lab
        </a>
      </th>
    ...
    <tr id="lch-function">
      <th>
        <a
          href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/color_value/lch"
          target="_blank">
          LCH
        </a>
      </th>
    ...
    <tr id="oklab-function">
      <th>
        <a
          href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/color_value/oklab"
          target="_blank">
          Oklab
        </a>
      </th>
    ...
    <tr id="oklch-function">
      <th>
        <a
          href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/color_value/oklch"
          target="_blank">
          OkLCh
        </a>
      </th>
...
// 从 srgb-linear 转换为 xyz-d50
// 矩阵取自 http://www.brucelindbloom.com/index.html?Eqn_RGB_to_XYZ.html
