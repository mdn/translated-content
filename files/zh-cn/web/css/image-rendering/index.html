...
<dl>
 ...
 <dd>自 Gecko 1.9（Firefox 3.0）起，Gecko 使用<em>双线性</em>（<em>bilinear</em>）算法进行重新采样（高质量）。</dd>
...
<p>Internet Explorer 7 和 8 支持非标准的 <a href="http://msdn.microsoft.com/en-us/library/ie/ms530822(v=vs.85).aspx"><code>-ms-interpolation-mode</code> 属性</a>，有两个属性值：<code>bicubic</code> 和 <code>nearest-neighbor</code>，和大量差距：</p>
...
<p>Canvas 可以通过人工方式支持 <a href="http://phrogz.net/tmp/canvas_image_zoom.html">crisp-edge/optimize-contrast</a> 属性。</p>
