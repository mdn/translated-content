...
<p><code>scaleX(-1)</code> 表示通过原点的垂直轴定义轴对称（由 <code><a href="transform-origin">transform-origin</a></code> 属性指定）。</p>
...
<p><code>scaleY(-1)</code> 定义了通过原点的水平轴的轴对称（由 <code><a href="transform-origin">transform-origin</a></code> 属性指定）。</p>
...
<p><code>scaleZ(-1)</code> 定义了通过原点的 z 轴的轴对称（由 <code><a href="transform-origin">transform-origin</a></code> 属性指定）。</p>
