...
<dl>
 ...
 <dt>&lt;number&gt;</dt>
 <dd>mask 边框宽度为元素<code>border-width</code>的倍数。不能为负数。</dd>
 <dt><code>auto</code></dt>
 <dd>使<code>mask-border</code>的宽度等于相应<a href="https://developer.mozilla.org/en-US/docs/Web/CSS/mask-border-slice"><code>mask-border-slice</code></a>的固有宽度或高度（以适用者为准），如果图像没有所需的固有尺寸，则使用相应的边框宽度。</dd>
</dl>
