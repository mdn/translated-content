...
**`:user-valid`** CSS [伪类](/zh-CN/docs/Web/CSS/Pseudo-classes)表示已验证的表单元素，其值是根据[验证约束](/zh-CN/docs/Web/HTML/Constraint_validation)来进行正确验证的。然而，不同于 {{cssxref(":valid")}}，它只在用户与它进行交互后才匹配。
