...
<h2 id="Tricky_edge_cases">棘手的边界情况</h2>
...
background: url(images/bg.gif) no-repeat top right;
 ...
 <li>简写属性不试图强制它们替代属性的值的特定顺序。这适用于当这些属性使用不同类型的值时，因为这个时候顺序并不重要。但当几个属性可以设置相同值的时候，就没那么简单了。处理这些情况分以下几种类型：
  <ol>
   <li>处理和盒子（box）边界（edge）相关的属性时，比如 {{cssxref("border-style")}}、{{cssxref("margin")}} 或者 {{cssxref("padding")}}， 始终使用一致的 1 个到 4 个值的语法表示这些边界：
    <table>
     <tbody>
      <tr>
       <td style="width: 79px;"><img alt="border1.png" src="/files/3646/border1.png"></td>
       <td><em>1 个值的语法：</em><code>border-width: 1em</code> — 这一个值表示所有的边框宽度</td>
      </tr>
      <tr>
       <td><img alt="border2.png" src="/files/3647/border2.png"></td>
       <td><em>2 个值的语法：</em><code>border-width: 1em 2em</code> — 第一个值表示垂直方向的，即 top 和 bottom；第二个值表示水平方向的，即 left 和 right</td>
      </tr>
      <tr>
       <td><img alt="border3.png" src="/files/3648/border3.png"></td>
       <td><em>3 个值的语法：</em><code>border-width: 1em 2em 3em</code> — 第一个值表示 top；第二个值表示水平方向的，即 left 和 right；第三个值表示 bottom</td>
      </tr>
      <tr>
       <td><img alt="border4.png" src="/files/3649/border4.png"></td>
       <td>
        <p><em>4 个值的语法：</em><code>border-width: 1em 2em 3em 4em</code> — 这四个值分别表示 top、right、bottom、left，总是按此顺序，即从 top 开始的顺时针顺序（Top-Right-Bottom-Left 首字母与英文单词 trouble 的顺序一致：TRBL）</p>
       </td>
      </tr>
     </tbody>
    </table>
   </li>
   <li>同样，在处理和盒子的角相关的属性时，比如 {{cssxref("border-radius")}}，也始终使用一致的 1 个到 4 个值的语法表示：
    <table>
     <tbody>
      <tr>
       <td style="width: 69px;"><img alt="corner1.png" src="/files/3650/corner1.png"></td>
       <td><em>1 个值的语法：</em><code>border-radius: 1em</code> — 这一个值表示所有的表框角度的半径</td>
      </tr>
      <tr>
       <td><img alt="corner2.png" src="/files/3651/corner2.png"></td>
       <td><em>2 个值的语法：</em><code>border-radius: 1em 2em</code> — 第一个值表示 top-left 和 bottom-right 方向的角；第二个值表示 top-right 和 bottom-left 方向的角</td>
      </tr>
      <tr>
       <td><img alt="corner3.png" src="/files/3652/corner3.png"></td>
       <td><em>3 个值的语法：</em><code>border-radius: 1em 2em 3em</code> — 第一个值表示 top-left 方向的角，第二个值表示 top-right 和 bottom-left 方向的角，第三个值表示 bottom-right 方向的角</td>
      </tr>
      <tr>
       <td><img alt="corner4.png" src="/files/3653/corner4.png"></td>
       <td>
        <p><em>4 个值的语法：</em><code>border-radius: 1em 2em 3em 4em</code> — 这四个值分别表示 top-left、top-right、bottom-right、bottom-left 方向的角。总是按此顺序，即从 top-left 开始的顺时针顺序</p>
       </td>
      </tr>
     </tbody>
    </table>
...
<h2 id="Background_Properties">Background 属性</h2>
...
<h2 id="Font_Properties">Font 属性</h2>
...
<h2 id="Border_Properties">Border 属性</h2>
...
<h2 id="Margin_and_Padding_Properties">Margin 和 Padding 属性</h2>
...
<h2 id="The_universal_shorthand_property">通用简写属性</h2>
