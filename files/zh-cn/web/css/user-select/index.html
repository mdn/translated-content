...
<dl>
 ...
 <dd>元素及其子元素的文本不可选中。请注意这个{{domxref("Selection")}} 对象可以包含这些元素。从 Firefox 21 开始， <code>none</code> 表现的像 <code>-moz-none</code>，因此可以使用 <code>-moz-user-select: text</code> 在子元素上重新启用选择。</dd>
 ...
 <dd>用户可以选择文本。</dd>
 <dt><code>all</code></dt>
 <dd>在一个 HTML 编辑器中，当双击子元素或者上下文时，那么包含该子元素的最顶层元素也会被选中。</dd>
