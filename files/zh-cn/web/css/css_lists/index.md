...
该模块定义了一系列 CSS 特性，用于设置和重置列表的计数器，指定用于标记的[计数器样式](/zh-CN/docs/Web/CSS/CSS_counter_styles)或符号，并控制这些标记的位置。它还为开发者提供了创建自定义标记的能力。
...
- [一致的列表缩进](/zh-CN/docs/Web/CSS/CSS_lists/Consistent_list_indentation)
