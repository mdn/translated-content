...
<p><img alt="The effect of the CSS margin-right property on the element box" src="/files/4041/margin-right.svg" style="border: solid 1px; float: left; height: 200px; margin-bottom: 1em; margin-right: 1em; width: 400px;"><strong><code>margin-right</code></strong>  属性 设置与元素相关联的盒子模型的右外边距。这个值可以为负值。</p>

<p>竖直排列相邻的两个盒子模型的外边距会重叠，称为 <a href="https://developer.mozilla.org/en-US/docs/CSS/margin_collapsing"><em>margin collapsing</em></a>.</p>
...
<dl>
 ...
 <dd>一个固定宽度 {{cssxref("&lt;length&gt;")}}值：可以是一个绝对宽度，e.g. in <code>px</code>, 也可以是一个相对宽度，e.g. in <code>em</code>, 或者相对视窗的大小，e.g. in <code>vh</code>.</dd>
 <dt><code>&lt;percentage&gt;</code></dt>
 <dd>以百分比为单位的 margin 值，计算时是相对于其最近的父级容器的宽度。</dd>
 <dt><code>auto</code></dt>
 <dd>auto 关键词表示在当前布局模式下，浏览器根据接收的左边距自动计算出外边距。如果有几组 margin-left 和 margin-right 设置为 auto，那么最后计算的空间分布，会根据 display，float，position 属性，自动生成以下几种情况：
