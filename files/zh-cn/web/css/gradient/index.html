...
<p><strong><code>&lt;gradient&gt;</code></strong> 数据类型由下列函数定义。</p>

<div id="linear-gradient">
<h4 id="线形渐变"><strong>线形渐变</strong></h4>
...
<p>{{EmbedLiveSample('linear-gradient', 240, 80)}}</p>
</div>
...
<p>{{EmbedLiveSample('radial-gradient', 240, 80)}}</p>
</div>
...
<p>{{EmbedLiveSample('repeating-gradient', 220, 180)}}</p>
</div>
