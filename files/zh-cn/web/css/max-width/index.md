...
**`max-width`** [CSS](/zh-CN/docs/Web/CSS) 属性设置了元素的最大宽度。它可防止 {{cssxref("width")}} 属性的[应用值](/zh-CN/docs/Web/CSS/used_value)大于 `max-width` 指定的值。
...
- [MDN 理解 WCAG，指引 1.4 解释](/zh-CN/docs/Web/Accessibility/Understanding_WCAG/Perceivable#guideline_1.4_make_it_easier_for_users_to_see_and_hear_content_including_separating_foreground_from_background)
