...
<p><strong><code>:visited</code></strong> CSS<a href="/zh-CN/docs/Web/CSS/Pseudo-classes">伪类</a>表示用户已访问过的链接。出于隐私原因，可以使用此选择器修改的样式非常有限。</p>
...
<ul>
 ...
 <li>允许使用的样式的 αlpha 分量 (透明度) 将被忽略。 设置在<code>:visited</code>中的样式将使用元素的非<code>:visited</code> 访问状态的 αlpha 分量， 如果该分量为 0，这个样式将被完全忽略。</li>
 <li>虽然这些样式可以改变用户最终的颜色外观，但 {{domxref("window.getComputedStyle")}} 方法将存在并且始终返回非访问颜色的值。</li>
</ul>

<div class="note style-wrap">
<p>注意：有关这些限制及其背后原因的更多信息，请参阅 <a href="/zh-CN/docs/Web/CSS/Privacy_and_the_:visited_selector">Privacy and the :visited selector</a>。</p>
</div>

<h2 id="示例">示例</h2>

<p>未设置颜色或透明的属性不能使用<code>:visited</code>。 在可以使用此伪类设置的属性中，浏览器可能只有<code>color</code>和<code>column-rule-color</code>两个默认值。 因此，对于其他属性，在使用<code>:visited</code>选择器前，应该先为这些属性设置基础样式。 </p>
...
<pre class="brush: css"><code>a {
  /* </code>指定某些属性的默认值，允许他们使用：visited 状态进行样式设置<code> */
...
<ul>
 <li><a href="/zh-CN/docs/Web/CSS/Privacy_and_the_:visited_selector">Privacy and the :visited selector</a></li>
