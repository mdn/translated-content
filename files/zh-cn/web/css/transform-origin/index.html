...
<p><strong><code>transform-origin</code></strong> CSS 属性让你更改一个元素变形的原点。</p>
...
<ul>
 ...
 <li>三个值：
  <ul>
   ...
   <li>第三个值必须是{{cssxref("&lt;length&gt;")}}。它始终代表 Z 轴偏移量。</li>
  </ul>
 </li>
</ul>
...
<dl>
 ...
 <dd><code>left，</code><code>right，</code><code>top，</code><code>bottom或</code><code>center中之一，定义相对应的变形中心偏移。</code></dd>
 <dt><em>y-offset</em></dt>
 <dd>定义变形中心距离盒模型的顶的{{cssxref("&lt;length&gt;")}}或{{cssxref("&lt;percentage&gt;")}}偏移值。</dd>
 <dt><em>x-offset-keyword</em></dt>
 <dd><code>left，</code><code>right</code><code>或</code><code>center中之一，定义相对应的变形中心偏移。</code></dd>
 <dt><em>y-offset-keyword</em></dt>
 <dd><code>top，</code><code>bottom或</code><code>center中之一，定义相对应的变形中心偏移。</code></dd>
 <dt><em>z-offset</em></dt>
 <dd>定义变形中心距离用户视线（z=0 处）的{{cssxref("&lt;length&gt;")}}（不能是{{cssxref("&lt;percentage&gt;")}}）偏移值。</dd>
</dl>
...
<ul>
 <li><a href="/en-US/docs/CSS/Using_CSS_transforms">使用 CSS 变形</a></li>
</ul>
