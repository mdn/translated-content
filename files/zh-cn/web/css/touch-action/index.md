...
<p>CSS 属性 <strong><code>touch-action</code></strong> 用于设置触摸屏用户如何操纵元素的区域 (例如，浏览器内置的缩放功能)。</p>
...
<ul>
 <li>任何一个关键字 <code><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/touch-action$edit#auto">auto</a>、</code><code><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/touch-action$edit#none">none</a>、</code><code><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/touch-action$edit#manipulation">manipulation</a>，或</code></li>
 <li>零或任何一个关键字 <code><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/touch-action$edit#pan-x">pan-x</a>、</code><code><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/touch-action$edit#pan-keywords">pan-left</a>、</code><code><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/touch-action$edit#pan-keywords">pan-right</a>，加</code>零或任何一个关键字 <code><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/touch-action$edit#pan-y">pan-y</a>、</code><code><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/touch-action$edit#pan-keywords">pan-up</a>、</code><code><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/touch-action$edit#pan-keywords">pan-down</a>，加可选关键字</code> <code><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/touch-action$edit#">pinch-zoom</a></code>.</li>
</ul>
...
<dl>
 ...
 <dd>当触控事件发生在元素上时，由浏览器来决定进行哪些操作，比如对 viewport 进行平滑、缩放等。</dd>
 ...
 <dd>浏览器只允许进行滚动和持续缩放操作。任何其它被 auto 值支持的行为不被支持。启用平移和缩小缩放手势，但禁用其他非标准手势，例如双击以进行缩放。禁用双击可缩放功能可减少浏览器在用户点击屏幕时延迟生成点击事件的需要。这是“<strong>pan-x pan-y pinch-zoom</strong>”（为了兼容性本身仍然有效）的别名。</dd>
...
<ul>
 ...
 <li>WebKit Blog <a href="https://webkit.org/blog/5610/more-responsive-tapping-on-ios/">More Responsive Tapping on iOS</a></li>
</ul>
