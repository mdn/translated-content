...
使用 {{cssxref("@property")}} [At 规则](/zh-CN/docs/Web/CSS/At-rule)时需要 **`inherits`** [CSS](/zh-CN/docs/Web/CSS) 描述符，它控制着由 `@property` 指定的自定义属性注册是否默认继承。
...
- [Houdini APIs](/zh-CN/docs/Web/API/Houdini_APIs)
