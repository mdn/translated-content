...
**`:volume-locked`** [CSS](/zh-CN/docs/Web/CSS) [伪类](/zh-CN/docs/Web/CSS/Pseudo-classes) 选择器表示能够发出声音，但其音量目前被用户“锁定”的媒体元素，如 {{htmlelement("audio")}} 或 {{htmlelement("video")}}，但是媒体元素的音量目前被用户"锁定"了。
