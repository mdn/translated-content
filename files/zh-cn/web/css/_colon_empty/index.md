...
辅助技术（如屏幕阅读器）无法解析交互内容为空的情况。所有交互内容必须具有无障碍名称，这是通过为交互控件的父元素（如[锚点](/zh-CN/docs/Web/HTML/Reference/Elements/a)、[按钮](/zh-CN/docs/Web/HTML/Reference/Elements/button)等）提供文本值来创建的。无障碍名称将交互控件暴露给[无障碍树](/zh-CN/docs/Learn_web_development/Core/Accessibility/What_is_accessibility#无障碍_api)，这是一个传达对辅助技术有用的信息的 API。
