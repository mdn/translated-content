...
- `deg`
  - : 以[度（角）](<https://zh.wikipedia.org/wiki/%E5%BA%A6_(%E8%A7%92)>)为单位表示角度。一个完整的圆是 `360deg`。例：`0deg`、`90deg`、`14.23deg`。
- `grad`
  - : 以[百分度](https://zh.wikipedia.org/wiki/%E7%99%BE%E5%88%86%E5%BA%A6)为单位表示角度。一个完整的圆是 `400grad`。例：`0grad`、`100grad`、`38.8grad`。
- `rad`
  - : 以[弧度](https://zh.wikipedia.org/wiki/%E5%BC%A7%E5%BA%A6)为单位表示角度。一个完整的圆是 2π 弧度，约等于 `6.2832rad`，`1rad` 是 180/π 度。例：`0rad`、`1.0708rad`、`6.2832rad`。
- turn
