...
**`inherit`** 关键字使得元素获取其父元素的[计算值](/zh-CN/docs/Web/CSS/CSS_cascade/computed_value)。它可以应用于任何 CSS 属性，包括 CSS 简写 {{cssxref("all")}}。
...
- [Inheritance](/zh-CN/docs/Web/CSS/CSS_cascade/Inheritance)
