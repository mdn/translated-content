...
<p> <strong><code>inherit</code></strong> 关键字使得元素获取其父元素的<a href="/zh-CN/docs/Web/CSS/computed_value">计算值</a>。它可以应用于任何 CSS 属性，包括 CSS 简写 {{cssxref("all")}}。</p>
...
<p>在下面这个例子中，如果 sidebar 中<code>h2</code>元素的 div 匹配下面的规则的话，颜色会变成蓝色。</p>
...
<ul>
 <li><a href="/en-US/docs/CSS/inheritance">Inheritance</a></li>
