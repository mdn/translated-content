...
一个[计数器](/zh-CN/docs/Web/CSS/CSS_counter_styles/Using_CSS_counters)本身没有可见的效果，而是通过 `counter()` 函数（和 [`counters()`](/zh-CN/docs/Web/CSS/counters) 函数）返回开发人员定义的字符串（或图像）从而使计数器拥有很棒的作用。
