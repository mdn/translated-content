...
<div><strong><code>:out-of-range</code> </strong><a href="/zh-CN/docs/Web/CSS">CSS</a> <a href="/zh-CN/docs/CSS/Pseudo-classes">伪类</a> 表示一个 {{htmlelement("input")}} 元素，其当前值处于属性 <code><a href="https://developer.mozilla.org/zh-CN/docs/Web/HTML/Element/input#attr-min">min</a></code> 和 <code><a href="https://developer.mozilla.org/zh-CN/docs/Web/HTML/Element/input#attr-max">max</a></code> 限定的范围外。</div>
...
<div>{{EmbedLiveSample('示例', 600, 140)}}</div>
