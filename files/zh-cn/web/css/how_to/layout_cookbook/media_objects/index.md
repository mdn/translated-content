...
我选择使用[Grid Layout](/zh-CN/docs/Web/CSS/Guides/Grid_layout)实现媒体对象，因为它可以让我在我需要的时候控制两个维度的布局。这意味着当我们有一个页脚（footer）的时候，上面的内容很短，页脚可以被推到媒体对象的底部。
...
- [CSS Grid Layout](/zh-CN/docs/Web/CSS/Guides/Grid_layout)
- [Using Grid Template Areas](/zh-CN/docs/Web/CSS/Guides/Grid_layout/Grid_template_areas)
- [fit-content](/zh-CN/docs/Web/CSS/Reference/Values/fit-content)
