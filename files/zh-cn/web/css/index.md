...
- CSS 关键概念：
  ...
  - [初始值](/zh-CN/docs/Web/CSS/CSS_cascade/Value_processing)、[计算值](/zh-CN/docs/Web/CSS/CSS_cascade/Value_processing)、[应用值](/zh-CN/docs/Web/CSS/CSS_cascade/Value_processing)和[实际值](/zh-CN/docs/Web/CSS/CSS_cascade/Value_processing)
