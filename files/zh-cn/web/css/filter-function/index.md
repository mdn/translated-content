...
- [`grayscale()`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/filter-function/grayscale)
  - : 将图像转为灰度图
- [`hue-rotate()`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/filter-function/hue-rotate)
  - : 改变图像的整体色调
- [`invert()`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/filter-function/invert)
  - : 反转图像颜色
- [`opacity()`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/filter-function/opacity)
  - : 改变图像透明度
- [`saturate()`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/filter-function/saturate)
  - : 超饱和或去饱和输入的图像
- [`sepia()`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/filter-function/sepia)
  - : 将图像转为棕褐色
