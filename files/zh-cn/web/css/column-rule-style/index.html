...
<p>CSS 特性 <code>column-rule-color</code> 让你可以设置在多列布局中被画在两列之间的规则（线条）的样式。</p>

<p>{{cssinfo}}</p>

<h2 id="Syntax">Syntax</h2>

<pre class="twopartsyntaxbox"><a href="/en-US/docs/CSS/Value_definition_syntax">Formal syntax</a>: {{csssyntax("column-rule-style")}}
</pre>
