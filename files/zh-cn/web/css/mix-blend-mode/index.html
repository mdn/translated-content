...
<p><strong><code>mix-blend-mode</code></strong> CSS 属性描述了元素的内容应该与元素的直系父元素的内容和元素的背景如何混合。</p>
...
<pre class="notranslate">mix-blend-mode: normal;
...
<h3 id="不同mix-blend-mode值的效果">不同 mix-blend-mode 值的效果</h3>
...
<h3 id="HTML中使用_mix-blend-mode">HTML 中使用 mix-blend-mode</h3>

<h4 id="HTML">HTML</h4>

<pre class="brush: html notranslate">&lt;div class="isolate"&gt;
...
<pre class="brush: css notranslate">.circle {
  width: 80px;
  height: 80px;
  border-radius: 50%;
  mix-blend-mode: screen;
...
<h3 id="SVG中使用_mix-blend-mode">SVG 中使用 mix-blend-mode</h3>

<h4 id="SVG">SVG</h4>

<pre class="brush: html notranslate">&lt;svg&gt;
  &lt;g class="isolate"&gt;
...
<pre class="brush:css notranslate">circle { mix-blend-mode: screen; }
