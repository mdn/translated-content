...
<p><strong><code>aspect-ratio</code></strong>  <a href="/en-US/docs/CSS">CSS</a> 属性为 box 容器规定了一个<strong>期待的纵横比</strong>，这个纵横比可以用来计算自动尺寸以及为其他布局函数服务。</p>
...
<p>浏览器内部已经为替换的元素和其他接受 <code>width</code> 和 <code>height</code> 的元素添加了 <code>aspect-ratio</code>。这些可以在浏览器的 UA 样式表中看到。</p>
...
<p>您可以在 <a href="https://www.smashingmagazine.com/2020/03/setting-height-width-images-important-again/">为图片设置宽高仍然重要 gain</a> 一文中了解更多与这个功能有关的内容。</p>
