...
- `steps(n, <jumpterm>)`
  ...
  - : 按照 n 个途径点在转换中显示动画迭代，每个停止点等长时间显示。例如，如果 n 为 5，则有 5 个步骤。动画是否暂时停留在 0%、20%、40%、60% 和 80% 处，在 20%、40%、60%、80% 和 100% 处之间作出 5 个停止点，或者在动画沿着 0% 和 100% 之间做出 5 个停止点（在 0%、25%、50%、75% 和 100% 处）取决于使用以下跳跃项之一：
