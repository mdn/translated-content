...
[CSS](/zh-CN/docs/Web/CSS) **`align-items`** 属性设置了所有直接子元素的 [align-self](/zh-CN/docs/Web/CSS/align-self) 值作为一个组。在 Flexbox 中，它控制子元素在[交叉轴](/zh-CN/docs/Glossary/Cross_Axis)上的对齐。在 Grid 布局中，它控制了子元素在其[网格区域](/zh-CN/docs/Glossary/Grid_Areas)内的块轴上的对齐。
