...
<div>表示其在 type 为 range 的 input 标签内中的滑块凹槽，也就是滑块可滑动的区域</div>
...
<p><strong><code>::-webkit-slider-runnable-track</code></strong> 不是任何规范的一部分。这是 WebKit/Blink 特有的伪元素 (也就是 chrome/safari 浏览器内核特有的)</p>
