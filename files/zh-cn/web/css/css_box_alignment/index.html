...
<p>CSS 盒子对齐 (Box Alignment) 模块指定了在各种 CSS 盒子布局模型，如块布局，表布局，弹性布局和网格布局中，与盒子对齐有关的 CSS 功能。该模块旨在建立一种能一致地在 CSS 中指定对齐的方法。这份文档详述了出现在该规范中的一般概念。</p>
...
<p>传统上，CSS 的对齐功能非常有限。我们可以利用 {{cssxref("text-align")}} 对齐文本，利用 auto {{cssxref("margin")}} 对齐块，并且利用 {{cssxref("vertical-align")}} 属性在表格 (table) 或者行内块 (inline-block) 布局中对齐块。现在 <a href="https://www.w3.org/TR/css-inline-3/">Inline Layout</a> 与 <a href="https://www.w3.org/TR/css-text-3/">CSS Text</a> 模块中涵盖了文本对齐的内容，而盒子对齐模块让我们第一次拥有了完整的水平与垂直对齐的能力。</p>
...
<p><img src="align-container-subjects.png"></p>
...
<p><img src="writing-mode-start.png"></p>
...
<p><img src="justify-content-start.png"></p>

<p>如果你在弹性容器上设置了 <code>justify-content: space-between</code> ，那么可用空间会被共享并放置在项目之间。</p>

<p><img src="justify-content-space-between.png"></p>
...
<p>由于 CSS 盒子对齐属性的实现方式取决于与它们相交互的规范，因此请参见以下每种布局类型的页面，以获取关于如何将对齐属性与其一起使用的详细信息：</p>
