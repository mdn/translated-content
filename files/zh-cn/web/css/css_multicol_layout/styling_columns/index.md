...
列之间的间距由 `column-gap` 属性控制。该属性最初在多列布局规范中定义。然而，现在它在[盒子对齐](/zh-CN/docs/Web/CSS/CSS_box_alignment)中定义，以便统一其他规范（如 [CSS 网格布局](/zh-CN/docs/Web/CSS/CSS_grid_layout/Box_alignment_in_grid_layout)）中的盒子间距。
