...
<p><strong><code>transition</code> </strong><a href="https://developer.mozilla.org/en/CSS">CSS</a> 属性是 {{ cssxref("transition-property") }}，{{ cssxref("transition-duration") }}，{{ cssxref("transition-timing-function") }} 和 {{ cssxref("transition-delay") }} 的一个<a href="/en-US/docs/CSS/Shorthand_properties">简写属性</a>。</p>
...
<p>请查看“<a href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Transitions/Using_CSS_transitions#When_property_value_lists_are_of_different_lengths">如何处理</a>”以了解当<code>transition</code>属性的值个数超过可以接收的值的个数时该如何处理。简而言之，当<code>transition</code>属性的值个数超过可以接收的值的个数时，多余的值都会被忽略掉，不再进行解析。</p>
...
<p>“<a href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Transitions/Using_CSS_transitions">使用 CSS 过渡</a>”一文中还包含了几个 CSS 过渡示例。</p>
