...
你可以在 [v-fonts.com](https://v-fonts.com/) 和 [axis-praxis.org](https://www.axis-praxis.org/) 找到可变字体示例；参见[可变字体指南](/zh-CN/docs/Web/CSS/Guides/Fonts/Variable_fonts)以获取更多信息。
...
- [OpenType 字体特性指南](/zh-CN/docs/Web/CSS/Guides/Fonts/OpenType_fonts)
