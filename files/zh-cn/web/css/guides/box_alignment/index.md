...
如果你最初学习过[弹性盒子（Flexbox）](/zh-CN/docs/Web/CSS/Guides/Flexible_box_layout)，你可能会觉得这些属性是弹性盒子规范的一部分。确实，某些属性是列在弹性盒子的 Level 1 标准中，不过规范指出我们应该提到盒子对齐规范，因为它可能会弹性盒子的基础上增加额外的功能。

## 基本示例

下面的例子演示了部分盒子对齐属性在[网格](/zh-CN/docs/Web/CSS/Guides/Grid_layout)和[弹性盒子](/zh-CN/docs/Web/CSS/Guides/Flexible_box_layout)中是如何被使用的。
...
- [Box alignment for block, absolutely positioned and table layout](/zh-CN/docs/Web/CSS/Guides/Box_alignment/In_block_abspos_tables)
...
- CSS 弹性盒子指南：_[Aligning items in a flex container](/zh-CN/docs/Web/CSS/Guides/Flexible_box_layout/Aligning_items)_
- CSS 网格指南：_[Box alignment in CSS Grid layouts](/zh-CN/docs/Web/CSS/Guides/Grid_layout/Box_alignment)_
