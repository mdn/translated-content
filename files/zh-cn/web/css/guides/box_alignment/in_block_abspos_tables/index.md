...
[盒子对齐规范](/zh-CN/docs/Web/CSS/Guides/Box_alignment)详细说明了对齐在各种布局方法中的工作原理。在本页，我们研究盒子对齐在块布局上下文中的工作方式，包括浮动、定位和表格元素。由于本页旨在详细介绍专门与块布局和盒子对齐相关的内容，它应与主要的[盒子对齐](/zh-CN/docs/Web/CSS/Guides/Box_alignment)页面一起阅读，该页面详细介绍了盒子对齐在各种布局方法中的共同特性。
