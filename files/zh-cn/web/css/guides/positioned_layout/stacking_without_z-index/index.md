...
- [使用 z-index](/zh-CN/docs/Web/CSS/Guides/Positioned_layout/Using_z-index)：如何使用 `z-index` 来更改默认堆叠。
- [层叠上下文](/zh-CN/docs/Web/CSS/Guides/Positioned_layout/Stacking_context)：关于堆叠上下文的说明。
