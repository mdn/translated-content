...
<p><code>@counter-style 是一个</code> <a href="/en/CSS">CSS</a> <a href="/en/CSS/At-rule">at-rule</a> ，它让开发者可以自定义 counter 的样式。 一个 <code>@counter-style 规则</code> 定义了如何把一个计数器的值转化为字符串表示。</p>
