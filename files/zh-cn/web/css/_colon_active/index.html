...
<p><a href="/zh-CN/docs/Web/CSS">CSS</a> <strong><code>:active</code></strong> <a href="/zh-CN/docs/CSS/Pseudo-classes">伪类</a>匹配被用户激活的元素。它让页面能在浏览器监测到激活时给出反馈。当用鼠标交互时，它代表的是用户按下按键和松开按键之间的时间。</p>
