...
<p><strong>table-layout </strong>CSS 属性定义了用于布局表格<em>单元格</em>，<em>行</em>和<em>列</em>的算法。</p>
...
<p>本示例使用了 fixed 的表格布局，结合{{cssxref("width")}}属性来限制表格的宽。{{cssxref("text-overflow")}} 属性用于文字过长时显示省略号。</p>

<p>如果表格的布局是 auto，即使指定了表格的 width，表格仍然会自适应内容自动撑开。</p>
