...
- _请注意_。当与创建[层叠上下文](/zh-CN/docs/Web/CSS/CSS_positioned_layout/Stacking_context)的属性值一起使用（例如 will-change: opacity）时，`will-change` 实际上可能会影响元素的视觉外观，因为层叠上下文是提前创建的。
