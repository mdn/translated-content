...
[CSS](/zh-CN/docs/Web/CSS) [伪类](/zh-CN/docs/Web/CSS/Pseudo-classes) **`:-moz-locale-dir(rtl)`** 是一个用于在用户界面为从右到左显示时，匹配元素的 [Mozilla 扩展](/zh-CN/docs/Web/CSS/Reference/Mozilla_extensions)。其判断依据是首选项 `intl.uidirection.locale`（其中 `locale` 表示当前语言环境）被设置为“rtl”。
