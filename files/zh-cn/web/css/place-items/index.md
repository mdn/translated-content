...
<dl>
 ...
 <ul>
  <li>在块级布局中，<code>normal</code> 和 <code>start</code> 一样。</li>
 ...
 这只对 flex 布局元素生效，对于不是 flex 容器的子元素，它被视为 end 。</dd>
 ...
 <dd>指定参与第一个或最后一个基线对齐：元素的第一个或最后一个基线集的对齐基线与基线共享组中所有框共享的第一个或最后一个基线集中相应的基线对齐。<br>
 <code>first baseline</code> 的回退对齐方式为 <code>start</code> ，<code>last baseline</code> 则为 <code>end</code>。</dd>
