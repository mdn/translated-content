...
- `only`
  ...
  - : 禁止用户代理覆盖元素的颜色方案。
    ...
    可以使用 `color-scheme: only light;` 应用于特定的元素或 `:root`，以关闭由 Chrome 的[自动深色主题](https://developer.chrome.google.cn/blog/auto-dark-theme?hl=zh-cn#per-element-opt-out)引起的颜色覆盖。
