...
- [`prefers-color-scheme`](/en-US/docs/Web/CSS/@media/prefers-color-scheme) 媒体查询来检测用户对配色方案的偏好。
- [使用 CSS 将颜色应用于 HTML 元素](/en-US/docs/Web/CSS/CSS_Colors/Applying_color)
- 其他颜色相关的属性：{{cssxref("color")}}、{{cssxref("background-color")}}、{{cssxref("border-color")}}、{{cssxref("outline-color")}}、{{cssxref("text-decoration-color")}}、{{cssxref("text-emphasis-color")}}、{{cssxref("text-shadow")}}、{{cssxref("caret-color")}}, and {{cssxref("column-rule-color")}}
