...
- [元素选择器](/zh-CN/docs/Web/CSS/Reference/Selectors/Type_selectors)
  - : 按照给定的节点名称，选择所有匹配的元素。
...
- [直接子代组合器](/zh-CN/docs/Web/CSS/Reference/Selectors/Child_combinator)
  - : `>` 组合器选择前一个元素的直接子代的节点。
...
- [一般兄弟组合器](/zh-CN/docs/Web/CSS/Reference/Selectors/Subsequent-sibling_combinator)
...
- [紧邻兄弟组合器](/zh-CN/docs/Web/CSS/Reference/Selectors/Next-sibling_combinator)
...
- [列组合器](/zh-CN/docs/Web/CSS/Reference/Selectors/Column_combinator) {{Experimental_Inline}}
  - : `||` 组合器选择属于某个表格行的节点。
