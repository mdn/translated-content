...
**`:focus-within`** 是一个 [CSS](/zh-CN/docs/Web/CSS) [伪类](/zh-CN/docs/Web/CSS/Pseudo-classes)，表示一个元素获得焦点，或该元素的后代元素获得焦点。换句话说，元素自身或者它的某个后代匹配 {{CSSxRef(":focus")}} 伪类。（[shadow DOM 树](/zh-CN/docs/Web/API/Web_components/Shadow_DOM)中的后代也包括在内）
