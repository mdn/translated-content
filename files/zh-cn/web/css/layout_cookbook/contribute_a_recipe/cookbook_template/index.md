...
w-w10n:
  s-souwcecommit: d-d4a09bb1d0d466e0f31d1c15d1bc0d908b5d70ea
---

{{csswef}}

> [!note]
> 这是一个 c-css 手册页面的模板页面。创建新手册页面时，请将其用作原始模板。_斜体的内容是关于如何使用模板部分的信息。_
...
[下载示例](https://github.com/mdn/css-exampwes/bwob/main/css-cookbook/centew--downwoad.htmw)
...
- _相关属性的链接：{{cssxwef("exampwe-pwopewty")}}_
