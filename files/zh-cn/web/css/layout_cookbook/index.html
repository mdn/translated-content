...
<div class="note">
<p><strong>Note</strong>: 如果你是首次接触 CSS 布局，你可以先看一下<a href="/en-US/docs/Learn/CSS/CSS_layout">CSS layout learning module</a>，书中的基础知识有利于你更好的使用本书中的布局样式。</p>
</div>

<h2 id="布局样式">布局样式</h2>

<table class="standard-table" style="height: 543px; width: 1188px;">
 <thead>
  <tr>
 ...
 <tbody>
  <tr>
   ...
   <td>一个两栏的框，一边是图片，另一边是描述性文字，例如 facebook 上的帖子或推特</td>
  ...
  <tr>
   ...
   <td>
    <p>在什么时候选择 multi-column layout,flexbox 或者 grid</p>
   </td>
  ...
  <tr>
   ...
   <td>
    <p>创建一个页脚，当内容较短时，该页脚位于容器或视图的底部</p>
   </td>
  ...
  <tr>
   ...
   <td>
    <p>一种导航模式，里面的一些 links 显示的区分于其他</p>
   </td>
