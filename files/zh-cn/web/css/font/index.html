...
<pre class="brush: css line-numbers language-css"><code class="language-css">/* Set the font size to 12px and the line height to 14px.
...
p { font: status-bar }</code></pre>

<h3 id="live_sample">实样</h3>
