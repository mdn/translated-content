...
[CSS](/zh-CN/docs/Web/CSS) [@规则](/zh-CN/docs/Web/CSS/Guides/Syntax/At-rules) 中的 `@layer` 声明了一个*层叠层*，同一层内的规则将级联在一起，这给予了开发者对层叠机制的更多控制。
...
一个层叠层同样可以通过 {{cssxref("@import")}} 来创建，规则存在于被引入的样式表内：
