...
[CSS](/zh-CN/docs/Web/CSS) **`<length-percentage>`** [数据类型](/zh-CN/docs/Web/CSS/Reference/Values/Data_types)表示一个值，该值可以是 {{Cssxref("length")}} 或 {{Cssxref("percentage")}}。
...
- {{cssxref("&lt;percentage&gt;")}}
- {{cssxref("&lt;length&gt;")}}
- [CSS 值和单位](/zh-CN/docs/Web/CSS/Guides/Values_and_units)
