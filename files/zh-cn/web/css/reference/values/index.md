...
**CSS 值**是可赋予 CSS 属性的数值，包括关键字、[数据类型](/zh-CN/docs/Web/CSS/Reference/Values/Data_types)以及[函数](/zh-CN/docs/Web/CSS/Reference/Values/Functions)。

> [!NOTE]
> 本页面是 CSS 中所有值特性的索引。[CSS 值与单位](/zh-CN/docs/Web/CSS/Guides/Values_and_units)页面介绍了定义其中部分（而非全部）值的模块。
