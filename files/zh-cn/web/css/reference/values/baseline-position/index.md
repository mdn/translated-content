...
**`<baseline-position>`** {{glossary("enumerated", "枚举")}}值类型表示 `baseline` 关键字以及 `first` 和 `last` 两个修饰符。它用于 {{cssxref("align-content")}}、{{cssxref("align-items")}}、{{cssxref("align-self")}}、{{cssxref("justify-items")}} 和 {{cssxref("justify-self")}} 属性，以及 {{cssxref("place-content")}}、{{cssxref("place-items")}} 和 {{cssxref("place-self")}} 这些简写属性。

`first` 和 `last` 值赋予盒一个基线对齐偏好，如果省略修饰符则默认为 `first`。
