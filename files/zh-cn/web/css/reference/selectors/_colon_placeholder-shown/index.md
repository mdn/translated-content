...
**`:placeholder-shown`** [CSS](/zh-CN/docs/Web/CSS) [伪类](/zh-CN/docs/Web/CSS/Reference/Selectors/Pseudo-classes)表示当前显示[占位符文本](/zh-CN/docs/Web/HTML/Reference/Elements/input#placeholder)的任何 {{htmlElement("input")}} 或 {{htmlElement("textarea")}} 元素。
