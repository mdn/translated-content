...
[CSS](/zh-CN/docs/Web/CSS) **`:seeking`** [伪类](/zh-CN/docs/Web/CSS/Reference/Selectors/Pseudo-classes)选择器表示一个可播放的元素，比如 {{htmlelement("audio")}} 或 {{htmlelement("video")}}，当可播放元素正在媒体资源中寻找播放位置时。如果用户请求在媒体资源中的特定位置播放，但媒体元素尚未达到该位置，则认为资源正在寻找。
