...
**`::first-line`** [CSS](/zh-CN/docs/Web/CSS) [伪元素](/zh-CN/docs/Web/CSS/Reference/Selectors/Pseudo-elements)在[区块容器](/zh-CN/docs/Web/CSS/CSS_display/Visual_formatting_model#区块容器)的第一行应用样式。
