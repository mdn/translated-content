...
**`::target-text`** [CSS](/zh-CN/docs/Web/CSS) [伪元素](/zh-CN/docs/Web/CSS/Reference/Selectors/Pseudo-elements)代表了浏览器在支持[文本片段](/zh-CN/docs/Web/URI/Reference/Fragment/Text_fragments)技术时所滚动到的文字。它使得作者可以选择高亮一段文字的方式。
