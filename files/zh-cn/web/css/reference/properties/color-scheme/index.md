...
- [`prefers-color-scheme`](/zh-CN/docs/Web/CSS/Reference/At-rules/@media/prefers-color-scheme) 媒体查询来检测用户对配色方案的偏好。
- [使用 CSS 将颜色应用于 HTML 元素](/zh-CN/docs/Web/CSS/Guides/Colors/Applying_color)
