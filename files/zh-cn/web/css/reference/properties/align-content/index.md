...
[CSS](/zh-CN/docs/Web/CSS) 的 **`align-content`** 属性设置了浏览器如何沿着[弹性盒子布局](/zh-CN/docs/Web/CSS/Guides/Flexible_box_layout)的纵轴和[网格布局](/zh-CN/docs/Web/CSS/Guides/Grid_layout)的主轴在内容项之间和周围分配空间。
...
- 弹性盒子布局的基本概念：_[Basic Concepts of Flexbox](/zh-CN/docs/Web/CSS/Guides/Flexible_box_layout/Basic_concepts)_
- 对齐弹性容器中的弹性项目：_[Aligning items in a flex container](/zh-CN/docs/Web/CSS/Guides/Flexible_box_layout/Aligning_items)_
- 网格布局中的盒模型对齐：_[Box alignment in CSS Grid layouts](/zh-CN/docs/Web/CSS/Guides/Grid_layout/Box_alignment)_
