...
<p>在以下示例中，已将容器设置为 <code>display: flex</code> ，这意味着三个子项成为弹性项。<code>justify-content</code> 的值已设置为 <code>space-between</code> ，以便在主轴上均匀地分隔项目。在每个项目之间放置等量的空间，左侧和右侧项目与 Flex 容器的边缘齐平。你还能看到项目在十字轴上拉伸，因为 <code>align-items</code> 的默认值为 <code>stretch</code>。这些项目伸展到 Flex 容器的高度，使它们看起来都像最高的项目一样高。</p>
...
<p>属性 <code>align-content</code>、<code>align-self</code>、<code>align-items</code> 和 <code>justify-content</code> 最初出现在 Flexbox 规范中，但现在在 Box Alignment 中定义，Flexbox 规范引用了 Box Alignment 规范以获取最新定义。Box Alignment 中还定义了其他对齐属性。</p>
...
<dl>
 ...
 <dd>概述 flexbox 的功能</dd>
 <dt><a href="/zh-CN/docs/Web/CSS/CSS_Flexible_Box_Layout/Using_CSS_flexible_boxes">使用 CSS 弹性盒子</a></dt>
 <dd>循序渐进的讲解如何用此特性来建立布局。</dd>
 <dt><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/CSS_Flexible_Box_Layout/Relationship_of_Flexbox_to_Other_Layout_Methods">Flexbox 与其他布局方法的关系</a></dt>
 <dd>Flexbox 如何与其他布局方法和其他 CSS 规范相关</dd>
 <dt><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/CSS_Flexible_Box_Layout/Aligning_Items_in_a_Flex_Container">对齐 Flex 容器中的项目</a></dt>
 <dd>Box Alignment 属性如何与 flexbox 一起使用。</dd>
 ...
 <dd>本文介绍了 flex-grow，flex-shrink 和 flex-basis 属性。</dd>
 ...
 <dd>如何使用多行创建 Flex 容器并控制这些行中项目的显示。</dd>
 ...
 <dt><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/CSS_Flexible_Box_Layout/Backwards_Compatibility_of_Flexbox">Flexbox 的向后兼容性</a></dt>
 <dd>Flexbox 的浏览器状况，互操作性问题以及支持的旧浏览器和规范版本</dd>
</dl>
