...
[CSS](/zh-CN/docs/Web/CSS) [伪类](/zh-CN/docs/Web/CSS/Pseudo-classes) **`:-moz-locale-dir(ltr)`** 是一个 [Mozilla 扩展](/zh-CN/docs/Web/CSS/Mozilla_Extensions)，当用户界面为从左到右显示时，它会匹配元素。其判断依据是首选项 `intl.uidirection.locale`（其中 `locale` 表示当前语言环境）被设置为“ltr”。
