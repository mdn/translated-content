...
<p><strong><code>:host</code></strong> CSS 伪类选择包含其内部使用的 CSS 的 shadow DOM 的根元素 - 换句话说，这允许你从其 shadow DOM 中选择一个自定义元素。</p>
...
<p>在元素的构造函数中，我们创建<code>style</code>和<code>span</code>元素，用自定义元素的内容填充<code>span</code>，并使用一些 CSS 规则填充<code>style</code> 元素：</p>
