...
<p><strong><code>font-variation-settings</code></strong> CSS 属性提供了对 <a href="/en-US/docs/Web/CSS/CSS_Fonts/Variable_Fonts_Guide">variable font</a> 特征的低级控制，通过指定要更改的特征的四个字母轴名称及其值。</p>
...
<div class="note"><strong>Note</strong>: font characteristics set using <code>font-variation-settings</code> will always override those set using the corresponding basic font properties, e.g. <code>font-weight</code>, no matter where they appear in the cascade. In some browsers, this is currently only true when the <code>@font-face</code> declaration includes a <code>font-weight</code> range.</div>
...
<p>See below for interactive examples demonstrating the registered axes. You can find a number of other variable fonts examples at our <a href="/en-US/docs/Web/CSS/CSS_Fonts/Variable_Fonts_Guide">Variable fonts guide</a>, <a href="https://v-fonts.com/">v-fonts.com</a>, and <a href="https://www.axis-praxis.org/">axis-praxis.org</a>.</p>
