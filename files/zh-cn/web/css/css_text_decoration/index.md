...
**CSS 文本装饰**（Text Decoration）模块定义了与文本装饰相关的功能，如下划线、文本阴影和强调标记等。
...
<p>
  这个 <a class="plain" href="#">链接将不会显示下划线</a>，而链接通常默认是带有下划线的。
  在为超链接移除文字装饰时请格外小心，因为用户通常依赖下划线来识别超链接。
</p>
<p class="underover">这段文字上方<em>和</em>下方都有线。</p>
<p class="thick">
  在支持的浏览器中，这段文字下方会有一条非常粗的紫色下划线。
</p>
<p class="blink">
  根据你使用的浏览器，这段文字可能会闪烁。
</p>
