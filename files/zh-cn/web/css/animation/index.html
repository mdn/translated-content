...
<p><a href="/zh-CN/docs/Web/Guide/CSS/Using_CSS_transitions#Which_CSS_properties_are_animatable">哪些属性是可动画的？</a>值得注意的是，此描述也适用于<a href="/en-US/docs/CSS/CSS_transitions">CSS 变换</a>。</p>
...
<ul>
 ...
 <li>{{cssxref("&lt;time&gt;")}} 可能会出现 0、1 或 2 次</li>
</ul>
...
<h3 id="Cylon_Eye"><strong>赛隆人之眼 (赛隆人</strong>是一个虚构的生化人种族，出自科幻电视系列剧星际大争霸系列<strong>)</strong></h3>

<pre class="brush: html line-numbers language-html"><code class="language-html">&lt;div class="view_port"&gt;
...
<pre class="brush: css line-numbers language-css"><code class="language-css">.polling_message {
  color: white;
  float: left;
  margin-right: 2%;
}
...
@-webkit-keyframes move_eye { from { margin-left: -20%; } to { margin-left: 100%; }  }
        @keyframes move_eye { from { margin-left: -20%; } to { margin-left: 100%; }  }</code></pre>

<p>{{EmbedLiveSample('Cylon_Eye')}}</p>

<p>更多示例请参阅<a href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Animations/Using_CSS_animations#Examples">使用 CSS 动画</a>。</p>
...
<ul>
 <li>Gecko 有一个 bug，当你在屏幕上对屏幕外的元素使用带有指定延时的动画时，Gecko 不会在某些平台上重绘，例如 Windows {{bug(1383239)}}。这个问题已经在 Firefox 新的并行 CSS 引擎 (也称为<a href="https://wiki.mozilla.org/Quantum">Quantum CSS</a> 或者 <a href="https://wiki.mozilla.org/Quantum/Stylo">Stylo</a>，计划在 Firefox 57 中发布) 中得到了解决。</li>
 <li>另外一个 Gecko bug，当我们激活&lt;details&gt;元素的动画效果时，即使通过 open 属性也不能将其展示 ({{bug(1382124)}})。Quantum CSS 会将其修复了。</li>
 <li>另一个 bug 是，由于动画使用的是 em 单位，所以即使我们改变父元素的 font-size 属性也不会影响该动画元素 ({{bug(1254424)}})，而它们原本应该受到影响。Quantum CSS 会将其修复了。</li>
</ul>
