...
<p><strong><code>:read-write</code></strong> <code><a href="/zh-CN/docs/Web/CSS">CSS</a></code> <code><a href="/zh-CN/docs/Web/CSS/Pseudo-classes">伪类</a></code> 代表一个元素（例如可输入文本的 input 元素）可以被用户编辑。</p>
