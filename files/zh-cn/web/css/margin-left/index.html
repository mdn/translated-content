...
<p><img alt="Area on which CSS margin-left apply" src="/files/4039/margin-left.svg" style="border-style: solid; border-width: 1px; float: left; margin-bottom: 2em; margin-right: 1em;"><strong><code>margin-left</code></strong>  属性 设置与元素相关联的盒子模型的左外边距。这个值可以为负值。</p>

<p>竖直排列相邻的两个盒子模型的外边距会重叠 <em><a href="/en-US/docs/CSS/margin_collapsing">margin collapsing</a>。</em></p>

<p>在长度 (width) 被约束这种极少情况下，( <code>即当所有的宽度，左边界，边界，填充内容区域和边缘都被定义</code>), 左边界<code>会被忽略，</code>如果被制定为 auto 值，会有相同的计算值。</p>
 ...
 <table class="standard-table">
  ...
  <tbody>
   ...
   <tr>
    ...
    <th><em>any</em></th>
    <td>
     <p>在水平方向上有空余空间的情况下，空余的空间会被平均分给水平方向上写有 margin-left:auto 属性的元素的外边距</p>
    </td>
