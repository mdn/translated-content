...
<p>当我们需要在图形上指定一点的坐标<a href="https://zh.wikipedia.org/wiki/algebra">algebra</a>)，这个坐标需要先对于某一个固定点。这个固定点我们称为原点<a href="https://zh.wikipedia.org/wiki/Origin_(mathematics)">origin</a>. 这个指定点的坐标即为包含在各个维度上相对于远点的距离值。</p>
