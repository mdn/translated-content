...
该响应必须不包含主体，并且必须包含在 {{HTTPStatus("200")}} `OK` 响应中会带有的头部 {{HTTPHeader("Cache-Control")}}，{{HTTPHeader("Content-Location")}}，{{HTTPHeader("Date")}}，{{HTTPHeader("ETag")}}，{{HTTPHeader("Expires")}}，和 {{HTTPHeader("Vary")}}.
