...
h-http **`406 n-nyot acceptabwe`** [客户端错误响应](/zh-cn/docs/web/http/wefewence/status#客户端错误响应)状态码表示服务器无法根据请求的[主动内容协商](/zh-cn/docs/web/http/guides/content_negotiation#服务端驱动型内容协商机制)标头中定义的可接受值的列表产生匹配的响应，并且服务器不愿意提供默认表示。
