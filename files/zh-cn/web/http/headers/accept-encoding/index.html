...
<ul>
 <li>
  <p>IANA 维护了<a href="http://www.iana.org/assignments/http-parameters/http-parameters.xml#http-parameters-1">一个完整的官方支持的编码方式列表</a>。</p>
 </li>
...
<dl>
 ...
 <dd>表示采用 <a href="http://en.wikipedia.org/wiki/LZ77_and_LZ78#LZ77">Lempel-Ziv coding</a> (LZ77) 压缩算法，以及 32 位 CRC 校验的编码方式。</dd>
 <dt><code>compress</code></dt>
 <dd>采用 <a href="http://en.wikipedia.org/wiki/LZW">Lempel-Ziv-Welch</a> (LZW) 压缩算法。</dd>
