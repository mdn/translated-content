...
<p>全局的 <code><a href="/en-US/docs/Web/HTML/Global_attributes/lang">lang</a></code> 属性使用在 HTML 元素去表达全部的 <a href="/en-US/docs/Web/HTML">HTML</a>文档或者部分的语言。</p>

<pre class="brush: html">&lt;html lang="de"&gt;</pre>

<p>不要使用这个 meta 元素去声明文档语言：</p>
