...
<div class="warning">
<p>在表单提交之后， <code>form-action</code> 指令是否应该阻止重定向仍有待讨论，各个浏览器对于此行为的实现也不尽相同（例如，Chrome 63 会阻止重定向，而 Firefox 57 则不会）。</p>
</div>
