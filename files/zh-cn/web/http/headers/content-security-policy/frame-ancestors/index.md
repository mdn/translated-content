...
HTTP 头部 {{HTTPHeader("Content-Security-Policy")}} (CSP) `中的 frame-ancestors` 指令指定了一个可以包含{{HTMLElement("frame")}}，{{HTMLElement("iframe")}}，{{HTMLElement("object")}}，{{HTMLElement("embed")}}，or {{HTMLElement("applet")}}等元素的有效父级。
