...
- [跨域资源共享（CORS）](/zh-CN/docs/Web/HTTP/Guides/CORS)
...
- [HTTP 客户端提示（Client Hint）](/zh-CN/docs/Web/HTTP/Guides/Client_hints)
  - : **客户端提示**是一组响应标头，服务器可以使用它来主动从客户端请求关于设备、网络、用户以及用户代理指定的首选项的信息。然后，服务器可以根据客户端选择提供的信息来确定发送哪些资源。
- [HTTP 的演变](/zh-CN/docs/Web/HTTP/Guides/Evolution_of_HTTP)
...
- [HTTP 状态码](/zh-CN/docs/Web/HTTP/Reference/Status)
  - : HTTP 状态码用来表示指定的 HTTP 请求是否已成功完成。响应分为五类：信息响应、成功响应，重定向、客户端错误和服务器错误。
- [CSP 指令](/zh-CN/docs/Web/HTTP/Reference/Headers/Content-Security-Policy)
...
- [浏览器的工作原理（2011）](https://web.developers.google.cn/articles/howbrowserswork)
