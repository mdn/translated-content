...
<pre class="brush: http"><code class="language-html">Cache-Control: no-store</code></pre>
...
<pre class="brush: http"><code class="language-html">Cache-Control: no-cache</code></pre>
...
<pre class="brush: http"><code class="language-html">Cache-Control: private
...
<pre class="brush: http"><code class="language-html">Cache-Control: max-age=31536000</code></pre>
...
<pre class="brush: http"><code class="language-html">Cache-Control: must-revalidate</code></pre>
...
<pre class="brush: http"><code class="language-html">Vary: User-Agent</code></pre>
