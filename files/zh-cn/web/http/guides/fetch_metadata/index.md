...
通过使用这些标头中的信息来允许或拒绝特定请求，服务器可以实现对[_跨源攻击_](#跨源攻击)如[跨站请求伪造（CSRF）](/zh-CN/docs/Web/Security/Attacks/CSRF)和各种[跨站泄漏](/zh-CN/docs/Web/Security/Attacks/XS-Leaks)的防御。
...
- [跨站信息泄露](/zh‑CN/docs/Web/Security/Attacks/XS‑Leaks)：这类攻击中，攻击者会借助请求获取到用户与目标站点之间的相关信息，这种信息窃取通常是借助[错误事件](/en-US/docs/Web/Security/Attacks/XS-Leaks#leaking_page_existence_using_error_events)这类侧信道完成的。
