...
Web APIs 已经有对 base64 进行编码解码的方法: [Base64 encoding and decoding](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Base64_encoding_and_decoding).
...
- [Base64 encoding and decoding](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Base64_encoding_and_decoding)
- {{domxref("WindowBase64.atob","atob()")}}
- {{domxref("WindowBase64.btoa","btoa()")}}
- [CSS `url()`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/uri)
- [URI](https://developer.mozilla.org/zh-CN/docs/URI)
