...
---
<p>HTTP 是一个拓展性非常好的协议。它依赖于以下的一些基本概念: 像资源或是 URI 的概念 , 一个简单的消息结构，一个客户端 - 服务器结构的通信流。 在这些基础概念之上， 近年来已经出现了许多拓展，以增加新的 HTTP 方法或首部的方式为 HTTP 协议增加了新的功能和语义。</p>
...
<dl>
 ...
 <dd>HTTP 是在 20 世纪 90 年代早期出现的，并且已经被扩充了多次。本文会回顾 HTTP 的发展史，描述 HTTP/0.9、HTTP/1.0、HTTP/1.1 和最新的 HTTP/2， 以及这些年来出现的一些新特性。</dd>
 <dt><u><a href="https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Basics_of_HTTP/Negotiating)an_HTTP_version">商定 HTTP 版本</a></u></dt>
 ...
 <dd>资源 URLs（URLs 是以为<code>resource:scheme</code>前缀的) 是被 Firefox 和 Firefox 浏览器拓展插件用来内在地加载资源， 当然有些资源在浏览器连接的网站上存在的。</dd>
 ...
 <dt><u><a href="https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Flow_of_an_HTTP_session">HTTP 会话流程</a></u></dt>
 <dd>本文描述了一个经典的 HTTP 会话： 当你在浏览器中点击一个链接时，在后台发生了什么...</dd>
 <dt><a href="/zh-CN/docs/Web/HTTP/Messages">HTTP 消息</a></dt>
 <dd>在请求和响应中传输的 HTTP 消息具有非常清晰的结构； 本文介绍了消息的结构、设计目的以及其可能性。</dd>
 ...
 <dt><u><a href="https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Connection_management_in_HTTP_2">HTTP/2 的连接管理</a></u></dt>
