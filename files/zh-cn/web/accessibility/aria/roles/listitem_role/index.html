...
<div class="notecard warning">
  <p><strong>警告：</strong> 如果可能，您应该使用适当的语义化 HTML 元素来标记 <code>list</code> 及其 <code>listitem</code>，如 {{HTMLElement("ul")}}、{{HTMLElement("ol")}} 和 {{HTMLElement("li")}}。有关完整示例，请参阅 <a href="#best_practices">最佳实践</a>。</p>
</div>
...
<div class="notecard note">
  <p><strong>备注：</strong> ARIA <code>list</code> / <code>listitem</code> 角色不区分有序列表和无序列表。</p>
</div>

<div class="notecard note">
  <p><strong>备注：</strong> 如果要标记将用作选项卡式界面的项目列表，则应改为使用 <code>tab</code>、<code>tabpanel</code> 和 <code>tablist</code> 角色。</p>
</div>
