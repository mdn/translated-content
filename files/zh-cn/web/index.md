...
- [Web 开发者指南](/zh-CN/docs/MDN/Guides)
  - : Web 开发者指南提供了实用的操作方法内容，帮助你使用 Web 技术实现你的目标或需求。
- [面向 Web 开发者的教程](/zh-CN/docs/MDN/Tutorials)
...
- [OpenSearch](/zh-CN/docs/Web/XML/Guides/OpenSearch)
...
- [XSLT](/zh-CN/docs/Web/XML/XSLT)
  - : 可扩展样式表语言转换是一种基于 [XML](/zh-CN/docs/Web/XML/Guides/XML_introduction) 的语言，和专门的处理软件一起使用，用于 XML 文档转换。
- [XPath](/zh-CN/docs/Web/XML/XPath)
  - : XPath 使用非 XML 语法来提供一种灵活地定位（指向）[XML](/zh-CN/docs/Web/XML/Guides/XML_introduction) 文档的不同部分的方法。它也可以用于检查文档中某个定位节点是否与某个模式匹配。
- [EXSLT](/zh-CN/docs/Web/XML/EXSLT)
...
- [Edge 开发者工具](https://learn.microsoft.com/zh-cn/microsoft-edge/devtools-guide-chromium/landing/)
