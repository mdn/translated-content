...
---
<p><strong>安全上下文</strong>是 <code>Window</code> 与 <code>Worker</code> 中的概念满足了最低标准的身份验证和机密性。许多 Web APIs 的访问仅能在安全上下文中. 安全上下文的主要目标是防止 <a href="https://zh.wikipedia.org/wiki/man-in-the-middle_attack">MITM attackers</a> 强大的 APIs 被坏人利用。</p>

<h2 id="为什么要限制某些功能">为什么要限制某些功能？</h2>

<p>有些 APIs 是非常强大的，能给攻击者更强的能力以及更多的操作：</p>
