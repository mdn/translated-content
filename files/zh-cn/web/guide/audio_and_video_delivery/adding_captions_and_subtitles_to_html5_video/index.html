...
<div class="note">
<p><strong>Note</strong>: 观众老爷可以点击这里 <a href="https://github.com/iandevlin/iandevlin.github.io/tree/master/mdn/video-player-with-captions">查看 Github 源码</a>, 或者<a href="http://iandevlin.github.io/mdn/video-player-with-captions/">浏览在线视频</a>.</p>
</div>

<h2 id="HTML5视频字幕">HTML5 视频字幕</h2>
...
<h2 id="修改_HTML和CSS">修改 HTML 和 CSS</h2>
