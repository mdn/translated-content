...
<pre class="notranslate">user_pref("capability.policy.policynames", "allowclipboard");
...
<div class="note"><strong>注意：</strong> 如果你想知道如何标准的在你的页面中创建和插入编辑器，请查阅 <a href="/@api/deki/files/6243/=rich-text-editor.zip">更多完整的富文本编辑器例子</a>.</div>
