...
对于 PWA（渐进式 Web 应用）来说，[响应式设计](/zh-CN/docs/Learn/CSS/CSS_layout/Responsive_Design)至关重要，以确保任何屏幕大小的设备都能访问到内容。用户应能够无论他们的设备屏幕大小如何，都能访问所有的功能和内容。通过在不同视口大小重新排列内容，你可以优先显示重要的数据和操作。
