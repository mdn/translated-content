...
在前面的文章我们介绍了很多 API，例如：[Service Worker](/zh-CN/docs/Web/Progressive_web_apps/Tutorials/js13kGames/Offline_Service_workers)、[Web 应用程序清单](/zh-CN/docs/Web/Progressive_web_apps/Guides/Making_PWAs_installable)、[通知和推送](/zh-CN/docs/Web/Progressive_web_apps/Tutorials/js13kGames/Re-engageable_Notifications_Push)，它们让我们的示例应用 [js13kPWA](https://mdn.github.io/pwa-examples/js13kpwa/) 成为一个渐进式 Web 应用。在这篇文章里我们将会更进一步，使用资源渐进式加载来提高整个应用的性能。
...
这就是这个系列的所有内容了。我们通过 [js13kPWA 示例应用的源码](https://github.com/mdn/pwa-examples/tree/main/js13kpwa) 学习了渐进式 Web 应用的用法，包括 [PWA 介绍](/zh-CN/docs/Web/Progressive_web_apps/Tutorials/js13kGames)、[PWA 结构](/zh-CN/docs/Web/Progressive_web_apps/Tutorials/js13kGames/App_structure)、[通过 Service Worker 让 PWA 离线工作](/zh-CN/docs/Web/Progressive_web_apps/Tutorials/js13kGames/Offline_Service_workers)、[让 PWA 易于安装](/zh-CN/docs/Web/Progressive_web_apps/Guides/Making_PWAs_installable)，以及最后的通知功能。在 [Service Worker Cookbook](https://github.com/mdn/serviceworker-cookbook/) 的帮助下，我们还解释了推送的原理。而在本篇文章中，我们探讨了渐进式加载的概念，包括一个使用了 [Intersection Observer API](/zh-CN/docs/Web/API/Intersection_Observer_API) 的有趣示例。
