...
<p>剩余参数和 <code><a href="/zh-cn/JavaScript/Reference/Functions_and_function_scope/arguments">arguments</a></code>对象之间的区别主要有三个：</p>

<ul>
 <li>剩余参数只包含那些没有对应形参的实参，而 <code>arguments</code> 对象包含了传给函数的所有实参。</li>
 <li><code>arguments</code>对象不是一个真正的数组，而剩余参数是真正的 <code><a href="/zh-cn/JavaScript/Reference/Global_Objects/Array">Array</a></code>实例，也就是说你能够在它上面直接使用所有的数组方法，比如 <code><a href="/zh-cn/JavaScript/Reference/Global_Objects/Array/sort">sort</a></code>，<code><a href="/zh-cn/JavaScript/Reference/Global_Objects/Array/map">map</a></code>，<code><a href="/zh-cn/JavaScript/Reference/Global_Objects/Array/forEach">forEach</a></code>或<code><a href="/zh-cn/JavaScript/Reference/Global_Objects/Array/pop">pop</a></code>。</li>
...
<ul>
 <li><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Spread_operator">Spread operator</a> (also ‘<code>...</code>’)</li>
