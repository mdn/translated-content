...
<p>The exponentiation assignment operator (<code>**=</code>) raises the value of a variable to the power of the right operand.</p>
...
<h3 id="Using_exponentiation_assignment">Using exponentiation assignment</h3>
