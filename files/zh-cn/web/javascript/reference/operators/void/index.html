...
<p>当用户点击一个以 <code>javascript:</code> 开头的 URI 时，它会执行 URI 中的代码，然后用返回的值替换页面内容，除非返回的值是{{jsxref("Global_Objects/undefined", "undefined")}}。<code>void</code>运算符可用于返回{{jsxref("Global_Objects/undefined", "undefined")}}。例如：</p>
