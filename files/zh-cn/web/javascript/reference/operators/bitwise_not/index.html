...
<pre class="syntaxbox"><code><var>~a</var></code>
</pre>

<h2 id="描述">描述</h2>

<p>操作数被转换为 32 位二进制表示（0 和 1）。超过 32 位的数字将丢弃其最高有效位。如下例子中，超过 32 位的整数转换为 32 位整数：</p>
...
<p>按位非运算时，任何数字 <code>x</code> 的运算结果都是 <code>-(x + 1)</code>。例如，<code>〜-5</code> 运算结果为 <code>4</code>。</p>
...
<p>请注意，由于对数字<code>~-1</code>和<code>~4294967295</code> (2^32 - 1) 使用 32 位表示形式，结果均为 0。</p>
