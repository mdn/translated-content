...
<dl>
 ...
 <dd>一个字符串类型或者 symbol 类型的属性名或者数组索引（非 symbol 类型将会强制转为字符串）。</dd>
...
<p>如果你使用 <code><a href="/zh-CN/docs/JavaScript/Reference/Operators/delete">delete</a></code> 运算符删除了一个属性，则 <code>in</code> 运算符对所删除属性返回 <code>false</code>。</p>
...
<pre class="brush:js">"toString" in {}; // 返回 true
</pre>
...
<ul>
 ...
 <li><code><a href="/zh-CN/docs/JavaScript/Reference/Operators/delete">delete</a></code></li>
