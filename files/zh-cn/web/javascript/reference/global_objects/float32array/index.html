...
<p><strong><code>Float32Array</code></strong> 类型数组代表的是平台字节顺序为 32 位的浮点数型数组 (对应于 C 浮点数据类型) 。 如果需要控制字节顺序， 使用 {{jsxref("DataView")}} 替代。其内容初始化为 <code>0</code>。一旦建立起来，你可以使用这个对象的方法对其元素进行操作，或者使用标准数组索引语法 (使用方括号)。</p>
...
<dl>
 ...
 <dd>返回元素字节数。在 <code>Float32Array</code> 的情况下返回 4。</dd>
...
<dl>
 ...
 <dd>从一个类数组对象或可遍历对象创建一个新的 Float32Array。参见 {{jsxref("Array.from()")}}。</dd>
 <dt>{{jsxref("TypedArray.of", "Float32Array.of()")}}</dt>
 <dd>用可变数量的参数创建一个新的 Float32Array。 参见 {{jsxref("Array.of()")}}。</dd>
</dl>

<h2 id="Boolean_instances"><code>Float32Array</code> 属性</h2>

<p>所有的<code>Float32Array 对象都</code>继承自 {{jsxref("TypedArray.prototype", "%TypedArray%.prototype")}}。</p>
...
<dl>
 ...
 <dd>返回这个<code>Float32Array</code> 引用的 {{jsxref("ArrayBuffer")}}。构造时已固定，所以是<strong>只读</strong>的。</dd>
 <dt>{{jsxref("TypedArray.prototype.byteLength", "Float32Array.prototype.byteLength")}} {{readonlyInline}}</dt>
 <dd>返回从<code>Float32Array</code> 的 {{jsxref("ArrayBuffer")}} 开头开始的长度 (以字节为单位) 。构造时已固定，所以是<strong>只读</strong>的。</dd>
 <dt>{{jsxref("TypedArray.prototype.byteOffset", "Float32Array.prototype.byteOffset")}} {{readonlyInline}}</dt>
 <dd>返回从<code>Float32Array</code> 的 {{jsxref("ArrayBuffer")}} 开头开始的偏移量（以字节为单位）。构造时已固定，所以是<strong>只读</strong>的。</dd>
 <dt>{{jsxref("TypedArray.prototype.length", "Float32Array.prototype.length")}} {{readonlyInline}}</dt>
 <dd>返回 <code>Float32Array</code> 中的元素个数。构造时已固定，所以是<strong>只读</strong>的。</dd>
</dl>
...
<p>从 ECMAScript 2015 (ES6) 开始， <code>Float32Array</code>构造函数需要用一个{{jsxref("Operators/new", "new")}}操作符来构造。现在直接把<code>Float32Array 构造函数当函数调用而不使用 new，会抛出一个</code>{{jsxref("TypeError")}}。</p>
