...
<p>目前没有默认设定了<code>[Symbol.asyncIterator]</code>属性的 JavaScript 内建的对象。不过，WHATWG（网页超文本应用技术工作小组）Streams 会被设定为第一批异步可迭代对象，<code>[Symbol.asyncIterator]</code> 最近已在设计规范中落地。</p>
