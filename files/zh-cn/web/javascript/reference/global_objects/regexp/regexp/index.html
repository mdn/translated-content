...
<p>阅读<a href="/zh-CN/docs/Web/JavaScript/Guide">JavaScript 指南</a>中的<a href="/zh-CN/docs/Web/JavaScript/Guide/Regular_Expressions">正则表达式</a>一节以了解正则表达式。</p>
...
<dl>
 ...
 <dd>正则表达式的文本。从 ES5 开始，这也可以是另一个<code>RegExp</code>对象或文字 (仅用于两个 RegExp 构造函数符号)。模式可以包含特殊字符<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions#Using_special_characters">special characters</a>来匹配比字面值字符串更广泛的值范围。</dd>
 <dt><code><var>flags</var></code></dt>
 <dd>
 <p>如果指定，<code><var>flags</var></code> 是包含要添加的标志的字符串。</p>

 <p>或者，如果为模式提供了一个对象，flags 字符串将替换该对象的任何标志 (并且<code>lastIndex</code>将重置为 0)(从 ES2015 开始)。</p>
 
 <p>如果没有指定<code><var>flags</var></code>并且提供了一个正则表达式对象，则该对象的 flags(和 lastIndex 值) 将被复制。</p>
 ...
 <dl>
  ...
  <dd>如果<code>u</code>标志也被启用，使用 Unicode 大小写折叠。</dd>
...
<ul>
<li><a href="/zh-CN/docs/Web/JavaScript/Guide">JavaScript 指南中的</a></li>
