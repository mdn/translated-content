...
你不能使用属性访问器 (`` RegExp.$` ``) 来使用简写的别名，因为解析器在这里会将其看做模板字符串的开始，并抛出 {{jsxref("SyntaxError")}} 。使用 [方括号符号](/en-US/docs/Web/JavaScript/Reference/Operators/Property_Accessors)来访问属性。
