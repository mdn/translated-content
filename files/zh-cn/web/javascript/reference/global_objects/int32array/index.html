...
<p>该 <strong><code>Int32Array</code></strong> 类型表示在平台顺序字节中一个双补码 32 位有符号的整型数组。如果需要控制字节顺序，请改用 {{jsxref("DataView")}}。此内容的初始化为 <code>0</code>。一旦创建，你可以使用对象的方法或者标准数组索引的语法 (即使用括号表示法)。</p>
...
<dl>
 ...
 <dd>如果数组中至少有一个元素满足所提供的测试函数，则返回 true。更多请见{{jsxref("Array.prototype.some()")}}。</dd>
