...
<dl>
 ...
 <dd>ArrayBuffer 构造函数的 length 属性，其值为 1。</dd>
 <dt>{{jsxref("ArrayBuffer.prototype.byteLength")}}</dt>
 <dd>只读属性，表示 <code>ArrayBuffer</code> 的 byte 的大小，在 ArrayBuffer 构造完成时生成，不可改变。</dd>
...
<ul>
 ...
 <li><a href="zh-CN/docs/Web/JavaScript/Typed_arrays">{{jsxref("SharedArrayBuffer")}}</a></li>
</ul>
