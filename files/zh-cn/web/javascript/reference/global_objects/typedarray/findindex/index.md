...
如果某个元素满足所提供的测试函数，**`findIndex()`**方法返回类型化数组中的 **下标**。否则返回 -1。 _TypedArray_ 是这里的 [类型化数组类型](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/TypedArray#TypedArray_objects) 之一。
