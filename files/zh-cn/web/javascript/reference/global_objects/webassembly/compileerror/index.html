...
<p><code><strong>WebAssembly.CompileError()</strong></code>构造函数创建一个新的 WebAssembly <code>CompileError</code>对象，该对象表示 WebAssembly 解码或验证期间的错误。</p>
...
<dl>
 ...
 <dd>错误信息。尽管 ECMA-262 指定{{jsxref("URIError")}}应提供自己的<code>message</code>属性，但在<a href="/en-US/docs/Mozilla/Projects/SpiderMonkey">SpiderMonkey</a>中，它继承了 {{jsxref("Error.prototype.message")}}。</dd>
...
<p>以下代码段创建一个新的 CompileError 实例，并将其详细信息记录到控制台：</p>
