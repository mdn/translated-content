...
<p><code><strong>WebAssembly.RuntimeError()</strong></code>构造函数创建一个新的 WebAssembly RuntimeError 对象 --- 一个每当 WebAssembly 陷入指定陷阱时将抛出的类型。</p>
...
<dl>
 ...
 <dd>错误信息。 尽管 ECMA-262 指定{{jsxref("URIError")}}应提供自己的<code>message</code>属性，但在<a href="https://developer.mozilla.org/en-US/docs/Mozilla/Projects/SpiderMonkey">SpiderMonkey</a>中，它继承了{{jsxref("Error.prototype.message")}}。</dd>
...
<p>以下代码段创建了一个新的 RuntimeError 实例，并将其详细信息记录到控制台：</p>
