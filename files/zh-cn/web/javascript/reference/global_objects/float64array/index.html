...
<p><strong><code>Float64Array</code></strong> 类型数组代表的是平台字节顺序为 64 位的浮点数型数组 (对应于 C 浮点数据类型) 。 如果需要控制字节顺序，使用 {{jsxref("DataView")}} 替代。其内容初始化为<code>0</code>。一旦建立起来，你可以使用这个对象的方法对其元素进行操作，或者使用标准数组索引语法 (使用方括号)。</p>
...
<dl>
 ...
 <dd>返回元素字节数。<code>在</code> <code>Float64Array</code> 的情况下返回 8。</dd>
...
<dl>
 ...
 <dd>从一个类数组对象或可遍历对象创建一个新的 Float64Array。参见 {{jsxref("Array.from()")}}。</dd>
 <dt>{{jsxref("TypedArray.of", "Float64Array.of()")}}</dt>
 <dd>用可变数量的参数创建一个新的 Float64Array。 参见 {{jsxref("Array.of()")}}。</dd>
</dl>

<h2 id="Float64Array_属性"><code>Float64Array</code> 属性</h2>

<p>所有的 <code>Float64Array</code> 对象都继承自 {{jsxref("TypedArray.prototype", "%TypedArray%.prototype")}}。</p>
...
<dl>
 ...
 <dd>返回这个<code>Float64Array 引用的</code> {{jsxref("ArrayBuffer")}}。构造时已固定，所以是<strong>只读</strong>的。</dd>
 <dt>{{jsxref("TypedArray.prototype.byteLength", "Float64Array.prototype.byteLength")}} {{readonlyInline}}</dt>
 <dd>返回从<code>Float64Array 的</code>{{jsxref("ArrayBuffer")}}开头开始<code>的</code>长度 (以字节为单位) 。构造时已固定，所以是<strong>只读</strong>的。</dd>
 <dt>{{jsxref("TypedArray.prototype.byteOffset", "Float64Array.prototype.byteOffset")}} {{readonlyInline}}</dt>
 <dd>返回从<code>Float64Array 的</code>{{jsxref("ArrayBuffer")}}开头开始<code>的偏移量</code> (以字节为单位) 。构造时已固定，所以是<strong>只读</strong>的。</dd>
 <dt>{{jsxref("TypedArray.prototype.length", "Float64Array.prototype.length")}} {{readonlyInline}}</dt>
 <dd>返回 <code>Float64Array</code> 中的元素个数。构造时已固定，所以是<strong>只读</strong>的。</dd>
</dl>
...
<dl>
 ...
 <dd>创建一个新数组，数据为原数组中所有能让给入函数返回 true 的元素。参见{{jsxref("Array.prototype.filter()")}}。</dd>
 <dt>{{jsxref("TypedArray.find", "Float64Array.prototype.find()")}}</dt>
 <dd>返回满足测试函数的值，如果没有找到，返回 undefined。 参见{{jsxref("Array.prototype.find()")}}。</dd>
 ...
 <dd>判断是否包含某个元素，返回 <code>true</code> 或 <code>false</code>。参见{{jsxref("Array.prototype.includes()")}}。</dd>
 ...
 <dd>如果数组中至少有一个元素满足测试函数的要求则返回 true。参见{{jsxref("Array.prototype.some()")}}。</dd>
...
<p>从 ECMAScript 2015 (ES6) 开始，<code>Float32Array</code> 构造函数需要用一个 {{jsxref("Operators/new", "new")}} 操作符来构造。现在直接把 <code>Float32Array</code> 构造函数当函数调用而不使用 new，会抛出一个 {{jsxref("TypeError")}}。</p>
