...
<p><strong><code>InternalError</code> 对象</strong>表示出现在 JavaScript 引擎内部的错误。 例如： <strong>"InternalError</strong>: too much recursion"（内部错误：递归过深）。</p>
...
<p>当 JavaScript 引擎出现内部错误时将会抛出<code>InternalError。</code></p>
