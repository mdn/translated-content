...
<h3 id="Character_access">从字符串中获取单个字符</h3>
...
<h3 id="Comparing_strings">字符串比较</h3>
...
<div class="note">
<p><strong>备注：</strong> 其他的将字符串对象转换成基本字符串的方法可以及参考 <a href="/zh-CN/docs/Web/JavaScript/Typed_arrays/StringView"><code>StringView</code> – a C-like representation of strings based on typed arrays</a>.</p>
</div>
...
<p>移除字符串泛型的措施，参见 <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Errors/Deprecated_string_generics">Warning: String.x is deprecated; use String.prototype.x instead</a>.</p>

<p>{{jsxref("Global_Objects/Array", "Generics", "#Array_generic_methods", 1)}} 在 Javascript 1.6 中同样支持{{jsxref("Global_Objects/Array", "Array")}}。</p>

<h2 id="String_instances"><code>String</code> 实例</h2>
