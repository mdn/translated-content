...
<p><code>__defineGetter__</code> 方法可以为一个已经存在的对象设置（新建或修改）访问器属性，而 {{jsxref("Operators/get", "对象字面量中的 get 语法", "", 1)}} 只能在新建一个对象时使用。</p>
...
<ul>
 ...
 <li><a href="http://whereswalden.com/2010/04/16/more-spidermonkey-changes-ancient-esoteric-very-rarely-used-syntax-for-creating-getters-and-setters-is-being-removed/">[个人博文] defineGetter__ 和 __defineSetter__ 已被废弃</a></li>
</ul>
