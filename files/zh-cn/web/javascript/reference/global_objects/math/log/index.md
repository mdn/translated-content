...
<h3 id="Example:_Using_Math.log">例子 1:使用<code>Math.log</code></h3>
...
<h3 id="例子_2：使用_math.log_时基于不同的底数">例子 2：使用 <code>Math.log</code> 时基于不同的底数</h3>

<p>下面的函数返回以 <code>x</code> 为底 <code>y</code> 的对数（即 log<sub>x</sub> y）：</p>
