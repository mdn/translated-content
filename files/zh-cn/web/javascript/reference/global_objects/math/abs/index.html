...
<p>由于 <code>Math.abs()</code> 是 <code>Math</code> 中的一个静态方法，你应该通过 <code>Math.abs()</code> 调用。（Math 不是构造器）</p>

<h2 id="Examples">示例</h2>

<h3 id="Example:_Math.abs_behavior">Math.abs() 函数的行为</h3>

<p>传入一个非数字形式的字符串或者 {{jsxref("undefined")}}/empty 变量，将返回 {{jsxref("NaN")}}。传入 {{jsxref("null")}} 将返回 0。</p>
