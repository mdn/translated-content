...
<dl>
 ...
 <dl>
  ...
  <dd>被迭代的 map（上文语法框中的 <code><var>myMap</var></code>）。</dd>
 </dl>
 </dd>
...
<p><code>forEach</code> 方法会对 map 中每个真实存在的键执行一次给定的 <code>callback</code> 函数。它不会对被删除的键执行函数。然而，它会对每个值为 <code>undefined</code> 的键执行函数。</p>
