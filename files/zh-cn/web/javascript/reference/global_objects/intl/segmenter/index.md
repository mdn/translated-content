...
- {{jsxref("Intl/Segmenter/segment", "Intl.Segmenter.prototype.segment()")}}
  - : 返回一个新的可迭代的 [`Segments`](/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Intl/Segmenter/segment/Segments) 实例，包含了根据当前 `Intl.Segmenter` 实例的语言环境和粒度选项生成的字符串片段。
...
- [`Intl.Segmenter` 在 FormatJS 中的 polyfill](https://formatjs.github.io/docs/polyfills/intl-segmenter/)
- {{jsxref("Intl")}}
