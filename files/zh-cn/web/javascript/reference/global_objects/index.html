...
<p>这里的术语"全局对象"（或标准内置对象）不应与<strong>global 对象</strong>混淆。这里的"全局对象"指的是<strong>处在全局作用域里的多个对象</strong>。</p>

<p><strong>global 对象</strong>可以在全局作用域里通过使用{{JSxRef("Operators/this", "this")}}访问到（但只有在 ECMAScript 5 的非严格模式下才可以，在严格模式下得到的是 {{JSxRef("undefined")}}）。其实全局作用域<strong>包含</strong>全局对象中的属性，包括它可能继承来的属性。</p>
...
<p>ECMAScript 核心的附加功能，用于支持多语言处理。</p>
