...
<p><strong><code>GeneratorFunction</code>构造器</strong>生成新的{{jsxref("Statements/function*", "生成器函数")}} 对象。在 JavaScript 中，生成器函数实际上都是<code>GeneratorFunction</code>的实例对象。</p>
...
<dl>
 ...
 <dd>函数使用的名称作为形式参数名称。每个必须是一个字符串，对应于一个有效的 JavaScript 标识符或这样的字符串的列表，用逗号分隔；如“<code>x</code>”，“<code>theValue</code>”或“<code>a,b</code>”。</dd>
 <dt><code>functionBody</code></dt>
 <dd>一个包含多条表示 JavaScript 函数体语句的字符串。</dd>
</dl>
