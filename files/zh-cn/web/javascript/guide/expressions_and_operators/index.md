...
| 指数运算符 (\*\*) | 计算 `base(底数)` 的 `exponent`(指数) 次方, 表示为`base^exponent`                                                                            | `2 ** 3` 返回 `8`. `10 ** -1` 返回 `0.1`.                                                                |
|                   |                                                                                                                                                |                                                                                                                |
...
你可以使用[`new` operator](/zh-CN/docs/Web/JavaScript/Reference/Operators/new) 创建一个自定义类型或者是预置类型的对象实例。用法如下：
