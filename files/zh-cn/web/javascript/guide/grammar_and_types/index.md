...
ECMAScript 2015 增加了一种新的字面量，叫做模板字面量 **[template literals](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/template_strings)。**它包含一些新特征，包括了多行字符串！
