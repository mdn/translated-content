...
<p>或者调用<code><a href="/zh-CN/docs/JavaScript/Reference/Global_Objects/RegExp">RegExp</a></code>对象的构造函数，如下所示：</p>
 ...
 <tbody>
  <tr>
   ...
   <td>
    ...
    <p>在非特殊字符之前的反斜杠表示下一个字符是特殊字符，不能按照字面理解。例如，前面没有 "\" 的 "b" 通常匹配小写字母 "b"，即字符会被作为字面理解，无论它出现在哪里。但如果前面加了 "\"，它将不再匹配任何字符，而是表示一个<a href="#note">字符边界</a>。</p>
  ...
  <tr>
   <td><a href="#special-lookahead"><code>(?&lt;=y)</code></a>x</td>
   <td>
  ...
  <tr>
   <td><a href="#special-form-feed"><code>\f</code></a></td>
  ...
  <tr>
   <td>
    <p><code><a href="#special-unicode-escape-es6">\u{hhhh}</a>或\u{hhhhh}</code></p>
   </td>
