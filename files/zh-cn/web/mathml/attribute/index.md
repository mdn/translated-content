...
> **备注：** 就像 [MathML](/zh-CN/docs/Web/MathML) 主页所解释的那样，MDN 使用 [MathML 核心](https://w3c.github.io/mathml-core/)作为参考规范。不过，一些浏览器仍在使用的传统功能也被记录在案。你可以在 
 [MathML 4](https://w3c.github.io/mathml/) 中找到有关这些功能和其他功能的更多详细信息。
