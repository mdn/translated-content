...
- `display`
  - : 该[枚举](/zh-CN/docs/Glossary/Enumerated)属性指定了应如何渲染封闭的 MathML 标记。其可以是以下值之一：
    - `block`，这意味着该元素将显示在当前文本范围之外的块中，并将 [`math-style`](/zh-CN/docs/Web/CSS/Reference/Properties/math-style) 设置为 `normal`。
    - `inline`，这意味着该元素将显示在当前的文本范围内，并将 [`math-style`](/zh-CN/docs/Web/CSS/Reference/Properties/math-style) 设置为 `compact`。
