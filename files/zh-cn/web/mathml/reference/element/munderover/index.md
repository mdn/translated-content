...
- `accent`
  - : [`<boolean>`](/zh-CN/docs/Web/MathML/Reference/Values#mathml_特定类型)，表示上标是否应被着重标识（即，绘制得更大并且更接近基本表达式）。
- `accentunder`
  - : [`<boolean>`](/zh-CN/docs/Web/MathML/Reference/Values#mathml_特定类型)，表示下标是否应被着重标识（即，绘制得更大并且更接近基本表达式）。
