...
<h4 id="Example_in_HTML5_texthtml">HTML 网页中的 MathML</h4>
...
<p>浏览器不支持转换 MathML 的内容。建议在发布网页之前，把你的 MathML 内容标记转换成 MathML 表达式，比如说利用 <a href="https://code.google.com/p/web-xslt/source/browse/trunk/#trunk/ctop">ctop.xsl</a> 样式表作为辅助。本页提到的工具可以生成 MathML 表达式。</p>
