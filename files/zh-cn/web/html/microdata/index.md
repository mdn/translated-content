...
<p><a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/itemscope">itemscope </a>– Itemscope（通常）与<a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/itemtype">itemtype</a>一起使用，以指定块中包含的关于特定项目的 HTML。 itemscope 创建 Item 并定义与之关联的 itemtype 的范围。 itemtype 是描述项及其属性上下文的词汇表（例如<a href="http://schema.org/">schema.org</a>）的有效 URL。</p>
...
<table class="standard-table">
 <tbody>
  <tr>
   ...
   <td>itemtype</td>
   <td colspan="2" rowspan="1">SoftwareApplication (http://schema.org/SoftwareApplication)</td>
  </tr>
  <tr>
   <td>itemprop</td>
   <td>name</td>
