...
---
<p>HTML input 元素 <strong><code>&lt;input type="checkbox"&gt;</code></strong> 允许你为表单中（或不在表单中）的提交项选择一个单一值。</p>

<div class="note">
<p><strong>备注：</strong> 若表单提交时，checkbox 未勾选，则提交的值并非为 value=unchecked；此时的值不会被提交到服务器。</p>
</div>
