...
<p>{{HTMLElement("input")}} 类型为 <strong><code>week</code></strong> 的元素会创建输入字段，以便轻松输入年份以及该年（即第 1 周到<a href="https://en.wikipedia.org/wiki/ISO_8601#Week_dates">52 or 53</a>周）的<a href="https://en.wikipedia.org/wiki/ISO_8601#Week_dates">ISO 8601 week number</a> </p>
...
<p><img src="week-control-chrome.png"></p>

<p>Edge 的<code>week</code>控制更加精细，使用滚动的滚轮打开周和年的选择器。</p>

<p><img src="week-control-edge.png"></p>
...
<p><img src="week-validation-chrome.png"></p>
...
<p><br>
 诸如 Android 和 iOS 之类的移动平台确实很好地利用了这种输入类型，提供了专门的 UI 控件，使在触摸屏环境中选择值变得非常容易。 例如，Android 版 Chrome 上的周选择器如下所示：<img src="week-chrome-android.png"></p>
