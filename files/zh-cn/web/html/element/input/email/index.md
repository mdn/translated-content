...
<table class="properties">
  <tbody>
    ...
    <tr>
      ...
      <td>
        [`autocomplete`](/zh-CN/docs/Web/HTML/Element/input#autocomplete)、[`list`](/zh-CN/docs/Web/HTML/Element/input#list)、[`maxlength`](/zh-CN/docs/Web/HTML/Element/input#maxlength)、[`minlength`](/zh-CN/docs/Web/HTML/Element/input#minlength)、[`multiple`](/zh-CN/docs/Web/HTML/Element/input#multiple)、[`name`](/zh-CN/docs/Web/HTML/Element/input#name)、[`pattern`](/zh-CN/docs/Web/HTML/Element/input#pattern)、[`placeholder`](/zh-CN/docs/Web/HTML/Element/input#placeholder)、[`readonly`](/zh-CN/docs/Web/HTML/Element/input#readonly)、[`required`](/zh-CN/docs/Web/HTML/Element/input#required)、[`size`](/zh-CN/docs/Web/HTML/Element/input#size) 和 [`type`](/zh-CN/docs/Web/HTML/Element/input#type)
      </td>
    </tr>
    <tr>
