...
<p><code>{{HTMLElement("input")}}</code> 元素的<code><strong>text</strong></code> 类型创建基础的单行文本框。</p>
...
<p>如果文本框中的字符数大于 <code>maxlength</code> UTF-16 编码单元，输入框的<a href="/en-US/docs/Web/Guide/HTML/HTML5/Constraint_validation">验证</a>就会失败。 约束验证仅作用于用户输入值的时候。</p>
...
<ul>
 ...
 <li>{{HTMLElement("textarea")}}: Multi-line text inputmaxlength</li>
</ul>
