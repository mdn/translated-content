...
<table class="properties">
 <tbody>
  ...
  <tr>
   ...
   <td>[`autocomplete`](/zh-CN/docs/Web/HTML/Element/input#autocomplete)、[`list`](/zh-CN/docs/Web/HTML/Element/input#list)、[`maxlength`](/zh-CN/docs/Web/HTML/Element/input#maxlength)、[`minlength`](/zh-CN/docs/Web/HTML/Element/input#minlength)、[`pattern`](/zh-CN/docs/Web/HTML/Element/input#pattern)、[`placeholder`](/zh-CN/docs/Web/HTML/Element/input#placeholder)、[`required`](/zh-CN/docs/Web/HTML/Element/input#required)、[`size`](/zh-CN/docs/Web/HTML/Element/input#size)。</td>
  </tr>
  <tr>
