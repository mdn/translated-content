 ...
 <tbody>
  ...
  <tr>
   <td><strong>支持的通用属性</strong></td>
      <td>
        [`autocomplete`](/zh-CN/docs/Web/HTML/Element/input#autocomplete)、[`list`](/zh-CN/docs/Web/HTML/Element/input#list)、[`maxlength`](/zh-CN/docs/Web/HTML/Element/input#maxlength)、[`minlength`](/zh-CN/docs/Web/HTML/Element/input#minlength)、[`pattern`](/zh-CN/docs/Web/HTML/Element/input#pattern)、[`placeholder`](/zh-CN/docs/Web/HTML/Element/input#placeholder)、[`readonly`](/zh-CN/docs/Web/HTML/Element/input#readonly) 和 [`size`](/zh-CN/docs/Web/HTML/Element/input#size)
      </td>
  </tr>
  <tr>
