...
```html
<p>
  几乎每个开发人员最喜欢的分子都是 C<sub>8</sub>H<sub>10</sub>N<sub>4</sub>O<sub>2</sub>，它通常被称为“咖啡因”。
</p>
```
...
<table class="properties">
  <tbody>
    ...
    <tr>
      ...
      <td>
        <code
          ><a href="/zh-CN/docs/Web/Accessibility/ARIA/Roles/structural_roles#有 HTML 等价形式的结构角色">subscript</a
          ></code
        >
      </td>
    </tr>
