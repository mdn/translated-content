...
- _[内容分类](/zh-CN/docs/Web/HTML/Content_categories)_ None.
- _允许的内容_[流内容](/zh-CN/docs/Web/HTML/Content_categories#flowing_content)，但是不能包含 {{HTMLElement("header")}} 元素、{{HTMLElement("footer")}} 元素或者其他章节、标题内容。
...
查看示例请移步 [定义列表示例](/zh-CN/docs/Web/HTML/Element/dl#examples)。
