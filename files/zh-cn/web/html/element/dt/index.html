...
<ul>
 ...
 <li><dfn>允许的内容</dfn><a href="/en-US/docs/HTML/Content_categories#Flowing_content">流内容</a>，但是不能包含 {{HTMLElement("header")}} 元素、{{HTMLElement("footer")}} 元素或者其他章节、标题内容。</li>
 ...
 <li><dfn>DOM 接口</dfn> {{domxref("HTMLElement")}} Up to Gecko 1.9.2 (Firefox 4) inclusive, Firefox implements the <a href="/en-US/docs/DOM/span">HTMLSpanElement</a> interface for this element.</li>
</ul>
