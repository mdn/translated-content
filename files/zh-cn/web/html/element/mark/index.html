...
<p>这个<em> HTML mark </em>标签代表突出显示的文字，例如可以为了<strong>标记</strong>特定上下文中的文本而使用这个标签<strong>.</strong> 举个例子，它可以用来显示搜索引擎搜索后关键词</p>

<ul>
 <li><dfn>内容分类</dfn> <a href="/en-US/docs/HTML/Content_categories#Flow_content">Flow content</a>, <a href="/en-US/docs/HTML/Content_categories#Phrasing_content">phrasing content</a>, palpable content.</li>
 <li><dfn>允许的内容</dfn> <a href="/en-US/docs/HTML/Content_categories#Phrasing_content">Phrasing content</a>.</li>
 <li><dfn>标签省略</dfn> {{no_tag_omission}}</li>
 <li><dfn>允许的父元素</dfn>任何接受<a href="/en-US/docs/HTML/Content_categories#Phrasing_content">phrasing content</a> 的元素。</li>
 <li><dfn>DOM 接口</dfn> {{domxref("HTMLElement")}}</li>
</ul>

<h2 id="属性">属性</h2>

<p>这个元素只包含了 <a href="https://developer.mozilla.org/en-US/docs/HTML/Global_attributes">全局属性</a>.</p>
