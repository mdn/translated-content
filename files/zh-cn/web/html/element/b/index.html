...
---
<p><strong>HTML 提醒注意（Bring Attention To）元素（<code>&lt;b&gt;</code>）</strong>用于吸引读者的注意到该元素的内容上（如果没有另加特别强调）。这个元素过去被认为是<strong>粗体（Boldface）元素</strong>，并且大多数浏览器仍然将文字显示为粗体。尽管如此，你不应将 <code>&lt;b&gt;</code> 元素用于显示粗体文字；替代方案是使用 CSS {{cssxref("font-weight")}} 属性来创建粗体文字。</p>
...
<p>这个元素只包含<a href="/en-US/docs/HTML/Global_attributes">全局属性</a>。</p>
...
<ul>
 ...
 <li><a href="http://www.w3.org/International/questions/qa-b-and-i-tags">Using &lt;b&gt; and &lt;i&gt; elements (W3C)</a></li>
</ul>
