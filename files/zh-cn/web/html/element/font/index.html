...
<p>从 HTML 4 开始，HTML 不能在 {{HTMLElement("style")}} 元素，或各元素 <strong>style</strong> 属性以外，表现任何样式信息。今后的网页开发，样式只能使用 <a href="/zh-TW/docs/CSS">CSS</a> 来编写。</p>

<p>{{HTMLElement("font")}} 元素的行为，可以通过 <a href="/zh-TW/docs/CSS">CSS</a> 属性实现，以及更好控制。</p>
</div>

<h2 id="属性">属性</h2>

<p>如同其他 HTML 元素，这个元素支持<a href="/en-US/docs/HTML/Global_attributes">全局属性</a>。</p>
...
<dl>
 ...
 <dd>这个属性使用数字或相对值指定文字大小。数字在最小的 7 到最大的 7 之间，默认值为 3。也可以用诸如 +2 或 -3 的相对值指定，这会将其设置为，相对于 {{HTMLElement("basefont")}} 元素 {{htmlattrxref("size", "basefont")}}属性的值，或者如果不存在，则是相对于 3 也就是默认值的值。</dd>
</dl>
