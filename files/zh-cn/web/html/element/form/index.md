...
- {{htmlattrdef("rel")}}
  - : 根据 value 创建一个超链接或 Creates a hyperlink or annotation depending on the value, see the [{{htmlattrdef("rel")}}](/zh-CN/docs/Web/HTML/Attributes/rel) attribute for details.
