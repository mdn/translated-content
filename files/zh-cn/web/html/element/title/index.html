...
<p>这个元素只拥有<a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes">全局属性。</a></p>

<h2 id="使用说明">使用说明</h2>

<p>&lt;title&gt;元素始终在页面的 {{HTMLElement("head")}} 块内使用。</p>

<h3 id="页面标题和SEO">页面标题和 SEO</h3>
...
<ul>
 ...
 <li>搜索引擎通常显示页面标题的前 55 至 60 个字符。 超出此范围的文本可能会丢失，因此请尽量不要使标题更长。 如果您必须使用较长的标题，请确保重要的部分出现在前面，并且标题中可能要删除的部分中没有关键内容。</li>
