...
<p>The {{htmlelement("meta")}} 元素可用于提供 名称 - 值 对形式的文档元数据，{{htmlattrxref("name", "meta")}} 属性为元数据条目提供名称，而 {{htmlattrxref("content", "meta")}} 属性提供值。</p>
...
<ul>
 ...
 <li>
  ...
  <ul>
   ...
   <li>若想了解 Firefox 移动版对此声明的支持和处理，请参考<a href="/zh-CN/docs/Mobile/Viewport_meta_tag">这篇文章</a>。</li>
  </ul>
  </div>
