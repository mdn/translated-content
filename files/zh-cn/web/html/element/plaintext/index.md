...
> - 如果 {{HTMLElement("plaintext")}} 元素是页面的第一个元素（除了任何不显示的元素），那就不要使用 HTML 了。配置你的服务器，使用 `text/plain` [MIME-type](/zh-CN/docs/Learn/Server-side/Configuring_server_MIME_types) 来发送你的页面。
