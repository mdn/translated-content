...
<ul>
 ...
 <li>如果 {{HTMLElement("plaintext")}} 元素是页面的第一个元素（除了任何不显示的元素），那就不要使用 HTML 了。配置你的服务器，使用 <code>text/plain</code> <a href="/en-US/docs/Properly_Configuring_Server_MIME_Types">MIME-type</a> 来发送你的页面。</li>
 ...
 <li>等宽字体也可以显示在 {{HTMLElement("div")}} 元素中，通过使用足够的 <a href="https://developer.mozilla.org/en-US/docs/Web/CSS">CSS</a> 样式，在 {{cssxref("font-family")}} 中将 <code>monospace</code> 用作通用字体（generic-font）的值。</li>
</ul>
</div>

<h2 id="属性">属性</h2>

<p>除了 <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/global_attributes">全局属性</a> 之外，这个元素没有其它属性。</p>
