...
**`<tt>`** [HTML](/zh-CN/docs/Web/HTML) 元素创建内联文本，该文本使用{{Glossary("user agent", "用户代理")}}默认的等宽字体。此元素旨在以固定宽度设备（如电传打字机、纯文本屏幕或行式打印机）上显示文本的方式呈现文本。
...
<table class="properties">
  <tbody>
    ...
    <tr>
      ...
      <td>
        任何接受<a href="/zh-CN/docs/Web/HTML/Content_categories#phrasing_content"
          >短语内容</a
        >的元素。
      </td>
    </tr>
