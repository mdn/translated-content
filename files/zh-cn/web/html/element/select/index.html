...
<p>包括下列<a href="/en-US/docs/Web/HTML/Global_attributes">全局属性</a>。</p>
...
<dl>
 ...
 <dd><code>&lt;select&gt;</code> 所关联的{{HTMLElement("form")}} (它的"表单拥有者")。其值必须是在同一文档中的 <code>&lt;form&gt;</code> 元素的{{htmlattrxref("id")}}（如果没有设置这个属性， <code>&lt;select&gt;</code> 元素则与其任何存在的祖先 <code>&lt;form&gt;</code> 元素关联）。<br />
 这个属性让你将 <code>&lt;select&gt;</code> 元素与文档中任意位置的 <code>&lt;form&gt;</code> 元素相关联，而不仅仅是包含 <code>&lt;select&gt;</code> 元素的 <code>&lt;form&gt;</code> 元素。这个属性还可以覆盖元素的祖先 <code>&lt;form&gt;</code> 元素。</dd>
...
<div class="note"><p><strong>备注：</strong> 根据 HTML5 规范，默认值应该为 1；但是，在实践中，这样会影响到一些网站，同时其它浏览器也没有那么处理，所以 Mozilla 在 Firefox 中选择继续使用默认值 0。</p></div>
