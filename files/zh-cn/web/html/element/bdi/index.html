...
<p>尽管同样的显示效果可以通过使用 CSS 规则 {{cssxref("unicode-bidi")}}：隔离{{HTMLElement("span")}}或者其他文本格式化元素，但语义信息只能通过&lt;bdi&gt;元素传递。特别是，当浏览器允许忽略 CSS 样式时，在这种情况下，使用&lt;bdi&gt;仍然可以保证文本正确显示，而使用 CSS 样式来传递语义时就显得毫无用处。</p>
...
<p>如同其他 HTML 元素一样，它包含<a href="/en-US/docs/HTML/Global_attributes">全局属性</a>，但是有一些语义上的细微差别：<strong>dir</strong>属性不继承父元素。如果没有设置，默认值即为 auto，以便浏览器根据元素内容决定元素内容的方向。</p>
...
<p>This arabic word REDLOHECALP_CIBARA is automatically displayed right-to-left.</p>
