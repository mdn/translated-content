...
[HTML](/zh-CN/docs/Web/HTML) **`<footer>`** 元素表示其最近的祖先[分段内容](/zh-CN/docs/Web/HTML/Content_categories#分段内容)的页脚或[分段内容](/zh-US/docs/Web/HTML/Element/Heading_Elements#分段内容)元素。`<footer>` 通常包含有关该部分作者、版权数据或相关文档链接的信息。
...
<table class="properties">
  <tbody>
    <tr>
      ...
      <td>
        <a href="/zh-CN/docs/Web/HTML/Content_categories#流式内容">流式内容</a>、可感知内容。
      </td>
    </tr>
    <tr>
      <th scope="row">允许的内容</th>
      <td>
        <a href="/zh-CN/docs/Web/HTML/Content_categories#流式内容">流式内容</a>，但不可以有 <code>&#x3C;footer></code> 或
    ...
    <tr>
      ...
      <td>
        任何接受<a href="/zh-CN/docs/Web/HTML/Content_categories#流式内容">流式内容</a>的元素。请注意，<code>&#x3C;footer></code> 元素不得是 {{HTMLElement("address")}}、{{HTMLElement("header")}} 或其他 <code>&#x3C;footer></code> 元素的后代。
      </td>
    </tr>
    <tr>
      ...
      <td>
       ...
       如果是 <a href="/zh-CN/docs/Web/HTML/Element/article">article</a>、<a href="/zh-CN/docs/Web/HTML/Element/aside">aside</a>、        <a href="/zh-CN/docs/Web/HTML/Element/main">main</a>、<a href="/zh-CN/docs/Web/HTML/Element/nav">nav</a> 或 <a href="/zh-CN/docs/Web/HTML/Element/section">section</a> 元素的后代，则为 <a href="/zh-CN/docs/Web/Accessibility/ARIA/Roles/Contentinfo_role">contentinfo</a> 或
