...
<p><em>HTML <code>&lt;area&gt;</code> 元素 在图片上定义一个热点区域，可以关联一个超链接。&lt;area&gt;元素仅在&lt;map&gt;元素内部使用。</em></p>

<ul>
 <li><dfn><a href="/en-US/docs/HTML/Content_categories">内容分类</a></dfn> <a href="/en-US/docs/HTML/Content_categories#Flow_content">流内容</a>, <a href="/en-US/docs/HTML/Content_categories#Phrasing_content">短语内容</a>.</li>
...
<dl>
 ...
 <dd>指明链接资源的语言类型，值的范围参考<a href="http://www.ietf.org/rfc/bcp/bcp47.txt">BCP47</a>. 这个属性只能在指明 href 属性之后使用。</dd>
</dl>
