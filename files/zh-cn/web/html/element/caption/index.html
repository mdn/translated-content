...
<p>本元素包含了所有 <a href="https://developer.mozilla.org/en-US/docs/HTML/Global_attributes">全局特性</a>。</p>
...
<dl>
 ...
 <div class="note"><strong>使用说明：</strong>不要使用这个属性，它已经被弃用：{{HTMLElement("caption")}} 元素应该使用 <a href="/en-US/docs/CSS">CSS</a>设置样式。要得到类似<code>align</code>属性的效果，使用 <a href="/en-US/docs/CSS">CSS</a> 属性 {{cssxref("caption-side")}} 和 {{cssxref("text-align")}}.</div>
 </dd>
</dl>
