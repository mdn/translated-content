...
---
<p><strong><code>inputmode</code></strong> <a href="/en-US/docs/Web/HTML/Global_attributes">全局属性</a> 是一个枚举属性，它提供了用户在编辑元素或其内容时可能输入的数据类型的提示。它可以是以下值：</p>

<dl>
 <dt><code>"none"</code></dt>
 <dd>无虚拟键盘。在应用程序或者站点需要实现自己的键盘输入控件时很有用。</dd>
 <dt><code>"text"</code></dt>
 <dd>使用用户本地区域设置的标准文本输入键盘。</dd>
 ...
 <dd>为邮件地址输入优化的虚拟键盘，通常包含"@"符号和其他优化。表单里面的邮件地址输入应该使用 <code><a href="/en-US/docs/Web/HTML/Element/input/email">&lt;input type="email"&gt;</a></code> 。</dd>
 <dt><code>"url"</code></dt>
 <dd>为网址输入优化的虚拟键盘，比如，“/”键会更加明显、历史记录访问等。表单里面的网址输入通常应该使用 <code><a href="/en-US/docs/Web/HTML/Element/input/url">&lt;input type="url"&gt;</a></code> 。</dd>
</dl>
