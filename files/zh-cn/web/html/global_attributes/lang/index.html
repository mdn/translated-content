...
<p><strong>lang</strong> <a href="/en-US/docs/Web/HTML/Global_attributes">全局属性</a> 参与了元素语言的定义。这个语言是不可编辑元素写入的语言，或者可编辑元素应该写入的语言。标签包含单个条目，值的格式由 <a href="http://www.ietf.org/rfc/bcp/bcp47.txt"><em>用于定义语言的标签 (BCP47)</em></a> IETF 文档定义。如果标签的内容是空字符串，语言就设为<em>未知</em>。如果标签内容是无效的，根据 BCP47，它就设为<em>无效</em>。</p>
