...
<p>查看 <a href="/zh-CN/docs/Web/HTML/CORS_settings_attributes">CORS settings attributes</a> 来了解更多 <code>crossorigin</code> 属性的用法。</p>
...
<p>配置完毕后，你就可以将这些格式的图片保存到本地 <a href="/zh-CN/docs/Web/Guide/API/DOM/Storage">DOM 存储</a> 中了，就像这些图片在你自己域名之下一样。</p>
...
<ul>
 <li><a href="http://blog.chromium.org/2011/07/using-cross-domain-images-in-webgl-and.html">在 Chrome 13 的 WebGL 中使用跨域图片</a></li>
 <li><a href="http://whatwg.org/html#attr-img-crossorigin">HTML 标准 - <code>crossorigin</code> 属性</a></li>
</ul>
