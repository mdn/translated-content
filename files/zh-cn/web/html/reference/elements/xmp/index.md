...
**`<xmp>`** [HTML](/zh-CN/docs/Web/HTML) 元素能够在不解释其中的 HTML 代码的情况下，以等宽字体渲染起始标签与结束标签之间的文本。HTML 2 规范建议其渲染宽度应足以容纳每行 80 个字符。

> [!NOTE]
> 请不要使用这个元素。
>
> - 自 HTML 3.2 以来，此元素已被弃用，并且其实现方式并不一致。当前 HTML 中已彻底移除了该元素。
