...
| {{HTMLElement("head")}}  | 包含文档相关的配置信息（元数据），包括文档的[标题](/zh-CN/docs/Web/HTML/Reference/Elements/title)、[脚本](/zh-CN/docs/Web/HTML/Reference/Elements/script)和[样式表](/zh-CN/docs/Web/HTML/Reference/Elements/style)等。                 |
...
| {{HTMLElement("footer")}}                                                                                                                                                                                                                                                                                                                                                                                              | 表示最近的一个父[分段内容](/zh-CN/docs/Web/HTML/Guides/Content_categories#分段内容)或[分段的根](/zh-CN/docs/Web/HTML/Reference/Elements/Heading_Elements)元素的页脚。`<footer>` 通常包含该章节作者、版权数据或者与文档相关的链接等信息。 |
