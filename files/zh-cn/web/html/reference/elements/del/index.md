...
<table class="properties">
 <tbody>
  <tr>
   ...
   <td><a href="/zh-CN/docs/Web/HTML/Guides/Content_categories#短语元素（Phrasing_content）">短语元素</a> 或者 <a href="/zh-CN/docs/Web/HTML/Guides/Content_categories#流式元素（Flow_content）">流式元素</a> 。</td>
  </tr>
  <tr>
   <th scope="row">允许的内容</th>
   <td><a href="/zh-CN/docs/Web/HTML/Guides/Content_categories#透明内容模型（Transparent_content_model）">透明内容模型</a></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>任意<a href="/zh-CN/docs/Web/HTML/Guides/Content_categories#短语元素（Phrasing_content）">短语元素</a> </td>
  </tr>
  <tr>
