...
<p>为了阐述一些 典型的 web storage 的用法，我们创了一个简单的例子，想象上地称为 <a href="https://github.com/mdn/dom-examples/tree/master/web-storage">Web Storage Demo</a>. <a href="https://mdn.github.io/dom-examples/web-storage/">landing page</a> 提供控制器可以用来自定义颜色，字体和装饰图片。 当你选择不同的选项，页面会被立即更新;此外，你的选择被储存到 localStorage 中， 以便当你离开该页面，然后过些时候在重新加载它时，你的选择会被记住。</p>
