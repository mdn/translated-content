...
> **备注：** 若用户[禁用第三方 cookie](https://support.mozilla.org/zh-CN/kb/disable-third-party-cookies)，那么将不允许来自第三方 IFrames 对 Web Storage 的访问。（从[Firefox 43](https://developer.mozilla.org/zh-CN/Firefox/Releases/43)版本开始实行）
