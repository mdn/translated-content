...
> **备注：** 若用户[禁用第三方 cookie](https://support.mozilla.org/en-US/kb/third-party-cookies-firefox-tracking-protection)，那么将不允许来自第三方 IFrames 对 Web Storage 的访问。
...
另外，我们还提供了一个 [event output page](https://mdn.github.io/dom-examples/web-storage/event.html) —— 如果你在另一个标签页加载这个页面，然后在 landing page 改变你的选择，你将看到在触发 {{domxref("StorageEvent")}} 时输出更新的存储信息。
