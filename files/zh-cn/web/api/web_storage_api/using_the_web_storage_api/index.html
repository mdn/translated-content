...
<p><img src="landing.png">当你选择不同的选项后，页面会立即更新；除此之外，你的选择会被存到 <code>localStorage</code> 里，这样，当你关闭页面之后重新加载时，你的选择会被记住。</p>
...
<p>各浏览器支持的 localStorage 和 sessionStorage 容量上限不同。测试页面 <a href="http://dev-test.nemikor.com/web-storage/support-test/">detailed rundown of all the storage capacities for various browsers</a>。</p>
