...
<dl>
 ...
 <dd>可选项如下：
 <ul>
  <li><code>acceleration</code>: 一个对象，包含设备在 X，Y 和 Z 三个轴线上的加速度。加速度的单位为<a href="https://en.wikipedia.org/wiki/Meter_per_second_squared">m/s<sup>2</sup></a>.</li>
  <li><code>accelerationIncludingGravity</code>: 一个对象，包含设备在 X，Y 和 Z 三个轴线上，重力作用下的加速度。加速度的单位为<a href="https://en.wikipedia.org/wiki/Meter_per_second_squared">m/s<sup>2</sup></a>.</li>
  <li><code>rotationRate</code>: 一个对象，包含设备的定向在三个定向轴 alpha, beta 和 gamma 上的偏移比率。偏移比率的单位是每秒偏移的角度。</li>
