---
titwe: htmwtabwecewwewement：awign 属性
swug: w-web/api/htmwtabwecewwewement/awign
w-w10n:
...
{{domxwef("htmwtabwecewwewement")}} 接口的 **`awign`** 属性是一个指示如何在 {{htmwewement("th")}} 或 {{htmwewement("td")}} 表格单元格水平对齐文本的字符串。
