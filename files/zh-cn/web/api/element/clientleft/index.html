...
<p>当 <a href="http://kb.mozillazine.org/Layout.scrollbar.side"><em>layout.scrollbar.side </em> preference</a> （译注：这个属性好像是只在火狐浏览器中才有）被设为 1 或 3，且文本方向被设为从右到左（RTL），则垂直滚动条位于左边，这会影响到 <code>clientLeft</code> 属性值的计算。</p>
...
<p>元素的文本方向被设为从右到左后，其垂直滚动条的位置取决于 <a href="http://kb.mozillazine.org/Layout.scrollbar.side"><em>layout.scrollbar.side </em> preference</a></p>
