...
<p>这个属性是只读属性，对于没有定义 CSS 或者内联布局盒子的元素为 0，否则，它是元素内部的高度 (单位像素)，包含内边距，但不包括水平滚动条、边框和外边距。</p>
...
<p>备注：上面的有问题 因为使用 element.getBoundingClientRect() 只能获取元素的 width / height，但是这个值是 offsetWidth / offsetHeight ，包括边框的长度，所以不能获取 clientWidth / clientHeight</p>
</div>

<h2 id=".E8.AF.AD.E6.B3.95.E5.92.8C.E5.80.BC">语法</h2>
...
<h3 id=".E6.B3.A8.E6.84.8F">备注</h3>

<p>clientHeight 是在 IE 浏览器对象模型中引入的属性。</p>

<h3 id=".E5.8F.82.E8.80.83">相关链接</h3>
