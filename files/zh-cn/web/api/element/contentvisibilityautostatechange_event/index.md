...
**`contentvisibilityautostatechange`** 事件会在设置了 {{cssxref("content-visibility", "content-visibility: auto")}} 的元素开始或不再[与用户相关](/zh-CN/docs/Web/CSS/Guides/Containment#与用户相关)，且正在[跳过其内容](/zh-CN/docs/Web/CSS/Guides/Containment#跳过其内容)时触发。
