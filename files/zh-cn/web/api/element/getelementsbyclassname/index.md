...
<p>获取所有包含 class 名称为 test 的元素：</p>
<pre class="brush: js">element.getElementsByClassName('test');</pre>
<p>获取所有包含 <code>red</code> 和 <code>test</code> class 名的元素：</p>
<pre class="brush: js">element.getElementsByClassName('red test');</pre>
<p>获取 <code>id</code> 为 <code>main</code> 的元素的所有包含一个 <code>test</code> class 名的后代元素：</p>
