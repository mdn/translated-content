...
元素收到 {{domxref("Element/mousedown_event", "mousedown")}} 事件后，如果鼠标或触控板按钮施加的压力达到“强制点按”的阈值，Safari 会开始向元素发送 **`webkitmouseforcedown`** 事件。

**`webkitmouseforcedown`** 是 WebKit 特有的专有事件，属于 [Force Touch 事件](/zh-CN/docs/Web/API/Force_Touch_events)功能。
