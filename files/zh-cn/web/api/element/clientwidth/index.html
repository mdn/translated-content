...
<p>当在根元素 (&lt;html&gt;元素) 上使用 clientWidth 时 (或者在&lt;body&gt;上，如果文档是在 quirks(怪异) 模式下)，将返回 viewport 的宽度 (不包括任何滚动条). <a href="https://www.w3.org/TR/2016/WD-cssom-view-1-20160317/#dom-element-clientwidth">This is a special case of <code>clientWidth</code></a>.</p>
