...
**`DOMQuad`** 接口的 **`p1`** 属性包含一个 {{domxref("DOMPoint")}} 对象，可用于表示 `DOMQuad` 的四个角之一。当从 {{domxref("DOMQuad.fromRect_static", "DOMQuad.fromRect()")}} 创建时，它就是点 (x, y)。
...
- 其他 `DOMPoint` 属性：{{domxref("DOMQuad.p2", "p2")}}、{{domxref("DOMQuad.p3", "p3")}} 和 {{domxref("DOMQuad.p4", "p4")}}。
