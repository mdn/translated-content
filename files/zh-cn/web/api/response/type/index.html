...
<ul>
 ...
 <li><code>cors</code>: Response 接收到一个有效的跨域请求。<a href="https://fetch.spec.whatwg.org/#concept-filtered-response-cors">部分 headers 和 body</a>可以被访问。</li>
...
<div class="note">
<p><strong>Note</strong>: “错误”响应从来没有真正暴露于脚本：这种响应 {{domxref("GlobalFetch.fetch","fetch()")}} 将被 promise 拒绝。</p>
</div>
