...
<p>这些事件定义在 {{domxref("GlobalEventHandlers")}} 中，并被混入和实现在{{domxref("HTMLElement")}}, {{domxref("Document")}}, {{domxref("Window")}}上，任意 html 元素、document 对象，window 对象上均可以使用它提供的属性， 即时是全局的{{domxref("WorkerGlobalScope")}}。</p>
