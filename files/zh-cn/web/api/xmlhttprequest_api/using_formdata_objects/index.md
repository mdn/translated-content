...
如果你想知道不使用 FormData 对象的情况下，如何序列化并通过 [AJAX](/zh-CN/docs/Learn/JavaScript/Client-side_web_APIs/Fetching_data) 提交表单，[请点击这里](/zh-CN/docs/Web/API/XMLHttpRequest_API/Using_XMLHttpRequest#提交表单和上传文件)。
