...
<p><code><strong>WheelEvent.deltaY</strong></code> 只读属性是一个 <code>double</code> 类型值，声明垂直滚动量以<a href="https://developer.mozilla.org/zh-CN/docs/Web/API/WheelEvent/deltaMode"><code>WheelEvent.deltaMode</code></a> 为单位。</p>
