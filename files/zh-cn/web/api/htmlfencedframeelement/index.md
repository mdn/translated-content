...
- {{domxref("HTMLFencedFrameElement.config")}} {{experimental_inline}}
  - : 一个 {{domxref("FencedFrameConfig")}} 对象，表示 {{htmlelement("fencedframe")}} 的导航，即其中将显示什么内容。`FencedFrameConfig` 是从诸如[受保护的受众 API](https://developers.google.com/privacy-sandbox/private-advertising/protected-audience) 等来源返回的。
