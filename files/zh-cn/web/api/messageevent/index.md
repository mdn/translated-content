...
- [Server-sent events](https://developer.mozilla.org/zh-CN/docs/Web/API/Server-sent_events) (参见{{domxref("EventSource.onmessage")}}).
- [Web sockets](https://developer.mozilla.org/zh-CN/docs/Web/API/WebSockets_API) (参见 [WebSocket](https://developer.mozilla.org/zh-CN/docs/Web/API/WebSocket) 接口的 `onmessage` 属性).
- Cross-document messaging (参见 {{domxref("Window.postMessage()")}} 和 {{domxref("Window.onmessage")}}).
- [Channel messaging](https://developer.mozilla.org/zh-CN/docs/Web/API/Channel_Messaging_API) (参见 {{domxref("MessagePort.postMessage()")}} 和{{domxref("MessagePort.onmessage")}}).
...
- [Broadcast channels](https://developer.mozilla.org/zh-CN/docs/Web/API/Broadcast_Channel_API) (参见 {{domxref("Broadcastchannel.postMessage()")}}) 和 {{domxref("BroadcastChannel.onmessage")}}).
