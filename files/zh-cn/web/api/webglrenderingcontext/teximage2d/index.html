...
<dl>
 ...
 <ul>
  ...
  <li><code>gl.TEXTURE_CUBE_MAP_POSITIVE_X</code>:立方体映射纹理的正 X 面。</li>
  <li><code>gl.TEXTURE_CUBE_MAP_NEGATIVE_X</code>: 立方体映射纹理的负 X 面。</li>
  <li><code>gl.TEXTURE_CUBE_MAP_POSITIVE_Y</code>: 立方体映射纹理的正 Y 面。</li>
  <li><code>gl.TEXTURE_CUBE_MAP_NEGATIVE_Y</code>: 立方体映射纹理的负 Y 面。</li>
  <li><code>gl.TEXTURE_CUBE_MAP_POSITIVE_Z</code>: 立方体映射纹理的正 Z 面。</li>
  <li><code>gl.TEXTURE_CUBE_MAP_NEGATIVE_Z</code>: 立方体映射纹理的负 Z 面。</li>
 </ul>
 </dd>
 <dt><code>level</code></dt>
 <dd> {{domxref("GLint")}} 指定详细级别. 0 级是基本图像等级，n 级是第 n 个金字塔简化级。</dd>
 <dt><code>internalformat</code></dt>
 <dd> {{domxref("GLenum")}} 指定纹理中的颜色组件。在 WebGL1 和 WebGL2 中可能的值：
 <table>
  <thead>
   <tr>
    <td>Format</td>
 ...
 在 WebGL2 中，对带有 <code>ArrayBufferView</code> 或 <code>GLintptr offset</code>的  <code>texImage2D</code> 版本，其它可能的值
...
<table>
 ...
 在 WebGL2 中，使用<code>HTMLImageElement</code>, <code>HTMLCanvasElement</code>, <code>HTMLVideoElement</code>, <code>ImageBitmap</code>, 或 <code>ImageData</code>作为<code>texImage2D</code> 纹理的版本中，可能的值有：

 <ul>
  <li><code>gl.ALPHA</code>: 抛弃红色、绿色和蓝色组件并读取 alpha 组件。</li>
  <li><code>gl.RGB</code>:抛弃 alpha 组件，读取红色、绿色和蓝色组件。</li>
  <li><code>gl.RGBA</code>: 从颜色缓冲区读取红色、绿色、蓝色和 alpha 组件。</li>
  <li><code>gl.LUMINANCE</code>: E 每个颜色组件是一个亮度组件，alpha 值为 1.0。</li>
  <li><code>gl.LUMINANCE_ALPHA</code>: 每个组件都是亮度/alpha 组件。</li>
 ...
 <dd> {{domxref("GLenum")}} 指定 texel 数据格式。在 WebGL 1 中，它必须与 <code>internalformat</code> 相同（查看上面). 在 WebGL 2 中，<a href="https://www.khronos.org/registry/webgl/specs/latest/2.0/#TEXTURE_TYPES_FORMATS_FROM_DOM_ELEMENTS_TABLE">这张表</a>中列出了这些组合。</dd>
 <dt><code>type</code></dt>
 <dd> {{domxref("GLenum")}} 指定 texel 数据的数据类型。可能的值：
 <ul>
  <li><code>gl.UNSIGNED_BYTE</code>:  <code>gl.RGBA</code>每个通道 8 位</li>
  <li><code>gl.UNSIGNED_SHORT_5_6_5</code>: 5 bits 红，6 bits 绿，5 bits 蓝</li>
  <li><code>gl.UNSIGNED_SHORT_4_4_4_4</code>: 4 bits 红，4 bits 绿，4 bits 蓝，4 alpha bits.</li>
  <li><code>gl.UNSIGNED_SHORT_5_5_5_1</code>: 5 bits 红，5 bits 绿，5 bits 蓝，1 alpha bit.</li>
 ...
 <dt>offset</dt>
 <dd> {{domxref("GLintptr")}} 类型偏移到 {{domxref("WebGLBuffer")}}的数据存储中。 用于上传数据到当前范围 {{domxref("WebGLTexture")}} 从<code>WebGLBuffer</code> 范围到<code>PIXEL_UNPACK_BUFFER</code> 目标。(仅在 WebGL 2 中 )</dd>
</dl>
