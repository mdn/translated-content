...
<p>指针锁定和<a href="/en/DOM/element.setCapture">鼠标捕获</a>有关。鼠标捕获在一个鼠标被拖曳时可以向一个目标元素持续传递有关事件，但是当鼠标按钮被放开时就会停止。指针锁定和鼠标捕获在以下方面有所不同：</p>
...
<h2 id="method_overview">方法/属性 概述</h2>
...
<h2 id="Browser_compatibiltiy">浏览器兼容性</h2>

{{Compat("api.Element.requestPointerLock")}}

<h2 id="See_also">参见</h2>

<p><a href="http://dvcs.w3.org/hg/pointerlock/raw-file/default/index.html">W3C Pointer Lock API Specification</a></p>

<p><a href="/en/DOM/MouseEvent">MouseEvent</a></p>
