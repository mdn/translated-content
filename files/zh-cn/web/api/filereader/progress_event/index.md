...
{{domxref("FileReader")}} 接口的 **`progress`** 事件在 `FileReader` 读取数据时定期触发。
...
- 相关事件：{{domxref("FileReader.loadstart_event", "loadstart")}}、{{domxref("FileReader.loadend_event", "loadend")}}、{{domxref("FileReader.load_event", "load")}}、{{domxref("FileReader.error_event", "error")}}、{{domxref("FileReader.abort_event", "abort")}}
