...
<p>要优先使用标准化过的 <a href="/zh-CN/docs/DOM/WheelEvent">WheelEvent</a> 来代替该陈旧的事件对象。</p>
...
<p>查看 <a href="/en-US/docs/XPCOM_Interface_Reference/nsIDOMMouseScrollEvent#initMouseScrollEvent%28%29">nsIDOMMouseScrollEvent::initMouseScrollEvent()</a>。</p>

<h2 id="Browser_Compatibility">滚轮相关事件对比</h2>
...
<table>
 <tbody>
  ...
  <tr>
   <td><a href="/zh-CN/docs/DOM/DOM_event_reference/mousewheel">mousewheel</a></td>
   <td><a href="/zh-CN/docs/DOM/MouseWheelEvent">MouseWheelEvent</a></td>
   <td>非标准</td>
   <td>只有 Firefox 不支持</td>
  </tr>
  <tr>
   <td><a href="/zh-CN/docs/DOM/DOM_event_reference/DOMMouseScroll">DOMMouseScroll</a></td>
   <td><a href="/zh-CN/docs/DOM/MouseScrollEvent">MouseScrollEvent</a></td>
   <td>非标准</td>
   <td>只有 Firefox 支持</td>
  </tr>
  <tr>
   <td><a href="/zh-CN/docs/DOM/DOM_event_reference/wheel">wheel</a></td>
   <td><a href="/zh-CN/docs/DOM/WheelEvent">WheelEvent</a></td>
   <td><a href="https://www.w3.org/TR/DOM-Level-3-Events/#event-type-wheel">DOM Level 3</a></td>
