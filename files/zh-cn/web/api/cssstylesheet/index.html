...
<dl>
 <dt>{{domxref("CSSStyleSheet.cssRules", "cssRules")}} {{ReadOnlyInline}}</dt>
 <dd>
 ...
 <dt>{{domxref("CSSStyleSheet.ownerRule", "ownerRule")}} {{ReadOnlyInline}}</dt>
...
<dl>
 <dt>{{domxref("CSSStyleSheet.deleteRule", "deleteRule()")}}</dt>
 <dd>从样式表中删除特定位置的一条规则。</dd>
 <dt>{{domxref("CSSStyleSheet.insertRule", "insertRule()")}}</dt>
