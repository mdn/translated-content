...
举个例子，当视口更改大小时，[媒体查询](/zh-CN/docs/Web/CSS/Guides/Media_queries) / {{domxref("window.matchMedia")}} 非常适合在特定点更新布局，但是如果要响应于特定元素的大小更改而更改布局，该元素又不是外部容器时，该怎么办？
...
- [ResizeObserver：类似于元素的 document.onresize](https://web.developers.google.cn/articles/resize-observer)
