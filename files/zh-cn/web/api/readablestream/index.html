...
<dl>
 ...
 <dd>locked 返回这个可读流是否被一个<a href="https://streams.spec.whatwg.org/#locked-to-a-reader">读取器锁定</a>。</dd>
</dl>
...
<dl>
 ...
 <dd><code>tee</code> 方法（tee 本意是将高尔夫球放置在球座上）<a href="https://streams.spec.whatwg.org/#tee-a-readable-stream">tees</a> 了可读流，返回包含两个{{domxref("ReadableStream")}} 实例分支的数组，每个元素接收了相同的传输数据。</dd>
