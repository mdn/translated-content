...
<dl>
 ...
 <dd>阴影水平偏移距离的 float 类型的值。默认值是 0。  {{jsxref("Infinity")}} 或者{{jsxref("NaN")}}都会被忽略。</dd>
</dl>

<h2 id="示例">示例</h2>

<h3 id="Using_the_shadowOffsetX_property">使用 <code>shadowOffsetX</code> 属性</h3>

<p>这是一段简单的代码片段，使用 <code>shadowOffsetX</code> 属性设置阴影的水平偏移量。注意：将 shadowColor 属性设置成不透明，阴影才会被绘制。</p>
