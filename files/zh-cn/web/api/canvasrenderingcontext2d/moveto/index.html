...
<p><strong><code>CanvasRenderingContext2D.moveTo()</code></strong> 是 Canvas 2D API 将一个新的子路径的起始点移动到 (x，y) 坐标的方法。</p>
...
<h3 id="使用_moveTo_方法">使用 <code>moveTo</code> 方法</h3>

<p>这是一段使用 <code>moveTo</code> 方法的简单的代码片段，移动画笔到起始点绘制一条线。</p>
