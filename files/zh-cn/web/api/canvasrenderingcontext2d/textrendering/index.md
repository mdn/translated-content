...
这些值对应于 SVG 的 [`text-rendering`](/zh-CN/docs/Web/SVG/Reference/Attribute/text-rendering) 属性（和 CSS 的 [`text-rendering`](/zh-CN/docs/Web/CSS/Reference/Properties/text-rendering) 属性）。
