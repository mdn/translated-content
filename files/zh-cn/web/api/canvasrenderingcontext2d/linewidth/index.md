...
一个数字，指定线条的宽度，单位为坐标空间单位。值为零、负数、{{jsxref("Infinity")}} 和 {{jsxref("NaN")}} 将被忽略。默认值为 `1.0`。
...
有关此属性的更多示例和说明，请参阅 [Canvas 教程](/zh-CN/docs/Web/API/Canvas_API/Tutorial)中的[应用样式和颜色](/zh-CN/docs/Web/API/Canvas_API/Tutorial/Applying_styles_and_colors)。
