...
<div class="note">
<p><strong>注意</strong>: 对于大多数现代浏览器，以下信息应该相当准确，但在已知的情况下会调出特定于浏览器的信息。Opera 和 Chrome 在所有情况下都应该表现相同。<a href="http://www.opera.com/mobile/mini">Opera Mini</a>（仍然是基于 presto 的，服务器端呈现）不会在客户端上存储任何数据。</p>
</div>
...
<ul>
 ...
 <li><a href="http://asmjs.org/">asm.js</a>缓存</li>
...
<ul>
 <li><a href="http://www.html5rocks.com/en/tutorials/offline/quota-research/">在移动浏览器上使用配额</a>（<a href="http://blog.agektmr.com"> Eiji Kitamura</a>著）：详细分析了移动浏览器上的客户端存储。</li>
 <li><a href="https://developers.google.com/web/updates/2011/11/Quota-Management-API-Fast-Facts">配额管理 API：快速实践</a> （<a href="http://blog.agektmr.com">Eiji Kitamura</a>著）：查看 Chrome / Blink 中的配额管理 API（也应包括 Opera）。</li>
</ul>
