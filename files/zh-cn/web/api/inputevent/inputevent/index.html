...
<dl>
 ...
 <dd>一个 <code>InputEventInit</code> 字典，有以下字段：
	...
	<li><code>ranges</code>（可选），一个静态 {{domxref("Range")}} 数组，如果输入事件没有被取消，它将受到对 DOM 的更改的影响。</li>
	</ul>
 </dd>
</dl>

<p><code>InputEventInit</code> 字典也接受来自 {{domxref("UIEvent.UIEvent", "UIEventInit")}} 以及 {{domxref("Event.Event", "EventInit")}} 字典的值。</p>
