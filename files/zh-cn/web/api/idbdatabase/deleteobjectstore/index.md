...
与 {{ domxref("IDBDatabase.createObjectStore") }} 一样，此方法*只能*在[`versionchange`](https://developer.mozilla.org/zh-CN/docs/IndexedDB/IDBTransaction#VERSION_CHANGE)事务中调用。
