...
<table class="no-markdown">
 <thead>
  ...
  <tr>
   ...
   <td><kbd>AltGr</kbd>或<kbd>AltGraph</kbd>（Alternate Graphics）键。 启用 ISO Level 3 移位修改器（其中<kbd>Shift</kbd>是 2 级修改器）。</td>
   <td></td>
   <td></td>
...
<ul>
 <li><a href="http://atsc.org/standard/a100-dtv-application-software-environment-level-1-dase-1/">DTV Application Software Environment</a> (part of the <a href="https://zh.wikipedia.org/wiki/ATSC">ATSC</a> specification)</li>
...
<table class="no-markdown">
 <thead>
  ...
  <tr>
   ...
   <td>Toggles display of <a href="https://zh.wikipedia.org/wiki/teletext">teletext</a>, if available.</td>
