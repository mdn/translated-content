...
<p>{{domxref("navigator.getBattery")}} 方法返回一个 promise 对象，该 promise 将提供一个 BatteryManager 接口，你可以从<a href="/en-US/docs/Web/API/Battery_Status_API">Battery Status API</a> 查询到相关信息。</p>
...
<dl>
 ...
 <dd>一个数字，代表距离充电完毕还需多少秒，如果为 0 则充电完毕。</dd>
...
<ul>
 <li>The <a href="/zh-CN/docs/Web/API/Battery_Status_API">电池状态 API</a></li>
