...
<p><code><strong>ImageData()</strong></code> 构造函数返回一个新的实例化的 <code style="font-style: normal; line-height: 1.5;">ImageData</code> 对象，  此对象由给定的类型化数组和指定的宽度与高度组成。</p>
...
<dl>
 ...
 <dd>无符号长整型（unsigned long）数值，描述图像的高度。<br>
 如果已给定数组，这个值是可选的：它将通过它的大小和给定的宽度进行推断。</dd>
</dl>
