...
<p><code><strong>DOMPoint</strong></code> 的 <code><strong>z</strong></code> 属性表示该点的深度坐标。 <code>z</code> 值为 0 表示屏幕平面，正值表示从屏幕前面向靠近用户的方向延伸，负值表示从屏幕后面向远离用户的方向延伸，除非改变了默认的轴方向。</p>
