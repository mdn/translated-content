...
<p>这篇文章探讨了一些关于虚拟现实（VR）的概念及其背后的理论基础。如果你是一个进入这个领域的新手，在你深入学习相关代码知识前，非常有必要对于以下的话题做一定的了解。<strong>【K】</strong></p>

<h2 id="sect1"> </h2>

<h2 id="The_history_of_VR_关于VR的历史【K】">The history of VR 关于 VR 的历史<strong>【K】</strong></h2>
...
<p><strong>1939 年<a href="https://en.wikipedia.org/wiki/View-Master">View-Master device</a>问世，它允许人们通过它观看 3D 成像的照片。这款设备播放的是，存储在圆盘硬纸板上的，成对的立体 3D 的彩色小照片。经过了许多年的研发，军方开始对使用这项技术产生了浓厚的兴趣，终于在 1961 年，名为 HEADSIGHT 的项目诞生了：它包含了一个连接头部追踪系统的显示屏的头盔。</strong></p>
...
<p><strong>世界上第一次 VR 游戏的尝试是既大又昂贵的：1991 年 Virtuality Group 制造了一款名为 VR-ready 的商业街机，其中装有护目镜，并且美其名曰 Pac-Man to virtual reality。随后，世嘉株式会社 (SEGA) 在 1993 的 Consumer Electronics Show 上引进了他们的 VR 眼睛设备。当时的公司都在努力尝试，但是市场和消费者并不关注和买账：之后，我们再见到真正成功的 VR 项目，就要等到最近的 2012 年了。【K】</strong></p>

<h3 id="VR_in_recent_times_最近的VR发展【K】">VR in recent times 最近的 VR 发展<strong>【K】</strong></h3>

<p>So what's new? Virtual Reality hardware needs to deliver high-precision, low-latency data to deliver an acceptable user experience; computers running VR applications need to be powerful enough to handle all this information. It has not been until recently that such accuracy and power has been available at an afforable cost, if at all. Early VR prototypes cost tens of thousands of dollars, whereas the latest <a href="https://www.oculus.com/rift/">Oculus Rift</a> developer kit is available for $350, and cheaper solutions are available, such as mobile device-based solutions like <a href="https://www.google.com/get/cardboard/">Google Cardboard</a>.</p>

<p><strong>那么有什么值得我们期待的呢？VR 硬件需要传输高精度的信息，在保证低延迟的情况下传递可接受的用户的体感信息；运行 VR 设备和程序的电脑，必需强大到足以维持这些庞大的信息。直到最近的这几年，如此高精度并且能量强大的设备，才能通过大众可以接受的价格被购买到。早期的 VR 原型设备，需要花费数万美元，然而最近出现的<a href="https://www.oculus.com/rift/">Oculus Rift</a> developer kit 却仅售 350$， 并且还有更加便宜的解决方案，比如基于手机的 VR 设备像是<a href="https://www.google.com/get/cardboard/">Google Cardboard</a>.【K】</strong></p>
...
<p><strong>到了 2015 年，类似的 VR 设备吸引了大量的商业投资，进入到 VR 科技的研发中。SONY 正在 PS4 中开发一项针对 VR 的硬件工具 (编程代号 <a href="http://www.cnet.com/products/sony-project-morpheus/">Project Morpheus</a>), FACRBOOK 花费 20 亿美元买下了 <a href="https://www.oculus.com/rift/">Oculus Rift</a>, Valve 开发了 <a href="http://store.steampowered.com/universe/vr">SteamVR</a> 软件系统，能够应用于 HTC 的<a href="http://www.htcvr.com/">Vive VR headset</a>, 随后，谷歌发布了能够最多支持 6 英寸手机屏幕的 CARDBOARD 的 2.0 版本 (它同时完全兼容了 IOS 的设备，因为在它屏幕的背后有一块传感海绵凸起作为触碰点。)</strong></p>

<p> </p>

<p>Samsung also launched a headset associated with Oculus called <a href="http://www.samsung.com/global/microsite/gearvr/gearvr_features.html">GearVR</a>, which works by connecting its Note 4 and 6S devices. This however only works with native apps, so it is not very interesting for the specific area of WebVR.</p>

<p><strong>三星公司同 Oculus 合作，也推出了它的头戴设备<a href="http://www.samsung.com/global/microsite/gearvr/gearvr_features.html">GearVR</a>, 这款设备可以连接旗下的 NOTE4 以及 6S 等手机。然而这款设备仅仅能够运行几款纯粹的 APP 应用，因而相对于 WEBVR 的特效领域而言，显得不是那么的有意思。【K】</strong></p>
...
<p><strong>科技已经发展到了今天，随着时间的推移，只会有更多的昂贵的头显设备变得越来越便宜，从而另更多的人在将来能够亲自体验虚拟现实的乐趣。【K】</strong></p>

<p> </p>

<p> </p>

<h3 id="Input_devices_传入设备【K】">Input devices 传入设备<strong>【K】</strong></h3>
...
<h2 id="VR_Hardware_setup_创建VR设备的硬件环境【K】">VR Hardware setup 创建 VR 设备的硬件环境<strong>【K】</strong></h2>
...
<ul>
 ...
 <li><strong>手机：通过使用一部智能手机可以营造一部头显设备（HMD）-- 扮演 VR 显示器的角色 -- 安装在一个像谷歌 CARDBOARD 那样的 VR 框架中，其中包含了必需要有的透镜，用以提供投射在手机屏幕上的立体视觉效果。【K】</strong><img alt="Mobile based VR setup" src="mobilebasedvrsetup.png"></li>
 ...
 <li><strong>电脑：将一部 VR 设备连接到你的电脑上 -- 它是由一部包含了能分别为左眼和右眼显示图像的高分辨率全景镜头所组成的头显设备所组成，同时它还包含了两块分别为双眼配备的，可以提升左右眼图像分离（立体视觉）的透镜。这套设备还包含了一套分离式的感应设备，它能够测算出你的头部的位置/方向/速度/加速度等信息，并实时的把这些信息传输给计算机。【K】</strong><img alt="Computer based VR Setup" src="computerbasedvrsetup.png"></li>
</ul>
...
<ul>
 ...
 <li><strong>手持传感识别器：一个可以追踪你的手部位置和运动的传感器，这使得它变成了一个非常有趣的控制器，以及一件存在于 VR 游戏世界种的物体。迄今为止，最先进的这类设备首属<a href="https://www.leapmotion.com/">Leap Motion</a>,它可以同电脑配合使用 (同 Oculus Rift 设备连接) 并且同时还可以和手机兼容 (暂时处于实验阶段。)</strong></li>
 ...
 <li><strong>（手机）游戏手柄：我们可以配置一套 XBOX 控制器或者类似的设备作为浏览器的键盘 -- 这种方法提供了另一种同 VR 网页互动的形式。有一些游戏手柄更可以和手机协同使用 -- 就像</strong><a href="http://www.mergevr.com/">MergeVR headset</a>--<strong>但是这些方法都是通过蓝牙连接设备的方法，并不能完全等同于和 WEBVR 结合。</strong></li>
 ...
 <li>A more complex positional sensor system: The SteamVR controller, combined with the <a href="http://www.roadtovr.com/steamvr-beta-update-brings-lighthouse-support-and-vr-tracking-app/">Lighthouse</a> tracking system aims to achieve an experience in which you can move through a space of 10x10 square feet in a VR world.</li>
 <li><strong>更加复杂的位置传感系统：SteamVR 控制器，结合了<a href="http://www.roadtovr.com/steamvr-beta-update-brings-lighthouse-support-and-vr-tracking-app/">Lighthouse</a>追踪系统，旨在实现帮助我们能在一个 10x10 square feet 的 VR 空间范围内自由活动的目的。</strong></li>
</ul>

<h2 id="Position_and_orientation_velocity_and_acceleration">Position and orientation, velocity and acceleration </h2>

<h2 id="位置和方向，速度和加速度【K】">位置和方向，速度和加速度<strong>【K】</strong></h2>
...
<ol>
 <li>Position — The position of the HMD along three axes in a 3D coordinate space. x is to the left and right, y is up and down, and z is towards and away from the position sensor. In WebVR:<br>
  <br>
  <strong>位置--HMD 设备的位置基于一个 3D 坐标空间中的三个轴--X 代表左右移动，Y 代表上下移动，Z 代表朝向和远离位置传感设备。在 WEBVR 中： </strong>

  <ul>
   <li>x position is represented by {{domxref("VRPositionState.position")}}.x.</li>
   <li>y position is represented by {{domxref("VRPositionState.position")}}.y.</li>
   <li>z position is represented by {{domxref("VRPositionState.position")}}.z.</li>
  </ul>
 </li>
 <li>Orientation — The rotation of the HMD around three axes in a 3D coordinate space. Pitch is rotation around the x axis, yaw is rotation around the y axis, and roll is rotation around the z axis. In WebVR:<br>
  <br>
  <strong>方位--HMD 设备的协同是绕着一个 3D 坐标空间中的三个轴。PITCH 负责协同 X 轴，YAW 负责协同 Y 轴，还有 ROLL 入则系统 Z 轴。在 WEBVR 中： </strong>
  <ul>
   <li>Pitch is represented by {{domxref("VRPositionState.orientation")}}.x.</li>
   <li>Yaw is represented by {{domxref("VRPositionState.orientation")}}.y.</li>
   <li>Roll is represented by {{domxref("VRPositionState.orientation")}}.z.</li>
  </ul>
 </li>
 <li>Velocity — There are two types of velocity to consider in VR:<br>
  <br>
  <strong>速度 -- 在 VR 中有两种需要被考虑的速度： </strong>
  <ul>
   <li>Linear — The speed along any one of the axes that the HMD is traveling. This information can be accessed using {{domxref("VRPositionState.linearVelocity")}} (x, y, and z.）</li>
   <li><strong>线速度--HMD 追踪的沿着三种轴向之一的速度。这类的信息可以被接收通过 {{domxref("VRPositionState.linearVelocity")}} (x, y, and z.)</strong></li>
   <li>Angular — The speed at which the HMD is rotating around any one of the axes. This information can be accessed using {{domxref("VRPositionState.angularVelocity")}} (x, y, and z.)</li>
   <li><strong>角速度 -- 就是 HMD 设备绕着三种轴向之一旋转的速度。这类的信息可以被接收通过{{domxref("VRPositionState.angularVelocity")}} (x, y, and z.)</strong></li>
  </ul>
 </li>
 <li>Acceleration — There are two types of acceleration to consider in VR:<br>
  <strong>加速度 -- 在 VR 中有两种需要被考虑的加速度：</strong>
  <ul>
   <li>Linear — The acceleration of travel along any one of the axes that the HMD is traveling. This information can be accessed using {{domxref("VRPositionState.linearAcceleration")}} (x, y, and z.)</li>
   <li><strong>线性加速度--HMD 设备沿着轴向追踪的加速度。这类的信息可以被接收通过{{domxref("VRPositionState.linearAcceleration")}} (x, y, and z.)</strong></li>
   <li>Angular — The acceleration of rotation of the HMD around any one of the axes. This information can be accessed using {{domxref("VRPositionState.angularAcceleration")}} (x, y, and z.)</li>
   <li><strong>角度加速度--HMD 设备绕着轴旋转的加速度。这类的信息可以被接收通过 {{domxref("VRPositionState.angularAcceleration")}} (x, y, and z.)</strong></li>
  </ul>
 </li>
</ol>

<h2 id="Field_of_view_视野【K】">Field of view 视野<strong>【K】</strong></h2>
...
<ul>
 <li>{{domxref("VRFieldOfViewReadOnly.upDegrees")}}: The number of degrees upwards that the field of view extends in.</li>
 <li>{{domxref("VRFieldOfViewReadOnly.rightDegrees")}}: The number of degrees to the right that the field of view extends in.</li>
 <li>{{domxref("VRFieldOfViewReadOnly.downDegrees")}}: The number of degrees downwards that the field of view extends in.</li>
 <li>{{domxref("VRFieldOfViewReadOnly.leftDegrees")}}: The number of degrees to the left that the field of view extends in.</li>
...
<p>Different users will also require slightly different values for optimal viewing. It therefore makes sense to be able to calibrate these when a user starts using an app. You can detect the current value of these using the methods of the {{domxref("VREyeParameters")}} interface, and set new values using the {{domxref("HMDVRDevice.setFieldOfView()")}} method.</p>

<p><strong>不同的使用者将会为了达成尽量完美的视觉体验，而要求略有不同的特性数值。因此，我们有理由在使用者开始使用一个 APP 之前，对这些特性进行测算。你可以使用{{domxref("VREyeParameters")}} interface, and set new values using the {{domxref("HMDVRDevice.setFieldOfView()")}} method.这个方法来侦测现行的特性值。</strong></p>
...
<h2 id="Concepts_for_VR_apps_VR_APP的概念【K】">Concepts for VR apps VR APP 的概念<strong>【K】</strong></h2>
...
<p><strong>这个部分讨论的是，从前在我们开发普通的 APP 和手机或者 PC 应用时，不必考虑的，但是在我们开发 VR APP 的时候必须被意识到的概念。</strong></p>
...
<h3 id="Stereoscopic_vision【K】">Stereoscopic vision<strong>【K】</strong></h3>

<p><strong>立体视觉</strong></p>
...
<h3 id="Head_tracking_头部追踪【K】">Head tracking <strong>头部追踪【K】</strong></h3>

<p>The primary technology used to make you feel present in a 360º scene, thanks to the gyroscope, accelerometer, and magnetometer (compass) included in the HMD.</p>

<p><strong>首要的使我们能够感到置身于 360°场景中的科技，要感谢包括在 HMD 设备中的陀螺仪、加速剂、磁力计等装置。</strong><br>
...
<p><strong>这种技术对于 VR 有非常重要的关联性，因为它让我们的眼睛相信我们置身于一个球形的屏幕前，它提供给使用者一种在 APP 画布中沉浸式的体验。</strong></p>

<h3 id="Eye_strain【K】眼部拉伤">Eye strain<strong>【K】眼部拉伤</strong></h3>
...
<h3 id="Motion_sickness_晕动病【K】">Motion sickness 晕动病<strong>【K】</strong></h3>
...
<h3 id="Latency_延迟【K】">Latency 延迟<strong>【K】</strong></h3>
...
<p><strong>Oculus Rift headset 的延迟在 20ms 甚至比这更低，但是目前这都非常依赖于智能手机的 CPU 性能和其他性能。</strong></p>

<h3 id="Framerate_(_Frames_per_second_FPS_)_帧率【K】">Framerate ( Frames per second / FPS ) 帧率<strong>【K】</strong></h3>
...
<p><strong>最困难的任务之一就是保持一个稳定的和高帧率的值，所以我们必须优化代码从而使它发挥最大的功效。假如能够有一个合适的帧率并且不会规律的或者突然的改变，那将会是非常好的体验；因此你需要在一个场景中设置尽量少的物体（例如在 WEBGL 中）并且减小 DRAW CALLS 的值。</strong></p>

<h3 id="Interpupillary_distance_(_IPD_)_瞳孔间距【K】">Interpupillary distance ( IPD ) 瞳孔间距<strong>【K】</strong></h3>
...
<p>Interpupillary distace ( IPD ) is represented by {{domxref("VREyeParameters.eyeTranslation")}} in WebVR.</p>

<p><strong>瞳孔间距（IPD）可用 {{domxref("VREyeParameters.eyeTranslation")}} 来表示。</strong></p>
...
<p><strong>这个值是通过 HMD 来返回的并且它的值一般在 60-70mm 之间；在像是 Oculus Rift 这样的 HMD 设备中，你可以设置你自己的 IPD。一般我们不会去改变这个值，但是你可以通过有意的改变它从而改变你所身处的整个场景。例如，如果你将 IPD 调整到 6000mm，使用者将会看到一个好像巨人身处小人国中一样的世界。</strong></p>

<h3 id="Degrees_of_Freedom_(_DoF_)_自由度【K】">Degrees of Freedom ( DoF ) 自由度<strong>【K】</strong></h3>
...
<p><strong>DOF 直接和使用者的头部运动追踪相关联。</strong></p>

<h3 id="Cone_of_focus_锥形焦点【K】">Cone of focus 锥形焦点<strong>【K】</strong></h3>
...
<p>这样的限制对于在考虑如何在 APP 画布上设置视角的时候，是非常重要的 -- 假如太过于远离锥形焦点的边缘，就可能更快更容易的导致眼部的拉伤。想要阅读 MozVR.com 上的关于这个问题的有意思的文章（还包含其他内容）-- 请点击<a href="http://mozvr.com/posts/quick-vr-prototypes/">Quick VR Mockups with Illustrator</a>.</p>

<h3 id="3D_Positional_Audio_3D定位音效【K】【如ECHO回声APP】">3D Positional Audio 3D 定位音效<strong>【K】【如 ECHO 回声 APP】</strong></h3>
...
<p><strong>这项技术直接关系到<a href="/en-US/docs/Web/API/Web_Audio_API">Web Audio API</a>，它可以让我们将一段声音附加到，一个我们在 VANVAS 中或者 launch audio 中的物体上，并且基于一个用户在其中可以移动或者观看的场景的一部分。</strong></p>
