...
Many WebVR hardware setups feature controllers that go along with the headset. These can be used in WebVR apps via the [Gamepad API](https://developer.mozilla.org/zh-CN/docs/Web/API/Gamepad_API), and specifically the [Gamepad Extensions API](https://developer.mozilla.org/zh-CN/docs/Web/API/Gamepad_API#Experimental_Gamepad_extensions) that adds API features for accessing [controller pose](https://developer.mozilla.org/zh-CN/docs/Web/API/GamepadPose), [haptic actuators](https://developer.mozilla.org/zh-CN/docs/Web/API/GamepadHapticActuator), and more. This article explains the basics.
