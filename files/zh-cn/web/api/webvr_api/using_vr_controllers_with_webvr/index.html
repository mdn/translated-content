...
<p>许多 WebVR 硬件的功能设置控制器与头戴设备在一起，实际这些功能可以通过手柄控制器在 WebVR 软件中实现，尤其对于添加了姿态控制器，触觉驱动器，等拓展性 API 的手柄控制器。本篇文章介绍了一些基本的内容。</p>
