...
<p><strong><code>get()</code></strong> 方法以 {{domxref("ByteString")}} 形式从 Headers 对象中返回指定 header 的全部值。如果 Header 对象中不存在请求的 header，则返回 <code>null</code>。</p>

<div class="note">
<p><strong>备注：</strong>出于安全原因，部分头信息只能被用户代理控制。这些头信息包括 {{Glossary("Forbidden_header_name", "forbidden header names", 1)}} 和 {{Glossary("Forbidden_response_header_name", "forbidden response header names", 1)}}。</p>
</div>
...
<dl>
 <dt><em>name</em></dt>
 <dd>从 Headers 对象中检索的 HTTP header 名，如果 HTTP header 中不存在指定 header 名则会抛出一个{{jsxref("TypeError")}}.</dd>
</dl>
