...
<dl>
 ...
 <dd>The time 声音开始播放的时间，单位是秒，与 {{domxref("AudioContext")}}使用相同的时间坐标系统。如果 <code>when</code> 小于 ({{domxref("AudioContext.currentTime")}}, 或者是 0，声音立即被播放。 <strong>默认值是 0。</strong></dd>
...
<div class="note">
<p>For a more complete example showing <code>start()</code> in use, check out our {{domxref("AudioContext.decodeAudioData()")}} example, You can also <a href="http://mdn.github.io/decode-audio-data/">run the code example live</a>, or <a href="https://github.com/mdn/decode-audio-data">view the source</a>.</p>
</div>
