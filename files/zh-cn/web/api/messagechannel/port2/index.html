...
<p>有关完整的运行示例，请参阅我们在 GitHub 的 <a href="https://github.com/mdn/channel-messaging-basic-demo">channel messaging basic demo</a>  (<a href="http://mdn.github.io/channel-messaging-basic-demo/">run it live too</a>).</p>
