...
有关更完整的示例，详见 [基本的 channel messaging 示例](https://github.com/mdn/dom-examples/tree/main/channel-messaging-basic) （[在线运行基本的 channel messaging](https://mdn.github.io/dom-examples/channel-messaging-basic/)）。
