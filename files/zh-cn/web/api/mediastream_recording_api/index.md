...
<p>例子中，我们使用 Canvas 作为{{domxref("MediaStream")}}的源，在 9 秒后停止录音。</p>
...
<p>如果你需要检查一个特殊的 MIME 类型是否被支持，使用{{domxref("MediaRecorder.isTypeSupported()")}}.</p>
