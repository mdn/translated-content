...
<dl>
 <dt>numOfChannels</dt>
 <dd>An integer 代表该缓冲区拥有的声道的数目。该实现需要支持至少 32 个声道。</dd>
 <dt>length</dt>
...
<pre class="brush: js line-numbers  language-js"><code class="language-js">// 定义一个在线或者离线的音频上下文
...
<div class="note">
<p><strong>备注：</strong> 想要获取完整的例子，请看我们在 Github 仓库的 <a href="http://mdn.github.io/offline-audio-context-promise/">offline-audio-context-promise</a> （也可以看 <a href="https://github.com/mdn/offline-audio-context-promise">源代码</a> ）</p>
</div>
