...
<p><a href="/en-US/docs/Web/API/Web_Audio_API">Web Audio API</a> 的 <strong><code>WaveShaperNode()</code></strong> 构造方法创建一个新的 {{domxref("WaveShaperNode")}}对象，是一个可以用来表示非线性畸变的{{domxref("AudioNode")}} 。</p>
