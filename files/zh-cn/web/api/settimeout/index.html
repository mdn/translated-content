...
<dl>
 ...
 <dd>{{jsxref("function")}} 是你想要在到期时间 (<code>delay</code>毫秒) 之后执行的<a href="https://developer.mozilla.org/en-US/docs/JavaScript/Reference/Global_Objects/Function">函数</a>。</dd>
...
<p>也可参考 <a href="/en-US/docs/DOM/window.clearTimeout#Example"><code>clearTimeout()</code> </a>示例。</p>
...
<p>此外，也可使用 <a href="https://developer.mozilla.org/en-US/docs/JavaScript/Reference/Global_Objects/Function/bind">function's bind</a>：</p>
...
<p>当你向 <code>setTimeout()</code> (或者其他函数) 传递一个函数时，该函数中的<code>this</code>指向跟你的期望可能不同，这个问题在 <a href="/en-US/docs/JavaScript/Reference/Operators/this#Method_binding">JavaScript reference</a> 中进行了详细解释。</p>
...
<p>另一个解决<code>this</code>问题的方法是使用两个非原生的 <code>setTimeout()</code> 和 <code>setInterval()</code> 全局函数代替原生的。该非原生的函数通过使用<a href="/en-US/docs/JavaScript/Reference/Global_Objects/Function/call"><code>Function.prototype.call</code></a> 方法激活了正确的作用域。下面的代码显示了应该如何替换：</p>
...
<div class="note"><strong>注：</strong>JavaScript 1.8.5 引入了 <code><a href="/en-US/docs/JavaScript/Reference/Global_Objects/Function/bind">Function.prototype.bind()</a></code> 方法，该方法允许显式地指定函数调用时 this 所指向的值 。该方法可以帮助你解决 this 指向不确定的问题。</div>
...
<p>向<code>setTimeout()</code>传递一个字符串而不是函数会遭受到与使用<code><a href="/en-US/docs/JavaScript/Reference/Global_Objects/eval#Don.27t_use_eval.21">eval</a></code>一样的风险。</p>
...
<ul>
 <li><a href="https://developer.mozilla.org/en-US/docs/JavaScript/Timers">JavaScript timers</a></li>
 <li><a href="https://developer.mozilla.org/en-US/docs/Mozilla/JavaScript_code_modules/Timer.jsm">Timer.jsm</a></li>
 <li>{{domxref("clearTimeout")}}</li>
 <li>{{domxref("WindowTimers.setInterval")}}</li>
 <li>{{domxref("window.requestAnimationFrame")}}</li>
 <li><a href="https://developer.mozilla.org/en-US/docs/JavaScript/Timers/Daemons"><em>Daemons</em> management</a></li>
</ul>
