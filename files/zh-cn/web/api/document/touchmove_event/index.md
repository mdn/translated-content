...
<p>当触点在触控平面上移动时触发 <code>touchmove</code> 事件。</p>

<h2 id="常规信息">常规信息</h2>

<dl>
 <dt>规范</dt>
 <dd><a href="http://w3c.github.io/touch-events/#event-touchmove">Touch Events</a></dd>
 <dt>接口</dt>
 <dd>{{domxref("TouchEvent")}}</dd>
 <dt>是否冒泡</dt>
 <dd>Yes</dd>
 <dt>能否取消默认行为</dt>
 <dd>Yes</dd>
...
<p>这些事件的代码示例在这个页面 <a href="/en-US/DOM/Touch_events">Touch events</a> 中均有体现。</p>
