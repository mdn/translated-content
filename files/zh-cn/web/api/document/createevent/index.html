...
---
<div class="warning">
<p><code>createEvent</code> 使用的许多方法，如 <code>initCustomEvent</code>，都被废弃了。请使用 <a href="/zh-CN/docs/Web/API/CustomEvent">event constructors</a> 来替代。</p>
</div>
...
<p>创建一个指定类型的<a href="/zh-CN/docs/Web/API/Event">事件</a>。其返回的对象必须先初始化并可以被传递给 <a href="/zh-CN/docs/DOM/element.dispatchEvent">element.dispatchEvent</a>。</p>
...
<ul>
 <li><code>event</code> 就是被创建的 <a href="/zh-CN/docs/DOM/event">Event</a> 对象。</li>
...
<ul>
 <li><a href="/zh-CN/docs/Web/Guide/Events/Creating_and_triggering_events">Creating and triggering events</a></li>
</ul>

<h2 id="Notes">注意</h2>

<p>Event type 字符串只能传递事件模块中定义的值给 CreateEvent。其中一些事件模块是在 DOM 事件规范定义的，还有些事在其他规范定义的（如 SVG），还有一些是 Gecko-specific 事件。详情见下表。</p>
...
<table class="fullwidth-table">
 <tbody>
  ...
  <tr style="background-color: #eee;">
   <td colspan="3"><a href="http://www.w3.org/TR/DOM-Level-2-Events/events.html#Events-eventgroupings">DOM Level 2 Events</a></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><a href="/en-US/docs/DOM/event.initMouseEvent">event.initMouseEvent</a></td>
  </tr>
  <tr>
   <td>Mutation event module</td>
   <td><code>"MutationEvents"</code></td>
   <td><a href="/en-US/docs/DOM/event.initMutationEvent">event.initMutationEvent</a></td>
  </tr>
  <tr>
  ...
  <tr style="background-color: #eee;">
   <td colspan="3"><a href="http://www.w3.org/TR/DOM-Level-3-Events/">DOM Level 3 Events</a></td>
  </tr>
  <tr>
   <td>User Interface event module</td>
  ...
  <tr>
   ...
   <td><a href="/en-US/docs/DOM/event.initMutationNameEvent">event.initMutationNameEvent</a></td>
  </tr>
  <tr>
   <td>Text event module</td>
   <td><code>"TextEvent"</code> (Gecko also supports <code>"TextEvents"</code>)</td>
   <td><a href="/en-US/docs/DOM/event.initTextEvent">event.initTextEvent</a> (not implemented)</td>
  </tr>
  <tr>
   <td>Keyboard event module</td>
   <td><code>"KeyboardEvent"</code> (Gecko also supports <code>"KeyEvents"</code>)</td>
   <td><a href="/en-US/docs/DOM/event.initKeyEvent">event.initKeyEvent</a> (Gecko-specific; the DOM 3 Events working draft uses <code>initKeyboardEvent</code> instead)</td>
  </tr>
  <tr>
  ...
  <tr style="background-color: #eee;">
   <td colspan="3"><a href="http://www.w3.org/TR/SVG/script.html#DOMInterfaces">SVG 1.1 Scripting</a></td>
  </tr>
  <tr>
   <td rowspan="2">SVG</td>
  ...
  <tr>
   ...
   <td><a href="/en-US/docs/DOM/event.initMessageEvent">event.initMessageEvent</a></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><a href="/en-US/docs/DOM/event.initPopupBlockedEvent">event.initPopupBlockedEvent</a></td>
  </tr>
  <tr>
   <td><code>"XULCommandEvent"</code>, <code>"XULCommandEvents"</code></td>
   <td><a href="/en-US/docs/DOM/event.initCommandEvent">event.initCommandEvent</a></td>
  </tr>
  <tr>
...
<p>有些事件可以使用两种事件类型参数，这是因为 DOM Level 3 Events 将事件类型参数更改为单数形式，但是仍然支持老的复数形式以向后兼容。</p>
