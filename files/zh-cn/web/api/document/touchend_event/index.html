...
<dl>
 <dt>规范</dt>
 <dd><a href="http://www.w3.org/TR/touch-events/#the-touchend-event">Touch Events</a></dd>
 <dt>接口</dt>
 <dd>TouchEvent</dd>
 <dt>是否冒泡</dt>
 <dd>Yes</dd>
...
<p>这些事件的代码示例在这个页面<a href="/en-US/docs/DOM/Touch_events">Touch events</a>中均有体现。</p>
