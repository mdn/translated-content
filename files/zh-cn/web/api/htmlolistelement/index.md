...
- {{domxref("HTMLOListElement.type")}}
  ...
  - : 一个字符串反映 [`type`](/zh-CN/docs/Web/HTML/Element/ol#type) 并定义要用于显示的标记种类，它可以具有以下的值：
...
- {{domxref("HTMLOListElement.compact")}} {{deprecated_inline}}
  - : 一个布尔值指示减小列表项之间的间距，此属性仅反映 [`compact`](/zh-CN/docs/Web/HTML/Element/ol#compact) 属性，不考虑现代页面中用于该行为的 {{cssxref("line-height")}} CSS 属性。
