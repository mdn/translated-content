...
- [Basic View Transitions demo](https://mdn.github.io/dom-examples/view-transitions/)：一个基本的图像库演示，其中包含新旧图像之间的单独过渡，以及新旧标题之间的单独过渡。
- [HTTP 203 playlist](https://http203-playlist.netlify.app/)：一个更复杂的视频播放器演示应用程序，其中包含许多不同的视图过渡，其中许多在 [Smooth and simple transitions with the View Transitions API](https://developer.chrome.com/docs/web-platform/view-transitions/) 中有解释。
