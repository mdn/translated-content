...
| [`dragend`](/zh-CN/docs/Web/API/HTMLElement/dragend_event)     | {{domxref('GlobalEventHandlers.ondragend','ondragend')}}     | 当拖拽操作结束时触发 (比如松开鼠标按键或敲“Esc”键). (见[结束拖拽](/zh-CN/docs/Web/API/HTML_Drag_and_Drop_API/Drag_operations#dragend))      |
| [`dragenter`](/zh-CN/docs/Web/API/HTMLElement/dragenter_event) | {{domxref('GlobalEventHandlers.ondragenter','ondragenter')}} | 当拖拽元素或选中的文本到一个可释放目标时触发（见 [指定释放目标](/zh-CN/docs/Web/API/HTML_Drag_and_Drop_API/Drag_operations#droptargets)）。 |
...
| [`dragstart`](/zh-CN/docs/Web/API/HTMLElement/dragstart_event) | {{domxref('GlobalEventHandlers.ondragstart','ondragstart')}} | 当用户开始拖拽一个元素或选中的文本时触发（见[开始拖拽操作](/zh-CN/docs/Web/API/HTML_Drag_and_Drop_API/Drag_operations#dragstart)）。        |
| [`drop`](/zh-CN/docs/Web/API/HTMLElement/drop_event)           | {{domxref('GlobalEventHandlers.ondrop','ondrop')}}           | 当元素或选中的文本在可释放目标上被释放时触发（见[执行释放](/zh-CN/docs/Web/API/HTML_Drag_and_Drop_API/Drag_operations#drop)）。             |
...
欲了解更多关于拖拽图像的信息，见 [设置拖拽图像](/zh-CN/docs/Web/API/HTML_Drag_and_Drop_API/Drag_operations#dragfeedback)。
...
查看 [拖拽效果](/zh-CN/docs/Web/API/HTML_Drag_and_Drop_API/Drag_operations#drageffects) 更多细节。
...
欲了解更多信息，参见 [指定释放目标](/zh-CN/docs/Web/API/HTML_Drag_and_Drop_API/Drag_operations#droptargets)。
...
更多信息请参见 [执行释放](/zh-CN/docs/Web/API/HTML_Drag_and_Drop_API/Drag_operations#drop)。
...
更多关于处理拖拽结束的信息请参见 [结束拖拽](/zh-CN/docs/Web/API/HTML_Drag_and_Drop_API/Drag_operations#dragend)。
