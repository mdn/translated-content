...
---
<p>剪贴板 <a href="/zh-CN/docs/Web/API/Clipboard_API">Clipboard API</a> 为 <strong>{{domxref("Navigator")}}</strong> 接口添加了只读属性 <strong><code>clipboard</code></strong>，该属性返回一个可以读写剪切板内容的 {{domxref("Clipboard")}} 对象。 在 Web 应用中，剪切板 API 可用于实现剪切、复制、粘贴的功能。</p>
