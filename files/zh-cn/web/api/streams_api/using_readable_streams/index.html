...
<p>作为一个 js 开发者，一块一块的读取和操作一个从网上获取的数据流是非常实用的功能！但是如何使用 Streams API 操作数据流呢？可以在这里看到基本的介绍。</p>

<div class="note">
<p><strong>提示</strong>: 本文要求您已了解流文件相关知识，如果还不了解，建议您先查看 <a href="/en-US/docs/Web/API/Streams_API#Concepts_and_usage">文件流概念及简介</a>  以及 dedicated <a href="/en-US/docs/Web/API/Streams_API/Concepts">文件流 API</a> 然后再阅读此文。</p>
</div>
