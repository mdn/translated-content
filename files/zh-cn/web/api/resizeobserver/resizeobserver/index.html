...
<p><strong><code>ResizeObserver</code></strong> 构造器创新一个新的  {{domxref("ResizeObserver")}} 对象，用于接收 {{domxref('Element')}}内容区域的改变 或 {{domxref('SVGElement')}} 的边界框改变改变。</p>
...
<p>The following example shows the dimensions of a box inside it, as text, upon resizing.<br>
 下面示例展示了 box 调整大小时，其内部文本显示为尺寸大小。</p>
