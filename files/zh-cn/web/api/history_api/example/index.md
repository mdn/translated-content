...
> **备注：** 为了在该机制中很好地整合 {{HTMLElement("form")}} 元素 , 请看一下这段[提交表单和上传文件](/zh-CN/docs/Web/API/XMLHttpRequest_API/Using_XMLHttpRequest#提交表单和上传文件)。
...
For more information, please see: [Manipulating the browser history](/zh-CN/docs/DOM/Manipulating_the_browser_history).
