...
<p>如果起始节点类型是 <code>Text</code>、<code>Comment</code> 或 <code>CDATASection</code>之一，那么 <code>startOffset</code> 指的是从起始节点算起字符的偏移量。 对于其他 <code>Node</code> 类型节点，<code>startOffset</code> 是指从起始结点开始算起子节点的偏移量。</p>
...
<dl>
 ...
 <dd> 必须为不小于 0 的整数。表示从<code>startNode</code>的开始位置算起的偏移量。</dd>
</dl>
