...
<p>使用<code>ServiceWorker</code>技术时，页面的提取动作会在 ServiceWorker 作用域 (<code>ServiceWorkerGlobalScope</code>) 中触发 fetch 事件。</p>

<p>使用 {{domxref("ServiceWorkerGlobalScope.onfetch")}}或 addEventListener 监听。<br>
