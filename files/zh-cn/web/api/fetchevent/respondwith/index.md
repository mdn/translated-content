...
例如，这意味着，如果 service worker 拦截了一个 stylesheet 或者 worker script，那么提供的 {{domxref("Response.url")}} 将会用于解决任何与 {{cssxref("@import")}} 或 {{domxref("WorkerGlobalScope.importScripts()","importScripts()")}} 相关的子资源加载（{{bug(1222008)}}）。
