...
<p>Next, the current rotation vector is computed by converting the current rotation in degrees (<code>currentAngle</code>) into <a href="https://zh.wikipedia.org/wiki/radians">radians</a>, then setting the first component of the rotation vector to the <a href="https://zh.wikipedia.org/wiki/sine">sine</a> of that value and the second component to the <a href="https://zh.wikipedia.org/wiki/cosine">cosine</a>. The <code>currentRotation</code> vector is now the location of the point on the <a href="https://zh.wikipedia.org/wiki/unit_circle">unit circle</a> located at the angle <code>currentAngle</code>.</p>
