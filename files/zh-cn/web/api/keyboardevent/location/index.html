...
<table>
 <tbody>
  ...
  <tr>
   <td><code>DOM_KEY_LOCATION_MOBILE</code> {{Non-standard_inline()}}{{Deprecated_Inline}}</td>
   <td>4</td>
   <td>
    <p>The key was on a mobile device; this can be on either a physical keypad or a virtual keyboard.</p>

    <div class="note"><strong>Note: </strong>Gecko always returns <code>DOM_KEY_LOCATION_MOBILE</code> on Android (Prior to 18), Maemo, and <a href="/en-US/docs/Mozilla/Boot_to_Gecko">Boot to Gecko</a>. However, at {{gecko("38")}}, this is dropped.</div>
   </td>
  </tr>
  <tr>
