...
<p>例如，QWERTY 布局键盘上的“<kbd>q</kbd>”键返回的<code>code</code>是“<code>KeyQ</code>”，但 Dvorak 键盘上的“<kbd>'</kbd>”键和 AZERTY 键盘上的“<kbd>a</kbd>”键也返回的相同<code>code</code>值。这使得如果用户没有使用预期的键盘布局，则无法使用<code>code</code>值来确定用户按键的名称。</p>
