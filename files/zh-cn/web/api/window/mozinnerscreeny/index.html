...
<p>在屏幕坐标下获取窗口视口左上角的 Y 坐标</p>

<div class="note"><strong>备注：</strong>该坐标是以 CSS 像素报告显示的，而不是以硬件像素。 这意味着它可以受缩放级别的影响; 要计算物理屏幕像素的实际数量，需要使用<a href="/en-US/docs/XPCOM_Interface_Reference/nsIDOMWindowUtils"><code>nsIDOMWindowUtils.screenPixelsPerCSSPixel</code></a> 属性</div>
