...
<p>当 URL 的片段标识符更改时，将触发<strong>hashchange</strong>事件 (跟在＃符号后面的 URL 部分，包括＃符号)</p>
...
<p>你可以在 {{domxref("EventTarget/addEventListener", "addEventListener")}} 方法中使用 <code>hashchange</code> 事件：</p>

<pre class="brush:js">window.addEventListener('hashchange', function() {
  console.log('The hash has changed!')
}, false);</pre>

<p>或使用 <code>onhashchange</code> 事件处理程序属性：</p>
