...
有关此事件如何与页面生命周期中其他事件相关的更多信息，请参阅[页面生命周期 API](https://developer.chrome.google.cn/blog/page-lifecycle-api/) 指南。
...
- [页面生命周期 API](https://developer.chrome.google.cn/blog/page-lifecycle-api/#developer-recommendations-for-each-state) 提供了在 web 应用程序中处理页面生命周期行为的最佳实践指南。
