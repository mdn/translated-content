...
<p>任何窗口对象，如 {{domxref("window")}}、frame、frameset 或 secondary window 都支持 <code>innerHeight</code> 属性。</p>

<p>有一个<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=189112#c7">算法</a>用来获取不包括水平滚动条的视口高度。</p>
...
<h2 id="Standards_information">标准相关信息</h2>
