...
<p>getComputedStyle 可以从<strong>伪元素</strong>拉取样式信息 (比如，<code>::after</code>, <code>::before</code>, <code>::marker</code>, <code>::line-marker</code>—查看 <a href="http://dev.w3.org/csswg/css3-content/#pseudo-elements">详情</a> 这里).</p>
...
<ul>
 <li><a href="http://www.w3.org/TR/DOM-Level-2-Style/css.html#CSS-CSSview-getComputedStyle">DOM Level 2 Style: getComputedStyle</a></li>
 <li><a href="http://dev.w3.org/csswg/cssom/#resolved-values">CSS Object Model specification</a></li>
</ul>
