...
<p>参考 <a href="/en-US/docs/Using_files_from_web_applications">从 Web 应用程序使用文件</a> 了解更多信息和例子。</p>
...
<dl>
 ...
 <dd>返回当前 <code>File</code> 对象所引用文件最后修改时间的 <code><a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date">Date</a></code> 对象。</dd>
...
<dl>
 ...
 <dd>返回文件的 <a href="/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types">多用途互联网邮件扩展类型（MIME Type）</a></dd>
</dl>
...
<ul>
 <li>在 Gecko 中，你可以从 Chrome 代码中使用这个 API。详细内容参见 <a href="/en-US/docs/Extensions/Using_the_DOM_File_API_in_chrome_code">Using the DOM File API in chrome code</a>。若要从 chrome 代码，JSM 和引导范围中使用它，你必须使用 <code><a href="/en-US/docs/Components.utils.importGlobalProperties">Cu.importGlobalProperties</a>(['File']);</code> 来导入它。</li>
...
<ul>
 ...
 <li><a href="/zh-CN/docs/Extensions/Using_the_DOM_File_API_in_chrome_code">在 chrome 代码中使用 DOM File API 读取文件</a>（适用于被授权在 Gecko 中运行的代码，例如 Firefox 拓展的代码）</li>
</ul>
