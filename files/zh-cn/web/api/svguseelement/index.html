...
<h2 id="SVG使用DOM接口">SVG使用DOM接口</h2>

<p>该<strong><code>SVGUseElement</code></strong>接口对应于{{SVGElement("use")}}元素。</p>

<p>{{InheritanceDiagram(600, 140)}}</p>

<h2 id="性质">性质</h2>

<p><em>此接口还从其父接口{{domxref("SVGGraphicsElement")}} 继承属性，并从{{domxref("SVGURIReference")}}实现属性。</em></p>
