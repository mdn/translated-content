...
- {{domxref("HTMLMeterElement.high")}}
  - : 一个 `double` 表示高边界的值，反映 [`high`](/zh-CN/docs/Web/HTML/Element/meter#high) 属性。
- {{domxref("HTMLMeterElement.low")}}
  - : 一个 `double` 表示低边界的值，反映 [`low`](/zh-CN/docs/Web/HTML/Element/meter#low) 属性。
- {{domxref("HTMLMeterElement.max")}}
  - : 一个 `double` 表示最大值，反映 [`max`](/zh-CN/docs/Web/HTML/Element/meter#max) 属性。
- {{domxref("HTMLMeterElement.min")}}
  - : 一个 `double` 表示最小值，反映 [`min`](/zh-CN/docs/Web/HTML/Element/meter#min) 属性。
- {{domxref("HTMLMeterElement.optimum")}}
  - : 一个 `double` 表示最优值，反映 [`optimum`](/zh-CN/docs/Web/HTML/Element/meter#optimum) 属性。
- {{domxref("HTMLMeterElement.value")}}
  - : 一个 `double` 表示当前值，反映 [`value`](/zh-CN/docs/Web/HTML/Element/meter#value) 属性。
