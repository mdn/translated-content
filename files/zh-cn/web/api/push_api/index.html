...
<div class="note">
<p><strong>注意</strong>: 本文档涵盖了 W3C Push API 规范; 如果您正在寻找有关 Firefox OS 专有推送机制的文档，请参阅 <a href="/en-US/docs/Web/API/Simple_Push_API">Simple Push</a>.</p>
</div>
...
<div class="note">
<p><strong>Note</strong>: 从 Gecko 44 开始，当新的通知触发时，每个应用程序允许的推送消息配额不会增加，而另一个仍然可见，持续三秒钟。 这可以处理收到通知突发的情况，而不是所有通知都会产生可见通知。</p>
</div>

<div class="note">
<p><strong>Note</strong>:早于 52 的 Chrome 版本要求您在<a href="https://developers.google.com/cloud-messaging/">Google Cloud Messaging</a>上设置项目以发送推送消息，并在发送推送通知时使用关联的项目编号和 API 密钥。 它还需要一个应用程序清单，其中包含一些使用此服务的特殊参数。</p>
</div>
...
<p>Mozilla's <a href="https://serviceworke.rs/">ServiceWorker Cookbook</a> 包含很多关于 Push 有用的示例。</p>
