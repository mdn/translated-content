...
<dl>
 ...
 <div class="blockIndicator note">
 <p><strong>Note:</strong> 在 Firefox 3.5 以及更早的版本中，HTML 的元素都没有命名空间。而在最新的版本中，无论是 HTML 还是 XML 文档树 ，所有元素的命名空间统一为 <code><a href="https://www.w3.org/1999/xhtml/">http://www.w3.org/1999/xhtml/</a></code>。</p>
 </div>
 </dd>
 <dt>{{DOMxRef("Node.nodePrincipal")}} {{Non-standard_inline}}{{Deprecated_Inline}}</dt>
 ...
 <dt>{{DOMxRef("Node.rootNode")}} {{Deprecated_Inline}}{{ReadOnlyInline}}</dt>
