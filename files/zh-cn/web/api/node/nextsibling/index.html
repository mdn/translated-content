...
<p>Gecko 内核的浏览器会在源代码中标签内部有空白符的地方插入一个文本结点到文档中。因此，使用诸如 <a href="/zh-CN/docs/Web/API/Node/firstChild"><code>Node.firstChild</code></a> 和 <a href="/zh-CN/docs/Web/API/Node/previousSibling"><code>Node.previousSibling</code></a> 之类的方法可能会引用到一个空白符文本节点，而不是使用者所预期得到的节点。</p>

<p>详情请参见 <a href="/zh-CN/docs/Whitespace_in_the_DOM">DOM 中的空白符</a> 和<a href="http://www.w3.org/DOM/faq.html#emptytext">W3C DOM 3 FAQ: 为什么一些文本节点是空的</a>.</p>
