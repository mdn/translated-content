...
<table class="standard-table">
 ...
 <tbody>
  <tr>
   ...
   <td>SDP 协议请求内容包含在属性{{domxref("RTCSessionDescription.sdp", "sdp")}}中。 换言之，此会话描述描述了商定的配置，并将被发送以完成协商。.</td>
  </tr>
  <tr>
...
<dl>
 ...
 <dd>该构造函数返回一个新的 <code>RTCSessionDescription</code> 对象。参数是 <code>RTCSessionDescriptionInit</code> 字典包含包含分配这两个属性的值。</dd>
