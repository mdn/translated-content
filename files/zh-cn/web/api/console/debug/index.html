...
<p><code>{{domxref("Console")}}</code>.<strong><code>debug()</code></strong> 输出“调试”级别的消息且仅仅控制台配置为显示调试输出时才显示该消息。</p>

<p>{{AvailableInWorkers}}</p>

<h2 id="语法">语法</h2>

<pre class="syntaxbox">console.debug(<em>对象 1</em> [, <em>对象 2</em>, ..., <em>对象 N</em>]);
...
<dl>
 <dt><code>对象 1</code> ... <code>对象 N</code></dt>
 <dd>要输出的 JavaScript 对象列表。按传参的顺序把对象输出到控制台。</dd>
 <dt><code>消息</code></dt>
 <dd>一个 JavaScript 字符串，其中包含零个或多个替代字符串。</dd>
 <dt><code>字符串 1</code> ... <code>字符串 N</code></dt>
