...
<dl>
 ...
 <dd>闭合当前内联 <a href="/en-US/docs/Web/API/console#Using_groups_in_the_console">group</a>。</dd>
 ...
 <dd>启动一个以入参作为特定名称的<a href="/en-US/docs/Web/API/console#Timers">计时器</a>，在显示页面中可同时运行的计时器上限为 10,000.</dd>
 <dt>{{domxref("Console.timeEnd()")}}</dt>
 <dd>结束特定的 <a href="/en-US/docs/Web/API/console#Timers">计时器</a> 并以毫秒打印其从开始到结束所用的时间。</dd>
 ...
 <dd>添加一个标记到浏览器的 <a href="https://developer.chrome.com/devtools/docs/timeline">Timeline</a> 或 <a href="/en-US/docs/Tools/Performance/Waterfall">Waterfall</a> 工具。</dd>
...
<p><img alt="timerresult.png" src="console-timelog.png"></p>
...
<ul>
 ...
 <li><a href="/en-US/docs/Tools/Web_Console">Web Console</a> - Firefox 浏览器控制台如何处理 console API 的调用</li>
