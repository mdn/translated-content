...
- 你不能用 [`LocalFileSystem.requestFileSystem()`](/zh-CN/docs/Web/API/File_and_Directory_Entries_API#requestfilesystem) 方法来访问指定的本地文件系统。
- 没有实现 [`LocalFileSystem.resolveLocalFileSystemURL()`](/zh-CN/docs/Web/API/File_and_Directory_Entries_API#resolvelocalfilesystemurl) 方法。
