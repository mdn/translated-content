...
<p>Appends the contents of the specified JavaScript object to the {{ domxref("Blob") }} being built. If the value you specify isn't a {{ domxref("Blob") }}, <a href="/zh-CN/JavaScript_typed_arrays/ArrayBuffer"><code>ArrayBuffer</code></a>, or <a href="/zh-CN/JavaScript/Reference/Global_Objects/String"><code>String</code></a>, the value is coerced to a string before being appended to the blob.</p>
<pre>void append(
  in ArrayBuffer data
);
...
<dl>
  ...
  <dt>
    contentType {{ optional_inline() }}</dt>
  <dd>
    设置返回的{{ domxref("File") }}对象中的数据的 MIME 类型。这个值将会成为返回<code>的File</code>对象的 type 属性的值。</dd>
</dl>
<h6 id="返回值_2">返回值</h6>
...
<h2 id="相关链接">相关链接</h2>
<ul>
  <li><a href="http://dev.w3.org/2009/dap/file-system/file-writer.html#idl-def-BlobBuilder">File API Specification: BlobBuilder</a></li>
  <li>{{ domxref("Blob") }}</li>
  <li>{{ domxref("File") }}</li>
</ul>
