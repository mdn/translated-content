...
<p><code>SVGPathElement</code>接口对应于{{ SVGElement("path") }}元素。</p>
...
<table class="standard-table">
 <tbody>
  ...
  <tr>
   ...
   <td><a href="http://www.w3.org/TR/SVG11/types.html#InterfaceSVGPathElement">SVG 1.1 (2nd Edition)</a></td>
  </tr>
 </tbody>
</table>
...
<table class="standard-table">
 ...
 <tbody>
  <tr>
   ...
   <td>对应于给定{{ SVGElement("path") }}元素的{{ SVGAttr("pathLength") }}属性。</td>
  </tr>
 </tbody>
</table>
...
<table class="standard-table">
 ...
 <tbody>
  <tr>
   ...
   <td>浮点数</td>
   <td>返回用浏览器的 distance-along-a-path 算法计算得出的路径全长，匹配当前用户坐标系中的长度。</td>
  </tr>
  <tr>
