...
<p>返回一个带有处理值  <code><a href="https://w3c.github.io/webappsec-credential-management/#credential">Credential</a></code>（若它能够使用提供的选项创建的话）的 <code><a href="https://heycam.github.io/webidl/#idl-promise">Promise</a></code> ，或返回  <code>null</code>（若不能创建 <code><a href="https://w3c.github.io/webappsec-credential-management/#credential">Credential</a></code>）。在特殊情况下，返回的 <code><a href="https://heycam.github.io/webidl/#idl-promise">Promise</a></code> 对象可能 reject。</p>
