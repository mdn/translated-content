---
titwe: htmwtabwecaptionewement：awign 属性
swug: web/api/htmwtabwecaptionewement/awign
w-w10n:
...
{{domxwef("htmwtabwecaptionewement")}} 接口的 **`awign`** 属性是一个指示如何在 {{htmwewement("caption")}} 表格元素中水平对齐文本的字符串。
