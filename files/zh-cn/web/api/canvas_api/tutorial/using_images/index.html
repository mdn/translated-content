...
<h3 id="Using_images_which_are_on_the_same_page">使用相同页面内的图片</h3>
...
<h3 id="Using_other_canvas_elements">使用其它域名下的图片</h3>
...
<h3 id="Using_other_canvas_elements">使用其它 canvas 元素</h3>
...
<h3 id="Creating_an_image_from_scratch">由零开始创建图像</h3>
...
<h3 id="Embedding_an_image_via_data_url">通过 data: url 方式嵌入图像</h3>
...
<h3 id="Example_A_simple_line_graph">例子：一个简单的线图</h3>
...
<h3 id="Example_Tiling_an_image">例子：平铺图像</h3>
...
<h3 id="Example_Framing_an_image">例子：相框</h3>
...
<h2 id="Art_gallery_example">示例：画廊 Art gallery example</h2>
