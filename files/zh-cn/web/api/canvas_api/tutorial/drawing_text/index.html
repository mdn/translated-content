...
<h3 id="A_fillText_example">一个填充文本的示例</h3>
...
<h3 id="A_strokeText_example">一个文本边框的示例</h3>
...
<p>下面的图片（from the <a href="http://www.whatwg.org/">WHATWG</a>）展示了 textBaseline 属性支持的不同的基线情况：</p>
...
<p>在 Geoko（Firefox，Firefox OS 及基于 Mozilla 的应用的渲染引擎）中，曾有一些版本较早的 <a href="/zh-CN/docs/Web/API/CanvasRenderingContext2D#Prefixed_APIs">API</a> 实现了在 canvas 上对文本作画的功能，但它们现在已不再使用。</p>
