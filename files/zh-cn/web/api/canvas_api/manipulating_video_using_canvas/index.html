...
<p><a href="/samples/video/chroma-key/index.xhtml">查看该实例</a>。</p>
...
<ol>
 <li>这篇文档布置了两个 <a href="/en-US/docs/Web/HTML/Element/canvas"><code>canvas</code></a> 元素，分别带着 ID 为 <code>c1</code> 和 <code>c2</code> 的属性。Canvas <code>c1</code> 用于显示原视频的当前帧，而 <code>c2</code> 用于显示执行了色度键控效果后的视频；<code>c2</code> 预先加载将被用于替换视频中绿幕（绿色背景）的静态图像。</li>
...
<ul>
 <li><a href="/en-US/docs/Web/Guide/HTML/Using_HTML5_audio_and_video">使用音频和视频</a></li>
</ul>
