...
<p><strong>Web 视频文本跟踪格式 </strong>(<strong>WebVTT</strong>) 是一种使用{{HTMLElement("track")}}元素显示定时文本轨道（如字幕或标题）的格式。 WebVTT 文件的主要用途是将文本叠加添加到{{HTMLElement("video")}}。 WebVTT 是一种基于文本的格式，必须使用{{Glossary("UTF-8")}}进行编码。 在可以使用空格的地方，您也可以使用制表符。 还有一个小的 API 可用于表示和管理这些轨道以及在正确的时间执行文本回放所需的数据。</p>
...
<p>我们还可以在.vtt 文件中放置注释，以帮助我们记住关于文件各部分的重要信息。这些应该在单独的行上，从字符串 NOTE 开始。您将在下一节中找到更多关于这些的信息。</p>

<p>重要的是不要在提示中使用“额外的”空白行，例如在计时行和提示有效负载之间。WebVTT 是基于行;空白行将关闭提示。</p>
...
[<a href="https://w3c.github.io/webvtt/#dom-vttcue-vttcue">Constructor</a>(double <dfn>startTime</dfn>, double <dfn>endTime</dfn>, DOMString <dfn>text</dfn>)]
interface <dfn>VTTCue</dfn> : <a href="https://html.spec.whatwg.org/multipage/embedded-content.html#texttrackcue">TextTrackCue</a> {
  attribute <a href="https://w3c.github.io/webvtt/#vttregion">VTTRegion</a>? <a href="https://w3c.github.io/webvtt/#dom-vttcue-region">region</a>;
  attribute <a href="https://w3c.github.io/webvtt/#enumdef-directionsetting">DirectionSetting</a> <a href="https://w3c.github.io/webvtt/#dom-vttcue-vertical">vertical</a>;
  attribute boolean <a href="https://w3c.github.io/webvtt/#dom-vttcue-snaptolines">snapToLines</a>;
  attribute (double or <a href="https://w3c.github.io/webvtt/#enumdef-autokeyword">AutoKeyword</a>) <a href="https://w3c.github.io/webvtt/#dom-vttcue-line">line</a>;
  attribute <a href="https://w3c.github.io/webvtt/#enumdef-linealignsetting">LineAlignSetting</a> <a href="https://w3c.github.io/webvtt/#dom-vttcue-linealign">lineAlign</a>;
  attribute (double or <a href="https://w3c.github.io/webvtt/#enumdef-autokeyword">AutoKeyword</a>) <a href="https://w3c.github.io/webvtt/#dom-vttcue-position">position</a>;
  attribute <a href="https://w3c.github.io/webvtt/#enumdef-positionalignsetting">PositionAlignSetting</a> <a href="https://w3c.github.io/webvtt/#dom-vttcue-positionalign">positionAlign</a>;
  attribute double <a href="https://w3c.github.io/webvtt/#dom-vttcue-size">size</a>;
  attribute <a href="https://w3c.github.io/webvtt/#enumdef-alignsetting">AlignSetting</a> <a href="https://w3c.github.io/webvtt/#dom-vttcue-align">align</a>;
  attribute DOMString <a href="https://w3c.github.io/webvtt/#dom-vttcue-text">text</a>;
  <a href="https://dom.spec.whatwg.org/#documentfragment">DocumentFragment</a> <a href="https://w3c.github.io/webvtt/#dom-vttcue-getcueashtml">getCueAsHTML</a>();
};</pre>
...
[<a href="https://w3c.github.io/webvtt/#dom-vttregion-vttregion">Constructor</a>]
interface <dfn>VTTRegion</dfn> {
  attribute double <a href="https://w3c.github.io/webvtt/#dom-vttregion-width">width</a>;
  attribute long <a href="https://w3c.github.io/webvtt/#dom-vttregion-lines">lines</a>;
  attribute double <a href="https://w3c.github.io/webvtt/#dom-vttregion-regionanchorx">regionAnchorX</a>;
  attribute double <a href="https://w3c.github.io/webvtt/#dom-vttregion-regionanchory">regionAnchorY</a>;
  attribute double <a href="https://w3c.github.io/webvtt/#dom-vttregion-viewportanchorx">viewportAnchorX</a>;
  attribute double <a href="https://w3c.github.io/webvtt/#dom-vttregion-viewportanchory">viewportAnchorY</a>;
  attribute <a href="https://w3c.github.io/webvtt/#enumdef-scrollsetting">ScrollSetting</a> <a href="https://w3c.github.io/webvtt/#dom-vttregion-scroll">scroll</a>;
};</pre>
