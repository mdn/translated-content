...
<p>在本文中，我们将进一步扩充 <a href="https://mdn-samples.mozilla.org/s/websocket-chat">WebSocket chat</a> 作为我们的 WebSocket 文档的一部分（本文链接即将发布;它实际上还没有在线），以支持在用户之间的双向视频通话。你可以在<a href="https://webrtc-from-chat.glitch.me/">Glitch</a>上查看这个例子，你也尝试<a href="https://glitch.com/edit/#!/remix/webrtc-from-chat">修改</a>这个例子。您还可以在<a href="https://github.com/mdn/samples-server/tree/master/s/webrtc-from-chat">GitHub</a>上查看完整的项目代码。</p>
