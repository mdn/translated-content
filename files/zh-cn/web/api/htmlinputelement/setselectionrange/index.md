...
该元素必须是以下输入类型之一：[`password`](/en-US/docs/Web/HTML/Element/input/password)、[`search`](/en-US/docs/Web/HTML/Element/input/search)、[`tel`](/en-US/docs/Web/HTML/Element/input/tel)、[`text`](/en-US/docs/Web/HTML/Element/input/text) 或 [`url`](/en-US/docs/Web/HTML/Element/input/url)。否则，浏览器会抛出 `InvalidStateError` 异常。
