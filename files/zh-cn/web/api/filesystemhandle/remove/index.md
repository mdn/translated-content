...
你也可以在[源私有文件系统](/zh-CN/docs/Web/API/File_System_Access_API#origin_private_file_system)的根目录上调用 `remove()` 来清除其内容，此后一个新的空源私有文件系统会被创建。
...
我们的 [FileSystemHandle.remove() 示例](https://filesystemhandle-remove.glitch.me/)（参阅[源代码](https://glitch.com/edit/#!/filesystemhandle-remove)）是个用于创建文件的应用。你可以在 {{htmlelement("textarea")}} 中输入文本然后按下“Save file” {{htmlelement("button")}}，然后应用会打开一个文件选择器以允许你将输入的文本保存到你在你的本地文件系统中选择的文件。你还可以删除你创建的文件。
...
- [FileSystemHandle.remove() 示例](https://filesystemhandle-remove.glitch.me/)
