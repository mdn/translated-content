...
它还提供了操作处理程序，浏览器可通过这些处理程序访问平台上的媒体按键，例如键盘、耳机、遥控器上的硬件按键，以及移动设备通知区域和锁屏界面中的软件按键。因此，即使您没有查看网页，也能通过设备无缝控制网页提供的媒体内容。
...
> [!CALLOUT]
> 原始图片资源：[桌面设备上的媒体中心、移动设备上的媒体通知和穿戴式设备](https://web.dev/articles/media-session) 在 web.dev (2024)
