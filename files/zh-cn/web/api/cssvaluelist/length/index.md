...
> 为了实现你的目标，你可以使用：
>
> - 无类型的 [CSS 对象模型](/zh-CN/docs/Web/API/CSS_Object_Model)，广泛支持；或者现代的 [CSS 类型对象模型 API](/zh-CN/docs/Web/API/CSS_Typed_OM_API)，支持较少且被视为实验性功能。

## 值

一个 `unsigned long` 类型的值，表示列表中 {{domxref("CSSValue")}} 的数量。
