...
<p><a href="/zh-CN/docs/Web/API/Gamepad_API">Gamepad API</a> 的 <code>Gamepad</code> 接口，定义了一个独立的游戏手柄或其他控制器，允许访问控制器的信息，譬如按钮按下的状态、坐标输入的位置。游戏手柄或其他控制器，允许访问如按钮按下，和 ID 等信息。</p>
...
<dl>
 ...
 <dd>一个表示 WebVR 控制器姿态方位信息的 {{domxref("GamepadPose")}} 对象 (比如其在 3D 空间中的位置和方向)。 </dd>
</dl>
...
<ul>
 <li><a href="/zh-CN/docs/Web/Guide/API/Gamepad">使用 Gamepad API</a></li>
