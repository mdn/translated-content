...
<div class="note">
<p><strong>注：</strong>Chrome 不允许你在 <code>load</code> 事件处理中调用 {{domxref("Notification.requestPermission()")}}（参见 <a href="https://code.google.com/p/chromium/issues/detail?id=274284">issue 274284</a>）。</p>
</div>
