...
<dl>
 ...
 <dd>表示控制器的位置方向（例如，在 3D 空间中的位置和方向）于 <a href="/en-US/docs/Web/API/WebVR_API">WebVR</a> 控制器中。</dd>
</dl>
...
<dl>
 ...
 <dd>于 {{domxref("Navigator")}} 对象中的一个扩展。会返回一个 名为{{domxref("Gamepad")}} 的数组对象，其中每个数组元素对应一个已连接的控制器。</dd>
</dl>
