...
---
<p>loadend 事件总是在一个资源的加载进度停止之后被触发 (例如，在已经触发 “error”，“abort” 或 “load” 事件之后)。这适用于 {{domxref("XMLHttpRequest")}} 调用，以及 {{htmlelement("img")}} 或 {{htmlelement("video")}} 之类元素的内容。</p>

<h2 id="General_info">General info</h2>

<dl>
 <dt>规范</dt>
 <dd><a href="http://www.w3.org/TR/progress-events/">Progress</a></dd>
 <dt>接口</dt>
 <dd>ProgressEvent</dd>
 <dt>可冒泡</dt>
 <dd>否</dd>
 ...
 <dd>否</dd>
 <dt>触发对象</dt>
 <dd>例如{{domxref("HTMLImageElement")}}</dd>
 <dt>默认行为</dt>
 <dd>无</dd>
</dl>
