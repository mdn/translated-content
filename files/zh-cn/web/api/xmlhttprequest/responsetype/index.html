...
<dl>
    ...
    <dd>试图更改 <code>XMLHttpRequest</code> 的 <code>responseType</code>，该值处于同步模式但不在 {{DOMxRef("Worker")}} 中。有关其他详细信息，请参阅下面的 <a href="#synchronous_xhr_restrictions">同步 XHR 限制</a>。</dd>
</dl>
