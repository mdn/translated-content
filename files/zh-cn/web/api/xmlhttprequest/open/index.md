...
**XMLHttpRequest.open()** 方法初始化一个请求。该方法要从 JavaScript 代码使用；从原生代码初始化一个请求，使用 [`openRequest()`](</zh-CN/docs/Mozilla/Tech/XPCOM/Reference/Interface/nsIXMLHttpRequest#openRequest()>) 替代。
