...
<p>当处理一个异步 request 的时候，尽管当前请求并没有结束，<code>responseText</code> 的返回值是当前从后端收到的内容。</p>

<p>当请求状态 {{domxref("XMLHttpRequest.readyState", "readyState")}} 变为 {{domxref("XMLHttpRequest.DONE", "XMLHttpRequest.DONE")}} (<code>4</code>)，且 {{domxref("XMLHttpRequest.status", "status")}} 值为 200（"OK"）时，<code>responseText</code> 是全部后端的返回数据</p>
