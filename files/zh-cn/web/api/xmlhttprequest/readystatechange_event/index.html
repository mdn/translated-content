...
<p>只要 <code>readyState</code> 属性发生变化，就会调用相应的<a href="/zh-CN/docs/Web/API/EventHandler">处理函数</a>。这个回调函数会被用户线程所调用。<strong><code>XMLHttpRequest.onreadystatechange</code></strong> 会在 {{domxref("XMLHttpRequest")}} 的{{domxref("XMLHttpRequest.readyState", "readyState")}} 属性发生改变时触发 {{event("readystatechange")}} 事件的时候被调用。</p>

<div class="warning">
<p><strong>警告</strong>：这个方法不该用于同步的 requests 对象，并且不能在内部 (C++) 代码中使用。</p>
</div>
