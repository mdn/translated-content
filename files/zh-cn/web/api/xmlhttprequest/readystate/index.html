...
<p><strong>XMLHttpRequest.readyState</strong> 属性返回一个 XMLHttpRequest 代理当前所处的状态。一个 <abbr>XHR</abbr> 代理总是处于下列状态中的一个：</p>
...
<div class="note">
<p>在 IE 中，状态有着不同的名称，并不是 <code>UNSENT</code>，<code>OPENED</code> ，<code>HEADERS_RECEIVED</code> ，<code>LOADING</code> <code>和 DONE，而是 READYSTATE_UNINITIALIZED</code> (0)，<code>READYSTATE_LOADING</code> (1) ，<code>READYSTATE_LOADED</code> (2) ，<code>READYSTATE_INTERACTIVE</code> (3) <code>和 READYSTATE_COMPLETE</code> (4) 。</p>
</div>
