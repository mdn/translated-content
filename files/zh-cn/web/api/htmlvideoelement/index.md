...
- {{domxref("HTMLVideoElement.height")}}
  - : 表达 HTML 属性 [`height`](/zh-CN/docs/Web/HTML/Reference/Elements/video#height)的值的一个{{jsxref("String")}} ，以 CSS pixels 的单位给出了显示区域的大小。
- {{domxref("HTMLVideoElement.poster")}}
  - : 表达 HTML 属性 [`poster`](/zh-CN/docs/Web/HTML/Reference/Elements/video#poster)的值的一个{{jsxref("String")}} ，用于指定当视频无法播放时需要展示的图片。
...
- {{domxref("HTMLVideoElement.width")}}
  - : 表达 HTML 属性 [`width`](/zh-CN/docs/Web/HTML/Reference/Elements/video#width)的值的一个{{jsxref("String")}} ，以 CSS pixels 的单位给出了显示区域的大小。
