...
<ul>
 ...
 <li>
  <p><code>range</code> 被赋予一个 <a href="/en-US/docs/DOM/range">Range</a> 对象</p>
 </li>
</ul>
...
<ul>
 ...
 <li>HTML5 DOM Range <a href="http://html5.org/specs/dom-range.html#selection">Interface Selection</a></li>
 <li><a href="http://lxr.mozilla.org/mozilla/source/content/base/public/nsISelection.idl">IDL definition in Mozilla cross-reference</a></li>
