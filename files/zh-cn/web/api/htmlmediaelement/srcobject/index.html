...
<div class="note">
<p><strong>备注：</strong> 截至 2020 年 3 月，只有 Safari 支持设置 <code>MediaStream</code>  之外的对象。在其他浏览器跟上之前，对<code>MediaSource</code>, <code>Blob</code> 和 <code>File</code>, 请考虑返回创建具有{domxref("URL.createObjectURL()")}} 的 URL， 并将其赋值给{{domxref("HTMLMediaElement.src")}} 有关示例，请参阅下文。</p>
</div>
