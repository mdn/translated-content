...
<p>当暂停媒体播放时 <code>pause</code> 事件触发， 并且媒体进入暂停状态，最常见的是通过<code>pause()</code>方法来触发。 当<code>pause()</code> 触发时<code>pause</code>状态只改变 1 次，并且媒体的<code>pause</code>变成 <code>true</code>。</p>
...
<p>下面例子给媒体添加 <code>pause</code> 事件监听 handler，然后事件发生时会给 handler 发送一个提醒信息</p>
