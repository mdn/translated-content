...
<p>HTMLFormElement 接口可以创建或者修改{{HTMLElement("form")}}对象;它继承了{{domxref("HTMLElement")}}接口的方法和属性。</p>

<h2 id="属性">属性</h2>

<p><em>继承自父类的属性，{{domxref("HTMLElement")}}.</em></p>
...
<dl>
 ...
 <dt>{{domxref("HTMLFormElement.elements")}}<code><a href="/en/DOM/form.elements"> </a></code>{{readonlyinline}}</dt>
...
<p><em>这个元素继承了 {{domxref("HTMLElement")}} 的属性。</em></p>
...
<dl>
 ...
 <dd>从元素集合中获取 <code>name</code> 或者 <code>id</code> 与指定名称匹配的项，没有匹配项则返回 null。您也可以像调用数组那样用圆括号或方括号来指定名称， 而不必显式地调用这个方法。</dd>
...
<p>The following example shows how to submit a form in a <a href="/en-US/docs/DOM/window.open">popup window</a>.</p>
...
<p>If you want to know how to serialize and submit a form using the <a href="/en-US/docs/DOM/XMLHttpRequest"><code>XMLHttpRequest</code></a> API, please read <a href="/en-US/docs/DOM/XMLHttpRequest/Using_XMLHttpRequest#Submitting_forms_and_uploading_files">this paragraph</a>.</p>
