...
- {{cssxref('@property')}}
  - : 定义了浏览器应该如何解析 {{cssxref('--*', 'CSS custom properties')}}。通过 [CSS](/zh-CN/docs/Web/CSS) 中的 {{cssxref('@property')}} [at 规则](/zh-CN/docs/Web/CSS/CSS_syntax/At-rules)访问该接口。
...
可以在 [CSS](/zh-CN/docs/Web/CSS) 中使用 {{cssxref('@property')}} [at-rule](/zh-CN/docs/Web/CSS/CSS_syntax/At-rules) 进行相同的注册：
