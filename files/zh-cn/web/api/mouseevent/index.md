...
_这个接口也从父接口 {{domxref("UIEvent")}} 和 {{domxref("Event")}} 继承了属性。_

- {{domxref("MouseEvent.altKey")}} {{readonlyinline}}
  - : 当鼠标事件触发时，如果 <kbd>alt</kbd> 键被按下，返回 `true`。
- {{domxref("MouseEvent.button")}} {{readonlyinline}}
  - : 当鼠标事件触发时，如果鼠标按钮被按下（如果有的话），将会返回一个数值。
- {{domxref("MouseEvent.buttons")}} {{readonlyinline}}
  - : 当鼠标事件触发时，如果多个鼠标按钮被按下（如果有的话），将会返回一个或者多个代表鼠标按钮的数字。
- {{domxref("MouseEvent.clientX")}} {{readonlyinline}}
  - : 鼠标指针在[视口坐标系](/zh-CN/docs/Web/API/CSSOM_view_API/Coordinate_systems#视口)中的 X 坐标。
- {{domxref("MouseEvent.clientY")}} {{readonlyinline}}
  - : 鼠标指针在[视口坐标系](/zh-CN/docs/Web/API/CSSOM_view_API/Coordinate_systems#视口)中的 Y 坐标。
...
_这个接口也从父接口 {{domxref("UIEvent")}} 和 {{domxref("Event")}} 继承了方法。_

- {{domxref("MouseEvent.getModifierState()")}}
  - : 返回指定修饰键的当前状态。请参照 {{domxref("KeyboardEvent.getModifierState", "KeyboardEvent.getModifierState()")}} 查看详情。
