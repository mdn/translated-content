...
---
<p>除了标准的 <a href="/en-US/docs/Web/JavaScript">JavaScript</a> 函数集 (例如 {{jsxref("String")}}, {{jsxref("Array")}}, {{jsxref("Object")}}, {{jsxref("JSON")}} 等), DOM 有多种功能可供 workers 使用。</p>

<p>本文提供了一些列表。</p>

<p><strong>Workers </strong>在另一个全局上下文内运行<strong>, {{domxref("DedicatedWorkerGlobalScope")}} </strong>与当前<strong> window</strong>不同。</p>

<p>默认情况下，{{domxref("Window")}}的方法和属性不可用，但{{domxref("DedicatedWorkerGlobalScope")}}像 Window，实现{{domxref("WindowTimers")}} 和 {{domxref("WindowBase64")}}。</p>



<h2 id="比较不同类型workers的属性和方法">比较不同类型 workers 的属性和方法</h2>

<table class="no-markdown">
 <tbody>
  <tr>
   <td class="header">Function</td>
   <td class="header">Dedicated workers</td>
...
<h2 id="APIs_available_in_workers">APIs available in workers</h2>

<table class="no-markdown">
 <tbody>
  <tr>
   <td class="header">Function</td>
   <td class="header">Functionality</td>
   <td class="header">Support in Gecko (Firefox)</td>
  ...
  <tr>
   ...
   <td>
    <p>允许在{{glossary("origin","同源")}}的浏览{{glossary("browsing context", "上下文")}}（即窗口，制表符，框架或 iframe）之间进行简单通信（通常是来自同一站点的页面）。</p>
   </td>
  ...
  <tr>
   ...
   <td><code>FormData</code> objects provide a way to easily construct a set of key/value pairs representing form fields and their values, which can then be easily sent using the XMLHttpRequest <a href="/en-US/docs/DOM/XMLHttpRequest#send()"><code>send()</code></a> method.</td>
  ...
  <tr>
   <td>{{ domxref("URL") }}</td>
   <td>Workers can use the static methods <a href="/en-US/docs/DOM/window.URL.createObjectURL">URL.createObjectURL</a> and <a href="/en-US/docs/DOM/window.URL.revokeObjectURL">URL.revokeObjectURL</a> with {{domxref("Blob")}} objects accesible to the worker.<br>
  ...
  <tr>
   ...
   <td>10.0</td>
   <td>{{CompatNo}} See <a href="https://code.google.com/p/chromium/issues/detail?id=31666">crbug.com/31666</a></td>
   <td>{{CompatNo}}</td>
  </tr>
  <tr>
