...
---
<p>这个页面讲的是如何利用 JavaScript 中的 <a href="http://www.w3.org/TR/DOM-Level-3-Core/core.html">DOM Core</a> API 来创建和修改 DOM 对象。它适用于特权（扩展）和非特权（网页）代码中的所有基于 Gecko 的应用程序（如 Firefox）。</p>
