...
<div>
<p><a href="/en-US/docs/Web/API/Fetch_API">Fetch</a> 是一个现代的概念，等同于 <a href="/en-US/docs/Web/API/XMLHttpRequest">XMLHttpRequest</a>。它提供了许多与 XMLHttpRequest 相同的功能，但被设计成更具可扩展性和高效性。本文介绍了 Fetch API 的一些基本概念。</p>
</div>

<div class="note">
<p><strong>Note</strong>: 这篇文章可能还需要修改。如果你觉得有的概念可以解释的更好，让人们在<a href="https://discourse.mozilla-community.org/c/mdn">MDN 论坛</a>上知道，或 <a href="https://wiki.mozilla.org/IRC">Mozilla IRC</a> (#mdn room)。</p>
</div>
...
<p><a href="/en-US/docs/Web/API/ServiceWorker_API">Service Workers</a> 是大量使用 Fetch 的 API 的一个示例。</p>
