...
<p><a href="/en-US/docs/Web/API/Web_Audio_API">Web Audio API</a> 的 <strong><code>AudioBuffer</code></strong> 构造函数将创建一个新的 {{domxref("AudioBuffer")}} 对象。</p>
...
<dl>
 ...
 <ul>
  <li><code>length</code>: buffer 中采样帧的长度。</li>
  <li><code>numberOfChannels</code>: buffer 的通道数. 默认值为 1. </li>
  <li><code>sampleRate</code>: buffer 的采样率 (Hz). 默认值为构造此对象时使用的 <code>context</code> 的采样率。</li>
 </ul>
 </dd>
</dl>
...
<p>一个新的 {{domxref("AudioBuffer")}} 对象实例。</p>
