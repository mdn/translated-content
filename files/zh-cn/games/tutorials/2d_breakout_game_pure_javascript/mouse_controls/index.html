...
<div>
<p>本篇为 <a href="/en-US/docs/Games/Workflows/Breakout_game_from_scratch">Gamedev Canvas tutorial</a> 10 节教程中的<strong>第 9 节</strong>。在你完成这篇课程之后，你可以在 <a href="https://github.com/end3r/Gamedev-Canvas-workshop/blob/gh-pages/lesson09.html">Gamedev-Canvas-workshop/lesson9.html</a> 找到我们的源代码。</p>
</div>

<p>这个游戏实际已经完成，现在让我们着手去润色。我们已经添加过键盘控制，而加入鼠标控制也同样简单。</p>
...
<p>现在我们已经拥有一个完整的游戏。我们的系列教程将以一些细节上的调整作为<a href="/en-US/docs/Games/Workflows/Breakout_game_from_scratch/Finishing_up">结束。</a></p>
