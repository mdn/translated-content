...
为了更快速高效的学习本系列教程，你需要掌握 [JavaScript](/zh-CN/docs/Learn_web_development/Getting_started/Your_first_website/Adding_interactivity) 的一些基础知识。学习完本教程之后你就可以创建自己的网页小游戏了。
