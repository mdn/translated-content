...
- [使用设备方向的 2D 迷宫游戏](/zh-CN/docs/Games/Tutorials/HTML5_Gamedev_Phaser_Device_Orientation)
  - : 该教程展示如何使用 HTML，结合碰撞检测及在 {{htmlelement("canvas")}} 中放置精灵的基础知识来创建一个 2D 迷宫游戏。这是一个移动端游戏，它使用[设备方向](/zh-CN/docs/Web/API/Device_orientation_events)和[振动](/zh-CN/docs/Web/API/Vibration_API) **API** 来增强游戏体验，并使用 [Phaser](https://phaser.io/) 框架构建。
