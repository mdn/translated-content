...
<div>
<p>在本教程中，我们将介绍构建 HTML5 移动游戏的过程。本游戏使用 <a href="/en-US/Apps/Build/gather_and_modify_data/responding_to_device_orientation_changes">Device Orientation</a> 和 <a href="/en-US/docs/Web/Guide/API/Vibration">Vibration </a><strong>APIs</strong> 来增强游戏玩法，并使用 <a href="http://phaser.io/">Phaser</a> 框架构建。为了充分理解本教程建议您先学习基础的 JavaScript 知识。</p>
</div>

<h2 id="Example_game">Example game</h2>

<p>在本教程结束时，您将有一个功能齐全的游戏 demo：<a href="http://orb.enclavegames.com/">Cyber Orb </a>。如下所示：</p>
...
<p>您能够在 GitHub 看到它的源代码 <a href="https://github.com/EnclaveGames/Cyber-Orb">Cyber Orb</a>。文件夹结构非常简单：起点是 <code>index.html</code>。我们在该文件中初始化框架并设置 html 元素 {{htmlelement("canvas")}} 以呈现游戏。</p>
...
<p>您可以在您最喜爱的浏览器中打开 index 文件以启动并尝试游戏。目录中还有三个文件夹：</p>

<ul>
 <li><code>img</code>: 我们将在游戏中使用的所有图片。</li>
 <li><code>src</code>:定义了游戏中所有源代码的 JavaScript 文件。</li>
...
<div class="note">
<p><strong>备注：</strong> You can read the <a href="http://gamedevelopment.tutsplus.com/tutorials/getting-started-with-phaser-building-monster-wants-candy--cms-21723">Building Monster Wants Candy</a> article for the in-depth introduction to the basic Phaser-specific functions and methods.</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> To find more out about implementing device orientation and what raw code would look like, read <a href="/en-US/Apps/Build/gather_and_modify_data/responding_to_device_orientation_changes">Keep it level: responding to device orientation changes</a>.</p>
</div>
