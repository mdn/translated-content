...
<div>
<p>这是<a href="/en-US/docs/Games/Workflows/2D_Breakout_game_Phaser">Gamedev Phaser 教程</a> 16 的<strong>第 13 步</strong>。您可以在<a href="https://github.com/end3r/Gamedev-Phaser-Content-Kit/blob/gh-pages/demos/lesson13.html">Gamedev-Phaser-Content-Kit / demos / lesson13.html</a>完成本课程后找到源代码。</p>
</div>
...
<p>定义文本看起来像我们已经在<a href="/en-US/docs/Games/Workflows/2D_Breakout_game_Phaser/The_score">分数</a>课上已经做<a href="/en-US/docs/Games/Workflows/2D_Breakout_game_Phaser/The_score">的</a>。<code>scoreText</code>在<code>create()</code>函数内的现有定义下方添加以下行：</p>
...
<p>生活让游戏更加宽容 - 如果你失去一个生命，你还剩下两个，可以继续玩。现在让我们通过添加<a href="/en-US/docs/Games/Workflows/2D_Breakout_game_Phaser/Animations_and_tweens">动画和补间来</a>扩展游戏的外观和感觉。</p>
