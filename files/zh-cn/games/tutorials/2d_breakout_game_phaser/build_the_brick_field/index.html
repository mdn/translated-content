...
<div>
<p>这是<a href="/en-US/docs/Games/Workflows/2D_Breakout_game_Phaser">Gamedev Phaser 教程</a> 16 的<strong>第 9 步</strong>。在<a href="https://github.com/end3r/Gamedev-Phaser-Content-Kit/blob/gh-pages/demos/lesson09.html">Gamedev-Phaser-Content-Kit / demos / lesson09.html</a>完成本课后，您可以找到源代码。</p>
</div>

<p>建立砖块比将单个对象添加到屏幕要复杂一点，尽管使用 Phaser 还是比纯 JavaScript 更容易。我们来探讨如何创建一组砖块，并使用循环在屏幕上打印。</p>
...
<p>您还需要<a href="https://github.com/end3r/Gamedev-Phaser-Content-Kit/blob/gh-pages/demos/img/brick.png">从 Github 抓取砖图像</a>并将其保存在您的<code>/img</code>目录中。</p>
...
<h2 id="检查initbricks_代码">检查 initBricks() 代码</h2>
...
<p>有些东西丢失了 球不经停，经过砖块 - 我们需要适当的<a href="/en-US/docs/Games/Workflows/2D_Breakout_game_Phaser/Collision_detection">碰撞检测</a>。</p>
