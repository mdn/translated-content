...
---
<div>{{GamesSidebar}}</div><p>游戏中一个典型的 3D 场景 (最简单的那种)  包含标准的物品比如在坐标轴中的形状，一个实际可看到他们的摄像机，灯光和材质让其看起来不错，动画使其生动等等。<strong> Three.js</strong>, 和其他 3D 库一样，提供内置的 helper 函数来帮助你尽可能快地实现通用的 3D 功能 . 在这篇文章我们会带你了解使用 Three 的基本知识，包含设置开发者环境，必要的 HTML 结构，Three.js 对象基础，以及如何创建一个基本的 demo.</p>

<div class="note">
<p><strong>备注：</strong> 我们选择 Three.js 因为它是最流行的<a href="/en-US/docs/Web/API/WebGL_API">WebGL</a> 库之一，并且很容易上手。我们不会介绍任何其他更好的 WebGL 库，你可以自由选择其他库做尝试，比如 <a href="http://www.ambiera.com/copperlicht/index.html">CopperLicht</a>, <a href="http://www.glge.org/">GLGE</a>, <a href="http://osgjs.org/">OSG.js</a>, <a href="https://code.google.com/p/o3d/">O3D</a>, 或者其他你喜欢的库。</p>
</div>
...
<ul>
 <li>确保使用的支持 <a href="/en-US/docs/Web/API/WebGL_API">WebGL</a> 的现代浏览器，例如最新版的 Firefox 或 Chrome.</li>
 <li>创建一个目录保存例子。</li>
 <li>复制最新的压缩版<a href="http://threejs.org/build/three.min.js"> Three.js</a> 到你的目录。</li>
 <li>用单独的浏览器 tab 打开 <a href="http://threejs.org/docs/">Three.js </a>文档 — 对应参考很有用。</li>
</ul>
...
<div class="note">
<p><strong>备注：</strong> The distance values (e.g. for the camera z position) are unitless, and can basically be anything you deem suitable for your scene — milimeters, meters, feet, or miles — it's up to you.</p>
</div>
...
<p>You can also <a href="https://github.com/end3r/MDN-Games-3D/blob/gh-pages/Three.js/shapes.html">see it on GitHub</a> and <a href="https://github.com/end3r/MDN-Games-3D/">fork the repository</a> if you want to play with it yourself locally. Now you know the basics of Three.js, you can get back to the parent page about <a href="/en-US/docs/Games/Techniques/3D_on_the_web">3D on the Web</a>.</p>
