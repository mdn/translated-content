...
游戏中的典型 3D 场景（即使是最简单的场景）包含一些标准项目，如位于坐标系中的形状、用于查看的摄像头、使其看起来更漂亮的灯光和材质、使其看起来更生动的动画等。与其他三维库一样，**Three.js** 也提供了内置辅助函数，以帮助您更快地实现常见的三维功能。在本文中，我们将带你了解使用 Three.js 的真正基础知识，包括设置开发环境、构建必要的 HTML、Three 的基本对象以及如何制作一个基本演示。
