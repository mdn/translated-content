...
社区贡献对这个开源项目帮助巨大。贡献者可以通过他们在 MDN Web 文档上的工作展示他们的写作、技术和协作技能，以及与来自不同背景的人合作的能力。本节将介绍您在 MDN Web 文档项目志愿工作中可以担任的角色。
...
如果你是新人，并且想成为一名贡献者，可以看看我们的[贡献者指南](https://github.com/mdn/content/blob/main/CONTRIBUTING.md)和 [MDN GitHub 组织中的仓库列表](https://github.com/orgs/mdn/repositories)。
...
- 在你的 GitHub 账户开启[二步认证](https://docs.github.com/zh/authentication/securing-your-account-with-two-factor-authentication-2fa)。
...
所有者拥有管理用户和 [GitHub 团队](https://github.com/orgs/mdn/teams)、维护 [MDN 组织](https://github.com/mdn)中各版本库的访问权限、维护版本库设置以及部署到生产环境的广泛权限。所有者受其他贡献者角色的所有要求约束。

> **备注：** 所有者角色目前仅限 Mozilla 员工获得。
...
| [**组织成员**](#组织成员) | - 在 GitHub 账户上启用二步认证（2FA）<br> - 启用签名提交<br><br>至少一个：<br>- 解决至少两个议题<br> - 至少贡献了两个月<br>- 在一个项目领域作出活跃贡献            | 组织级别的访问权限                                     |
