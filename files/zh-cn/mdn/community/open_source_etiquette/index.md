...
- 我总是使用这个工具，并且找到了一个差错（bug），或想要帮助解决它。
- 我想帮助其他人更加顺利地使用这个工具。
- 我想帮助其他人更加顺利地向项目做贡献。
- 我想提升个人技能水平。
- 我想公开展示我在大学课程中学习到的技能。
...
要始终弄清楚哪里是问问题的最佳地点。好的开源项目总会在它们的文档中明确指定这一点（请查看[在 MDN 中寻求帮助](/zh-CN/docs/MDN/Community)一节）。如果你想问一些通用性的问题，请使用这些频道。不要为每个问题发出一遍 GitHub issue，因为它给项目增加了噪音（请查看下述”要取得进展，不要捣乱“章节）。
...
然而，有些事情将主要由一小群核心贡献者决定。你可以自由地提出反对任何决定的理由，但有时版主会做出与你的意见相反的决定，你需要尊重并接受这些决定。
