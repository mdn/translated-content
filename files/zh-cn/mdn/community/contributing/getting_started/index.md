...
想要为 MDN 做贡献的道路很多，取决于你的技能和兴趣。对于每一种任务，我们会给出简要的解释和预计完成的大致时间。

> 如果你不知道该做些什么，欢迎向我们[寻求帮助](https://github.com/mdn/mdn-community/)。
> 也需要注意，我们麻雀虽小，但五脏俱全的团队正在维护着这个存储库，为了保护带宽，将关闭无关的讨论。

## 首要的贡献类型

我们创建了一个[贡献者任务板](https://github.com/orgs/mdn/projects/25/views/1)来帮助你寻找为项目做出重大影响的贡献机会，任务板包含有概述部分和特定贡献类型的分离视图。
...
> 注意：没必要为完成 _所有_ 的课程任务和阅读资料不知所措。在了解了“GitHub 简介”课程后，你应该拥有了足够的知识来为我们贡献。

- [GitHub 简介](https://github.com/skills/introduction-to-github)
- [安装并设定 Git](https://docs.github.com/cn/get-started/quickstart/set-up-git)
...
某些写作相关的机会需要对英语的足够了解。即使你的语法不够好，也不用担心！我们的团队会保证 MDN 上的内容足够好。也就是说，有人会在一旁确保工作的整洁和行文的正确性。

一旦你决定了你所做的任务种类，就可以前往[贡献者任务板](https://github.com/orgs/mdn/projects/25/views/1)中挑选议题，并在评论区中留下评论和提及 `@mdn/mdn-community-engagement` 团队。我们队伍中的成员会回应，且将议题分配给你。

这保证两个人的工作不会“撞车”，并且可以知道在工作遇到困难的时候，你该联系的人。

### 贡献

当贡献时，视为你同意 [Attribution-ShareAlike license](https://creativecommons.org/licenses/by-sa/4.0/)（或在所编辑页面中另行指定的）许可。另外，代码示例的许可为 [Creative Commons CC-0](https://creativecommons.org/share-your-work/public-domain/cc0/)（一种公有领域贡献的协议）。
