...
自 2020 年 12 月 14 日起，MDN 一直运行在一个[在 GitHub 上进行维护](/zh-CN/docs/MDN/Community/Our_repositories)的平台上。这为 MDN 带来了许多积极影响，但我们需要彻底改变我们处理本地化内容的方式。这是因为在我们的非英语本地化语言中，有很多内容未经维护且已经过时，我们希望将来能更好地管理这些内容。

**除了**以下语言，其他所有的本地化内容都已经归档，这意味着它们在 GitHub 上是只读的，不能在 MDN 上查看。活跃的本地语言有专门的团队负责维护。
...
- 当前维护者：[cw118](https://github.com/cw118)、[tristantheb](https://github.com/tristantheb)
...
- 仓库：[mdn/translated-content-de](https://github.com/mdn/translated-content-de)
- 讨论：[Discord (`#german`)](/discord)
- 当前维护者：[caugner](https://github.com/caugner)

### 意大利语（`it`）

- 仓库：[mdn/translated-content-it](https://github.com/mdn/translated-content-it)
- 讨论：[Discord (`#italian`)](/discord)
- 当前维护者：[caugner](https://github.com/caugner)
