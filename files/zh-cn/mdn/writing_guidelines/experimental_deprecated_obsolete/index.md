...
> **警告：** 规范冲突：WHATWG 规范列出了 [`inputmode`](https://html.spec.whatwg.org/multipage/interaction.html#attr-inputmode)，且现代浏览器正在尝试支持它。而 [W3C HTML 5.2 规范](https://html.spec.whatwg.org/multipage/index.html#contents)不再将其列出（即将其标记为过时）。在达成共识之前，你应该将 WHATWG 定义视为是正确。
