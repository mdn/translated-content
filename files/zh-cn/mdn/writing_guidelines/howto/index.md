...
MDN Web 文档写作指南的这一部分包含了为 MDN Web 文档做贡献时完成特定任务的所有步骤信息：我们如何使用 markdown，如何向词汇表添加条目，如何移动或删除页面，等等。要了解更多关于*如何（通过 GitHub 进行）贡献*的方法，请参见我们的[贡献指南](/zh-CN/docs/MDN/Community)。
