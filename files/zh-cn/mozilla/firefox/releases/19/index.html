...
---
<div>{{FirefoxSidebar}}</div><p>Firefox 19 已于 2013 年 2 月 19 日正式发布。</p>
...
<ul>
 <li><code><a href="/zh-CN/docs/JavaScript/Reference/Global_Objects/Map">Map</a></code> 和 <code><a href="/zh-CN/docs/JavaScript/Reference/Global_Objects/Set">Set</a></code> 对象的 <code>size()</code> 方法变成了 <code>size</code> 属性。({{bug("807001")}})</li>
 <li><code><a href="/zh-CN/docs/JavaScript/Reference/Global_Objects/Map">Map</a></code> 和 <code><a href="/zh-CN/docs/JavaScript/Reference/Global_Objects/Set">Set</a></code> 对象新增了一个 clear() 方法。({{bug("805003")}})</li>
</ul>
...
<p><a href="http://www.philipp-wagner.com/blog/2011/07/the-future-of-mozilla-xforms/"><strong>删除</strong></a>了对<a href="/zh-CN/docs/XForms">XForms</a>的支持。</p>

<h2 id="附加组件和Mozilla开发者需要注意的变化">附加组件和 Mozilla 开发者需要注意的变化</h2>

<div class="note">
<p><strong>备注：</strong> A key change in Firefox 19 is that <a href="/zh-CN/docs/XPCOM_API_Reference/nsresult"><code>nsresult</code></a> is now strongly typed. This will help make it easier to detect bugs that are caused by mishandling of return values, but may cause existing code to break if it's making incorrect assumptions in this regard.</p>
</div>
