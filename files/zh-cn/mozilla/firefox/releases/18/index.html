...
---
<div>{{FirefoxSidebar}}</div><p>Firefox 18 已于 2013 年 1 月 8 日发布。</p>
...
<ul>
  ...
  <li>The cascade has been updated: now author <code>!important</code> rules override <a href="/zh-CN/docs/CSS/Using_CSS_animations">CSS animations</a>. ({{bug("783714")}})</li>
  <li>{{cssxref("background")}}简写属性可以包含 CSS3 中的{{cssxref("background-size")}}属性了。({{bug("570326")}})</li>
  <li>初步实现了 Flexbox.默认禁用状态，可以通过设置<code>layout.css.flexbox.enabled</code>选项激活该特性.({{bug('666041')}})</li>
</ul>
<h3 id="DOM">DOM</h3>
<ul>
  <li><code>实现了navigator.mozPay属性</code>({{bug("767818")}})</li>
  <li><code>实现了window.devicePixelRatio属性</code>. ({{bug("564815")}})</li>
  <li>在 MacOS 上实现了<code>window.navigator.battery属性</code>. ({{bug("696045")}})</li>
  <li>删除了{{domxref("BlobBuilder", "MozBlobBuilder")}}.开发者们应该使用{{domxref("Blob")}}构造函数来创建<code>Blob对象</code>. ({{bug("744907")}})</li>
  <li>{{event("visibilitychange")}}事件和<a href="/zh-CN/docs/DOM/Using_the_Page_Visibility_API">页面可见性 API</a>取消前缀{{bug("812086")}}).</li>
  <li><code>实现了TextDecoder</code>和<code>TextEncoder</code> .({{bug("764234")}})</li>
  <li><code>HTMLMediaElement</code><code>.src</code>被分成了两个属性：一个是标准的<code>src属性</code>,返回普通的字符串{{domxref("DOMString")}},另一个是带前缀的<code>mozSrcObject</code>属性，返回<a href="/zh-CN/docs/WebRTC/MediaStream_API">media streams</a> ({{bug("792665")}}).</li>
</ul>
<h3 id="JavaScript">JavaScript</h3>
<ul>
  <li>实现了 EcmaScript 6 中的<a href="/zh-CN/docs/JavaScript/Reference/Global_Objects/Proxy">直接代理</a>({{bug("703537")}}).警告：该实现包含了一些已知的 bug，以及未根据最新规范草案实现某些特性。不要在生产环境中使用它。</li>
  <li>实现了 ECMAScript 6 中的字符串方法<code>contains()</code>.</li>
</ul>
...
<h3 id="网络">网络</h3>
<ul>
  <li>HTTP 请求头<code>Accept-Language可以使用两位数字的质量因子</code>("q-values")({{bug("672448")}}).</li>
  <li>HTTP 响应头支持了<a href="/zh-CN/docs/The_X-FRAME-OPTIONS_response_header"><code>X-FRAME-OPTIONS</code></a>中的<code>ALLOW-FROM</code>语法 ({{bug("690168")}}).</li>
</ul>
...
<dl>
  ...
  <dd>
    <code>setUploadStream()</code> 支持了超过 2GB 大小的 content-length ({{bug("790617")}})</dd>
  <dt>
...
<h2 id="相关链接">相关链接</h2>
<ul>
  <li><a href="http://www.mozilla.org/zh-CN/firefox/18.0/releasenotes/">Firefox 18 发行说明</a></li>
  <li><a href="https://hacks.mozilla.org/2012/10/aurora-18-hidpi-touch-events/">Aurora 18: HiDPI &amp; Touch Events</a> (Mozilla Hacks)</li>
  <li><a href="/zh-CN/docs/Site_Compatibility_for_Firefox_18">Firefox 18 网站兼容性</a></li>
  <li><a href="https://blog.mozilla.org/addons/2012/12/28/compatibility-for-firefox-18/">Firefox 18 附加组件兼容性</a></li>
</ul>
<h3 id="更早版本">更早版本</h3>
