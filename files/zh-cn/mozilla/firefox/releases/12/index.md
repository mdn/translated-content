...
- The source editor now offers methods for providing search capability: [`find()`](</zh-CN/docs/JavaScript_code_modules/source-editor.jsm#find()>), [`findNext()`](</zh-CN/docs/JavaScript_code_modules/source-editor.jsm#findNext()>), and [`findPrevious()`](</zh-CN/docs/JavaScript_code_modules/source-editor.jsm#findPrevious()>).
