...
A [`getDataDirectory()`](</zh-CN/Add-ons/Add-on_Manager/Addon#getDataDirectory()>) method has been added to [`Addon`](/zh-CN/Add-ons/Add-on_Manager/Addon) instances. This method returns the preferred location, within the current profile, for add-ons to store data.
