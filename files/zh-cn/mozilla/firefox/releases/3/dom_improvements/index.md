...
- 为 `Node.nodePrincipal`、`Node.baseURIObject` 和 `document.documentURIObject` 添加了仅限特权代码的 getter。Chrome 代码不得访问（获取或设置）这些属性，例如在一个未包装的内容对象上（如 [`XPCNativeWrapper`](/zh-CN/XPCNativeWrapper) 的 `wrappedJSObject`），详情请参见 [Firefox bug 324464](https://bugzil.la/324464)。
...
- [Firefox 3 中的 CSS 改进](/zh-CN/docs/CSS_improvements_in_Firefox_3)
