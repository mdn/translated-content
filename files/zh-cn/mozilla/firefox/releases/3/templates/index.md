...
- XUL 排序服务更加稳健，并且能够[更好地排序](/zh-CN/docs/XUL/Template_Guide/Sorting_Results)内容树和非内容树。它还允许对非模板构建的内容进行排序。（[Firefox bug 335122](https://bugzil.la/335122)）
