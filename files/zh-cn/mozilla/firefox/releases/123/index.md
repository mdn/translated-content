...
- [Web Authentication API](/zh-CN/docs/Web/API/Web_Authentication_API) 现已支持跨源凭据创建。更具体地，如果顶层嵌入的 [`<iframe>`](/zh-CN/docs/Web/HTML/Element/iframe#allow) 的 [`Feature-Policy: publickey-credentials-create`](/zh-CN/docs/Web/HTTP/Reference/Headers/Permissions-Policy/publickey-credentials-create) 允许，现在可以在从不同来源加载的嵌套浏览上下文中调用 [`navigator.credentials.create({publicKey})`](/zh-CN/docs/Web/API/CredentialsContainer/create)。（[Firefox bug 1870863](https://bugzil.la/1870863)）。
