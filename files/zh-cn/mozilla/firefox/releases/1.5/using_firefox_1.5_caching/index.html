...
---
<div>{{FirefoxSidebar}}</div><h2 id="Introduction">介绍</h2>
...
<h2 id="New_browser_events">新的浏览器事件</h2>
...
<h3 id="pageshow_event">pageshow 事件</h3>
...
<h3 id="pagehide_event">pagehide 事件</h3>
...
<h2 id="Developing_Firefox_extensions">开发 Firefox 扩展</h2>
