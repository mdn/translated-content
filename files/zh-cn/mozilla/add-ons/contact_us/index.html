...
<p><a href="https://matrix.org/">Matrix</a>是一个开放的轻量级协议，用于分散的（decentralized）实时通信。有关如何加入 Mozilla Matrix 频道的信息，请参阅<a href="https://wiki.mozilla.org/Matrix"> Mozilla Wiki 上的 Matrix 页面</a>。
...
<p>如果你发现网站有问题，我们很乐意修复它。请<a href="https://github.com/mozilla/addons/issues/new">提交错误报告</a>，并尽可能详细地说明。