...
测试时打开 MDN 上的一个包含诸多图片的页面（如[https://developer.mozilla.org/zh-CN/docs/Tools/Network_Monitor](/zh-CN/docs/Tools/Network_Monitor) ），重新加载[WebExtension](/zh-CN/Add-ons/WebExtensions/Temporary_Installation_in_Firefox#Reloading_a_temporary_add-on)，然后重新加载这个页面：
