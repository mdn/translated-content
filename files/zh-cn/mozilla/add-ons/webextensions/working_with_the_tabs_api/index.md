...
- manifest.json
  ...
  - : The [`manifest.json`](https://github.com/mdn/webextensions-examples/blob/master/apply-css/manifest.json) requests permissions required to use the CSS features. You need either:
    ...
    - `"tabs"` permission and [host permission](/zh-CN/docs/Mozilla/Add-ons/WebExtensions/manifest.json/permissions#host_permissions); or,
...
- [Tabs API reference](/zh-CN/docs/Mozilla/Add-ons/WebExtensions/API/tabs)
- [Example extensions](/zh-CN/docs/Mozilla/Add-ons/WebExtensions/Examples) (many of which use the Tabs API)
