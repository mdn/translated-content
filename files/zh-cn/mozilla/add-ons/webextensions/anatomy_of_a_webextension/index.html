...
<ul>
 ...
 <li>图标: 用于扩展插件和任何它可能定义的按钮儿。</li>
 <li><a href="/zh-CN/docs/Mozilla/Add-ons/WebExtensions/Anatomy_of_a_WebExtension#侧边栏，弹出窗口，选项页面">侧边栏，弹出窗口，选项页</a>: 为各式各样用户界面组件提供内容的 HTML 文件。</li>
