...
<p>附加组件的短名称。一般用在 <a href="/en-US/Add-ons/WebExtensions/manifest.json/name">name</a> 特性太长的情况下。建议短名称的长度不要超过 12 个字符。如果没有在 manifest.json 主文件中声明 short_name, 并且 name 特性的值又比较长的话，用户界面显示的时候可能只会显示一部分. </p>
