...
<p>该对象的两个属性都是可选的。如果存在“name”和“url”属性，将会分别覆盖<a href="/en-US/Add-ons/WebExtensions/manifest.json/author">author</a>和<a href="/en-US/Add-ons/WebExtensions/manifest.json/homepage_url">homepage_url</a>键。这个对象仅仅允许指定一个开发者名字的主页地址。</p>
