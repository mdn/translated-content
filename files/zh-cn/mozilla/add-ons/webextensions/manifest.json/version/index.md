...
需要注意的是 Chrome 浏览器的 version 格式要求 ([the syntax defined for Chrome's `version`](https://developer.chrome.google.cn/extensions/manifest/version)) 比 Firefox 浏览器的 version 格式更严格一些，这意味这：
