...
<p>扩展程序包含的某些 UI 组件，例如： <a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/user_interface/Popups">popups</a>, <a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/user_interface/Sidebars">sidebars</a>, <a href="/en-US/Add-ons/WebExtensions/user_interface/Options_pages">options pages</a> ，实际上可以用如下方式统一定义：</p>
...
<p><strong>备注：</strong> 谷歌浏览器 <strong>Google Chrome</strong> 和 欧朋浏览器 <strong>Opera</strong> 使用字段名 <code>chrome_style</code> 而非<code>browser_style</code>, 因此如果要适配它们，你需要同时添加这两个字段。</p>
</div>
...
<p>大多数样式是自动应用的，但是某些元素需要添加非标准的类名 <code>browser-style</code> 来获得其样式，如下表所示：</p>
...
<div class="blockIndicator note">
<p><strong>备注：</strong> 查看 {{bug(1465256)}} 以了解相关修订</p>
</div>
...
<div class="note">
<p><strong>备注：</strong> 此功能不是通用标准，仅支持在 firefox 中使用</p>
</div>
...
<p>{{EmbedLiveSample("示例","640","360")}}</p>
