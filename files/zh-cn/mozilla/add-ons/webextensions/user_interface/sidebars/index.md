...
<p><img src="bookmarks-sidebar.png">Using the <code>sidebar_action</code> manifest.json key, an extension can add its own sidebar to the browser. It will be listed alongside the built-in sidebars, and the user will be able to open it using the same mechanism as for the built-in sidebars.</p>
...
<p>For details on how to design your sidebar's web page to match the style of Firefox, see the <a href="https://design.firefox.com/photon/index.html">Photon Design System</a> documentation.</p>
