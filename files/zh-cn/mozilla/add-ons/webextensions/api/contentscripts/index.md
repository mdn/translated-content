...
<p>此 API 与 <code><a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/manifest.json">manifest.json</a></code> 的  <code><a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/manifest.json/content_scripts">"content_scripts"</a></code> 键非常相似，但  <code>"content_scripts"</code> 键所能注册的内容脚本是固定的，自拓展安装后便不可更改。但通过 <code>contentScripts</code> API，拓展可以在运行时动态地注册或取消注册脚本。</p>
