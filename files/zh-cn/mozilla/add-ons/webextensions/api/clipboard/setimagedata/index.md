...
虽然此 API 基于 Chrome 浏览器的 [`clipboard.setImageData()`](https://developer.chrome.com/docs/apps/reference/clipboard) API，但两者还是有一些区别：
...
> [!NOTE]
> 此 API 基于 Chromium 的 [`chrome.clipboard`](https://developer.chrome.com/docs/apps/reference/clipboard) API。
