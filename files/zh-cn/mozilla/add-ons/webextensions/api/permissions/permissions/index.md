...
- `permissions` {{optional_inline}}
  - : 具名权限的数组，包含 [API 权限](/zh-CN/docs/Mozilla/Add-ons/WebExtensions/manifest.json/permissions#api_permissions)和[剪贴板权限](/zh-CN/docs/Mozilla/Add-ons/WebExtensions/manifest.json/permissions#clipboard_access)。
