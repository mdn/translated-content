...
- [`getURL()`](</zh-CN/Add-ons/WebExtensions/API/extension#getURL()>)
...
- [`connect()`](</zh-CN/Add-ons/WebExtensions/API/runtime#connect()>)
- [`getManifest()`](</zh-CN/Add-ons/WebExtensions/API/runtime#getManifest()>)
- [`getURL()`](</zh-CN/Add-ons/WebExtensions/API/runtime#getURL()>)
- [`onConnect`](/zh-CN/Add-ons/WebExtensions/API/runtime#onConnect)
- [`onMessage`](/zh-CN/Add-ons/WebExtensions/API/runtime#onMessage)
- [`sendMessage()`](</zh-CN/Add-ons/WebExtensions/API/runtime#sendMessage()>)
