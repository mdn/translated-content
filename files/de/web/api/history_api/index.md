...
> **Note:** **Anmerkung:** Der Internet Explorer unterstützt das Übergeben von String URLs als Parameter für `go()`; dies ist nicht standardisiertes Verhalten und wird von Gecko nicht unterstützt.
