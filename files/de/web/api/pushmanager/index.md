...
The `PushManager` interface of the [Push API](/de/docs/Web/API/Push_API) provides a way to receive notifications from third-party servers as well as request URLs for push notifications.
...
- [Using the Push API](/de/docs/Web/API/Push_API/Using_the_Push_API)
