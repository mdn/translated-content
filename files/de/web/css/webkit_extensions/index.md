...
## Standardisierte Eigenschaften mit Präfix
...
- {{ cssxref("-webkit-region-overflow") }}
...
## Eigenschaften, deren Präfix entfernt wurde

> **Warning:** Diese Eigenschaften sollten nur noch als Fallbacks genutzt werden.
...
> **Warning:** Diese Eigenschaften sind nicht für den Einsatz auf gebräuchlichen Webseiten gedacht.
