...
- {{htmlattrdef("align")}} {{Deprecated_inline}}
  - : Dieses aufgezählte Attribut gibt an, wie die Tabelle im beinhaltenden Dokument ausgerichtet werden muss. Es kann die folgenden Werte haben:\* left, bedeutet, dass die Tabelle links im Dokument angezeigt werden soll;
    ...
    - right, bedeutet, dass die Tabelle rechts im Dokument angezeigt werden soll.

  > **Hinweis:** **Verwenden Sie dieses Attribut nicht**, da es überholt ist: das {{HTMLElement("table")}}-Element sollte mit [CSS](/de/docs/CSS "CSS") angepasst werden. Um einen ähnlichen Effekt zu erreichen wie mit dem align-Attribut, sollten die [CSS](/de/docs/CSS "CSS")-Eigenschaften "text-align" und "vertical-align" verwendet werden.
      >
...
- {{htmlattrdef("width")}} {{Deprecated_inline}}
  ...
  > **Note:** **Usage Note:** Do not use this attribute, as it has been deprecated: the rules should be defined and styled using [CSS](/de/docs/CSS "CSS"). use the [CSS](/de/docs/CSS "CSS") property {{cssxref("width")}} instead.
